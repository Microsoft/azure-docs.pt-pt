...
|**Geração1**|**VpnGw1AZ**| Um máximo de 30*   | Um máximo de 128  | Um máximo de 250       | 650 Mbps  | Suportado | Sim |
|**Geração1**|**VPNGw2AZ**| Um máximo de 30*   | Um máximo de 128  | Um máximo de 500       | 1 Gbps    | Suportado | Sim |
|**Geração1**|**VpnGw3AZ**| Um máximo de 30*   | Um máximo de 128  | Um máximo de 1000      | 1,25 Gbps | Suportado | Sim |
|        |            |            |           |                |           |           |     |
...
|**Geração2**|**VpnGw4**  | Um máximo de 30*   | Um máximo de 128  | Um máximo de 5000      | 5 Gbps    | Suportado | Não |
|**Geração2**|**VpnGw5**  | Um máximo de 30*   | Um máximo de 128  | Um máximo de 10000      | 10 Gbps   | Suportado | Não |
|**Geração2**|**VPNGw2AZ**| Um máximo de 30*   | Um máximo de 128  | Um máximo de 500       | 1,25 Gbps | Suportado | Sim |
|**Geração2**|**VpnGw3AZ**| Um máximo de 30*   | Um máximo de 128  | Um máximo de 1000      | 2,5 Gbps  | Suportado | Sim |
|**Geração2**|**VpnGw4AZ**| Um máximo de 30*   | Um máximo de 128  | Um máximo de 5000      | 5 Gbps    | Suportado | Sim |
|**Geração2**|**VpnGw5AZ**| Um máximo de 30*   | Um máximo de 128  | Um máximo de 10000      | 10 Gbps   | Suportado | Sim |
