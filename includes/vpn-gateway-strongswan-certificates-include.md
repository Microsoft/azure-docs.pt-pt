...
Imprima o certificado de autoridade de certificação no formato base64. Esse é o formato com suporte do Azure. Você carrega esse certificado no Azure como parte das [etapas de configuração do P2S](../articles/vpn-gateway/vpn-gateway-howto-point-to-site-resource-manager-portal.md).
