...
O Azure acolhe o Azure Cloud Shell, um ambiente interativo de conchas que pode utilizar através do seu navegador. Pode utilizar a Bash ou a PowerShell com a Cloud Shell para trabalhar com os serviços Azure. Pode utilizar os comandos pré-instalados cloud Shell para executar o código neste artigo sem ter de instalar nada no seu ambiente local.

Para iniciar a Casca de Nuvem Azure:
