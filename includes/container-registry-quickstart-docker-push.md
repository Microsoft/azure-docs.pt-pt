...
Antes de poder empurrar uma imagem para o seu registo, tem de a marcar com o nome totalmente qualificado do seu servidor de login de registo. O nome do servidor de login está no formato * \<registry-name\> .azurecr.io* (todos minúsculos), por exemplo, *mycontainerregistry007.azurecr.io*.
