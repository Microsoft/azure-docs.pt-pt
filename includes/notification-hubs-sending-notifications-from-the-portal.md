...
Aqui está uma lista de outros tutoriais que você pode querer rever para envio de notificações:

* Aplicações móveis Azure: Para um exemplo de como enviar notificações de uma aplicação móvel de volta integrada com Centros de Notificação, consulte [Adicionar Notificações push à sua aplicação iOS](../articles/app-service-mobile/app-service-mobile-ios-get-started-push.md).  
