...
|Fornecedor|Objetivo|
|--|--|
|[Consola](/aspnet/core/fundamentals/logging/#console-provider)|O fornecedor de registo de `Console` ASP.NET Core. Todas as definições de configuração do núcleo ASP.NET e os valores predefinidos para este fornecedor de registos são suportados.|
|[Depurar](/aspnet/core/fundamentals/logging/#debug-provider)|O fornecedor de registo de `Debug` ASP.NET Core. Todas as definições de configuração do núcleo ASP.NET e os valores predefinidos para este fornecedor de registos são suportados.|
...
Para obter mais informações sobre a configuração ASP.NET suporte de registo do núcleo, consulte [a configuração do ficheiro Definições](/aspnet/core/fundamentals/logging/).