...
|----------------------------------------------------------- |------------------------------------|
| [Gerir mensagens do IoT Hub](../articles/iot-hub/iot-hub-vscode-iot-toolkit-cloud-device-messaging.md)                  | Extensão do VS o Kit de ferramentas do código do Azure IoT Hub|
...
| [Gerir o seu dispositivo IoT](../articles/iot-hub/iot-hub-device-management-iot-toolkit.md)                | Extensão do VS o Kit de ferramentas do código do Azure IoT Hub|
