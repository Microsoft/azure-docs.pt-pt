...
|----------------------------------------------------------- |------------------------------------|
| [Gerir mensagens do Hub IoT](../articles/iot-hub/iot-hub-vscode-iot-toolkit-cloud-device-messaging.md)                  | Extensão vs Código Azure IoT Hub|
...
| [Gerir o seu dispositivo IoT](../articles/iot-hub/iot-hub-device-management-iot-toolkit.md)                | Extensão vs Código Azure IoT Hub|
...
| [Deteção de anomalias e reação automáticas](../articles/iot-hub/iot-hub-monitoring-notifications-with-azure-logic-apps.md) | Azure Logic Apps                   |
