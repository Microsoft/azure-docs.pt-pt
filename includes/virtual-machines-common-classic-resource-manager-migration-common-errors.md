...
| A rede virtual {virtual-network-name} não existe. |Isto pode acontecer se tiver criado a Rede Virtual no novo portal do Azure. O nome de rede Virtual real segue o padrão "grupo * \<nome da VNET >" |
