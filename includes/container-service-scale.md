...
Pode alterar o número de nós de agente num cluster DC/OS, Docker Swarm ou Kubernetes utilizando o portal Azure ou o CLI Azure. 
...
## <a name="scale-with-the-azure-cli"></a>Escala com o CLI Azure

[Instale o CLI Azure](/cli/azure/install-azure-cli) e inscreva-se numa conta Azure com `az login` .
...
O CLI Azure devolve uma corda JSON que representa a nova configuração do serviço de contentores, incluindo a nova contagem de agentes.
...
* Veja [mais exemplos](../articles/container-service/dcos-swarm/container-service-create-acs-cluster-cli.md) de utilização dos comandos Azure CLI com o Serviço de Contentores Azure.
