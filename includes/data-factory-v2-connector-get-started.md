...
-->
Pode utilizar uma das seguintes ferramentas ou SDKs para utilizar a atividade de cópia com um pipeline. Selecione uma ligação para obter instruções passo a passo:
...
- [Modelo do Azure Resource Manager](../articles/data-factory/quickstart-create-data-factory-resource-manager-template.md)
