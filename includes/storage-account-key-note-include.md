...
> 
> A Microsoft recomenda utilizar a autenticação do Azure Active Directory (Azure AD) para seus aplicativos de armazenamento BLOBs e filas (pré-visualização) sempre que possível para uma maior segurança. Para obter mais informações, consulte [autenticar o acesso ao Azure os blobs e filas com o Azure Active Directory (pré-visualização)](https://docs.microsoft.com/azure/storage/common/storage-auth-aad).
