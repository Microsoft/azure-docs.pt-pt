...
1. No Estúdio Visual, navegue para **Project > Thermostat Properties > Debug**. Em seguida, adicione as seguintes variáveis ambientais ao projeto:
    ...
    | IOTHUB_CONNECTION_STRING | O valor que fez notar quando completou [Configurar o seu ambiente](../articles/iot-pnp/set-up-environment.md) |
...
> [!NOTE]
> Esta amostra utiliza o **microsoft.Azure.Devices.Client** namespace do **cliente de serviço IoT Hub**. Para saber mais sobre as APIs, incluindo as gémeas digitais API, consulte o [guia de desenvolvedores de serviços.](../articles/iot-pnp/concepts-developer-guide-service.md)
