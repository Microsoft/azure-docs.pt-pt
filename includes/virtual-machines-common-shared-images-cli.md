...
Pode partilhar imagens através de subscrições utilizando o Controlo de Acesso Baseado em Papéis (RBAC). Pode partilhar imagens na galeria, definição de imagem ou nível de versão de imagem. Qualquer utilizador que tenha lido permissões para uma versão de imagem, mesmo através de subscrições, poderá implementar um VM utilizando a versão de imagem.
