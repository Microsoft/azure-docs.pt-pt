...
| --- | --- |
| Azure AD Domain Services | [Redes virtuais que contêm serviços de domínio AD Azure](../articles/active-directory-domain-services/migrate-from-classic-vnet.md) |
