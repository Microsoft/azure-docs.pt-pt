...
ms.locfileid: "83860528"
---
* [Autenticação do serviço de aplicações / visão geral da autorização.](../articles/app-service/overview-authentication-authorization.md)
* [Utilização avançada de autenticação e autorização no Serviço de Aplicações Azure](../articles/app-service/app-service-authentication-how-to.md)
* [Tutorial: Autenticar e autorizar utilizadores ponto a ponto no Serviço de Aplicações do Azure](../articles/app-service/app-service-web-tutorial-auth-aad.md)
* Adicione a autenticação à sua Aplicação Móvel: [iOS,][ios-get-started-users] [Android,][android-get-started-users] [Windows Universal,][windows-get-started-users] [Xamarin.Android,][xamarin-android-get-started-users] [Xamarin.iOS,][xamarin-ios-get-started-users] [Xamarin.Forms,][xamarin-forms-get-started-users] [Cordova][cordova-get-started-users].  
