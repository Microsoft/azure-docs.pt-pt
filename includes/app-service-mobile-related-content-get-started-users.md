...
* [Uso avançado da autenticação e autorização no Serviço de Aplicações Azure](../articles/app-service/app-service-authentication-how-to.md)
...
* Adicione autenticação à sua Aplicação Móvel: [iOS][ios-get-started-users], [Android,][android-get-started-users] [Windows Universal,][windows-get-started-users] [Xamarin.Android,][xamarin-android-get-started-users] [Xamarin.iOS,][xamarin-ios-get-started-users] [Xamarin.Forms,][xamarin-forms-get-started-users] [Cordova][cordova-get-started-users].  
