...
- Automatizar a configuração dos VMs
    - As ferramentas incluem [ansible,](#ansible) [chef,](#chef) [marioneta,](#puppet)e [modelo de Gestor de Recursos Azure.](#azure-resource-manager-template)
...
- [Instale e configure terraforma com Azure](/azure/developer/terraform/install-configure).
- [Crie uma infraestrutura Azure com Terraform.](/azure/developer/terraform/create-linux-virtual-machine-with-infrastructure)
...
[Jenkins](https://jenkins.io) é um servidor de integração contínua que ajuda a implementar e testar aplicações, e criar pipelines automatizados para entrega de códigos. Existem centenas de plugins para estender a plataforma core Jenkins, e você também pode integrar-se com muitos outros produtos e soluções através de webhooks. Pode instalar o Jenkins manualmente num VM Azure, executar jenkins dentro de um contentor Docker ou usar uma imagem azure marketplace pré-construída.
...
- [Implementar VMs spot usando um modelo de Gestor de Recursos](../articles/virtual-machines/linux/spot-template.md).
- [Implemente uma máquina virtual Azure utilizando C# e um modelo](../articles/virtual-machines/windows/csharp-template.md)de Gestor de Recursos .
- [Crie uma máquina virtual do Windows a partir de um modelo de Gestor de Recursos](../articles/virtual-machines/windows/ps-template.md).
- [Descarregue o modelo para um VM](../articles/virtual-machines/windows/download-template.md).
- [Crie um modelo de construtor de imagem Azure.](../articles/virtual-machines/linux/image-builder-json.md)
