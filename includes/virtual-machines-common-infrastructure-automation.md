...
- [Instale e configuure Ansível no Linux para utilização com a Azure](../articles/ansible/ansible-install-configure.md).
- [Crie uma máquina virtual Linux.](../articles/ansible/ansible-create-vm.md)
- [Gerir uma máquina virtual Linux.](../articles/ansible/ansible-manage-linux-vm.md)
...
- [Instale o Chef no Windows e crie VMs Azure](../articles/chef/chef-automation.md).
...
- [Experimente um tutorial sobre a configuração de VM automatizada utilizando o cloud-init](../articles/virtual-machines/linux/tutorial-automate-vm-deployment.md).
...
A extensão de script personalizado Azure para [o Linux](../articles/virtual-machines/linux/extensions-customscript.md) ou [Windows](../articles/virtual-machines/windows/extensions-customscript.md) descarrega e executa scripts em VMs Azure. Pode utilizar a extensão quando criar um VM, ou em qualquer momento após a utilização do VM.
...
- [Crie um Linux VM com o CLI Azure e use a extensão de script personalizada.](../articles/virtual-machines/scripts/virtual-machines-linux-cli-sample-create-vm-nginx.md?toc=%2fcli%2fazure%2ftoc.json)
- [Crie um VM do Windows com Azure PowerShell e utilize a extensão de script personalizada](../articles/virtual-machines/scripts/virtual-machines-windows-powershell-sample-create-vm-iis.md?toc=%2fpowershell%2fmodule%2ftoc.json).
...
- [Utilize o Packer para criar uma imagem Linux VM em Azure](../articles/virtual-machines/linux/build-image-with-packer.md).
...
- [Criar um livro de execução PowerShell](../articles/automation/automation-first-runbook-textual-powershell.md).
- [Utilize o Trabalhador de Runbook Híbrido para gerir os recursos no local.](../articles/automation/automation-hybrid-runbook-worker.md)
- [Utilizar a Azure Automation DSC](../articles/automation/automation-dsc-getting-started.md).
...
[Azure Resource Manager](../articles/azure-resource-manager/templates/overview.md) é o serviço de implementação e gestão da Azure. Fornece uma camada de gestão que lhe permite criar, atualizar e eliminar recursos na sua subscrição Azure. Utiliza funcionalidades de gestão, como controlo de acessos, fechaduras e tags, para proteger e organizar os seus recursos após a implantação.

Aprenda a:

- [Implementar VMs spot utilizando um modelo de Gestor de Recursos](../articles/virtual-machines/linux/spot-template.md).
- [Implemente uma máquina virtual Azure utilizando C# e um modelo de Gestor de Recursos](../articles/virtual-machines/windows/csharp-template.md).
- [Crie uma máquina virtual Windows a partir de um modelo de Gestor de Recursos.](../articles/virtual-machines/windows/ps-template.md)
- [Descarregue o modelo para um VM](../articles/virtual-machines/windows/download-template.md).
