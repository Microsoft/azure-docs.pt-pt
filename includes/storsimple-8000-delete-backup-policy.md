...
2. Na listagem tabular das políticas de backup, selecione a política que pretende eliminar. Clique à direita e a partir do menu de contexto, **selecione Delete**.

    ![Selecione uma política de backup para eliminar](./media/storsimple-8000-delete-backup-policy/deletebupol1.png)

3. Ser-lhe-á pedido que confirme. Tenha em mente que a eliminação de uma política de backup irá eliminar todas as cópias de segurança associadas. Clique **em Sim** para apagar.
