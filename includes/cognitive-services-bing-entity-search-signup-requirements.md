...
ms.locfileid: "75383953"
---
## <a name="create-an-azure-resource"></a>Criar um recurso Azure

Comece a utilizar a API de Pesquisa de Entidades Bing através da criação de um dos recursos Azure abaixo.
...
* Criar um recurso de pesquisa de [entidadebing:](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingEntitySearch)
    ...
    * A Bing Entity Search também é oferecida em camadas pagas do [recurso Bing Search v7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7).
