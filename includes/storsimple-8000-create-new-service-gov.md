...
1. Utilize as credenciais da sua conta Microsoft para iniciar sessão no [Portal do Governo microsoft Azure](https://portal.azure.us/).
2. No Portal do **+** Governo, clique e, em seguida, no mercado, clique em **Ver tudo.** Procure o _StorSimple Físico_. Selecione e clique em **Série do Dispositivo Físico do StorSimple** e, em seguida, clique em **Criar**. Alternativamente, no portal do **+** Governo, clique e, em seguida, em **Armazenamento,** clique em **StorSimple Physical Device Series**.
3. No painel **Gestor de Dispositivos do StorSimple**, siga os seguintes passos:
   ...
   4. Forneça uma **Localização** para o serviço. A localização refere-se à região geográfica onde pretende implementar o seu dispositivo. Selecione **USGov Iowa** ou **USGov Virginia**.
