...
Você adquire uma instância de VM reservada com o tamanho Standard_DS4_v2 onde a taxa ou a superfície relativa em comparação com os outros tamanhos nessa série é 8.

- Cenário 1: executar oito VMs de tamanho Standard_DS1_v2 com uma taxa de 1. Seu desconto de reserva se aplica a todas as oito dessas VMs.
- Cenário 2: executar duas VMs de tamanho Standard_DS2_v2 com uma proporção de 2 cada. Além disso, execute uma VM de tamanho Standard_DS3_v2 com uma proporção de 4. A superfície total é 2 + 2 + 4 = 8. Portanto, seu desconto de reserva se aplica a todas as três VMs.
- Cenário 3: execute um Standard_DS5_v2 com uma proporção de 16. Seu desconto de reserva se aplica à metade do custo de computação da VM.
