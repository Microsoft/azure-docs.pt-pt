...
3. Coloque a função de cluster de grupo de disponibilidade offline. Na **Gestor de clusters de ativação pós-falha** sob **funções**, a função com o botão direito e selecione **parar função**.

4. <a name="congroup"></a>Configure o recurso IP para o grupo de disponibilidade.
...
5. <a name = "dependencyGroup"></a>Tornar o recurso do grupo de disponibilidade do SQL Server dependentes no ponto de acesso de cliente.
...
6. <a name="listname"></a>Marca o recurso de ponto de acesso de cliente dependente no endereço IP.
...
7. <a name="setparam"></a>Defina os parâmetros de cluster no PowerShell.
...
8. Colocar a função de cluster de grupo de disponibilidade online. Na **Gestor de clusters de ativação pós-falha** sob **funções**, clique com o botão direito do rato na função e selecione **iniciar função**.
...
2. Com o botão direito **endereço IP**e selecione **propriedades**.

3. Copiar o **nome** do endereço IP. Pode ser `Cluster IP Address`. 

4. <a name="setwsfcparam"></a>Defina os parâmetros de cluster no PowerShell.
