...
1. Selecione **VIRTUAL WAN** a partir dos resultados. Na página Virtual WAN, clique em **Criar**.
1. Na página **Create WAN,** preencha os seguintes campos:
...
4. Depois de preencher os campos, clique em **Criar**.