...
| Size          | vCPU | Memória (GiB) | Disco temporário<sup>1</sup> (GiB) | Discos NVMe<sup>2</sup> | Débito de disco de NVMe<sup>3</sup> (IOPS de leitura / MBps) | Max não colocado em cache o débito de disco de dados (IOPs/MBps)<sup>4</sup> | Discos de dados de máx. | NICs. Máx. / esperado de largura de banda de rede (Mbps) |
|---------------|-----------|-------------|--------------------------|----------------|---------------------------------------------------|-------------------------------------------|------------------------------|------------------------------| 
