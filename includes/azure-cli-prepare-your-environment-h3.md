...
ms.locfileid: "93347399"
---
### <a name="prepare-your-environment-for-the-azure-cli"></a>Prepare o seu ambiente para o CLI do Azure

- Utilize o [Azure Cloud Shell](/azure/cloud-shell/quickstart) com o ambiente do Bash.
