...
3. Em poucos minutos, o site mostrará o estado de ligação e conectividade.
   ...
   **Estado da conectividade:** Este é o estado real de conectividade (caminho de dados) entre a porta VPN da Azure no hub e o VPN Site. Pode mostrar qualquer um dos seguintes estados:
