...
Para obter mais informações sobre como utilizar estas funcionalidades de encriptação, consulte [utilizar o EKM com funcionalidades de encriptação do servidor SQL](https://msdn.microsoft.com/library/dn198405.aspx#UsesOfEKM).
