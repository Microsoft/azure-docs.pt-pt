...
### <a name="is-file-transfer-supported-with-azure-bastion-rdp-session"></a><a name="filetransfer"></a>A transferência de ficheiros é suportada com a sessão do RdP do Bastião Azure?
