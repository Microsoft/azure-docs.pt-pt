...
2. Selecione **o dispositivo Reset**.
    ...
    ![Repor dispositivo](media/azure-stack-edge-device-reset/device-reset-1.png)

3. Quando solicitado para confirmação, reveja o aviso e selecione **Sim** para continuar.

    ![Confirmar reset](media/azure-stack-edge-device-reset/device-reset-2.png)  
