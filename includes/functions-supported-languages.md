...
|Idioma                                 |1.x         |2.x| 3.x |
|-----------------------------------------|------------|---| --- |
|[C #](../articles/azure-functions/functions-reference-csharp.md)|GA (.quadro 4.7)|GA (.NET Core 2.2)| GA (.NET Core 3.1) |
|[JavaScript](../articles/azure-functions/functions-reference-node.md#node-version)|GA (Nó 6)|GA (Nó 8 & 10)| GA (Nó 10 & 12) |
...
<sup>1</sup> Suportado através da transposição para javaScript.

Para obter informações sobre alterações planeadas no suporte linguístico, consulte o [roteiro do Azure.](https://azure.microsoft.com/roadmap/?tag=functions)
