...
| Diagnóstico | [Métricas multidimensionais do Monitor Azure](../articles/load-balancer/load-balancer-standard-diagnostics.md) | [Registos do Monitor Azure](../articles/load-balancer/load-balancer-monitor-log.md) |
