...
ms.locfileid: "67184158"
---
## <a name="create-an-azure-storage-account"></a>Criar uma conta de armazenamento do Azure
A forma mais fácil de criar a sua primeira conta de armazenamento Azure é utilizando o [Portal Azure.](https://portal.azure.com) Para saber mais, veja [Criar uma conta de armazenamento](https://docs.microsoft.com/azure/storage/common/storage-quickstart-create-account).
