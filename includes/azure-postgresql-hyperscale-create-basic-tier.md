...
4. Preencha o formulário com os detalhes do novo servidor com as seguintes informações:
   ...
   - Ativar a caixa de **verificação, ativar as funcionalidades de pré-visualização**.
...
5. Clique **no grupo de servidores Configure**.
   - Selecione o botão de rádio **Básico** para o **Tier**.
   - Clique em **Guardar**.
