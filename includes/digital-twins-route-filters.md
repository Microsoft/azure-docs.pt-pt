...
| Verdadeiro / Falso | Permite criar uma rota sem filtragem, ou desativar uma rota | `<true/false>` | `true`= rota está ativada sem filtragem <br> `false`= rota é desativada |
