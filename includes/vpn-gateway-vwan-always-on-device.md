...
1. Copie o texto que se segue e guarde-o como ***devicecert.ps1***.
   ...
   Write-Host "$Message"
   ```
1. Copie o texto que se segue e guarde-o como ***VPNProfile.xml** _ na mesma pasta que _*devicecert.ps1**. Edite o seguinte texto para combinar com o seu ambiente.
