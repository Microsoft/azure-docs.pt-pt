...
## <a name="create-a-subscription-to-the-topic"></a>Criar uma subscrição para o tópico
...
3. Sobre o **criar subscrição** página, introduza um **nome** para a subscrição e, em seguida, selecione **criar**. 
