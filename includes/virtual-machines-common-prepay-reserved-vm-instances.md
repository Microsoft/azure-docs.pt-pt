...
O seu ficheiro de utilização mostra os seus encargos por período de faturação e uso diário. Para obter informações sobre o download do seu ficheiro de utilização, consulte [Ver e descarregue o seu uso e custos Azure](../articles/cost-management-billing/understand/download-azure-daily-usage.md). Em seguida, utilizando as informações do ficheiro de utilização, pode [determinar qual a reserva a comprar.](../articles/cost-management-billing/reservations/determine-reservation-purchase.md)
...
|Otimizar para     |A flexibilidade do tamanho da instância VM é selecionada por padrão. Clique **em definições avançadas** para alterar o valor de flexibilidade do tamanho da instância para aplicar o desconto de reserva a outros VMs no mesmo [grupo de tamanho VM](../articles/virtual-machines/windows/reserved-vm-instance-size-flexibility.md). A prioridade de capacidade prioriza a capacidade de datacenter das implementações. Oferece confiança adicional na sua capacidade de lançar as instâncias VM quando precisa delas. A prioridade da capacidade só está disponível quando o âmbito de reserva é uma subscrição única. |
...
Para obter mais informações sobre como os descontos de reserva aparecem nos dados de utilização, consulte [o uso da reserva Understand Azure para a sua inscrição na Enterprise](../articles/cost-management-billing/reservations/understand-reserved-instance-usage-ea.md) se for cliente da EA. Se tiver uma subscrição individual, consulte [o uso da reserva Understand Azure para a sua subscrição Pay-As-You-Go](../articles/cost-management-billing/reservations/understand-reserved-instance-usage.md).
...
- Para saber mais sobre as Reservas do Azure, veja os seguintes artigos:
    ...
    - [Compreender como o desconto das reservas é aplicado](../articles/cost-management-billing/manage/understand-vm-reservation-charges.md)
