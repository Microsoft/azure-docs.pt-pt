...
ms.locfileid: "87311551"
---
> [!IMPORTANT]
> MSAL.js 2.0 não suporta atualmente o Azure AD B2C para utilização com o fluxo de código de autorização PKCE. Neste momento, o Azure AD B2C recomenda a utilização do fluxo implícito descrito no [Tutorial: Registe uma aplicação][implicit-flow]. Para acompanhar os progressos nesta questão, consulte o [MSAL.js wiki][msal-wiki].
