...
1. Para **o URL de resposta,** insira um ponto final onde o Azure AD B2C deve devolver quaisquer fichas que a sua aplicação solicite. Neste tutorial, a amostra corre localmente e `https://localhost:5000`ouve.
1. Para **o ID da aplicação URI,** adicione um identificador de ponto final da API ao URI mostrado. Para este tutorial, entre, `api`para que o `https://contosob2c.onmicrosoft.com/api`URI completo seja semelhante a .
1. Selecione **Criar**.
...
1. Em **Redirecione o URI**, selecione **Web**e, em seguida, introduza um ponto final onde o Azure AD B2C deve devolver quaisquer fichas que a sua aplicação solicite. Neste tutorial, a amostra corre localmente e `http://localhost:5000`ouve.
