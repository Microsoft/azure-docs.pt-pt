...
Se tiver concluído o [Quickstart: Conecte uma aplicação de dispositivo IoT Plug e Play com amostras em funcionamento no Linux ou Windows para IoT Hub (C)](../articles/iot-pnp/quickstart-connect-device.md) já descarregou o código.
...
1. O Visual Studio abre o *launch.vs.jsem* arquivo. Edite este ficheiro como mostrado no seguinte corte para definir as variáveis ambientais necessárias. Fez uma nota da chave principal de ID e inscrição quando completou [Configurar o seu ambiente para os quickstarts e tutoriais do IoT Plug and Play:](../articles/iot-pnp/set-up-environment.md)
...
1. Clique com o botão direito no ficheiro *pnp_temperature_controller.c* e selecione **Definir como Ponto de Arranque**.
