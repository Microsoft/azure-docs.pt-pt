...
ms.locfileid: "75382863"
---
## <a name="create-an-azure-resource"></a>Criar um recurso Azure

Comece a utilizar a API bing spell check criando um dos recursos Azure abaixo.

* [Criar um recurso experimental:](https://azure.microsoft.com/try/cognitive-services/?api=spellcheck-api-v7)
...
* [Crie um recurso de verificação de feitiços de Bing:](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7)
    ...
    * A API bing spell check também é oferecida em alguns níveis do [recurso Bing Search v7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7).
