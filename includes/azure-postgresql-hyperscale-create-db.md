...
3. Para a opção de implantação, clique no botão **criar** em **hiperescala (Citus) grupo de servidores-visualização.**
...
6. Clique em **Seguinte: Rede >** na parte inferior da tela.
