...
| Número máximo de unidades de análise (UA) por conta |250 | Utilizar qualquer combinação das até um máximo de 250 AUs em 20 tarefas. Para aumentar este limite, contacte Support da Microsoft. |
| Tamanho máximo de script para a submissão da tarefa | 3 MB | |
| Número máximo de contas do Data Lake Analytics por região por subscrição | 5 | Para aumentar este limite, contacte Support da Microsoft. |
