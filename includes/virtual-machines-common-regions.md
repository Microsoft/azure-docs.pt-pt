...
Você cria recursos do Azure em regiões geográficas definidas como ' oeste dos EUA ', ' Europa Setentrional ' ou ' sudeste asiático '. Pode rever a [lista de regiões e as respetivas localizações](https://azure.microsoft.com/regions/). Dentro de cada região, existem vários datacenters para fornecer redundância e disponibilidade. Essa abordagem oferece flexibilidade à medida que você projeta aplicativos para criar VMs mais próximas de seus usuários e para atender a qualquer finalidade jurídica, de conformidade ou de imposto.

## <a name="special-azure-regions"></a>Regiões do Azure especiais
O Azure tem algumas regiões especiais que você talvez queira usar ao criar seus aplicativos para fins de conformidade ou legais. Estas regiões especiais incluem:
...
**Managed Disks do Azure**
* Os Managed Disks Premium são apoiados por unidades de estado sólido (SSDs) e os Managed Disks padrão são apoiados por discos de rotação regular. Os Managed Disks Premium e os Standard são carregados com base na capacidade de aprovisionamento do disco.

**Discos não geridos**
* O armazenamento Premium é apoiado por SSDs (unidades de estado sólido) e é cobrado com base na capacidade do disco.
