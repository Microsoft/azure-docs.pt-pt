...
1. Selecione **Criar**.
    ...
    :::image type="content" source="./media/iot-central-video-analytics-part2/new-application.png" alt-text="Configure Azure A D app para Azure Media Services":::
...
:::image type="content" source="./media/iot-central-video-analytics-part2/administration.png" alt-text="Configure Azure A D app para Azure Media Services":::

Selecione **Tokens API** e gere um novo token chamado **LVAEdgeToken** para o papel **de Operador:**

:::image type="content" source="./media/iot-central-video-analytics-part2/token.png" alt-text="Configure Azure A D app para Azure Media Services":::
