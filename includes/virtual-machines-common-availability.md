...
|----|----|----|
| Modelo de configuração de VM| Nenhum. VirtualMachineProfile é indefinido no modelo do conjunto de dimensionamento. | Necessário. VirtualMachineProfile é populado no modelo de conjunto de dimensionamento. |
