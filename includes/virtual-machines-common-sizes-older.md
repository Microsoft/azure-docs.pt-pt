...
| Tamanho | vCPU | Memória: GiB | Armazenamento (HDD) temporário: GiB | Máximo de discos de dados | Débito máximo do disco de dados: IOPS | Máximo de NICs/largura de banda de rede esperada (Mbps)  |
| --- | --- | --- | --- | --- | --- | --- |
...
| Tamanho | vCPU | Memória: GiB | Armazenamento (HDD) temporário: GiB | Máximo de discos de dados | Débito máximo do disco de dados: IOPS | NICs máximos|
| --- | --- | --- | --- | --- | --- | --- |
...
| Tamanho          | vCPU | Memória (GiB) | Armazenamento temporário (GiB) | Máximo de discos de dados | Taxa de transferência máxima do armazenamento temporário (IOPS/MBps) | Taxa de transferência máxima do disco não armazenado em cache (IOPS/MBps) | Máximo de NICs/largura de banda de rede esperada (Mbps) | 
|----------------|-----------|-------------|--------------------------|----------------|-------------------------------------------------------------|-------------------------------------------|------------------------------| 
