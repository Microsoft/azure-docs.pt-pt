...
| Source | Portas de origem | Destino | Etiqueta do serviço de destino | Portas de destino | Protocol | Action |
| --- | --- | --- | --- | --- | --- | --- |
| Any | * | [Etiqueta de serviço](../articles/virtual-network/security-overview.md#service-tags) | `Storage`(na mesma região que sua conta do lote e VNet) | 443 | TCP | Allow |
...
| Endereços IP de origem | Portas de origem | Destino | Portas de destino | Protocol | Action |
| --- | --- | --- | --- | --- | --- |
Any <br /><br />Apesar de isto necessitar efetivamente de "permitir todos", o serviço Batch aplica uma regra ACL ao nível de cada nó que filtra todos os endereços IP de serviço não pertencentes ao Batch. | * | Any | 10100, 20100, 30100 | TCP | Allow |
| Opcional, para permitir o acesso RDP a nós de computação. | * | Any | 3389 | TCP | Allow |

**Regras de segurança de saída**

| Source | Portas de origem | Destino | Portas de destino | Protocol | Action |
| --- | --- | --- | --- | --- | --- |
