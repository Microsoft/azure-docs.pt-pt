...
Consulte [a saúde do Monitor do Log Analytics no Monitor Azure](../articles/azure-monitor/logs/monitor-workspace.md) para criar regras de alerta para ser notificado proactivamente quando atingir quaisquer limites de ingestão.

>[!NOTE]
>Dependendo do tempo que usa o Log Analytics, poderá ter acesso a níveis de preços antigos. Saiba mais sobre [os níveis de preços do legado Log Analytics](../articles/azure-monitor/logs/manage-cost-storage.md#legacy-pricing-tiers).