...
Na Cloud Shell, podes usar o [`az webapp create`](/cli/azure/webapp#az_webapp_create) comando. No exemplo a seguir, substitua `<app-name>` com um nome de aplicação globalmente exclusivo (os carateres válidos são `a-z`, `0-9` e `-`). 
