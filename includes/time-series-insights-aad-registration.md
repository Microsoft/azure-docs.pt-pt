...
1. Dar à aplicação um nome e selecionar **Contas neste diretório organizacional apenas** para especificar os **tipos de conta suportado** que podem aceder à API. Escolha um URI válido para redirecionar os utilizadores para depois de autenticarem e, em seguida, **registar-se**.
