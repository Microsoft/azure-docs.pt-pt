...
A partir do menu do portal Azure ou página **Inicial,** selecione **grupos de Recursos**, e na página **de grupos de recursos,** selecione **myResourceGroup**.
