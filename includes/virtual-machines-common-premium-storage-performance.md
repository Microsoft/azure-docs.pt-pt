...
* Para que as etiquetas de volume persistam após o reinício do VM, tem de atualizar /etc/fstab com as referências universalmente únicas do identificador (UUID) aos discos. Para obter mais informações, consulte [Adicionar um disco gerido a um Linux VM](../articles/virtual-machines/linux/add-disk.md).
