...
ms.locfileid: "91360701"
---
1. Inicie sessão no [Portal do Azure](https://portal.azure.com).
 
2. Faça uma pesquisa em **Gestão de Custos + Faturação** .
 
   ![Captura de ecrã que mostra uma pesquisa do portal do Azure por Cost Management + Faturação.](./media/billing-check-account-type/billing-search-cost-management-billing.png)    
