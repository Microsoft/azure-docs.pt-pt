...
![Janela de definições de criação do Unity](./media/spatial-anchors-unity/unity-ios-build-settings.png)
...
Baixe [Unity ARKit Plug-in na versão 2.0.0](https://bitbucket.org/Unity-Technologies/unity-arkit-plugin/get/v2.0.0.zip) e extraia o arquivo.
