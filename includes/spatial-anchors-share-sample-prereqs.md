...
* Um ou mais dispositivos (iOS ou Android) para implementar e executar uma aplicação.
  * Se estiver a usar o Android, precisa de ter:
    * <a href="https://developer.android.com/studio/" target="_blank">Android Studio 3.3</a> ou mais tarde, <a href="https://unity3d.com/get-unity/download" target="_blank">Unity 2019.1 ou 2019.2</a>- e <a href="https://git-scm.com/download/win" target="_blank">Git para Windows</a> instalado no seu computador Windows.
    * Um dispositivo Android <a href="https://developer.android.com/studio/debug/dev-options" target="_blank">ativado por desenvolvedore</a> e <a href="https://developers.google.com/ar/discover/supported-devices" target="_blank">capaz de ARCore.</a>
