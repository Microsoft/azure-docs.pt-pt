...
ms.locfileid: "60713529"
---
A tabela seguinte lista os atributos de vinculação que estão disponíveis num projeto de biblioteca de classe de funções do Azure e o acionador. Todos os atributos estão no namespace `Microsoft.Azure.WebJobs`.
