...
ms.locfileid: "100551391"
---
O NFS é suportado em **todas as** regiões onde o Armazenamento de Ficheiros Premium está disponível.

Estamos continuamente a adicionar regiões. Para a lista mais atualizada, utilize a amostra abaixo para consultar a lista de regiões com suporte NFS. Também pode verificar o suporte da sua região na [Azure Products disponível por página da região](https://azure.microsoft.com/global-infrastructure/services/?products=storage&regions=all) no **âmbito do Armazenamento de Ficheiros Premium.**
