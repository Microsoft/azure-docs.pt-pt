...
- Para obter uma visão geral da configuração do dispositivo VPN, consulte a [visão geral da configuração do dispositivo VPN](../articles/vpn-gateway/vpn-gateway-3rdparty-device-config-overview.md).
