...
- Para uma descrição geral da configuração do dispositivo VPN, consulte [descrição geral de configuração do dispositivo VPN](../articles/vpn-gateway/vpn-gateway-3rdparty-device-config-overview.md).
