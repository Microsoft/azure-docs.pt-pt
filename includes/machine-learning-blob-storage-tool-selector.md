...
ms.locfileid: "96027391"
---
<!-- Guidance on technologies used to move data to and/or from Azure Blob storage are linked here:
-->
Este menu liga-se a tecnologias que pode utilizar para mover dados de e para o armazenamento da Azure Blob:

> [!div class="op_single_selector" title1="Ferramentas de armazenamento blob"]
