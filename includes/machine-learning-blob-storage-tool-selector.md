...
ms.locfileid: "61044359"
---
<!-- Guidance on technologies used to move data to and/or from Azure Blob storage are linked here:
-->
Este links de menu para tecnologias que podem ser usadas para mover dados para e do armazenamento de Blobs do Azure:
...
> * [Explorador de armazenamento do Azure](../articles/machine-learning/team-data-science-process/move-data-to-azure-blob-using-azure-storage-explorer.md)
