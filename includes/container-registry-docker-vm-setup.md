...
Siga os passos na [Instalação Azure CLI com apta](/cli/azure/install-azure-cli-apt?view=azure-cli-latest) a instalar o CLI Azure na sua máquina virtual Ubuntu. Por exemplo:
