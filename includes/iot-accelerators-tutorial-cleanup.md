...
![Eliminar solução](media/iot-accelerators-tutorial-cleanup/deletesolution.png)

![Eliminar solução](media/iot-accelerators-tutorial-cleanup/deletesolution-provision.png)