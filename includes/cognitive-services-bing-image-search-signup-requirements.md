...
ms.locfileid: "85603281"
---
## <a name="create-an-azure-resource"></a>Criar um recurso Azure

Comece a utilizar a API de Pesquisa de Imagem Bing criando um dos seguintes recursos Azure.

### <a name="bing-search-v7-resource"></a>[Bing Search v7 recurso](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7)
