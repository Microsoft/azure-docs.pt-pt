...
## <a name="cli"></a>Interface de linha de comando Azure (CLI)
...
## <a name="arm-model"></a>Modelo de implementação do Gestor de Recursos Azure
...
## <a name="sla"></a>acordo de nível de serviço (SLA)
