---
title: Enviar mensagens para um servidor MQTT usando a biblioteca de cliente MQTT do Azure | Microsoft Docs
description: Usar o DevKit como um cliente para enviar mensagens para um servidor MQTT
author: liydu
manager: jeffya
ms.service: iot-hub
services: iot-hub
