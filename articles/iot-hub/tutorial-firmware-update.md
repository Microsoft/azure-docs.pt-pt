---
title: Tutorial - Atualizar o firmware do dispositivo através do Azure IoT Hub | Microsoft Docs
description: Tutorial - Saiba como implementar um processo de atualização de firmware do dispositivo que pode ser desencadeado a partir de uma aplicação de back-end ligada ao seu hub IoT.
services: iot-hub
author: wesmc7777
ms.author: wesmc
ms.service: iot-hub
...
Cria uma [configuração automática](iot-hub-automatic-device-management.md#create-a-configuration) de gestão de dispositivos na aplicação back-end para iniciar o processo de atualização de firmware em todos os dispositivos marcados com um tipo de **dispositivo** de refrigeração. Nesta secção, saberá como:
