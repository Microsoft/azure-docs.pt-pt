...
Por exemplo, de soluções completas de ponta a ponta que utilizam o Hub IoT, consulte a Documentação de [Aceleradores de Solução IoT Azure](/azure/iot-accelerators).
