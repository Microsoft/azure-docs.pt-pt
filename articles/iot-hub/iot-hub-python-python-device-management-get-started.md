...
3. Adicione as instruções de `import` a seguir ao início do arquivo **dmpatterns_getstarted_device. py** .
...
3. Adicione as instruções de `import` a seguir ao início do arquivo **dmpatterns_getstarted_service. py** .
