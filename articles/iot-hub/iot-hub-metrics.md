...
|EventGridDeliveries|Entregas de grelha de eventos (pré-visualização)|Contagem|Total|O número de pedidos para o IoT Hub emitir eventos para o Event Grid. Este número inclui pedidos com êxito ou falhados. Utilize a dimensão de resultado para o número de tipos de resposta diferente. Para ver de onde os pedidos são provenientes, utilize a dimensão de EventType.|Resultado, EventType|
