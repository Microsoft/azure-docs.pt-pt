...
Para remover o grupo de recursos, utilize o comando [az group delete](/cli/azure/group#az_group_delete). Lembre-se que `$resourceGroup` foi definido para **ContosoResourcesMsgEn** no início deste tutorial.
