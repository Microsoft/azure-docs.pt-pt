...
Nesta secção, utilizará o Azure Cloud Shell com a [extensão IoT](/cli/azure/iot) para monitorizar as mensagens do dispositivo que são enviadas pelo dispositivo Android.
