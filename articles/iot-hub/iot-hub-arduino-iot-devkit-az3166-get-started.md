...
1. Instale o [ARDUINO IDE](https://www.arduino.cc/en/Main/Software). Ele fornece o ferramentas necessário para compilar e carregar o código Arduino.
    ...
    * **Ubuntu**: Descompacte-o em uma pasta como `$HOME/Downloads/arduino-1.8.8`
...
6. Clique em `F1` para abrir a paleta de comandos, digite e selecione **Arduino: gerente de placa**. Procure **AZ3166** e instale a versão mais recente.
...
1. Em VS Code, clique em `F1`, digite e selecione **Hub IOT do Azure: definir a cadeia de conexão do Hub IOT**. Copie a cadeia de conexão nela.
