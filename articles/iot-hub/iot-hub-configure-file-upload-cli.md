...
* Um centro de IoT Azure. Se não tiver um hub IoT, pode usar o [ `az iot hub create` comando](https://docs.microsoft.com/cli/azure/iot/hub#az-iot-hub-create) para criar um ou [criar um hub IoT utilizando o portal](iot-hub-create-through-portal.md).

* Uma conta do Armazenamento do Azure. Se não tiver uma conta de Armazenamento Azure, pode usar o CLI Azure para criar uma. Para obter mais informações, veja [Criar uma conta de armazenamento](../storage/common/storage-create-storage-account.md).
