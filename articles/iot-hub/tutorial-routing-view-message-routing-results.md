...
Para remover o grupo de recursos, utilize o comando [az group delete](/cli/azure/group#az-group-delete). `$resourceGroup` foi definido para **ContosoResources** de volta no início deste tutorial.
