...
8. Existem três formas de gerar um certificado de verificação:
    ...
    * Se estiver a utilizar o OpenSSL para gerar os seus certificados, tem primeiro de gerar uma chave privada e um pedido de assinatura de certificado (CSR):
