...
Para criar um ponto final de encaminhamento, utilize [o ponto final de encaminhamento do hub az iot](/cli/azure/iot/hub/routing-endpoint#az_iot_hub_routing_endpoint_create). Para criar a rota de mensagem para o ponto final, utilize [a rota az iot hub create](/cli/azure/iot/hub/route#az_iot_hub_route_create).
