...
Para criar um ponto final de encaminhamento, utilize [o ponto final de encaminhamento do hub az iot](/cli/azure/iot/hub/routing-endpoint#az-iot-hub-routing-endpoint-create). Para criar a rota de mensagem para o ponto final, utilize [a rota az iot hub create](/cli/azure/iot/hub/route#az-iot-hub-route-create).
