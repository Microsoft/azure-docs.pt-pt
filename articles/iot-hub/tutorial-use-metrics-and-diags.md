...
O IoT Hub ainda não foi migrado para as [métricas no Azure Monitor;](../azure-monitor/platform/data-platform.md#metrics) você tem que usar [alertas clássicos.](../azure-monitor/platform/alerts-classic.overview.md)
