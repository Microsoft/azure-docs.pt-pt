---
title: Gerir a conectividade IoT Hub e mensagens fiáveis c/dispositivo SDKs
...
* [SDK do nó](https://github.com/Azure/azure-iot-sdk-node/wiki/Connectivity-and-Retries#types-of-errors-and-how-to-detect-them)
...
### <a name="retry-policy-apis"></a>APIs de política de retry
   ...
   | Python| Não atualmente apoiado | Não atualmente apoiado | Não atualmente apoiado |
...
O mecanismo de retry para após `DefaultOperationTimeoutInMilliseconds`, que está atualmente definido em 4 minutos.
