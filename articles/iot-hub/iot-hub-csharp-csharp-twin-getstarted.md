...
* **CreateDeviceIdentity**. Esta aplicação cria uma identidade do dispositivo e uma chave de segurança associada para ligar a sua aplicação de dispositivo simulado.
