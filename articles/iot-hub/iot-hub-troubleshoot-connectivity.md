...
1. Selecione **adicionar condição**, em seguida, selecione "Ligar os dispositivos (pré-visualização)".
1. Conclua a configuração de seu limiares pretendidos e os alertas opções por seguintes prompts.
