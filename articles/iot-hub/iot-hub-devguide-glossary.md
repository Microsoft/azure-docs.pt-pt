...
O [Azure IoT Explorer](https://github.com/Azure/azure-iot-explorer) é utilizado para visualizar a telemetria que o dispositivo está a enviar, trabalhar com propriedades do dispositivo e comandos de chamada. Também pode utilizar o explorador para interagir e testar os seus dispositivos, e para gerir os dispositivos plug e play.
...
O explorador do dispositivo foi substituído pelo [Explorador Azure IoT,](https://github.com/Azure/azure-iot-explorer)que é utilizado para visualizar a telemetria que o dispositivo está a enviar, trabalhar com propriedades do dispositivo e comandos de chamada. Também pode utilizar o explorador para interagir e testar os seus dispositivos, e para gerir os dispositivos plug e play.
