...
| Ativação pós-falha manual |10 min-2 horas|Consulte a tabela de RPO acima|Sim|Muito baixo. Você só precisa disparar essa operação no Portal.|Nenhum|
