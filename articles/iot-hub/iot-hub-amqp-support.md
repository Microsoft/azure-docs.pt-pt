...
ms.locfileid: "67055377"
---
# <a name="communicate-with-your-iot-hub-by-using-the-amqp-protocol"></a>Comunicar com IoT hub, utilizando o protocolo AMQP

O IoT Hub do Azure suporta [OASIS Advanced Message Queuing Protocol (AMQP) versão 1.0](http://docs.oasis-open.org/amqp/core/v1.0/os/amqp-core-complete-v1.0-os.pdf) fornecer uma variedade de funcionalidades através de pontos finais com acesso de dispositivo e voltado para o serviço. Este documento descreve a utilização de clientes AMQP para ligar a um hub IoT para usar a funcionalidade do IoT Hub.
