...
## <a name="solutions-for-azure-kubernetes-service-aks"></a>Soluções para o serviço kubernetes do Azure (AKS)

[Integração do Azure NetApp Files com o AKS](https://github.com/andyzhangx/demo/tree/master/linux/nfs)

## <a name="solutions-for-oracle-database"></a>Soluções para banco de dados Oracle
...
## <a name="solutions-for-sap-applications"></a>Soluções para aplicativos SAP
