...
---
# <a name="benefits-of-using-azure-netapp-files-with-windows-virtual-desktop"></a>Benefícios da utilização de ficheiros Azure NetApp com desktop virtual do Windows 
