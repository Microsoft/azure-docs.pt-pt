...
- `--dbsid <SAP HANA SID>` é o SAP HANA SID sendo selecionado a partir do ficheiro de configuração para aplicar os comandos de restauro de volume para.
