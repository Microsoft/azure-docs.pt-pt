---
title: SDKs de ficheiros NetApp do Azure | Documentos da Microsoft
description: Lista os SDKs suportados pelo Azure NetApp ficheiros.
...
ms.locfileid: "65957884"
---
# <a name="azure-netapp-files-sdks"></a>SDKs do Azure NetApp Files

Este artigo lista os SDKs suportados pelo Azure NetApp ficheiros.

## <a name="supported-sdks"></a>SDKs suportados 

A tabela abaixo lista os SDKs suportados.  Pode encontrar detalhes sobre os SDKs suportados nas respetivas localizações publicados no GitHub.  

|    Idioma    |    SDK publicado localização    |
|------------------|--------------------------------------------------------------------------------------------|
...
## <a name="next-steps"></a>Passos Seguintes   
 [Transferir SDKs do Azure](https://azure.microsoft.com/downloads/)
