...
* **Autenticação do Diretório Ativo Azure:** Obtenha o ID de aplicação da Aplicação Empresarial Azure VPN registado no seu inquilino AZure AD, [o emitente,](https://sts.windows.net/your-Directory-ID/)e [o inquilino da AD Azure.](https://login.microsoftonline.com/your-Directory-ID)
...
O exemplo a seguir mostra a autenticação do certificado Azure.
