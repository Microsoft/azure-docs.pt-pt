...
- O utilizador SAP que está a ser utilizado no conector de tabela DATA Factory SAP deve ter as seguintes permissões:
  ...
  - Permissões à atividade executante do S_SDSAUTH objeto de autorização, ou permissões à atividade executar do S_RFC: FUGR - RFC1, SYST, SYSU FUNC - RFCPING, RFC_FUNCTION_SEARCH actvt – 16 objeto de autorização. 
