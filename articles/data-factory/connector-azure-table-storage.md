---
title: Copiar dados de e para o armazenamento de tabelas do Azure usando Data Factory | Microsoft Docs
...
| Propriedade | Descrição | Necessário |
|:--- |:--- |:--- |
| type | A propriedade Type do coletor da atividade de cópia deve ser definida como **AzureTableSink**. |Sim |
