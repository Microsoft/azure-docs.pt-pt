...
| Runtime de Integração |Único com uma fábrica de dados. Os nomes são insensíveis a casos. |<ul><li>Integração tempo de execução O nome pode conter apenas letras, números e o caráter traço (-) do caráter.</li><li>O primeiro e último caracteres deve ser uma letra ou número. Cada traço (-) caracteres deve ser imediatamente precedido e seguido por uma letra ou um número.</li><li>Traços consecutivos não são permitidos em nome de execução de integração. </li></ul> |
