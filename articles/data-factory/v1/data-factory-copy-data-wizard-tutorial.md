...
5. Na página **Escolher o ficheiro ou pasta de entrada**:
   ...
   2. Selecione **emp.txt** e clique em **Escolher**
      ...
      ![A screenshot mostra a opção Escolher para o seu ficheiro de entrada.](./media/data-factory-copy-data-wizard-tutorial/copy-tool-choose-input-file-or-folder.png)
6. Na página **Escolher o ficheiro ou pasta de entrada**, clique em **Seguinte**. Não selecione **Cópia binária**. 
   
    ![A screenshot mostra a opção de cópia Binary para a sua entrada.](./media/data-factory-copy-data-wizard-tutorial/chose-input-file-folder.png) 
...
12. Na página **Definições de desempenho**, clique em **Seguinte**. 
    ...
    ![A screenshot mostra a página de definições de desempenho onde pode selecionar Seguinte.](./media/data-factory-copy-data-wizard-tutorial/performance-settings.png)
13. Reveja as informações na página **Resumo** e clique em **Concluir**. O assistente cria dois serviços ligados, dois conjuntos de dados (entrada e saída) e um pipeline na fábrica de dados (a partir da qual iniciou o Assistente de Cópia). 
    ...
    ![A screenshot mostra a página Resumo onde pode selecionar Seguinte.](./media/data-factory-copy-data-wizard-tutorial/summary-page.png)
