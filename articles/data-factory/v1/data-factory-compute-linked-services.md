...
Pode criar um serviço ligado ao Armazém de Dados SQL e usá-lo com a [Atividade de Procedimento Armazenado](data-factory-stored-proc-activity.md) para invocar um procedimento armazenado a partir de um oleoduto data factory. Para mais informações, consulte [o conector Azure SQL Data Warehouse](data-factory-azure-sql-data-warehouse-connector.md#linked-service-properties).
