...
* `s3:ListBucket`para amazon S3 Bucket Operations. Se estiver a utilizar o `s3:ListAllMyBuckets` Assistente de Cópia da Fábrica de Dados, também é necessário.
