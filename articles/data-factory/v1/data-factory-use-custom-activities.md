...
1. Criar uma **conta do Azure Batch** utilizando o [portal do Azure](https://portal.azure.com). Ver [criar e gerir uma conta do Azure Batch] [ batch-create-account] artigo para obter instruções.
