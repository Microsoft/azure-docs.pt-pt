...
4. Se escolher **a configuração manual:**
    ...
    2. Utilize a chave de **autenticação** da página **Configure** para registar o gateway.
        ...
        ![Data Management Gateway - instalação bem sucedida](media/data-factory-data-management-gateway-high-availability-scalability/data-factory-gateway-authentication-key.png)
...
- Os certificados wild card são suportados. Se o seu nome FQDN for **node1.domain.contoso.com,** pode utilizar ***.domain.contoso.com** como nome de assunto do certificado.
