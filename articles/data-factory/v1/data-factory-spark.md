...
> * [Atividade de recurso de atualização de aprendizagem automática](data-factory-azure-ml-update-resource-activity.md)
...
| ---- | ----------- | -------- | ---- |
| . | O caminho principal do trabalho spark no serviço ligado ao armazenamento. | Yes | Pasta |
