...
Suponha que o conjunto de dados da amostra seja utilizado como saída de uma atividade de cópia, a atividade de cópia comprime os dados de saída com o codec GZIP utilizando a relação ideal e, em seguida, escreva os dados comprimidos num ficheiro denominado pagecounts.csv.gz no Azure Blob Storage.
...
* Leia .zip ficheiro do servidor FTP, descomprimir os ficheiros para obter os ficheiros dentro e colocar esses ficheiros na Azure Data Lake Store. Você define um conjunto de dados FTP de entrada com a `compression` `type` propriedade JSON como ZipDeflate.
