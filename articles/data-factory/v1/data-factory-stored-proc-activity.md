...
| nome de procedure armazenado |Especifique o nome do procedimento armazenado na Base de Dados Azure SQL, Azure SQL Data Warehouse ou SQL Server que é representado pelo serviço ligado que a tabela de saída utiliza. |Yes |
