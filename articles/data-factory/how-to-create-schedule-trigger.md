...
1. Na página **Novo Gatilho,** faça os seguintes passos: 
    ...
    1. Especifique o fuso horário em que o gatilho será criado. A definição do fuso horário será aplicada à **Data de Início,** **Data de Fim** e **Horários de Execução** em opções avançadas de recorrência. A alteração da definição do Fuso Horário não altera automaticamente a data de início. Certifique-se de que a Data de Início está correta no fuso horário especificado
