...
|:--- |:--- |:--- |
| type | A propriedade de tipo tem de ser definida como: **Greenplum** | Sim |
...
| Propriedade | Descrição | Necessário |
|:--- |:--- |:--- |
| type | A propriedade de tipo do conjunto de dados deve ser definida como: **GreenplumTable** | Sim |
...
| Propriedade | Descrição | Necessário |
|:--- |:--- |:--- |
| type | A propriedade de tipo de origem de atividade de cópia tem de ser definida: **GreenplumSource** | Sim |
