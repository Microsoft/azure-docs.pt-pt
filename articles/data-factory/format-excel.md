...
| nome de folhaName        | O nome da folha de cálculo do Excel para ler dados.                       | Especificar `sheetName` ou `sheetIndex` |
| sheetIndex | O índice da folha de cálculo do Excel para ler dados, a partir de 0. | Especificar `sheetName` ou `sheetIndex` |
