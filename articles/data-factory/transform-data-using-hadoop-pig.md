---
title: Transformar dados usando a atividade Pig do Hadoop no Azure Data Factory
...
| autor             | Especifique parâmetros como pares de chave/valor para referência no script Pig. | Não       |
