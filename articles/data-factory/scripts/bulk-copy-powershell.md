...
Esta amostra de script PowerShell copia dados de várias tabelas na Base de Dados Azure SQL para Azure Synapse Analytics (anteriormente SQL Data Warehouse).
