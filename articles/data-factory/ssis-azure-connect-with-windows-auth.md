...
O resto deste artigo descreve como configurar o catálogo SSIS (SSISDB) hospedado na Base de Dados SQL/SQL Managed Instance para executar pacotes no Ir Azure-SSIS que utilizam a autenticação do Windows para aceder a lojas de dados. 
...
1. Com o SQL Server Management Studio (SSMS) ou outra ferramenta, ligue-se à Base de Dados SQL/SQL Managed Instance que acolhe o SSISDB. Para mais informações, consulte [Connect to SSISDB in Azure](https://docs.microsoft.com/sql/integration-services/lift-shift/ssis-azure-connect-to-catalog-database).
...
1. Com SSMS ou outra ferramenta, ligue-se à Base de Dados SQL/SQL Managed Instance que acolhe o SSISDB. Para mais informações, consulte [Connect to SSISDB in Azure](https://docs.microsoft.com/sql/integration-services/lift-shift/ssis-azure-connect-to-catalog-database).
...
4. Utilize o procedimento armazenado sSISDB `catalog.set_execution_credential` para fornecer credenciais conforme descrito neste artigo.
...
3. Utilize o procedimento armazenado sSISDB `catalog.set_execution_credential` para fornecer credenciais conforme descrito neste artigo.
