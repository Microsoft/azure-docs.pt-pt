...
| versão | A versão do objeto, S3, se o controlo de versões de S3 está ativado. Se não for especificado, será possível obter a versão mais recente. |Não |
