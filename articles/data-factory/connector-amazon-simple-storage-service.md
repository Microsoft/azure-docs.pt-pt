...
Este conector requer chaves de acesso para uma conta AWS Identity and Access Management (IAM) para copiar dados do Amazon S3. [As credenciais de segurança temporária](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html) também são apoiadas.
