...
| clientId | A aplicação client_id fornecida pela Concur App Management.  | Yes |
| o nome de utilizador | O nome de utilizador que utiliza para aceder ao Serviço Concur.  | Yes |
