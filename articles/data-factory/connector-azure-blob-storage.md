...
| prefixo                   | Prefixo para o nome blob sob o recipiente dado configurado em conjunto de dados para filtrar bolhas de origem. São selecionados blobs cujo nome começa com este prefixo. <br>Aplica-se `wildcardFolderPath` apenas quando e `wildcardFileName` as propriedades não são especificadas. | Não                                                          |
