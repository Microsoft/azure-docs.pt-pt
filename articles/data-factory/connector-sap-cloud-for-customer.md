...
| o nome de utilizador | Especifique o nome de utilizador para ligar ao SAP C4C. | Sim |
...
| path | Especificar o caminho da entidade SAP C4C OData. |Sim |
