---
title: Definições políticas incorporadas
description: Lista definições de políticas incorporadas para data factory. Estas definições políticas incorporadas fornecem abordagens comuns para gerir os seus recursos Azure.
ms.author: lle
author: lrtoyou1223
...
ms.locfileid: "102432443"
---
# <a name="azure-policy-built-in-definitions-for-data-factory-preview"></a>Definições incorporadas da Política Azure para a Fábrica de Dados (Pré-visualização)
[!INCLUDE[appliesto-adf-xxx-md](includes/appliesto-adf-xxx-md.md)]

Esta página é um índice de definições de política incorporadas da [Azure Policy](../governance/policy/overview.md) para data factory. Para obter mais incorporados em Azure Policy para outros serviços, consulte [definições incorporadas da Política Azure](../governance/policy/samples/built-in-policies.md).
