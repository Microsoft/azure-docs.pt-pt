...
| timeSpanFormat                   | Cadeia de formato ao converter entre períodos de tempo e cordas, por exemplo, `dd\.hh\:mm` . Consulte as [cadeias de formato TimeSpan personalizadas](https://docs.microsoft.com/dotnet/standard/base-types/custom-timespan-format-strings) para obter informações detalhadas. | No       |
