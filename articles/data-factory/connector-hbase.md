---
title: Copiar dados do HBase com o Azure Data Factory
...
| anfitrião | O nome ou endereço IP anfitrião do servidor de HBase. ,.  `[clustername].azurehdinsight.net`, `192.168.222.160`)  | Sim |
