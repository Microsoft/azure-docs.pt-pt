...
```
Se **o Documento por linha** for selecionado, os fluxos de dados de mapeamento leiam um documento JSON de cada linha num ficheiro. 
...
File3.json
 ...
 {"time":"2015-04-29T07:13:21.4370000Z","callingimsi":"466923101048691","callingnum1":"678901578","callingnum2":"345626404","switch1":"Germany","switch2":"UK"}
```
Se **o Conjunto de documentos** for selecionado, os fluxos de dados de mapeamento leiam um conjunto de documentos a partir de um ficheiro. 
