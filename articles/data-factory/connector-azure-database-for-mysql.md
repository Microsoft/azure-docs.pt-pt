...
|:--- |:--- |:--- |
| type | A propriedade de tipo tem de ser definida como: **AzureMySql** | Sim |
...
| Propriedade | Descrição | Necessário |
|:--- |:--- |:--- |
| type | A propriedade de tipo do conjunto de dados deve ser definida como: **AzureMySqlTable** | Sim |
