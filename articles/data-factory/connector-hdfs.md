...
3.  Selecione o algoritmo de encriptação que é usado em Kerberos.
    ...
    a. Selecione a política **do** grupo de gestão do grupo de gestão do grupo de  >  **gestão** do servidor  >    >    >  **Padrão ou política de domínio ativo** e, em seguida, selecione **Editar**.
