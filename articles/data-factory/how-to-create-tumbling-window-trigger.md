...
| **retryPolicy: Contar** | O número de repetições antes de a execução do pipeline ser marcada como "falha".  | Número inteiro | Um inteiro, onde o padrão é 0 (sem repetições). | Não |
