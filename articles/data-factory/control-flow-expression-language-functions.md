...
|booleano|Converta o parâmetro para um valor booleano. Por exemplo, a seguinte expressão retorna `false`:  `bool(0)`<br /><br /> **Número de parâmetro**: 1<br /><br /> **Nome**: Value<br /><br /> **Descrição**: Necessário. O valor que é convertido para booleano.|  
