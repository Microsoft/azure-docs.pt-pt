...
| **[BAA HIPAA](/compliance/regulatory/offering-hipaa-hitech)** |
| **[HITRUST](/compliance/regulatory/offering-hitrust)** |

Se estiver interessado na conformidade do Azure e na forma como o Azure assegura a sua própria infraestrutura, visite o [Microsoft Trust Center](https://microsoft.com/trustcenter/default.aspx). Para a lista mais recente de todas as ofertas da Azure Compliance, verifique -  https://aka.ms/AzureCompliance .
...
### <a name="firewall-configurations-and-allow-list-setting-up-for-ip-addresses"></a>Configurações de firewall e permitir configuração de lista para endereços IP
