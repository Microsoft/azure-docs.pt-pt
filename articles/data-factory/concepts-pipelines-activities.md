...
--------- | ----------- | -------------- | --------
tempo limite | Especifica o tempo limite para a execução da atividade. | Período de tempo | Não. O tempo limite predefinido é de 7 dias.
