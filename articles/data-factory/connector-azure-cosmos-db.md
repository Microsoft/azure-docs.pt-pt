...
- Copie os dados de e para o AZure Cosmos DB [SQL API](https://docs.microsoft.com/azure/cosmos-db/documentdb-introduction).
...
| Propriedade | Descrição | Necessário |
|:--- |:--- |:--- |
| tipo | A **type** propriedade tipo da fonte de atividade da cópia deve ser definida para **CosmosDbSqlApiSource**. |Yes |
