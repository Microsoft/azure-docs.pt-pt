...
Se estava a usar um conector Amazon S3 para copiar dados do Google Cloud Storage, ainda é suportado como é para retrocompatibilidade. Sugerimos que utilize o novo modelo mencionado anteriormente, até que a UI de autoria da Data Factory tenha mudado para gerar o novo modelo.
