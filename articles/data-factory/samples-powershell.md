...
|[Cópia a granel](scripts/bulk-copy-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Esta amostra de script PowerShell copia dados de várias tabelas numa base de dados na Base de Dados Azure SQL para um armazém de dados Azure SQL. |
...
|[Criar o runtime de integração de SSIS do Azure](scripts/deploy-azure-ssis-integration-runtime-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Este script PowerShell prevê um tempo de integração Azure-SSIS que executa pacotes sql server integration Services (SSIS) em Azure. |
