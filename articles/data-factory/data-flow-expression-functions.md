...
Devolve um valor nulo. Utilize a função syntax(null()) se existir um nome de coluna com o nome 'null'. Qualquer operação que utiliza irá resultar num valor nulo * ``custId = NULL (for derived field)``
* ``custId == NULL -> NULL``
* ``'nothing' + NULL -> NULL``
* ``10 * NULL -> NULL'``
* ``NULL == '' -> NULL'``
