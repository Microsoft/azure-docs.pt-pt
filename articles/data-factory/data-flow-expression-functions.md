...
Calcular a raiz de cubo de um número.  
* ``cbrt(8) -> 2.0``  
___
### <code>ceil</code>
...
Tem a data atual quando este trabalho começar a funcionar. Você pode passar um timezone opcional sob a forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. O intervalo local é usado como padrão. Consulte o SimpleDateFormat da Java para os formatos disponíveis. [https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html](https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html). 
...
Devolve sempre um valor falso. Utilize a sintaxe de função (falso)) se houver uma coluna chamada "falso".  
* ``(10 + 20 > 30) -> false``  
* ``(10 + 20 > 30) -> false()``
___
### <code>filter</code>
...
___
### <code>floor</code>
<code><b>floor(<i>&lt;value1&gt;</i> : number) => number</b></código><br/><br/> Devolve o maior inteiro não maior than the number.  
* ``floor(-0.1) -> -1``  
___
### <code>fromBase64</code>
<code><b>fromBase64(<i>&lt;value1&gt;</i> : string) => string</b></código><br/><br/> Codifica o dado string in base64.  
* ``fromBase64('Z3VuY2h1cw==') -> 'gunchus'``  
___
### <code>fromUTC</code>
<code><b>fromUTC(<i>&lt;value1&gt;</i> : timestamp, [<i>&lt;value2&gt;</i> : string]) => timestamp</b></código><br/><br/> Converte-se ao calendário da UTC. Você pode opcionalmente passar o timezone sob a forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. Está em incumprimento do atual timezoneRefer Java's SimpleDateFormat para formatos disponíveis. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
* ``fromUTC(currentTimeStamp()) == toTimestamp('2050-12-12 19:18:12') -> false``  
* ``fromUTC(currentTimeStamp(), 'Asia/Seoul') != toTimestamp('2050-12-12 19:18:12') -> true``  
___
### <code>greater</code>
<code><b>greater(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => boolean</b></código><br/><br/> Comparar maior operador. Same as > operator.  
* ``greater(12, 24) -> false``  
* ``('dumbo' > 'dum') -> true``  
* ``(toTimestamp('2019-02-05 08:21:34.890', 'yyyy-MM-dd HH:mm:ss.SSS') > toTimestamp('2019-02-03 05:19:28.871', 'yyyy-MM-dd HH:mm:ss.SSS')) -> true``  
___
### <code>greaterOrEqual</code>
<code><b>greaterOrEqual(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => boolean</b></código><br/><br/> Comparação maior do que ou igual operador. A mesma coisa as >= operator.  
* ``greaterOrEqual(12, 12) -> true``  
* ``('dumbo' >= 'dum') -> true``  
___
### <code>greatest</code>
<code><b>greatest(<i>&lt;value1&gt;</i> : any, ...) => any</b></código><br/><br/> Devolve o maior valor entre a lista de valores como entrada saltando valores nulos. Devoluções nulas se todos inputs are null.  
...
___
### <code>hasColumn</code>
<code><b>hasColumn(<i>&lt;column name&gt;</i> : string, [<i>&lt;stream name&gt;</i> : string]) => boolean</b></código><br/><br/> Verifica se há um valor de coluna pelo nome no fluxo. Pode passar um nome de fluxo opcional como segundo argumento.  Os nomes das colunas conhecidos na hora do design devem ser abordados apenas pelo seu nome. As entradas computadas não são suportadas, mas pode usar parameter substitutions.  
* ``hasColumn('parent')``  
___
### <code>hour</code>
<code><b>hour(<i>&lt;value1&gt;</i> : timestamp, [<i>&lt;value2&gt;</i> : string]) => integer</b></código><br/><br/> Obtém o valor de hora de um timetamp. Você pode passar um timezone opcional sob a forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. O intervalo local é usado como padrão. Consulte o SimpleDateFormat da Java para os formatos disponíveis. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
* ``hour(toTimestamp('2009-07-30 12:58:59')) -> 12``  
* ``hour(toTimestamp('2009-07-30 12:58:59'), 'PST') -> 12``  
___
### <code>hours</code>
<code><b>hours(<i>&lt;value1&gt;</i> : integer) => long</b></código><br/><br/> Duração em milissegundos number of hours.  
* ``hours(2) -> 7200000L``  
___
### <code>iif</code>
<code><b>iif(<i>&lt;condition&gt;</i> : boolean, <i>&lt;true_expression&gt;</i> : any, [<i>&lt;false_expression&gt;</i> : any]) => any</b></código><br/><br/> Com base numa condição aplica-se um valor ou outro. Se outro não for especificado, é considerado NU. Ambos os valores devem ser compatíveis(numeric, string...).  
* ``iif(10 + 20 == 30, 'dumbo', 'gumbo') -> 'dumbo'``  
* ``iif(10 > 30, 'dumbo', 'gumbo') -> 'gumbo'``  
* ``iif(month(toDate('2018-12-01')) == 12, 345.12, 102.67) -> 345.12``  
___
### <code>iifNull</code>
<code><b>iifNull(<i>&lt;value1&gt;</i> : any, [<i>&lt;value2&gt;</i> : any], ...) => any</b></código><br/><br/> Verifica se o primeiro parâmetro é nulo. Se não for nulo, o primeiro parâmetro é devolvido. Se nulo, o segundo parâmetro é devolvido. Se forem especificados três parâmetros, o comportamento é o mesmo que iif(isNull(valor1), valor2, valor3) e o terceiro parâmetro é devolvido se o primeiro va lue is not null.  
* ``iifNull (10, 20) -> 10``  
...
___
### <code>in</code>
<code><b>in(<i>&lt;array of items&gt;</i> : array, <i>&lt;item to find&gt;</i> : any) => boolean</b></código><br/><br/> Verifica se um item is in the array.  
* ``in([10, 20, 30], 10) -> true``  
* ``in(['good', 'kid'], 'bad') -> false``  
___
### <code>initCap</code>
<code><b>initCap(<i>&lt;value1&gt;</i> : string) => string</b></código><br/><br/> Converte a primeira letra de cada palavra para maiúscula. As palavras são identificadas como separadasd by whitespace.  
* ``initCap('cool iceCREAM') -> 'Cool Icecream'``  
___
### <code>instr</code>
<code><b>instr(<i>&lt;string&gt;</i> : string, <i>&lt;substring to find&gt;</i> : string) => integer</b></código><br/><br/> Encontra a posição(1 baseada) do sub-adiscão dentro de uma cadeia. 0 é retornoed if not found.  
* ``instr('dumbo', 'mbo') -> 3``  
* ``instr('microsoft', 'o') -> 5``  
* ``instr('good', 'bad') -> 0``  
___
### <code>isDelete</code>
<code><b>isDelete([<i>&lt;value1&gt;</i> : integer]) => boolean</b></código><br/><br/> Verifica se a linha está marcada para eliminar. Para transformações que tomem mais de um fluxo de entrada, pode passar o índice (1 base) do fluxo. O índice de fluxo deve ser 1 ou 2 e o default value is 1.  
* ``isDelete()``  
* ``isDelete(1)``  
___
### <code>isError</code>
<code><b>isError([<i>&lt;value1&gt;</i> : integer]) => boolean</b></código><br/><br/> Verifica se a linha está marcada como erro. Para transformações que tomem mais de um fluxo de entrada, pode passar o índice (1 base) do fluxo. O índice de fluxo deve ser 1 ou 2 e o default value is 1.  
* ``isError()``  
* ``isError(1)``  
___
### <code>isIgnore</code>
<code><b>isIgnore([<i>&lt;value1&gt;</i> : integer]) => boolean</b></código><br/><br/> Verifica se a linha está marcada para ser ignorada. Para transformações que tomem mais de um fluxo de entrada, pode passar o índice (1 base) do fluxo. O índice de fluxo deve ser 1 ou 2 e o default value is 1.  
* ``isIgnore()``  
* ``isIgnore(1)``  
___
### <code>isInsert</code>
<code><b>isInsert([<i>&lt;value1&gt;</i> : integer]) => boolean</b></código><br/><br/> Verifica se a linha está marcada para inserção. Para transformações que tomem mais de um fluxo de entrada, pode passar o índice (1 base) do fluxo. O índice de fluxo deve ser 1 ou 2 e o default value is 1.  
* ``isInsert()``  
* ``isInsert(1)``  
___
### <code>isMatch</code>
<code><b>isMatch([<i>&lt;value1&gt;</i> : integer]) => boolean</b></código><br/><br/> Verifica se a linha é correspondida no lookup. Para transformações que tomem mais de um fluxo de entrada, pode passar o índice (1 base) do fluxo. O índice de fluxo deve ser 1 ou 2 e o default value is 1.  
* ``isMatch()``  
* ``isMatch(1)``  
___
### <code>isNull</code>
...
___
### <code>isUpdate</code>
<code><b>isUpdate([<i>&lt;value1&gt;</i> : integer]) => boolean</b></código><br/><br/> Verifica se a linha está marcada para atualização. Para transformações que tomem mais de um fluxo de entrada, pode passar o índice (1 base) do fluxo. O índice de fluxo deve ser 1 ou 2 e o default value is 1.  
* ``isUpdate()``  
* ``isUpdate(1)``  
___
### <code>isUpsert</code>
<code><b>isUpsert([<i>&lt;value1&gt;</i> : integer]) => boolean</b></código><br/><br/> Verifica se a linha está marcada para inserção. Para transformações que tomem mais de um fluxo de entrada, pode passar o índice (1 base) do fluxo. O índice de fluxo deve ser 1 ou 2 e o default value is 1.  
* ``isUpsert()``  
* ``isUpsert(1)``  
___
### <code>lastDayOfMonth</code>
<code><b>lastDayOfMonth(<i>&lt;value1&gt;</i> : datetime) => date</b></código><br/><br/> Obtém a última data do month given a date.  
* ``lastDayOfMonth(toDate('2009-01-12')) -> toDate('2009-01-31')``  
___
### <code>least</code>
<code><b>least(<i>&lt;value1&gt;</i> : any, ...) => any</b></código><br/><br/> Comparação inferior ou igual ao operador. A mesma coisa as <= operator.  
* ``least(10, 30,15, 20) -> 10``  
* ``least(toDate('2010-12-12'), toDate('2011-12-12'), toDate('2000-12-12')) -> toDate('2000-12-12')``  
___
### <code>left</code>
<code><b>left(<i>&lt;string to subset&gt;</i> : string, <i>&lt;number of characters&gt;</i> : integral) => string</b></código><br/><br/> Extrata um início de substring no índice 1 com número de caracteres. O mesmo que o SUBSTRING(str, 1, n).  
* ``left('bojjus', 2) -> 'bo'``  
* ``left('bojjus', 20) -> 'bojjus'``  
___
### <code>length</code>
<code><b>length(<i>&lt;value1&gt;</i> : string) => integer</b></código><br/><br/> Devolve o length of the string.  
* ``length('dumbo') -> 5``  
___
### <code>lesser</code>
<code><b>lesser(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => boolean</b></código><br/><br/> Menos operador de comparação. Same as < operator.  
* ``lesser(12, 24) -> true``  
* ``('abcd' < 'abc') -> false``  
* ``(toTimestamp('2019-02-03 05:19:28.871', 'yyyy-MM-dd HH:mm:ss.SSS') < toTimestamp('2019-02-05 08:21:34.890', 'yyyy-MM-dd HH:mm:ss.SSS')) -> true``  
___
### <code>lesserOrEqual</code>
<code><b>lesserOrEqual(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => boolean</b></código><br/><br/> Comparação inferior ou igual ao operador. A mesma coisa as <= operator.  
* ``lesserOrEqual(12, 12) -> true``  
* ``('dumbo' <= 'dum') -> false``  
___
### <code>levenshtein</code>
<code><b>levenshtein(<i>&lt;from string&gt;</i> : string, <i>&lt;to string&gt;</i> : string) => integer</b></código><br/><br/> Obtém a betw distância levenshteineen two strings.  
...
___
### <code>locate</code>
<code><b>locate(<i>&lt;substring to find&gt;</i> : string, <i>&lt;string&gt;</i> : string, [<i>&lt;from index - 1-based&gt;</i> : integral]) => integer</b></código><br/><br/> Encontra a posição(1 baseada) do sublamamento dentro de uma cadeia que inicia uma determinada posição. Se a posição for omitida, é considerada desde o início da cadeia. 0 é retorno ed if not found.  
* ``locate('mbo','dumbo') -> 3``  
* ``locate('o', 'microsoft', 6) -> 7``  
* ``locate('bad', 'good') -> 0``  
___
### <code>log</code>
<code><b>log(<i>&lt;value1&gt;</i> : number, [<i>&lt;value2&gt;</i> : number]) => double</b></código><br/><br/> Calcula o valor do registo. Uma base opcional pode ser fornecida mais um Euler number if used.  
* ``log(100, 10) -> 2``  
___
### <code>log10</code>
<code><b>log10(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Calcula o valor do registo based on 10 base.  
* ``log10(100) -> 2``  
___
### <code>lower</code>
...
___
### <code>lpad</code>
<code><b>lpad(<i>&lt;string to pad&gt;</i> : string, <i>&lt;final padded length&gt;</i> : integral, <i>&lt;padding&gt;</i> : string) => string</b></código><br/><br/> Almofadas esquerda a cadeia pelo estofamento fornecido até que tenha um certo comprimento. Se a corda for igual ou maior do que o comprimento, então é d to the length.  
* ``lpad('dumbo', 10, '-') - > '-----dumbo'``  
* ``lpad('dumbo', 4,  '-') aparado -> 'dumb'' * ''lpad'('dumbo', 8, '<>') -> '<><dumbo'``  ___
### <code>ltrim</code>
<code><b>ltrim(<i>&lt;string to trim&gt;</i> : string, [<i>&lt;trim characters&gt;</i> : string]) => string</b></código><br/><br/> Left apara uma série de caracteres principais. Se o segundo parâmetro não for especificado, apara o espaço em branco. Caso contrário, apara qualquer personagem especificado no second parameter.  
* ``ltrim('  dumbo  ') -> 'dumbo  '``  
* ``ltrim('!--!du!mbo!', '-!') -> 'du!mbo!'``  
___
### <code>map</code>
...
___
### <code>md5</code>
<code><b>md5(<i>&lt;value1&gt;</i> : any, ...) => string</b></código><br/><br/> Calcula a digestão MD5 de conjunto de colunas de tipos de dados primitivos variados e devolve uma cadeia hexagonal de 32 caracteres. Pode ser usado para calcular um dedoprint for a row.  
* ``md5(5, 'gunchus', 8.2, 'bojjus', true, toDate('2010-4-4')) -> '4ce8a880bd621a1ffad0bca905e1bc5a'``  
___
### <code>millisecond</code>
<code><b>millisecond(<i>&lt;value1&gt;</i> : timestamp, [<i>&lt;value2&gt;</i> : string]) => integer</b></código><br/><br/> Obtém o valor milisegundo de uma data. Você pode passar um timezone opcional sob a forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. O intervalo local é usado como padrão. Consulte o SimpleDateFormat da Java para os formatos disponíveis. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
* ``millisecond(toTimestamp('2009-07-30 12:58:59.871', 'yyyy-MM-dd HH:mm:ss.SSS')) -> 871``  
___
### <code>milliseconds</code>
<code><b>milliseconds(<i>&lt;value1&gt;</i> : integer) => long</b></código><br/><br/> Duração em milissegundos para número of milliseconds.  
* ``milliseconds(2) -> 2L``  
___
### <code>minus</code>
<code><b>minus(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => any</b></código><br/><br/> Subtra os números. Subtraia de um número de dias de data. Subtrair a duração de uma hora. Subtrair dois vezes para obter a diferença em milissegundos. O mesmo que the - operator.  
* ``minus(20, 10) -> 10``  
* ``20 - 10 -> 10``  
...
___
### <code>minute</code>
<code><b>minute(<i>&lt;value1&gt;</i> : timestamp, [<i>&lt;value2&gt;</i> : string]) => integer</b></código><br/><br/> Obtém o valor minúsculo de um timetamp. Você pode passar um timezone opcional sob a forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. O intervalo local é usado como padrão. Consulte o SimpleDateFormat da Java para os formatos disponíveis. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
* ``minute(toTimestamp('2009-07-30 12:58:59')) -> 58``  
* ``minute(toTimestamp('2009-07-30 12:58:59'), 'PST') -> 58``  
___
### <code>minutes</code>
<code><b>minutes(<i>&lt;value1&gt;</i> : integer) => long</b></código><br/><br/> Duração em milissegundos para number of minutes.  
* ``minutes(2) -> 120000L``  
___
### <code>mod</code>
<code><b>mod(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => any</b></código><br/><br/> Modulus de par de números. O mesmo que the % operator.  
* ``mod(20, 8) -> 4``  
* ``20 % 8 -> 4``  
___
### <code>month</code>
<code><b>month(<i>&lt;value1&gt;</i> : datetime) => integer</b></código><br/><br/> Obtém o valor mensal de um date or timestamp.  
* ``month(toDate('2012-8-8')) -> 8``  
___
### <code>monthsBetween</code>
<code><b>monthsBetween(<i>&lt;from date/timestamp&gt;</i> : datetime, <i>&lt;to date/timestamp&gt;</i> : datetime, [<i>&lt;roundoff&gt;</i> : boolean], [<i>&lt;time zone&gt;</i> : string]) => double</b></código><br/><br/> Obtém o número de meses entre duas datas. Pode completar os cálculos. Você pode passar um timezone opcional sob a forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. O intervalo local é usado como padrão. Consulte o SimpleDateFormat da Java para os formatos disponíveis. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
* ``monthsBetween(toTimestamp('1997-02-28 10:30:00'), toDate('1996-10-30')) -> 3.94959677``  
___
### <code>multiply</code>
<code><b>multiply(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => any</b></código><br/><br/> Multiplica o par de números. O mesmo que the * operator.  
* ``multiply(20, 10) -> 200``  
* ``20 * 10 -> 200``  
___
### <code>negate</code>
<code><b>negate(<i>&lt;value1&gt;</i> : number) => number</b></código><br/><br/> Nega um número. Transforma os números positivos em negativos and vice versa.  
* ``negate(13) -> -13``  
___
### <code>nextSequence</code>
<code><b>nextSequence() => long</b></código><br/><br/> Devolve a próxima sequência única. O número é consecutivo apenas dentro de uma divisória e é prefixado por the partitionId.  
* ``nextSequence() == 12313112 -> false``  
___
### <code>normalize</code>
<code><b>normalize(<i>&lt;String to normalize&gt;</i> : string) => string</b></código><br/><br/> Normalize o valor da cadeia para separar uni acentuadacode characters.  
* ``regexReplace(normalize('bo²s'), `\p{M}`, '') -> 'boys'``  
___
### <code>not</code>
<code><b>not(<i>&lt;value1&gt;</i> : boolean) => boolean</b></código><br/><br/> Logical negation operator.  
* ``not(true) -> false``  
* ``not(10 == 20) -> true``  
___
### <code>notEquals</code>
<code><b>notEquals(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => boolean</b></código><br/><br/> Comparação não é igual a operador. A mesma coisa as != operator.  
* ``12!= 24 -> true``  
* ``'bojjus' != 'bo' + 'jjus' -> false``  
___
### <code>notNull</code>
<code><b>notNull(<i>&lt;value1&gt;</i> : any) => boolean</b></código><br/><br/> Verifica se o value is not NULL.  
* ``notNull(NULL()) -> false``  
* ``notNull('') -> true``  
___
### <code>null</code>
<code><b>null() => null</b></código><br/><br/> Devolve um valor NULO. Utilize a sintaxe de função (nula)) se houver uma coluna denominada "nulo". Qualquer operação que utilize r esult in a NULL.  
...
___
### <code>or</code>
<code><b>or(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : boolean) => boolean</b></código><br/><br/> Ópera lógica ORtor. Same as ||.  
* ``or(true, false) -> true``  
* ``true || false -> true``  
___
### <code>pMod</code>
<code><b>pMod(<i>&lt;value1&gt;</i> : any, <i>&lt;value2&gt;</i> : any) => any</b></código><br/><br/> Modulus positivo de pair of numbers.  
* ``pmod(-20, 8) -> 4``  
___
### <code>partitionId</code>
<code><b>partitionId() => integer</b></código><br/><br/> Devolve o id partição atual input row is in.  
* ``partitionId()``  
___
### <code>power</code>
<code><b>power(<i>&lt;value1&gt;</i> : number, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Eleva um número para o power of another.  
* ``power(10, 2) -> 100``  
___
### <code>random</code>
<code><b>random(<i>&lt;value1&gt;</i> : integral) => long</b></código><br/><br/> Devolve um número aleatório dado uma semente opcional dentro de uma divisória. A semente deve ser um valor fixo e é usada em conjunto com a partitionId para produce random values  
* ``random(1) == 1 -> false``
___
### <code>reduce</code>
...
<code><b>regexExtract(<i>&lt;string&gt;</i> : string, <i>&lt;regex to find&gt;</i> : string, [<i>&lt;match group 1-based index&gt;</i> : integral]) => string</b></código><br/><br/> Extrair um sublmomento correspondente para um determinado padrão regex. O último parâmetro identifica o grupo de jogo e está em incumprimento a 1 if omitted. Use '<regex>'(citação traseira) para combinar com uma corda without escaping.  
* ``regexExtract('Cost is between 600 and 800 dollars', '(\\d+) and (\\d+)', 2) -> '800'``  
* ``regexExtract('Cost is between 600 and 800 dollars', `(\d+) and (\d+)`, 2) -> '800'``  
___
### <code>regexMatch</code>
<code><b>regexMatch(<i>&lt;string&gt;</i> : string, <i>&lt;regex to match&gt;</i> : string) => boolean</b></código><br/><br/> Verifica se a cadeia corresponde ao rege dadox pattern. Use '<regex>'(citação traseira) para combinar com uma corda without escaping.  
* ``regexMatch('200.50', '(\\d+).(\\d+)') -> true``  
* ``regexMatch('200.50', `(\d+).(\d+)`) -> true``  
___
### <code>regexReplace</code>
<code><b>regexReplace(<i>&lt;string&gt;</i> : string, <i>&lt;regex to find&gt;</i> : string, <i>&lt;substring to replace&gt;</i> : string) => string</b></código><br/><br/> Substitua todas as ocorrências de um padrão regex por outro substring no given string Use '<regex>'(citação traseira) para combinar com uma corda without escaping.  
* ``regexReplace('100 and 200', '(\\d+)', 'bojjus') -> 'bojjus and bojjus'``  
* ``regexReplace('100 and 200', `(\d+)`, 'gunchus') -> 'gunchus and gunchus'``  
___
### <code>regexSplit</code>
<code><b>regexSplit(<i>&lt;string to split&gt;</i> : string, <i>&lt;regex expression&gt;</i> : string) => array</b></código><br/><br/> divide uma cadeia baseada num limonhagem baseado no regex e devolve um array of strings.  
...
___
### <code>replace</code>
<code><b>replace(<i>&lt;string&gt;</i> : string, <i>&lt;substring to find&gt;</i> : string, [<i>&lt;substring to replace&gt;</i> : string]) => string</b></código><br/><br/> Substitua todas as ocorrências de um sublamento por outro sub-cordão na cadeia dada. Se o último parâmetro for omitido, é padrão to empty string.  
...
___
### <code>right</code>
<code><b>right(<i>&lt;string to subset&gt;</i> : string, <i>&lt;number of characters&gt;</i> : integral) => string</b></código><br/><br/> Extrai um sub-adcção com número de caracteres da direita. O mesmo que SUBSTRING (str, LENGTH(str) - n, n).  
* ``right('bojjus', 2) -> 'us'``  
* ``right('bojjus', 20) -> 'bojjus'``  
___
### <code>rlike</code>
<code><b>rlike(<i>&lt;string&gt;</i> : string, <i>&lt;pattern match&gt;</i> : string) => boolean</b></código><br/><br/> Verifica se a cadeia corresponde à dádivan regex pattern.  
* ``rlike('200.50', `(\d+).(\d+)`) -> true``  
* ``rlike('bogus', `M[0-9]+.*`) -> false``  
___
### <code>round</code>
<code><b>round(<i>&lt;number&gt;</i> : number, [<i>&lt;scale to round&gt;</i> : number], [<i>&lt;rounding option&gt;</i> : integral]) => double</b></código><br/><br/> Rounds um número dado uma escala opcional e um modo de arredondamento opcional. Se a balança for omitida, é desagredida a 0.  Se o modo for omitido, é incumprido ROUND_HALF_UP(5). Os valores para r ounding incl u de 1 - ROUND_U P 2 - ROUND_DOWN 3 - ROUND_CEILING 4 - ROUND_FLOOR 5 - ROUND_HALF_UP 6 - ROUND_HALF_DOWN 7 - ROUND_HALF_EVEN 8 - ROUND_UNNECESSARY.  
* ``round(100.123) -> 100.0``  
* ``round(2.5, 0) -> 3.0``  
* ``round(5.3999999999999995, 2, 7) -> 5.40``  
___
### <code>rpad</code>
<code><b>rpad(<i>&lt;string to pad&gt;</i> : string, <i>&lt;final padded length&gt;</i> : integral, <i>&lt;padding&gt;</i> : string) => string</b></código><br/><br/> As almofadas direitas pelo acolchoamento fornecido até que tenha um certo comprimento. Se a corda é igual ou maior do que o comprimento, então é aparadod to the length.  
* ``rpad('dumbo', 10, '-') -> 'dumbo-----'``  
* ``rpad('dumbo', 4, '-') -> 'dumb'``  
* ``rpad('dumbo', 8, '<>') -> 'dumbo<><'``  ___
### <code>rtrim</code>
<code><b>rtrim(<i>&lt;string to trim&gt;</i> : string, [<i>&lt;trim characters&gt;</i> : string]) => string</b></código><br/><br/> Direita apara uma série de caracteres principais. Se o segundo parâmetro não for especificado, apara o espaço em branco. Caso contrário, apara qualquer personagem especificado no second parameter.  
* ``rtrim('  dumbo  ') -> '  dumbo'``  
* ``rtrim('!--!du!mbo!', '-!') -> '!--!du!mbo'``  
___
### <code>second</code>
<code><b>second(<i>&lt;value1&gt;</i> : timestamp, [<i>&lt;value2&gt;</i> : string]) => integer</b></código><br/><br/> Obtém o segundo valor de uma data. Você pode passar um timezone opcional sob a forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. O intervalo local é usado como padrão. Consulte o SimpleDateFormat da Java para os formatos disponíveis. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
* ``second(toTimestamp('2009-07-30 12:58:59')) -> 59``  
___
### <code>seconds</code>
<code><b>seconds(<i>&lt;value1&gt;</i> : integer) => long</b></código><br/><br/> Duração em milissegundos para number of seconds.  
* ``seconds(2) -> 2000L``  
___
### <code>sha1</code>
<code><b>sha1(<i>&lt;value1&gt;</i> : any, ...) => string</b></código><br/><br/> Calcula a digestão SHA-1 de conjunto de colunas de tipos de dados primitivos variados e devolve uma cadeia hexagonal de 40 caracteres. Pode ser usado para calcular um dedoprint for a row.  
* ``sha1(5, 'gunchus', 8.2, 'bojjus', true, toDate('2010-4-4')) -> '46d3b478e8ec4e1f3b453ac3d8e59d5854e282bb'``  
___
### <code>sha2</code>
<code><b>sha2(<i>&lt;value1&gt;</i> : integer, <i>&lt;value2&gt;</i> : any, ...) => string</b></código><br/><br/> Calcula a digestão SHA-2 do conjunto de colunas de tipos de dados primitivos variados dado um pouco de comprimento que só pode ser dos valores 0(256), 224, 256, 384, 512. Pode ser usado para calcular um dedoprint for a row.  
* ``sha2(256, 'gunchus', 8.2, 'bojjus', true, toDate('2010-4-4')) -> 'afe8a553b1761c67d76f8c31ceef7f71b66a1ee6f4e6d3b5478bf68b47d06bd3'``  
___
### <code>sin</code>
<code><b>sin(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Calculadoraes a sine value.  
* ``sin(2) -> 0.9092974268256817``  
___
### <code>sinh</code>
<code><b>sinh(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Calcula um hiperbolic sine value.  
* ``sinh(0) -> 0.0``  
___
### <code>size</code>
...
___
### <code>split</code>
<code><b>split(<i>&lt;string to split&gt;</i> : string, <i>&lt;split characters&gt;</i> : string) => array</b></código><br/><br/> divide uma cadeia baseada num delimitador e devolve um array of strings.  
...
___
### <code>sqrt</code>
<code><b>sqrt(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Calcula o quadrado root of a number.  
* ``sqrt(9) -> 3``  
___
### <code>startsWith</code>
<code><b>startsWith(<i>&lt;string&gt;</i> : string, <i>&lt;substring to check&gt;</i> : string) => boolean</b></código><br/><br/> Verifica se a cadeia começa com o supplied string.  
* ``startsWith('dumbo', 'du') -> true``  
___
### <code>subDays</code>
<code><b>subDays(<i>&lt;date/timestamp&gt;</i> : datetime, <i>&lt;days to subtract&gt;</i> : integral) => datetime</b></código><br/><br/> Subtrair meses a partir de uma data ou hora. O mesmo que o - operator for date.  
...
___
### <code>substring</code>
<code><b>substring(<i>&lt;string to subset&gt;</i> : string, <i>&lt;from 1-based index&gt;</i> : integral, [<i>&lt;number of characters&gt;</i> : integral]) => string</b></código><br/><br/> Extrai um sublmomento de um determinado comprimento a partir de uma posição. A posição é 1 baseada. Se o comprimento for omitido, é incumprido para en d of the string.  
...
___
### <code>tan</code>
<code><b>tan(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Cálculos a tangent value.  
* ``tan(0) -> 0.0``  
___
### <code>tanh</code>
...
___
### <code>toDate</code>
<code><b>toDate(<i>&lt;string&gt;</i> : any, [<i>&lt;date format&gt;</i> : string]) => date</b></código><br/><br/> Converte a cadeia de data de entrada até à data utilizando um formato de data de entrada opcional. Consulte o SimpleDateFormat da Java para os formatos disponíveis. Se o formato da data de entrada for omitido, o formato predefinido é yyyy-[M]M-[d]d. Os formatos aceites são :[yyyyyy-[M]M, yyyy-[M]M-[d]d,yyyy-[M]M-[d]dT* ].  
...
<code><b>toTimestamp(<i>&lt;string&gt;</i> : any, [<i>&lt;timestamp format&gt;</i> : string], [<i>&lt;time zone&gt;</i> : string]) => timestamp</b></código><br/><br/> Converte uma cadeia para um timetamp dado um formato de timetamp opcional. Consulte o Java SimpleDateFormat para todos os formatos possíveis. Se a estampação de tempo for omitida, é utilizado o padrão padrão.yyyy-[M]M-[d]d hh:mm:mm:ss[.f...] é usado. Você pode passar um timezone opcional sob a forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. O timetamp suporta até milissegundo precisão com o valor do SimpleDateFormat de 999Refer Java para formatos disponíveis. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
...
___
### <code>trim</code>
<code><b>trim(<i>&lt;string to trim&gt;</i> : string, [<i>&lt;trim characters&gt;</i> : string]) => string</b></código><br/><br/> Trims uma série de personagens principais e em fuga. Se o segundo parâmetro não for especificado, apara o espaço em branco. Caso contrário, apara qualquer personagem especificado no second parameter.  
* ``trim('  dumbo  ') -> 'dumbo'``  
* ``trim('!--!du!mbo!', '-!') -> 'du!mbo'``  
___
### <code>true</code>
<code><b>true() => boolean</b></código><br/><br/> Sempre devolve um valor verdadeiro. Utilize a sintaxe de função(verdadeiro)) se houver um column named 'true'.  
* ``(10 + 20 == 30) -> true``  
* ``(10 + 20 == 30) -> true()``  
___
### <code>typeMatch</code>
<code><b>typeMatch(<i>&lt;type&gt;</i> : string, <i>&lt;base type&gt;</i> : string) => boolean</b></código><br/><br/> Corresponde ao tipo da coluna. Só pode ser usado em expressões de padrão.número corresponde a curto, inteiro, longo, duplo, flutuante ou decimal, combinações integrais curtas, inteiros, longas, fracionárias partidas duplas, flutuantes, decimais e datas datas ou timestamp type.  
...
___
### <code>uuid</code>
<code><b>uuid() => string</b></código><br/><br/> Devolve o generated UUID.  
* ``uuid()``  
___
### <code>weekOfYear</code>
<code><b>weekOfYear(<i>&lt;value1&gt;</i> : datetime) => integer</b></código><br/><br/> Recebe a semana do year given a date.  
* ``weekOfYear(toDate('2008-02-20')) -> 8``  
___
### <code>weeks</code>
<code><b>weeks(<i>&lt;value1&gt;</i> : integer) => long</b></código><br/><br/> Duração em milissegundos number of weeks.  
* ``weeks(2) -> 1209600000L``  
___
### <code>xor</code>
<code><b>xor(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : boolean) => boolean</b></><de código br/><br/> Operador Lógico XOR. Same as ^ operator.  
* ``xor(true, false) -> true``  
* ``xor(true, true) -> false``  
* ``true ^ false -> true``  
___
### <code>year</code>
<code><b>year(<i>&lt;value1&gt;</i> : datetime) => integer</b></código><br/><br/> Gets the year value of a date.  
* ``year(toDate('2012- 8-8')) -> 2012'' ## Funções Agg r egate As seguintes funções só estão disponíveis em agregado, pivô, unpivot e janelatransformations.
___
### <code>avg</code>
<code><b>avg(<i>&lt;value1&gt;</i> : number) => number</b></código><br/><br/> Obtém a média de values of a column.  
* ``avg(sales)``  
___
### <code>avgIf</code>
<code><b>avgIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => number</b></código><br/><br/> Com base num critério obtém a média de values of a column.  
* ``avgIf(region == 'West', sales)``  
___
### <code>count</code>
<code><b>count([<i>&lt;value1&gt;</i> : any]) => long</b></código><br/><br/> Obtém a contagem agregada de valores. Se a coluna(s) opcional for especificada, ignora o NULL valu es in the count.  
* ` `count(custId)``  
* ``count(cus tId, custName)``* ``count()``  
* ``count(iif(isNull(custId), 1, NULL))``  
___
### <code>countDistinct</code>
<code><b>countDistinct(<i>&lt;value1&gt;</i> : any, [<i>&lt;value2&gt;</i> : any], ...) => long</b></código><br/><br/> Obtém a contagem agregada de valores distintos de um set of columns.  
* ``countDistinct(custId, custName)``  
___
### <code>countIf</code>
<code><b>countIf(<i>&lt;value1&gt;</i> : boolean, [<i>&lt;value2&gt;</i> : any]) => long</b></código><br/><br/> Com base num critério obtém-se a contagem agregada de valores. Se a coluna opcional for especificada, ignora o VALU NULOes in the count.  
* ``countIf(state == 'CA' && commission < 10000, name)``  
___
### <code>covariancePopulation</code>
<code><b>covariancePopulation(<i>&lt;value1&gt;</i> : number, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Recebe a aposta da covariância da populaçãoeen two columns.  
* ``covariancePopulation(sales, profit)``  
___
### <code>covariancePopulationIf</code>
<code><b>covariancePopulationIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number, <i>&lt;value3&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém a covariância da população of two columns.  
* ``covariancePopulationIf(region == 'West', sales)``  
___
### <code>covarianceSample</code>
<code><b>covarianceSample(<i>&lt;value1&gt;</i> : number, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Obtém a covariância da amostra of two columns.  
* ``covarianceSample(sales, profit)``  
___
### <code>covarianceSampleIf</code>
<code><b>covarianceSampleIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number, <i>&lt;value3&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém a covariância da amostra of two columns.  
* ``covarianceSampleIf(region == 'West', sales, profit)``  
___
### <code>first</code>
<code><b>first(<i>&lt;value1&gt;</i> : any, [<i>&lt;value2&gt;</i> : boolean]) => any</b></código><br/><br/> Obtém o primeiro valor de um grupo de colunas. Se o segundo parâmetro ignorarNulls é omitido, is assumed false.  
* ``first(sales)``  
* ``first(sales, false)``  
___
### <code>kurtosis</code>
<code><b>kurtosis(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Fica o kurtosis of a column.  
* ``kurtosis(sales)``  
___
### <code>kurtosisIf</code>
<code><b>kurtosisIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém-se o kurtosis of a column.  
* ``kurtosisIf(region == 'West', sales)``  
___
### <code>last</code>
<code><b>last(<i>&lt;value1&gt;</i> : any, [<i>&lt;value2&gt;</i> : boolean]) => any</b></código><br/><br/> Obtém o último valor de um grupo de colunas. Se o segundo parâmetro ignorarNulls é omitido, i s assumed false.  
*``last(sales)``  
* ``last(sales, false)``  
___
### <code>max</code>
<code><b>max(<i>&lt;value1&gt;</i> : any) => any</b></código><br/><br/> Obtém o máximo value of a column.  
* ``max(sales)``  
___
### <code>maxIf</code>
<code><b>maxIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : any) => any</b></código><br/><br/> Com base num critério, obtém o máximo value of a column.  
* ``maxIf(region == 'West', sales)``  
___
### <code>mean</code>
<code><b>mean(<i>&lt;value1&gt;</i> : number) => number</b></código><br/><br/> Obtém a média dos valores de um column. Same as AVG.  
* ``mean(sales)``  
___
### <code>meanIf</code>
<code><b>meanIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => number</b></código><br/><br/> Com base num critério obtém-se a média de valores de uma coluna. Same as avgIf.  
* ``meanIf(region == 'West', sales)``  
___
### <code>min</code>
<code><b>min(<i>&lt;value1&gt;</i> : any) => any</b></código><br/><br/> Obtém o mínimo value of a column.  
* ``min(sales)``  
___
### <code>minIf</code>
<code><b>minIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : any) => any</b></código><br/><br/> Com base num critério, obtém o mínimo value of a column.  
* ``minIf(region == 'West', sales)``  
___
### <code>skewness</code>
<code><b>skewness(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Recebe o espetoess of a column.  
* ``skewness(sales)``  
___
### <code>skewnessIf</code>
<code><b>skewnessIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém o espetoess of a column.  
* ``skewnessIf(region == 'West', sales)``  
___
### <code>stddev</code>
<code><b>stddev(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Obtém o desvio padrãoion of a column.  
* ``stdDev(sales)``  
___
### <code>stddevIf</code>
<code><b>stddevIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém o desvio padrãoion of a column.  
* ``stddevIf(region == 'West', sales)``  
___
### <code>stddevPopulation</code>
<code><b>stddevPopulation(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Obtém o desvio padrão da populaçãoion of a column.  
* ``stddevPopulation(sales)``  
___
### <code>stddevPopulationIf</code>
<code><b>stddevPopulationIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém o desvio padrão da populaçãoion of a column.  
* ``stddevPopulationIf(region == 'West', sales)``  
___
### <code>stddevSample</code>
<code><b>stddevSample(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Obtém o desvio padrão da amostraion of a column.  
* ``stddevSample(sales)``  
___
### <code>stddevSampleIf</code>
<code><b>stddevSampleIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém o desvio padrão da amostraion of a column.  
* ``stddevSampleIf(region == 'West', sales)``  
___
### <code>sum</code>
<code><b>sum(<i>&lt;value1&gt;</i> : number) => number</b></código><br/><br/> Obtém a soma agregada de um numeric column.  
* ``sum(col)``  
___
### <code>sumDistinct</code>
<code><b>sumDistinct(<i>&lt;value1&gt;</i> : number) => number</b></código><br/><br/> Obtém a soma agregada de valores distintos de um numeric column.  
* ``sumDistinct(col)``  
___
### <code>sumDistinctIf</code>
<code><b>sumDistinctIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => number</b></código><br/><br/> Com base em critérios obtém-se a soma agregada de uma coluna numérica. A condição pode ser base d on any column.  
* ``sumDistinctIf(state == 'CA' && commission <10000, sales)``  
* ``sumDistinctIf(true, sales)``  
___
### <code>sumIf</code>
<code><b>sumIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => number</b></código><br/><br/> Com base em critérios obtém-se a soma agregada de uma coluna numérica. A condição pode ser base d on any column.  
* ``sumIf(state == 'CA' && commission <10000, sales)``  
* ``sumIf(true, sales)``  
___
### <code>variance</code>
<code><b>variance(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Obtém a variaçãonce of a column.  
* ``variance(sales)``  
___
### <code>varianceIf</code>
<code><b>varianceIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém a variaçãonce of a column.  
* ``varianceIf(region == 'West', sales)``  
___
### <code>variancePopulation</code>
<code><b>variancePopulation(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Recebe a população variance of a column.  
* ``variancePopulation(sales)``  
___
### <code>variancePopulationIf</code>
<code><b>variancePopulationIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></código><br/><br/> Com base num critério, obtém a variação da populaçãonce of a column.  
* ``variancePopulationIf(region == 'West', sales)``  
___
### <code>varianceSample</code>
<code><b>varianceSample(<i>&lt;value1&gt;</i> : number) => double</b></código><br/><br/> Obtém a variação imparcialnce of a column.  
