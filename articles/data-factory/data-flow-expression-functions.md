...
Subtrai números. Subtraia de um número de data de dias. Subtraia duração de um carimbo de data/hora. Subtraia dois carimbos de data/hora para obter a diferença em milissegundos. Mesmo que o operador-* ``minus(20, 10) -> 10``  
  * ``20 - 10 -> 10``  
...
A direita pads a cadeia de caracteres pelo preenchimento fornecido até que seja de um determinado comprimento. Se a cadeia de caracteres for igual ou maior que o comprimento, ela será cortada para o comprimento* ``rpad('dumbo', 10, '-') -> 'dumbo-----'``  
  * ``rpad('dumbo', 4, '-') -> 'dumb'``  
  * ``rpad('dumbo', 8, '<>') -> 'dumbo<><'``  
___
