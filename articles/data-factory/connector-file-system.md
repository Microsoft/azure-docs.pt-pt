...
Este artigo descreve como copiar dados de e para o sistema de ficheiros. Para saber mais sobre o Azure Data Factory, leia os [artigo introdutório](introduction.md).

## <a name="supported-capabilities"></a>Capacidades suportadas

Este conector do sistema de ficheiros é suportada para as seguintes atividades:
...
Para copiar dados de e para o sistema de ficheiros no **Parquet ou formato de texto delimitado**, consulte [formato Parquet](format-parquet.md) e [formato de texto delimitado](format-delimited-text.md) artigo num conjunto de dados com base no formato e definições suportadas. As seguintes propriedades são suportadas para o sistema de ficheiros em `location` definições no conjunto de dados com base no formato:

| Propriedade   | Descrição                                                  | Necessário |
| ---------- | ------------------------------------------------------------ | -------- |
| tipo       | A propriedade de tipo sob `location` no conjunto de dados deve ser definida como **FileServerLocation**. | Sim      |
...
Para copiar dados de e para o sistema de ficheiros no **formato ORC/Avro/JSON/binário**, são suportadas as seguintes propriedades:
...
Para copiar dados de sistema de ficheiros no **Parquet ou formato de texto delimitado**, consulte [formato Parquet](format-parquet.md) e [formato de texto delimitado](format-delimited-text.md) artigo na origem de atividade de cópia baseada em formato e definições suportadas. As seguintes propriedades são suportadas para o sistema de ficheiros em `storeSettings` definições na origem de cópia baseada no formato:

| Propriedade                 | Descrição                                                  | Necessário                                      |
| ------------------------ | ------------------------------------------------------------ | --------------------------------------------- |
| tipo                     | A propriedade de tipo sob `storeSettings` deve ser definida como **FileServerReadSetting**. | Sim                                           |
...
Para copiar dados de sistema de ficheiros no **formato ORC/Avro/JSON/binário**, as seguintes propriedades são suportadas na atividade de cópia **origem** secção:
...
Para copiar dados para o sistema de ficheiros no **Parquet ou formato de texto delimitado**, consulte [formato Parquet](format-parquet.md) e [formato de texto delimitado](format-delimited-text.md) artigo sobre o sink de atividade de cópia baseada em formato e definições suportadas. As seguintes propriedades são suportadas para o sistema de ficheiros em `storeSettings` as definições de sink de cópia baseada no formato:

| Propriedade                 | Descrição                                                  | Necessário |
| ------------------------ | ------------------------------------------------------------ | -------- |
| tipo                     | A propriedade de tipo sob `storeSettings` deve ser definida como **FileServerWriteSetting**. | Sim      |
...
Para copiar dados para o sistema de ficheiros no **formato ORC/Avro/JSON/binário**, as seguintes propriedades são suportadas os **sink** secção:
