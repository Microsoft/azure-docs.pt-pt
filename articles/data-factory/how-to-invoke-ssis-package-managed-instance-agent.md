...
Para utilizar esta funcionalidade, [descarregue](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017) e instale o mais recente SQL Server Management Studio (SSMS). Detalhes de suporte da versão como abaixo:
