...
- Armazenamento Azure Blob (sem incluir a conta de armazenamento V1)
- Armazenamento de mesa Azure (sem incluir a conta de armazenamento V1)
- Ficheiros Azure (sem incluir a conta de armazenamento V1)
