...
- [**Base de Dados Azure SQL gerida como** destino de carga de trabalho de base de dados](#azure-sql-database-managed-instance-as-database-workload-destination)
...
### <a name="azure-sql-database-managed-instance-as-database-workload-destination"></a>**Base de Dados Azure SQL gerida como** destino de carga de trabalho de base de dados
