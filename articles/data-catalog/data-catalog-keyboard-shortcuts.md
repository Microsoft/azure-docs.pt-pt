...
| Operação | Premir |
| --- | --- |
| Abasque para cada controlo numa página |Tecla de Tabulação |
| Escolha uma opção |Entrar ou Barra espacial |
| Maximizar página |WIN+UP |
| Página de restauro/minimização |WIN+DOWN |
| Menu de página aberta |BARRA ESPACIAL ALT+ |
...
| Operação | Premir |
| --- | --- |
| Vá para a página seguinte (se estiver ativado) |ALT+N |
| Alterar o tipo selecionado quando o foco estiver em um azulejo |SETA ESQUERDA, PARA CIMA, DIREITA OU PARA BAIXO |
...
| Navegue para cada item de lista |SETA PARA CIMA OU PARA BAIXO |
| Hierarquia do servidor, expandir o nó de uma vista de árvore |SETA DIREITA |
| Mova itens selecionados para **objetos** ou objetos disponíveis **para serem registados** |BARRA ESPACIAL |
...
| Operação | Premir |
| --- | --- |
| Guarde o botão (se estiver ativado) |ALT+S |
| Botão Cancelar |ALT+C |
...
| Perfurar numa secção |ESPAÇO ou ENTER |
| Sair de uma secção |ESC |
| Pin/unpin um ativo |ALT+P |
| Na página de descobrir, quando um ativo tem foco, selecione o ativo |ESPAÇO ou ENTER |
| Adiciona/remove o ativo de vários selecionados |CTRL+SPACE ou ENTER |
| Alternar o menu de correspondências de pesquisa |ALT+S |
| Toggle **Aberto No** menu |ALT+O |
