...
6. Registe os metadados do recurso de dados. Neste exemplo, regista-se objetos de **produto** a partir do espaço de nome da amostra:
    ...
    3. selecione a **seta selecionada pelo movimento** **>** (). Esta ação move todos os objetos selecionados para a lista **Objetos a registar**.
...
6. selecione o separador Perfil de **Dados** para ver o perfil de dados (por exemplo: número de linhas, tamanho de dados ou valor mínimo numa coluna) no ativo de dados.
...
2. selecione **ProductModel** em resultados de pesquisa.  
