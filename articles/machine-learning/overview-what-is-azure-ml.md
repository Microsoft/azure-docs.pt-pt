...
+ **Experiências de rastreio**
  ...
  Aprenda a [rastrear e visualizar experiências de ciência de dados](how-to-track-monitor-analyze-runs.md) no estúdio. 

    :::image type="content" source="media/how-to-track-monitor-analyze-runs/run-history.png" alt-text="Execute detalhes no estúdio Azure Machine Learning":::
...
+ __MLFlow__. Para obter mais informações, consulte [mLflow para rastrear métricas](how-to-use-mlflow.md)  e [implementar modelos Mlflow como um serviço web](how-to-deploy-mlflow-models.md) 
