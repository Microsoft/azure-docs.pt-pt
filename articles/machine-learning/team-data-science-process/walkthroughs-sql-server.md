---
title: Analytics no SQL Server com R, Python e T-SQL - Processo de Ciência de Dados de Equipa
description: Exemplos que percorrem o uso R, Python e T-SQL no SQL Server para fazer análises preditivas.
...
## <a name="predict-taxi-tips-using-python-and-sql-queries-with-sql-server"></a>Prever dicas de táxi usando consultas Python e SQL com SQL Server 

O walkthrough [use SQL Server](sql-walkthrough.md) mostra como constrói e implementa modelos de classificação e regressão de machine learning.  Os dados são uma viagem de táxi e dataset de tarifas de NYC publicamente disponíveis.
