...
* Encontre as suas credenciais de espaço de trabalho a partir de configurações do Azure Machine Learning Studio (clássico). No Azure Machine Learning Studio, clique em  -->    -->  **Tokens de Autorização de Nome** de Definições .
