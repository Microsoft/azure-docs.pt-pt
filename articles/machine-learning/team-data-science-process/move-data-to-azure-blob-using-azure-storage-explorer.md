...
> [!NOTE]
> Se estiver a utilizar VM que foi configurado com os scripts fornecidos pelas [máquinas virtual data science em Azure](virtual-machines.md), então o Azure Storage Explorer já está instalado no VM.
> 
> [!NOTE]
> Para uma introdução completa ao armazenamento de blob Azure, consulte o [Azure Blob Basics](../../storage/blobs/storage-dotnet-how-to-use-blobs.md) e [o Azure Blob Service](https://msdn.microsoft.com/library/azure/dd179376.aspx).   
> 
> 
...
* Para obter instruções sobre a criação de uma conta de armazenamento e para obter informações de conta e informações fundamentais, consulte [as contas de Armazenamento Azure](../../storage/common/storage-create-storage-account.md). Tome nota da chave de acesso da sua conta de armazenamento, pois necessita desta chave para ligar à conta com a ferramenta Azure Storage Explorer.
