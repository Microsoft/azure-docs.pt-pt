...
>
> Ao autenticar uma implantação no Serviço Azure Kubernetes ou em Instâncias de Contentores Azure, é utilizado um método de autenticação diferente. Para obter mais informações, consulte [Configurar a autenticação para os recursos de aprendizagem de máquinas Azure e fluxos de trabalho.](how-to-setup-authentication.md#web-service-authentication)
