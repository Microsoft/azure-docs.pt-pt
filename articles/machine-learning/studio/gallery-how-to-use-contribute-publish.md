...
**[Galeria de ia do Azure](https://gallery.azure.ai)** é um site baseado na Comunidade para descobrir e compartilhar soluções criadas com o Azure ia.
A galeria tem uma variedade de recursos que você pode usar para desenvolver suas próprias soluções de análise.
...
Use esses recursos para saber mais e começar a resolver seus próprios problemas de análise de dados.

Você pode facilmente localizar recursos populares e publicados recentemente na galeria ou pode pesquisar por nome, marcas, algoritmos e outros atributos.
Clique em **Procurar tudo** no cabeçalho da galeria e, em seguida, selecione refinamentos de pesquisa à esquerda da página e insira os termos de pesquisa na parte superior.
Exiba as contribuições de um autor específico clicando no nome do autor de dentro de qualquer um dos blocos.
Você pode comentar, fornecer comentários ou fazer perguntas por meio da seção comentários em cada página de recursos.
Você pode até compartilhar um recurso de interesse com amigos ou colegas usando os recursos de compartilhamento do LinkedIn ou Twitter, ou enviando um link por email.

Quando você entra, você se torna membro da Comunidade da galeria. Isso permite que você baixe recursos ou contribuir com seus próprios itens de galeria para que outras pessoas possam se beneficiar das soluções que você descobriu.

Você pode baixar **experimentos**, **módulos personalizados**e **notebooks Jupyter** para usar no desenvolvimento de suas próprias soluções de análise.
Você pode contribuir com **experimentos**, **tutoriais**e **coleções** para a galeria.

## <a name="download-experiments-modules-notebooks"></a>Baixar experimentos, módulos, notebooks
...
Para baixar um recurso de dentro da Galeria de ia:
...
Você pode ajudar outras pessoas escrevendo um **tutorial** na galeria que explica os conceitos de aprendizado de máquina ou criando uma **coleção** que agrupa vários recursos em uma solução específica.

1. Entre na Galeria usando seu conta Microsoft.

1. Selecione sua imagem no canto superior direito da página e, em seguida, selecione seu nome.
...
Sua contribuição agora está em Galeria de IA do Azure. Suas contribuições são listadas na página sua conta na guia **itens** .

### <a name="add-to-and-edit-your-collection"></a>Adicionar e editar sua coleção

Você pode adicionar itens à sua coleção de duas maneiras:

* Abra a coleção, selecione **Editar**e, em seguida, selecione **Adicionar item**. Você pode adicionar itens que você contribuiu para a galeria ou pode pesquisar a Galeria de itens a serem adicionados. Depois de selecionar os itens que deseja adicionar, clique em **Adicionar**.

* Se você encontrar um item que deseja adicionar enquanto estiver navegando na Galeria, abra o item e selecione **Adicionar à coleção**. Selecione a coleção à qual você deseja adicionar o item.

Você pode editar os itens em sua coleção selecionando **Editar**.

* Você pode alterar o resumo, a descrição ou as marcas da sua coleção.
* Você pode alterar a ordem dos itens na coleção usando as setas ao lado de um item.
* Para adicionar anotações aos itens em sua coleção, selecione o canto superior direito de um item e, em seguida, selecione **Adicionar/Editar Anotação**.
...
Queremos que a Galeria seja orientada por nossos usuários e para nossos usuários. Use o Smiley à direita para nos dizer o que você adora ou testa sobre a galeria.  
