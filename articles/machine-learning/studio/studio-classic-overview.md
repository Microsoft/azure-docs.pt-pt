...
Para alguma ajuda a navegar através da grande biblioteca de algoritmos de machine learning disponíveis, consulte [Como escolher algoritmos para o Microsoft Machine Learning Studio (clássico)](algorithm-choice.md).
