...
* Para obter detalhes sobre como preparar o seu modelo, consulte [Como preparar o seu modelo para implementação no Azure Machine Learning Studio (clássico)](convert-training-experiment-to-scoring-experiment.md).
