...
Você pode adicionar um ponto de extremidade a um serviço Web usando o Azure Machine Learning Portal de serviços Web. Depois que o ponto de extremidade for criado, você poderá consumi-lo por meio de APIs síncronas, APIs de lote e planilhas do Excel.
...
Por padrão, cada serviço Web publicado é configurado para dar suporte a 20 solicitações simultâneas e pode ser tão alto quanto 200 solicitações simultâneas. A versão clássica do Azure Machine Learning Studio otimiza automaticamente a configuração para fornecer o melhor desempenho para o serviço Web e o valor do portal é ignorado.
