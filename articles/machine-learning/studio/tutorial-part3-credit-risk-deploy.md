...
> [!TIP]
> Se quiser mais detalhes sobre o que acontece quando converte uma experiência de treino para uma experiência preditiva, consulte [Como preparar o seu modelo para implantação no Azure Machine Learning Studio (clássico)](convert-training-experiment-to-scoring-experiment.md).
