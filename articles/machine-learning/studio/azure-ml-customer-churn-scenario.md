...
Uma adição interessante aqui é a análise de big data. As empresas de telecomunicações e retalho de hoje recolhem dados exaustivos sobre os seus clientes, e podemos facilmente prever que a necessidade de conectividade multi-modelo se tornará uma tendência comum, dadas as tendências emergentes como a Internet das Coisas e dispositivos ubíquos, que permitem às empresas empregar soluções inteligentes em várias camadas.  
