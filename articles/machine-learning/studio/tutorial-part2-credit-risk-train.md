...
> [!TIP]
> Para obter ajuda para decidir qual o algoritmo machine learning que melhor se adequa ao problema específico que está a tentar resolver, consulte [Como escolher algoritmos para o Microsoft Azure Machine Learning Studio (clássico)](algorithm-choice.md).
> 
> 
