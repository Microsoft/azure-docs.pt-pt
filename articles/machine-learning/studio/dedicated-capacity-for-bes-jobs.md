---
title: Trabalhos de serviço do Lote Azure
titleSuffix: ML Studio (classic) - Azure
description: Visão geral dos serviços do Azure Batch para trabalhos do Machine Learning Studio (clássico). Processamento de conjunto do batch permite-lhe criar conjuntos de onde pode submeter tarefas de lote.
...
> [!NOTE]
> Você deve ter um novo serviço web machine learning baseado em Recursos para criar uma piscina. Uma vez criado, você pode executar qualquer serviço web BES, tanto baseado em New Resource Manager como clássico, na piscina.
...
Para obter mais informações sobre a criação de serviços web, consulte [Implementar um serviço web Azure Machine Learning](deploy-a-machine-learning-web-service.md).
...
"AzureBatchPoolId":"&lt;&gt;de identificação da piscina"
