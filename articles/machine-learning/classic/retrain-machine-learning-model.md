...
1. Copie o código da amostra C# para a execução do lote e cole-o no ficheiro .cs Programa. Certifique-se de que o espaço de nome permanece intacto.
...
Para modificar a definição do modelo treinado para utilizar o modelo recém-treinado, tem primeiro de utilizar o cmdlet [Export-AzMlWebService](/powershell/module/az.machinelearning/export-azmlwebservice) para exportá-lo para um ficheiro em formato JSON.
...
Utilize o cmdlet [Import-AzMlWebService](/powershell/module/az.machinelearning/import-azmlwebservice) para converter o ficheiro JSON modificado de volta num objeto de Definição de Serviço Web que pode utilizar para atualizar a experiência de pretensão.
...
Por fim, utilize o [cmdlet Update-AzMlWebService](/powershell/module/az.machinelearning/update-azmlwebservice) para atualizar a experiência preditiva.
