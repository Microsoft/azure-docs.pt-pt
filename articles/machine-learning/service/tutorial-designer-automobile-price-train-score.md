...
1. Selecione **Designer**.
    ...
    ![Captura de tela do espaço de trabalho Visual mostrando como acessar o designer](./media/ui-tutorial-automobile-price-train-score/launch-visual-interface.png)
...
Há vários exemplos de conjuntos de exemplo incluídos no designer para você experimentar. Para este tutorial, use o exemplo de **dados de preço de automóvel (RAW)** . 
