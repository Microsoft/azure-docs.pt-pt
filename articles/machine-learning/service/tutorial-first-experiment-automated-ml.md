...
* O arquivo de dados **bankmarketing_train. csv** . Baixá-lo [aqui](https://automlsamplenotebookdata.blob.core.windows.net/automl-sample-notebook-data/bankmarketing_train.csv).
