---
title: Implantar modelos no FPGAs
...
ms.locfileid: "68494917"
---
# <a name="deploy-a-model-as-a-web-service-on-an-fpga-with-azure-machine-learning-service"></a>Implantar um modelo como um serviço Web em um FPGA com o serviço Azure Machine Learning
...
Esses modelos estão disponíveis no momento:
  - ResNet 50
  - ResNet 152
  - DenseNet-121
  - VGG-16
...
- Uma área de trabalho do serviço do Azure Machine Learning e o Azure Machine Learning SDK para Python instalada. Para obter mais informações, consulte [criar um espaço de trabalho](setup-create-workspace.md).
...
Para implementar o seu modelo como um serviço da web de produção de grande escala, utilize o Azure Kubernetes Service (AKS). Você pode criar um novo usando o SDK do Azure Machine Learning, a CLI ou a portal do Azure.
...
Para obter informações sobre como proteger os serviços Web do FPGA, consulte o documento [Secure Web Services](how-to-secure-web-service.md) .
