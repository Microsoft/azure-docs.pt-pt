...
1. Se você não tiver uma assinatura do Azure, crie uma conta gratuita antes de começar. Experimente a [versão gratuita ou paga do serviço de Azure Machine Learning](https://aka.ms/AMLFree).
...
![Criar experimento simples](media/how-to-run-batch-predictions-ui/ui-batch-scoring-2.png)
...
![Criar pipeline de inferência de lote](media/how-to-run-batch-predictions-ui/ui-batch-scoring-5.png)
...
![Pipeline de inferência de lote padrão](media/how-to-run-batch-predictions-ui/ui-batch-scoring-6.png)
...
![Configurações de exemplo](media/how-to-run-batch-predictions-ui/ui-batch-scoring-8.png)
...
![Implantação de pipeline](media/how-to-run-batch-predictions-ui/ui-batch-scoring-10.png)
...
![Ponto de extremidade de instalação](media/how-to-run-batch-predictions-ui/ui-batch-scoring-11.png)
...
![Execução de pipeline](media/how-to-run-batch-predictions-ui/ui-batch-scoring-15.png)
