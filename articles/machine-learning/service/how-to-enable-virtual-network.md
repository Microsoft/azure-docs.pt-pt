...
Para obter mais informações, consulte a [criar um conjunto do Batch do Azure numa rede virtual](/azure/batch/batch-virtual-network.md#user-defined-routes-for-forced-tunneling) artigo.
