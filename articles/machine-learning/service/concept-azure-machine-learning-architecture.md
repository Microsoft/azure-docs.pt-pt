...
Para obter um exemplo, [consulte o tutorial: Treine um modelo de classificação de imagem](tutorial-train-models-with-aml.md)com Azure Machine Learning.
