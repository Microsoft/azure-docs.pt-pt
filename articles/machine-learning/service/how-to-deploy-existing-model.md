...
* Uma área de trabalho de serviço do Azure Machine Learning. Para obter mais informações, consulte [criar um espaço de trabalho](setup-create-workspace.md).
