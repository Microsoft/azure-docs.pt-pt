...
Se você receber um erro "não é possível carregar arquivos de projeto no diretório de trabalho no Azurefile porque o armazenamento está sobrecarregado", aplique as seguintes soluções alternativas.
