...
Você pode criar vários espaços de trabalho e cada espaço de trabalho pode ser compartilhado por várias pessoas. Ao compartilhar um espaço de trabalho, você pode controlar o acesso a ele atribuindo essas funções aos usuários:
...
* [Como executar previsões de lote](how-to-run-batch-predictions.md)
