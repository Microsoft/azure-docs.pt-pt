...
Neste artigo, aprende-se a implementar um modelo de designer como ponto final em tempo real no estúdio Azure Machine Learning.

Uma vez registado ou descarregado, pode utilizar modelos treinados como qualquer outro modelo. Os modelos exportados podem ser implementados em casos como internet das coisas (IoT) e implementações locais.
