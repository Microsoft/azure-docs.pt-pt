...
+ [Monitor Azure ML experimenta e métricas](./how-to-log-view-metrics.md)
+ [Monitorizar e recolher dados de pontos finais de serviço Web de ML](./how-to-enable-app-insights.md)