...
Este [artigo](./how-to-run-jupyter-notebooks.md#add-new-kernels) fornece informações sobre como instalar um ambiente Conda como um núcleo num caderno.
