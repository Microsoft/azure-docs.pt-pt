...
Na **segunda parte** do tutorial, você executa o código para treinar um modelo de `tutorial-1st-experiment-sdk-train.ipynb` aprendizagem automática. 
