...
O valor de uma `PipelineData` entrada é o caminho para a saída anterior. Se, como mostrado anteriormente, o primeiro passo escreveu um único ficheiro, consumi-lo pode parecer: 
