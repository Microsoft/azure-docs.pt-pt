...
> [!NOTE]
> Ambas as seguintes imagens VM foram depreciadas:
>
> * Imagem DSVM do Windows Server 2016
> * Imagem Ubuntu 16.04 DSVM 
>
> Estas imagens VM só estão disponíveis para clientes existentes que utilizam implementações ARM. Estas imagens continuarão a receber patches críticos de segurança até à data da sua reforma, mas não serão atualizadas com as mais recentes ferramentas científicas de dados que vão para a frente.
> 
> Consulte a [página DSVM Image Deprecations](./reference-deprecation.md).
...
| ------------- | ------------- |
| Versão(s) suportadas | |
| Edições DSVM suportadas      | Ubuntu 16.04 (depreciado)    |
...
| Edições DSVM suportadas      | Windows Server 2019<br>Ubuntu 18.04<br> Windows 2016 (precotado)<br> Ubuntu 16.04 (depreciado)  |
...
| Edições DSVM suportadas      | Ubuntu 18.04<br> Ubuntu 16.04 (depreciado)   |
...
| Edições DSVM suportadas      | Windows 2016 (precotado)<br> Ubuntu 16.04 (depreciado)   |
...
| Edições DSVM suportadas      | Windows Server 2019<br>Ubuntu 18.04<br> Ubuntu 16.04 (depreciado) |
