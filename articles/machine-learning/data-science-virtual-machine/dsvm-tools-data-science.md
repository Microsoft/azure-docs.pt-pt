...
| Usos típicos      | Biblioteca geral de aprendizagem automática      |
| Como é configurado ou instalado?      |  Instalado com suporte gpu   |
| Como usá-lo ou executá-lo      | Como uma biblioteca Python (2.7 e 3.6+), pacote R e ferramenta de linha de comando on-path `C:\dsvm\tools\xgboost\bin\xgboost.exe` (para Windows e `/dsvm/tools/xgboost/xgboost` linux)    |
