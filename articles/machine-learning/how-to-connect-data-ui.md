...
Depois de criar uma datastore, crie um conjunto de dados para interagir com os seus dados. Os conjuntos de dados embalam os seus dados num objeto consumível avaliado preguiçosamente para tarefas de aprendizagem automática, como o treino. [Saiba mais sobre conjuntos de dados.](how-to-create-register-datasets.md)
...
* Se planeia utilizar um [principal de serviço](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal) para autenticação, vá às **inscrições da** sua App e selecione qual a aplicação que pretende utilizar.
