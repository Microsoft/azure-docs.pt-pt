...
> [!IMPORTANT]
> O motor SQL utilizado neste módulo é **SQLite.** Para obter mais informações sobre a sintaxe SQLite, consulte [SQL como entendido pela SQLite](https://www.sqlite.org/index.html) para obter mais informações.  
