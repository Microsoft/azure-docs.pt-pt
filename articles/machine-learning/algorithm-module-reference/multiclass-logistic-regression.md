...
description: Aprenda a usar o módulo de Regressão Logística Multiclass no Azure Machine Learning para criar um modelo de regressão logística que pode ser usado para prever múltiplos valores.
