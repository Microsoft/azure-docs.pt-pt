...
description: Saiba mais sobre os módulos de serviço web no Azure Machine Learning designer (pré-visualização)
...
Este artigo descreve os módulos de entrada de serviço web e de saída de serviço web no designer de aprendizagem automática Azure (pré-visualização).
