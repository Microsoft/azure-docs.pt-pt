...
1.  Adicione os **recursos extrair N-Gram do módulo de texto** ao seu experimento e conecte o conjunto de um que contém o texto que você deseja processar à porta do **conjunto** de recursos.
