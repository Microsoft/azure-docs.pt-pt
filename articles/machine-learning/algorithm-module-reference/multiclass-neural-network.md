...
description: Aprenda a usar o módulo Multiclass Neural Network em Azure Machine Learning para criar um modelo de rede neural que pode ser usado para prever um alvo que tem múltiplos valores.
