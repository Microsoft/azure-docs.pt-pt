...
* SSDT para Visual Studio. Se tem o Visual Studio, provavelmente já tem SSDT para Estúdio Visual. Para instruções e opções de instalação, consulte [Instalar o Visual Studio e SSDT](sql-data-warehouse-install-visual-studio.md).
...
2. Abra o Explorador de Objetos do Servidor SQL selecionando **a visualização** > Explorador de **Objetos do Servidor SQL**.
...
3. Copie a seguinte consulta T-SQL na janela de consulta:
    ...
    ```
4. Executar a consulta clicando na seta verde ou use o seguinte atalho: `CTRL`+`SHIFT`+`E`.
