---
title: Limites de capacidade-SQL Data Warehouse do Azure | Microsoft Docs
...
ms.locfileid: "71686428"
---
# <a name="sql-data-warehouse-capacity-limits"></a>Limites de capacidade de SQL Data Warehouse
...
|:--- |:--- |:--- |
| [Unidades de data warehouse (DWU)](what-is-a-data-warehouse-unit-dwu-cdwu.md) |DWU Max para um único SQL Data Warehouse | Gen1 DW6000<br></br>Gen2 DW30000c |
...
| Ligação à base de dados |Máximo de sessões abertas simultâneas |1024<br/><br/>O número de sessões abertas simultâneas irá variar com base no DWU selecionado. O DWU600c e superior dão suporte a um máximo de 1024 sessões abertas. DWU500c e abaixo, dão suporte a um limite máximo de sessão de abertura simultânea de 512. Observe que há limites no número de consultas que podem ser executadas simultaneamente. Quando o limite de simultaneidade for excedido, a solicitação entrará em uma fila interna onde aguardará o processamento. |
| Ligação à base de dados |Memória máxima para instruções preparadas |20 MB |
| [Gestão de cargas de trabalho](resource-classes-for-workload-management.md) |Máximo de consultas simultâneas |128<br/><br/> SQL Data Warehouse pode executar no máximo 128 consultas simultâneas e filas restantes.<br/><br/>O número de consultas simultâneas pode diminuir quando os usuários são atribuídos a classes de recursos mais altas ou quando SQL Data Warehouse tem uma configuração de [unidade de data warehouse](memory-and-concurrency-limits.md) inferior. Algumas consultas, como consultas DMV, sempre podem ser executadas e não afetam o limite de consultas simultâneas. Para obter mais detalhes sobre a execução de consultas simultâneas, consulte o artigo de [máximos de simultaneidade](memory-and-concurrency-limits.md#concurrency-maximums) . |
...
| Identificadores por instrução |Número de identificadores referenciados |65,535<br/><br/>SQL Data Warehouse limita o número de identificadores que podem estar contidos em uma única expressão de uma consulta. Exceder esse número resulta na SQL Server do erro 8632. Para obter mais informações, consulte erro de [Internal: Um limite de serviços de expressão foi atingido @ no__t-0. |
| Literais de cadeia de caracteres | Número de literais de cadeia de caracteres em uma instrução | 20,000 <br/><br/>SQL Data Warehouse limita o número de constantes de cadeia de caracteres em uma única expressão de uma consulta. Exceder esse número resulta na SQL Server do erro 8632.|
...
| sys.dm_pdw_request_steps |Número total de etapas para as solicitações SQL mais recentes de 1000 que são armazenadas em sys. dm _pdw_exec_requests. |
| sys.dm_pdw_os_event_logs |10,000 |
| sys.dm_pdw_sql_requests |As solicitações SQL mais recentes de 1000 que são armazenadas em sys. dm _pdw_exec_requests. |

## <a name="next-steps"></a>Passos seguintes
Para obter recomendações sobre como usar SQL Data Warehouse, consulte a [folha](cheat-sheet.md)de consulta.
