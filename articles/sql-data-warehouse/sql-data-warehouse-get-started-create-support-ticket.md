...
O passo final é preencher os detalhes restantes do seu pedido de suporte da Base de Dados SQL. Em seguida, selecione **Next: Review + create>>** e depois de rever os detalhes do pedido, clique **em Criar** para submeter o pedido.
