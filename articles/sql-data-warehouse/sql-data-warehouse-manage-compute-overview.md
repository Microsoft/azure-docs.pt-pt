...
Pode escalar ou escalar a computação traseira ajustando a definição das [unidades](what-is-a-data-warehouse-unit-dwu-cdwu.md) de armazém de dados para a sua piscina SQL. O desempenho de carregamento e consulta pode aumentar linearmente à medida que adiciona mais unidades de armazém de dados. 
...
| Unidades do armazém de dados  | \# de substantivos de computação | \# de distribuições por nó |
| -------- | ---------------- | -------------------------- |
| DW100c   | 1                | 60                         |
| DW200c   | 1                | 60                         |
| DW300c   | 1                | 60                         |
...
A escala ção do pool SQL requer as permissões descritas na BASE DE [DADOS ALTER](/sql/t-sql/statements/alter-database-azure-sql-data-warehouse).  Pausa e Retoma requerem a permissão [do Contribuinte SQL DB,](../role-based-access-control/built-in-roles.md#sql-db-contributor) especificamente Microsoft.Sql/servers/bases de dados/ação.
