...
- 72 MB +
- \#filas \* colunas \#\* 8 bytes +
- \#filas \* \#colunas de cordas curtas \* 32 bytes +
- \#colunas de longas cordas \* 16 MB para dicionário de compressão

onde as colunas de cadeias curtas utilizam tipos de dados de cordas de <= 32 bytes e colunas de longas cordas usam tipos de dados de cordas de > 32 bytes.
...
Para uma discussão aprofundada dos requisitos de memória da columnstore, consulte o vídeo [SQL Analytics: configuração e orientação](https://channel9.msdn.com/Events/Ignite/2016/BRK3291).
