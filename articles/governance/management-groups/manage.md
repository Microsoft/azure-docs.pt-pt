...
Ao mover um grupo de gestão principal, a hierarquia de grupo seja também movido. Para o acesso tem de mover grupos de gestão, consulte [acesso de grupo de gestão](index.md#management-group-access).
