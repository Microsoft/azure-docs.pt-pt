...
1. Selecione **+ Adicionar grupo de gestão**.
   ...
   :::image type="content" source="./media/main.png" alt-text="Screenshot da página de grupos de gestão mostrando grupos de gestão de crianças e subscrições.":::
