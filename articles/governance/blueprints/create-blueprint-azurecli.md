...
- Se nunca tenha utilizado a Azure Blueprints antes, registe o fornecedor de recursos através do Azure CLI com `az provider register --namespace Microsoft.Blueprint` .
