---
title: Controlos de amostrade amostra de amostra de carga de carga ASE/SQL ISO 27001
description: Mapeamento de controlo da amostra de projeto de carga de trabalho do serviço de aplicações ISO 27001 para a Política Azure e RBAC.
ms.date: 01/13/2020
ms.topic: sample
...
---
# <a name="control-mapping-of-the-iso-27001-asesql-workload-blueprint-sample"></a>Mapeamento de controlo da amostra de projeto de carga de trabalho Iso 27001 ASE/SQL

O seguinte artigo detalha como os mapas da amostra de amostra seletiva ASE/SQL da ASE/SQL para os controlos ISO 27001. Para obter mais informações sobre os controlos, consulte [ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
- \[Pré-visualização\]: Auditar número mínimo de proprietários para subscrição
...
Agora que reviu o mapeamento de controlo da amostra de base de trabalho iso 27001 App Service Environment/SQL Database, visite os seguintes artigos para saber sobre a arquitetura e como implementar esta amostra:

> [!div class="nextstepaction"]
> [ISO 27001 App Service Environment/SQL Base de dados plano de carga de trabalho - Visão geral](./index.md)
> [ISO 27001 App Service Environment/SQL Database workload blueprint - Implementar passos](./deploy.md)
