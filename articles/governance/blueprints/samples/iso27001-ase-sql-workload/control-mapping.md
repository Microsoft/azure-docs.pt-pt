...
- \[Preview @ no__t-1: Número mínimo de auditoria de proprietários para assinatura
...
> [ISO 27001 ambiente do serviço de aplicativo/especificação técnica de carga de trabalho do banco de dados SQL](./deploy.md)
