---
title: Implementar amostra de planta alta da FedRAMP
...
ms.locfileid: "100594775"
---
# <a name="deploy-the-fedramp-high-blueprint-sample"></a>Implementar a amostra de planta alta fedRAMP

Para implantar a amostra de planta Azure Blueprints FedRAMP High, devem ser tomadas as seguintes medidas:
...
1. Encontre a amostra de planta **High FedRAMP** em _outras amostras_ e selecione **Utilize esta amostra.**

1. Introduza as _Informações Básicas_ do esquema de exemplo:

   - **Nome da planta**: Forneça um nome para a sua cópia da amostra de planta Da FedRAMP High.
...
1. Selecione **Publicar esquema**, na parte superior da página. Na página nova à direita, indique uma **Versão** para a cópia do esquema de exemplo. Esta propriedade é útil se fizer modificações mais tarde. Fornecer **notas de mudança** como "Primeira versão publicada a partir da amostra de planta da FedRAMP High". Em seguida, selecione **Publicar**, na parte inferior da página.
...
>  [FedRAMP High blueprint - Control mapeamento](./control-mapping.md)
