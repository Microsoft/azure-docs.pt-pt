...
|SKUs de máquina virtual permitida|Atribuição de políticas|Lista de SKUs de máquina virtual permitida|A lista de SKUs que pode ser especificada para máquinas virtuais.|
