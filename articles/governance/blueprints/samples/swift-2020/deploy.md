...
description: Implante as etapas para o CSP SWIFT-CSCF v2020 Blueprint de exemplo, incluindo detalhes do parâmetro de artefato do Blueprint.
author: DCtheGeek
ms.author: dacoulte
ms.date: 09/24/2019
ms.topic: sample
...
1. Insira os _conceitos básicos_ do exemplo Blueprint:
   ...
   - **Nome do plano gráfico**: forneça um nome para sua cópia da amostra do CSCF v2020 Blueprint do Swift CSP.
...
|\[Preview @ no__t-1: Audit SWIFT CSP – CSCF v2020 Controls e implante extensões de VM específicas para dar suporte aos requisitos de auditoria|Atribuição de política|IDs de espaço de trabalho conectadas|Uma lista separada por ponto-e-vírgula das IDs de espaço de trabalho às quais o agente de Log Analytics deve estar conectado|
