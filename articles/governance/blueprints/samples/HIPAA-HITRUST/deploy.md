...
Para implantar a amostra de planta HIPAA HITRUST, devem ser tomadas as seguintes medidas:
...
1. **Selecione Publicar** a planta no topo da página. Na nova página à direita, forneça uma **versão** para a sua cópia da amostra de planta. Esta propriedade é útil para se você fizer uma modificação mais tarde. Fornecer **notas de alteração** tais como "Primeira versão publicada a partir da amostra de planta HITRUST HIPAA." Em seguida, **selecione Publicar** na parte inferior da página.
...
> [Plantas HITRUST HIPAA - Visão geral](./index.md) 
>  [Plantas HITRUST HIPAA - Controlo de mapeamento](./control-mapping.md)
