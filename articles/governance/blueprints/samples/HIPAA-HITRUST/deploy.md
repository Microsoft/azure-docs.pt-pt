---
title: Implementar a amostra de planta HIPAA HITRUST
description: Desloque os passos para a amostra de planta HIPAA HITRUST, incluindo detalhes do parâmetro do artefacto da planta.
ms.date: 12/03/2019
ms.topic: sample
...
---
# <a name="deploy-the-hipaa-hitrust-blueprint-sample"></a>Implementar a amostra de plantas HIPAA HITRUST

Para implantar a amostra de plantas HIPAA HITRUST, devem ser tomadas as seguintes medidas:
...
1. Selecione **Publicar a planta** no topo da página. Na nova página à direita, forneça uma **Versão** para a sua cópia da amostra de plantas. Esta propriedade é útil para se fizer uma modificação mais tarde. Forneça notas de **alteração** como "Primeira versão publicada a partir da amostra de plantas HIPAA da HITRUST." Em seguida, **selecione Publicar** na parte inferior da página.
...
|\[Pré-visualização\]: Audite os controlos HIPAA da HITRUST e implemente extensões vm específicas para apoiar os requisitos de auditoria |Atribuição de política |Grupo de administradores |Grupo, grupo. Exemplo: `Administrator; myUser1; myUser2` |
...
Agora que reviu os passos para implementar a amostra HITRUST HIPAA, visite os seguintes artigos para saber sobre a visão geral e o mapeamento de controlo:

> [!div class="nextstepaction"]
> [Plantas HIPAA hitrust - Visão geral](./index.md)
> [das plantas hipaa da HITRUST - Mapeamento de controlo](./control-mapping.md)
