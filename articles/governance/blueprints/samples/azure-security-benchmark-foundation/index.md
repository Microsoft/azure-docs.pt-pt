...
- [Os registos do Monitor Azure](../../../../azure-monitor/logs/data-platform-logs.md) e uma conta de armazenamento Azure para garantir registos de recursos, registos de atividades, métricas e fluxos de tráfego de redes são armazenados num local central para fácil consulta, análise, arquivo e alerta.
