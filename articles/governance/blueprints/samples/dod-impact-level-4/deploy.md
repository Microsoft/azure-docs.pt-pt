...
|\[Pré-visualização \] : DoD Impact Level 4|Atribuição de política|Lista de utilizadores que devem ser excluídos do grupo de administradores do Windows VM|Uma lista separada de membros que deve ser excluída no grupo local de administradores. Ex: Administrador; myUser1; myUser2|
|\[Pré-visualização \] : DoD Impact Level 4|Atribuição de política|Lista de utilizadores que devem ser incluídos no grupo de administradores do Windows VM|Uma lista separada de membros que deve ser incluída no grupo local de administradores. Ex: Administrador; myUser1; myUser2|
...
|\[Pré-visualização \] : DoD Impact Level 4|Atribuição de política|Locais permitidos para recursos e grupos de recursos|Lista de locais Azure que a sua organização pode especificar ao utilizar recursos. Este valor fornecido é também utilizado pela política "Locais Permitidos" no âmbito da iniciativa política.|
...
|\[Pré-visualização \] : DoD Impact Level 4|Atribuição de política|A avaliação da vulnerabilidade deve ser ativada em Máquinas Virtuais|Informações sobre os efeitos da política podem ser encontradas na [Understand Azure Policy Effects](../../../policy/concepts/effects.md).|
...
|\[Pré-visualização \] : DoD Impact Level 4|Atribuição de política|Backup geo-redundante deve ser ativado para Azure Database for MariaDB|Informações sobre os efeitos da política podem ser encontradas na [Understand Azure Policy Effects](../../../policy/concepts/effects.md).|
...
|\[Pré-visualização \] : DoD Impact Level 4|Atribuição de política|As regras do Grupo de Segurança da Rede para máquinas virtuais com internet devem ser endurecidas|Informações sobre os efeitos da política podem ser encontradas na [Understand Azure Policy Effects](../../../policy/concepts/effects.md).|
