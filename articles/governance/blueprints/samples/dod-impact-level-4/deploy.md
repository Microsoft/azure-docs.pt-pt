...
Para implantar a amostra de projeto do Departamento de Impacto de Defesa do Azure Blueprints Nível 4 (DoD IL4), devem ser tomadas as seguintes medidas:
...
1. Encontre a amostra de planta do **Nível de Impacto do DoD 4** em _outras amostras_ e selecione **Utilize esta amostra**.

1. Introduza os _Fundamentos_ da amostra de plantas:

   - **Nome**da planta : Forneça um nome para a sua cópia da amostra de planta do Nível de Impacto 4 do DoD.
...
1. Selecione **Publicar a planta** no topo da página. Na nova página à direita, forneça uma **Versão** para a sua cópia da amostra de plantas. Esta propriedade é útil para se fizer uma modificação mais tarde. Forneça notas de **alteração** como "Primeira versão publicada a partir da amostra de plantas DoD IL4." Em seguida, **selecione Publicar** na parte inferior da página.
