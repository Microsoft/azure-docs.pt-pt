...
- \[Preview\]: Implemente pré-requisitos para auditar VMs do Windows que não restringem o comprimento mínimo da palavra-passe a 14 caracteres
...
- \[\]de pré-visualização : Implementar pré-requisitos para auditar configurações de VMs do Windows em 'Atribuição de Direitos de Utilizador'
...
- \[Pré-visualização\]: Mostrar resultados de auditoria das configurações dos VMs do Windows em 'Opções de Segurança - Configurações do Sistema'
...
- [Preview\]: Controlo de Acesso baseado em funções (RBAC) deve ser utilizado nos serviços kubernetes
...
- \[Preview\]: Implementar pré-requisitos para auditar configurações de VMs do Windows em 'Opções de Segurança - Acesso à Rede'

### <a name="ac-142--ac--143---remote-access-for-non-employees-must-be-restricted-to-allow-access-only-to-specifically-approved-information-systems"></a>AC-1.42 e AC- 1.43 - O acesso remoto a não empregados deve ser restrito para permitir o acesso apenas a sistemas de informação especificamente aprovados

- \[Preview\]: Mostrar resultados de auditoria de VMs Linux que permitem ligações remotas a partir de contas sem senhas
...
## <a name="auditing--logging"></a>Auditoria e Exploração Madeireira
...
- \[Pré-visualização\]: Mostrar resultados de auditoria das configurações dos VMs do Windows em 'Opções de Segurança - Contas'
- \[preview\]: Implementar pré-requisitos para auditar configurações de VMs do Windows em 'Opções de Segurança - Cliente da Rede Microsoft'
...
- \[Preview\]: Mostrar resultados de auditoria das configurações dos VMs do Windows em 'Opções de Segurança - Consola de recuperação'
...
- \[Pré-visualização\]: Implemente pré-requisitos para auditar VMs do Windows que contenham certificados que expirem dentro do número especificado de dias
...
## <a name="change--config-management"></a>Gestão de Alterações e Config
...
- \[Preview\]: Mostrar resultados de auditoria das configurações dos VMs do Windows em 'Windows Firewall Properties'
...
- \[Pré-visualização\]: Implemente pré-requisitos para auditar configurações de VMs do Windows em 'Windows Firewall Properties'
...
> [Projeto dos media - Visão geral](./control-mapping.md)
> Projeto de Media - Implementar [etapas](./deploy.md)
