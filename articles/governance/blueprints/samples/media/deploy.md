---
title: Implementar amostra de projeto de mídia
description: Desloque os passos para a amostra de projeto de mídia, incluindo detalhes do parâmetro do artefacto da planta.
ms.date: 02/25/2020
ms.topic: sample
...
Para implantar a amostra de projeto dos Meios de Comunicação Social, devem ser tomadas as seguintes medidas:
...
1. Encontre a amostra da planta **Media** em _Outras Amostras_ e selecione **Utilize esta amostra**.
...
1. Selecione **Publicar a planta** no topo da página. Na nova página à direita, forneça uma **Versão** para a sua cópia da amostra de plantas. Esta propriedade é útil para se fizer uma modificação mais tarde. Forneça **notas de alteração** como "Primeira versão publicada a partir da amostra de projeto dos Media". Em seguida, **selecione Publicar** na parte inferior da página.
