...
|\[Pré-visualização \] : Audit Media controls e implementar extensões VM específicas para suportar requisitos de auditoria |Atribuição de política |Log Analytics workspace ID que VMs deve ser configurado para |Este é o ID (GUID) do espaço de trabalho Log Analytics para o qual os VMs devem ser configurados. |
...
|\[Pré-visualização \] : Audit Media controls e implementar extensões VM específicas para suportar requisitos de auditoria |Atribuição de política |Grupo de administradores |Grupo. Exemplo: `Administrator; myUser1; myUser2` |
