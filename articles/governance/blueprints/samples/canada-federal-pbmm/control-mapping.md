---
title: Exemplo-Canadá Federal PBMM Blueprint – mapeamento de controle
...
O artigo a seguir fornece detalhes sobre como a amostra do plano gráfico do plano gráfico do Azure com o governo federal protegido B, de integridade média, de disponibilidade média (PBMM) é mapeada para os controles federais PBMM do Canadá. Para obter mais informações sobre os controles, consulte [Canadá Federal PBMM](https://www.canada.ca/en/government/system/digital-government/modern-emerging-technologies/cloud-services/government-canada-security-control-profile-cloud-based-it-services.html#toc4).

Os mapeamentos a seguir são para os controles **federais PBMM do Canadá** . Use a navegação à direita para ir diretamente para um mapeamento de controle específico. Muitos dos controles mapeados são implementados com uma iniciativa de [Azure Policy](../../../policy/overview.md) . Para examinar a iniciativa completa, abra a **política** no portal do Azure e selecione a página **definições** . Em seguida, localize e selecione o ** @ no__t-1Preview @ no__t-2: Faça auditoria dos controles PBMM federais do Canadá @ no__t-0 iniciativa de política interna.
...
## <a name="location-constraints"></a>Restrições de local

Este projeto ajuda a restringir o local da implantação de todos os recursos e grupos de recursos para o "centro-Canadá" e o "leste do Canadá" atribuindo as seguintes definições de Azure Policy:

- Locais permitidos (com código embutido no "Canadá central" e "leste do Canadá")
- Locais permitidos para grupos de recursos (foram embutidos em código para "Canadá central" e "leste do Canadá")
...
## <a name="ac-6-least-privilege"></a>Privilégios mínimos de AC-6
...
- \[Preview @ no__t-1: Log Analytics do espaço de trabalho de auditoria para VM – relatar incompatibilidade
...
## <a name="ia-8-100-identification-and-authentication-non-organizational-users--identity-and-credential-assurance-levels"></a>Identificação e autenticação IA-8 (100) (usuários não organizacionais) | Níveis de garantia de identidade e credencial
