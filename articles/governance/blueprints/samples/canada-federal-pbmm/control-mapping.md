...
O seguinte artigo detalha como o Azure Blueprints Canada Federal Protected B, Medium Integrity, Medium Availability (PBMM) mapeia os mapas de amostras de pBMM federais do Canadá. Para obter mais informações sobre os controlos, consulte [o Canadá Federal PBMM](https://www.canada.ca/en/government/system/digital-government/modern-emerging-technologies/cloud-services/government-canada-security-control-profile-cloud-based-it-services.html#toc4).

Os seguintes mapeamentos são para os controlos **Federais de PBMM** do Canadá. Utilize a navegação à direita para saltar diretamente para um mapeamento de controlo específico. Muitos dos controlos mapeados são implementados com uma iniciativa da [Política Azure.](../../../policy/overview.md) Para rever a iniciativa completa, abra a **Política** no portal Azure e selecione a página **Definições.** Em seguida, encontre e selecione a ** \[Pré-Visualização\]: Audite o PBMM Federal do Canadá controla** a iniciativa política incorporada.
...
Este plano ajuda-o a restringir a localização para a implantação de todos os recursos e grupos de recursos para "Canadá Central" e "Canadá Leste", atribuindo as seguintes definições de Política Azure:

- Locais permitidos (foi codificado duramente para "Canadá Central" e "Canadá Leste")
- Locais permitidos para grupos de recursos (foi codificado duramente para "Canadá Central" e "Canadá Leste")
...
## <a name="ac-6-least-privilege"></a>Privilégio Menos AC-6
...
## <a name="ia-8-100-identification-and-authentication-non-organizational-users--identity-and-credential-assurance-levels"></a>IA-8 (100) Identificação e Autenticação (Utilizadores Não Organizantes) [ Utilizadores Não Organizantes) [ Utilizadores Não Organizantes) [ Utilizadores Não Organizantes) [ Utilizadores Não Organizantes) [ Utilizadores Não Organizantes) [ Utilizadores Não Organizantes) [ Utilizadores Não Organizantes) [ Utilizadores Não Níveis de Garantia de Identidade e Credenciais
...
Revistei o mapeamento de controlo da amostra de plantas pBMM federais do Canadá. Em seguida, visite os seguintes artigos para saber sobre a visão geral e como implementar esta amostra:

> [!div class="nextstepaction"]
> [Planta Federal PBMM do Canadá - Visão geral](./control-mapping.md)
> [do Canadá Plano Federal pBMM - Desdobrar etapas](./deploy.md)
