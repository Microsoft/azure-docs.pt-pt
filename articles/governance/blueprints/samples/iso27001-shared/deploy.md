...
|Grupo de recursos Log Analytics|Grupo de recursos|Nome|**Locked** - Concatenates o **nome da Organização** para tornar o grupo de recursos `-sharedsvsc-log-rg` único.|
...
|Grupo de recursos de rede|Grupo de recursos|Nome|**Locked** - Concatenates o **nome da Organização** para tornar o grupo de recursos `-sharedsvcs-net-rg` único.|
...
|Grupo de recursos Key Vault|Grupo de recursos|Nome|**Locked** - Concatenates o **nome da Organização** para tornar o grupo de recursos `-sharedsvcs-kv-rg` único.|
...
|Grupo de recursos Jumpbox|Grupo de recursos|Nome|**Locked** - Concatenates o **nome da Organização** para tornar o grupo de recursos `-sharedsvcs-jb-rg` único.|
...
|Grupo de recursos de serviços de domínio de diretório ativo|Grupo de recursos|Nome|**Locked** - Concatenates o **nome da Organização** para tornar o grupo de recursos `-sharedsvcs-adds-rg` único.|
