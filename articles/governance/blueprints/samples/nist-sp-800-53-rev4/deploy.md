...
Para implantar a amostra de plantas Azure NIST SP 800-53 R4, devem ser tomadas as seguintes medidas:
...
1. Encontre a amostra de plantas **NIST SP 800-53 R4** em _outras amostras_ e selecione **Utilize esta amostra**.

1. Introduza os _Fundamentos_ da amostra de plantas:

   - **Nome**da planta : Forneça um nome para a sua cópia da amostra de plantas NIST SP 800-53 R4.
