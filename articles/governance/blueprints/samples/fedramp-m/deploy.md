---
title: Implementar a amostra de plantas moderadas fedRAMP
description: Desloque os passos para a amostra de plantas moderadas fedRAMP, incluindo detalhes do parâmetro de artefacto de plantas.
ms.date: 05/14/2020
ms.topic: sample
...
ms.locfileid: "83816255"
---
# <a name="deploy-the-fedramp-moderate-blueprint-sample"></a>Implementar a amostra de plantas moderadas fedRAMP

Para implantar a amostra de plantas FedRAMP Moderada seleções do Azure Blueprints, devem ser tomadas as seguintes medidas:
...
1. Encontre a amostra de plantas **moderada selada fedRAMP** em _outras amostras_ e selecione **Utilize esta amostra**.

1. Introduza os _Fundamentos_ da amostra de plantas:

   - **Nome**da planta : Forneça um nome para a sua cópia da amostra de plantas moderadas FedRAMP.
...
Agora que reviu os passos para implementar a amostra de plantas moderadas fedRAMP, visite os seguintes artigos para saber sobre o mapeamento de plantas e controlo:

> [!div class="nextstepaction"]
> [FedRAMP Projeto moderado - Visão geral](./index.md) 
>  [FedRAMP Planta moderada - Mapeamento de controlo](./control-mapping.md)
