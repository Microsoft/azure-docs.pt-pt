...
description: Controlo do mapeamento da amostra de planta do IRS 1075. Cada controlo é mapeado para uma ou mais Políticas Azure que ajudam na avaliação.
ms.date: 08/19/2020
ms.topic: sample
...
## <a name="9321-ac-2-7-account-management--role-based-schemes"></a>9.3.2.1 AC-2 (7) Gestão de Conta Regimes baseados em funções
...
## <a name="9321-ac-2-12-account-management--account-monitoring--atypical-usage"></a>9.3.2.1 AC-2 (12) Gestão de Conta Monitorização de Conta / Utilização Atípica
...
## <a name="9316-ac-6-7-least-privilege--review-of-user-privileges"></a>9.3.1.6 AC-6 (7) Menos Privilégio Revisão dos Privilégios de Utilização
...
## <a name="9336-au-6-4-audit-review-analysis-and-reporting--central-review-and-analysis"></a>9.3.3.6 AU-6 (4) Análise, Análise e Reporte de Auditoria Análise e Análise Central
...
## <a name="9375-ia-5-1-authenticator-management--password-based-authentication"></a>9.3.7.5 IA-5 (1) Gestão de Autenticadores / Autenticação baseada em palavras-passe
