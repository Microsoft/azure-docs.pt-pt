...
description: Esta definição de política de exemplo requer que um grupo de segurança de rede específico seja usado com cada interface de rede virtual.
ms.date: 01/23/2019
ms.topic: sample
