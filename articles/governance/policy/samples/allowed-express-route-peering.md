---
title: Exemplo-locais de emparelhamento de ExpressRoute permitidos
description: Esta definição de política de exemplo requer que o ExpressRoute use locais de emparelhamento especificados definidos em um parâmetro.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463449"
---
# <a name="sample---allowed-peering-location-for-expressroute"></a>Exemplo-local de emparelhamento permitido para o ExpressRoute
