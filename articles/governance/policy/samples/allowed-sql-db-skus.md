---
title: Exemplo – SKUs de BD SQL permitidas
description: Esta definição de política de exemplo requer que os bancos de dados SQL usem um SKU aprovado. Novos recursos que não atendem ao requisito são negados.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74076382"
---
# <a name="sample---allowed-sql-database-skus"></a>Exemplo – SKUs do banco de dados SQL permitido
