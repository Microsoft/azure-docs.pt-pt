...
description: Esta definição de política de exemplo requer que máquinas virtuais e conjuntos de dimensionamento de máquinas virtuais usem discos gerenciados.
ms.date: 01/23/2019
ms.topic: sample
