...
description: Esta definição de política de exemplo requer que a criptografia de arquivo esteja habilitada para todas as contas de armazenamento do Azure.
ms.date: 01/23/2019
ms.topic: sample
