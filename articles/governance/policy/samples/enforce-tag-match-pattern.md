---
title: Exemplo – impor padrão de correspondência de marca
description: Esta definição de política de exemplo requer que os recursos atendam ao padrão de correspondência para o valor de marca para um formato de data específico.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463353"
---
# <a name="sample---enforce-tag-match-pattern-for-tag-values"></a>Exemplo – impor padrão de correspondência de marca para valores de marca
