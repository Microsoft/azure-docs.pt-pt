...
description: Esta definição de política de exemplo proíbe o uso de extensões especificadas definidas em um parâmetro em máquinas virtuais.
ms.date: 01/23/2019
ms.topic: sample
