---
title: Exemplo-usar vNet listada para interfaces de rede de VM
description: Esta definição de política de exemplo requer que as interfaces de rede usem uma rede virtual aprovada definida em um parâmetro.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463103"
---
# <a name="sample---use-approved-vnet-for-vm-network-interfaces"></a>Exemplo – usar vNet aprovada para interfaces de rede de VM
