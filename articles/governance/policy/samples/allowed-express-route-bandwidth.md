...
description: Essa definição de política de exemplo requer que o ExpressRoute use um conjunto especificado de larguras de banda definido em um parâmetro.
ms.date: 01/23/2019
ms.topic: sample
