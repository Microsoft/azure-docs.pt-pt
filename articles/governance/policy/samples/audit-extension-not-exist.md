...
description: Esta definição de política de exemplo audita se uma extensão definida em um parâmetro não é implantada em uma máquina virtual.
ms.date: 01/23/2019
ms.topic: sample
