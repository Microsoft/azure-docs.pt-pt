...
description: Esta definição de política de exemplo proíbe o uso do benefício de uso híbrido do Azure (AHUB) para máquinas virtuais e conjuntos de dimensionamento de máquinas virtuais.
ms.date: 01/23/2019
ms.topic: sample
