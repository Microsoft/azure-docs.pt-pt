---
title: Detalhes da conformidade regulamentar para cis Microsoft Azure Foundations Benchmark 1.1.0
description: Detalhes da iniciativa cis Microsoft Azure Foundations Benchmark 1.1.0 Regulatory Compliance incorporada. Cada controlo é mapeado para uma ou mais definições da Política Azure que ajudam na avaliação.
ms.date: 04/14/2021
ms.topic: sample
ms.custom: generated
...
ms.locfileid: "107497749"
---
# <a name="details-of-the-cis-microsoft-azure-foundations-benchmark-110-regulatory-compliance-built-in-initiative"></a>Detalhes da iniciativa cis Microsoft Azure Foundations Benchmark 1.1.0 Regulatory Compliance

O artigo que se segue detalha como a definição de iniciativa integrada na conformidade da política Azure mapeia **os domínios** e **controlos** de conformidade no CIS Microsoft Azure Foundations Benchmark 1.1.0.
...
Em seguida, encontre e selecione a definição de iniciativa de referência das **Fundações CIS Microsoft Azure v1.1.0** Regulatory Compliance incorporada.

Esta iniciativa incorporada é implementada como parte da amostra de [projeto benchmark 1.1.0 das Fundações CIS Microsoft Azure Foundations.](../../blueprints/samples/cis-azure-1-1-0.md)
...
|Name<br /><sub>(Portal Azure)</sub> |Description |Efeito(s) |Versão<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Azure Key Vault Gerido HSM deve ter proteção de purga ativada](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc39ba22d-4428-4149-b981-70acb31fc383) |A eliminação maliciosa de um Cofre de Chave Azure Gerido HSM pode levar à perda permanente de dados. Um infiltrado malicioso na sua organização pode potencialmente eliminar e purgar o Azure Key Vault Managed HSM. A proteção de purga protege-o de ataques de infiltrados, impondo um período de retenção obrigatório para o Azure Key Vault Gerido HSM. Ninguém dentro da sua organização ou microsoft será capaz de purgar o seu Azure Key Vault Managed HSM durante o período de retenção de eliminação suave. |Auditoria, Negar, Deficientes |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Key%20Vault/ManagedHsm_Recoverable_Audit.json) |
