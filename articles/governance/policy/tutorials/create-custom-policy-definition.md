...
description: Crie uma definição de política personalizada para Azure Policy para impor regras de negócios personalizadas em seus recursos do Azure.
ms.date: 04/23/2019
ms.topic: tutorial
