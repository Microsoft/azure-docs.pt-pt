...
1. Selecione a nuvem nacional da lista:
   ...
   :::image type="content" source="../media/extension-for-vscode/set-default-azure-cloud-sign-in.png" alt-text="Descreva o sinal de nuvem Azure padrão para o Código do Estúdio Visual" border="false":::
...
1. Inscreva-se no Azure a partir da extensão da Política Azure ou da Paleta de Comando.
   ...
   - Extensão da Política Azure
     ...
     :::image type="content" source="../media/extension-for-vscode/azure-cloud-sign-in-policy-extension.png" alt-text="Azure cloud iniciar súmite para Código de Estúdio Visual a partir da extensão da Política de Azure" border="false":::

   - Paleta de comando

     A partir da barra de menu, vá à **Paleta de**  >  **Comando,** e introduza **Azure: Iniciar Sedura**.

     :::image type="content" source="../media/extension-for-vscode/azure-cloud-sign-in-command-palette.png" alt-text="Azure cloud iniciar súmite para Código de Estúdio Visual da Paleta de Comando" border="false":::
...
:::image type="content" source="../media/extension-for-vscode/extension-hover-shows-property-alias.png" alt-text="Hover de extensão de política Azure mostra pseudónimo de gestor de recursos" border="false":::
