...
1. Selecione ou insira os seguintes valores:
   ...
   | Resource group | Selecione **criar novo**, especifique um nome e, em seguida, selecione **OK**. Na captura de tela, o nome do grupo de recursos é *mypolicyquickstart @ no__t-1Date em MMDD > RG*. |
