...
## <a name="a-namecount-resourcescount-azure-resources"></a>recursos do Azure de @no__t 0Count
...
## <a name="a-namecount-keyvaultscount-key-vault-resources"></a>recursos do cofre de chaves <a name="count-keyvaults">Count
...
## <a name="a-namelist-resourceslist-resources-sorted-by-name"></a>recursos de @no__t 0List classificados por nome
...
## <a name="a-nameshow-vmsshow-all-virtual-machines-ordered-by-name-in-descending-order"></a><a name="show-vms"/>Show todas as máquinas virtuais ordenadas pelo nome em ordem decrescente
...
## <a name="a-nameshow-sortedshow-first-five-virtual-machines-by-name-and-their-os-type"></a><a name="show-sorted"/>Show primeiras cinco máquinas virtuais por nome e seu tipo de so
...
## <a name="a-namecount-oscount-virtual-machines-by-os-type"></a>máquinas virtuais <a name="count-os"/>Count por tipo de sistema operacional
...
## <a name="a-nameshow-storageshow-resources-that-contain-storage"></a>recursos de @no__t 0Show que contêm armazenamento
...
## <a name="a-namelist-publiciplist-all-public-ip-addresses"></a><a name="list-publicip"/>List todos os endereços IP públicos
...
Essa consulta expande esse padrão para incluir apenas os resultados em que **Properties. ipaddress**
 @ no__t-2, para retornar apenas as **Propriedades. ipaddress**e para `limit` os resultados pela parte superior
...
## <a name="a-namecount-resources-by-ipcount-resources-that-have-ip-addresses-configured-by-subscription"></a>recursos de @no__t 0Count que têm endereços IP configurados pela assinatura
...
## <a name="a-namelist-taglist-resources-with-a-specific-tag-value"></a>recursos de @no__t 0List com um valor de marca específico
...
## <a name="a-namelist-specific-taglist-all-storage-accounts-with-specific-tag-value"></a><a name="list-specific-tag"/>List todas as contas de armazenamento com um valor de marca específico
...
## <a name="a-nameshow-aliasesshow-aliases-for-a-virtual-machine-resource"></a>aliases de @no__t 0Show para um recurso de máquina virtual
...
## <a name="a-namedistinct-alias-valuesshow-distinct-values-for-a-specific-alias"></a>valores distintos de @no__t 0Show para um alias específico
...
## <a name="a-nameunassociated-nsgsshow-unassociated-network-security-groups"></a>grupos de segurança de rede não associados do @no__t 0Show
