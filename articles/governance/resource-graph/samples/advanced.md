...
Se for necessário procurar um nome de marca e um valor de marca que não diferenciam maiúsculas de minúsculas, use `mv-expand` com o parâmetro **bagexpansion** . Essa consulta usa mais cota do que a consulta anterior, portanto, use `mv-expand` somente se necessário.
