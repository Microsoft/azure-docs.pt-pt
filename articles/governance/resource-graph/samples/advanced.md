...
- [Encontre todas as razões pelas quais uma máquina não é compatível com as atribuições de Configuração de Hóspedes](#query-gcmachinedetails)
...
- Portal do Governo Azure: <a href="https://portal.azure.us/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%0D%0A%7C%20distinct%20type%2C%20apiVersion%0D%0A%7C%20where%20isnotnull%28apiVersion%29%0D%0A%7C%20order%20by%20type%20asc" target="_blank">portal.azure.us</a>
...
- Portal do Governo Azure: <a href="https://portal.azure.us/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%0D%0A%7C%20project%20tags%0D%0A%7C%20summarize%20buildschema%28tags%29" target="_blank">portal.azure.us</a>
...
Esta consulta utiliza dois comandos **leftouter** `join` para reunir máquinas virtuais criadas com o modelo de implementação do Gestor de Recursos, as suas interfaces de rede relacionadas e qualquer endereço IP público relacionado com essas interfaces de rede.
...
## <a name="count-of-non-compliant-guest-configuration-assignments"></a><a name="count-gcnoncompliant"></a>Contagem de atribuições de configuração de hóspedes não conformes

Apresenta uma contagem de máquinas não conformes por razão de [atribuição de configuração de convidados](../../policy/how-to/determine-non-compliance.md#compliance-details-for-guest-configuration). Limita os resultados aos primeiros 100 para o desempenho.
