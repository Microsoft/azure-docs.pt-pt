...
1. Deixe a Publicação para a caixa de verificação **de grupo de recursos** selecionados e a **localização do Grupo de Recursos** definida para **(EUA) West Central US**.
