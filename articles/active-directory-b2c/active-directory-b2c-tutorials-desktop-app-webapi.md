---
title: 'Tutorial: conceder acesso a uma API Web node. js de um aplicativo de área de trabalho'
description: Tutorial sobre como usar Active Directory B2C para proteger uma API Web node. js e chamá-la de um aplicativo de desktop .NET.
