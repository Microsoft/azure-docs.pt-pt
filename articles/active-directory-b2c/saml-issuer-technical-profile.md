...
|TokenLifeTimeInSeconds| No| Especifica a vida da Afirmação SAML. Este valor encontra-se em segundos a partir do valor Não Antes referido acima. O valor predefinido é de 300 segundos (5 Min). |
