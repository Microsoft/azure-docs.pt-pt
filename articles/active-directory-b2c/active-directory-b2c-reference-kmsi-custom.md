...
![Inscreva-se início de sessão na página de exemplo que mostra um Keep-me conectado na caixa de verificação](./media/active-directory-b2c-reference-kmsi-custom/kmsi.PNG)
