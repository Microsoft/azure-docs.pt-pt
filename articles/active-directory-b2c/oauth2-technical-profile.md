...
| scope | Não | O âmbito do pedido que é definido de acordo com a especificação de fornecedor de identidade do OAuth2. Por exemplo, `openid`, `profile`, e `email`. |
