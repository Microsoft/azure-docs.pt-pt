...
Abaixo as transformações de sinistros no interior `<BuildingBlocks>` , adicione o seguinte [ContentDefinition](contentdefinitions.md) para referência à versão 2.1.0 dados URI:
