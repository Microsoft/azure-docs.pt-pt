...
1. No **Site URL,** insira `https://your-tenant-name.b2clogin.com/` a substituição `your-tenant-name` com o nome do seu inquilino. Introduza um URL para o `http://www.contoso.com`URL da Política de **Privacidade,** por exemplo. O URL de política é uma página que mantém para fornecer informações de privacidade para a sua aplicação.
