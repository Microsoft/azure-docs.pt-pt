...
Para utilizar uma conta Microsoft como uma [fornecedor de identidade](active-directory-b2c-reference-oidc.md) no Azure Active Directory (Azure AD) B2C, terá de criar uma aplicação no inquilino do Azure AD. O inquilino do Azure AD não é o mesmo que o inquilino do Azure AD B2C. Se ainda não tiver uma conta Microsoft, pode obter um de cada [ https://www.live.com/ ](https://www.live.com/).
