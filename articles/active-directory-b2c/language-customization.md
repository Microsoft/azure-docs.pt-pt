...
> [!NOTE]
> Na amostra seguinte, adicionámos o símbolo da libra `#` no início de cada linha, para que possa encontrar facilmente as etiquetas localizadas no ecrã.
