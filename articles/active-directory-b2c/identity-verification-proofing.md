---
title: Comprovativo de identidade e verificação para Azure AD B2C
titleSuffix: Azure AD B2C
description: Conheça os nossos parceiros que se integram com o Azure AD B2C para fornecer soluções de comprovação de identidade e verificação
...
ms.locfileid: "105027685"
---
# <a name="identity-verification-and-proofing-partners"></a>Parceiros de verificação e revisão de identidade
...
A Microsoft faz parcerias com os seguintes parceiros ISV.
