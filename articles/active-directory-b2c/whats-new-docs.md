...
- [Assegurar a autenticação de vários fatores por telefone (MFA)](phone-based-mfa.md)

### <a name="updated-articles"></a>Artigos atualizados

- [Exemplos de código do Azure Active Directory B2C](code-samples.md)
- [Acompanhe o comportamento do utilizador em Azure AD B2C utilizando insights de aplicação](analytics-with-application-insights.md)
...
- [Visão geral da política personalizada AZURE AD B2C](custom-policy-overview.md)
...
- [Exemplos de código do Azure Active Directory B2C](code-samples.md)
- [Versões do esquema de página](page-layout.md)
...
### <a name="new-articles"></a>Artigos novos
- [Adicione um conector API a um fluxo de utilizador de inscrição (pré-visualização)](add-api-connector.md)
- [Tutorial: Registar uma aplicação de uma página (SPA) no Azure Ative Directory B2C](tutorial-register-spa.md)
- [Utilize conectores API para personalizar e alargar os fluxos de utilizador de inscrição](api-connectors-overview.md)
- [SubJourneys](subjourneys.md)

### <a name="updated-articles"></a>Artigos atualizados
- [Defina um perfil técnico do fornecedor de identidade SAML numa política personalizada do Azure Ative Directory B2C](saml-identity-provider-technical-profile.md)
- [Adicione um conector API a um fluxo de utilizador de inscrição (pré-visualização)](add-api-connector.md)
- [Exemplos de código do Azure Active Directory B2C](code-samples.md)
- [Tipos de aplicação que podem ser usados no Ative Directory B2C](application-types.md)
- [Fluxo de código de autorização OAuth 2.0 no Azure Ative Directory B2C](authorization-code-flow.md)
- [Tutorial: Registar uma aplicação web no Azure Ative Directory B2C](tutorial-register-applications.md)

## <a name="september-2020"></a>Setembro de 2020

### <a name="new-articles"></a>Artigos novos
- [Visão geral das chaves de política no Azure Ative Directory B2C](policy-keys-overview.md)
...
### <a name="updated-articles"></a>Artigos atualizados
- [Versões do esquema de página](page-layout.md)
- [Modelo de faturação para Azure Ative Directory B2C](billing.md)
