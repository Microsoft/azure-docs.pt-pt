...
Para ver como adicionar fornecedores de identidade no Azure AD B2C, consulte [adicionar fornecedores de identidade às suas aplicações no Azure Ative Directory B2C](add-identity-provider.md).
