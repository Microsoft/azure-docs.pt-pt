...
Para utilizar uma conta WeChat como fornecedor de identidade no Azure Ative Directory B2C (Azure AD B2C), precisa de criar uma aplicação no seu inquilino que o represente. Se ainda não tiver uma conta WeChat, pode [https://kf.qq.com/faq/161220Brem2Q161220uUjERB.html](https://kf.qq.com/faq/161220Brem2Q161220uUjERB.html)obter informações em .

### <a name="register-a-wechat-application"></a>Registe uma aplicação WeChat

1. Inscreva-se [https://open.weixin.qq.com/](https://open.weixin.qq.com/) nas suas credenciais weChat.
1. **Selecione** (centro de gestão).
1. Siga os passos para registar uma nova aplicação.
1. Insira `https://your-tenant_name.b2clogin.com/your-tenant-name.onmicrosoft.com/oauth2/authresp` em **portugal** (URL de callback). Por exemplo, se o nome do seu inquilino `https://contoso.b2clogin.com/contoso.onmicrosoft.com/oauth2/authresp`for contoso, defino o URL para ser .
