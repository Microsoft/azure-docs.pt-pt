...
1. Elimine todos os fluxos de utilizador (diretivas) no seu inquilino do Azure AD B2C.
1. Elimine todos os aplicativos que registou no seu inquilino do Azure AD B2C.
