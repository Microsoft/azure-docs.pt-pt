...
1. Selecione **inscrever-se/entrar** para se inscrever como um usuário do aplicativo. O **fluxo de utilizador b2c_1_signupsignin1** é utilizado.
...
No entanto, o recurso de **lista de tarefas pendentes** não funcionará até que você conclua o próximo tutorial da série, [tutorial: usar Azure ad B2C para proteger uma API Web ASP.net](tutorial-web-api-dotnet.md).
...
> [Tutorial: usar Azure Active Directory B2C para proteger uma API Web ASP.NET >](tutorial-web-api-dotnet.md)
