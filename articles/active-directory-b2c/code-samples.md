...
| Sample | Descrição |
|--------| ----------- |
| [ms-identidade-javascript-react-tutorial](https://github.com/Azure-Samples/ms-identity-javascript-react-tutorial/tree/main/3-Authorization-II/2-call-api-b2c) | Uma aplicação de uma página única (SPA) chamando uma API web. A autenticação é feita com Azure AD B2C utilizando o MSAL React. Esta amostra utiliza o fluxo de código de autorização com O PKCE. |
