...
- Estruturas JavaScript:
    - Azure AD B2C utiliza uma [versão específica do jQuery](page-layout.md#jquery-version). Não inclua outra versão do jQuery. Usar mais do que uma versão na mesma página causa problemas.
