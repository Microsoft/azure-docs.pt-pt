...
:::image type="content" source="media/api-management/internal-deployment.png" alt-text="Implementação interna - API Management for Azure VMware Solution" lightbox="media/api-management/internal-deployment.png":::