...
Continue até ao próximo tutorial para aprender a configurar uma cópia de segurança dos VMware VMs em execução na Solução VMware Azure utilizando o Azure Backup Server.
