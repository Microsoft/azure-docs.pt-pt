...
Neste artigo, fornecemos recomendações para a integração de uma implementação de Azure VMware Solution (AVS) num hub existente ou numa nova [arquitetura hub e spoke](https://docs.microsoft.com/azure/architecture/reference-architectures/hybrid-networking/shared-services) on Azure. 
...
-   **Rede virtual falada**
    ...
    -   **PaaS Falou:** A PaaS Spoke acolhe serviços Azure PaaS utilizando endereços privados graças ao [Private Endpoint](https://docs.microsoft.com/azure/private-link/private-endpoint-overview) e [private Link](https://docs.microsoft.com/azure/private-link/private-link-overview).
...
As ligações ExpressRoute permitem que o tráfego flua entre as instalações, o AVS e o tecido da rede Azure. O AVS utiliza [o ExpressRoute Global Reach](https://docs.microsoft.com/azure/expressroute/expressroute-global-reach) para implementar esta conectividade.
...
Pode encontrar mais detalhes sobre conceitos de networking e interconectividade AVS na documentação do [produto AVS.](https://docs.microsoft.com/azure/azure-vmware/concepts-networking)

### <a name="traffic-segmentation"></a>Segmentação do tráfego

[Azure Firewall](https://docs.microsoft.com/azure/firewall/) é a peça central da topologia hub e spoke, implantada na rede virtual Hub. Utilize o Azure Firewall ou outro aparelho virtual suportado pela Azure para estabelecer regras de tráfego e segmentar a comunicação entre os diferentes raios de estado, no local e cargas de trabalho AVS.
...
Como uma melhor prática recomendada, integrar [o domínio AD com o Azure Ative Directory](https://docs.microsoft.com/azure/architecture/reference-architectures/identity/azure-ad).
