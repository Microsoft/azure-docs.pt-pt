...
2. Introduza o nome para a chave de autorização e selecione **Criar**. 
   ...
   :::image type="content" source="media/expressroute-global-reach/create-global-reach-auth-key.png" alt-text="Selecione Criar para criar uma nova chave de autorização. ":::
