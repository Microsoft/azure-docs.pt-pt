...
Para os clusters windows, recomenda-se que crie monitorização de clusters com [registos de Agente de Diagnóstico](https://docs.microsoft.com/azure/service-fabric/service-fabric-diagnostics-event-aggregation-wad) e Monitor [Azure](https://docs.microsoft.com/azure/service-fabric/service-fabric-diagnostics-oms-setup).

Para os clusters Linux, os registos do Azure Monitor são também a ferramenta recomendada para a plataforma Azure e monitorização de infraestruturas. Os diagnósticos da plataforma Linux requerem uma configuração diferente, como indicado em [eventos de cluster de tecido de serviço Linux no Syslog](https://docs.microsoft.com/azure/service-fabric/service-fabric-diagnostics-oms-syslog).
...
* Conheça as recomendações gerais de monitorização dos recursos Azure: [Melhores Práticas - Monitorização e diagnósticos.](https://docs.microsoft.com/azure/architecture/best-practices/monitoring)