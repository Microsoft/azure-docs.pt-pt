---
title: Elementos do esquema XML do modelo do serviço de Service Fabric do Azure | Microsoft Docs
...
|definido|localmente em [complexType](service-fabric-service-model-schema-complex-types.md#diagnosticstype-complextype) de diagnosticstype|
...
#### <a name="filestore"></a>Repositório
...
|conteúdo|0 elemento (s), 0 atributo (s)|
|definido|localmente em complexType do Gerenciador de [manifesto](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype), complexType do [pacotetype](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|name|Diagnóstico|
|minOccurs|0|
...
|definido|localmente em [complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype) do pacotetype|
...
|type|complexType anônimo|
|conteúdo|2 elementos, 0 atributo (s)|
|definido|localmente em [complexType](service-fabric-service-model-schema-complex-types.md#servicediagnosticstype-complextype) de addiagnosticstype|
|name|ETW|
|minOccurs|0|
...
|type|complexType anônimo|
|conteúdo|1 elemento, 0 atributo (s)|
|definido|localmente em [complexType](service-fabric-service-model-schema-complex-types.md#resourcestype-complextype) ResourceType|
|name|Pontos Finais|
|minOccurs|0|
...
|conteúdo|0 elemento (s), 0 atributo (s)|
|definido|localmente no [complexType](service-fabric-service-model-schema-complex-types.md#parameterstype-complextype) ParameterType|
|name|Parâmetro|
|minOccurs|1|
|maxOccurs|unbounded|
...
|type|xs: String|
|conteúdo|0 elemento (s), 0 atributo (s)|
|definido|localmente no tipo complexo [ServiceType](service-fabric-service-model-schema-complex-types.md#servicetype-complextype), o tipo complexType [complexo](service-fabric-service-model-schema-complex-types.md#servicetypetype-complextype), [ServiceGroupTypeType complexType](service-fabric-service-model-schema-complex-types.md#servicegrouptypetype-complextype)|
...
|definido|localmente em [complexType](service-fabric-service-model-schema-complex-types.md#defaultservicestype-complextype) defaultservicestype|
|name|Serviço|
...
|type|[StatefulServiceGroupType](service-fabric-service-model-schema-complex-types.md#statefulservicegrouptype-complextype)|
|conteúdo|0 elemento (s), 0 atributo (s)|
|definido|localmente em [complexType](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype)de Service TemplateType, elemento de serviço|
|name|StatefulServiceGroup|
