...
Declara um certificado usado para encriptar informações confidenciais dentro do manifesto de aplicação. O autor da aplicação utiliza o cmdlet Invoke-ServiceFabricEncryptSecret para encriptar as informações sensíveis, que são copiadas para um Parâmetro na secção ConfigOverrides.
...
Declara definições de configuração num manifesto de serviço a ser ultrapassado. Consiste numa ou mais secções de pares de valores-chave. Os valores dos parâmetros podem ser encriptados utilizando o cmdlet Invoke-ServiceFabricEncryptSecret.
...
Se for verdade, o valor deste parâmetro é encriptado. O desenvolvedor de aplicações é responsável pela criação de um certificado e pela utilização do cmdlet Invoke-ServiceFabricEncryptSecret para encriptar informações confidenciais. As informações do certificado que serão utilizadas para encriptar o valor estão especificadas na secção Certificados. Este atributo é precotado. Por favor, use o atributo Tipo.
...
Se definido para Encriptado, o desenvolvedor de aplicações é responsável pela criação de um certificado e pela utilização do cmdlet Invoke-ServiceFabricEncryptSecret para encriptar informações confidenciais.
