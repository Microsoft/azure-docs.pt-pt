---
title: 'Atualização de aplicação: parâmetros de atualização'
...
> | WhatIf | PS | Os valores permitidos são **true** e **false**. Apresenta o que aconteceria mediante a execução do cmdlet. O cmdlet não é executado. |
