...
Para mais informações consulte [ver versões de cluster suportadas em Azure](https://docs.microsoft.com/azure/service-fabric/service-fabric-versions#supported-operating-systems)
