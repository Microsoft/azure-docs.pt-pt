...
A capacidade tamponada é outra característica do Cluster Resource Manager. Permite a reserva de alguma parte da capacidade global do nó. Este tampão de capacidade é utilizado apenas para colocar serviços durante upgrades e falhas nos nós. 

A capacidade tamponada é especificada globalmente por métrica para todos os nós. O valor que escolhe para a capacidade reservada é uma função do número de domínios de falha e de upgrade que tem no cluster. Mais domínios de avaria e atualização significam que pode escolher um número mais baixo para a sua capacidade tamponada. Se tiver mais domínios, pode esperar que quantidades menores do seu cluster não estejam disponíveis durante as atualizações e falhas. Especificar a capacidade tamponada só faz sentido se também tiver especificado a capacidade do nó para uma métrica.
