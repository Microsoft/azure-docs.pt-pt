...
Pode implementar o modelo como uma atualização do Gestor de recursos ao seu cluster, utilizando o `New-AzResourceGroupDeployment` API no módulo Azure PowerShell. Um comando de exemplo seria:
