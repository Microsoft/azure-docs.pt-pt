...
Os clusters Azure Service Fabric que funcionam em versões inalteradas mais tarde do que 6.3 sofrerão perdas de funcionalidades ou perturbações de serviço se não forem atualizados para uma versão suportada até 19 de janeiro de 2021.
 ...
 - **Para os clusters que executam uma versão do Service Fabric superior a 6.3 e utilizar [a funcionalidade open networking para contentores](./service-fabric-networking-modes.md#set-up-open-networking-mode)** , o cluster pode ficar indisponível e deixará de funcionar, o que poderá causar interrupções de serviço nas suas cargas de trabalho.
 
 -   **Para os clusters que executam as [versões do Windows entre 7.0.457 e 7.0.466 (ambas as versões incluídas)](#supported-version-names) e o Windows OS tem a Funcionalidade de Contentores do Windows ativada. NOTA: As versões Linux 7.0.457, 7.0.464 e 7.0.465 NÃO são impactadas**.
...
| 7.1.409.* | 7.0.466.* |Menos ou igual à versão 4.1 |31 de julho de 2021 |
| 7.1.417.* | 7.0.466.* |Menos ou igual à versão 4.1 |31 de julho de 2021 |
| 7.1.428.* | 7.0.466.* |Menos ou igual à versão 4.1 |31 de julho de 2021 |
| 7.1.456.* | 7.0.466.* |Menos ou igual à versão 4.1 |31 de julho de 2021 |
| 7.1.458.* | 7.0.466.* |Menos ou igual à versão 4.1 |31 de julho de 2021 |
| 7.1.459.* | 7.0.466.* |Menos ou igual à versão 4.1 |31 de julho de 2021 |
| 7.1.503.* | 7.0.466.* |Menos ou igual à versão 4.1 |31 de julho de 2021 |
| 7.1.510.* | 7.0.466.* |Menos ou igual à versão 4.1 |31 de julho de 2021 |
| 7.2.413.* | 7.0.470.* |Menos ou igual à versão 4.2 |30 de novembro de 2021 |
| 7.2.432.* | 7.0.470.* |Menos ou igual à versão 4.2 |30 de novembro de 2021 |
| 7.2.433.* | 7.0.470.* |Menos ou igual à versão 4.2 |30 de novembro de 2021 |
| 7.2.445.* | 7.0.470.* |Menos ou igual à versão 4.2 |30 de novembro de 2021 |
| 7.2.452.* | 7.0.470.* |Menos ou igual à versão 4.2 |30 de novembro de 2021 |
| 7.2.457.* | 7.0.470.* |Menos ou igual à versão 4.2 |30 de novembro de 2021 |
| 7.2.477.* | 7.0.478.* |Menos ou igual à versão 4.2 |30 de novembro de 2021 |
| 8.0.514.* | 7.1.510.* |Menos ou igual à versão 5.0 |Versão atual, então sem data de fim |
