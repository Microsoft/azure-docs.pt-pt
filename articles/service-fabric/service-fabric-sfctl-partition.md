...
| health | Obtém a integridade da partição de Service Fabric especificada. |
...
| load | Obtém as informações de carga da partição de Service Fabric especificada. |
...
| restart | Essa API irá reiniciar algumas ou todas as réplicas ou instâncias da partição especificada. |
