...
A visualização de criptografia de disco para o conjunto de dimensionamento de máquinas virtuais requer o auto-registro. Utilize os passos seguintes: 
...
* A criptografia para conjuntos de dimensionamento de máquinas virtuais tem suporte apenas para conjuntos de dimensionamento criados com discos gerenciados. Não há suporte para conjuntos de dimensionamento de disco nativos (ou não gerenciados).
...
### <a name="use-the-custom-template-that-you-already-have"></a>Use o modelo personalizado que você já tem 
