...
Pode encontrar suas *TenantId*, ou o ID de diretório, na [portal do Azure](https://portal.azure.com). Selecione **do Azure Active Directory -> propriedades** e copie a **ID do diretório** valor.
