...
Os passos neste artigo partem do princípio de que está a instalar nativamente no Linux ou a utilizar a imagem de contentor OneBox do Service Fabric, `mcr.microsoft.com/service-fabric/onebox:latest`.
