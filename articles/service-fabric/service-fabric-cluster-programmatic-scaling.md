...
- [Bibliotecas de Gestão Azure para .NET](https://github.com/Azure/azure-libraries-for-net) (útil para interagir com os conjuntos de escala de máquinas virtuais subjacentes de um cluster de tecido de serviço)
