---
title: Implementar uma aplicação de cluster gerido por Tecido de Serviço (pré-visualização) utilizando o modelo ARM
...
Em seguida, cria um modelo de Gestor de Recursos, atualiza o ficheiro de parâmetros com detalhes da aplicação e implementa o modelo no cluster de Tecido de Serviço. [Explore amostras.](https://github.com/Azure-Samples/service-fabric-dotnet-quickstart/tree/voting-sample-no-reverse-proxy/ARM-Managed-Cluster)
