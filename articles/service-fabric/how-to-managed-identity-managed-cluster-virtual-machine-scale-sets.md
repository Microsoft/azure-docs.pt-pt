...
Finalmente, adicione as `vmManagedIdentity` propriedades e propriedades à `userAssignedIdentities` definição do nó do nó gerido. Certifique-se de que utiliza **a pré-visualização 2021-01-01** ou mais tarde para o `apiVersion` .
