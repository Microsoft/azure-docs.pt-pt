...
| **Parâmetro** | **Valores Permitidos** | **Política de atualização** | **Documentação de orientação ou descrição breve** |
| --- | --- | --- | --- |
|Activado |Bool, a predefinição é falso |Estático|O sinalizador ativado para ImageStoreService. Predefinição: Falso |
...
|CleanupApplicationPackageOnProvisionSuccess|bool, a predefinição é falso |Dinâmico|Esta configuração ativa ou desativa a limpeza automática de pacote de aplicação fornecimento com êxito. |
...
|Carregar |cadeia de caracteres, predefinido for "Admin" | Dinâmico|A operação de carregamento do cliente do arquivo de configuração de segurança para a imagem. |
...
| **Parâmetro** | **Valores Permitidos** |**Atualizar política** |**Documentação de orientação ou descrição breve** |
| --- | --- | --- | --- |
