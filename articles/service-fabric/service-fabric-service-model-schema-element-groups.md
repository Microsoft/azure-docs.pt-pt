---
title: Grupos de elementos de elementos de esquema XML de serviço de serviço Azure Service Fabric
description: Descreve os grupos de elementos no esquema XML do modelo de serviço Service Fabric.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "79282084"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>Elementos de esquema xml de serviço de serviço de serviço xml

## <a name="partitiondescriptiongroup-group"></a>Grupo PartitionDescriptionGroup
Define o regime de partição para um serviço.
...
#### <a name="singletonpartition"></a>Partição Singleton
...
#### <a name="uniformint64partition"></a>UniformInt64Partição
...
#### <a name="namedpartition"></a>Partição Nomeada
...
#### <a name="instancecountscalingmechanism"></a>Mecanismo de contagem de tempos
