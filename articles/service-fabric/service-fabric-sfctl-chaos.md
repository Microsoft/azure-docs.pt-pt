---
title: CLI do Azure Service Fabric-sfctl caos | Microsoft Docs
description: Descreve os comandos Service Fabric sfctl de caos da CLI.
...
| Obter | Obtenha o status do caos. |
| start | Inicia o caos no cluster. |
| deixar | Interrompe o caos se estiver em execução no cluster e colocar a agenda de caos em um estado parado. |
