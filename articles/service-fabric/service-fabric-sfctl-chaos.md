...
Se o caos ainda não estiver em execução no cluster, ele iniciará o caos com os parâmetros de caos passados. Se o caos já estiver em execução quando essa chamada for feita, a chamada falhará com o código de erro FABRIC_E_CHAOS_ALREADY_RUNNING.
