...
> [!NOTE]
> Para as nuvens nacionais (Governo Azure, Azure China, `fabricSettings` Azure Alemanha), você também deve adicionar o seguinte ao seu modelo: `AADLoginEndpoint`, `AADTokenEndpointFormat` e `AADCertEndpointFormat`.
