...
Um serializer personalizado precisa implementar a interface [IStateSerializer. \<T> ](https://docs.microsoft.com/dotnet/api/microsoft.servicefabric.data.istateserializer-1)
