...
Para receber a notificação quando um ponto final tiver sido alterado, os clientes devem registar uma chamada ver [ServiceNotificationFilterDescription](https://docs.microsoft.com/dotnet/api/system.fabric.description.servicenotificationfilterdescription).
...
> [!NOTE]
> Esta funcionalidade pode ser configurada nos serviços existentes utilizando o cmdlet Update-ServiceFabricService ou o modelo ARM como mencionado acima, quando a versão do código cluster for 7.1.XXX ou acima.
>
>
