---
title: Descrições do modelo de esquema sinuoso do serviço Azure Service Fabric XML
description: Uma descrição do esquema XML do modelo de serviço Service Fabric, incluindo a localização e um resumo dos componentes.
ms.topic: reference
ms.date: 12/10/2018
...
# <a name="service-model-xml-schema-documentation"></a>Documentação de esquema sema do modelo de serviço XML
Este artigo documenta o ficheiro esquema ServiceFabricServiceModel.xsd instalado com o Service Fabric SDK.  Por predefinição, o ficheiro schema está instalado em *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Encadernações de espaço de nome

|Prefixo|Espaço de nome URI|
|---|---|
...
- [112 tipos complexos](service-fabric-service-model-schema-complex-types.md)
- [1 tipos simples](service-fabric-service-model-schema-simple-types.md)
