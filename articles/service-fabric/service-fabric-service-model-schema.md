---
title: Design de serviço de tecido de serviço Azure XML descrições de esquema
description: Uma descrição do esquema XML do modelo de serviço de serviço service Fabric, incluindo a localização e um resumo dos componentes.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639195"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Documentação de esquema do modelo de serviço XML
Este artigo documenta o ficheiro de esquema ServiceFabricServiceModel.xsd instalado com o Service Fabric SDK.  Por predefinição, o ficheiro de esquemas é instalado em *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Encadernações do espaço de nome

|Prefixo|URI de espaço de nome|
|---|---|
|xs|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Resumo do componente 
Os seguintes componentes são definidos em ServiceFabricServiceModel.xsd:
- [257 elementos](service-fabric-service-model-schema-elements.md)
- [112 complexosTips](service-fabric-service-model-schema-complex-types.md)
- [1 simplesTips](service-fabric-service-model-schema-simple-types.md)
