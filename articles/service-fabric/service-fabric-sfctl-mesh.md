---
title: Malha CLI-sfctl de serviço Azure
description: Saiba mais sobre o sfctl, a interface de linha de comando do Azure Service Fabric. Inclui uma lista de comandos para gerir aplicações de malha de tecido de serviço.
author: jeffj6123
ms.topic: reference
ms.date: 1/16/2020
ms.author: jejarry
...
| [volume](service-fabric-sfctl-mesh-volume.md) | Obter e apagar recursos de volume. |
