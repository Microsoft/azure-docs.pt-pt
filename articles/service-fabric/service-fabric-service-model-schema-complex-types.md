...
|definido|globalmente|
|nome|AplicaçõesHealthPolicyType|
...
#### <a name="considerwarningaserror"></a>Considere advertênciaserro
Especifica se deve tratar os relatórios de saúde como erros durante a avaliação da saúde. Predefinição: false.

|Atributo|Valor|
|---|---|
|nome|Considere advertênciaserro|
|tipo|xs:corda|
|utilizar|opcional|
|predefinição|false|
...
#### <a name="defaultservicetypehealthpolicy"></a>Política de Saúde DefaultServiceType
...
#### <a name="servicetypehealthpolicy"></a>Política de Saúde do Tipo de Serviço
...
#### <a name="applicationpackageref"></a>Pacote de aplicaçõesRef

|Atributo|Valor|
|---|---|
|nome|Pacote de aplicaçõesRef|

#### <a name="servicepackageref"></a>Pacote de serviçoRef
...
#### <a name="defaultservices"></a>Serviços Predefinidos
...
|definido|globalmente|
|nome|Políticas de aplicaçãoTipo|
...
#### <a name="defaultrunaspolicy"></a>Política de DefaultRunAs
...
#### <a name="securityaccesspolicies"></a>Políticas de Acesso à Segurança
...
#### <a name="connectionstringisencrypted"></a>Conexão StringisEncriptada

|Atributo|Valor|
|---|---|
|nome|Conexão StringisEncriptada|
|tipo|xs:corda|
|utilizar|necessário|
...
#### <a name="isseednode"></a>Nóedde IsSeed
...
#### <a name="servercertificate"></a>Certificado de servidor
O certificado usado para assegurar a comunicação intra cluster.
...
#### <a name="clientcertificate"></a>Certificado de Cliente
...
#### <a name="nodetypes"></a>Tipos de nó
...
#### <a name="fabricsettings"></a>Definições de tecido
...
#### <a name="mountpoint"></a>MontePoint
...
#### <a name="environmentvariablename"></a>Nome variável ambiente

|Atributo|Valor|
|---|---|
|nome|Nome variável ambiente|
|tipo|xs:corda|
|utilizar|opcional|
|predefinição||
...
#### <a name="codepackageref"></a>CódigoPacoteRef

|Atributo|Valor|
|---|---|
|nome|CódigoPacoteRef|
|utilizar|necessário|
...
|definido|globalmente|
|nome|Tipo de Certificado de Contentores|
...
#### <a name="relativepath"></a>Caminho relativo
...
#### <a name="includedockerhealthstatusinsystemhealthreport"></a>Incluir DockerHealthStatusInSystemHealthReport
...
|Atributo|Valor|
|---|---|
|nome|Incluir DockerHealthStatusInSystemHealthReport|
|tipo|xs:boolean|
|utilizar|opcional|
|predefinição|true|
...
#### <a name="imagename"></a>Nome de imagem
...
|definido|globalmente|
|nome|Tipo de políticas de anfitriões de contentores|
...
#### <a name="usetokenauthenticationcredentials"></a>Credenciais de autenticação usetoken
Utilize a autenticação token MSI (ou um ponto final especificado) para obter um símbolo usado para autenticação.
        

|Atributo|Valor|
|---|---|
|nome|Credenciais de autenticação usetoken|
|tipo|xs:corda|
|utilizar|opcional|
|predefinição|false|
...
#### <a name="containersretentioncount"></a>ContentoresRecount
...
|conteúdo|1 elementos, 1 atributo(s)|
|definido|globalmente|
|nome|Tipo de condutor de contentores|
...
#### <a name="networktype"></a>Tipo de rede
...
|conteúdo|1 elementos, 1 atributo(s)|
|definido|globalmente|
|nome|Tipo de Política de Rede de Contentores|
...
#### <a name="entrypointtype"></a>Tipo de ponto de entrada

|Atributo|Valor|
|---|---|
|nome|Tipo de ponto de entrada|
|utilizar|opcional|
|predefinição|Principal|

#### <a name="codepackagelinkfolder"></a>Pasta CodePackageLink

|Atributo|Valor|
|---|---|
|nome|Pasta CodePackageLink|
...
#### <a name="datapackagelinkfolder"></a>Pasta dataPackageLink

|Atributo|Valor|
|---|---|
|nome|Pasta dataPackageLink|
...
#### <a name="workingfolder"></a>Pasta de Trabalho
...
#### <a name="containerentrypoint"></a>Ponto de entrada de contentores
...
#### <a name="containermountedvolume"></a>Volume Montado em Contentor
...
#### <a name="containerenvironmentblock"></a>ContentorEnvironmentBlock
...
#### <a name="foldersource"></a>PastaSource
...
## <a name="dllhostentrypointtype-complextype"></a>Complexo DllHostEntryPointTypeType
...
#### <a name="isolationpolicy"></a>Política de Isolamento
...
#### <a name="unmanageddll"></a>Dll não gerido
...
|conteúdo|0 elementos, 4 atributos|
|definido|globalmente|
|nome|Tipo de opção de condutor|
...
|conteúdo|3 elementos, 0 atributos ou s|
|definido|globalmente|
|nome|Tipo de Descrição do Ponto de Entrada|
...
#### <a name="containerhost"></a>Anfitrião de Contentores
...
|conteúdo|0 elementos, 3 atributos|
|definido|globalmente|
|nome|AmbienteVariávelOverrideType|
...
#### <a name="isexternalexecutable"></a>IsExternalExecutável
...
#### <a name="consoleredirection"></a>Direção consolere
...
|definido|globalmente|
|nome|Tipo de Certificado de Tecido|
...
#### <a name="clientconnectionendpoint"></a>Ponto final de Ligação ao Cliente
...
#### <a name="serviceconnectionendpoint"></a>ServiçoConnectionEndpoint
...
#### <a name="defaultreplicatorendpoint"></a>Ponto final de ReplicatorEndpoint predefinido
...
|conteúdo|3 elementos, 0 atributos ou s|
|definido|globalmente|
|nome|Tipo de Definições FabricKtlLogger|
...
#### <a name="faultdomain"></a>Domínio de Falhas
O domínio da falha deste nó.

|Atributo|Valor|
|---|---|
|nome|Domínio de Falhas|
|tipo|xs:anyURI|
|utilizar|opcional|

#### <a name="upgradedomain"></a>UpgradeDomínio
...
|conteúdo|1 elementos, 0 atributos|
|definido|globalmente|
|nome|Tipo de Informação de Infraestruturas|
...
|conteúdo|0 elementos, 2 atributos|
|definido|globalmente|
|nome|Tipo de ponto de final interno|
...
#### <a name="logicaldirectoryname"></a>Nome lógico do Directory
O nome do Diretório Lógico.

|Atributo|Valor|
|---|---|
|nome|Nome lógico do Directory|
|tipo|xs:corda|
|utilizar|necessário|

#### <a name="mappedto"></a>Mapeado
...
#### <a name="containernetworkpolicy"></a>Política de Rede de Contentores
...
|conteúdo|0 elementos, 2 atributos|
|definido|globalmente|
|nome|Tipo de Política de Partilha de Pacotes|
...
|conteúdo|0 elementos, 2 atributos|
|definido|globalmente|
|nome|Tipo de encadernação de porta|
...
|conteúdo|0 elementos, 3 atributos|
|definido|globalmente|
|nome|RepositórioCredenciasTipo|
...
|definido|globalmente|
|nome|Tipo de Política de Governança de Recursos|
...
|conteúdo|0 elementos, 4 atributos|
|definido|globalmente|
|nome|Tipo de Política de Acesso de Segurança|
...
#### <a name="grantrights"></a>Direitos de Concessão
Os direitos de concessão: Ler, Alterar ou Cheio. O padrão é Read.

|Atributo|Valor|
|---|---|
|nome|Direitos de Concessão|
...
|conteúdo|2 elementos, 0 atributos|
|definido|globalmente|
|nome|Tipo de Diretores de Segurança|
...
|conteúdo|4 elementos, 0 atributos ou s|
|definido|globalmente|
|nome|Tipo de serviço e grupode serviços|
...
#### <a name="statelessservicetype"></a>ApátridaServiceType
...
#### <a name="removeservicefabricruntimeaccess"></a>RemoverServiceFabricRuntimeAccess
...
|Atributo|Valor|
|---|---|
|nome|RemoverServiceFabricRuntimeAccess|
|tipo|xs:boolean|
|predefinição|false|
...
|conteúdo|1 elementos, 2 atributos|
|definido|globalmente|
|nome|Tipo de Membro do Grupo de Serviço|
...
|definido|globalmente|
|nome|Tipo de serviçoTipo de grupo|
...
#### <a name="servicegrouptypename"></a>Nome tipo de grupo de serviço
...
|Atributo|Valor|
|---|---|
|nome|Nome tipo de grupo de serviço|
|utilizar|necessário|

#### <a name="useimplicitfactory"></a>Utilização ImplicitFactory
...
|Atributo|Valor|
|---|---|
|nome|Utilização ImplicitFactory|
|tipo|xs:boolean|
|utilizar|opcional|
...
#### <a name="placementconstraints"></a>Restrições de Colocação
...
#### <a name="servicegroupmembers"></a>Membros do Grupo de Serviços
...
#### <a name="servicepackageresourcegovernancepolicy"></a>Política de Governança de Recursos de Recursos de Serviços
...
#### <a name="servicepackagecontainerpolicy"></a>Política de contentores de pacotes de serviço
...
|conteúdo|0 elementos, 0 atributos(s)|
|definido|globalmente|
|nome|ServiceManifestRefRefType|
...
|conteúdo|1 elementos, 2 atributos|
|definido|globalmente|
|nome|Tipo de política de pacotes de serviço|
...
|conteúdo|0 elementos, 2 atributos|
|definido|globalmente|
|nome|Tipo de política de governança de recursos de serviço|
...
#### <a name="manifestversion"></a>Manifestaversão

|Atributo|Valor|
|---|---|
|nome|Manifestaversão|
|tipo|xs:corda|
|utilizar|necessário|
...
#### <a name="digestedservicetypes"></a>Tipos de Serviços Digeridos

|Atributo|Valor|
|---|---|
|nome|Tipos de Serviços Digeridos|

#### <a name="digestedcodepackage"></a>Pacote de Código Digerido
...
#### <a name="digestedconfigpackage"></a>Pacote DeConfig digerido
...
#### <a name="digesteddatapackage"></a>Pacote de Dados Digeridos
...
#### <a name="defaultmovecost"></a>PadrãoMoveCost
...
#### <a name="servicecorrelations"></a>Correlações de Serviço
...
#### <a name="serviceplacementpolicies"></a>Políticas de Colocação de Serviços
...
#### <a name="servicescalingpolicies"></a>Políticas de Sescalaing de Serviços
...
|conteúdo|1 elementos, 0 atributos|
|definido|globalmente|
|nome|Tipo de serviçoExtensionPolicyPropertiesType|
...
|conteúdo|0 elementos, 3 atributos|
|definido|globalmente|
|nome|Tipo de ServiçoSHealthPolicyType|
...
|conteúdo|0 elementos, 0 atributos(s)|
|definido|globalmente|
|nome|ApátridaServiceGroupTypeType|
...
#### <a name="currentinstallation"></a>Instalação atual
...
#### <a name="targetinstallation"></a>Instalação de alvos
...
|definido|globalmente|
|nome|Informação de implantação do WindowsFabric|
...
#### <a name="clustermanifestlocation"></a>ClusterManifestalocalização
Este é o caminho completo para o Cluster Manifest Location.

|Atributo|Valor|
|---|---|
|nome|ClusterManifestalocalização|
|tipo|xs:corda|
|utilizar|opcional|

#### <a name="infrastructuremanifestlocation"></a>InfraestruturaManifestalocalização
Esta localização do manifesto de infraestrutura que é gerado internamente.

|Atributo|Valor|
|---|---|
|nome|InfraestruturaManifestalocalização|
|tipo|xs:corda|
|utilizar|opcional|

#### <a name="targetversion"></a>Versão-alvo
...
#### <a name="undoupgradeentrypointexeparameters"></a>NãodoUpgradeEntryPointExeParameters
Parâmetros para o ponto de entrada de configuração exe

|Atributo|Valor|
|---|---|
|nome|NãodoUpgradeEntryPointExeParameters|
|tipo|xs:corda|
|utilizar|opcional|
