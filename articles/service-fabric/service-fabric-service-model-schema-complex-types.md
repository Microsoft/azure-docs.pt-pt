...
Modo de isolamento para o recipiente. Os valores válidos são predefinidos, processuais ou Hiper-V (suportado apenas para recipientes Windows).
...
Declara etiquetas necessárias para a colocação de um serviço. Útil para influenciar dinamicamente a colocação do serviço. 
...
Declara etiquetas necessárias para colocação e execução de um serviço. Útil para influenciar dinamicamente a colocação e execução do serviço. 
