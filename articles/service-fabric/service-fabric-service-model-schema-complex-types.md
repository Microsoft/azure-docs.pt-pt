...
Opções de motorista a serem passadas para o motorista. O plugin de volume Azure Files suporta as seguintes opções de controlador: shareName (a parte de ficheiro Supor Ficheiros Azure que fornece o volume para o recipiente), armazenamentoAccountName (a conta de armazenamento Azure que contém a partilha de ficheiros Azure Files), armazenamentoAccountKey (chave de acesso para a conta de armazenamento Azure que contém a parte de ficheiro sondo do Azure Files).
