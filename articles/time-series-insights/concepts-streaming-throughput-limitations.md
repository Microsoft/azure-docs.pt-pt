---
title: Limitações de produção de streaming- Azure Time Series Insights Microsoft Docs
description: Saiba mais sobre os limites de produção ingresss em Azure Time Series Insights.
author: lyrana
ms.author: lyhughes
manager: cshankar
...
Por padrão, a Time Series Insights pode ingerir dados de entrada a uma taxa de **até 1 megabyte por segundo (MBps) por ambiente de Insights de Séries de Tempo**. Existem limitações adicionais [por partição do hub.](concepts-streaming-throughput-limitations.md#hub-partitions-and-per-partition-limits)
...
* **Exemplo 1:**
    ...
    * A taxa de ingestão da Contoso Shipping estaria dentro da limitação da escala.
...
Quer esteja a criar um novo hub para o seu ambiente de Insights de Séries Temporinhas ou usando um existente, terá de calcular a sua taxa de ingestão por partição para determinar se está dentro dos limites. 
