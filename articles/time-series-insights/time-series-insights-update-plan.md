...
> [!NOTE]
> Ver [planejar seu ambiente de disponibilidade geral do Azure Time Series Insights](time-series-insights-environment-planning.md), para as práticas recomendadas planejar uma instância do TSI de disponibilidade geral.
...
* R [modelo de série de tempo](./time-series-insights-update-tsm.md).
* Uma [origem de eventos ligado ao Time Series Insights](./time-series-insights-how-to-add-an-event-source-iothub.md).
...
Para criar um novo ambiente do Time Series Insights, selecione um **ID de série de tempo**. Ao fazê-lo então, atua como uma partição lógica para os seus dados. Como observado, lembre-se de que tem os seus IDs de série de tempo pronto.
...
* Modo de série de tempo, campos de instância e eventos incluem apenas as informações necessárias, como um **ID de série de tempo** ou **Timestamp**.
