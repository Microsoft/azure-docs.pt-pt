...
> [!NOTE]
> O Time Series Insights não tem BCDR incorporada. Por predefinição, o armazenamento do Azure, o IoT Hub do Azure e o Event Hubs do Azure têm recuperação incorporada.
