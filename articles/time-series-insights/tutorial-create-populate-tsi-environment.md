...
1. Depois que a página **instalação da simulação** for carregada, insira os parâmetros necessários.
   ...
   **Modelo do dispositivo** | Selecioneresfriador.
   **Número de dispositivos**  | Insira `1000` em **quantidade**.
   **Frequência da telemetria** | Insira `10` segundos.
   **Duração da simulação** | Selecione **terminar em:** e digite `5` minutos.
...
1. Retorne à página **visão geral** do grupo de recursos do ambiente de time Series insights. Selecione o ambiente de Time Series Insights.
   ...
   [![Ambiente e grupo de recursos de ambiente Time Series Insights](media/tutorial-create-populate-tsi-environment/ap-view-tsi-env-rg.png)](media/tutorial-create-populate-tsi-environment/ap-view-tsi-env-rg.png#lightbox)
