...
|---|---|---|
| O tipo de dados Azure Time Series Insights Gen2 é anexado ao final do seu nome de coluna como "_ \<dataType\> " | ```"type": "Accumulated Heat"``` | type_string |
