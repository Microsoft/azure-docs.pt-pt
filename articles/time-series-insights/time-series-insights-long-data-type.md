...
ms.locfileid: "86183635"
---
# <a name="adding-support-for-long-data-type"></a>Adicionar suporte para um tipo de dados longo

Estas alterações serão aplicadas apenas aos ambientes de pré-visualização (PAYG). Se tiver um ambiente SKU TSI Standard (S) SKU, poderá ignorar estas alterações.

Estamos a fazer alterações na forma como armazenamos e indexamos dados numéricos na Pré-visualização do Azure Time Series Insights que podem impactar-te. Se for afetado por algum dos casos abaixo, faça as alterações necessárias o mais rápido possível. Os seus dados começarão a ser indexados como Longo e Duplo entre 29 de junho e 30 de junho de 2020, dependendo da sua região. Se tiver alguma dúvida ou preocupação com esta alteração, envie um bilhete de apoio através do portal Azure e mencione esta comunicação.
