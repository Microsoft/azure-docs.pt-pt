...
### <a name="in-this-video-we-cover-querying-data-using-the-time-series-insights-explorer-br"></a>Neste vídeo, vamos abordar consultar dados com o Explorador do Time Series Insights. </br>
...
1. Também pode atualizar disponibilidade automaticamente a cada minuto, ao selecionar o **automática no** botão.  Tenha em atenção de que o botão 'Auto-On' aplica-se apenas para o gráfico de disponibilidade, não o conteúdo da visualização principal.
