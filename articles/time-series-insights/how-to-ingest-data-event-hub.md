...
- Crie um ambiente Azure Time Series Insights, conforme descrito no [Criar um ambiente de Insights de Séries de Tempo Azure](./time-series-insights-update-create-environment.md).
