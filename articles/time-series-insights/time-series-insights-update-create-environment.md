---
title: 'Tutorial: Configurar um ambiente de pré-visualização do Azure Time Series Insights'
description: 'Tutorial: saiba como configurar seu ambiente no Azure Time Series Insights Preview.'
author: deepakpalled
ms.author: dpalled
manager: cshankar
