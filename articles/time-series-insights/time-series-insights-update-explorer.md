...
* **Instância do modelo de série temporal**: As instâncias são a própria série temporal. Na maioria dos casos, eles são DeviceIDou AssetID, que é o identificador exclusivo do ativo no ambiente.
