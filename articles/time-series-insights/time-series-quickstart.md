...
1. Deixe a caixa **Filtrar série** em branco para ver todos os termos de pesquisa selecionados ou insira um termo de filtro na caixa **série de filtro** para filtragem da série improvisadas.
