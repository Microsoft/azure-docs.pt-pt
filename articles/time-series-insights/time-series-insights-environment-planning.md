...
- Saiba como [adicionar uma fonte de eventos do Event Hubs](time-series-insights-how-to-add-an-event-source-eventhub.md) ao Azure Time Series Insights.
