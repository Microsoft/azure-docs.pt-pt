...
## <a name="purchase-a-new-subscription"></a>Comprar uma nova subscrição
...
1. Selecione o tipo de subscrição que está a comprar:
...
1. Preencha as suas **informações de faturação.** Se a sua instituição fizer parte de um acordo de licenciamento de volume, pode inserir o seu número de contrato de licenciamento de volume. Se se inscrever para uma nova subscrição e estiver a pagar por outra coisa que não o cartão de crédito, pode haver um atraso no acesso à sua subscrição enquanto o pagamento processa. Receberá e-mails atualizando o progresso do pagamento.

    :::image type="content" source="media/enroll-renew-subscription/application-billing-information.png" alt-text="Insira informações de faturação." border="false":::
...
1. Confirme todas as informações de compra e clique **em 'Encomenda'**( Ordem Local). Os e-mails de confirmação serão enviados para a sua caixa de entrada, com atualizações sobre o estado do pagamento e quaisquer passos seguintes possíveis.
