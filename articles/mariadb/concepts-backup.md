...
Estes ficheiros de backup não são expostos ao utilizador e não podem ser exportados. Estas cópias de segurança só podem ser utilizadas para restaurar as operações na Base de Dados Azure para o MariaDB. Pode usar [mysqldump](howto-migrate-dump-restore.md) para copiar uma base de dados.
...
Na Base de Dados Azure para O MariaDB, a realização de um restauro cria um novo servidor a partir das cópias de segurança do servidor original e restaura todas as bases de dados contidas no servidor.
