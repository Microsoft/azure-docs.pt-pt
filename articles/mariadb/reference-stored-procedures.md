...
Para configurar a replicação de dados entre um mestre e uma réplica na Base de Dados Azure para MariaDB, consulte [como configurar a replicação de dados.](howto-data-in-replication.md)
