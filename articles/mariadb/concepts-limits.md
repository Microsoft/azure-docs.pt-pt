...
- A instância do servidor MariaDB exibe a versão incorreta do servidor após a conexão ser estabelecida. Para obter versão do motor de instância de servidor correto, utilize o `select version();` comando.
