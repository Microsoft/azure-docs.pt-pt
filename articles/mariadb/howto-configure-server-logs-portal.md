...
5. Altere os parâmetros que você precisa ajustar, incluindo a ativação de **slow_query_log** para **ativado**. Todas as alterações feitas nesta sessão são realçadas em roxo. 
