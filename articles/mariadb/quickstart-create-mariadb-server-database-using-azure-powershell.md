---
title: 'Quickstart: Criar um servidor - Azure PowerShell - Azure Database for MariaDB'
...
Este quickstart descreve como usar o PowerShell para criar uma Base de Dados Azure para servidor MariaDB num grupo de recursos Azure. Pode utilizar o PowerShell para criar e gerir os recursos Azure de forma interativa ou em scripts.
...
A tabela seguinte contém uma lista de parâmetros e valores de amostra geralmente utilizados para o `New-AzMariaDbServer` cmdlet.
...
O exemplo a seguir desativa o SSL na sua Base de Dados Azure para o servidor MariaDB.
...
## <a name="connect-to-the-server-using-mariadb-workbench"></a>Ligue-se ao servidor utilizando a bancada mariaDB
...
Para eliminar apenas o servidor criado neste arranque rápido sem eliminar o grupo de recursos, utilize o `Remove-AzMariaDbServer` cmdlet.
...
> [Desenhe uma base de dados Azure para MariaDB utilizando o PowerShell](tutorial-design-database-using-powershell.md)