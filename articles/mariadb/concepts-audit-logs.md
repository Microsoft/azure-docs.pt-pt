...
As seções a seguir descrevem o que é resultado de logs de auditoria do MariaDB com base no tipo de evento. Dependendo do método de saída, os campos incluídos e a ordem na qual eles aparecem podem variar.
