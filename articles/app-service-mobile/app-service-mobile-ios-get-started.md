...
description: Siga este tutorial para começar com a utilização de backends de aplicações móveis Azure para o desenvolvimento do iOS em Objective-C ou Swift.
