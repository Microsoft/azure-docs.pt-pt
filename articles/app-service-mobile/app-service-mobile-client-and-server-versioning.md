...
Ou seja, deve utilizar um SDK cliente de *Aplicações Móveis* com um servidor de *aplicações móveis* SDK e similarmente para *Serviços Móveis*. Este contrato é aplicado através de um valor especial de cabeçalho usado pelos SDKs do cliente e do servidor, `ZUMO-API-VERSION`.
...
## <a name="azure-mobile-apps-client-and-server"></a><a name="2.0.0"></a>Cliente e servidor de Aplicativos Móveis Azure
### <a name="mobile-apps-client-sdks"></a><a name="MobileAppsClients"></a>SDKs clientes de *aplicativos* móveis
