...
------------ | ------------- |  
| Arquivo de dados |  Alocar espaço <br> Procurar repositório de armazenamento |
...
| Resource | Atribuir VM ao pool de recursos<br>Migrar máquina virtual desligada<br>Migrar máquina virtual ligada |
| Inventário de máquina virtual |  Criar a partir de existente<br>Criar Novo<br>Mover<br>remover | 
| Interação da máquina virtual |  Configurar mídia de CD<br>Interação do console<br>Ligação do Dispositivo<br>Desligar<br>Ligar<br>Redefinir<br>Suspender<br>Instalação de ferramentas | 
| Configuração de máquina virtual |  Adicionar disco existente<br>Adicionar novo disco<br>Adicionar ou remover<br>Remover disco<br>Avançadas<br>Alterar contagem de CPU<br>Alterar recurso<br>Estender disco virtual<br>Controle de Alterações de disco<br>Memória<br>Modificar configurações do dispositivo<br>Mudar o Nome<br>Definir anotação (versão 5,0 e posterior)<br>Definições<br>Posicionamento do Swapfile |
| Aprovisionamento |  Personalizar<br>Clonar modelo<br>Clonar máquina virtual<br>Implementar Modelo<br>Ler especificações de personalização |
