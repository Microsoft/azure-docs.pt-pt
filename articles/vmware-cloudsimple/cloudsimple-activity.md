...
Os alertas são notificações de qualquer atividade significativa no seu ambiente CloudSimple. Os eventos que impactam a faturação ou o acesso ao utilizador são apresentados como alertas.  Pode reconhecer alertas do portal CloudSimple.
