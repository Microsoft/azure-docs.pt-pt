...
7. Selecione o **tipo de nó** aprovisionados no Azure.  Pode escolher o [opção CS28 ou CS36](cloudsimple-node.md#vmware-solution-by-cloudsimple-nodes-sku). A última opção inclui a capacidade de computação e memória máxima.
...
Para alterar a palavra-passe, siga as instruções em [gerir a palavra-passe de um utilizador](https://docs.vmware.com/en/VMware-NSX-T-Data-Center/2.4/administration/GUID-DB31B304-66A5-4516-9E55-2712D12B4F27.html).

> [!WARNING]
> Por predefinição, a palavra-passe de administrador do NSX expira após 90 dias.
