...
2. Reveja a [consideração](sql-support-matrix.md#feature-consideration-and-limitations) de recursos e [suporte ao cenário](sql-support-matrix.md#scenario-support).
