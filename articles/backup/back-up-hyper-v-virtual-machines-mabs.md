...
3. No menu **ações** , clique em **recuperar** para abrir o assistente de recuperação.
    ...
    A VM e o ponto de recuperação selecionados aparecem na tela **examinar seleção de recuperação** . Clique em **Seguinte**.
