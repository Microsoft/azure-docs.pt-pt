...
| Configuração de grupos de proteção | Incapaz de configurar a proteção | Se o servidor protegido for um servidor SQL, verifique se as permissões de função sysadmin foram fornecidas à conta do sistema (NTAuthority\System) no computador protegido, conforme descrito [neste artigo](https://docs.microsoft.com/previous-versions/system-center/system-center-2012-R2/hh757977(v=sc.12)).
