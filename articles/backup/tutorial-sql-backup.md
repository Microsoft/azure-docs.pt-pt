...
description: Neste tutorial, saiba como fazer backup de um banco de dados SQL Server em execução em uma VM do Azure para um cofre dos serviços de recuperação de backup do Azure.
ms.topic: tutorial
ms.date: 06/18/2019
...
Evite os seguintes nomes de banco de dados:
...
5. Em **meta de Backup** > **descobrir bancos de os em VMs**, selecione **Iniciar descoberta** para procurar VMs desprotegidas na assinatura. Pode demorar um pouco, dependendo do número de máquinas virtuais desprotegidas na assinatura.
