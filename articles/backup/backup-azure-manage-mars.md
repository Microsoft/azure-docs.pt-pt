...
1. A partir da página De alteração ou paragem de uma página **de backup agendada,** selecione Parar usando esta agenda de **backup, mas mantenha as cópias de segurança armazenadas até que um horário seja novamente ativado**. Em seguida, selecione **Seguinte**.
...
- A partir da consola de agente MARS, vá ao **Actions Pane** > **Change properties** >. Em seguida, vá para o **separador Encriptação**.<br>
...
- Saiba mais sobre o comportamento de [retenção](backup-configure-vault.md#set-up-on-demand-backup-policy-retention-behavior)de políticas de backup da On demand .
