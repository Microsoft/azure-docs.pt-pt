...
1. Execute o comando [de demonstração de política de backup az](https://docs.microsoft.com/cli/azure/backup/policy#az_backup_policy_show) para recuperar os detalhes da política que pretende atualizar.
...
1. Execute o comando [de definição](https://docs.microsoft.com/cli/azure/backup/policy#az_backup_policy_set) de política de backup az e passe o caminho completo do ficheiro JSON atualizado como o valor para o - - parâmetro **de política.**
...
>[!NOTE]
>Também pode recuperar a política JSON da amostra executando o comando [get-by-vm da política de backup az.](https://docs.microsoft.com/cli/azure/backup/policy#az_backup_policy_get_default_for_vm)
