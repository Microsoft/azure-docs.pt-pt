...
* Os relatórios de backup são suportados para VMs Azure, SQL em VMs Azure, SAP HANA/ASE em VMs Azure, agente dos Serviços de Recuperação do Microsoft Azure (MARS), Microsoft Azure Backup Server (MABS) e System Center Data Protection Manager (DPM).
...
* Além disso, o esquema V1 de enviar dados de diagnóstico para uma conta de armazenamento ou um espaço de trabalho log Analytics também está em uma rota de depreciação. Se tiver escrito quaisquer consultas ou automatizações personalizadas com base no esquema V1, é aconselhável atualizar estas consultas para utilizar o esquema V2 atualmente suportado.
