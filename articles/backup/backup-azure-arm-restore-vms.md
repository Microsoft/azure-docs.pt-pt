...
**VMs da zona** | O Azure Backup suporta a cópia de segurança e a restauração de VMs fixados em zona. [Mais informações](https://azure.microsoft.com/global-infrastructure/availability-zones/)
