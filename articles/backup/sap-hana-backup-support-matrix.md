...
| **Versões de SO**            | SLES 12 com SP2, SP3 e SP4; SLES 15 com SP0 e SP1 <br><br>   **Pré-visualização** - RHEL 7.4, 7.6, 7.7 e 8.1  <br>     [Começa](./tutorial-backup-sap-hana-db.md) com a pré-visualização de backup SAP HANA para RHEL (7.4, 7.6, 7.7 e 8.1). Para mais perguntas, escreva-nos em [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com) .                |                                             |
...
> [!NOTE]
> Agora pode [monitorizar os trabalhos de backup e restauro](./sap-hana-db-manage.md#monitor-manual-backup-jobs-in-the-portal) (para a mesma máquina) desencadeados a partir de clientes nativos da HANA (SAP HANA Studio/ Cockpit/ DBA Cockpit) no portal Azure.

## <a name="next-steps"></a>Passos seguintes

* Saiba como [fazer backup sap HANA bases de dados em VMs Azure](./backup-azure-sap-hana-database.md)
