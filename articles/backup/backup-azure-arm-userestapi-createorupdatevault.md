...
---
# <a name="create-azure-recovery-services-vault-using-rest-api"></a>Criar cofre de serviços de recuperação de Azure usando REST API

Os passos para criar um Cofre de Serviços de Recuperação Azure usando a API REST são delineados na criação de documentação [API de REPOUSO DE COFRE.](https://docs.microsoft.com/rest/api/recoveryservices/vaults/createorupdate) Usemos este documento como referência para criar um cofre chamado "testVault" em "West US".
...
|sku     |         |  [Sku](https://docs.microsoft.com/rest/api/recoveryservices/vaults/createorupdate#sku)       |    Identifica o identificador de sistema único para cada recurso Azure     |
