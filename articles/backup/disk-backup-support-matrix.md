...
Pode utilizar [a cópia de segurança do Azure](https://docs.microsoft.com/azure/backup/backup-overview) para proteger discos Azure. Este artigo resume a disponibilidade da região, cenários apoiados e limitações.

## <a name="supported-regions"></a>Regiões suportadas

A Azure Disk Backup está disponível em pré-visualização nas seguintes regiões: West Central US. 
...
- A Azure Backup for Managed Disks utiliza instantâneos incrementais, que estão limitados a 200 instantâneos por disco. Para permitir que você assuma o backup a pedido para além de backups programados, a política de backup limita o total de backups para 180. Saiba mais sobre [instantâneos incrementais](https://docs.microsoft.com/azure/virtual-machines/windows/disks-incremental-snapshots-portal#restrictions) para discos geridos.

- Os limites de [subscrição e serviço](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits#virtual-machine-disk-limits) azure aplicam-se ao número total de snapshots de disco por região por subscrição.
