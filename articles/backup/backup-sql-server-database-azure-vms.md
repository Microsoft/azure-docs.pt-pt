...
- **Permitir o acesso através de etiquetas de Firewall do Azure**. Se estiver usando o Firewall do Azure, criar uma regra de aplicação utilizando o AzureBackup [etiqueta do FQDN](https://docs.microsoft.com/en-us/azure/firewall/fqdn-tags). Isso permite o acesso de saída para o Azure Backup.
