...
Uma vez concluído o processo de extração, verifique se a caixa para lançar o *setup.exe* recentemente extraído para começar a instalar o Microsoft Azure Backup Server e selecione no botão **Terminar.**
