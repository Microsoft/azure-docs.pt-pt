...
Para obter algum código de amostra, consulte [Criar e ligar uma aplicação de cliente Node.js](./tutorial-connect-device-nodejs.md) ou Criar e ligar uma [aplicação do cliente Python](./tutorial-connect-device-python.md).
