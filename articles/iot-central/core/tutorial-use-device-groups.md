...
Antes de começar, deve completar a [aplicação Create a Azure IoT Central](./quick-deploy-iot-central.md) e [adicionar um dispositivo simulado à sua aplicação IoT Central](./quick-create-simulated-device.md) rapidamente para criar o modelo de dispositivo **MXChip IoT DevKit** para trabalhar.
