...
| Nome a Apresentar        | Nome do Campo    |  Severidade padrão |
| --------------------| ------------- |-----------|
...
- **Pendente**: o dispositivo está sendo alterado para o valor de configuração no momento.
...
| Nome a Apresentar  | Nome do Campo    |  Unidades  | decimais |This|
| --------------| ------------- |---------| ---------|---- |
...
- **Regra de telemetria**, que é disparada quando a telemetria do dispositivo selecionado cruza um limite especificado. [Saiba mais sobre as regras de telemetria](howto-create-telemetry-rules.md).
