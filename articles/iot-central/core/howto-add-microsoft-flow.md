...
1. Não há suporte para contas pessoais da Microsoft (como @hotmail.com, @live.com, @outlook.com domínios) no momento. Você deve usar uma conta corporativa ou de estudante do Azure Active Directory (AD).
