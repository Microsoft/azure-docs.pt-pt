...
Antes de começar, você deve concluir os dois guias de início rápido anteriores [criar um aplicativo de IOT central do Azure](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) e [Adicionar um dispositivo simulado ao seu aplicativo de IOT central](./quick-create-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) para criar o modelo de dispositivo de **sensor de ambiente** com o qual trabalhar.
...
1. Na seção **condições** , você define o que dispara sua regra. Use as informações a seguir para definir uma condição com base na telemetria de temperatura:
    ...
    ![Criar condição de regra](./media/quick-configure-rules-pnp/condition.png)
...
1. Use as informações na tabela a seguir para definir sua ação:
    ...
    ![Criar ação de regra](./media/quick-configure-rules-pnp/action.png)
...
> [Use o IOT central do Azure para monitorar seus dispositivos](quick-monitor-devices-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
