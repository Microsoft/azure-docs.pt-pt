...
![Página Configurações do aplicativo](media/howto-use-app-templates-pnp/appcopy2.png)
...
![Página Configurações do aplicativo](media/howto-use-app-templates-pnp/appcopy3a.png)
