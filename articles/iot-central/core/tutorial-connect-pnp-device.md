...
1. Depois de a construção completar com sucesso, no mesmo comando executar a sua aplicação. Substitua `<scopeid>` e `<primarykey>` os valores que observou anteriormente:
