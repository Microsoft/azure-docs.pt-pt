...
2. No painel esquerdo, selecione **exportação de dados contínuas**.
    ...
    > [!Note]
    > Se você não vir a exportação de dados contínua no painel esquerdo, você não é um administrador em seu aplicativo. Converse com um administrador para configurar a exportação de dados.
