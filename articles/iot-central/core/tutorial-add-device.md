...
Antes de começar, o construtor deve concluir pelo menos o primeiro tutorial do construtor para criar o aplicativo de IoT Central do Azure: [definir um novo tipo de dispositivo](tutorial-define-device-type.md) (obrigatório)
...
2. Observe que o modelo de dispositivo **conectado do ar-condicionado** é aquele selecionado na **Device Explorer**. Para começar a conectar um dispositivo de ar-condicionado real que usa esse modelo, selecione **+** e, em seguida, **real**:
