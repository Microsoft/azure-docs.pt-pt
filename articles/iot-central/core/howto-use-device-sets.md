...
1. Dê ao seu dispositivo um nome que seja exclusivo em todo o aplicativo. Você também pode adicionar uma descrição. Um conjunto de dispositivos só pode conter dispositivos de um único modelo de dispositivo. Escolha o modelo de dispositivo a ser usado para este conjunto.
...
A análise em conjuntos de dispositivos é a mesma guia análise principal no painel esquerdo. Você pode aprender mais sobre a análise no artigo sobre [como criar análises](howto-use-device-sets.md).
