...
ms.locfileid: "104609566"
---
# <a name="iot-central-operator-guide"></a>Guia do operador central IoT

Este artigo fornece uma visão geral do papel do operador na IoT Central. Um operador gere os dispositivos ligados à aplicação.
...
:::image type="content" source="media/overview-iot-central-tour/iot-central-homepage.png" alt-text="Screenshot da página inicial do IoT Central":::
...
1. No painel direito da página **Dispositivos,** vê-se uma lista de dispositivos criados a partir desse modelo do dispositivo. Escolha um dispositivo individual para ver a página de detalhes do dispositivo para este dispositivo:
    ...
    ![Screenshot da página de detalhes do dispositivo](./media/overview-iot-central-operator/device-list.png)
...
1. Selecione **Import** (Importar).
    ...
    ![Screenshot da Ação de Importação](./media/overview-iot-central-operator/bulk-import-1-a.png)
...
1. Uma vez concluída a importação, uma mensagem de sucesso é mostrada no painel de Operações do Dispositivo.
    ...
    ![Screenshot do sucesso da importação](./media/overview-iot-central-operator/bulk-import-3-a.png)
...
1. No painel esquerdo, escolha **Todos os dispositivos:**
    ...
    ![Screenshot de dispositivos não-associados](./media/overview-iot-central-operator/unassociated-devices-2-a.png)
...
1. **Selecione Migrar:**
    ...
    ![Screenshot de Dispositivos Associados](./media/overview-iot-central-operator/unassociated-devices-1-a.png)
...
1. Selecione os dispositivos que pretende exportar e, em seguida, selecione a ação **Exportação.**
    ...
    ![Screenshot da exportação](./media/overview-iot-central-operator/export-1-a.png)
...
1. Selecione o link **'Ficheiro de descarregamento'** para descarregar o ficheiro para uma pasta local no disco.
    ...
    ![Screenshot do sucesso da exportação](./media/overview-iot-central-operator/export-2-a.png)
