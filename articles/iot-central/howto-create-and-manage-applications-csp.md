...
![Centro de IoT do Azure disponíveis para gerir](media/howto-create-application-csp/image2.png)
...
![Criar Manager para CSPs](media/howto-create-application-csp/image3.png)
...
![Criar a página do aplicativo para CSPs](media/howto-create-application-csp/image4.png)

![Criar a página do aplicativo para CSPs](media/howto-create-application-csp/image4-1.png)
