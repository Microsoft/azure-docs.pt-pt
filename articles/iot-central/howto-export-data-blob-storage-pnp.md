...
6. Para ativar a exportação de dados contínuas, verifique se a **exportação de dados** está **ativada**. Selecione **Guardar**.
   ...
   ![Configurar exportação de dados contínuas](media/howto-export-data-pnp/export-list-blob.png)
...
> [Como visualizar seus dados no Power BI](howto-connect-powerbi-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
