...
1. Escolha **Device Explorer** no menu de navegação à esquerda. Aqui você vê uma lista de seus [modelos de dispositivo](howto-set-up-template.md).
...
1. Escolha **Device Explorer** no menu de navegação.
