...
1. Introduza um nome de Token, clique em **próxima**e, em seguida **cópia**.
    > [!NOTE]
...
Agora que aprendeu como utilizar o Explorador de Central de IoT, a próxima etapa sugerida é explorar [gestão de dispositivos IoT Central](howto-manage-devices-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
