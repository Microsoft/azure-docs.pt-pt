...
* [Criar uma aplicação de análise na loja na Central Azure IoT](./tutorial-in-store-analytics-create-app.md) (Obrigatório)
...
1. Abra a aplicação de monitorização de condições que criou na aplicação de análise Create a store no tutorial [Central Azure IoT.](./tutorial-in-store-analytics-create-app.md)
...
1. Selecione **Guardar**. As alterações são guardadas no painel de instrumentos e o modo de edição está desativado.
    ...
    ![Azure IoT Central mudar nome do dashboard](./media/tutorial-in-store-analytics-customize-dashboard/dashboard-change-name.png)
...
1. **Selecione Configure** no azulejo de imagem que exibe a imagem da marca Northwind. 
    ...
    ![Azure IoT Central edita imagem da marca](./media/tutorial-in-store-analytics-customize-dashboard/brand-image-edit.png)
...
1. Selecione **a configuração de atualização**. O botão de **configuração de atualização** guarda alterações no painel de instrumentos e deixa o modo de edição ativado.
    ...
    ![Azure IoT Central guarda imagem de marca](./media/tutorial-in-store-analytics-customize-dashboard/brand-image-save.png)
...
1. Selecione **a configuração de atualização**.
    ...
    ![Mapa da loja Azure IoT Central](./media/tutorial-in-store-analytics-customize-dashboard/store-map-save.png)
    ...
    ![Zonas de loja central Azure IoT](./media/tutorial-in-store-analytics-customize-dashboard/store-zones.png)
...
1. Selecione **X Delete** para remover os **seguintes azulejos: Volte a todas as zonas,** visite o **painel de instrumentos da loja,** tempo de **espera,** e todos os três azulejos associados ao **Checkout 3**. O painel da loja Contoso não usa estes azulejos. 
    ...
    ![Azure IoT Central apaga azulejos](./media/tutorial-in-store-analytics-customize-dashboard/delete-tiles.png)
...
1. Selecione **X Delete** para remover as seguintes telhas: **Zona de aquecimento,** zona de saída de **arrefecimento,** **regulações do sensor de ocupação,** regulações do sensor do **termóstato**e **condições**de ambiente . 
   ...
   ![Central Azure IoT apaga azulejos restantes](./media/tutorial-in-store-analytics-customize-dashboard/delete-tiles-2.png)
...
1. Veja as suas alterações no painel de instrumentos.
   ...
   ![Central Azure IoT após apagar azulejos](./media/tutorial-in-store-analytics-customize-dashboard/after-delete-tiles.png)
...
1. Veja as alterações de layout. 
    ...
    ![Telhas de bateria de firmware central Azure IoT](./media/tutorial-in-store-analytics-customize-dashboard/firmware-battery-tiles.png)
...
Nesta secção, adicione mais dois azulejos de telemetria para mostrar telemetria ambiental dos sensores RuuviTag que adicionou na aplicação de análise Create a store no tutorial [Central Azure IoT.](./tutorial-in-store-analytics-create-app.md) 
...
1. **Selecione Combine**. 
    ...
    ![Azure IoT Central adiciona azulejo RuuviTag 1](./media/tutorial-in-store-analytics-customize-dashboard/add-zone1-ruuvi.png)
...
1. Veja o seu painel de contoso completo. 
    ...
    ![Azure IoT Central completa personalização do dashboard](./media/tutorial-in-store-analytics-customize-dashboard/completed-dashboard.png)
