...
* Antes de começar, deverá completar o anterior [Criar uma aplicação de análise de vídeo ao vivo no tutorial Azure IoT Central.](./tutorial-video-analytics-create-app.md)
