...
![Conjunto de dados de ocupação](./media/tutorial-in-store-analytics-visualize-insights-pnp/dataset-2.png)
...
Antes de criar a aplicação lógica, precisa dos IDs do dispositivo dos dois sensores RuuviTag que ligou à sua aplicação IoT Central na aplicação De análise Create in store no tutorial [Central Azure IoT:](./tutorial-in-store-analytics-create-app-pnp.md)
...
1. Selecione **Guardar** e, em seguida, selecione **Designer** para ver a versão visual da lógica que adicionou:
    ...
    ![Design de aplicativológico](./media/tutorial-in-store-analytics-visualize-insights-pnp/logic-app.png)
...
![Definições do cartão](./media/tutorial-in-store-analytics-visualize-insights-pnp/card-settings.png)
