...
Agora tem uma visão geral dos passos para implementar e usar o modelo de aplicação de análise de vídeo, consulte [Criar uma aplicação de análise de vídeo n no Azure IoT Central](tutorial-video-analytics-create-app.md) para começar.
