...
| Menu | Descrição |
| ---- | ----------- |
| ![Menu de navegação à esquerda](media/overview-iot-central-tour-pnp/navigationbar.png) | <ul><li>A página **painel** exibe o painel do aplicativo. Como um construtor, você pode personalizar o painel para seus operadores. Os usuários também podem criar seus próprios painéis.</li><li>A página **dispositivos** lista os dispositivos simulados e reais associados a cada modelo de dispositivo no aplicativo. Como um operador, você usa **dispositivos** para gerenciar seus dispositivos conectados.</li><li>A página **grupos de dispositivos** permite exibir e criar grupos de dispositivos. Como um operador, você pode criar grupos de dispositivos como um conjunto lógico de dispositivos especificados por uma consulta.</li><li>A página **regras** permite que você edite regras que são acionadas com base na telemetria do dispositivo e disparam ações personalizáveis.</li><li>A página **análise** mostra a análise derivada da telemetria do dispositivo para dispositivos e grupos de dispositivos. Como operador, pode criar vistas personalizadas com base nos dados dos dispositivos para obter informações da aplicação.</li><li>A página **trabalhos** permite o gerenciamento de dispositivos em massa, fazendo com que você crie e execute trabalhos para atualizar seus dispositivos em escala.</li><li>A página **modelos de dispositivo** mostra as ferramentas que um construtor usa para criar e gerenciar modelos de dispositivo.</li><li>A página **exportação de dados** permite que um administrador configure uma exportação contínua para outros serviços do Azure, como armazenamento e filas.</li><li>A página **Administração** mostra as páginas de administração do aplicativo em que um administrador pode gerenciar configurações, usuários e funções do aplicativo.</li></ul> |
