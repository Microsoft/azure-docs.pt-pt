...
ms.locfileid: "76988758"
---
# <a name="group-multiple-actions-to-run-from-one-or-more-rules-preview-features"></a>Grupo múltiplas ações para executar a partir de uma ou mais regras (funcionalidades de pré-visualização)
