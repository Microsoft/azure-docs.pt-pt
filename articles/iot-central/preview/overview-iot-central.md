...
Pode criar uma aplicação IoT Central utilizando um teste gratuito de 7 dias ou utilizar uma subscrição padrão.
...
[O IoT Plug and Play](../../iot-pnp/overview-iot-plug-and-play.md) permite ao IoT Central integrar dispositivos sem que escreva qualquer código de dispositivo incorporado. No núcleo do Plug and Play IoT, é um esquema de modelo de capacidade de dispositivo que descreve os recursos do dispositivo. Em um aplicativo IoT Central Preview, os modelos de dispositivo usam esses modelos de capacidade de dispositivo de Plug and Play IoT.
