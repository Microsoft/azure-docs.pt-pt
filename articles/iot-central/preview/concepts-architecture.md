...
Para saber mais sobre a conectividade do dispositivo no IoT Central do Azure, confira [conectividade do dispositivo](overview-iot-central-get-connected.md).
