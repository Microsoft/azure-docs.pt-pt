...
ms.locfileid: "76987735"
---
# <a name="extend-azure-iot-central-with-custom-analytics-using-azure-databricks-preview-features"></a>Estenda o Azure IoT Central com análisepersonalizada utilizando os Bricks Azure (funcionalidades de pré-visualização)
