...
ms.locfileid: "76990917"
---
# <a name="export-your-application-preview-features"></a>Exportar a sua aplicação (funcionalidades de pré-visualização)
...
Pode criar uma cópia de qualquer aplicação, menos quaisquer instâncias do dispositivo, histórico de dados do dispositivo e dados do utilizador. A cópia é uma aplicação padrão para a qual será cobrado. Não pode criar um pedido de Teste copiando um pedido.

Selecione **Copiar**. Na caixa de diálogo, introduza os detalhes para a nova aplicação padrão. Em seguida, selecione **Copy** para confirmar que pretende continuar. Para saber mais sobre os campos da forma, consulte o [Create a application](quick-deploy-iot-central.md) quickstart.

> [!NOTE]
> Só pode **copiar a sua aplicação** para locais **europeus** e **americanos.**
...
> [!NOTE]
> Quando uma aplicação é criada usando **o Shareable Link,** as localizações disponíveis são **a Europa** e **os EUA.**
...
Agora que aprendeu a usar modelos de aplicação, o próximo passo sugerido é aprender a [gerir a IoT Central a partir do portal Azure](../core/howto-manage-iot-central-from-portal.md?toc=/azure/iot-central/preview/toc.json&bc=/azure/iot-central/preview/breadcrumb/toc.json)
