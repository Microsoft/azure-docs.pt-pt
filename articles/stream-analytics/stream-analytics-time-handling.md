...
É importante usar um timetamp na carga útil quando a lógica temporal está envolvida para explicar os atrasos no sistema de origem ou na rede. O tempo atribuído a um evento está disponível no [SYSTEM. TIMETAMP](https://docs.microsoft.com/stream-analytics-query/system-timestamp-stream-analytics).
