...
| --- | --- | --- |
| **A executar** | O seu trabalho está a ser feito em eventos de leitura Azure provenientes das fontes de entrada definidas, processando-os e escrevendo os resultados para os lavatórios de saída configurados. | É uma boa prática acompanhar o desempenho do seu trabalho através da monitorização de [métricas chave.](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-set-up-alerts#scenarios-to-monitor) |
