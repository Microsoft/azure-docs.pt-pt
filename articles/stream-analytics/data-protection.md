...
Existe um problema conhecido em que um trabalho que utiliza a chave gerida pelo cliente encontra falhas ao usar a identidade gerida para autenticar quaisquer entradas ou saídas. Uma solução para esta questão está a ser trabalhada e estará disponível num futuro próximo. 
