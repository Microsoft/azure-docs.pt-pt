...
> [!NOTE]
> A SQL Database do Azure é suportada para uma tarefa de Stream Analytics, mas a máquina virtual do Azure com o SQL Server com uma base de dados anexado não é suportado de saída da oferta.
