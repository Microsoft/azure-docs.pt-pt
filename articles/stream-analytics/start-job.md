...
Para obter mais informações sobre o cmdlet `Start-AzStreamAnalyitcsJob`, exiba a [referência Start-AzStreamAnalyticsJob](/powershell/module/az.streamanalytics/start-azstreamanalyticsjob).
