...
| Eventos de entrada tardia      | Eventos que chegaram mais tarde do que a janela de tolerância à chegada tardia configurada. Saiba mais sobre as considerações da [ordem do evento Azure Stream Analytics](stream-analytics-out-of-order-and-late-events.md) . |
...
Pode utilizar estas métricas para [monitorizar o desempenho do seu trabalho stream Analytics](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-set-up-alerts#scenarios-to-monitor). 

## <a name="customizing-monitoring-in-the-azure-portal"></a>Personalização monitorização no portal Azure
Pode ajustar o tipo de gráfico, as métricas apresentadas e o intervalo de tempo nas definições do Gráfico de Edição. Para mais detalhes, consulte [como personalizar a monitorização.](../monitoring-and-diagnostics/insights-how-to-customize-monitoring.md)
