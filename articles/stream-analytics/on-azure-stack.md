...
Crie uma subscrição do Azure Stack Hub. Para mais informações, consulte o [tutorial para criar uma subscrição do Azure Stack Hub.](https://docs.microsoft.com/azure-stack/user/azure-stack-subscribe-services/)

Se quiser avaliar o Azure Stack Hub no seu próprio servidor, pode utilizar o Kit de Desenvolvimento de Pilhas Azure (ASDK).  Para obter mais informações sobre a ASDK, consulte a visão geral da [ASDK](https://docs.microsoft.com/azure-stack/asdk/).
...
2. Indique os valores seguintes para criar a conta de armazenamento:
   ...
   | Grupo de Recursos | Recomendamos que utilize o mesmo grupo de recursos para todos os recursos de teste que cria durante os quickstarts e tutoriais [IoT Edge.](https://docs.microsoft.com/azure/iot-edge/quickstart) Por exemplo, **IoTEdgeResources**. |
...
- [Azure Stream Analytics no IoT Edge](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-edge)
- [Desenvolver trabalhos stream Analytics Edge](https://docs.microsoft.com/stream-analytics-query/stream-analytics-query-language-reference)
