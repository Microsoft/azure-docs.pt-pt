...
## <a name="examples"></a>Exemplos
Utilize a notação de ponto (.) para aceder a campos aninhados. Por exemplo, esta consulta seleciona as coordenadas de Latitude e Longitude sob a propriedade de localização dos dados JSON anterior:
