...
Cada entrada Stream Analytics tem um **formato de serialização.** Para obter mais informações sobre as opções de entrada, consulte a documentação [da API input REST.](./stream-analytics-define-inputs.md)
