...
4. Implemente o seu modelo no [Serviço Azure Kubernetes](../machine-learning/how-to-deploy-and-where.md#choose-a-compute-target) para implementações de produção em larga escala. Se o serviço web não conseguir lidar com o número de pedidos provenientes do seu trabalho, o desempenho do seu trabalho em Stream Analytics será degradado, o que afeta a latência.
