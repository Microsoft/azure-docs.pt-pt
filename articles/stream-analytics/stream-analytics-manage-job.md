...
2. Selecione **Criar um recurso** e procurar o trabalho stream **Analytics**. Selecione o azulejo de **trabalho Stream Analytics** e selecione **Criar**.
