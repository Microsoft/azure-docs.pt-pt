...
A captura de ecrã acima, clicando no "HSM1_HSMnic" ou "HSM2_HSMnic" mostraria o endereço de IP privado adequado. Caso contrário, o comando `az resource show` utilizado acima é uma forma de identificar o endereço IP certo. 
