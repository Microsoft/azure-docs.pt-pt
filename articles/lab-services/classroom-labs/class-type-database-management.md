...
| ------------ | ------------------ |
|Virtual Machine Size| Média. This size is best suited for relational databases, in-memory caching, and analytics.|
