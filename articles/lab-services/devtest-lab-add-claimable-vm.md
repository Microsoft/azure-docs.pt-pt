...
Quando um utilizador não alega um VM, já não tem permissões do proprietário para esse VM de laboratório específico e está disponível para ser reclamado por qualquer outro utilizador de laboratório no estado em que foi reencontrado para a piscina. 
