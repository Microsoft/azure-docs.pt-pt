...
Para criar uma conta de laboratório, precisa de ter acesso a uma subscrição do Azure que está configurada para a sua escola. A sua escola pode ter uma ou mais assinaturas. Você usa uma subscrição para gerir faturação e segurança para todos os seus recursos e serviços Azure, incluindo contas de laboratório.  As subscrições Azure são normalmente geridas pelo seu departamento de TI.  Para mais informações, leia o seguinte tópico:
 - [Guia de Administradores - Subscrição](https://docs.microsoft.com/azure/lab-services/classroom-labs/administrator-guide#subscription)

### <a name="estimate-the-number-of-vms-and-vm-sizes-that-you-need"></a>Calcule o número de tamanhos de VMs e VM de que precisa
Terá de estimar o número de máquinas virtuais (VMs) e os [tamanhos de VM](https://docs.microsoft.com/azure/lab-services/administrator-guide#vm-sizing) de que a sua escola precisa.  Leia o seguinte post de blog para obter orientações sobre como estruturar os seus laboratórios\imagens.  Esta publicação de blog também o ajudará a decidir o número de VMs e os tamanhos VM que você precisará:
...
- [Guia de Administradores - Laboratório](https://docs.microsoft.com/azure/lab-services/administrator-guide#classroom-lab)
...
- [Guia de Administradores - Grupo de Recursos](https://docs.microsoft.com/azure/lab-services/administrator-guide#resource-group)
- [Guia de Administradores - Conta de Laboratório](https://docs.microsoft.com/azure/lab-services/administrator-guide#lab-account) 
- [Gestão de custos para serviços do Azure Lab](https://docs.microsoft.com/azure/lab-services/cost-management-guide)
...
### <a name="who-should-be-owners-and-contributors-of-the-lab-account"></a>Quem devem ser proprietários e contribuintes da conta do laboratório?
   ...
   -  [Guia de Administrador - Gerir a Identidade.](https://docs.microsoft.com/azure/lab-services/administrator-guide#manage-identity)
...
### <a name="who-will-be-allowed-to-create-labs"></a>Quem será autorizado a criar laboratórios?
   ...
   -  [Guia de Administradores - Gerir identidade](https://docs.microsoft.com/azure/lab-services/administrator-guide#manage-identity)
...
- [Guia de Administrador - Galeria de imagens partilhada](https://docs.microsoft.com/azure/lab-services/administrator-guide#shared-image-gallery)
- [Guia de Administradores - Preços partilhados da galeria de imagens](https://docs.microsoft.com/azure/lab-services/administrator-guide#shared-image-gallery-2)
...
- [Especifique as imagens do Marketplace disponíveis para os criadores de laboratório](https://docs.microsoft.com/azure/lab-services/specify-marketplace-images)
...
- [Fundamentos da arquitetura - Rede Virtual](https://docs.microsoft.com/azure/lab-services/classroom-labs-fundamentals#virtual-network)
- [Como ligar-se a uma rede virtual](https://docs.microsoft.com/azure/lab-services/how-to-connect-peer-virtual-network)
- [Como criar um laboratório com um recurso partilhado nos Serviços de Laboratório Azure](https://docs.microsoft.com/azure/lab-services/how-to-create-a-lab-with-shared-resource)

## <a name="set-up-your-lab-account"></a>Crie a sua conta de laboratório

Depois de terminar o planeamento, está pronto para criar a sua conta de laboratório.  Estes mesmos passos são aplicáveis para a criação de um laboratório [Azure Lab Services com equipas.](https://docs.microsoft.com/azure/lab-services/lab-services-within-teams-overview)
