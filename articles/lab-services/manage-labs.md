---
title: Ver e apagar laboratórios numa conta de laboratório nos Serviços de Laboratório Azure
description: Aprenda a ver todos os laboratórios numa conta de laboratório e elimine um laboratório da conta do laboratório.
ms.topic: article
ms.date: 06/26/2020
...
## <a name="view-labs-in-a-lab-account"></a>Ver laboratórios numa conta de laboratório

1. Na página **'Conta de Laboratório',** selecione **Todos os laboratórios** do menu esquerdo.
...
## <a name="delete-a-lab-in-a-lab-account"></a>Apagar um laboratório numa conta de laboratório
