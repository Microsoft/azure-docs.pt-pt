...
1. Configure a tarefa da seguinte forma:
   ...
   |**VM do laboratório de origem** > **ID da VM do laboratório de origem**|Se você alterou o nome padrão da variável LabVMId, insira-o aqui. O valor predefinido é **$(labVMId)** .|
