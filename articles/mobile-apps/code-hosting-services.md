...
- **Iniciar sua próxima compilação** de uma solicitação de pull do repositórios
    ...
    - Configurar integração contínua/entrega contínua (CI/CD) para automaticamente acionar as versões, testes e implementações com cada pedido pull concluído com o Azure Pipelines ou com as suas ferramentas.
