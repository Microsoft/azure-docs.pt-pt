...
2. Crie um cluster do AKS. Criar o cluster do AKS numa [região que suporta espaços de desenvolvimento](https://docs.microsoft.com/azure/dev-spaces/#a-rapid,-iterative-kubernetes-development-experience-for-teams).
