---
title: Tutorial - Criar um oleoduto de desenvolvimento em Azure com Jenkins
...
keywords: jenkins, azul, devops, oleoduto, cicd, estivador
ms.topic: tutorial
ms.date: 03/27/2017
...
- Se necessário, inicie sessão no Jenkins com o nome de utilizador e senha que criou.
...
![Adicionar webhook do GitHub ao seu repositório bifurcado](media/tutorial-jenkins-github-docker-cicd/github-webhook.png)
...
![Executar aplicação Node.js](media/tutorial-jenkins-github-docker-cicd/running-nodejs-app.png)
...
![Executar a aplicação Node.js após outra consolidação do GitHub](media/tutorial-jenkins-github-docker-cicd/another-running-nodejs-app.png)
