---
title: Tutorial - CI/CD de Jenkins a VMs Azure com Serviços Azure DevOps
...
keywords: jenkins, azure, devops, máquina virtual, cicd
ms.topic: tutorial
ms.date: 07/31/2018
...
> * Crie um oleoduto de lançamento da Azure Pipelines.
...
Para este tutorial, recomendamos que utilize [esta aplicação de exemplo disponível no GitHub](https://github.com/azure-devops/fabrikam-node). Este tutorial contém um script de exemplo que serve para instalar o Node.js e uma aplicação. Se pretender trabalhar com o seu próprio repositório, deve configurar um exemplo semelhante.
...
8. Escolha credenciais para ligar aos seus Serviços Azure DevOps ou ao ambiente do Servidor Azure DevOps:
   - Deixe o **Nome de utilizador** em branco se estiver a utilizar os Serviços de DevOps do Azure. 
   - Introduza um nome de utilizador e uma palavra-passe se estiver a utilizar uma versão no local do Servidor Azure DevOps.    
...
## <a name="create-an-azure-pipelines-release-pipeline"></a>Criar um oleoduto de lançamento de Gasodutos Azure
...
> * Configurar o Jenkins para integração nos Serviços de DevOps do Azure.
> * Criar um grupo de implementação para as máquinas virtuais do Azure.
> * Crie um Pipeline Azure que configura os VMs e implemente a aplicação.

Para saber como utilizar os gasodutos Azure para os passos de Construção e Lançamento, consulte [isto](https://docs.microsoft.com/azure/devops/pipelines/apps/cd/deploy-linuxvm-deploygroups).
