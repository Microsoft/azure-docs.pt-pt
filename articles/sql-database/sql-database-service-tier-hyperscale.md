...
1. Crie um servidor de base de dados Azure SQL na região alvo se ainda não tiver um servidor apropriado.  Este servidor deve ser propriedade da mesma subscrição que o servidor original (fonte).
