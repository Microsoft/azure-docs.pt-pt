---
title: Cli exemplo-move Azure SQL base de dados-SQL elástico
...
Este exemplo de script Azure CLI cria duas piscinas elásticas e move uma base de dados Azure SQL de uma piscina elástica SQL para outra piscina elástica SQL, e depois move a base de dados de piscina elástica para um único tamanho de computação de base de dados.
