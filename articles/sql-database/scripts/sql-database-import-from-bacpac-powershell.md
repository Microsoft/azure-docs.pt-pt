---
title: PowerShell exemplo importar ficheiro BACPAC Azure SQL base de dados
...
| [New-AzSqlServerFirewallRule](/powershell/module/az.sql/new-azsqlserverfirewallrule) | Cria uma regra de firewall do servidor de base de dados SQL para permitir o acesso a todas as bases de dados únicas e base de dados agrinada no servidor de base de dados SQL a partir da gama de endereços IP introduzido. |
