...
### <a name="for-azure-sql-database"></a>Para base de dados Azure SQL
...
Para obter mais informações sobre o Azure Purview, consulte [a documentação do Azure Purview](https://docs.microsoft.com/azure/purview/).
