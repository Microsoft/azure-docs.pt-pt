...
Na [segunda parte,](sql-database-tutorial-predictive-model-build-compare.md)aprenderá a criar e treinar vários modelos de aprendizagem automática em R, e depois escolherá o mais preciso.
...
Para utilizar os dados em R, irá carregar os dados da base de`rentaldata`dados Azure SQL num quadro de dados ().
...
> [Tutorial: Criar um modelo preditivo em R com Serviços de Machine Learning de Base de Dados Azure SQL (pré-visualização)](sql-database-tutorial-predictive-model-build-compare.md)
