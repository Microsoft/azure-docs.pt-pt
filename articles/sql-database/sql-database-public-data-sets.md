...
| [Dados do genoma público](https://www.completegenomics.com/public-data/) | "Um conjunto diversificado de dados de genomas humanos inteiros está livremente disponível para uso público para melhorar qualquer estudo genômico..." A fornecedora, Complete Genomics, é uma empresa privada com fins lucrativos. | Os conjuntos de dados, após a extração, estão em formato de texto UNIX. Também estão disponíveis ferramentas de análise. |
