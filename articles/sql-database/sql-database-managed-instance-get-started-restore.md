...
- Para consultar usando suas ferramentas ou linguagens favoritas, [consulte inícios rápidos: Conexão e consulta](sql-database-connect-query.md)do banco de dados SQL do Azure.
