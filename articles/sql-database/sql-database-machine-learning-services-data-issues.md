...
Para obter mais informações sobre tipos de dados de R suportados e não suportados, consulte [tipos de dados e de bibliotecas de R](/sql/advanced-analytics/r/r-libraries-and-data-types).
