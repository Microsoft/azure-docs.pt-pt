...
> [!NOTE]
> Encriptação de dados transparente com a integração do Azure Key Vault (traga a sua própria chave) para a instância gerida da base de dados SQL do Azure está em pré-visualização.
