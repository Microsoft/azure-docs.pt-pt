---
title: Limites de recursos baseados em vCore do banco de dados SQL do Azure – pools elásticos | Microsoft Docs
description: Esta página descreve alguns limites comuns de recursos baseados em vCore para pools elásticos no banco de dados SQL do Azure.
...
Este artigo fornece os limites de recursos detalhados para os pools elásticos do banco de dados SQL do Azure e bancos de dados em pool usando o modelo de compra baseado em vCore.

Para limites de modelo de compra baseados em DTU, consulte [limites de recursos baseados em DTU do banco de dados SQL-pools elásticos](sql-database-dtu-resource-limits-elastic-pools.md).
...
> [!NOTE]
> Os limites de recursos de bancos de dados individuais em pools elásticos geralmente são os mesmos dos bancos de dados únicos fora dos pools que têm o mesmo tamanho de computação. Por exemplo, o máximo de trabalhos simultâneos para um banco de dados GP_Gen4_1 é de 200 trabalhadores. Portanto, o máximo de trabalhos simultâneos para um banco de dados em um pool GP_Gen4_1 também é de 200 trabalhadores. Observe que o número total de trabalhos simultâneos no pool GP_Gen4_1 é de 210.
...
|Tamanho máximo do log|154|227|227|461|461|461|
...
### <a name="general-purpose-service-tier-generation-4-compute-platform-part-2"></a>Uso Geral camada de serviço: Plataforma de computação de geração 4 (parte 2)
...
|Tamanho máximo do log (GB)|461|614|614|614|1075|1229|
...
### <a name="general-purpose-service-tier-generation-5-compute-platform-part-1"></a>Uso Geral camada de serviço: Plataforma de computação de geração 5 (parte 1)
...
|Tamanho máximo de dados (GB)|512|756|756|1536|1536|1536|
|Tamanho máximo do log (GB)|154|227|227|461|461|461|461|
...
### <a name="general-purpose-service-tier-generation-5-compute-platform-part-2"></a>Uso Geral camada de serviço: Plataforma de computação de geração 5 (parte 2)
...
|Tamanho máximo do log (GB)|614|614|922|922|1229|1229|1229|
...
|Máximo de trabalhos simultâneos por pool (solicitações) *|1680|1890|2100|2520|33600|4200|8400|
|Máximo de logons simultâneos por pool (solicitações) *|1680|1890|2100|2520|33600|4200|8400|
...
|vCores|1|2|3|4|5|6|
|Memória (GB)|7|14|21|28|35|42|
|Número de DBs máximo por conjunto|Somente os bancos de computadores individuais têm suporte para esse tamanho de computação|50|100|100|100|100|
|Suporte a Columnstore|Sim|Sim|Sim|Sim|Sim|Sim|
...
|IOPS de destino (64 KB)|5000|10000|15 000|20000|25000|30000|
|Limites de taxa de log (MBps)|10|20|30|40|50|60|
|Máximo de trabalhos simultâneos por pool (solicitações) *|210|420|630|840|1050|1260|
|Máximo de logons simultâneos por pool (solicitações) *|210|420|630|840|1050|1260|
|Máximo de sessões permitidas|30000|30000|30000|30000|30000|30000|
|Opções vCore de pool elástico mínimo/máximo por banco de dados|N/A|0, 0,25, 0,5, 1, 2|0, 0,25, 0,5, 1... 3|0, 0,25, 0,5, 1... 4|0, 0,25, 0,5, 1... 5|0, 0,25, 0,5, 1... 6|
...
### <a name="business-critical-service-tier-generation-4-compute-platform-part-2"></a>Comercialmente Crítico camada de serviço: Plataforma de computação de geração 4 (parte 2)
...
|Suporte a Columnstore|N/A|N/D|N/D|N/D|N/D|N/A|
...
#### <a name="business-critical-service-tier-generation-5-compute-platform-part-1"></a>Comercialmente Crítico camada de serviço: Plataforma de computação de geração 5 (parte 1)
...
|vCores|2|4|6|8|10|12|14|
|Memória (GB)|10.2|20,4|30,6|40,8|51|61,2|71,4|
|Número de DBs máximo por conjunto|Somente os bancos de computadores individuais têm suporte para esse tamanho de computação|50|100|100|100|100|100|
|Suporte a Columnstore|Sim|Sim|Sim|Sim|Sim|Sim|Sim|
...
|IOPS de destino (64 KB)|5000|10000|15 000|20000|25000|30000|35000|
|Limites de taxa de log (MBps)|15|30|45|60|75|90|105|
|Máximo de trabalhos simultâneos por pool (solicitações) *|210|420|630|840|1050|1260|1470|
|Máximo de logons simultâneos por pool (solicitações) *|210|420|630|840|1050|1260|1470|
|Máximo de sessões permitidas|30000|30000|30000|30000|30000|30000|30000|
|Opções vCore de pool elástico mínimo/máximo por banco de dados|N/A|0, 0,25, 0,5, 1... 4|0, 0,25, 0,5, 1... 6|0, 0,25, 0,5, 1... 8|0, 0,25, 0,5, 1... 10|0, 0,25, 0,5, 1... 12|0, 0,25, 0,5, 1... 14|
...
#### <a name="business-critical-service-tier-generation-5-compute-platform-part-2"></a>Comercialmente Crítico camada de serviço: Plataforma de computação de geração 5 (parte 2)
