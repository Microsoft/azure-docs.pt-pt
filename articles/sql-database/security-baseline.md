...
**Orientação**: Utilize o Centro de Segurança Azure e remediar as recomendações de proteção da rede para a subrede para a qual o seu Servidor de Base de Dados Azure SQL está implantado. 

Para máquinas virtuais Azure (VM) que estarão conectadas à sua instância de Servidor de Base de Dados Azure SQL, ativar registos de fluxo do grupo de segurança de rede (NSG) para os NSGs que protegem esses VMs e enviar registos numa Conta de Armazenamento Azure para auditoria de tráfego. 
