...
Para acessar a página **recursos do SQL do Azure** , no menu portal do Azure, selecione **SQL do Azure** ou pesquise e selecione **SQL do Azure** em qualquer página.
...
![Página do portal SQL do Azure](../media/sql-database-technical-overview/add-azure-sql-resources.png)
...
![detalhes do bloco bancos de dados](../media/sql-database-technical-overview/single-sql-database-deployment-options.png)
