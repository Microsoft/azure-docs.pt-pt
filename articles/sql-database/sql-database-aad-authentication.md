...
description: Saiba como utilizar o Diretório Ativo Azure para autenticação com base de dados SQL, Instância Gerida e Armazém de Dados SQL
...
3. Crie um administrador de diretório Ativo Azure para o servidor de base de dados Azure SQL, a Instância Gerida ou o Armazém de [Dados Azure SQL](https://azure.microsoft.com/services/sql-data-warehouse/).
...
- Os seguintes membros da AD Azure podem ser aprovisionados no servidor Azure SQL ou no Armazém de Dados SQL:
...
- A autenticação Azure AD é suportada para base de dados SQL, Instância Gerida e Armazém de Dados SQL por utilização CLI. Para mais informações, consulte [Configure e gerea autenticação de Diretório Ativo Azure com Base de Dados SQL ou Armazém de Dados SQL](sql-database-aad-authentication-configure.md) e [Servidor SQL - servidor az sql](https://docs.microsoft.com/cli/azure/sql/server).

## <a name="next-steps"></a>Passos seguintes

- Para aprender a criar e povoar o Azure AD, e depois configurar o Azure AD com a Base de Dados Azure SQL ou o Azure SQL Data Warehouse, consulte [a Configure e gerea a autenticação de Diretório Ativo Azure com base de dados SQL, Instância Gerida ou Armazém de Dados SQL.](sql-database-aad-authentication-configure.md)
