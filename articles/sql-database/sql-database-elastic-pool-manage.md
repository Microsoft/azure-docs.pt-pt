...
description: Crie e gerea piscinas elásticas Azure SQL.
...
## <a name="azure-portal-manage-elastic-pools-and-pooled-databases"></a>Portal Azure: Gerir piscinas elásticas e bases de dados reunidas

Todas as configurações da piscina podem ser encontradas num só local: a lâmina da **piscina Configure.** Para chegar aqui, encontre uma piscina elástica no portal e clique em **Configurar piscina,** quer a partir da parte superior da lâmina, quer a partir do menu de recursos à esquerda.
...
![Lâmina de configuração de piscina elástica](./media/sql-database-elastic-pool-manage-portal/configure-pool.png)

## <a name="powershell-manage-elastic-pools-and-pooled-databases"></a>PowerShell: Gerir piscinas elásticas e bases de dados reunidas
...
Para criar e gerir piscinas elásticas sQL Database e bases de dados com a Azure PowerShell, utilize os seguintes cmdlets PowerShell. Se precisar de instalar ou atualizar o PowerShell, consulte instalar o [módulo PowerShell Azure](/powershell/azure/install-az-ps). Para criar e gerir os servidores de base de dados SQL para uma piscina elástica, consulte Criar e gerir servidores de base de [dados SQL](sql-database-servers.md). Para criar e gerir as regras de firewall, consulte Criar e gerir regras de [firewall usando powerShell](sql-database-firewall-configure.md#use-powershell-to-manage-server-level-ip-firewall-rules).

> [!TIP]
> Para scripts de exemplo PowerShell, consulte [Criar piscinas elásticas e mover bases de dados entre piscinas e fora de uma piscina usando PowerShell](scripts/sql-database-move-database-between-pools-powershell.md) e [Use PowerShell para monitorizar e escalar uma piscina elástica SQL na Base de Dados Azure SQL](scripts/sql-database-monitor-and-scale-pool-powershell.md).
>
...
## <a name="azure-cli-manage-elastic-pools-and-pooled-databases"></a>Azure CLI: Gerir piscinas elásticas e bases de dados reunidas
...
> [!TIP]
> Para scripts de exemplo Azure CLI, consulte use o CLI para mover uma base de [dados Azure SQL numa piscina elástica SQL](scripts/sql-database-move-database-between-pools-cli.md) e [use o Azure CLI para escalar uma piscina elástica SQL na Base de Dados Azure SQL](scripts/sql-database-scale-pool-cli.md).
>
...
|[sys.elastic_pool_resource_stats (Base de Dados Azure SQL)](/sql/relational-databases/system-catalog-views/sys-elastic-pool-resource-stats-azure-sql-database)|Devolve as estatísticas de utilização de recursos para todas as piscinas elásticas num servidor de base de dados SQL. Para cada piscina elástica, há uma linha para cada janela de reporte de 15 segundos (quatro linhas por minuto). Isto inclui CPU, IO, Log, consumo de armazenamento e utilização simultânea de pedidos/sessões por todas as bases de dados da piscina.|
...
## <a name="rest-api-manage-elastic-pools-and-pooled-databases"></a>REST API: Gerir piscinas elásticas e bases de dados reunidas
