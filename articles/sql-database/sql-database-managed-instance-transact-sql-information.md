...
- Há `CREATE ASSEMBLY FROM BINARY` suporte apenas para. Confira [criar Assem clicando do binário](https://docs.microsoft.com/sql/t-sql/statements/create-assembly-transact-sql). 
