...
|**is_active**| parte |Indica se as informações estão ativas ou inativas. 1 indica trabalhos ativos e 0 indica inativo.
...
|**linha**|   nvarchar (max)|  Os comandos a serem executados por trabalhos elásticos por meio de command_type.|
...
|**retry_interval_backoff_multiplier**  |foto|  O multiplicador a ser aplicado ao intervalo de repetição se várias tentativas de execução de etapa de trabalho falharem. O valor padrão é 2,0.|
...
[trabalhos]. [target_groups_members]
