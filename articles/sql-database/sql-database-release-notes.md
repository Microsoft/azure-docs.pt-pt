...
| <a href="https://aka.ms/managed-instance-tde-byok">Traga suas próprias chaves de criptografia</a> | Migre o banco de dados do local que já habilitou Transparent Data Encryption (TDE) com as chaves TDE existentes. |
