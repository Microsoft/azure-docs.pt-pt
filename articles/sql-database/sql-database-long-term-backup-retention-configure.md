---
title: 'Base de dados única: Gerir a retenção de cópias de segurança a longo prazo'
description: Saiba como armazenar e restaurar cópias de segurança automatizadas para uma base de dados única ou pooled Azure SQL no armazenamento Azure (por um período de 10 anos) utilizando o Portal Azure e a PowerShell
...
> [!IMPORTANT]
> Para a base de dados Azure SQL gerida, consulte [o suporte LTR para a ocorrência gerida](sql-database-long-term-retention.md#managed-instance-support).
