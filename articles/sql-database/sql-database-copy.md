...
The following errors can be encountered while copying a database in Azure SQL Database. Para mais informações, consulte [Copiar uma Base de Dados SQL do Azure](sql-database-copy.md).
