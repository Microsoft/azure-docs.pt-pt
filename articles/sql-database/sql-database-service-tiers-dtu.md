...
|Indexação Columnstore |N/A|S3 e acima|Suportadas|
...
| Padrão |Transações por minuto |90 º percentil às 1,0 segundos |
| Basic |Transações por hora |80 º percentil às 2,0 segundos |
