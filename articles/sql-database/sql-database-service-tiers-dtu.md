...
|Indexação Columnstore |N/D|S3 e posterior|Suportado|
...
| :-- | --: | --: | --: |
| Tamanho de armazenamento máximo por base de dados  | 2GB | 1 TB | 1 TB |
...
| Básico |Transações por hora |percentil 80th em segundos 2.0 |
