...
No arranque da base de dados, a chave de encriptação encriptada da base de dados encriptada é desencriptada e depois usada para desencriptação e reencriptação dos ficheiros da base de dados no processo do Motor de Base de Dados do Servidor SQL. A encriptação transparente de dados executa encriptação e desencriptação de I/S em tempo real dos dados ao nível da página. Cada página é desencriptada quando é lida na memória e encriptada antes de ser escrita no disco. Para uma descrição geral da encriptação transparente de dados, consulte [encriptação](https://docs.microsoft.com/sql/relational-databases/security/encryption/transparent-data-encryption)transparente de dados .
