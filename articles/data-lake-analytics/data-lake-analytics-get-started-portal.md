...
Agora, você vai criar uma Data Lake Analytics e uma conta Azure Data Lake Storage Gen1 ao mesmo tempo.  Este passo é simples e leva apenas cerca de 60 segundos para concluir.
...
O texto apresentado em seguida é um script U-SQL muito simples. Tudo o que faz é definir um pequeno conjunto de dados dentro do script e, em `/data.csv`seguida, escrever esses dados para a conta padrão data Lake Storage Gen1 como um ficheiro chamado .
