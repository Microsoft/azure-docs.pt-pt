---
title: Gerenciar políticas de Azure Data Lake Analytics
...
ms.locfileid: "71672869"
---
# <a name="manage-azure-data-lake-analytics-using-policies"></a>Gerir o Azure Data Lake Analytics com políticas

Usando políticas de conta, você pode controlar como os recursos de uma conta de Azure Data Lake Analytics são usados. Essas políticas permitem controlar o custo do uso de Azure Data Lake Analytics. Por exemplo, com essas políticas, você pode evitar picos de custo inesperados limitando o número de AUs que a conta pode usar simultaneamente.
...
Há uma política padrão definida em cada conta. A política padrão se aplica a todos os usuários da conta. Você pode definir políticas adicionais para usuários e grupos específicos. 
