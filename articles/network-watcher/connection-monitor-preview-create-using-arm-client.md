...
* Pontos Finais
    ...
    * resourceId – Para pontos finais do Azure, o ID de recursos refere-se ao ID de recursos do Azure Resource Manager (ARM) para máquinas virtuais. No caso de pontos finais não-Azure, o ID de recursos refere-se ao ID de recursos ARM para o espaço de trabalho Log Analytics ligado a agentes não-Azure.
