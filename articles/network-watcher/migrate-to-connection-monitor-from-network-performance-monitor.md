...
* No caso de o Azure VM pertencer a uma região/subscrição diferente do log analytics, certifique-se de que o Network Watcher está ativado para essa subscrição e região.   
