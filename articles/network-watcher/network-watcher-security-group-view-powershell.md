...
Nesse cenário, você executa o cmdlet `Get-AzNetworkWatcherSecurityGroupView` para recuperar as informações da regra de segurança.
...
A primeira etapa é recuperar a instância do observador de rede. Essa variável é passada para o cmdlet `Get-AzNetworkWatcherSecurityGroupView`.
