...
|**Porto local** | Este valor filtra a captura do pacote para pacotes onde a porta local corresponde a este valor de filtro.|
|**Endereço IP remoto** | Este valor filtra a captura do pacote em pacotes onde o IP remoto corresponde a este valor de filtro.|
|**Porto remoto** | Este valor filtra a captura do pacote para pacotes onde a porta remota corresponde a este valor de filtro.|
