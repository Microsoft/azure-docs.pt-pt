...
ms.locfileid: "102506604"
---
# <a name="build-the-defender-micro-agent-from-source-code-preview"></a>Construa o micro-agente Defender a partir do código fonte (Pré-visualização)
