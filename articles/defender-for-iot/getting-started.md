...
description: Neste arranque rápido, você vai aprender como começar com a compreensão do fluxo de trabalho básico para o Defender para implementação de IoT.
ms.topic: quickstart
ms.date: 2/18/2021
