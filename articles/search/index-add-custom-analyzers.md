...
|[truncato](https://lucene.apache.org/core/6_6_1/analyzers-common/org/apache/lucene/analysis/miscellaneous/TruncateTokenFilter.html)|TruncateTokenFilter|Trunca os termos num comprimento específico.<br /><br /> **Opções**<br /><br /> comprimento (tipo: int) - Padrão: 300, máximo: 300. Necessário.|  
