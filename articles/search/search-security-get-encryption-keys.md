...
+ [Início Rápido: Definir e obter um segredo do Azure Key Vault com o PowerShell](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-powershell)
