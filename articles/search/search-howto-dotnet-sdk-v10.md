...
description: Saiba como criar e gerir objetos de pesquisa numa aplicação .NET utilizando C# e Microsoft.Azure.Search (versão 10) do .NET SDK. Os snippets de código demonstram a ligação ao serviço, criando índices e consultas.
manager: nitinme
author: brjohnstmsft
ms.author: brjohnst
ms.devlang: dotnet
...
Este artigo explica como criar e gerir objetos de pesquisa usando C# e a biblioteca de clientes legado, [**Microsoft.Azure.Search**](/dotnet/api/overview/azure/search/client10) (versão 10) no Azure SDK para .NET. 

A versão 10 é a última versão do pacote Microsoft.Azure.Search. Seguindo em frente, novas funcionalidades serão [**lançadas**](/dotnet/api/overview/azure/search.documents-readme) emAzure.Search.Docda equipa Azure SDK.

> [!NOTE]
> Se tiver projetos de desenvolvimento existentes ou de bordo, pode continuar a utilizar a versão 10. Para novos projetos, ou para utilizar novas funcionalidades, deverá transitar para a [nova biblioteca.](/dotnet/api/overview/azure/search.documents-readme)
