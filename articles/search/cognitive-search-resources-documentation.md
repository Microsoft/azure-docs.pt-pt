...
+ [API REST](https://docs.microsoft.com/rest/api/searchservice/)
  + [Create Skillset (versão api=2019-05-06)](https://docs.microsoft.com/rest/api/searchservice/create-skillset)
  + [Criar Indexer (versão api=2019-05-06)](https://docs.microsoft.com/rest/api/searchservice/create-indexer)
