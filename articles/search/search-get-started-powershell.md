...
description: Explica como criar um índice, carregar dados e executar consultas usando o Invoke-RestMethod do PowerShell e a API REST do Azure Pesquisa Cognitiva.
manager: nitinme
author: heidisteen
ms.author: heidist
