...
description: Neste rest API quickstart, aprenda a criar um índice, carregar dados e executar consultas usando o Invoke-RestMethod da PowerShell e a API de Pesquisa Cognitiva Azure.
manager: nitinme
author: tchristiani
ms.author: terrychr
