...
ms.locfileid: "85318556"
---
# <a name="azure-policy-built-in-definitions-for-azure-cognitive-search"></a>Definições incorporadas da Política Azure para a Pesquisa Cognitiva Azure
...
O nome de cada definição de política incorporada liga-se à definição de política no portal th Azure. Utilize o link na coluna **versão** para visualizar a fonte no [repo GitHub da Política Azure](https://github.com/Azure/azure-policy).
