...
description: Uma API-key controla o acesso ao ponto de extremidade de serviço. As chaves de administração concedem acesso de gravação. As chaves de consulta podem ser criadas para acesso somente leitura.
manager: nitinme
author: HeidiSteen
ms.author: heidist
