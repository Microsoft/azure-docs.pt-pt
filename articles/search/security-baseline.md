...
- [Configure as chaves geridas pelo cliente para encriptação de dados usando uma identidade gerida](./search-security-manage-encryption-keys.md#3---create-a-service-identity)
