---
title: Extração de dados interna, linguagem natural, processamento de imagens-Azure Search
description: Extração de dados, linguagem natural, habilidades cognitivas de processamento de imagens adicionam semântica e estrutura ao conteúdo bruto em um pipeline de Azure Search.
manager: pablocas
author: luiscabrer
services: search
ms.service: search
