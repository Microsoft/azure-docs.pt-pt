...
A indexação não funciona em segundo plano e o serviço equilibrará o indexante adicional face às consultas em curso. Durante a indexação, pode [monitorizar os pedidos](search-monitor-queries.md) de consulta no portal para garantir que as consultas estão a ser concluídas atempadamente.
