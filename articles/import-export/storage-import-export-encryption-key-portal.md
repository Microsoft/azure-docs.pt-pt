...
6. Também pode selecionar **Criar novo** para criar um novo cofre de chaves. Na lâmina do **cofre da chave Create,** insira o grupo de recursos e o nome do cofre da chave. Aceite todos os outros incumprimentos. Selecione **Rever + Criar**.
