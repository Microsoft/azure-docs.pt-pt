---
title: Ver estado de importância dos postos de trabalho da Azure Import/Export | Microsoft Docs
...
| Fechado | Depois de todas as unidades serem enviadas de volta para si, se houver erros durante o processamento do trabalho, o trabalho está definido para **fechado**. O trabalho é automaticamente apagado após 90 dias no estado **fechado.** |
