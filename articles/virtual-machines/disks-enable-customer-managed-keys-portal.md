...
- Para o Linux: [Chaves geridas pelo cliente](./disk-encryption.md#customer-managed-keys)
- Para Windows: [Chaves geridas pelo cliente](./disk-encryption.md#customer-managed-keys)
