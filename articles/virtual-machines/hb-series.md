...
- pilha de [software](./workloads/hpc/hb-series-overview.md#software-specifications) suportado, incluindo OS suportado, e
- [desempenho](./workloads/hpc/hb-series-performance.md) esperado da série HB VM.
