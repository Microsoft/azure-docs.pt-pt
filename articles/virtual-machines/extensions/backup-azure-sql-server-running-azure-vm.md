...
- [Perguntas comuns](../../backup/faq-backup-sql-server.yml) sobre o backup das bases de dados do SQL Server que funcionam em máquinas virtuais Azure (VMs) e que utilizam o serviço de Backup Azure.
