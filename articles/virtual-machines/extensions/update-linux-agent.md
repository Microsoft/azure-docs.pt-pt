...
> ! [NOTA] Para mais informações consulte [distribuições endossadas de Linux no Azure](https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros)
