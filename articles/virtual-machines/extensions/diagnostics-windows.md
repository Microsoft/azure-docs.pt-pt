...
* [O esquema de configurações de diagnóstico](../../azure-monitor/agents/diagnostics-extension-versions.md) explica as várias opções de configurações XML para a extensão de diagnóstico.