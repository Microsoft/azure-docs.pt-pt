...
description: Como configurar a Extensão de Diagnóstico Azure Linux (LAD) 3.0 para recolher métricas e eventos de registo de VMs Linux em execução em Azure.
ms.topic: article
...
```
#### <a name="azure-cli-sample-for-installing-lad-30-extension-on-the-virtual-machine-scale-set-instance"></a>Amostra de Azure CLI para instalação da extensão LAD 3.0 na caixa de conjunto de escala de máquina virtual
...
> [!NOTE]
> Se utilizar o portal Azure em vez de JSON, o formulário de campo de condição correto é Name='/mnt'
