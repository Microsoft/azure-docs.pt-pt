...
A extensão DSC para o Windows requer que a máquina virtual alvo seja capaz de comunicar com o Azure e a localização do pacote de configuração (.ficheiro zip) se for armazenado num local fora de Azure. 
