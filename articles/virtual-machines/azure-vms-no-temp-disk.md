...
4. Utilize o snapshot para criar um novo VM sem disco (como, Dv4, Dsv4, Ev4, Esv4) seguindo os passos descritos na [Criar uma máquina virtual a partir de um instantâneo com CLI](/previous-versions/azure/virtual-machines/scripts/virtual-machines-linux-cli-sample-create-vm-from-snapshot). 
