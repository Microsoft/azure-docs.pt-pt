---
title: Visão geral da migração suportada pela plataforma de recursos iaas do clássico para o Azure Resource Manager
description: Caminhe pela migração de recursos suportadas pela plataforma do clássico para o Azure Resource Manager.
author: tanmaygore
manager: vashan
...
ms.locfileid: "102615096"
---
# <a name="platform-supported-migration-of-iaas-resources-from-classic-to-azure-resource-manager"></a>Migração suportada por plataforma dos recursos IaaS clássicos para o Azure Resource Manager
...
| Rede | Redes virtuais usando VNet Peering. | Migrar a Rede Virtual para Gestor de Recursos, em seguida, peer. Saiba mais sobre [o VNet Peering](../virtual-network/virtual-network-peering-overview.md). |
