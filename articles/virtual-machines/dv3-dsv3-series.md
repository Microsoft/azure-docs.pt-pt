...
| Tamanho | vCPU | Memória: GiB | Armazenamento (SSD) temporário GiB | Discos de dados máximos | Produção de armazenamento temporário máximo: IOPS/Read MBps/Write MBps | NICs máximos|Largura de banda de rede |
|---|---|---|---|---|---|---|---|
