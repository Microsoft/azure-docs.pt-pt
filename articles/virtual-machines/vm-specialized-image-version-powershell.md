...
Uma vez que tenha uma versão de imagem especializada, pode criar um ou mais VMs novos. Utilizando o [cmdlet New-AzVM.](https://docs.microsoft.com/powershell/module/az.compute/new-azvm) 
