...
- Pilha de [software](./workloads/hpc/hc-series-overview.md#software-specifications) suportado, incluindo SISTEMA suportado
- Desempenho [](./workloads/hpc/hc-series-performance.md) esperado do VM da série HC
