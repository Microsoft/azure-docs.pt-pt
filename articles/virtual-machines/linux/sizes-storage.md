---
title: Tamanhos de VM do Linux do Azure - armazenamento | Documentos da Microsoft
description: Lista os tamanhos de diferentes com otimização de armazenamento disponíveis para máquinas virtuais do Linux no Azure. Lista as informações sobre o número de vCPUs, discos de dados e NICs, bem como armazenamento e débito de rede largura de banda para tamanhos nesta série.
