...
3. Selecione uma subscrição. Ele é usado para pagar pelo plano.
...
Não é possível cancelar ou trocar um plano SUSE ou RedHat que você comprou. Verifique a sua utilização para se certificar de que compra o plano adequado. Para obter ajuda para identificar o que comprar, consulte [entender como o desconto do plano de software é aplicado](../../billing/billing-understand-suse-reservation-charges.md).
...
Para saber como gerenciar uma reserva, consulte [gerenciar reservas do Azure](../../billing/billing-manage-reserved-vm-instance.md).
...
- [Entenda como o desconto de reserva do SUSE é aplicado](../../billing/billing-understand-suse-reservation-charges.md)
