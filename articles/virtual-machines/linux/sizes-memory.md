---
title: Tamanhos de VM do Linux do Azure - memória | Documentos da Microsoft
description: Lista os tamanhos de diferentes com otimização de memória disponíveis para máquinas virtuais do Linux no Azure. Lista as informações sobre o número de vCPUs, discos de dados e NICs, bem como armazenamento e débito de rede largura de banda para tamanhos nesta série.
...
* Saiba como [criar e gerir VMs do Linux com a CLI do Azure](tutorial-manage-vm.md)
