...
Utilize o seguinte pedido GET para recolher a [métrica percentual](../../azure-monitor/essentials/metrics-supported.md#microsoftcomputevirtualmachines) do CPU de uma Máquina Virtual
