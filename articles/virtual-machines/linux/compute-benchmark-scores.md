...
| Tamanho da VM | CPU | vCPUs | Nódosos NUMA | Memória (GiB) | Pontuação Avg | Rio StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
