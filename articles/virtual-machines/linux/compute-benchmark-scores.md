...
ms.locfileid: "107483746"
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>Pontuações de referência do Cálculo para Os VMs do Linux
As seguintes pontuações de referência do CoreMark mostram o desempenho do computação para a linha VM de alto desempenho da Azure, executando Ubuntu 18.04. As pontuações de referência do computo também estão disponíveis para [VMs do Windows](../windows/compute-benchmark-scores.md).

## <a name="azure-coremark-toc"></a>Azure (Coremark) TOC
| Tipo | Famílias |
| ---- | -------- |
| [Com otimização de computação](#compute-optimized) | [Fsv2](#fsv2---compute--premium-storage)  |
| [Fins gerais](#general-purpose) | [B](#b---burstable) [Dsv3](#dsv3---general-compute--premium-storage) [Dv3](#dv3---general-compute) [DSv2](#dsv2---general-purpose--premium-storage) [Dv2](#dv2---general-compute) [Dasv4](#dasv4) [Dav4](#dav4) [DC](#dcs---confidential-compute-series) [DCv2](#dcsv2) [Ddsv4](#ddsv4) [Ddv4 Ddv4](#ddv4) [Dsv4](#dsv4) [Dv4](#dv4)  |
| [Computação de elevado desempenho](#high-performance-compute) | [HBv2](#hbrsv2) [HB](#hbs---memory-bandwidth-amd-epyc) [HC](#hcs---dense-computation-intel-xeon-platinum-8168)  |
| [Com otimização de memória](#memory-optimized) | [DSv2](#dsv2---general-purpose--premium-storage) [Dv2](#dv2---general-compute) [Esv3](#esv3---memory-optimized--premium-storage) [Ev3](#ev3---memory-optimized) [Eav4](#easv4) [](#eav4) [Edsv4](#edsv4) [Edv4](#edv4) [Esv4 Ev4](#esv4) [](#ev4) [Msv2](#msv2-high-memory) [Ms](#m-series-medium-memory)  |
| [Com otimização de armazenamento](#storage-optimized) | [Lsv2](#lsv2---storage-optimized)  |


## <a name="compute-optimized"></a>Otimizado para computação
### <a name="fsv2---compute--premium-storage"></a>Fsv2 - Compute + Armazenamento Premium
(10/10/2020 PBIID:7668456)

| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
### <a name="dsv2---general-purpose--premium-storage"></a>DSv2 - Final geral + Armazenamento Premium
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2as_v4 | Processador AMD EPYC 7452 32-Core | 2 | 1 | 8.0 | 38,230 | 313 | 0.82% | 77 |
| Standard_D4as_v4 | Processador AMD EPYC 7452 32-Core | 4 | 1 | 16.0 | 71,707 | 790 | 1.10% | 98 |
| Standard_D8as_v4 | Processador AMD EPYC 7452 32-Core | 8 | 1 | 32,0 | 151,474 | 1,599 | 1.06% | 56 |
| Standard_D16as_v4 | Processador AMD EPYC 7452 32-Core | 16 | 2 | 64,0 | 292,074 | 9,782 | 3.35% | 91 |
| Standard_D32as_v4 | Processador AMD EPYC 7452 32-Core | 32 | 4 | 128.0 | 575,465 | 14,574 | 2.53% | 98 |
| Standard_D48as_v4 | Processador AMD EPYC 7452 32-Core | 48 | 6 | 192.0 | 843,316 | 21,739 | 2.58% | 105 |
| Standard_D64as_v4 | Processador AMD EPYC 7452 32-Core | 64 | 8 | 256.0 | 1,120,467 | 30,714 | 2.74% | 7 |
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2a_v4 | Processador AMD EPYC 7452 32-Core | 2 | 1 | 8.0 | 38,061 | 1,219 | 3.20% | 119 |
| Standard_D4a_v4 | Processador AMD EPYC 7452 32-Core | 4 | 1 | 16.0 | 70,996 | 2,280 | 3.21% | 140 |
| Standard_D8a_v4 | Processador AMD EPYC 7452 32-Core | 8 | 1 | 32,0 | 151,379 | 1,946 | 1.29% | 147 |
| Standard_D16a_v4 | Processador AMD EPYC 7452 32-Core | 16 | 2 | 64,0 | 293,654 | 6,263 | 2.13% | 161 |
| Standard_D32a_v4 | Processador AMD EPYC 7452 32-Core | 32 | 4 | 128.0 | 571,897 | 16,009 | 2.80% | 147 |
| Standard_D48a_v4 | Processador AMD EPYC 7452 32-Core | 48 | 6 | 192.0 | 837,332 | 22,923 | 2.74% | 161 |
| Standard_D64a_v4 | Processador AMD EPYC 7452 32-Core | 64 | 8 | 256.0 | 1,126,793 | 29,148 | 2.59% | 21 |
| Standard_D96a_v4 | Processador AMD EPYC 7452 32-Core | 96 | 12 | 384.0 | 1,590,434 | 31,887 | 2.00% | 14 |

### <a name="dcs---confidential-compute-series"></a>DCS - Série De Computação Confidencial
...
## <a name="high-performance-compute"></a>Computação de elevado desempenho
### <a name="hbrsv2"></a>HBrsv2
(10/16/2020 PBIID:7668456)

| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_HB120rs_v2 | Processador AMD EPYC 7V12 64-Core | 120 | 30 | 456.0 | 2,631,430 | 81,949 | 3.11% | 21 |

### <a name="hbs---memory-bandwidth-amd-epyc"></a>HBS - largura de banda de memória (AMD EPYC)
(10/14/2020 PBIID:7668456)

| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_HB60rs | Processador AMD EPYC 7551 32-Core | 60 | 15 | 228.0 | 986,593 | 28,102 | 2.85% | 21 |

### <a name="hcs---dense-computation-intel-xeon-platinum-8168"></a>HCS - computação densa (Intel Xeon Platinum 8168)
(10/14/2020 PBIID:7668456)
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2as_v4 | Processador AMD EPYC 7452 32-Core | 2 | 1 | 16.0 | 38,155 | 432 | 1,13% | 259 |
| Standard_E4as_v4 | Processador AMD EPYC 7452 32-Core | 4 | 1 | 32,0 | 71,500 | 1,260 | 1.76% | 259 |
| Standard_E8as_v4 | Processador AMD EPYC 7452 32-Core | 8 | 1 | 64,0 | 151,201 | 3,171 | 2.10% | 259 |
| Standard_E16as_v4 | Processador AMD EPYC 7452 32-Core | 16 | 2 | 128.0 | 293,186 | 6,371 | 2.17% | 280 |
| Standard_E20as_v4 | Processador AMD EPYC 7452 32-Core | 20 | 3 | 160.0 | 363,292 | 8,744 | 2.41% | 280 |
| Standard_E32as_v4 | Processador AMD EPYC 7452 32-Core | 32 | 4 | 256.0 | 570,199 | 14,140 | 2.48% | 294 |
| Standard_E48as_v4 | Processador AMD EPYC 7452 32-Core | 48 | 6 | 384.0 | 841,547 | 21,858 | 2.60% | 301 |
| Standard_E64as_v4 | Processador AMD EPYC 7452 32-Core | 64 | 8 | 512.0 | 1,108,151 | 28,783 | 2.60% | 28 |
| Standard_E96as_v4 | Processador AMD EPYC 7452 32-Core | 96 | 12 | 672.0 | 1,578,349 | 27,080 | 1.72% | 42 |
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2a_v4 | Processador AMD EPYC 7452 32-Core | 2 | 1 | 16.0 | 38,035 | 900 | 2.37% | 196 |
| Standard_E4a_v4 | Processador AMD EPYC 7452 32-Core | 4 | 1 | 32,0 | 71,345 | 949 | 1.33% | 196 |
| Standard_E8a_v4 | Processador AMD EPYC 7452 32-Core | 8 | 1 | 64,0 | 151,511 | 1,940 | 1.28% | 189 |
| Standard_E16a_v4 | Processador AMD EPYC 7452 32-Core | 16 | 2 | 128.0 | 292,668 | 7,220 | 2.47% | 196 |
| Standard_E20a_v4 | Processador AMD EPYC 7452 32-Core | 20 | 3 | 160.0 | 361,845 | 9,332 | 2.58% | 196 |
| Standard_E32a_v4 | Processador AMD EPYC 7452 32-Core | 32 | 4 | 256.0 | 570,615 | 14,419 | 2.53% | 196 |
| Standard_E48a_v4 | Processador AMD EPYC 7452 32-Core | 48 | 6 | 384.0 | 841,419 | 26,181 | 3.11% | 196 |
| Standard_E64a_v4 | Processador AMD EPYC 7452 32-Core | 64 | 8 | 512.0 | 1,116,891 | 28,545 | 2.56% | 14 |
| Standard_E96a_v4 | Processador AMD EPYC 7452 32-Core | 96 | 12 | 672.0 | 1,592,228 | 32,515 | 2.04% | 14 |
...
| Standard_E32 8ds_v4 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 8 | 2 | 256.0 | 136,743 | 2124 | 1.55% | 42 |
...
### <a name="msv2-high-memory"></a>Memória Alta Msv2
...
### <a name="m-series-medium-memory"></a>M-série Memória Média
...
### <a name="lsv2---storage-optimized"></a>Lsv2 - Armazenamento Otimizado
(10/13/2020 PBIID:7668456)

| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | Processador AMD EPYC 7551 32-Core | 8 | 1 | 64,0 | 102,237 | 1,320 | 1.29% | 77 |
| Standard_L16s_v2 | Processador AMD EPYC 7551 32-Core | 16 | 2 | 128.0 | 198,472 | 3,734 | 1.88% | 70 |
| Standard_L32s_v2 | Processador AMD EPYC 7551 32-Core | 32 | 4 | 256.0 | 390,015 | 10,126 | 2.60% | 77 |
| Standard_L48s_v2 | Processador AMD EPYC 7551 32-Core | 48 | 6 | 384.0 | 583,388 | 15,479 | 2.65% | 77 |
| Standard_L64s_v2 | Processador AMD EPYC 7551 32-Core | 64 | 8 | 512.0 | 774,827 | 19,205 | 2.48% | 77 |
| Standard_L80s_v2 | Processador AMD EPYC 7551 32-Core | 80 | 10 | 640.0 | 966,682 | 22,811 | 2.36% | 77 |


## <a name="about-coremark"></a>Sobre o CoreMark

[CoreMark](https://www.eembc.org/coremark/faq.php) é uma referência que testa a funcionalidade de um microctronoller (MCU) ou unidade central de processamento (CPU). O CoreMark não é dependente do sistema, pelo que funciona da mesma forma independentemente da plataforma (por exemplo, processador de gama alta ou de gama baixa). 

Os números de Linux foram calculados executando CoreMark em Ubuntu 18.04. O CoreMark foi configurado com o número de fios definidos para o número de CPUs virtuais, e a concordância definida para `PThreads` . O número de iterações-alvo foi ajustado com base no desempenho esperado para proporcionar um tempo de funcionaamento de pelo menos 20 segundos (normalmente muito mais longo). A pontuação final representa o número de iterações completas divididas pelo número de segundos que demorou a executar o teste. Cada teste foi executado pelo menos sete vezes em cada VM. Datas de teste mostradas acima. Os testes realizados em vários VMs em todas as regiões públicas do Azure o VM foi apoiado na data executada. 

### <a name="running-coremark-on-azure-vms"></a>Running Coremark em VMs Azure

**Download:**

CoreMark é uma ferramenta de código aberto que pode ser descarregada a partir do [GitHub.](https://github.com/eembc/coremark)

**Construção e execução:**

Para construir e executar o benchmark, escreva:

```> make```

Os resultados completos estão disponíveis nos ficheiros ```run1.log``` e ```run2.log``` . 
```run1.log``` contém resultados CoreMark. Estes são os resultados de referência com parâmetros de desempenho.
```run2.log``` contém resultados de referência com parâmetros de validação. 

**Tempo de execução:**

Por predefinição, o benchmark funcionará entre 10 a 100 segundos. Para anular, usar ```ITERATIONS=N```

```% make ITERATIONS=10```

acima da bandeira vai executar o benchmark para 10 iterações. 
**Os resultados só são válidos para reportar se o benchmark for de pelo menos 10 segundos!**

**Execução Paralela:**

Utilize ```XCFLAGS=-DMULTITHREAD=N``` onde N é o número de fios a serem executados em paralelo. Várias implementações estão disponíveis para executar em vários contextos.

```% make XCFLAGS="-DMULTITHREAD=4 -DUSE_PTHREAD"```

O acima irá compilar o referencial para a execução em 4 núcleos.

**Recomendações para os melhores resultados**

- O benchmark precisa de funcionar durante pelo menos 10 segundos, provavelmente mais tempo em sistemas maiores.
- Todos os ficheiros de origem devem ser compilados com as mesmas bandeiras.
- Não altere os ficheiros de origem para além ```core_portme*``` (use ```make check``` para validar)
- Várias corridas são sugeridas para obter os melhores resultados.

## <a name="coverage"></a>Cobertura

Séries preprecadas mais antigas não são mostradas. As séries N não são mostradas como centradas na GPU e a Coremark não mede o desempenho da GPU.  As séries mais recentes podem ainda não ter sido comparadas.
Versões anteriores deste documento citaram benchmark runs de Ubuntu 16.04, o que resultou num desempenho ligeiramente inferior aos atuais referenciais em Ubuntu 18.04.
