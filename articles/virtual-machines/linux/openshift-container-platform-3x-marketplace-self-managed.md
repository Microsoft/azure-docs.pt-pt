...
- **Nós de infra-estrutura**: três (3) nós de infra-estrutura com tipo de instância configurável.
...
| Subscrição | Assinatura do Azure na qual implantar o cluster |
