---
title: Criar imagens de Máquina Virtual do Azure partilhadas para o Linux no portal do | Documentos da Microsoft
...
> [!IMPORTANT]
> Não é possível utilizar o portal para implementar uma VM a partir de uma imagem no outro inquilino do azure. Para criar uma VM a partir de uma imagem partilhada entre inquilinos, tem de utilizar o [CLI do Azure](shared-images.md#create-a-vm) ou [Powershell](../windows/shared-images.md#create-vms-from-an-image).
...
1. Sob **conta de administrador**, selecione **palavra-passe** ou **chave pública SSH**, em seguida, introduza as suas informações.
1. Se pretender permitir o acesso remoto à VM, em **portas de entrada públicas**, escolha **permitir portas selecionadas** e, em seguida, selecione **SSH (22)** na lista suspensa. Se não pretender permitir o acesso remoto à VM, deixe **None** selecionado para **portas de entrada públicas**.
