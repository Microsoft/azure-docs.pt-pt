...
- [Exportar/copiar instantâneos geridos como VHD para uma conta de armazenamento numa região diferente com a CLI](/previous-versions/azure/virtual-machines/scripts/virtual-machines-cli-sample-copy-managed-disks-vhd)