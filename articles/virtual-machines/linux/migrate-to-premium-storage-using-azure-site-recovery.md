...
2. Selecione **Criar uma**cópia de segurança de gestão de recursos e recuperação do  >  **Management**  >  **Backup** **site (OMS)**. Em alternativa, pode **Browse**selecionar O  >  **Abóbada**de Serviços de Recuperação de Navegação  >  **Add**. 
