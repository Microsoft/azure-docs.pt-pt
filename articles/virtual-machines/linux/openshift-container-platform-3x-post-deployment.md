...
Leia as [instruções completas](../../azure-monitor/containers/containers.md#configure-a-log-analytics-agent-for-red-hat-openshift) para mais detalhes.
