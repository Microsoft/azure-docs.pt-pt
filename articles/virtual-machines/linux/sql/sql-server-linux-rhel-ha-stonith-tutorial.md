...
> [Tutorial: Configure o ouvinte do grupo de disponibilidade para o SQL Server em máquinas virtuais RHEL em Azure](sql-server-linux-rhel-ha-listener-tutorial.md)
