...
Este artigo mostra-lhe como criar uma cópia da sua máquina virtual Azure (VM) executando o Linux utilizando o modelo de implementação Azure CLI e o Modelo de Implementação do Gestor de Recursos Azure. 
