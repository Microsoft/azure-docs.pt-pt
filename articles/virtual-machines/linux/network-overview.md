---
title: Redes virtuais e máquinas virtuais do Linux no Azure
description: Saiba mais sobre a rede, pois ela se relaciona com as noções básicas de criação de máquinas virtuais do Linux no Azure.
