...
Saiba mais sobre a [arquitetura subjacente, topologia VM,](./workloads/hpc/hbv2-series-overview.md)e [desempenho](./workloads/hpc/hbv2-performance.md) esperado da série HBv2 VM.
