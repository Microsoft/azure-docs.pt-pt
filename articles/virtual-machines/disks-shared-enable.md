...
Os discos partilhados suportam vários sistemas operativos. Consulte as secções [Windows](./disks-shared.md#windows) e [Linux](./disks-shared.md#linux) do artigo conceptual para os sistemas operativos suportados.
