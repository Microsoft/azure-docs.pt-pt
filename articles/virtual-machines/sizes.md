...
:::image type="content" source="media/sizes/azurevmsthumb.jpg" alt-text="Vídeo do YouTube para selecionar o tamanho certo para o seu VM." link="https://youtu.be/zOSvnJFd3ZM":::
...
| [GPU](sizes-gpu.md) | NC, NCv2, NCv3, NCasT4_v3, ND, NDv2, NV, NVv3, NVv4 | Máquinas virtuais especializadas direcionadas para renderização gráfica pesada e edição de vídeo, bem como treino de modelos e inferenização (ND) com aprendizagem profunda. Disponível com GPUs individuais ou múltiplas. |
