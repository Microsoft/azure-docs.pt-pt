...
Para outras opções de backup do Servidor SQL e restaurar, consulte [backup e restauro para o Servidor SQL em Máquinas Virtuais Azure](virtual-machines-windows-sql-backup-recovery.md).
