...
Se preferir ter um walk-through completo tanto de provisionamento como de conectividade, consulte [o Provisioning a SQL Server Virtual Machine on Azure](virtual-machines-windows-portal-sql-server-provision.md).
...
![Opção pública de conectividade SQL durante o provisionamento](./media/virtual-machines-windows-sql-connect/sql-vm-portal-connectivity.png)
...
Para ver instruções de provisionamento juntamente com estes passos de conectividade, consulte [o fornecimento de uma máquina virtual do Servidor SQL no Azure](virtual-machines-windows-portal-sql-server-provision.md).
