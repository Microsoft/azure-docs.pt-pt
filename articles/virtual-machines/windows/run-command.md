...
O exemplo a seguir utiliza o comando [de comando de execução az vm](/cli/azure/vm/run-command#az-vm-run-command-invoke) para executar uma script de concha num Azure Windows VM.
