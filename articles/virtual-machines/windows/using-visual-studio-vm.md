...
|:------------------------------------------------------------:|:----------------------------:|:------------------------:|
|     Visual Studio 2019: Pré-visualização (RC3)                        |           Enterprise         |    Versão 16.0.0 RC3    |
| Visual Studio 2017: Versão mais recente (versão 15.9)                    |    Enterprise, da Comunidade     |      Versão 15.9.9      |
