---
title: Usar o PowerShell para redimensionar uma VM do Windows no Azure
description: Redimensione uma máquina virtual do Windows criada no modelo de implantação do Gerenciador de recursos usando o Azure PowerShell.
...
ms.locfileid: "74073358"
---
# <a name="resize-a-windows-vm"></a>Redimensionar uma VM do Windows

Este artigo mostra como mover uma VM para um [tamanho de VM](sizes.md) diferente usando o Azure PowerShell.
...
## <a name="resize-a-windows-vm-in-an-availability-set"></a>Redimensionar uma VM do Windows em um conjunto de disponibilidade
