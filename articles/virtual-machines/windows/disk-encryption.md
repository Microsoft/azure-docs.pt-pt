...
- [Ativar a encriptação baseada no anfitrião](disks-enable-host-based-encryption-powershell.md)
- [Azure PowerShell - Ative a dupla encriptação em repouso - discos geridos](disks-enable-double-encryption-at-rest-powershell.md)
- [Ativar as chaves geridas pelo cliente para o seu disco gerido - PowerShell](disks-enable-customer-managed-keys-powershell.md)
- [Ativar chaves geridas pelo cliente - discos geridos](disks-enable-customer-managed-keys-portal.md)
