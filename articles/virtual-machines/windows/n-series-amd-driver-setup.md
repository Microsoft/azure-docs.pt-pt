...
<br />
![Estado do dispositivo GPU](./media/n-series-amd-driver-setup/device-manager.png)
...
<br />
![Propriedades de GPU](./media/n-series-amd-driver-setup/dxdiag-output-new.png)
