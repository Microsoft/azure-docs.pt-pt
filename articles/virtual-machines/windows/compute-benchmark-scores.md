---
title: Pontuações de referência do Compute para VMs do Azure Windows
description: Compare as pontuações de referência da computação SPECint para VMs Azure que executam o Windows Server.
author: cynthn
...
ms.locfileid: "107479564"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>Pontuações de referência do Compute para VMs do Windows
As seguintes pontuações de referência coreMark mostram desempenho do cálculo para selecionar VMs Azure com execução do Windows Server 2019. As pontuações de referência do computo também estão disponíveis para [Os VMs do Linux.](../linux/compute-benchmark-scores.md)

| Tipo | Famílias |
| ---- | -------- |
| [Com otimização de computação](#compute-optimized) | [Fsv2](#fsv2---compute--premium-storage)  |
| [Fins gerais](#general-purpose) | [Dsv3](#dsv3---general-compute--premium-storage) [Dv3](#dv3---general-compute) [Dasv4](#dasv4) [Ddsv4 Ddv4](#ddsv4) [](#dav4) [Dsv4](#ddv4) [Dsv4](#dsv4) [Dv4](#dv4)  |
| [Com otimização de memória](#memory-optimized) | [Esv3](#esv3---memory-optimized--premium-storage) [Ev3](#ev3---memory-optimized) [Easv4](#easv4) [Eav4](#eav4) [Edsv4](#edsv4) [Edv4](#edv4) [Esv4 Ev4](#esv4) [Ev4](#ev4)  |
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2as_v4 | Processador AMD EPYC 7452 32-Core                 | 2 | 1 | 8.0 | 37,986 | 1,199 | 3.16% | 238 |
| Standard_D4as_v4 | Processador AMD EPYC 7452 32-Core                 | 4 | 1 | 16.0 | 75,828 | 1,343 | 1.77% | 196 |
| Standard_D8as_v4 | Processador AMD EPYC 7452 32-Core                 | 8 | 1 | 32,0 | 150,134 | 2,511 | 1.67% | 210 |
| Standard_D16as_v4 | Processador AMD EPYC 7452 32-Core                 | 16 | 2 | 64,0 | 286,789 | 5,984 | 2.09% | 224 |
| Standard_D32as_v4 | Processador AMD EPYC 7452 32-Core                 | 32 | 4 | 128.0 | 566,270 | 8,484 | 1.50% | 140 |
| Standard_D48as_v4 | Processador AMD EPYC 7452 32-Core                 | 48 | 6 | 192.0 | 829,547 | 15,679 | 1.89% | 126 |
| Standard_D64as_v4 | Processador AMD EPYC 7452 32-Core                 | 64 | 8 | 256.0 | 1,088,030 | 16,708 | 1.54% | 28 |
| Standard_D96as_v4 | Processador AMD EPYC 7452 32-Core                 | 96 | 12 | 384.0 | 751,849 | 6,836 | 0.91% | 14 |
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2a_v4 | Processador AMD EPYC 7452 32-Core                 | 2 | 1 | 8.0 | 38,028 | 995 | 2,62% | 238 |
| Standard_D4a_v4 | Processador AMD EPYC 7452 32-Core                 | 4 | 1 | 16.0 | 75,058 | 1,874 | 2.50% | 238 |
| Standard_D8a_v4 | Processador AMD EPYC 7452 32-Core                 | 8 | 1 | 32,0 | 149,706 | 2,520 | 1.68% | 168 |
| Standard_D16a_v4 | Processador AMD EPYC 7452 32-Core                 | 16 | 2 | 64,0 | 287,479 | 4,907 | 1.71% | 238 |
| Standard_D32a_v4 | Processador AMD EPYC 7452 32-Core                 | 32 | 4 | 128.0 | 567,019 | 11,019 | 1.94% | 210 |
| Standard_D48a_v4 | Processador AMD EPYC 7452 32-Core                 | 48 | 6 | 192.0 | 835,617 | 13,097 | 1.57% | 140 |
| Standard_D64a_v4 | Processador AMD EPYC 7452 32-Core                 | 64 | 8 | 256.0 | 1,099,165 | 21,962 | 2.00% | 252 |
| Standard_D96a_v4 | Processador AMD EPYC 7452 32-Core                 | 96 | 12 | 384.0 | 749,340 | 8,728 | 1.16% | 126 |
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2as_v4 | Processador AMD EPYC 7452 32-Core                 | 2 | 1 | 16.0 | 38,070 | 1,150 | 3.02% | 210 |
| Standard_E4as_v4 | Processador AMD EPYC 7452 32-Core                 | 4 | 1 | 32,0 | 75,733 | 1,444 | 1.91% | 196 |
| Standard_E4-2as_v4 | Processador AMD EPYC 7452 32-Core                 | 2 | 1 | 32,0 | 38,105 | 943 | 2.47% | 168 |
| Standard_E8as_v4 | Processador AMD EPYC 7452 32-Core                 | 8 | 1 | 64,0 | 149,522 | 2,333 | 1.56% | 210 |
| Standard_E8 2as_v4 | Processador AMD EPYC 7452 32-Core                 | 2 | 1 | 64,0 | 38,103 | 1,078 | 2.83% | 168 |
| Standard_E8-4as_v4 | Processador AMD EPYC 7452 32-Core                 | 4 | 1 | 64,0 | 76,060 | 1,132 | 1.49% | 168 |
| Standard_E16as_v4 | Processador AMD EPYC 7452 32-Core                 | 16 | 2 | 128.0 | 288,136 | 4,720 | 1.64% | 210 |
| Standard_E16-4as_v4 | Processador AMD EPYC 7452 32-Core                 | 4 | 2 | 128.0 | 73,038 | 2,310 | 3.16% | 196 |
| Standard_E16 8as_v4 | Processador AMD EPYC 7452 32-Core                 | 8 | 2 | 128.0 | 144,266 | 2,782 | 1.93% | 168 |
| Standard_E20as_v4 | Processador AMD EPYC 7452 32-Core                 | 20 | 3 | 160.0 | 346,277 | 7,387 | 2.13% | 14 |
| Standard_E20as_v4 | Processador AMD EPYC 7452 32-Core                 | 20 | 5 | 160.0 | 351,213 | 7,002 | 1.99% | 196 |
| Standard_E32as_v4 | Processador AMD EPYC 7452 32-Core                 | 32 | 4 | 256.0 | 561,950 | 7,679 | 1.37% | 42 |
| Standard_E32-8as_v4 | Processador AMD EPYC 7452 32-Core                 | 8 | 4 | 256.0 | 143,569 | 3,393 | 2.36% | 182 |
| Standard_E32 16as_v4 | Processador AMD EPYC 7452 32-Core                 | 16 | 4 | 256.0 | 283,614 | 5,018 | 1.77% | 182 |
| Standard_E48as_v4 | Processador AMD EPYC 7452 32-Core                 | 48 | 6 | 384.0 | 832,627 | 19,565 | 2.35% | 210 |
| Standard_E64as_v4 | Processador AMD EPYC 7452 32-Core                 | 64 | 8 | 512.0 | 1,097,588 | 26,100 | 2.38% | 280 |
| Standard_E64-16as_v4 | Processador AMD EPYC 7452 32-Core                 | 16 | 8 | 512.0 | 284,934 | 5,065 | 1,78% | 154 |
| Standard_E64-32as_v4 | Processador AMD EPYC 7452 32-Core                 | 32 | 8 | 512.0 | 561,951 | 9,691 | 1.72% | 140 |
| Standard_E96as_v4 | Processador AMD EPYC 7452 32-Core                 | 96 | 12 | 672.0 | 750,338 | 9,645 | 1.29% | 182 |
| Standard_E96 24as_v4 | Processador AMD EPYC 7452 32-Core                 | 24 | 11 | 672.0 | 423,442 | 8,504 | 2.01% | 182 |
| Standard_E96-48as_v4 | Processador AMD EPYC 7452 32-Core                 | 48 | 11 | 672.0 | 839,993 | 14,218 | 1.69% | 70 |
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2a_v4 | Processador AMD EPYC 7452 32-Core                 | 2 | 1 | 16.0 | 38,008 | 995 | 2,62% | 210 |
| Standard_E4a_v4 | Processador AMD EPYC 7452 32-Core                 | 4 | 1 | 32,0 | 75,410 | 1,431 | 1.90% | 196 |
| Standard_E8a_v4 | Processador AMD EPYC 7452 32-Core                 | 8 | 1 | 64,0 | 148,810 | 2,630 | 1.77% | 210 |
| Standard_E16a_v4 | Processador AMD EPYC 7452 32-Core                 | 16 | 2 | 128.0 | 286,811 | 4,877 | 1.70% | 182 |
| Standard_E20a_v4 | Processador AMD EPYC 7452 32-Core                 | 20 | 3 | 160.0 | 351,049 | 6,268 | 1.79% | 210 |
| Standard_E32a_v4 | Processador AMD EPYC 7452 32-Core                 | 32 | 4 | 256.0 | 565,363 | 10,941 | 1.94% | 126 |
| Standard_E48a_v4 | Processador AMD EPYC 7452 32-Core                 | 48 | 6 | 384.0 | 837,493 | 15,803 | 1.89% | 126 |
| Standard_E64a_v4 | Processador AMD EPYC 7452 32-Core                 | 64 | 8 | 512.0 | 1,097,111 | 30,290 | 2.76% | 336 |
| Standard_E96a_v4 | Processador AMD EPYC 7452 32-Core                 | 96 | 12 | 672.0 | 749,908 | 8,646 | 1.15% | 196 |
...
| Standard_E8 4ds_v4 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 4 | 1 | 64,0 | 67,144 | 1200 | 1.79% | 182 |
...
### <a name="edsv4-isolated-extended"></a>Edsv4 Isolado Estendido
(04/05/2021 PBIID:9198755)
...
| Tamanho da VM | CPU | vCPUs | Nó de numções | Memória (GiB) | Pontuação Avg | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E96ias_v4 | Processador AMD EPYC 7452 32-Core                 | 96 | 12 | 672.0 | 749,545 | 8,690 | 1.16% | 28 |
...
### <a name="esv4-isolated-extended"></a>Esv4 Isolado Estendido
(04/05/2021 PBIID:9198755)
