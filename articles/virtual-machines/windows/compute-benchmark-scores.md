---
title: Calcular pontuações de parâmetro de comparação para VMs do Windows do Azure | Microsoft Docs
description: Compare as pontuações de benchmark de computação SPECint para VMs do Azure que executam o Windows Server.
...
| Size | vCPUs | Nós NUMA | CPU | Execuções | Taxa base média | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
| Standard_M64-32ms Standard | 32 | 2 | Intel (R) Xeon (R) CPU E7-8890 v3 @ 2,50 GHz | 12 | 586,8 | 5.4 | 
...
| Standard_M128-32ms Standard | 32 | 4 | Intel (R) Xeon (R) CPU E7-8890 v3 @ 2,50 GHz | 13 | 620,5 | 2.5 | 
| Standard_M128-64Ms Standard | 64 | 4 | Intel (R) Xeon (R) CPU E7-8890 v3 @ 2,50 GHz | 12 | 1140,8 | 2.9 | 
