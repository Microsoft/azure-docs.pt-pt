...
Se quiser, também pode migrar recursos utilizando o [CLI Azure](../linux/migration-classic-resource-manager-cli.md).
...
Se não conseguir adicionar um coadministrator, contacte um administrador de serviço ou coadministrator para que a subscrição seja adicionada.
