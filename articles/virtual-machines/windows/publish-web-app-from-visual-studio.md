...
- O VM deve ter um nome DNS configurado. Para obter mais informações, consulte [Criar um nome de domínio totalmente qualificado no portal Azure para um Windows VM](../create-fqdn.md).
