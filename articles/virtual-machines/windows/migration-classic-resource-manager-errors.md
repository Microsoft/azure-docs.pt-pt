...
description: Este artigo cataloga os erros e mitigações mais comuns durante a migração dos recursos iaaS da Azure Service Management para a stack Do Gestor de Recursos Azure.
