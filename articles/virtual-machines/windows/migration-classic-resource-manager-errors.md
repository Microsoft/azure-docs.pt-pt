...
description: Conheça os erros e mitigações mais comuns que ocorrem durante a migração dos recursos iaaS da Azure Service Management para a pilha Azure Resource Manager.
author: tanmaygore
manager: vashan
