...
Existem dois métodos para encontrar o LUN, que você escolhe vai depender se você estiver usando [Espaços de Armazenamento](https://docs.microsoft.com/windows-server/storage/storage-spaces/overview) ou não.

### <a name="disk-management"></a>Gestão de Disco

Se não estiver a utilizar piscinas de armazenamento, pode utilizar a [Gestão do Disco](https://docs.microsoft.com/windows-server/storage/disk-management/overview-of-disk-management) para encontrar o LUN.
