---
title: Instale o Micro Focus Enterprise Server 5.0 e o Enterprise Developer 5.0 no Azure | Microsoft Docs
...
-   Obtenha a documentação para [Enterprise Server e Enterprise Developer](https://www.microfocus.com/documentation/enterprise-developer/ed50/).
    ...
    > -   Um túnel [de rede privada virtual local (VPN).](../../../../vpn-gateway/vpn-gateway-create-site-to-site-rm-powershell.md)
