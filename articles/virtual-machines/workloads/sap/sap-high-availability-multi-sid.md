...
Em setembro de 2016, a Microsoft lançou um recurso em que você pode gerenciar vários endereços IP virtuais usando um balanceador de carga interno do Azure. Essa funcionalidade já existe no balanceador externo de carga do Azure.
...
4. [Instalar a instância do banco de dados] [SAP-ha-Guide-9,2].  
