---
title: Utilizar o SAP nas máquinas virtuais do Linux | Documentos da Microsoft
...
## <a name="sap-netweaver-on-azure-suse-linux-virtual-machines"></a>SAP NetWeaver em máquinas virtuais do Azure SUSE Linux
Título: Testar o SAP NetWeaver em VMs do Linux do Microsoft Azure SUSE

Resumo: Não há nenhum suporte oficial do SAP para executar o SAP NetWeaver em VMs Linux do Azure no momento. No entanto, os clientes poderão querer fazer alguns testes ou podem considerar para executar sistemas de treinamento ou de demonstração SAP em VMs do Linux do Azure, desde que não é necessário para contactar o suporte da SAP. Este artigo deve ajudar a configuração de VMs do SUSE Linux do Azure para executar o SAP e fornece algumas dicas de básicas para evitar as armadilhas comuns de potenciais.
