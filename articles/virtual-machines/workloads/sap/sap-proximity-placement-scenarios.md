...
ms.locfileid: "70077991"
---
# <a name="azure-proximity-placement-groups-for-optimal-network-latency-with-sap-applications"></a>Azure Proximity Placement Groups para latência de rede otimizada com aplicações SAP
...
- [Visualizar: Implantar VMs em grupos de posicionamento de proximidade usando CLI do Azure](https://docs.microsoft.com/azure/virtual-machines/linux/proximity-placement-groups)
- [Visualizar: Implantar VMs em grupos de posicionamento de proximidade usando o PowerShell](https://docs.microsoft.com/azure/virtual-machines/windows/proximity-placement-groups)
