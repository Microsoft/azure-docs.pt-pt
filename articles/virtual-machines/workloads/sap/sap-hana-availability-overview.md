...
Além de estar familiarizado com a implementação de VMs em Azure, antes de definir a sua arquitetura de disponibilidade em Azure, recomendamos que leia [Gerir a disponibilidade de máquinas virtuais windows em Azure.](../../availability.md)
