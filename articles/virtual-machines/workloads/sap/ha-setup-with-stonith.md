...
3.1.1 Verifique se os padrões de ha_sles e SAPHanaSR-Doc estão instalados. Se não estiver instalado, instale-os. Instale-o em **ambos** os nós.
```
...
Execute o *crm_mon* de comando para garantir que **ambos** os nós estejam online. Você pode executá-lo em **qualquer um dos nós** do cluster
```
crm_mon
```
![CRM-Mon. png](media/HowToHLI/HASetupWithStonith/crm-mon.png) você também pode fazer logon no Hawk para verificar o status do cluster *https://\<o nó IP >: 7630*. O usuário padrão é hacluster e a senha é Linux. Se necessário, você pode alterar a senha usando o comando *passwd* .
...
Além disso, você pode ver o status em *https://\<endereço IP do nó >: 7630/CIB/Live/State*
