...
3. Validação técnica 
   ...
   2. Armazenamento
      1.  Uso [armazenamento SSD Standard do Azure](https://docs.microsoft.com/azure/virtual-machines/windows/disks-types#standard-ssd) como mínimo para as VMs que representa a camadas de aplicações SAP e para a implementação de DBMS confidencial não-desempenho
      2.  Que recomendamos para não utilizar [discos do Azure Standard HDD](https://docs.microsoft.com/azure/virtual-machines/windows/disks-types#standard-hdd) em geral
      2.  Uso [armazenamento Premium do Azure](https://docs.microsoft.com/azure/virtual-machines/windows/disks-types#premium-ssd) para todas as VMs DBMS que são remotamente desempenho confidencial
   ...
   3. Redes
      1.  Testar e avaliar a sua infraestrutura de VNet e a distribuição das suas aplicações SAP em ou em diferentes redes virtuais do Azure
          ...
          6.   Se estiver a utilizar o Balanceador de carga do Azure em conjunto com verificação de sistemas operativos de convidado de Linux que o Linux rede parâmetro **net.ipv4.tcp_timestamps** está definida como **0**. Contra as recomendações nas versões mais antigas do SAP note [#2382421](https://launchpad.support.sap.com/#/notes/2382421). A nota SAP enquanto isso é atualizada para refletir o fato de que o parâmetro tem de ser definido como 0 para trabalhar em conjunto com balanceadores de carga do Azure.
