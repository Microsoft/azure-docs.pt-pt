...
Este artigo descreve como implantar vários sistemas de alta disponibilidade do SAP NetWeaver (ou seja, vários SIDs) em um cluster de dois nós em VMs do Azure com SUSE Linux Enterprise Server para aplicativos SAP.  
...
8. **[1]** crie os recursos de cluster do SAP para o sistema SAP recentemente instalado. 
   ...
   O exemplo mostrado aqui é para sistemas SAP **NW2** e **NW3**, supondo que esteja usando o enqueue Server 1 Architecture (ENSA1):
