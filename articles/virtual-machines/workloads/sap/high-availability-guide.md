...
Neste artigo, utilizamos modelos de Gestor de Recursos Azure para [netWeaver SAP de três níveis.](https://github.com/Azure/azure-quickstart-templates/) Para obter uma visão geral útil dos modelos, consulte [os modelos do GESTOR de Recursos SAP Azure](https://blogs.msdn.microsoft.com/saponsqlserver/2016/05/16/azure-quickstart-templates-for-sap/).
