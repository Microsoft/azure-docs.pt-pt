...
## <a name="provider-type-sap-hana"></a>Tipo de fornecedor: SAP HANA
...
## <a name="provider-type-microsoft-sql-server"></a>Tipo de fornecedor: Servidor Microsoft SQL
...
## <a name="provider-type-high-availability-cluster"></a>Tipo de fornecedor: Cluster de alta disponibilidade
...
- Consulte [os passos de embarque](./azure-monitor-sap-quickstart.md) e crie o seu primeiro recurso Azure Monitor para soluções SAP.
