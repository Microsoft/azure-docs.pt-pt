...
- **Componente SAP**: um aplicativo SAP individual, como um componente central de ERP (ECC), Business Warehouse (BW), Solution Manager ou Enterprise Portal (EP). Os componentes SAP podem ser baseados em tecnologias tradicionais de ABAP ou Java ou em um aplicativo não baseado em NetWeaver, como objetos comerciais.
...
- **Cenário SAP**: refere-se a todos os ativos SAP em seu cenário de ti. A estrutura SAP inclui todos os ambientes de produção e de não produção.
...
- **Categoria de SKU**: para o SAP Hana em instâncias grandes, as duas categorias de SKUs a seguir são oferecidas:
