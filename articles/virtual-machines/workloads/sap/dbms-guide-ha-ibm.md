...
### <a name="hosts-dns-updates"></a>Hospedar Atualizações de DNS
...
1. Criar um pool de IPS de front-end:
   ...
   e. Depois que o novo pool de IPS de front-end for criado, observe o endereço IP do pool.
...
1. Crie as regras de balanceamento de carga:
   ...
   f. Certifique-se de **habilitar o IP flutuante**.
