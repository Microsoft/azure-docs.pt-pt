...
| Plataforma de Comércio SAP Hybris 5.x e 6.x | Windows | SQL Server | Todos os tipos de VM certificados netWeaver<br /> [Hybris Wiki](https://wiki.hybris.com/display/SUP/Using+the+hybris+Platform+with+the+Cloud) |
