...
3. **[A]** configurar resolução de nome de host
...
3. **[1]** criar um recurso de IP virtual e uma investigação de integridade para a instância de ers
