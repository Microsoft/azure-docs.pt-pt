...
|             | 7-RAW    | RAW    | Agente Linux | Família de imagens RHEL 7.x. <br> Anexado a repositórios regulares por defeito (não EUS).
...
|             | 7.4      | RAW    | Agente Linux | Anexados aos repositórios da UES por defeito a partir de abril de 2019.
|             | 74-gen2  | RAW    | Agente Linux | Anexado aos repositórios da EUS por defeito.
|             | 7.5      | RAW    | Agente Linux | Anexados aos repositórios da UES por incumprimento a partir de junho de 2019.
|             | 75-gen2  | RAW    | Agente Linux | Anexado aos repositórios da EUS por defeito.
|             | 7.6      | RAW    | Agente Linux | Anexados aos repositórios da UES por defeito a partir de maio de 2019.
|             | 76-gen2  | RAW    | Agente Linux | Anexado aos repositórios da EUS por defeito.
...
RHEL-SAP-HANA | 6.7       | RAW    | Agente Linux | RHEL 6.7 para SAP HANA. Ultrapassado a favor das imagens RHEL-SAP.
...
RHEL-SAP-APPS | 6.8       | RAW    | Agente Linux | RHEL 6.8 para Aplicações Empresariais SAP. Ultrapassado a favor das imagens RHEL-SAP.
