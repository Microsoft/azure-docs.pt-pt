...
|Tamanho da VM|Prazo adicional de carga|Valor adicional em dólares (USD)| Notas|
|---|---|---|---|
| Pequeno hóspede virtual (<=4 núcleos) | Taxa adicional horária | TBC | |
|  | Custo adicional mensal | TBC | Para instâncias reservadas |
|  | Custo adicional anual | TBC | Para instâncias reservadas |
| Grande hóspede virtual (>4 núcleos) | Taxa adicional horária | TBC | |
|  | Custo adicional mensal | TBC | Para instâncias reservadas |
|  | Custo adicional anual | TBC | Para instâncias reservadas |
