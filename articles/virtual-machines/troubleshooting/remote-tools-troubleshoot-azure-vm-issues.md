---
title: Use ferramentas remotas para resolver problemas com o Azure VM Microsoft Docs
...
- Para obter mais informações sobre o Enter-PSSession cmdlet, consulte [Enter-PSSession](/powershell/module/microsoft.powershell.core/enter-pssession?view=powershell-5.1&preserve-view=true).
