...
Para parar: Clique em grupos de recursos > [o seu grupo de recursos] > Recursos > [o seu conjunto de disponibilidade] > Máquinas Virtuais > [a sua máquina virtual] > Stop.
...
Se não tiver a opção de utilizar um tamanho VM diferente, tente implantar-se numa região diferente dentro do mesmo geo. Para mais informações sobre os tamanhos vm disponíveis em cada região emhttps://aka.ms/azure-regions
