...
## <a name="manage-windows-services"></a>Gerir serviços windows
...
> [!NOTE]
> O cmdlet Write-Progress pode não funcionar com este comando. Como mitigação, pode correr `$ProgressPreference = "SilentlyContinue"` no PowerShell para desativar a barra de progresso.
