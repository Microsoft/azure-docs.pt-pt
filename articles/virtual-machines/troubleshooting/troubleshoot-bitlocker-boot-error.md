...
6.  Descarregue o ficheiro BEK para o disco de recuperação. A amostra que se segue guarda o ficheiro BEK na pasta C:\BEK. Certifique-se de que o caminho existe antes de `C:\BEK\` executar os scripts.
