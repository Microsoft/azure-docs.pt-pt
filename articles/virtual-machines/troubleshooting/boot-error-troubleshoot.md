---
title: Erros de arranque em Máquinas Virtuais Azure Microsoft Docs
...
Este artigo lista os erros comuns de arranque que poderá receber quando iniciar uma máquina virtual do Windows (VM) no Microsoft Azure. Para obter mais informações sobre os erros, consulte os artigos na secção **de erros e soluções boot.**
