...
Pode utilizar o CLI Azure para ativar os diagnósticos de arranque numa máquina virtual Azure existente. Para obter mais informações, consulte [os diagnósticos de arranque az vm](/cli/azure/vm/boot-diagnostics).
