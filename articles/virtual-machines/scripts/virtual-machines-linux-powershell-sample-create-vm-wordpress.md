---
title: Exemplo de Script do Azure PowerShell – WordPress
...
| [Extensão set-AzVM](https://docs.microsoft.com/powershell/module/az.compute/set-azvmextension) | Adicione a Extensão do Script Personalizado à máquina virtual que invoca um script para instalar o WordPress. |
