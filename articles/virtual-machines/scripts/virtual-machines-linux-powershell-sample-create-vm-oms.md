---
title: Amostra de script Azure PowerShell Linux - registos do Monitor Azure
description: Amostra de script Azure PowerShell Linux - registos do Monitor Azure.
...
ms.locfileid: "91336076"
---
# <a name="create-an-azure-monitor-vm-with-powershell"></a>Criar um VM monitor Azure com PowerShell
...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Adicione uma extensão de VM à máquina virtual. Neste caso, é utilizada a extensão de agente do Log Analytics para instalar o agente do Log Analytics e inscrever a VM numa área de trabalho do Log Analytics. |
