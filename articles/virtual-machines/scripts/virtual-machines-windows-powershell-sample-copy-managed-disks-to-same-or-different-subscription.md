---
title: Copiar discos geridos para subscrição (Windows) - Amostra PowerShell
...
ms.locfileid: "87069190"
---
# <a name="copy-managed-disks-in-the-same-subscription-or-different-subscription-with-powershell-windows"></a>Copiar discos geridos na mesma subscrição ou subscrição diferente com PowerShell (Windows)
