---
title: Exemplo de Script do Azure PowerShell – NGINX
...
| [Extensão set-AzVM](https://docs.microsoft.com/powershell/module/az.compute/set-azvmextension) | Adicione uma extensão de VM à máquina virtual. Neste exemplo, é utilizada a extensão de script personalizado para instalar o NGINX. |
