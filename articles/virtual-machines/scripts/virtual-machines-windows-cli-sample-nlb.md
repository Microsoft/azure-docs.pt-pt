---
title: Exemplo do Script da CLI do Azure – Criar uma VM do Windows Server 2016 com o NLB
...
| [az network lb rule create](/cli/azure/network/lb/rule) | Cria uma regra do NLB. Neste exemplo, é criada uma regra para a porta 80. À medida que o tráfego HTTP chega ao NLB, é encaminhado para a porta 80 de uma das VMs no conjunto do NLB. |
