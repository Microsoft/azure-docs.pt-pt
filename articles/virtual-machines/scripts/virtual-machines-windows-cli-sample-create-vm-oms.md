---
title: Amostra Azure CLI - Criar um Azure VM executando monitor Azure
description: Amostra Azure CLI - Criar um VM Azure executando o Windows Server 2016 VM e Azure Monitor.
