---
title: Foto de VHD para fazer muitos discos geridos idênticos (Linux) - PowerShell
...
ms.locfileid: "87079932"
---
# <a name="create-a-snapshot-from-a-vhd-to-create-multiple-identical-managed-disks-in-small-amount-of-time-with-powershell-linux"></a>Crie um instantâneo a partir de um VHD para criar vários discos geridos idênticos em pouco tempo com PowerShell (Linux)
