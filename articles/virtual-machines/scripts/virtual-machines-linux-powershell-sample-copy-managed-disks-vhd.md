---
title: Exemplo de script Azure PowerShell – exportar/copiar o VHD de um disco gerenciado para uma conta de armazenamento em uma região diferente
