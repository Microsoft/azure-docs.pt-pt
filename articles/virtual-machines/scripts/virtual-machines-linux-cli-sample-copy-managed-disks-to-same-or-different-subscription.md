---
title: Copiar discos gerenciados para a assinatura-exemplo da CLI
description: Exemplo de script CLI do Azure – copiar (ou mover) discos gerenciados para o mesmo ou para uma assinatura diferente
