...
Saiba mais sobre:
- Arquitetura subjacente [e topologia VM](./workloads/hpc/hbv3-series-overview.md)
- [Pilha de software suportado,](./workloads/hpc/hbv3-series-overview.md#software-specifications) incluindo SISTEMA suportado
- Desempenho [](./workloads/hpc/hbv3-performance.md) esperado da série HBv3 VM.
