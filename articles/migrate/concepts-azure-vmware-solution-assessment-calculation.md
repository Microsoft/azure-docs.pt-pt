...
As avaliações avs avaliam cada VMs no local pela sua adequação para AVS, revendo as propriedades da máquina. Atribui igualmente cada máquina avaliada a uma das seguintes categorias de adequação:
