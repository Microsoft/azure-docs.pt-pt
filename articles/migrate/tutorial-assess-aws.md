---
title: Avaliar os casos da AWS para a migração para Azure com a Azure Migrate
description: Aprenda a aceder a casos AWS para migração para Azure com Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Este artigo mostra-lhe como avaliar os casos da Amazon Web Services (AWS) para migração para Azure, utilizando a ferramenta Azure Migrate: Discovery and assessment.
...
- Certifique-se de que as instâncias AWS não estão a executar o Windows Server 2003 ou o SUSE Linux. A avaliação não é suportada por estes servidores.
