---
title: Contentorizar aplicações de ASP.NET e migrar para o Serviço Azure Kubernetes
description: Saiba como contentorizar aplicações ASP.NET e migrar para o Serviço Azure Kubernetes.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
