---
title: Containerize aplicações de aplicações web java e migra para o Serviço Azure Kubernetes
description: Saiba como contentorizar aplicações web java e migrar para o Serviço Azure Kubernetes.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
