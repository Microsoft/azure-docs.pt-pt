---
title: Descubra servidores físicos com avaliação do servidor Azure Migrate
description: Saiba como descobrir servidores físicos no local com a Avaliação do Servidor Azure Migrate.
ms.topic: tutorial
ms.date: 09/14/2020
ms.custom: mvc
...
Para configurar o aparelho numa máquina física, descarregue e coloque um script instalador numa [máquina adequada](#prerequisites). Depois de criar o aparelho, instale-o pela primeira vez e registe-o com o projeto Azure Migrate.
...
1. In **Register with Azure Migrate**, selecione **Login**. Se não aparecer, certifique-se de ter desativado o bloqueador pop-up no navegador.
    ...
    ![Clique em Iniciar sessão para começar a registar o aparelho](./media/tutorial-discover-physical/register.png)

2. Na página **Iniciar súmis,** inscreva-se com o seu nome de utilizador E password Azure. O s-in com um PIN não é suportado.
3. Depois de iniciar sins com sucesso, volte para a aplicação.
4. No **Registo com Azure Migrate,** selecione a subscrição em que o projeto Azure Migrate foi criado e, em seguida, selecione o projeto.
5. Especifique um nome para o aparelho. O nome deve ser alfanumérico com 14 caracteres ou menos.
6. Selecione **Registar**. Em seguida, clique **em Continuar**. Uma mensagem mostra o registo como um sucesso.

    ![Preencha o nome de subscrição, projeto e aparelho e registe o aparelho](./media/tutorial-discover-physical/success-register.png)

## <a name="start-continuous-discovery"></a>Iniciar a descoberta contínua

O aparelho liga-se ao servidor físico para ser descoberto.
