...
Decida se pretende executar uma avaliação utilizando critérios de dimensionamento com base em dados de configuração de máquinas/metadados recolhidos como no local, ou com base em dados de desempenho.
