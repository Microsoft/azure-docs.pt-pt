...
| **Suporte**                | **Detalhes**               
| :-------------------       | :------------------- |
| **Anfitrião Hyper-V**       | O hospedeiro Hyper-V pode ser autónomo ou implantado num cluster.<br/><br/> O anfitrião Hyper-V pode executar o Windows Server 2019, o Windows Server 2016 ou o Windows Server 2012 R2.<br/> Não pode avaliar as VMs localizadas em sistemas anfitriões Hyper-V com o Windows Server 2012.
...
| **Comunicação remota do PowerShell**   | [A remoing PowerShell](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/enable-psremoting?view=powershell-7) deve ser ativada em cada hospedeiro Hiper-V. |
...
| **Serviços de Integração**       | [Os Serviços de Integração Hiper-V](https://docs.microsoft.com/virtualization/hyper-v-on-windows/reference/integration-services) devem estar a funcionar em VMs que você avaliar, a fim de capturar informações do sistema operativo. |
