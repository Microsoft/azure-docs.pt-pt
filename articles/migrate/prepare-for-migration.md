...
- Verifique [os requisitos de migração e o suporte](migrate-support-matrix-physical.md) para computadores físicos locais ou outros servidores virtualizados. 
