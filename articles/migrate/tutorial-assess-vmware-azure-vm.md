---
title: Avaliar servidores VMware para migração para VMs Azure em Azure Migrate
description: Saiba como avaliar os servidores VMware para migração para Azure VMs com Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Este artigo mostra-lhe como avaliar servidores descobertos do seu ambiente VMware em preparação para a migração para Azure VMs, utilizando a ferramenta Azure Migrate: Discovery and assessment.
