...
[5 do artigo: Realojar uma aplicação em VMs do Azure](contoso-migration-rehost-vm.md) | Contoso migra a sua aplicação da SmartHotel360 VMs para VMs do Azure com o serviço Site Recovery. | Disponível
...
2. Especifica que suas máquinas estão localizados no local, que são VMs do VMware, e que pretende replicar para o Azure.
    ![Objetivo da replicação](./media/contoso-migration-rehost-linux-vm/replication-goal.png)
