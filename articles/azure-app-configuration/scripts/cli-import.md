...
| Comando | Notas |
|---|---|
| [az appconfig import](/cli/azure/ext/appconfig/appconfig#ext-appconfig-az-appconfig-import) | Importa a uma configuração de aplicação armazena recursos. |
