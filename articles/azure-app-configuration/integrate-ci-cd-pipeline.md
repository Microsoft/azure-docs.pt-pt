...
1. Abra o seu ficheiro *.csproj* e adicione o seguinte script:
    ...
    ```
1. *Programa Aberto.cs*, e atualize o `CreateWebHostBuilder` método para utilizar o ficheiro JSON exportado, chamando o `config.AddJsonFile()` método.  Adicione o `System.Reflection` espaço de nome também.
