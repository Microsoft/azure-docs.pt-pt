...
Para ativar a implementação local do Git para a sua aplicação com o servidor de construção Kudu, corra [`az webapp deployment source config-local-git`](/cli/azure/webapp/deployment/#az_webapp_deployment_source_config_local_git) na Cloud Shell.
