...
1. Na secção de **repositório Predefinido,** coloque **o URI** em "https\://github.com/Azure-Samples/piggymetrics".

1. Desloque **o RÓTULO** para "config".
