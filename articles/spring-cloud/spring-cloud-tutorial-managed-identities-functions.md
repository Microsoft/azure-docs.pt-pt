...
* [Configure um pedido de cliente daemon para chamadas de serviço-a-serviço](../app-service/configure-authentication-provider-aad.md#configure-a-daemon-client-application-for-service-to-service-calls)