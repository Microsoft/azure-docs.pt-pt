...
1. Agora pode ver o estado das chamadas entre aplicações Piggymetrics. 
    ...
    [![Visão geral ](media/spring-cloud-quickstart-logs-metrics-tracing/tracing-overview.png) de rastreio distribuído](media/spring-cloud-quickstart-logs-metrics-tracing/tracing-overview.png#lightbox)
...
1. Por fim, clique em **Investigar o Desempenho** para explorar uma análise de desempenho mais poderosa.
    ...
    [![Desempenho de rastreio ](media/spring-cloud-quickstart-logs-metrics-tracing/tracing-performance.png) distribuído](media/spring-cloud-quickstart-logs-metrics-tracing/tracing-performance.png#lightbox)
