...
ms.locfileid: "104878304"
---
# <a name="tutorial-bind-an-azure-cosmos-db-database-to-your-azure-spring-cloud-application"></a>Tutorial: Ligue uma base de dados DB do Azure Cosmos à sua aplicação Azure Spring Cloud
...
Neste artigo, aprendeu a ligar a sua aplicação Azure Spring Cloud a uma base de dados DB do Azure Cosmos. Para saber mais sobre serviços de encadernação à sua aplicação, consulte [Bind to a Azure Cache for Redis cache](spring-cloud-howto-bind-redis.md).