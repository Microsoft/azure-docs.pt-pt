...
---|---|---
2.0. x | Finchley. RELEASE | 2.0.0-INSTANTÂNEO
2.1. x | Greenwich. RELEASE | 2.1.0-INSTANTÂNEO

Inclua este trecho de código em seu `pom.xml` com a versão correta da nuvem Spring do Azure na ' dependência ':
