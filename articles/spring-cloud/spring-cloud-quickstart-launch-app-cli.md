...
Precisamos de uma forma de aceder à aplicação através de um navegador web. A nossa aplicação gateway precisa de um ponto final virado para o público, que pode ser atribuído usando o seguinte comando:
