...
> [!TIP]
> Se estiver a utilizar um repositório privado para o servidor config, consulte o nosso tutorial sobre a [configuração da autenticação](./spring-cloud-howto-config-server.md).
