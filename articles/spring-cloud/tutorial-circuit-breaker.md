---
title: Tutorial - Use painel de disjuntores com nuvem de mola Azure
...
Siga o procedimento, [Provisão uma instância de serviço no Azure CLI](./spring-cloud-quickstart.md#provision-an-instance-of-azure-spring-cloud).
...
* [Prepare uma aplicação java spring para implantação em Azure Spring Cloud](how-to-prepare-app-deployment.md)
