...
* Um exemplo de Azure Spring Cloud. Siga o nosso [quickstart na implantação através do CLI Azure](spring-cloud-quickstart-launch-app-cli.md) para começar.
...
1. Crie uma base de dados do Azure Cosmos DB. Consulte o quickstart sobre a [criação de uma base de dados](https://docs.microsoft.com/azure/cosmos-db/create-cosmosdb-resources-portal) para obter ajuda. 
