...
description: Este artigo mostrará como associar uma instância do banco de dados do Azure para MySQL ao seu aplicativo do Azure Spring Cloud
author: jpconnock
