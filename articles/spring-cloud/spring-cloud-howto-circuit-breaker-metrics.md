...
* Ativar o agente java In-Process do [guia Java In-Process Agent for Application Insights](https://docs.microsoft.com/azure/spring-cloud/spring-cloud-howto-application-insights#enable-java-in-process-agent-for-application-insights). 

* Permitir a recolha de dimensões para métricas de resiliência4j do [guia Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/pre-aggregated-metrics-log-metrics#custom-metrics-dimensions-and-pre-aggregation).
...
* [Insights de aplicação](https://docs.microsoft.com/azure/spring-cloud/spring-cloud-howto-application-insights)
