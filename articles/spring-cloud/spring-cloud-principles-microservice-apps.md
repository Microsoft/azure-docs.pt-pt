...
ms.locfileid: "86172698"
---
# <a name="java-and-base-os-for-spring-microservice-apps"></a>Java e Base OS para aplicações de microserviços de primavera
...
* [Quickstart: Lançar uma aplicação Azure Spring Cloud existente utilizando o portal Azure](spring-cloud-quickstart-launch-app-portal.md)
