...
description: Usar o portal do Azure para criar uma instância do serviço de migração de banco de dados do Azure
...
3. No ecrã **Criar Serviço de Migração**:
    ...
    - Selecione uma VNet ( **rede virtual** ) existente ou crie uma.
        ...
        Para obter mais informações sobre como criar uma VNet no portal do Azure, consulte o artigo [criar uma rede virtual usando o portal do Azure](https://aka.ms/vnet).
