...
* Para configurar o seu [Windows Firewall para acesso ao motor de base de dados de origem](/sql/database-engine/configure-windows/configure-a-windows-firewall-for-database-engine-access).
