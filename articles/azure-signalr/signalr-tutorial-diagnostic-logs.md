---
title: Registos de recursos para o serviço de sinalização Azure
description: Aprenda a configurar registos de recursos para o Serviço De Sinalização Azure e como utilizá-lo para auto-resolução de problemas.
author: wanlwanl
ms.service: signalr
ms.topic: conceptual
ms.date: 12/17/2019
...
ms.locfileid: "82131001"
---
# <a name="resource-logs-for-azure-signalr-service"></a>Registos de recursos para o Serviço De Sinalização Azure

Este tutorial discute quais são os registos de recursos do Serviço De Sinalização Azure, como os configurar e como resolver problemas com eles. 

## <a name="prerequisites"></a>Pré-requisitos
Para ativar registos de recursos, você precisará de algum lugar para armazenar os seus dados de registo. Este tutorial utiliza o Azure Storage e o Log Analytics.

* [Armazenamento azure](../azure-monitor/platform/resource-logs-collect-storage.md) - Retém registos de recursos para auditoria de políticas, análise estática ou backup.
...
## <a name="set-up-resource-logs-for-an-azure-signalr-service"></a>Configurar registos de recursos para um serviço de sinalização Azure

Pode ver registos de recursos para o Serviço De Sinalização Azure. Estes registos proporcionam uma visão mais rica da conectividade com a sua instância de Serviço De Sinalização Azure. Os registos de recursos fornecem informações detalhadas de todas as ligações. Por exemplo, informações básicas (ID do utilizador, id de ligação e tipo de transporte e assim por diante) e informações do evento (conectar, desligar e abortar evento e assim por diante) da ligação. os registos de recursos podem ser utilizados para identificação de problemas, rastreio e análise de ligação.

### <a name="enable-resource-logs"></a>Ativar registos de recursos

Os registos de recursos são desativados por defeito. Para ativar os registos de recursos, siga estes passos:
...
O Serviço De Sinalização Azure captura registos de recursos numa categoria:
...
Para ver os registos de recursos, siga estes passos:
...
2. Introduza e selecione `SignalRServiceDiagnosticLogs` intervalo de tempo para consultar registos de recursos. Para consultas avançadas, consulte [Iniciar com Log Analytics no Monitor Azure](../azure-monitor/log-query/get-started-portal.md)
...
Para resolver problemas para o Serviço De Sinalização Azure, pode ativar registos laterais do servidor/cliente para capturar falhas. Atualmente, o Serviço De Sinalização Azure expõe registos de recursos, podendo também ativar registos para o lado do serviço.

Ao encontrar uma ligação inesperada de crescimento ou queda de situação, pode aproveitar os registos de recursos para resolver problemas.
...
Se uma ligação se desligar, os registos de recursos `ConnectionAborted` `ConnectionEnded` registarão este evento de desconexão, verá ou entrará `operationName`.
