...
description: Neste Quickstart, aprenda a criar um serviço Azure SignalR utilizando um modelo de Gestor de Recursos Azure.
author: mgblythe
ms.service: signalr
ms.topic: quickstart
...
2. Na lista SignalR, selecione o seu novo serviço. Aparece **a página 'Visão Geral'** do novo serviço Azure SignalR.
