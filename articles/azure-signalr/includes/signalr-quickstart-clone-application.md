...
ms.locfileid: "67184628"
---
## <a name="clone-the-sample-application"></a>Clonar a aplicação de exemplo

Enquanto o serviço está a ser implementado, vamos passar para trabalhar com código. Clone a [aplicação de exemplo do GitHub](https://github.com/Azure-Samples/signalr-service-quickstart-serverless-chat), defina a cadeia de ligação do Serviço SignalR e execute a aplicação localmente.
