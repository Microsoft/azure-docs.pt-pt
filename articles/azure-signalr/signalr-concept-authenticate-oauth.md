---
title: Guia para a autenticação de clientes do serviço Azure SignalR
description: Neste guia, irá aprender a autenticar os clientes do serviço Azure SignalR
author: sffamily
ms.service: signalr
ms.topic: conceptual
ms.date: 03/01/2019
