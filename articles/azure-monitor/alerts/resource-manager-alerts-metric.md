...
Este artigo fornece amostras de utilização de [modelos do Gestor de Recursos Azure](../../azure-resource-manager/templates/template-syntax.md) para configurar regras de [alerta métrica no](../alerts/alerts-metric-near-real-time.md) Azure Monitor. Cada amostra inclui um ficheiro de modelo e um ficheiro de parâmetros com valores de amostra para fornecer ao modelo.

[!INCLUDE [azure-monitor-samples](../../../includes/azure-monitor-resource-manager-samples.md)]

Consulte [recursos suportados para alertas métricos no Azure Monitor](../alerts/alerts-metric-near-real-time.md) para obter uma lista de recursos que podem ser usados com regras de alerta métrico. Uma explicação do esquema e propriedades para uma regra de alerta está disponível em [Alertas Métricos - Criar ou Atualizar](/rest/api/monitor/metricalerts/createorupdate).

> [!NOTE]
> O modelo de recursos para a criação de alertas métricos para o tipo de recurso: Azure Log Analytics Workspace (i.e.) `Microsoft.OperationalInsights/workspaces` , requer passos adicionais. Para mais detalhes, consulte [o Alerta métrico para Registos - Modelo de Recursos](../alerts/alerts-metric-logs.md#resource-template-for-metric-alerts-for-logs).
