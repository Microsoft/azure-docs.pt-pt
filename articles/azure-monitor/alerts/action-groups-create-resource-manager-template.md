...
* Saiba mais sobre [alertas.](../platform/alerts-overview.md)
* Aprenda a adicionar [alertas utilizando um modelo de Gestor de Recursos.](../platform/alerts-activity-log.md)
