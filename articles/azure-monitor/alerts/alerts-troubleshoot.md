...
1. **Verificou os parâmetros da regra de ação?**  
    ...
    Verifique a documentação da [regra de ação,](../alerts/alerts-action-rules.md)ou a regra de [ação PowerShell Set-AzActionRule](/powershell/module/az.alertsmanagement/set-azactionrule?view=azps-3.5.0) command. 
