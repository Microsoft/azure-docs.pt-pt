...
A amostra que se segue cria uma [série de regras de alerta de resultados](../alerts/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Notas

- Esta amostra inclui uma [carga útil webhook](../alerts/alerts-log-webhook.md). Se a regra de alerta não desencadear um webhook, então remova o elemento **personalizadoWebhookPayload.**
...
A amostra a seguir cria uma [regra de alerta de medição métrica](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
