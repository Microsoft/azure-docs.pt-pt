---
title: Preços FAQ para Azure Network Performance Monitor / Microsoft Docs
...
* [Monitor de ponto de terminação de serviço](https://docs.microsoft.com/azure/networking/network-monitoring-overview)
