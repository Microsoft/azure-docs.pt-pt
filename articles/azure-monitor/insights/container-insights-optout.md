...
Para voltar a Ativar monitorização do seu cluster, veja [ativar a monitorização com a CLI do Azure](container-insights-onboard.md#enable-using-azure-cli).
