...
- Com o Azure Red Hat OpenShift, verifique os registos omsagent, procurando na tabela **ContainerLog** para verificar se está ativada a recolha de registos de registos de azure-azure-azure..
