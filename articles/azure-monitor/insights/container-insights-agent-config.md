...
|Scope | Chave | Tipo de dados | Valor | Descrição |
|------|-----|-----------|-------|-------------|
...
| | `prometheus.io/scrape` | Booleano | verdadeiro ou falso | Habilita a recorte do pod. |
