...
- For um membro do **[proprietário](https://docs.microsoft.com/en-us/azure/role-based-access-control/built-in-role.md#owner)** função no recurso de cluster do AKS. 
