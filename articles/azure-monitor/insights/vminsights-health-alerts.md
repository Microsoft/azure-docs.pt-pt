...
| Monitorizar estado | Gravidade do alerta |
|:---|:---|
| Crítico | Sev1 |
| Aviso  | Sev2 |
...
Para ser notificado proativamente de um alerta desencadeado pela saúde dos hóspedes, crie um grupo de [ação](../platform/action-groups.md) para definir as diferentes ações a executar, tais como o envio de uma mensagem SMS ou o início de uma App Lógica. Em seguida, crie uma [regra de ação](../platform/alerts-action-rules.md) que especifique o âmbito dos monitores e das máquinas virtuais e utilize esse grupo de ação.
