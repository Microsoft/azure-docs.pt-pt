---
title: Insights da rede Azure Monitor
description: Uma visão geral do Azure Monitor Network Insights, que fornece uma visão abrangente da saúde e métricas para todos os recursos de rede implantados sem qualquer configuração.
ms.topic: conceptual
author: KumudD
ms.author: kumud
ms.date: 11/25/2020
...
A página Azure Monitor Network Insights **Overview** fornece uma forma fácil de visualizar o inventário dos seus recursos de rede, juntamente com a saúde dos recursos e alertas. Está dividido em quatro áreas funcionais fundamentais: pesquisa e filtragem, saúde de recursos e métricas, alertas e vista de dependência.
...
[![Screenshot que mostra resultados de pesquisa da Rede Azure Monitor Insights.](media/network-insights-overview/search.png)](media/network-insights-overview/search.png#lightbox)
...
![Screenshot que mostra saúde de recursos e métricas em Azure Monitor Network Insights.](media/network-insights-overview/resource-health.png)

Se selecionar as ligações ER e VPN indisponíveis, verá uma vista métrica: 

![Screenshot que mostra a vista métrica em Azure Monitor Network Insights.](media/network-insights-overview/metric-view.png)
...
![Sreenshot que mostra a vista do Gateway de Aplicação em Azure Monitor Network Insights.](media/network-insights-overview/application-gateway.png)
...
[![Screenshot que mostra vista de dependência em Azure Monitor Network Insights.](media/network-insights-overview/dependency-view.png)](media/network-insights-overview/dependency-view.png#lightbox)
...
![Screenshot que mostra o menu de visualização de dependência em Azure Monitor Network Insights.](media/network-insights-overview/dependency-view-menu.png)
...
![Screenshot que mostra um exemplo de uma pesquisa em Azure Monitor Network Insights.](media/network-insights-overview/search-example.png)
...
![Screenshot que mostra o separador conectividade em Azure Monitor Network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-tab.png)
...
[![Screenshot que mostra testes de conectividade em Azure Monitor Network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-tests.png)](media/network-insights-overview/azure-monitor-for-networks-connectivity-tests.png#lightbox)

Pode selecionar qualquer fonte ou azulejo de destino para abrir uma vista métrica:

[![Screenshot que mostra métricas de conectividade em Azure Monitor Network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-metrics.png)](media/network-insights-overview/azure-monitor-for-networks-connectivity-metrics.png#lightbox)
...
[![Screenshot que mostra o separador traffic in Azure Monitor Network Insights.](media/network-insights-overview/azure-monitor-for-networks-traffic-view.png)](media/network-insights-overview/azure-monitor-for-networks-traffic-view.png#lightbox)
...
[![Screenshot que mostra a vista da região de tráfego em Azure Monitor Network Insights.](media/network-insights-overview/azure-monitor-for-networks-traffic-region-view.png)](media/network-insights-overview/azure-monitor-for-networks-traffic-region-view.png#lightbox)
...
## <a name="onboarded-resources"></a>Recursos a bordo 

Os recursos a bordo têm livros embutidos e vistas de dependência. Os recursos atualmente a bordo são Virtual WAN, Application Gateway, Load Balancer e ExpressRoute.
...
Esta secção irá ajudá-lo a diagnosticar e resolver problemas comuns que poderá encontrar quando utilizar o Azure Monitor Network Insights. 

### <a name="how-do-i-resolve-performance-problems-or-failures"></a>Como resolvo problemas de desempenho ou falhas?

Para saber sobre a resolução de problemas relacionados com a rede que identificar com a Azure Monitor Network Insights, consulte a documentação de resolução de problemas para o recurso avariado. 
...
O Azure Monitor Network Insights pode mostrar recursos para apenas cinco subscrições de cada vez. 

### <a name="how-do-i-make-changes-or-add-visualizations-to-azure-monitor-network-insights"></a>Como faço alterações ou adiciono visualizações a Azure Monitor Network Insights?
...
O Azure Monitor Network Insights utiliza o grão de tempo **automático,** pelo que o grão de tempo baseia-se na gama de tempo selecionada.
...
### <a name="what-if-i-want-to-see-other-data-or-make-my-own-visualizations-how-can-i-make-changes-to-azure-monitor-network-insights"></a>E se eu quiser ver outros dados ou fazer as minhas próprias visualizações? Como posso fazer alterações ao Azure Monitor Network Insights?
