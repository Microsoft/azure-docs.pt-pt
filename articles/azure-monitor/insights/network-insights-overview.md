...
O Azure Monitor for Networks pode mostrar recursos para apenas cinco subscrições de cada vez. 

### <a name="how-do-i-make-changes-or-add-visualizations-to-azure-monitor-for-networks"></a>Como faço alterações ou adiciono visualizações ao Azure Monitor para redes?
...
O Azure Monitor for Networks utiliza o grão de tempo **automático,** pelo que o grão de tempo baseia-se na gama de tempo selecionada.
...
### <a name="what-if-i-want-to-see-other-data-or-make-my-own-visualizations-how-can-i-make-changes-to-azure-monitor-for-networks"></a>E se eu quiser ver outros dados ou fazer as minhas próprias visualizações? Como posso fazer alterações ao Azure Monitor for Networks?
