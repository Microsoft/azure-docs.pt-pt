...
description: Este artigo descreve como pode parar de monitorizar o seu conjunto de versão 4 do Seu Chapéu Vermelho Azure e do Red Hat OpenShift com o Monitor Azure para contentores.
ms.topic: conceptual
ms.date: 04/24/2020
...
Depois de ativar a monitorização do seu conjunto OpenShift e Red Hat OpenShift 4.x, pode parar de monitorizar o cluster com o Monitor Azure para obter contentores se decidir que já não o quer monitorizar. Este artigo mostra como fazer isto.  
