...
| Plataforma | Agente direto | Agente do SCOM | Armazenamento do Azure | SCOM necessário? | Dados de agente do SCOM enviados através do grupo de gestão | Frequência de recolha |
| --- | --- | --- | --- | --- | --- | --- |
