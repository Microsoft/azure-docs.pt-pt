...
A tabela a seguir compara conceitos e estruturas de dados entre os registos splunk e Azure Monitor.
 ...
 | Metadados de eventos estruturados | N/D | mesa |  Splunk não tem o conceito exposto à linguagem de pesquisa de metadados de eventos. Os registos do Monitor Azure têm o conceito de tabela, que tem colunas. Cada instância do evento é mapeada para uma linha. |
...
Consulte as [agregações em consultas de registo do Monitor Azure](/azure/data-explorer/kusto/query/samples?&pivots=azuremonitor#aggregations) para as diferentes funções de agregação.
