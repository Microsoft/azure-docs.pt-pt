...
:::image type="content" source="media/log-powerbi-excel/export-query2.png" alt-text="Consulta log Analytics mostrando a retirada do menu de opções de exportação" border="true":::
