...
|:---|:---|:---|
| Nome do Recurso | Nome legível por humanos do espaço de trabalho (também conhecido como "nome do componente") | workspace("contosoretail") |
...
| ID | GUID do espaço de trabalho | workspace("b438b3f6-912a-46d5-9db1-b42069242ab4") |
