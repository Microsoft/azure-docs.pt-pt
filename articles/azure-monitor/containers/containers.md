---
title: Solução de monitorização de contentores em | monitor Azure Microsoft Docs
...
2. Instale e utilize o Docker com um agente Log Analytics. Com base no seu sistema operativo e no orquestrador Docker, pode utilizar os seguintes métodos para configurar o seu agente.
   - Para anfitriões autónomos:
     - Nos sistemas operativos Linux suportados, instale e execute o Docker e, em seguida, instale e configuure o [agente Log Analytics para o Linux](../vm/quick-collect-linux-computer.md).  
...
- Para obter mais informações e etapas sobre como instalar o agente Log Analytics para linux, consulte a [visão geral do agente Log Analytics](../agents/log-analytics-agent.md).
...
Se usou previamente o agente instalado diretamente e pretender utilizar um agente que esteja a funcionar num contentor, deve primeiro remover o agente Log Analytics para o Linux. Consulte [desinstalar o agente Log Analytics para](../vm/quick-collect-linux-computer.md) que o Linux compreenda como desinstalar o agente com sucesso.  
...
* [Instale o agente Log Analytics para o Linux](../vm/quick-collect-linux-computer.md) diretamente em cada nó OpenShift  
* [Ativar a extensão VM do Log Analytics](../vm/quick-collect-azurevm.md) em cada nó OpenShift que reside no Azure  
...
Para ativar a monitorização do computador Windows e Hiper-V, instale o Microsoft Monitoring Agent (MMA) em computadores Windows que são anfitriões de contentores. Para computadores que executam o Windows no ambiente no local, consulte [os computadores Connect Windows ao Azure Monitor](../agents/agent-windows.md). Para máquinas virtuais em funcionamento em Azure, conecte-as ao Azure Monitor utilizando a [extensão da máquina virtual](../vm/quick-collect-azurevm.md).

Pode monitorizar os recipientes do Windows em funcionamento no Service Fabric. No entanto, [apenas máquinas virtuais que executam em Azure](../vm/quick-collect-azurevm.md) e [computadores que executam o Windows no seu ambiente no local](../agents/agent-windows.md) são atualmente suportados para o Service Fabric.
...
- [Agente windows](../agents/agent-windows.md)
- [Extensão VM do Log Analytics](../vm/quick-collect-azurevm.md)
...
A partir daqui, pode editar a consulta de pesquisa para modificá-la para encontrar a informação específica que lhe interessa. Para obter mais informações sobre consultas de registo, consulte [as consultas de registo no Azure Monitor](../logs/log-query-overview.md).
...
[Registos de consulta](../logs/log-query-overview.md) para visualizar registos de dados detalhados do contentor.
