...
> - [Gerir o uso e os custos para a Application Insights](../../azure-monitor/app/pricing.md) descreve como analisar o uso de dados em Insights de Aplicação.
...
Alguns clientes terão acesso aos [níveis de preços do Log Analytics](https://docs.microsoft.com/azure/azure-monitor/platform/manage-cost-storage#legacy-pricing-tiers) e ao antigo nível de preços da Enterprise Application [Insights.](https://docs.microsoft.com/azure/azure-monitor/app/pricing#legacy-enterprise-per-node-pricing-tier) 
