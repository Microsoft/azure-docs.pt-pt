...
O Azure Monitor suporta consultas de serviços cruzados entre O Explorador de Dados Azure, [Insights de Aplicação](../app/app-insights-overview.md)e [Log Analytics](./data-platform-logs.md). Em seguida, pode consultar o seu cluster Azure Data Explorer utilizando ferramentas De Registo Analytics/Application Insights e consultar-se numa consulta de serviço transversal. O artigo mostra como fazer uma consulta de cross-service.
...
* [Realize consultas de registo de recursos cruzados no Azure Monitor](../log-query/cross-workspace-query.md)