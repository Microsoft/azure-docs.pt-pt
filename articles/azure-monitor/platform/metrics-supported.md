...
|IncomingRequests|Pedidos Recebidos|Contagem|Total|Pedidos de entrada para Microsoft.EventHub.|Nenhum|
|Entradas|Mensagens Recebidas|Contagem|Total|Mensagens de entrada para Microsoft.EventHub.|Nenhum|
|Despesas de Saída|Mensagens Enviadas|Contagem|Total|Mensagens de saída para o Microsoft.EventHub.|Nenhum|
...
|vestígios/contagem|Rastreios|Contagem|Contagem|Contagem de documentos de rastreio|traço/severidadeLevel,operação/sintético,nuvem/funName,nuvem/roleInstance|
...
|StreamingIngestResults|Resultado do streaming inger|Contagem|Média|Resultado do streaming de ingerir|Result|
...
|tempdb_data_size<sup>1</sup> |Kilobytes do tamanho do ficheiro de dados temporários|Contagem|Máximo|Kilobytes tamanho de ficheiro de dados temporários.|Nenhum|
|tempdb_log_size<sup>1</sup> |Kilobytes do tamanho do ficheiro de registo temporário|Contagem|Máximo|Kilobytes tamanho do ficheiro de registo temporário.|Nenhum|
...
|SQLOnDemandLoginAttempts|Tentativas de login|Contagem|Total|Contagem de tentativas de login que succedou ou falhou|Result|
|SQLOnDemandQueriesEnded|Consultas terminadas|Contagem|Total|Contagem de consultas que sucederam, falharam, ou foram cancelados|Result|
...
|Ligações|Ligações|Contagem|Total|Contagem de entradas totais para a piscina SQL|Result|
