...
|TotalLowPriorityNodeCount|No|Contagem de nó de baixa prioridade|de palavras|Total|Número total de nós de baixa prioridade na conta do lote|Sem Dimensões|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|AddRegion|Yes|Região Adicionada|de palavras|de palavras|Região Adicionada|Região|
...
|Remover a Região|Yes|Região removida|de palavras|de palavras|Região removida|Região|
...
|SteamingIngestRequestRate|Yes|Taxa de pedido de ingestão de streaming|de palavras|RateRequestsPerSecond|Taxa de pedido de ingestão de streaming (pedidos por segundo)|Sem Dimensões|
|StreamingIngestDataRate|Yes|Taxa de dados de ingestão de streaming|de palavras|Média|Taxa de dados de ingestão de streaming (MB por segundo)|Sem Dimensões|
|StreamingIngestDuration|Yes|Duração do Streaming Ingest|Milissegundos|Média|Duração da ingestão de streaming em milissegundos|Sem Dimensões|
|StreamingIngestResults|Yes|Resultado do streaming inger|de palavras|Média|Resultado do streaming de ingerir|Resultado|
...
|CbsVolumeLogicalBackupBytes|Yes|Bytes lógicos apoiados|Bytes|Média|Toatl bytes não comprimidos/não encriptados apoiados para este Volume.|Sem Dimensões|
...
|Average_Uptime|Yes|Uptime|de palavras|Média|Average_Uptime|Computador, Nome de Objeto, Nome de Instância, CounterPath, SourceSystem|
...
|OuvinteConnections-ClientError|No|OuvinteConnections-ClientError|de palavras|Total|ClientError em ListenerConnections para Microsoft.Relay.|Nome da Entidade, |
|OuvinteConnections-ServerError|No|OuvinteConnections-ServerError|de palavras|Total|ServerError em ListenerConnections para Microsoft.Relay.|Nome da Entidade, |
|OuvinteConnections-Sucesso|No|OuvinteConnections-Sucesso|de palavras|Total|Falhas de escuta bem sucedidas para Microsoft.Relay.|Nome da Entidade, |
|OuvinteConnections-TotalRequests|No|OuvinteConnections-TotalRequests|de palavras|Total|Total de EscutasConnections para Microsoft.Relay.|Nome de Entidade|
...
|SenderConnections-Sucesso|No|SenderConnections-Sucesso|de palavras|Total|SenderConnections de sucesso para Microsoft.Relay.|Nome da Entidade, |
...
|CPUXNS|No|CPU (precedido)|Percentagem|Máximo|Métrica de utilização do espaço de identificação do espaço de serviço do serviço de serviço. Esta métrica está despricada. Utilize a métrica cpu (NamespaceCpuUsage) em vez disso.|Sem Dimensões|
...
|xtp_storage_percent|Yes|Por cento de armazenamento em memória OLTP|Percentagem|Média|Por cento de armazenamento em memória OLTP. Não aplicável aos armazéns de dados.|Sem Dimensões|
...
|storage_limit|Yes|Tamanho máximo de dados|Bytes|Média|Tamanho máximo de dados|Sem Dimensões|
...
|xtp_storage_percent|Yes|Por cento de armazenamento em memória OLTP|Percentagem|Média|Por cento de armazenamento em memória OLTP|Sem Dimensões|
...
|SQLOnDemandLoginAttempts|No|Tentativas de login|de palavras|Total|Contagem de tentativas de login que succedou ou falhou|Resultado|
...
|Média De Respostas|Yes|Tempo médio de resposta|Segundos|Média|Tempo médio de resposta|Instância|
...
|Média De Respostas|Yes|Tempo médio de resposta **(precotado)**|Segundos|Média|Tempo médio de resposta|Instância|
|BytesReceived|Yes|Dados em|Bytes|Total|Dados em|Instância|
|BytesSent|Yes|Data out|Bytes|Total|Data out|Instância|
