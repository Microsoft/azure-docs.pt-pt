...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|Bytes de leitura de disco|Sim|Bytes de leitura de disco|Bytes|Total|Bytes lidos a partir de disco durante o período de monitorização|RoleInstanceId|
|Operações de leitura de disco/sec|Sim|Operações de leitura de disco/sec|CondePerSecond|Média|IOPS de leitura de disco|RoleInstanceId|
|Bytes de escrita de disco|Sim|Bytes de escrita de disco|Bytes|Total|Bytes escritos para o disco durante o período de monitorização|RoleInstanceId|
|Operações de escrita de discos/seg|Sim|Operações de escrita de discos/seg|CondePerSecond|Média|IOPS de escrita de disco|RoleInstanceId|
|Percentagem da CPU|Sim|Percentagem da CPU|Percentagem|Média|A percentagem de unidades de computação atribuídas que estão atualmente a ser utilizadas pela Máquina Virtual(s)|RoleInstanceId|
...
|Lotes Processados|Sim|Lotes processados|de palavras|Média|Número de lotes agregados para ingestão. Tipo de lote: se o lote atingiu o tempo de loteamento, o tamanho dos dados ou o número de ficheiros limite definido pela política de loteamento|Base de dados, SealReason|
...
|Blobs Processado|Sim|Blobs Processados|de palavras|Média|Número de bolhas processadas por um componente.|Base de dados, ComponentType, Nome de Componentes|
|BlobsReceived|Sim|Blobs recebidos|de palavras|Média|Número de bolhas recebidas do fluxo de entrada por um componente.|Base de dados, ComponentType, Nome de Componentes|
|BlobsRejected|Sim|Blobs rejeitados|de palavras|Média|Número de bolhas permanentemente rejeitadas por um componente.|Base de dados, ComponentType, Nome de Componentes|
...
|IngestionLatencyInSeconds|Sim|Latência da ingestão|Segundos|Média|Tempo de ingestão da fonte (por exemplo, a mensagem está no EventHub) para o cluster em segundos|Sem Dimensões|
...
|IngestionVolumeInMB|Sim|Volume de ingestão (em MB)|Bytes|Total|Volume global de dados ingeridos para o cluster (em MB)|Sem Dimensões|
...
|ConsultaResult|Não|Resultado da Consulta|de palavras|de palavras|Número total de consultas.|Estado|
...
|CbsVolumeLogicalBackupBytes|Sim|Bytes lógicos apoiados|Bytes|Média|Bytes totais não comprimidos/não encriptados apoiados para este Volume.|Sem Dimensões|
...
|ListenerConnections-ClientError|Não|ListenerConnections-ClientError|de palavras|Total|ClientError em ListenerConnections para Microsoft.Relay.|Nome da Entidade, |
|ListenerConnections-ServerError|Não|ListenerConnections-ServerError|de palavras|Total|ServerError em ListenerConnections para Microsoft.Relay.|Nome da Entidade, |
|ListenerConnections-Success|Não|ListenerConnections-Success|de palavras|Total|Falhas de escuta bem sucedidas para Microsoft.Relay.|Nome da Entidade, |
...
|SenderConnections-Success|Não|SenderConnections-Success|de palavras|Total|SenderConnections de sucesso para Microsoft.Relay.|Nome da Entidade, |
...
|BigDataPoolApplicaçõesAtivas|Não|Aplicações Apache Spark ativas|de palavras|de palavras|Total ativa apache spark pool applications|Estado do Trabalho|
|BigDataPoolApplicaçõesEndidas|Não|Candidaturas de Apache Spark terminadas|de palavras|de palavras|As candidaturas à piscina de Apache Spark terminaram|JobType, JobResult|
...
|Horário do Cpu|Sim|Hora do CPU|Segundos|Total|A quantidade de CPU consumida pela app, em segundos. Para mais informações sobre esta métrica. Consulte https://docs.microsoft.com/azure/app-service/web-sites-monitor#cpu-time-vs-cpu-percentage (tempo cpu vs percentagem de CPU).|Instância|
