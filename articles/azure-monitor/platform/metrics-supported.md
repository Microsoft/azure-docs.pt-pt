...
|QueryPoolJobQueueLength|Sim|Threads: Comprimento da fila do trabalho da piscina de consulta|de palavras|Média|Número de empregos na fila da piscina de fios de consulta.|ServerResourceType|
...
|TotalLowPriorityNodeCount|Não|Contagem de nó de baixa prioridade|de palavras|Total|Número total de nós de baixa prioridade na conta do lote|Sem Dimensões|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|BroadcastProcessedCount|Sim|Contagem processada de transmissão|de palavras|Média|O número de transações processadas|Nó, canal, tipo, estado|
...
|ConsensoEtcdraftCommittedBlockNumber|Sim|Número de bloco comprometido de Etcdraft de consenso|de palavras|Média|O número do bloco do último bloco comprometido|Nó, canal|
|CpuUsagePercentageInDouble|Sim|Percentagem de Utilização cpu|Percentagem|Máximo|Percentagem de Utilização cpu|Nó|
|EndorserEndorsementFailures|Sim|Falhas de endosso do apoio do apoiante|de palavras|Média|O número de apoios falhados.|Nó, canal, código de corrente, codificador de correntes|
|Líder eleitoral da GossipLeader|Sim|Líder eleitoral do Líder da Gossip|de palavras|Total|Peer é líder (1) ou seguidor (0)|Nó, canal|
|GossipMembershipTotalPeersKnown|Sim|Membro gossip Total Pares Conhecidos|de palavras|Média|Total de pares conhecidos|Nó, canal|
|GossipStateHeight|Sim|Altura do Estado dos Mexericos|de palavras|Média|Altura do livro atual|Nó, canal|
...
|Contagem de Transações de Livros|Sim|Contagem de transações de livros|de palavras|Média|Número de transações processadas|Nó, canal, transaction_type, código de corrente, validation_code|
...
|Imagens Processadas|Sim|Imagens processadas|de palavras|Total| Número de Transações para processamento de imagem.|ApiName, FeatureName, UsageChannel, Região|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|Créditos CPU Consumidos|Sim|Créditos CPU Consumidos|de palavras|Média|Número total de créditos consumidos pela Máquina Virtual|Sem Dimensões|
|Créditos CPU Remanescentes|Sim|Créditos CPU Remanescentes|de palavras|Média|Número total de créditos disponíveis para rebentar|Sem Dimensões|
|Profundidade da Fila do Disco de Dados|Sim|Profundidade da fila do disco de dados (pré-visualização)|de palavras|Média|Profundidade da fila do disco de dados (ou comprimento da fila)|RIO LUN|
...
|Créditos CPU Consumidos|Sim|Créditos CPU Consumidos|de palavras|Média|Número total de créditos consumidos pela Máquina Virtual|Sem Dimensões|
|Créditos CPU Remanescentes|Sim|Créditos CPU Remanescentes|de palavras|Média|Número total de créditos disponíveis para rebentar|Sem Dimensões|
|Profundidade da Fila do Disco de Dados|Sim|Profundidade da fila do disco de dados (pré-visualização)|de palavras|Média|Profundidade da fila do disco de dados (ou comprimento da fila)|LUN, VMName|
...
|Profundidade da Fila do Disco do SO|Sim|Profundidade da fila do disco os (pré-visualização)|de palavras|Média|Profundidade da fila do disco os(ou comprimento da fila)|VMName|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|kube_node_status_allocatable_cpu_cores|Não|Número total de núcleos cpu disponíveis num cluster gerido|de palavras|Média|Número total de núcleos cpu disponíveis num cluster gerido|Sem Dimensões|
...
|kube_pod_status_ready|Não|Número de cápsulas no estado de Ready|de palavras|Média|Número de cápsulas no estado de Ready|espaço de nome, pod|
...
|C2DMessagesExpired|Sim|Mensagens C2D Expiradas (pré-visualização)|de palavras|Total|Número de mensagens de nuvem-para-dispositivo expiradas|Sem Dimensões|
|configurações|Sim|Métricas de configuração|de palavras|Total|Métricas para Operações de Configuração|Sem Dimensões|
|connectedDeviceCount|Não|Dispositivos conectados (pré-visualização)|de palavras|Média|Número de dispositivos ligados ao seu hub IoT|Sem Dimensões|
...
|totalDeviceCount|Não|Total de dispositivos (pré-visualização)|de palavras|Média|Número de dispositivos registados no seu hub IoT|Sem Dimensões|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|AddRegion|Sim|Região Adicionada|de palavras|de palavras|Região Adicionada|Região|
...
|Remover a Região|Sim|Região removida|de palavras|de palavras|Região removida|Região|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|ActiveConnections|Não|ActiveConnections|de palavras|Média|Total de conexões ativas para Microsoft.EventHub.|Sem Dimensões|
...
|CaptureBacklog|Não|Capture Backlog.|de palavras|Total|Capture Backlog for Microsoft.EventHub.|Sem Dimensões|
|CapturouBytes|Não|Bytes capturados.|Bytes|Total|Bytes capturados para Microsoft.EventHub.|Sem Dimensões|
|Caixas de Captura|Não|Mensagens capturadas.|de palavras|Total|Mensagens capturadas para Microsoft.EventHub.|Sem Dimensões|
|LigaçõesClosed|Não|Ligações Fechadas.|de palavras|Média|Ligações fechadas para Microsoft.EventHub.|Sem Dimensões|
|LigaçõesAsa|Não|Ligações Abertas.|de palavras|Média|Ligações abertas para Microsoft.EventHub.|Sem Dimensões|
...
|Entradas|Sim|Mensagens Recebidas|de palavras|Total|Mensagens de entrada para Microsoft.EventHub.|Sem Dimensões|
|IncomingRequests|Sim|Pedidos Recebidos|de palavras|Total|Pedidos de entrada para Microsoft.EventHub.|Sem Dimensões|
|OutgoingBytes|Sim|Bytes de saída.|Bytes|Total|Bytes de saída para Microsoft.EventHub.|Sem Dimensões|
|Despesas de Saída|Sim|Mensagens Enviadas|de palavras|Total|Mensagens de saída para o Microsoft.EventHub.|Sem Dimensões|
|QuotaExceededErrors|Não|Erros de Quota Excedida.|de palavras|Total|Quota Excedeu erros para Microsoft.EventHub.|Sem Dimensões|
|ServerErrors|Não|Erros do Servidor.|de palavras|Total|Erros de servidor para Microsoft.EventHub.|Sem Dimensões|
|Tamanho|Não|Tamanho|Bytes|Média|Tamanho de um EventHub em Bytes.|Função|
|Requess de sucesso|Não|Pedidos Com Êxito|de palavras|Total|Pedidos de sucesso para Microsoft.EventHub.|Sem Dimensões|
|ThrottledRequests|Não|Pedidos Limitados.|de palavras|Total|Pedidos de aceleração para o Microsoft.EventHub.|Sem Dimensões|
|UserErrors|Não|Erros do Utilizador.|de palavras|Total|Erros do utilizador para o Microsoft.EventHub.|Sem Dimensões|
...
|EHABL|Sim|Mensagens de atraso de arquivo (Deprecadas)|de palavras|Total|Mensagens de arquivo do Event Hub em atraso para um espaço de nome (Depreciado)|Sem Dimensões|
...
|EHAMSGS|Sim|Mensagens de arquivo (Depreciadas)|de palavras|Total|Event Hub arquivou mensagens num espaço de nome (Depreciado)|Sem Dimensões|
...
|EFINMSGS|Sim|Mensagens recebidas (depreciadas)|de palavras|Total|Total de mensagens recebidas para um espaço de nome (Deprecado)|Sem Dimensões|
...
|EHOUTMSGS|Sim|Mensagens de saída (depreciadas)|de palavras|Total|Total de mensagens de saída para um espaço de nome (Deprecado)|Sem Dimensões|
|FAILREQ|Sim|Pedidos Falhados (Deprecados)|de palavras|Total|Total de pedidos falhados para um espaço de nome (Deprecado)|Sem Dimensões|
...
|INMSGS|Sim|Mensagens recebidas (obsoletas) (Depreciadas)|de palavras|Total|Total de mensagens recebidas para um espaço de nome. Esta métrica está prevadida. Utilize a métrica de Mensagens recebidas (Deprecadas)|Sem Dimensões|
|INREQS|Sim|Pedidos de Entrada (Deprecados)|de palavras|Total|Total de pedidos de envio para um espaço de nome (Deprecado)|Sem Dimensões|
|INTERR|Sim|Erros internos do servidor (preprecados)|de palavras|Total|Erros internos totais do servidor para um espaço de nome (Deprecado)|Sem Dimensões|
|MISCERR|Sim|Outros Erros (Precotados)|de palavras|Total|Total de pedidos falhados para um espaço de nome (Deprecado)|Sem Dimensões|
...
|OUTMSGS|Sim|Mensagens de saída (obsoletas) (Depreciadas)|de palavras|Total|Mensagens de saída total para um espaço de nome. Esta métrica está prevadida. Utilize em vez disso a métrica mensagens de saída (deprecadas)|Sem Dimensões|
|QuotaExceededErrors|Não|Erros de Quota Excedida.|de palavras|Total|Quota Excedeu erros para Microsoft.EventHub.|Nome da Entidade, |
|ServerErrors|Não|Erros do Servidor.|de palavras|Total|Erros de servidor para Microsoft.EventHub.|Nome da Entidade, |
|Tamanho|Não|Tamanho|Bytes|Média|Tamanho de um EventHub em Bytes.|Nome de Entidade|
|Requess de sucesso|Não|Pedidos Com Êxito|de palavras|Total|Pedidos de sucesso para Microsoft.EventHub.|Nome da Entidade, |
|SUCCREQ|Sim|Pedidos de sucesso (Deprecados)|de palavras|Total|Total de pedidos bem sucedidos para um espaço de nome (Deprecado)|Sem Dimensões|
|SVRBSY|Sim|Erros ocupados do servidor (preprecados)|de palavras|Total|Erros de ocupado total do servidor para um espaço de nome (Deprecado)|Sem Dimensões|
|ThrottledRequests|Não|Pedidos Limitados.|de palavras|Total|Pedidos de aceleração para o Microsoft.EventHub.|Nome da Entidade, |
|UserErrors|Não|Erros do Utilizador.|de palavras|Total|Erros do utilizador para o Microsoft.EventHub.|Nome da Entidade, |
...
|Capacidade Observada|Sim|Capacidade observada|de palavras|Média|A capacidade reportada para autoescalar quando executou.|Sem Dimensões|
...
|Lotes Processados|Sim|Lotes processados|de palavras|Média|Número de lotes agregados para ingestão. Razão de conclusão do lote: Se o lote atingiu o tempo de loteamento, o tamanho dos dados ou o número de ficheiros limite definidos pela política de loteamento|Base de dados, SealReason|
...
|IngestionResult|Sim|Resultado da ingestão|de palavras|de palavras|Número de operações de ingestão|IngestionResultDetails|
...
|IngestionVolumeInMB|Sim|Volume de ingestão (em MB)|de palavras|Total|Volume global de dados ingeridos para o cluster (em MB)|Sem Dimensões|
...
|TotalNumberOfThrottledQueries|Sim|Número total de consultas estranguladas|de palavras|Total|Número total de consultas estranguladas|Sem Dimensões|
...
|Corridas Canceladas|Sim|Corridas Canceladas|de palavras|Total|Número de corridas canceladas para este espaço de trabalho. O conde é atualizado quando uma execução é cancelada com sucesso.|Cenário, RunType, PublishedPipelineId, ComputeType, PipelineStepType|
|Execuções Concluídas|Sim|Execuções Concluídas|de palavras|Total|Número de runs concluídas com sucesso para este espaço de trabalho. A contagem é atualizada quando uma execução tiver sido concluída e a saída tiver sido recolhida.|Cenário, RunType, PublishedPipelineId, ComputeType, PipelineStepType|
|CpuUtilização|Sim|CpuUtilização|de palavras|Média|Percentagem de utilização da memória num nó CPU. A utilização é reportada em intervalos de um minuto.|Cenário, runId, NodeId, ClusterName|
|Erros|Sim|Erros|de palavras|Total|Número de erros de execução neste espaço de trabalho. A contagem é atualizada sempre que o run encontra um erro.|Cenário|
|Corridas falhadas|Sim|Corridas falhadas|de palavras|Total|Número de corridas falhou neste espaço de trabalho. O conde é atualizado quando uma corrida falha.|Cenário, RunType, PublishedPipelineId, ComputeType, PipelineStepType|
...
|GpuUtilização|Sim|GpuUtilização|de palavras|Média|Percentagem de utilização da memória num nó GPU. A utilização é reportada em intervalos de um minuto.|Cenário, runId, NodeId, DeviceId, ClusterName|
|Núcleos Ociosos|Sim|Núcleos Ociosos|de palavras|Média|Número de núcleos ociosos|Cenário, ClusterName|
...
|Implementação de modelos iniciado|Sim|Implementação de modelos iniciado|de palavras|Total|Número de implementações de modelos iniciadas neste espaço de trabalho|Cenário|
|Implementação de modelos conseguiu|Sim|Implementação de modelos conseguiu|de palavras|Total|Número de implementações de modelos que foram bem sucedidas neste espaço de trabalho|Cenário|
...
|Registo modelo Bem sucedido|Sim|Registo modelo Bem sucedido|de palavras|Total|Número de registos de modelos que sucederam neste espaço de trabalho|Cenário|
|Não respondendo corre|Sim|Não respondendo corre|de palavras|Total|Número de corridas que não respondem a este espaço de trabalho. A contagem é atualizada quando uma execução entra no estado de Não Responder.|Cenário, RunType, PublishedPipelineId, ComputeType, PipelineStepType|
...
|Percentagem de Utilização de Cots|Sim|Percentagem de Utilização de Cots|de palavras|Média|Por cento das quotas utilizadas|Cenário, ClusterName, VmFamilyName, VmPriority|
|Corridas iniciadas|Sim|Corridas iniciadas|de palavras|Total|Número de corridas a correr para este espaço de trabalho. A contagem é atualizada quando a execução começa a funcionar com os recursos necessários.|Cenário, RunType, PublishedPipelineId, ComputeType, PipelineStepType|
|Execuções ini 'Starting'|Sim|Execuções ini 'Starting'|de palavras|Total|Número de corridas iniciadas para este espaço de trabalho. O Conde é atualizado após pedido para criar informações de execução e execução, como o Run Id, foi povoado|Cenário, RunType, PublishedPipelineId, ComputeType, PipelineStepType|
|Núcleos Totais|Sim|Núcleos Totais|de palavras|Média|Número de núcleos totais|Cenário, ClusterName|
...
|Avisos|Sim|Avisos|de palavras|Total|Número de avisos de execução neste espaço de trabalho. A contagem é atualizada sempre que uma corrida encontra um aviso.|Cenário|
...
|CbsVolumeBackupActive|Sim|Estado ativo de backup de volume|de palavras|Média|Está atualmente suspenso pelo volume.|Sem Dimensões|
...
|CbsVolumeOperationComplete|Sim|Estado de operação|de palavras|Média|É a última operação de backup/restauro bem sucedida.|Sem Dimensões|
...
|CbsVolumeProtector|Sim|Estado protegido do volume|de palavras|Média|É o volume protegido pelo serviço de backup em nuvem.|Sem Dimensões|
...
|HealthyHostCount|Sim|Contagem saudável do anfitrião|de palavras|Média|Número de hospedeiros saudáveis|BackendSettingsPool|
...
|Não-saudávelHostCount|Sim|Contagem de anfitriões pouco saudável|de palavras|Média|Número de anfitriões insalubres|BackendSettingsPool|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|QueryVolume|Sim|Volume de consulta|de palavras|Total|Número de consultas servidas para uma zona de DNS|Sem Dimensões|
...
|RecordSetCount|Sim|Contagem de recordes|de palavras|Máximo|Número de conjuntos de recordes numa zona de DNS|Sem Dimensões|
...
|ByteCount|Sim|Byte Count|de palavras|Total|Número total de Bytes transmitidos dentro do período de tempo|FrontendIPAddress, FrontendPort, Direção|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|ByteCount|Sim|Byte Count|de palavras|Total|Número total de Bytes transmitidos dentro do período de tempo|Porto, Direção|
...
|Average_Uptime|Sim|Uptime|de palavras|Média|Average_Uptime|Computador, Nome de Objeto, Nome de Instância, CounterPath, SourceSystem|
...
|qpu_high_utilization_metric|Sim|Maior Utilização de QPU|de palavras|Total|QPU Alta Utilização em Último Minuto, 1 para alta utilização QPU, caso contrário 0|Sem Dimensões|
...
|QueryPoolJobQueueLength|Sim|Comprimento da fila de trabalho da piscina de consulta (conjuntos de dados)|de palavras|Média|Número de empregos na fila da piscina de fios de consulta.|Sem Dimensões|
...
|BytesTransferido|Sim|BytesTransferido|de palavras|Total|Total bytesTransferred para Microsoft.Relay.|Nome de Entidade|
|OuvinteConnections-ClientError|Não|OuvinteConnections-ClientError|de palavras|Total|ClientError em ListenerConnections para Microsoft.Relay.|Nome da Entidade, |
|OuvinteConnections-ServerError|Não|OuvinteConnections-ServerError|de palavras|Total|ServerError em ListenerConnections para Microsoft.Relay.|Nome da Entidade, |
|OuvinteConnections-Sucesso|Não|OuvinteConnections-Sucesso|de palavras|Total|Falhas de escuta bem sucedidas para Microsoft.Relay.|Nome da Entidade, |
|OuvinteConnections-TotalRequests|Não|OuvinteConnections-TotalRequests|de palavras|Total|Total de EscutasConnections para Microsoft.Relay.|Nome de Entidade|
...
|SenderConnections-ClientError|Não|SenderConnections-ClientError|de palavras|Total|ClientError em SenderConnections para Microsoft.Relay.|Nome da Entidade, |
|SenderConnections-ServerError|Não|SenderConnections-ServerError|de palavras|Total|ServerError em SenderConnections para Microsoft.Relay.|Nome da Entidade, |
|SenderConnections-Sucesso|Não|SenderConnections-Sucesso|de palavras|Total|SenderConnections de sucesso para Microsoft.Relay.|Nome da Entidade, |
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|ActiveConnections|Não|ActiveConnections|de palavras|Total|Total de conexões ativas para Microsoft.ServiceBus.|Sem Dimensões|
...
|blocked_by_firewall|Sim|Bloqueado por Firewall|de palavras|Total|Bloqueado por Firewall|Sem Dimensões|
...
|dw_backup_size_gb|Sim|Tamanho do armazenamento de dados (GB)|de palavras|Total|O tamanho do armazenamento de dados é composto pelo tamanho dos seus dados e pelo registo de transações. A métrica é contada para a parte 'Armazenamento' da sua conta. Aplica-se apenas a armazéns de dados.|Sem Dimensões|
|dw_geosnapshot_size_gb|Sim|Tamanho do armazenamento de recuperação de desastres (GB)|de palavras|Total|O tamanho do armazenamento de recuperação de desastres é refletido como "Armazenamento de Recuperação de Desastres" na sua conta. Aplica-se apenas a armazéns de dados.|Sem Dimensões|
|dw_snapshot_size_gb|Sim|Tamanho do armazenamento de instantâneo (GB)|de palavras|Total|O tamanho do armazenamento instantâneo é o tamanho das alterações incrementais capturadas por instantâneos para criar pontos de restauro definidos pelo utilizador e automáticos. A métrica é contada para a parte 'Armazenamento' da sua conta. Aplica-se apenas a armazéns de dados.|Sem Dimensões|
...
|tempdb_data_size|Sim|Kilobytes do tamanho do ficheiro de dados temporários|de palavras|Máximo|Kilobytes tamanho de ficheiro de dados temporários. Não aplicável aos armazéns de dados.|Sem Dimensões|
|tempdb_log_size|Sim|Kilobytes do tamanho do ficheiro de registo temporário|de palavras|Máximo|Kilobytes tamanho do ficheiro de registo temporário. Não aplicável aos armazéns de dados.|Sem Dimensões|
...
|xtp_storage_percent|Sim|Por cento de armazenamento em memória OLTP|Percentagem|Média|Por cento de armazenamento em memória OLTP. Não aplicável aos armazéns de dados.|Sem Dimensões|
...
|storage_limit|Sim|Tamanho máximo de dados|Bytes|Média|Tamanho máximo de dados|Sem Dimensões|
...
|tempdb_data_size|Sim|Kilobytes do tamanho do ficheiro de dados temporários|de palavras|Máximo|Kilobytes do tamanho do ficheiro de dados temporários|Sem Dimensões|
|tempdb_log_size|Sim|Kilobytes do tamanho do ficheiro de registo temporário|de palavras|Máximo|Kilobytes do tamanho do ficheiro de registo temporário|Sem Dimensões|
...
|xtp_storage_percent|Sim|Por cento de armazenamento em memória OLTP|Percentagem|Média|Por cento de armazenamento em memória OLTP|Sem Dimensões|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|OrquestraçãoActivityRunsEnded|Não|A atividade corre terminada|de palavras|Total|Contagem de atividades de orquestração que sucederam, falharam ou foram canceladas|Resultado, Falha DeType, Atividade, ActivityType, Pipeline|
|OrquestrationPipelineRunsEnded|Não|As corridas de gasodutos terminaram|de palavras|Total|Contagem de corridas de oleoduto de orquestração que conseguiu, falhou, ou foram cancelados|Resultado, FalhaType, Pipeline|
|OrquestraçãoStroggersDessemotado|Não|Os gatilhos terminaram|de palavras|Total|Contagem de gatilhos de orquestração que conseguiu, falhou, ou foram cancelados|Resultado, FalhaType, Gatilho|
|SQLOnDemandLoginAttempts|Não|Tentativas de login|de palavras|Total|Contagem de tentativas de login que succedou ou falhou|Resultado|
|SQLOnDemandQueriesEnded|Não|Consultas terminadas|de palavras|Total|Contagem de consultas que sucederam, falharam, ou foram cancelados|Resultado|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|Capacidade de Cores|Não|Capacidade de núcleos|de palavras|Máximo|Capacidade de núcleos|Sem Dimensões|
|Capacidade de MemóriaGB|Não|Capacidade de memória (GB)|de palavras|Máximo|Capacidade de memória (GB)|Sem Dimensões|
|SparkJobsEnded|Sim|Candidaturas terminadas|de palavras|Total|Contagem de candidaturas terminadas|JobType, JobResult|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|Ativarequests|Sim|Pedidos Ativos|de palavras|Total|Pedidos Ativos|Instância|
...
|DiskQueueLength|Sim|Comprimento da fila do disco|de palavras|Média|Comprimento da fila do disco|Instância|
|Http101|Sim|Http 101|de palavras|Total|Http 101|Instância|
|Http2xx|Sim|Http 2xx|de palavras|Total|Http 2xx|Instância|
|Http3xx|Sim|Http 3xx|de palavras|Total|Http 3xx|Instância|
|Http401|Sim|Http 401|de palavras|Total|Http 401|Instância|
|Http403|Sim|Http 403|de palavras|Total|Http 403|Instância|
|Http404|Sim|Http 404|de palavras|Total|Http 404|Instância|
|Http406|Sim|Http 406|de palavras|Total|Http 406|Instância|
|Http4xx|Sim|Http 4xx|de palavras|Total|Http 4xx|Instância|
|Http5xx|Sim|http Erros do servidor|de palavras|Total|http Erros do servidor|Instância|
|HttpQueueLength|Sim|Comprimento da fila http|de palavras|Média|Comprimento da fila http|Instância|
...
|Pedidos|Sim|Pedidos|de palavras|Total|Pedidos|Instância|
...
|Métrica|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Descrição|Dimensões|
|---|---|---|---|---|---|---|
|AppConnections|Sim|Ligações|de palavras|Média|Ligações|Instância|
...
|Antiguidades Atuais|Sim|Atuais Assembleias|de palavras|Média|Atuais Assembleias|Instância|
|FileSystemUsage|Sim|Utilização do sistema de ficheiros|Bytes|Média|Utilização do sistema de ficheiros|Sem Dimensões|
|Gen0Collections|Sim|Coleções de lixo gen 0|de palavras|Total|Coleções de lixo gen 0|Instância|
|Gen1Collections|Sim|Coleções de lixo da Gen 1|de palavras|Total|Coleções de lixo da Gen 1|Instância|
|Gen2Collections|Sim|Coleções de lixo gen 2|de palavras|Total|Coleções de lixo gen 2|Instância|
|Pegas|Sim|N.º de Identificadores|de palavras|Média|N.º de Identificadores|Instância|
...
|Pedidos|Sim|Pedidos|de palavras|Total|Pedidos|Instância|
|PedidosInApplicationQueue|Sim|Pedidos na fila de aplicações|de palavras|Média|Pedidos na fila de aplicações|Instância|
|Fios|Sim|Contagem de fios|de palavras|Média|Contagem de fios|Instância|
|Total DeDomínios|Sim|Domínios totais de aplicativos|de palavras|Média|Domínios totais de aplicativos|Instância|
|TotalAppDomainsUnloaded|Sim|Total de domínios de aplicações descarregados|de palavras|Média|Total de domínios de aplicações descarregados|Instância|
...
|FunExecutionUnnits|Sim|Unidades de execução de funções|de palavras|Total|[Unidades de execução de funções](https://github.com/Azure/Azure-Functions/wiki/Consumption-Plan-Cost-Billing-FAQ#how-can-i-view-graphs-of-execution-count-and-gb-seconds)|Instância|
|Gen0Collections|Sim|Coleções de lixo gen 0|de palavras|Total|Coleções de lixo gen 0|Instância|
|Gen1Collections|Sim|Coleções de lixo da Gen 1|de palavras|Total|Coleções de lixo da Gen 1|Instância|
|Gen2Collections|Sim|Coleções de lixo gen 2|de palavras|Total|Coleções de lixo gen 2|Instância|
|HealthCheckStatus|Sim|Estado do controlo de saúde|de palavras|Média|Estado do controlo de saúde|Instância|
