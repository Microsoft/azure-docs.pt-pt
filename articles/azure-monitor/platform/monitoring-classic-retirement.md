...
- Qualquer regra de alerta nova (não migrada) criada além das unidades livres, na nova plataforma de Azure Monitor
- Todos os dados são ingeridos e retidos além das unidades livres incluídas por Azure Monitor
- Quaisquer testes da Web de vários testes executados por Application Insights
- Qualquer métrica Personalizada armazenada além das unidades livres incluídas no Azure Monitor
...
* Saiba mais sobre o [novo Azure monitor](../../azure-monitor/overview.md)unificado.
