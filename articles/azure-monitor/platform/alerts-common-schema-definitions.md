...
| Gravidade | Gravidade do alerta. Valores possíveis: Sev0, Sev1, Sev2, Sev3, Sev4 |
...
> [!NOTE]
> Se utilizar a opção de JSON personalizada para os alertas de registo existente, a personalização não é mantida no esquema comum.
