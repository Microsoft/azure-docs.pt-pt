...
Além da divisão, pode utilizar a função de filtragem apenas para exibir os grupos de recursos que pretende ver.  Por exemplo, se pretender visualizar a percentagem de CPU para VMs para um determinado grupo de recursos, pode utilizar a ferramenta "Adicionar filtro" para filtrar por grupo de recursos. Neste exemplo filtramos por TailspinToysDemo, que remove métricas associadas a recursos em TailspinToys. 
...
Para fixar o seu gráfico multi-recursos, siga as instruções [aqui](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-charts#pin-charts-to-dashboards). 
