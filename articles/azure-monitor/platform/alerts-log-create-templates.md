...
Este JSON pode ser guardado e implantado utilizando [o Gestor de Recursos Azure no portal Azure](../../azure-resource-manager/templates/deploy-portal.md#deploy-resources-from-custom-template).
...
## <a name="template-for-all-resource-types-from-api-version-2020-05-01-preview"></a>Modelo para todos os tipos de recursos (da versão API 2020-05-01))

[Modelo de criação de regras de consulta agendadas](/rest/api/monitor/scheduledqueryrules/createorupdate) para todos os tipos de recursos (conjunto de dados de amostra como variáveis):
