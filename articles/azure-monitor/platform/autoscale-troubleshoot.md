...
A Autoscale fornece-lhe [quatro métricas](metrics-supported.md#microsoftinsightsautoscalesettings) para entender o seu funcionamento. 
...
Pode utilizar o [Metrics Explorer](metrics-getting-started.md) para traçar as métricas acima, tudo num só local. O gráfico deve mostrar:
...
Tal como qualquer outro recurso Azure, o serviço de autoescala fornece [registos de recursos](platform-logs-overview.md). Há duas categorias de registos.
...
Tal como acontece com qualquer serviço suportado pelo Azure Monitor, pode utilizar [Definições de Diagnóstico](diagnostic-settings.md) para encaminhar estes registos:
