...
* [POST purga](https://docs.microsoft.com/rest/api/loganalytics/workspacepurge/purge) - toma um objeto especificando parâmetros de dados para eliminar e devolve um GUID de referência 
