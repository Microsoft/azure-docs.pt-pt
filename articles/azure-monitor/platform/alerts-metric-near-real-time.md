...
|Microsoft.DataFactory/datafactories| Sim| Não | [Fábricas de Dados V1](../../azure-monitor/platform/metrics-supported.md#microsoftdatafactorydatafactories)|
...
|Microsoft.DBforMySQL/servers |N/D| Não |[DB para MySQL](../../azure-monitor/platform/metrics-supported.md#microsoftdbformysqlservers)|
|Microsoft.DBforPostgreSQL/servers |N/D | Não | [DB para PostgreSQL](../../azure-monitor/platform/metrics-supported.md#microsoftdbforpostgresqlservers)|
...
|Microsoft.EventGrid/topics |Sim | Não |[Tópicos da Grelha de Eventos](../../azure-monitor/platform/metrics-supported.md#microsofteventgridtopics)|
...
|Microsoft.Network/expressRouteCircuits | N/D | Não |[Circuitos de Rota Expresso](../../azure-monitor/platform/metrics-supported.md#microsoftnetworkexpressroutecircuits) |
...
|Microsoft.Network/trafficManagerProfiles | Sim | Não | [Perfis de Gestor de Tráfego](../../azure-monitor/platform/metrics-supported.md#microsoftnetworktrafficmanagerprofiles) |
|Microsoft.OperationalInsights/workspaces| Sim | Não | [Log Analytics espaços de trabalho](../../azure-monitor/platform/metrics-supported.md#microsoftoperationalinsightsworkspaces)|
|Microsoft.Relay/namespaces | Sim | Não | [Relés](../../azure-monitor/platform/metrics-supported.md#microsoftrelaynamespaces)|
...
|Microsoft.Storage/storageAccounts/services | Sim| Não | [Serviços Blob,](../../azure-monitor/platform/metrics-supported.md#microsoftstoragestorageaccountsblobservices) [Serviços de Arquivo,](../../azure-monitor/platform/metrics-supported.md#microsoftstoragestorageaccountsfileservices) [Serviços de Fila](../../azure-monitor/platform/metrics-supported.md#microsoftstoragestorageaccountsqueueservices) e [Serviços de Mesa](../../azure-monitor/platform/metrics-supported.md#microsoftstoragestorageaccountstableservices)|
...
|Microsoft.Microsoft.VMWareCloudSimple/virtualMachines |Sim|Não |[CloudSimple Virtual Machines](../../azure-monitor/platform/metrics-supported.md#microsoftvmwarecloudsimplevirtualmachines)|
