...
| Nível de Eventos |Gravidade do evento de forma numérica. |
| Nome de nível de evento |Gravidade do evento em forma de texto. |
...
| Descrição renderizada |Descrição do evento com valores de parâmetros |
...
| Evento &#124; resumir contagem() por Fonte |Contagem de eventos windows por fonte. |
| Evento &#124; onde EventLevelName == "error" &#124; resumir a contagem() por Fonte |Contagem de erros do Windows por fonte. |
