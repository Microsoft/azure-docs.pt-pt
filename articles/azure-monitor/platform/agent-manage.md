...
- Revisão [resolução de problemas do agente Linux](agent-linux-troubleshoot.md) se ocorrerem problemas ao instalar ou gerir o agente do Linux.

- Revisão [o agente do Windows de resolução de problemas](agent-windows-troubleshoot.md) se ocorrerem problemas ao instalar ou gerir o agente do Windows.
