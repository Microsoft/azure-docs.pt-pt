...
1. **Recebeu um erro de permissão?**  
    ...
    Deve ter o [papel de Monitoring Contributor incorporado,](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#monitoring-contributor)ou as permissões específicas relacionadas com regras de ação e alertas.
