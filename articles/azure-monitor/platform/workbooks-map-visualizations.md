---
title: Visualizações do mapa do mapa do mapa do Azure Monitor
...
| `Custom formatting` | Utilize este campo para definir unidades, estilo e opções de formatação para valores de números. Isto é o mesmo que [a formatação personalizada da grelha.](workbooks-grid-visualizations.md#custom-formatting)|

## <a name="next-steps"></a>Passos seguintes

- Saiba como criar [visualizações de pentes de mel em livros de trabalho.](workbooks-honey-comb.md)