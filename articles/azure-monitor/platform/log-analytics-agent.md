...
| Computador híbrido com Linux| [Instalação manual](agent-linux.md)|Instale o agente para Linux chamando um script wrapper hospedado no GitHub ou baixe e instale manualmente o agente. | 
