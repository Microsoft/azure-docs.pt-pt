...
Atualmente não existe um portal UI para criar recursos do Modelo de Livro, a única forma atual de criá-los é [através de implementações do Modelo de Gestor de Recursos Azure (modelo ARM).](./workbooks-automate.md) Como tal, a maneira mais fácil de mover um modelo é reutilizar o modelo ARM anterior e atualizá-lo para ser implantado na nova região.
