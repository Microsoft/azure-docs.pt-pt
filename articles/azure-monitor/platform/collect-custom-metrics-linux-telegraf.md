...
1. Na página **Definições** do Grupo de Segurança da Rede De **Rede**  >  **Network Security Group**  >  **Selecione as portas de entrada pública**, selecione **HTTP** e **SSH (22)**. Deixe o resto das predefinições e selecione **OK**. 
