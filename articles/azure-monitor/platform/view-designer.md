---
title: Criar pontos de vista para analisar dados de registo no Azure Monitor Microsoft Docs
...
![Página geral](media/view-designer/overview-page.png)
...
Necessita de pelo menos permissões de [nível de contribuinte](manage-access.md#manage-access-using-azure-permissions) no espaço de trabalho Log Analytics para criar ou modificar visualizações. Se não tiver esta permissão, a opção 'Ver Designer' não será apresentada no menu.
