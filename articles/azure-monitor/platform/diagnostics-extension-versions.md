...
* Recuperação de todos os contadores de desempenho enviados para o Azure Monitor através das [métricas Azure Monitor APIs.](https://docs.microsoft.com/rest/api/monitor/metrics/list)
