---
title: Enviar alertas da Azure Application Insights Microsoft Docs
...
Criar um [recurso Application Insights](./dotnetcore-quick-start.md#enable-application-insights).
