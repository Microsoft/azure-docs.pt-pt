...
|AppCpuUsage|Yes|Utilização da CPU da Aplicação |Percentagem|Média|O recente uso do CPU para a app|Implantação, AppName, Pod|
...
|Metric|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Description|Dimensões|
|---|---|---|---|---|---|---|
|BlockedCalls|Yes|Chamadas bloqueadas|de palavras|Total|Número de chamadas que excederam a taxa ou limite de quota|ApiName, Servindo a Região, StatusCode|
|ClientErrors|Yes|Erros do Cliente|de palavras|Total|Número de chamadas com qualquer erro do cliente (código de estado HTTP 4xx)|ApiName, Servindo a Região, StatusCode|
|DataIn|Yes|Dados em|Bytes|Total|Pedido de entrada Content-Length em bytes|ApiName, Servindo a Região, StatusCode|
|DataOut|Yes|Data out|Bytes|Total|Resposta de saída Content-Length in bytes|ApiName, Servindo a Região, StatusCode|
|Latência|Yes|Latência|Milissegundos|Média|Latência em milissegundos|ApiName, Servindo a Região, StatusCode|
|ServerErrors|Yes|Erros do servidor|de palavras|Total|Número de chamadas com qualquer erro do servidor (código de estado HTTP 5xx)|ApiName, Servindo a Região, StatusCode|
|Chamadas de sucesso|Yes|Chamadas bem sucedidas|de palavras|Total|Número de chamadas bem sucedidas (código de estado HTTP 2xx)|ApiName, Servindo a Região, StatusCode|
|Total de Chamadas|Yes|Total de chamadas|de palavras|Total|Número total de chamadas|ApiName, Servindo a Região, StatusCode|
|TotalErrors|Yes|Total de Erros|de palavras|Total|Número de chamadas com qualquer erro (código de estado HTTP 4xx ou 5xx)|ApiName, Servindo a Região, StatusCode|
...
|Metric|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Description|Dimensões|
|---|---|---|---|---|---|---|
|c2d.comandos.falha|Yes|Invocações de comando falhadas|de palavras|Total|A contagem de todos os pedidos de comando falhados iniciados da IoT Central|Sem Dimensões|
|c2d.comandos.requestSize|Yes|Tamanho do pedido de invocações de comando|Bytes|Total|Tamanho do pedido de todos os pedidos de comando iniciados a partir da IoT Central|Sem Dimensões|
|c2d.comandos.responseSize|Yes|Tamanho da resposta das invocações de comando|Bytes|Total|Tamanho de resposta de todas as respostas de comando iniciadas a partir da IoT Central|Sem Dimensões|
|c2d.comandos.sucesso|Yes|Invocações de comando bem sucedidas|de palavras|Total|A contagem de todos os pedidos de comando bem sucedidos iniciados a partir da IoT Central|Sem Dimensões|
...
|d2c.telemetria.ingress.allProtocol|Yes|Mensagem total de telemetria enviar tentativas|de palavras|Total|Número de mensagens de telemetria dispositivo-nuvem tentadas de ser enviadas para a aplicação IoT Central|Sem Dimensões|
|d2c.telemetria.ingress.success|Yes|Mensagens totais de telemetria enviadas|de palavras|Total|Número de mensagens de telemetria dispositivo-nuvem enviadas com sucesso para a aplicação IoT Central|Sem Dimensões|
...
|dataExport.statusChange|Yes|Alteração do estado da exportação de dados|de palavras|Total|Número de alterações de estado|exportId, exportDisplayName, destinationId, destinationDisplayName, status|
|dispositivoDataUsage|Yes|Utilização total de dados do dispositivo|Bytes|Total|Bytes transferidos de e para qualquer dispositivo ligado à aplicação IoT Central|Sem Dimensões|
|provisionadoDeviceCount|No|Total de dispositivos provisões|de palavras|Média|Número de dispositivos previstos na aplicação IoT Central|Sem Dimensões|
...
|Metric|Exportável através de Definições de Diagnóstico?|Nome de exibição métrica|Unidade|Tipo de Agregação|Description|Dimensões|
|---|---|---|---|---|---|---|
|QueryVolume|No|Volume de consulta|de palavras|Total|Número de consultas servidas para uma zona de DNS|Sem Dimensões|
...
|RecordSetCount|No|Contagem de recordes|de palavras|Máximo|Número de conjuntos de recordes numa zona de DNS|Sem Dimensões|
...
|DDoSTriggerSYNPackets|Yes|Pacotes SYN de entrada para acionar a mitigação de DDoS|CondePerSecond|Máximo|Pacotes SYN de entrada para acionar a mitigação de DDoS|Sem Dimensões|
|Pacotes DDoSTriggerTCP|Yes|Pacotes TCP de entrada para acionar a mitigação de DDoS|CondePerSecond|Máximo|Pacotes TCP de entrada para acionar a mitigação de DDoS|Sem Dimensões|
|DDoSTriggerUDPPackets|Yes|Pacotes UDP de entrada para acionar a mitigação de DDoS|CondePerSecond|Máximo|Pacotes UDP de entrada para acionar a mitigação de DDoS|Sem Dimensões|
...
|InboundTraffic|Yes|Tráfego de Entrada|Bytes|Total|O tráfego de entrada de serviço|Sem Dimensões|
|OutboundTraffic|Yes|Tráfego de Saída|Bytes|Total|O tráfego de serviço de saída|Sem Dimensões|
|TotalConnectionCount|Yes|Contagem de Ligação|de palavras|Máximo|A quantidade de ligação do utilizador.|Sem Dimensões|
...
|SQLStreamingBackloggedInputEventSources|No|Eventos de entrada recuados (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de fontes de eventos de entrada recuado.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingConversionErrors|No|Erros de conversão de dados (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de eventos de saída que não puderam ser convertidos para o esquema de saída esperado. A política de erros pode ser alterada para 'Drop' para deixar cair eventos que encontrem este cenário.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingDeserializaçãoError|No|Erros de deserialização de entrada (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de eventos de entrada que não podiam ser desseerializados.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingEarlyInputEvents|No|Eventos de entrada antecipada (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de eventos de entrada que a hora da aplicação é considerada precocemente comparada com a hora de chegada, de acordo com a política de chegada precoce.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingInputEventBytes|No|Bytes de evento de entrada (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Quantidade de dados recebidos pelo trabalho de streaming, em bytes. Isto pode ser usado para validar que os eventos estão a ser enviados para a fonte de entrada.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingInputEvents|No|Eventos de entrada (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de eventos de entrada.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingInputEventsSourcesPerSecond|No|Fontes de entrada recebidas (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de fontes de eventos de entrada por segundo.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingLateInputEvents|No|Eventos de entrada tardia (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de eventos de entrada que a hora da aplicação é considerada tardia em comparação com a hora de chegada, de acordo com a política de chegada tardia.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingOutOfOrderEvents|No|Eventos fora de ordem (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de Eventos Hub Events (mensagens serializadas) recebidas pelo Adaptador de Entrada de Centro de Eventos, recebidas fora de ordem que foram retiradas ou receberam um timetamp ajustado, com base na Política de Encomenda de Eventos.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingOutputEvents|No|Eventos de saída (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número de eventos de saída.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingOutputWatermarkDelaySeconds|No|Atraso da marca de água (pré-visualização)|de palavras|Máximo|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Atraso da marca de água em segundos.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingResourceutilization|No|Utilização de % de recursos (pré-visualização)|Percentagem|Máximo|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental.
 Utilização de recursos expressa em percentagem. A elevada utilização indica que o trabalho está a utilizar perto dos recursos máximos atribuídos.|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
|SQLStreamingRuntimeErrors|No|Erros de tempo de execução (pré-visualização)|de palavras|Total|Esta é uma métrica de pré-visualização disponível nos EUA do Leste, Europa Ocidental. Número total de erros relacionados com o processamento de consultas (excluindo os erros encontrados ao ingerir eventos ou resultados de saída).|Nome de recursos, SQLPoolName, SQLDatabaseName, JobName, LogicalName, PartitionId, ProcessorInstance|
...
|FunExecutionUnnits|Yes|Unidades de execução de funções|de palavras|Total|Unidades de execução de funções. Apenas presente para Funções Azure.|Instância|
