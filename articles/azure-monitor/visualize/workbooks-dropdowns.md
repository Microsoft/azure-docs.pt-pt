...
8. O parâmetro Ambiente será uma queda com os três valores.
    ...
    ![Imagem mostrando a criação de um afogamento estático](./media/workbooks-dropdowns/dropdown-create.png)
...
![Imagem mostrando um exemplo de um dropdown agrupado](./media/workbooks-dropdowns/grouped-dropDown.png)
...
3. O parâmetro RequestName será um drop-down os nomes de todos os pedidos na aplicação.
    ...
    ![Imagem mostrando a criação de uma queda dinâmica](./media/workbooks-dropdowns/dropdown-dynamic.png)
...
4. Consulte a consulta para ver os resultados. Opcionalmente, torná-lo como um gráfico.
    ...
    ![Imagem mostrando uma referência de queda no KQL](./media/workbooks-dropdowns/dropdown-reference.png)
...
![Imagem mostrando um parâmetro drop-down usando opções de valor, etiqueta, seleção e grupo](./media/workbooks-dropdowns/dropdown-more-options.png)
...
![Imagem mostrando um parâmetro de queda multi-selecionado](./media/workbooks-dropdowns/dropdown-multiselect.png)
