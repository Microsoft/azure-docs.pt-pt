---
title: Azure Monitor vê designer para exemplos de conversão de livros
description: Exemplos para a transição de pontos de vista para livros de trabalho no Azure Monitor.
author: austonli
ms.author: aul
ms.topic: conceptual
ms.date: 02/07/2020
