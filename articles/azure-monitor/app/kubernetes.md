...
- [Métricas de fluxo ao vivo](../../azure-monitor/app/live-stream.md)
...
- [Monitorização de transações de ponta a ponta](../../azure-monitor/learn/tutorial-performance.md#identify-slow-server-operations)
