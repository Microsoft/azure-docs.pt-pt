---
title: Configurar as configurações de regra de detecção inteligente do Aplicativo Azure insights com modelos de Azure Resource Manager | Microsoft Docs
