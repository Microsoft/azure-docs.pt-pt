...
ms.locfileid: "67478995"
---
# <a name="status-monitor-v2-api-start-applicationinsightsmonitoringtrace-v031-alpha"></a>API de v2 de Monitor de estado: Start-ApplicationInsightsMonitoringTrace (v0.3.1-alpha)
