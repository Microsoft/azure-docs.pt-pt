...
> [!NOTE]
> O Url para SharePoint utiliza um formato de módulo diferente "...\ai.2.gbl.min.js" (note o **.gbl** adicional) este formato de módulo alternativo é necessário para evitar um problema causado pela ordem de que os scripts são carregados, o que fará com que o SDK não se inicialize e resultará na perda de eventos de telemetria.
>
> A questão é causada pela obrigação de OJS ser carregada e inicializada antes do SDK.
