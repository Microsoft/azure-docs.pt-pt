...
* **[Analise a utilização da aplicação móvel](../learn/mobile-center-quickstart.md)** ao integrar com o Centro de Aplicações do Visual Studio.
