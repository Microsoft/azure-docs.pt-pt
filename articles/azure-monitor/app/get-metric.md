...
### <a name="how-to-use-metricidentifier-when-there-are-more-than-three-dimensions"></a>Como usar o identificador métrico quando existem mais de três dimensões

Atualmente, 10 dimensões são suportadas, no entanto, `metricIdentifier`mais de três dimensões requer ao utilizador:
