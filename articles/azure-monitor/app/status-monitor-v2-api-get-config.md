...
ms.locfileid: "67807093"
---
# <a name="status-monitor-v2-api-get-applicationinsightsmonitoringconfig-v040-alpha"></a>API de v2 de Monitor de estado: Get-ApplicationInsightsMonitoringConfig (v0.4.0-alpha)
