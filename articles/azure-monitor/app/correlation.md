...
- Saiba mais sobre [a definição cloud_RoleName](../../azure-monitor/app/app-map.md#set-cloud-role-name) para outros SDKs.
- A bordo de todos os componentes do seu microserviço no Application Insights. Confira as [plataformas suportadas.](../../azure-monitor/app/platforms.md)
- Consulte o [modelo de dados](../../azure-monitor/app/data-model.md) para os tipos de Insights de Aplicação.
