...
Se o projeto já estiver configurado para usar o gradle para compilação, adicione uma das linhas a seguir ao grupo `dependencies` em seu arquivo Build. gradle:
