...
ms.locfileid: "67807072"
---
# <a name="status-monitor-v2-api-set-applicationinsightsmonitoringconfig-v040-alpha"></a>API de v2 de Monitor de estado: Set-ApplicationInsightsMonitoringConfig (v0.4.0-alpha)
