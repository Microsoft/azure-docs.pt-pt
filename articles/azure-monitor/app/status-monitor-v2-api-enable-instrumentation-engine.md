...
ms.locfileid: "67807122"
---
# <a name="status-monitor-v2-api-enable-instrumentationengine-v040-alpha"></a>API de v2 de Monitor de estado: Enable-InstrumentationEngine (v0.4.0-alpha)
