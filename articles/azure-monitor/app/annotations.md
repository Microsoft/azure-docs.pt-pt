...
Pode utilizar o script CreateReleaseAnnotation PowerShell do GitHub para criar anotações a partir de qualquer processo que queira, sem utilizar Azure DevOps.
