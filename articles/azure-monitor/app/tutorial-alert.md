...
6. Desabar locais falhados para maiores ou iguais a 3. Crie um [grupo de ação](../alerts/action-groups.md) para configurar quem é notificado quando o seu limiar de alerta é violado.
