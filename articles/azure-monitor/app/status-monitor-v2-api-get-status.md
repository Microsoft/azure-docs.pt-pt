...
Pode inspecionar o processo na máquina instrumentado para ver se todas as DLLs são carregadas. Se a monitorização está a funcionar, DLLS, pelo menos, 12 devem ser carregados.
