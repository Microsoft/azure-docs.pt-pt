...
Para node. js, pode ativar o modo de programador ao ativar o registo interno via `setInternalLogging` e a definição `maxBatchSize` como 0, que faz com que a telemetria ser enviado assim que são recolhido.
