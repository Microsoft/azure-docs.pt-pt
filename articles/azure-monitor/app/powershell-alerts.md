...
Pode automatizar a configuração de [alertas](../../azure-monitor/platform/alerts-log.md) em Insights de [Aplicação](../../azure-monitor/app/app-insights-overview.md).
