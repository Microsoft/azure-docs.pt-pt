...
1. **Consulte a telemetria dos eventos personalizados.** Na página 'Vista **Geral'** dos Insights de Aplicação, escolha **Registos (Analytics)**.
   ...
   Saiba mais sobre o [Analytics do Application Insights](../logs/log-query-overview.md) e a [linguagem de consultas do Log Analytics](/azure/data-explorer/kusto/query/).
