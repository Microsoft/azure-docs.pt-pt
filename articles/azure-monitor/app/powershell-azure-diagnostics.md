...
* [Enviar o Diagnóstico do Azure ao Application Insights](../platform/diagnostics-extension-to-application-insights.md)
* [Automatizar alertas de configuração](powershell-alerts.md)
