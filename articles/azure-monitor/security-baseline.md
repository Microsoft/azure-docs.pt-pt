...
- [Começando com consultas log analytics](./log-query/log-analytics-tutorial.md)
...
- [Como alertar nos dados de registos de registos](learn/tutorial-response.md)
