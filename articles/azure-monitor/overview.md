...
- **Dados de monitoramento do SO convidado**: dados sobre o sistema operacional no qual seu aplicativo está sendo executado. Isto pode estar a decorrer em Azure, outra nuvem, ou no local. 
