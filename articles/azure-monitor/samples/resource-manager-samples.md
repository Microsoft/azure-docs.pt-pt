...
- [Livros de trabalho](resource-manager-workbooks.md) - Criar livros de trabalho.
- [Monitor azul para contentores](resource-manager-container-insights.md) - Aglomerados a bordo para Azure Monitor para contentores.
- [Monitor Azure para VMs](resource-manager-vminsights.md) - Máquinas virtuais a bordo para Azure Monitor para VMs.
