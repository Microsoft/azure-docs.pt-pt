...
>[!NOTE]
>[As consultas de recursos cruzados](../logs/cross-workspace-query.md) nos alertas de registo só são suportadas na atual [API agendada para a API](/rest/api/monitor/scheduledqueryrules). Se estiver a utilizar o legado Log Analytics Alerts API, terá de [mudar para a API atual.](../alerts/alerts-log-api-switch.md) [Ver modelos de exemplo.](../alerts/alerts-log-create-templates.md)
...
Utilize [a Pesquisa de Registo](../logs/log-query-overview.md) para ver informações detalhadas para as suas aplicações Application Insights.
