...
O formato de dados da conta de armazenamento são [linhas JSON.](../essentials/resource-logs-blob-format.md) Isto significa que cada registo é delimitado por uma nova linha, sem matriz de registos externos e sem vírgulas entre os registos da JSON. 
...
A regra de exportação deve incluir tabelas que você tem no seu espaço de trabalho. Faça esta consulta para obter uma lista de tabelas disponíveis no seu espaço de trabalho.
...
| Data de Configuração | Suporte parcial – alguns dos dados são ingeridos através de serviços internos que não são apoiados para exportação. Esta parte está em falta nas exportações atualmente. |
...
| Evento | Suporte parcial – alguns dos dados desta tabela são ingeridos através da conta de armazenamento. Esta parte está em falta nas exportações atualmente. |
| TrocaComendamentRecommendation |  |
| Ingestion Falhada |  |
| FunÇõesAppLogs |  |
| Heartbeat |  |
| Marca de Caça |  |
| InsightsMetrics | Suporte parcial – alguns dos dados são ingeridos através de serviços internos que não são apoiados para exportação. Esta parte está em falta nas exportações atualmente. |
| IntuneAuditLogs |  |
| IntuneDevices |  |
...
| OfficeActivity | Suporte parcial – alguns dos dados a ingeridos via webhooks de O365 para LA. Esta parte está em falta nas exportações atualmente. |
| Operação | Suporte parcial – alguns dos dados são ingeridos através de serviços internos que não são apoiados para exportação. Esta parte está em falta nas exportações atualmente. |
| Des | Suporte parcial – apenas os dados perf do Windows perf são suportados atualmente. Os dados do Perf Linux estão em falta nas exportações atualmente. |
| PowerBIDatasetsTenant |  |
| PowerBIDatasetsSSSEssopalho |  |
...
| SecurityEvent | Suporte parcial – alguns dos dados desta tabela são ingeridos através da conta de armazenamento. Esta parte está em falta nas exportações atualmente. |
| SegurançaIncident |  |
| SecurityIoTRawEvent |  |
...
| Ingestion sucedeu |  |
| SinapseBigDataPoolApplicações Acabou |  |
| SynapseBuiltinSqlPoolRequestsEnded |  |
| SynapseGatewayApiReques |  |
| SynapseIntegrationActivityRuns |  |
| SynapseIntegrationPipelineRuns |  |
| SynapseIntegrationTriggerRuns |  |
| Operações De SinapseRbac |  |
| SynapseSqlPoolDmsWorkers |  |
| SinapseSqlPoolExecRequests |  |
| SinapseSqlPoolRequestSteps |  |
| SinapseSqlPoolSqlRequests |  |
| SynapseSqlPoolWaits |  |
| Syslog | Suporte parcial – alguns dos dados desta tabela são ingeridos através da conta de armazenamento. Esta parte está em falta nas exportações atualmente. |
| ThreatIntelligenceIndicator |  |
| Atualizar | Suporte parcial – alguns dos dados são ingeridos através de serviços internos que não são apoiados para exportação. Esta parte está em falta nas exportações atualmente. |
| UpdateRunProgress |  |
| UpdateSummary |  |
| Utilização |  |
| Lista de observação |  |
...
| WireData | Suporte parcial – alguns dos dados são ingeridos através de serviços internos que não são apoiados para exportação. Esta parte está em falta nas exportações atualmente. |
| WVDCheckpoints |  |
| WVDConnections |  |
| WVDErrors |  |
| WVDFeeds |  |
...
- [Consultar os dados exportados do Azure Data Explorer](../logs/azure-data-explorer-query-storage.md).
