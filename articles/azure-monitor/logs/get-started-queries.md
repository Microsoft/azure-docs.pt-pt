...
Para obter mais detalhes sobre as consultas de registo no Azure Monitor, consulte [a visão geral das consultas de registo no Azure Monitor](../logs/log-query-overview.md).
