...
|:---|:---|:---|
| Record criado na fonte de dados | [TimeGenerated](../platform/log-standard-columns.md#timegenerated-and-timestamp) <br>Se a fonte de dados não definir este valor, então será definido ao mesmo tempo que _TimeReceived. |
| Record recebido pelo Azure Monitor no ponto final | [_TimeReceived](../platform/log-standard-columns.md#_timereceived) | |
