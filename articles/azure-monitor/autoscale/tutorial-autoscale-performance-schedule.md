...
Para saber mais sobre as definições de dimensionamento automático, avance para [Autoscale overview](../autoscale/autoscale-overview.md) (descrição geral de dimensionamento automático).

> [!div class="nextstepaction"]
> [Archive your monitoring data](../essentials/platform-logs-overview.md) (Arquivar os dados de monitorização)
