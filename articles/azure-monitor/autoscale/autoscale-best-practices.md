...
* Todas as falhas de autoescala estão registadas no Registo de Atividades. Em seguida, pode configurar um [alerta de registo de atividade](../alerts/activity-log-alerts.md) para que possa ser notificado por e-mail, SMS ou webhooks sempre que houver uma falha de autoescalação.
