...
Para compreender os requisitos e métodos que o ajudam a monitorizar as suas máquinas virtuais, [reveja o Monitor de Azure para VMs](../insights/vminsights-enable-overview.md).
