...
* Ver regras de alerta definidas em [Alertas Azure](alerts/alerts-overview.md)
* Consulta para métricas utilizando o [Azure Monitor REST API,](/rest/api/monitor/metrics) [powerShell cmdlets](powershell-samples.md), ou [cli cross-platform](cli-samples.md).
...
* Consulte as [definições de diagnóstico](essentials/diagnostic-settings.md) para obter um recurso.
* Ver o [perfil de registo](essentials/activity-log.md#legacy-collection-methods) de uma subscrição.
...
* Defina [as definições de diagnóstico](essentials/diagnostic-settings.md) para um recurso.\*
* Desa estação o [perfil de registo](essentials/activity-log.md#legacy-collection-methods) de uma subscrição.\*
* Defina a atividade e as definições de regras de alerta através [de Alertas Azure](alerts/alerts-overview.md).
