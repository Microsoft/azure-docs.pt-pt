...
Consulte [instalar e configurar a extensão de diagnóstico do Windows Azure (WAD)](../agents/diagnostics-extension-windows-install.md) ou [utilizar a extensão de diagnóstico do Linux para monitorizar métricas e registos](../../virtual-machines/extensions/diagnostics-linux.md) para obter detalhes sobre a instalação e configuração da extensão de diagnóstico. Isto permitir-lhe-á especificar a conta de armazenamento e configurar a recolha dos dados que pretende encaminhar para os Registos do Monitor Azure.
...
* [Recolher registos e métricas para serviços Azure](../essentials/resource-logs.md#send-to-log-analytics-workspace) para serviços Azure suportados.
