...
* Um [agente do Log Analytics para o Windows](../agents/agent-windows.md) que está configurado para reportar ao mesmo espaço de trabalho que os agentes que comunicam através do portal
...
> [!NOTE]
> Configurar o Balançador de Carga Azure utilizando o **SKU Básico,** requer que as máquinas virtuais Azure pertençam a um Conjunto de Disponibilidade. Para saber mais sobre os conjuntos de disponibilidade, consulte [Gerir a disponibilidade de máquinas virtuais do Windows em Azure.](../../virtual-machines/availability.md) Para adicionar máquinas virtuais existentes a um conjunto de disponibilidade, consulte o Conjunto de [Disponibilidade VM do Gestor de Recursos do Azure.](https://gallery.technet.microsoft.com/Set-Azure-Resource-Manager-f7509ec4)
> 
...
>[!NOTE]
>Para instalar o agente Log Analytics nos computadores gateway e Windows que se ligam diretamente ao Log Analytics, consulte [os computadores Do Windows para o serviço Log Analytics em Azure](../agents/agent-windows.md). Para ligar computadores Linux, consulte [os computadores Connect Linux ao Azure Monitor](../agents/agent-linux.md). 
>
...
[Adicione fontes de dados](./../agents/agent-data-sources.md) para recolher dados de fontes conectadas e armazenar os dados no seu espaço de trabalho Log Analytics.
