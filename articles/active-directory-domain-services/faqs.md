...
Os utilizadores e grupos sincronizados do Azure Ative Directory para os Serviços de Domínio Azure AD não podem ser modificados porque a sua fonte de origem é o Azure Ative Directory. Isto inclui deslocar utilizadores ou grupos da unidade organizacional dos Utilizadores AADDC para uma unidade organizacional personalizada. Qualquer utilizador ou grupo originário do domínio gerido pode ser modificado.  
