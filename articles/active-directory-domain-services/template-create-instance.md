...
Este artigo mostra-lhe como ativar Azure AD DS usando um modelo de Gestor de Recursos Azure. Os recursos de apoio são criados usando a Azure PowerShell.
