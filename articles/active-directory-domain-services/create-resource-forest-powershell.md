...
Crie um principal de serviço Azure para a Azure AD DS para comunicar e autenticar-se. Um ID de aplicação específico é usado chamado *Serviços de Controlador* de Domínio com um ID de *2565bd9d-da50-47d4-8b85-4c97f669dc36*. Não mude esta identificação da aplicação.
