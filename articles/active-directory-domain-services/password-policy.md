...
1. Inicie sessão na VM do Windows utiliza para administrar o seu domínio gerido. Se não tiver um, siga as instruções para [gerir um domínio do Azure AD Domain Services](manage-domain.md).
...
9. Na **diretamente aplica-se a**, clique nas **Add** botão. Na **selecionar utilizadores ou grupos** caixa de diálogo, clique nas **localizações** botão.
   ...
   ![Selecionar utilizadores e grupos](./media/how-to/fgpp-applies-to.png)
