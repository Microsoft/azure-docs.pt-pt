...
* **CSPs podem criar scripts de criação de novos domínios geridos para seus clientes através do PowerShell:** Ver [como para ativar o Azure AD Domain Services com o PowerShell](powershell-create-instance.md) para obter detalhes.
