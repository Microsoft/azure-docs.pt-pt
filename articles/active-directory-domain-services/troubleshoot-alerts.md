...
| AADDS502 | *O certificado de secure LDAP para o domínio gerido irá expirar em [date].* | [Prazo de expiração de certificado de secure LDAP](alert-ldaps.md#aadds502-secure-ldap-certificate-expiring) |
...
Este erro é irrecuperável. Para resolver, tem [eliminar o domínio gerido existente](delete-aadds.md) e recriá-lo no diretório novo. Se estiver a ter problemas ao eliminar, contacte a equipa de produto do Azure Active Directory Domain Services [para obter suporte](contact-us.md).
...
1. [Eliminar o seu domínio gerido](delete-aadds.md) do diretório do Azure AD existente.
2. Crie um novo diretório que não é um diretório do Azure AD B2C.
3. Siga os [introdução ao](create-instance.md) guia para recriar um domínio gerido.
...
1. [Eliminar o seu domínio gerido](delete-aadds.md) do diretório.
...
3. Siga [guia de introdução ao utilizar o Azure AD Domain Services](create-instance.md) para recriar o seu domínio gerido. Certifique-se de que escolha uma rede virtual com um intervalo de endereços IP privados.
4. A associação ao domínio suas máquinas virtuais para o novo domínio, siga [este guia](join-windows-vm.md).
8. Para garantir que o alerta é resolvido, verifique o estado de funcionamento do seu domínio nas duas horas.

## <a name="aadds106-your-azure-subscription-is-not-found"></a>AADDS106: Não foi encontrada a sua subscrição do Azure
...
2. [Eliminar o seu domínio gerido](delete-aadds.md) do diretório do Azure AD existente.
3. Siga os [introdução ao](create-instance.md) guia para recriar um domínio gerido.
...
Pode optar por mover a subscrição associada do Azure AD Domain Services no diretório anterior ou se precisar [eliminar o seu domínio gerido](delete-aadds.md) do diretório existente e recrie-o no diretório escolhido (qualquer um deles com uma nova subscrição ou altere o diretório de sua instância do Azure AD Domain Services está no).
...
Este erro é irrecuperável. Para resolver, tem [eliminar o domínio gerido existente](delete-aadds.md) e [recriar o seu domínio gerido](create-instance.md)
...
> [!WARNING]
> Se o seu domínio gerido está suspenso durante um período prolongado de tempo, é em risco de que está a ser eliminado. É melhor abordar a suspensão mais depressa possível. Para obter mais informações, visite [este artigo](suspension.md).
...
[Verificar estado de funcionamento do seu domínio](check-health.md) para todos os alertas que possam indicar problemas na sua configuração do seu domínio gerido. Se pode resolver qualquer um destes alertas, fazê-lo. Depois, contacte o suporte para reativar a subscrição.
