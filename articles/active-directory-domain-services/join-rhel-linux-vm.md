...
Aqui, ' contoso100.com ' é o nome de domínio DNS do seu domínio gerenciado. ' contoso-RHEL ' é o nome do host da máquina virtual RHEL que você está unindo ao domínio gerenciado.
...
1. No terminal SSH, digite o seguinte comando para se conectar à máquina virtual RHEL ingressada no domínio usando SSH. Use uma conta de domínio que pertença ao domínio gerenciado (por exemplo,bob@CONTOSO100.COM' ' neste caso).
