...
| Atributo no Azure AD DS | Source | Notas |
|:--- |:--- |:--- |
...
|:--- |:--- |
| accountEnabled |userAccountControl (define ou limpa o ACCOUNT_DISABLED bit) |
| city |l |
| país |Co |
...
| passwordPolicies |userAccountControl (define ou limpa o DONT_EXPIRE_PASSWORD bit) |
