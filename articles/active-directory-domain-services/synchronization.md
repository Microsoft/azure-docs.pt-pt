...
* [Considerações de redes para o Azure AD Domain Services](network-considerations.md)
* [Introdução ao Azure AD Domain Services](create-instance.md)
