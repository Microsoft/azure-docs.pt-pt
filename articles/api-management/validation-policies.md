...
| tamanho máximo | Comprimento máximo do corpo do pedido ou resposta, verificado contra o `Content-Length` cabeçalho. Se o corpo de pedido ou o corpo de resposta forem comprimidos, este valor é o comprimento descomprimido. Valor máximo permitido: 102.400 bytes (100 KB).  | Sim       | N/D   |
