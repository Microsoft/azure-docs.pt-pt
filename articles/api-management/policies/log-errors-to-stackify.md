...
ms.locfileid: "92072072"
---
# <a name="send-errors-to-stackify-for-logging"></a>Enviar erros para Stackify para registar

Este artigo mostra uma amostra de política de gestão da API Azure que demonstra como adicionar uma política de registo de erros para enviar erros ao Stackify para registo de registo. Para definir ou editar um código de política, siga os passos descritos no [Conjunto ou edite uma política](../set-edit-policies.md). Para ver outros exemplos, consulte [as amostras de política.](../policy-reference.md)
