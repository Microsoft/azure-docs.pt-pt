...
|DelegatedSubscriptionUrl|string|Se a delegação estiver habilitada, a URL de assinatura delegada.|  
|Isconcorded|boolean|Se o produto tiver termos, se o usuário atual concordou com os termos.|  
