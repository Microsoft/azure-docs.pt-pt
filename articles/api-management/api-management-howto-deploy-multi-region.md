...
4. Use o `set-backend` combinado com as políticas de `choose` condicional para construir uma política de roteamento adequada na seção `<inbound> </inbound>` do arquivo.
