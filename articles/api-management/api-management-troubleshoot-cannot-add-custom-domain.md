...
ms.locfileid: "68351365"
---
# <a name="failed-to-update-api-management-service-hostnames"></a>Falha ao atualizar os nomes de anfitrião do serviço de Gestão de API
...
Verifique se o problema está resolvido. Para fazer isso, tente criar o domínio personalizado no serviço de gerenciamento de API usando o certificado Key Vault.
