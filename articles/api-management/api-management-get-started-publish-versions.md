...
Para ver detalhes sobre um conjunto de versão, executar o comando de exibição de [versões az apim api:](/cli/azure/apim/api/versionset#az_apim_api_versionset_show)
