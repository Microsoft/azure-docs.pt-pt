...
description: Saiba como escalar e adicionar regiões à instância de serviço de Gestão da API. Consulte um script de amostra e veja recursos disponíveis adicionais.
