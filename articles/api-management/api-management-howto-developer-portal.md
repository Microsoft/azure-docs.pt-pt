...
The old developer and publisher portals are now *legacy* features - they will be receiving security updates only. As novas funcionalidades só serão implementadas no novo portal do programador.
