...
|`samples`|Coleção de [exemplo de código](api-management-template-data-model-reference.md#Sample) entidades.|Os exemplos de código para a operação atual....|  
