...
##  <a name="developer-portal-templates"></a><a name="DeveloperPortalTemplates"></a> Modelos de portal de desenvolvedores  
...
-   [APIs](api-management-api-templates.md)  
    ...
    -   [Amostras de código](api-management-api-templates.md#CodeSamples)  
        -   [Caracóis](api-management-api-templates.md#Curl)  
...
+ [Referência do modelo de dados](api-management-template-data-model-reference.md)  
