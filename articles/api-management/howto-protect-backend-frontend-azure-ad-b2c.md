...
1. Vá à lâmina de Apps de Função do portal Azure, abra a sua aplicação de função vazia e, em seguida, crie uma nova função In-Portal 'Webhook + API' através do arranque rápido.
