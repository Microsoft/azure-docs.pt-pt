...
Tudo está funcionando, mas não há fontes de métricas. Aceda ao Prometheus URL (https://prom-prometheus-project.apps.*id aleatório*.*região*.azmosa.io/). Você pode encontrá-lo usando o seguinte comando:
