...
Sim. Pode implementar um cluster do Azure Red Hat OpenShift numa rede virtual existente quando cria um cluster. Consulte a [ligar uma rede virtual de um cluster a uma rede virtual existente ](tutorial-create-cluster.md#optional-connect-the-clusters-virtual-network-to-an-existing-virtual-network) para obter detalhes.
