---
title: Acesso delegado no Windows Virtual Desktop (pré-visualização) - Azure
description: Como delegar capacidades administrativas numa implantação de área de Trabalho Virtual do Windows, incluindo exemplos.
