...
3. Limpe a cache do browser. See [clear browser cache for your browser](https://binged.it/2RKyfdU).
...
4. Limpe a cache do browser. See [Clear browser cache for your browser](https://binged.it/2RKyfdU).
