...
Agora que aprendeu a implementar e conectar-se com a ferramenta de gestão, pode aprender a usar o Serviço Azure para monitorizar problemas de serviço e aconselhamento de saúde. Para saber mais, consulte o tutorial de alertas de [serviço Configuração.](./set-up-service-alerts.md)