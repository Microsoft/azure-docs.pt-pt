...
ms.locfileid: "64927646"
---
# <a name="troubleshooting-overview-feedback-and-support"></a>Descrição geral, comentários e suporte de resolução de problemas
...
Utilize a seguinte tabela para identificar e resolver problemas que poderá encontrar ao configurar um ambiente de inquilino com o cliente de ambiente de trabalho remoto.
