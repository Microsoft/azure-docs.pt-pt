...
2. Sob **criar rede virtual**, aplicar as seguintes definições: 
    ...
    |Localização|\<Selecione a região mais próxima dos seus utilizadores\>|Selecione uma localização geográfica onde pode alojar a sua rede virtual. Utilize a localização mais próxima dos seus utilizadores.|
...
2. Sob **serviço Azure Databricks**, aplicar as seguintes definições:
    ...
    |Localização|\<Selecione a região mais próxima dos seus utilizadores\>|Escolha a mesma localização que a rede virtual.|
