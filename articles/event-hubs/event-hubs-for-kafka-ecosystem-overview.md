...
Este artigo forneceu uma introdução aos Centros de Eventos para Kafka. Para saber mais, consulte o guia de [desenvolvimento da Apache Kafka para o Azure Event Hubs.](apache-kafka-developer-guide.md)
