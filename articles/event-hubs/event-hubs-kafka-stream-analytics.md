...
5. Navegue para `azure-event-hubs-for-kafka/quickstart/java/producer/src/main/java/com/example/app`, e abra o ficheiro **TestDataReporter.java** num editor à sua escolha. 
