---
title: Azure Event Hubs - Resource Manager exceções | Microsoft Docs
...
| Conflito | nenhum | A atualização do Namespace falhou com o conflito no backend. | Outra operação está atualmente a ser feita neste espaço de nome. | Aguarde até que a operação atual termine e, em seguida, redaça. |
