...
> [!NOTE]
> Este código nesta seção é para a versão estável atual (1.3.1) do SDK dos hubs de eventos. Se você estiver procurando o código de exemplo que usa a versão de visualização do SDK, consulte [esta página](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/eventhub/azure-eventhubs/examples).
