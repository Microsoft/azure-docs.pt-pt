...
Pode utilizar a [Chave De Acesso AzEventHubNameSpaceKey](/powershell/module/az.eventhub/get-azeventhubkey) para obter a cadeia de ligação para o nome de política/regra específico, como mostrado abaixo:
