...
> [!IMPORTANT]
> Este quickstart utiliza a versão 5 do Azure Event Hubs Python SDK. Para um arranque rápido que utilize a versão 1 do Python SDK, consulte [este artigo](event-hubs-capture-python.md). 
