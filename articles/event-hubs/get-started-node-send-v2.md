...
> [!IMPORTANT]
> Este quickstart utiliza o mais recente pacote azure/event-hubs versão 5. Para um início rápido que utilize o antigo pacote azure/event-hubs versão 2, consulte [Enviar e receber eventos utilizando a versão 2 de azure/event-hubs](event-hubs-node-get-started-send.md). 
