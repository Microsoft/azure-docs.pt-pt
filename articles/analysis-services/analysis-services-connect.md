...
> [!NOTE]
> As bibliotecas de clientes não podem ligar-se aos Serviços de Análise Azure através de servidores proxy que requerem um nome de utilizador e uma palavra-passe. 
