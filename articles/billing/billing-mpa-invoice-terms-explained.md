---
title: Compreender a fatura do Contrato de Parceiro da Microsoft no Azure
description: Saiba como ler e compreender a fatura do Contrato de Parceiro da Microsoft no Azure
author: bandersmsft
manager: jureid
tags: billing
ms.service: billing
...
ms.locfileid: "72512540"
---
# <a name="terms-in-your-microsoft-partner-agreement-invoice"></a>Termos na fatura do Contrato de Parceiro da Microsoft

Este artigo aplica-se à conta de faturação do Azure de um Contrato de Parceiro da Microsoft. [Verifique se tem acesso a um Contrato de Parceiro da Microsoft](#check-access-to-a-microsoft-partner-agreement).

A sua fatura disponibiliza um resumo dos seus custos e instruções para o pagamento. Está disponível para transferência em .pdf (Portable Document Format) a partir do [portal do Azure](https://portal.azure.com/) ou pode ser enviada por e-mail. Para obter mais informações, veja [Ver e transferir a sua fatura do Microsoft Azure](billing-download-azure-invoice.md).
...
| Termos de pagamento |Como paga pela sua fatura da Microsoft. *60 dias de calendário* significa que paga dentro de 60 dias a partir da data da fatura. |
...
## <a name="billing-details-by-product"></a>Detalhes de faturação por produto

A secção **Detalhes de faturação por produto** lista os custos totais de cada produto associado a este perfil de faturação. Pode visualizar a discriminação diária dos custos de cada produto no ficheiro CSV de utilização e custos do Azure. Para saber mais sobre como reconciliar o PDF da fatura com o CSV de utilização e custos do Azure, veja [Compreender a fatura do Contrato de Parceiro da Microsoft](billing-mpa-understand-your-bill.md).

## <a name="how-to-pay"></a>Como pagar

Na parte inferior da fatura, existem instruções para pagar a sua fatura. Pode pagar por cheque ou por transferência bancária no prazo de 60 dias a partir da data da fatura.
...
- [Compreender os custos na fatura do perfil de faturação](billing-mca-understand-your-bill.md)
...
- [Visualizar documentos fiscais para o seu perfil de faturação](billing-mca-download-tax-document.md)
