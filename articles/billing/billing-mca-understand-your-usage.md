...
Para obter o ficheiro de utilização e custos do Azure, veja [Visualizar e transferir a utilização e os custos do Azure para o seu Contrato de Cliente da Microsoft](billing-download-azure-daily-usage.md). Está disponível num formato de ficheiro de valores separados por vírgulas (.csv) que pode abrir numa aplicação de folha de cálculo.
...
Se quiser confirmar se os custos no seu ficheiro de utilização detalhado estão corretos, pode verificá-los. Veja [Compreender os custos na fatura do perfil de faturação](billing-mca-understand-your-bill.md)
