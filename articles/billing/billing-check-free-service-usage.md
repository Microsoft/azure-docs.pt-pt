...
2.  Escreva **Subscrições** na caixa de pesquisa.
    ...
    ![Captura de ecrã que mostra a pesquisa de subscrições no portal](./media/billing-check-usage-of-free-services/billing-search-subscriptions.png)
