...
Para obter mais detalhes, veja [Adicionar, atualizar ou remover um cartão de crédito do Azure](billing-how-to-change-credit-card.md).
...
3. Na página **Descrição geral da** **Gestão de Custos + Faturação**, consulte a coluna de estado na grelha **As minhas subscrições**.
...
- Veja [Resolver saldo em dívida na subscrição do Azure](billing-azure-subscription-past-due-balance.md) se tiver de pagar uma fatura do Azure.
