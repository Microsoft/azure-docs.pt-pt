...
![Exemplo que mostra onde Transferir o ficheiro CSV de dados da utilização no portal do Azure](./media/billing-understand-reserved-instance-usage-ea/portal-download-csv.png)
