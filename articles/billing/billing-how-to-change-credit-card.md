...
ms.locfileid: "68383673"
---
# <a name="add-update-or-remove-a-credit-card-for-azure"></a>Adicionar, atualizar ou remover um cartão de crédito do Azure

No portal do Azure, você pode adicionar um novo cartão de crédito, atualizar um cartão de crédito existente ou excluir um cartão de crédito que você não usa. Você deve ser um [administrador de conta](billing-subscription-transfer.md#whoisaa) para fazer essas alterações.
...
**Deseja mudar para pagar por fatura (transferência de cheque/transmissão)?** Consulte [pagar por assinaturas do Azure por fatura](billing-how-to-pay-by-invoice.md).
...
1. Selecione **Métodos de pagamento**.
    ...
    ![Captura de tela que mostra a opção gerenciar métodos de pagamento selecionada.](./media/billing-how-to-change-credit-card/payment-methods-blade-x.png)
...
1. Para tornar este cartão o seu método de pagamento ativo, marque a caixa ao lado de **tornar esse meu método de pagamento ativo** acima do formulário. Este cartão tornar-se-á o instrumento de pagamento ativo para todas as subscrições com o mesmo cartão da subscrição selecionada.

1. Selecione **Seguinte**.

Se você receber um erro depois de adicionar o cartão de crédito, confira [cartão de crédito recusado na inscrição do Azure](billing-credit-card-fails-during-azure-sign-up.md).

## <a name="update-existing-credit-card"></a>Atualizar cartão de crédito existente

Se o seu cartão de crédito for renovado e o número permanecer o mesmo, atualize os detalhes do cartão de crédito existente, como a data de validade. Se o número do seu cartão de crédito for alterado porque o cartão foi perdido, roubado ou expirou, siga as etapas na seção [Adicionar um cartão de crédito como um método de pagamento](#addcard) . Você não precisa atualizar o CVV.
...
1. Clique no cartão de crédito que você deseja editar. Será apresentado à direita um formulário de cartão de crédito.
...
### <a name="my-subscription-is-disabled-why-cant-i-remove-my-credit-card-now"></a>Minha assinatura está desabilitada. Por que não consigo remover meu cartão de crédito agora?

Depois que sua assinatura for desabilitada ou cancelada, aguardaremos 90 dias antes de excluir permanentemente sua assinatura. Mantemos seu método de pagamento no arquivo durante o período de retenção, caso você queira reativar a assinatura. Depois disso, a assinatura é excluída permanentemente.

Se você precisar remover seu cartão de crédito antes de o período de retenção de 90 dias terminar, [reative sua assinatura](billing-subscription-become-disable.md). Se você não puder reativar, [entre em contato com o suporte do Azure](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade).
...
Se você continuar recebendo essa mensagem de erro mesmo que você já tenha feito logoff e logon novamente, tente novamente com uma sessão de navegação privada.

### <a name="how-do-i-use-a-different-card-for-each-subscription-i-have"></a>Como fazer usar um cartão diferente para cada assinatura que tenho?

Infelizmente, se suas assinaturas já estiverem usando o mesmo cartão, não será possível separá-las para usar cartões diferentes. No entanto, ao se inscrever para uma nova assinatura, você pode optar por usar um novo método de pagamento para essa assinatura.

### <a name="how-do-i-make-payments"></a>Como fazer fazer pagamentos?
...
Se você estiver [pagando por fatura](billing-how-to-pay-by-invoice.md), envie seu pagamento para o local listado na parte inferior da fatura.

### <a name="how-do-i-change-the-tax-id"></a>Como fazer alterar a ID do imposto?

Para adicionar ou atualizar a ID do imposto, atualize seu perfil na [centro de contas do Azure](https://account.azure.com/Profile)e, em seguida, selecione **registro de impostos**. O NIF é utilizado para cálculos de isenção fiscal e é apresentado na sua fatura.
