...
1. Clique no cartão de crédito ou débito que quer editar. Será apresentado à direita um formulário de cartão de crédito.
...
1. Atualize os detalhes do cartão de crédito ou débito.
1. Selecione **Guardar**.
