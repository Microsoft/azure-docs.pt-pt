...
Todos os créditos ou ajustes que se apliquem à sua inscrição estão visíveis em [https://www.ea.azure.com](https://www.ea.azure.com) na secção **Relatórios**. Se tiver uma questão específica acerca de um montante de crédito real, contacte o [Suporte do Azure EA Portal](https://support.microsoft.com/supportrequestform/cf791efa-485b-95a3-6fad-3daf9cd4027c).
