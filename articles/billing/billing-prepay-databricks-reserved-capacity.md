...
![Exemplo que mostra a compra de Azure Databricks no portal do Azure](./media/billing-prepay-databricks-reserved-capacity/data-bricks-pre-purchase.png)
...
Não pode dividir ou unir a pré-compra de unidades de consolidação de Databricks. Para obter mais informações sobre como gerir reservas, veja [Gerir reservas após a compra](billing-manage-reserved-vm-instance.md).
