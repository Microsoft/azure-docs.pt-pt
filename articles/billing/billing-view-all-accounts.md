...
- **Programa Microsoft Online Services**: Uma conta de cobrança para um programa Microsoft Online Services é criada quando se inscreve no Azure através do Web site do Azure. Por exemplo, ao inscrever-se para obter um [conta gratuita do Azure](https://azure.microsoft.com/offers/ms-azr-0044p/), [oferta do Azure pré-pago](https://azure.microsoft.com/offers/ms-azr-0003p/) ou uma [subscritor do Visual studio](https://azure.microsoft.com/pricing/member-offers/credit-for-visual-studio-subscribers/).

- **Contrato Enterprise**: Quando a sua organização assina um contrato Enterprise para utilizar o Azure, é criada uma conta de faturação para um contrato Enterprise. Os administradores na conta de faturação para um contrato Enterprise usar departamentos e contas de faturação âmbitos para gerir e organizar a faturação para a sua organização.
