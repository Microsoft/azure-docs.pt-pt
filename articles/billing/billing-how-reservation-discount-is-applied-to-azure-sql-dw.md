...
- [Visualizar transações de reserva](billing-view-reservations.md)
- [Obter transações de reserva e utilização por meio de API](billing-reservation-apis.md)
