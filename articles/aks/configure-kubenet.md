...
Com um cluster AKS implantado na sua sub-rede de rede virtual existente, pode agora utilizar o cluster normalmente. Começa com a [criação de novas apps usando o Helm][develop-helm] ou [implementar aplicações existentes usando o Helm.][use-helm]
