...
### <a name="add-the-official-helm-stable-charts-repository"></a>Adicione o repositório oficial de gráficos de estábulo Helm

Use o comando [de repo de leme][helm-repo-add] para adicionar o repositório oficial de gráficos de estábulo Helm.
...
Por exemplo, o comando abaixo mostra o *IP EXTERNO* para o serviço de *controlador my-nginx-ingress:*
