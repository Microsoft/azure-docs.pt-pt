...
---
Numa concha baseada no PowerShell no Windows, utilize `Invoke-WebRequest` para descarregar o lançamento da tabela do Cônsul Helm e, em seguida, extrair com `Expand-Archive` seguinte:
