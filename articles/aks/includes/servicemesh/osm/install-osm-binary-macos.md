...
ms.locfileid: "106080389"
---
## <a name="download-and-install-the-osm-client-binary"></a>Descarregue e instale o binário de clientes OSM

Numa concha baseada em bash, use `curl` para descarregar o lançamento do OSM e, em seguida, extrair com o `tar` seguinte:
