...
Numa concha baseada em golpes no Linux ou [no Subsistema Windows para linux,][install-wsl]utilize `curl` para descarregar o lançamento do Linkerd da seguinte forma:
