...
Também pode utilizar o parâmetro de *contagem ip-contabilizado gerido* pelo carregador para definir o número inicial de IPs públicos geridos ao criar o seu cluster, fixando o parâmetro e definindo-o `--load-balancer-managed-outbound-ip-count` ao seu valor desejado. O número padrão de IPs públicos de saída geridos é 1.
