...
Este artigo mostra como usar intervalos de endereços IP autorizados do servidor de API para limitar solicitações ao plano de controle. Esta funcionalidade encontra-se em pré-visualização.
