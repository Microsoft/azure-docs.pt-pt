...
> [!NOTE]
> Se tiver instalado anteriormente a *pré-visualização do aks* extensão, instale qualquer disponível atualizações com o o `az extension update --name aks-preview` comando.
