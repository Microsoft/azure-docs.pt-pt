...
You need the Azure CLI version 2.0.66 or later installed and configured. Executar `az --version` para localizar a versão. Se precisar de instalar ou atualizar, veja [Instalar a CLI do Azure][install-azure-cli].
