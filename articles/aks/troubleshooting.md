...
Se você não vir o painel kubernetes, verifique se o Pod `kube-proxy` está em execução no namespace `kube-system`. Se não estiver em um estado de execução, exclua o pod e ele será reiniciado.
