...
Este artigo mostra-lhe como utilizar o código-fonte aberto [kured (KUbernetes reiniciar Daemon)] [ kured] para ver para nós do Linux que exigem uma reinicialização, em seguida, processam automaticamente o valor do reagendamento de execução pods e nó Reinicie o processo.
