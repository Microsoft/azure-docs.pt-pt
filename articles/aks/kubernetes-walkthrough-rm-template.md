...
Se optar por instalar e utilizar o CLI localmente, este arranque rápido requer que esteja a executar a versão Azure CLI 2.0.61 ou posterior. Executar `az --version` para localizar a versão. Se precisar de instalar ou atualizar, veja [Install Azure CLI (Instalar o Azure CLI)][azure-cli-install].
...
Leva alguns minutos para criar o cluster AKS. Aguarde que o cluster seja implantado com sucesso antes de passar ao passo seguinte.
