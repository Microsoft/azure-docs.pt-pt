...
Quando se cria uma política de replicação, é criada automaticamente uma política de replicação de failback correspondente, com o sufixo "failback". Depois de criar a apólice, pode editá-la selecionando-a e **editando Definições**.
...
1. Clique em **Associado**, e selecione o servidor de configuração.
    ...
    ![Servidor de configuração associado](./media/vmware-azure-set-up-replication/associate1.png)
...
1. Selecione **Gerir** > **Infraestrutura** de recuperação do local > políticas de **replicação.**
