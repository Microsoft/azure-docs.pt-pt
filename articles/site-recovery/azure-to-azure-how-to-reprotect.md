...
4. Apenas as alterações entre o disco de origem e o disco de destino são sincronizadas. Os diferenciais são calculados comparando a ambos os discos e, em seguida, transferidas. Para localizar a verificação de tempo estimado abaixo.
...
Na maioria dos casos, o Azure Site Recovery não replica os dados completos para a região de origem. Seguem-se as condições que determina a quantidade de dados seria replicada:
