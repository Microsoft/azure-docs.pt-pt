...
1. No cofre, selecione **itens replicados**e, em seguida, selecione o VM que foi reprotegido.
    ...
    ![Falha nas primárias](./media/site-recovery-azure-to-azure-failback/azure-to-azure-failback.png)
