...
O cenário combinado é representado no seguinte diagrama: ![local para o Azure com o ExpressRoute](./media/concepts-expressroute-with-site-recovery/site-recovery-with-expressroute.png)
