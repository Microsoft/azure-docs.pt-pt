...
> [!IMPORTANT]
> Consulte a documentação detalhada do SCVMM de [pré-requisitos](/system-center/vmm/upgrade-vmm?view=sc-vmm-2016#requirements-and-limitations)
