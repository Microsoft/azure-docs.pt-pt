...
A lista de etapas abaixo referidas aplica-se à configuração do utilizador de [anfitriões Hiper-V a Azure](https://docs.microsoft.com/azure/site-recovery/hyper-v-azure-architecture) executados seguindo este [tutorial](https://docs.microsoft.com/azure/site-recovery/hyper-v-prepare-on-premises-tutorial)
...
4. Utilize os passos [aqui](https://docs.microsoft.com/azure/site-recovery/hyper-v-azure-tutorial#set-up-the-source-environment) mencionados para registar o novo anfitrião do Windows Server 2016 para a Recuperação do Site Azure. Por favor, note que o site Hyper-V já está ativo e só precisa de registar o novo hospedeiro no cluster. 
...
1. Siga os passos [aqui](https://docs.microsoft.com/windows-server/failover-clustering/cluster-operating-system-rolling-upgrade#cluster-os-rolling-upgrade-process) mencionados para executar o processo de upgrade do cluster rolante. 
