...
|12 vCPUs (2 tomadas * 6 núcleos \@ 2,5 GHz) memória 24-GB |1 TB |1 TB a 2 TB |Replicar entre 150-225 máquinas. |
...
2. A **infraestrutura** de recuperação do site aberto > **VMWare e máquinas físicas** > servidores de **configuração** (em VMware e Máquinas Físicas).
