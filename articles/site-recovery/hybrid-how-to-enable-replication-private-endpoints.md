...
> [!NOTE]
> Se os pontos finais privados não estiverem ativados na conta de armazenamento, a proteção continuaria a ser bem sucedida. No entanto, o tráfego de replicação passaria através da internet para os pontos finais públicos de recuperação do local de Azure. Para garantir fluxos de tráfego de replicação através de ligações privadas, a conta de armazenamento deve ser ativada com pontos finais privados.
