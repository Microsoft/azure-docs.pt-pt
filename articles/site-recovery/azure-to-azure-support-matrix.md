...
**Liberar** | **Versão do serviço de mobilidade** | **Versão de kernel** |
--- | --- | --- |
Debian 7 | 9.24,9.25,9.26,9.27 | 3.2.0-4-AMD64 para 3.2.0-6-AMD64, 3.16.0-0. BPO. 4-AMD64 |
|||
...
Debian 8 | 9,24 | 3.16.0-4-AMD64 para 3.16.0-7-AMD64, 4.9.0-0. BPO. 4-AMD64 para 4.9.0-0. BPO. 8-AMD64 |
...
Azure Disk Encryption (ADE) para o sistema operacional Windows | Suportadas |
