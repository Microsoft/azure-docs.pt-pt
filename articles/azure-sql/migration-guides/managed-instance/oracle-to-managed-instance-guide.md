...
Para migrar o seu esquema Oráculo para a SQL Gestão de Casos, precisa: 
...
Utilize o SqL Server Migration Assistant (SSMA) para a Oracle para analisar objetos e dados de base de dados, avaliar bases de dados para migração, migrar objetos de base de dados para Azure SQL Managed Instance e, finalmente, migrar dados para a base de dados. 
...
1. Introduza os valores para os detalhes da ligação Oráculo na caixa de diálogo **'Ligar a Ligar ao Oráculo'.**
...
1. Migrar os dados: Clique com o botão direito do Explorador de **Metadados do Oráculo** e escolha **Dados Migratórios**. 
...
- Para saber mais sobre o ciclo de enquadramento e adoção para migrações em nuvem, ver
   ...
   -  [As melhores práticas para custos e cargas de trabalho de tamanho migram para a Azure](/azure/cloud-adoption-framework/migrate/azure-best-practices/migrate-best-practices-costs) s)
