...
Crie uma avaliação utilizando [o SqL Server Migration Assistant for Access](https://www.microsoft.com/download/details.aspx?id=54255). 
...
Para migrar dados utilizando o SSMA para acesso, siga estes passos: 
