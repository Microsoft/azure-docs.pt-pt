...
| Dados/IOPS de registo (aproximadamente) | Até 30-40 K IOPS por exemplo*, 500 - 7500 por ficheiro<br/>\*[Aumente o tamanho do ficheiro para obter mais IOPS](#file-io-characteristics-in-general-purpose-tier)| 16 K - 320 K (4000 IOPS/vCore)<br/>Adicione mais vCores para obter um melhor desempenho de IO. |
...
| Isolamento computacional | A Gen5 não é apoiada, uma vez que as instâncias de Propósito Geral podem partilhar hardware físico com outras instâncias<br/>A Gen4 não é apoiada por depreciação|Gen5:<br/>-suportado por 40, 64, 80 vCores<br/>-não suportado para outros tamanhos<br/><br/>A Gen4 não é apoiada por depreciação|
...
Existe também um limite de nível de instância na produção de registo máximo (ver acima para valores como 22 MB/s), para que não possa alcançar o ficheiro máximo em todo o ficheiro de registo porque está a atingir o limite de produção de caso.
