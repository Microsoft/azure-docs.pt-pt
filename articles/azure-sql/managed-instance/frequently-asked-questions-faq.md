...
(substituir 'teste' pelo nome de login pretendido)

 > [!Note]
 > Os valores predefinidos para CHECK_POLICY e CHECK_EXPIRATION estão definidos para OFF.
