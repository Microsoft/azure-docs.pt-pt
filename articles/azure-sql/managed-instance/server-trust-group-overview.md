...
[Server Trust Group](https://aka.ms/mi-server-trust-group-arm) é um objeto Azure Resource Manager que foi rotulado como **grupo de confiança SQL** no portal Azure.
