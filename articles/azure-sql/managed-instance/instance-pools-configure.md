...
> [!NOTE]
> Para verificar limites no número de bases de dados por exemplo, pool e instância gerida implantadas dentro da secção de limites de recursos de [piscinas Instance.](instance-pools-overview.md#resource-limitations)
