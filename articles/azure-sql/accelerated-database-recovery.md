...
ADR está atualmente disponível para Azure SQL Database, Azure SQL Managed Instance, bases de dados em Azure Synapse Analytics e SQL Server em VMs Azure a partir do SQL Server 2019. 
