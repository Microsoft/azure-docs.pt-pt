---
title: 'Quckstart: Crie um VM de servidor Linux SQL em Azure'
...
Neste tutorial de arranque rápido, utiliza-se o portal Azure para criar uma máquina virtual Linux com o SQL Server 2017 instalado. Aprende-se o seguinte: 
...
1. Limite os resultados de pesquisa selecionando o **sistema operativo**  >  **Redhat**.
    ...
    ![Filtro de pesquisa para imagens VM SQL Server 2019](./media/sql-vm-create-portal-quickstart/searchfilter.png)
