...
Para migrações a granel, recomendamos o serviço [de Recuperação do Local Azure.](../../../site-recovery/site-recovery-overview.md) Com a Recuperação do Site Azure, os clientes podem replicar todo o VM, incluindo o SQL Server de instalações para Azure VM.
...
O [Azure Database Migration Service](../../../dms/dms-overview.md) é uma opção para os clientes se estiverem a migrar de instalações para um Azure VM, atualizando o SQL Server para a versão de 2012 ou mais tarde.
