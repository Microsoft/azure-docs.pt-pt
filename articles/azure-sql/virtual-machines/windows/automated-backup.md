...
- As bases de dados de destino devem estar na instância padrão do Servidor SQL ou numa instância de nome [devidamente instalada.](frequently-asked-questions-faq.md#administration) 
...
Para as máquinas virtuais existentes do SQL Server, navegue para o recurso das [máquinas virtuais SQL](manage-sql-vm-portal.md#access-the-sql-virtual-machines-resource) e, em seguida, selecione **Backups** para configurar as suas cópias de segurança automatizadas.
