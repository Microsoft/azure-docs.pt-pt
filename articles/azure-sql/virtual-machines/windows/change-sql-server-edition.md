...
1. Vá à **Manutenção** e escolha a opção Upgrade da **Edição.** 
   ...
   ![Seleção para upgrade da edição do SQL Server](./media/change-sql-server-edition/edition-upgrade.png)
