...
Filestream não é suportado para um cluster failover com uma quota de ficheiro premium. Para utilizar o filestream, implemente o seu cluster utilizando espaços de [armazenamento direto](failover-cluster-instance-storage-spaces-direct-manually-configure.md).
...
:::image type="content" source="media/manually-configure-failover-cluster-instance-premium-file-share/test-cluster-failover.png" alt-text="Falha no cluster de teste movendo o recurso principal para os outros nós":::
...
1. Selecione nova instalação de **cluster de falha do Servidor SQL**. Siga as instruções no assistente para instalar o SQL Server FCI.
   ...
   :::image type="content" source="media/manually-configure-failover-cluster-instance-premium-file-share/use-file-share-as-data-directories.png" alt-text="Utilize a partilha de ficheiros como diretórios de dados SQL":::
