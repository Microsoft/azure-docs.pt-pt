...
- [Configure um sQL Server Sempre em grupo de disponibilidade em máquinas virtuais Azure em diferentes regiões](availability-group-manually-configure-multiple-regions.md)
