...
---
# <a name="introduction-to-a-multitenant-saas-app-that-uses-the-database-per-tenant-pattern-with-azure-sql-database"></a>Introdução a uma aplicação SaaS multiarrendatária que utiliza o padrão de base de dados por inquilino com base de dados Azure SQL
...
|[Implementar e explorar a aplicação Wingtip SaaS](../../sql-database/saas-dbpertenant-get-started-deploy.md)|  Desloque e explore a aplicação Wingtip SaaS com a sua subscrição Azure. |
|[Inquilinos de provisão e catálogo](../../sql-database/saas-dbpertenant-provision-and-catalog.md)| Saiba como a aplicação se conecta aos inquilinos utilizando uma base de dados de catálogo e como o catálogo mapeia os inquilinos aos seus dados. |
|[Monitorizar e gerir o desempenho](../../sql-database/saas-dbpertenant-performance-monitoring.md)| Aprenda a utilizar as funcionalidades de monitorização da Base de Dados SQL e defina alertas quando os limiares de desempenho são ultrapassados. |
|[Monitorizar com os registos do Azure Monitor](../../sql-database/saas-dbpertenant-log-analytics.md) | Aprenda a usar [os registos do Monitor Azure](../../azure-monitor/log-query/log-query-overview.md) para monitorizar grandes quantidades de recursos em várias piscinas. |
|[Restaurar um único inquilino](../../sql-database/saas-dbpertenant-restore-single-tenant.md)| Aprenda a restaurar uma base de dados de inquilinos para um ponto de acesso anterior. Também saiba como restaurar uma base de dados paralela, o que deixa a base de dados de inquilinos existente online. |
