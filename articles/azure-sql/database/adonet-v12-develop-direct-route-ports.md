...
Quando o seu cliente corre dentro do limite da nuvem Azure, ele usa o que podemos chamar de *uma rota direta* para interagir com a Base de Dados SQL. Após a estabelecer uma ligação, outras interações entre o cliente e a base de dados não envolvem gateway de base de dados Azure SQL.
...
2. ADO.NET então liga-se diretamente à Base de Dados SQL, sem intermediários no meio.
