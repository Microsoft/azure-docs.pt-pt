...
Consulte [Adicionar um fragmento a uma aplicação utilizando a biblioteca de clientes de base](elastic-scale-add-a-shard.md)de dados elástica .

## <a name="how-much-do-elastic-database-tools-cost"></a>Quanto custam as ferramentas de base de dados elásticas

A utilização da biblioteca de clientes de base de dados elástica não incorre em quaisquer custos. Os custos acumulam-se apenas para as bases de dados da Base de Dados Azure SQL que utiliza para fragmentos e para o Gestor de Mapas de Fragmentos, bem como para as funções web/trabalhador que você provisão para a ferramenta Split Merge.
