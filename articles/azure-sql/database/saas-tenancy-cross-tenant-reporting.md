...
* A aplicação Wingtip Tickets SaaS Database Per Tenant está implementada. Para implantar em menos de cinco minutos, consulte Implementar e explorar a base de [dados saaS de bilhetes wingtip por pedido](../../sql-database/saas-dbpertenant-get-started-deploy.md) de inquilino
...
1. No **Object Explorer,** expanda os pontos de vista **contosoconcerthall:**  >  **Views**
...
* [Tutoriais adicionais que se baseiam na base de dados SaaS de Bilhetes De Ponta Por Inquilino](../../sql-database/saas-dbpertenant-wingtip-app-overview.md#sql-database-wingtip-saas-tutorials)
