...
Utilize [o SQL Server Management Studio (SSMS)](/sql/ssms/download-sql-server-management-studio-ssms) para ligar e navegar nos servidores de aplicações e bases de dados.
...
- [Implementar a aplicação de ingressos saas de ponta saas](./saas-standaloneapp-get-started-deploy.md)
- [Implementar a Base de Dados saaS de Ingressos de Ponta de Asa por pedido de Inquilino](./saas-dbpertenant-get-started-deploy.md)
- [Implementar a aplicação de base de dados de multi-inquilinos Wingtip SaaS](./saas-multitenantdb-get-started-deploy.md)