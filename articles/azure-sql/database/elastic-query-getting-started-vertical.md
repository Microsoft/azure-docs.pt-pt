...
Consulta de base de dados elástica (pré-visualização) para Base de Dados SQL Azure permite-lhe executar consultas T-SQL que abrangem várias bases de dados usando um único ponto de ligação. Este artigo aplica-se a bases de [dados verticalmente divididas](elastic-query-vertical-partitioning.md).  
...
Para mais informações sobre a funcionalidade de consulta de base de dados elástica, consulte a visão geral da consulta de [dados elástica azure SQL](elastic-query-overview.md)Database .
...
Para começar, crie duas bases de dados, **Clientes** e **Encomendas,** nos mesmos servidores ou diferentes.
