...
> [!IMPORTANT]
> Um trabalho Azure Stream Analytics pode ser transmitido para Azure SQL Database, Azure SQL Managed Instance ou Azure Synapse Analytics. Para mais informações, consulte [outputs](../../stream-analytics/stream-analytics-define-outputs.md).
