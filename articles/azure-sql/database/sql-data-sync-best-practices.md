...
> [!IMPORTANT]
> O Azure SQL Data Sync **não** suporta a Instância Gerida Azure SQL neste momento.
...
Quando criar uma nova base de dados, detete o tamanho máximo para que seja sempre maior do que a base de dados que implementa. Se não definir o tamanho máximo para maior do que a base de dados implementada, a sincronização falha. Embora o SQL Data Sync não ofereça crescimento automático, pode executar o comando para aumentar o tamanho da base de dados depois de ter `ALTER DATABASE` sido criada. Certifique-se de que se mantém dentro dos limites de tamanho da base de dados.
...
Cada mesa de um grupo de sincronização deve ter uma chave primária. O SQL Data Sync não consegue sincronizar uma tabela que não tenha uma chave primária.
...
-   Visão geral - Sync dados em várias bases de dados de nuvem e no local com O Sincronizado de [Dados Azure SQL](sql-data-sync-data-sql-server-sql-database.md)
-   Configurar o SQL Data Sync
    ...
    - Com o PowerShell
        ...
        -  [Utilize o PowerShell para sincronizar entre uma base de dados na Base de Dados SQL e uma base de dados numa instância do Servidor SQL](scripts/sql-data-sync-sync-data-between-azure-onprem.md)
...
-   Troubleshoot - [Problemas com O Sincronizado de Dados Azure SQL](sql-data-sync-troubleshoot.md)
-   Atualizar o esquema de sincronização
    -   Com a Transact-SQL - [Automatizar a replicação de alterações de esquemas no Azure SQL Data Sync](sql-data-sync-update-sync-schema.md)
