...
description: A máscara de dados dinâmicos limita a exposição de dados sensíveis, mascarando-os a utilizadores não privilegiados para a Base de Dados Azure SQL, A Instância Gerida Azure SQL e a Azure Synapse Analytics
...
ms.locfileid: "84050192"
---
# <a name="dynamic-data-masking"></a>Máscara de dados dinâmica 
[!INCLUDE[appliesto-sqldb-sqlmi-asa](../includes/appliesto-sqldb-sqlmi-asa.md)]

Base de Dados Azure SQL, Instância Gerida Azure SQL e Azure Synapse Analytics suportam máscara dinâmica de dados. A máscara de dados dinâmicos limita a exposição de dados sensíveis, mascarando-as a utilizadores não privilegiados. 
...
* Utilizadores de **SQL excluídos da máscara** - Um conjunto de utilizadores DeSQL ou identidades Azure AD que obtêm dados desmascarados nos resultados da consulta SQL. Os utilizadores com privilégios de administrador são sempre excluídos da máscara e vêem os dados originais sem máscara.
...
- [Remover-AzSqlDatabaseDataMaskingRule](https://docs.microsoft.com/powershell/module/az.sql/Remove-AzSqlDatabaseDataMaskingRule)
- [Set-AzSqlDatabaseDataMaskingRule](https://docs.microsoft.com/powershell/module/az.sql/Set-AzSqlDatabaseDataMaskingRule)

## <a name="set-up-dynamic-data-masking-for-your-database-using-the-rest-api"></a>Configurar a máscara de dados dinâmicos para a sua base de dados utilizando a API REST

Pode utilizar a API REST para gerir programáticamente a política e as regras de máscara de dados. A API rest publicada apoia as seguintes operações:
...
- [Obter:](https://docs.microsoft.com/rest/api/sql/datamaskingpolicies/get)Obtém uma política de máscara de dados na base de dados. 

### <a name="data-masking-rules"></a>Regras de mascaramento de dados

- [Criar ou atualizar](https://docs.microsoft.com/rest/api/sql/datamaskingrules/createorupdate): Cria ou atualiza uma regra de máscara de dados de base de dados.
- [Lista por Base](https://docs.microsoft.com/rest/api/sql/datamaskingrules/listbydatabase)de Dados : Obtém uma lista das regras de máscara de dados da base de dados.
