...
* A aplicação Wingtip Tickets SaaS para o arrendamento. Para implantá-lo em menos de cinco minutos, consulte [implementar e explorar a aplicação de base de dados SaaS por insusição.](../../sql-database/saas-dbpertenant-get-started-deploy.md)
...
Experimente o [tutorial de monitorização do desempenho.](../../sql-database/saas-dbpertenant-performance-monitoring.md)
...
* [Scripts de depurar no Windows PowerShell ISE](https://docs.microsoft.com/powershell/scripting/components/ise/how-to-debug-scripts-in-windows-powershell-ise)
