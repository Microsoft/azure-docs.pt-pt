...
- [Conecte-se resilientemente ao SQL com PHP](https://docs.microsoft.com/sql/connect/php/step-4-connect-resiliently-to-sql-with-php)
...
Uma discussão sobre o período de *bloqueio* para clientes que usam ADO.NET está disponível em [Connection Pooling (ADO.NET)](https://msdn.microsoft.com/library/8xx3tyca.aspx).
...
Para obter mais informações, consulte [bases de dados e logins em Azure SQL Database](https://docs.microsoft.com/azure/sql-database/sql-database-manage-logins).
...
1. Faça a seguinte consulta SQL para verificar a vista [sys.dm_exec_requests](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-exec-requests-transact-sql) para ver quaisquer pedidos de bloqueio:
...
Para obter mais informações sobre os limites de recursos, consulte [os limites de recursos do servidor Lógico SQL](https://docs.microsoft.com/azure/sql-database/sql-database-resource-limits-database-server).
...
3. Se a base de dados já tiver ultrapassado o tamanho máximo suportado para a sua edição, experimente um ou mais dos seguintes passos:
   ...
   - Para escalar a base de dados, consulte [os recursos de base de dados únicos de escala](https://docs.microsoft.com/azure/sql-database/sql-database-single-database-scale) e recursos de piscina elástica em [escala.](https://docs.microsoft.com/azure/sql-database/sql-database-elastic-pool-scale)
...
| 40551 |16 |A sessão foi encerrada devido ao `TEMPDB` uso excessivo. Tente modificar a sua consulta para reduzir o uso temporário do espaço de mesa.<br/><br/>Se estiver a utilizar objetos temporários, conserva o espaço na `TEMPDB` base de dados, deixando cair objetos temporários depois de já não serem necessários pela sessão. Para obter mais informações sobre a utilização de temperaturas na Base de Dados SQL, consulte [a base de dados Tempdb na Base de Dados SQL](https://docs.microsoft.com/sql/relational-databases/databases/tempdb-database#tempdb-database-in-sql-database).|
...
- [Desempenho da consulta de sintonia manual na Base de Dados Azure SQL](https://docs.microsoft.com/azure/sql-database/sql-database-performance-guidance)
- [Monitorização do desempenho Azure SQL Database utilizando vistas dinâmicas de gestão](https://docs.microsoft.com/azure/sql-database/sql-database-monitoring-with-dmvs)
- [Operar a Loja de Consultas em Base de Dados Azure SQL](https://docs.microsoft.com/azure/sql-database/sql-database-operate-query-store)
...
4. Teste a conectividade entre o servidor de aplicações e a Base de Dados Azure SQL utilizando [o SQL Server Management Studio (SSMS)](https://docs.microsoft.com/azure/sql-database/sql-database-connect-query-ssms), um ficheiro UDL, ping ou telnet. Para obter mais informações, consulte problemas de conectividade de [resolução de problemas](https://support.microsoft.com/help/4009936/solving-connectivity-errors-to-sql-server) e [diagnósticos para questões de conectividade.](https://docs.microsoft.com/azure/sql-database/sql-database-connectivity-issues#diagnostics)

   > [!NOTE]
   > Como um passo de resolução de problemas, também pode testar conectividade em um computador cliente diferente.

5. Como uma boa prática, certifique-se de que a lógica de relícola está em vigor. Para obter mais informações sobre a lógica de relagem, consulte [falhas transitórias de resolução de problemas e erros de ligação à Base de Dados SQL](https://docs.microsoft.com/azure/sql-database/sql-database-connectivity-issues).
