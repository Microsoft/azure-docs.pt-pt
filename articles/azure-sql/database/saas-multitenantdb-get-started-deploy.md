...
2. A aplicação apressa então o nome do inquilino para criar uma chave para aceder a um catálogo usando a [gestão de mapas de fragmentos.](elastic-scale-shard-map-management.md)
...
Agora experimente o [tutorial de Provision e catálogo.](saas-dbpertenant-provision-and-catalog.md)
