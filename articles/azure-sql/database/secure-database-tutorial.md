...
Para saber mais, consulte a visão geral de segurança da [Base de Dados Azure SQL](./security-overview.md) e [os artigos de capacidades.](security-overview.md)

> [!TIP]
> O módulo seguinte Do Microsoft Learn ajuda-o a aprender gratuitamente sobre como proteger a [sua base de dados na Base de Dados Azure SQL](/learn/modules/secure-your-azure-sql-database/).
...
> [!NOTE]
> Também pode criar uma regra de firewall ao nível do servidor em SSMS utilizando o comando [sp_set_firewall_rule,](/sql/relational-databases/system-stored-procedures/sp-set-firewall-rule-azure-sql-database?view=azuresqldb-current&preserve-view=true) embora tenha de estar ligado à base de dados *principal.*
...
- [Gerir a AD Azure usando o PowerShell](/powershell/azure/)
