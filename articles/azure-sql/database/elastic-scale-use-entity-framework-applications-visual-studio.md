...
Para definições de termo, consulte o glossário das [ferramentas elásticas database](elastic-scale-glossary.md).
...
1. Crie ligações físicas de base de dados através das interfaces de cliente de dados elásticos do gestor de mapas de fragmentos.
