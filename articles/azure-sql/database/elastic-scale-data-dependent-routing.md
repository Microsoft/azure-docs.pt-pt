...
Para desprender um fragmento, ou para voltar a colocar um fragmento, consulte [Utilizar a classe RecoveryManager para corrigir problemas no mapa](elastic-database-recovery-manager.md)do fragmento .
