...
Na [segunda parte,](clustering-model-build-tutorial.md)aprenderás a criar e treinar um modelo de agrupamento K-Means em R.
...
> [Tutorial: Criar um modelo preditivo em R com Serviços de Machine Learning de Base de Dados Azure SQL (pré-visualização)](clustering-model-build-tutorial.md)
