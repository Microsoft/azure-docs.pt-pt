...
> [!IMPORTANT]
> Não  edite os dados na base de dados do catálogo por acesso direto! As atualizações diretas não são suportadas devido ao elevado risco de corrupção de dados. Em vez disso, edite os dados de mapeamento utilizando apenas as APIs EDCL.
