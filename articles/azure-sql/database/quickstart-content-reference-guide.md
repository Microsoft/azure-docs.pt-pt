...
- [Fornecimento de uma base de dados na Base de Dados SQL para armazenar dados de aplicações](/learn/modules/provision-azure-sql-db/)
- [Desenvolver e configurar uma aplicação ASP.NET que consulta uma base de dados na Base de Dados Azure SQL](/learn/modules/develop-app-that-queries-azure-sql/)
- [Proteja a sua base de dados na Base de Dados Azure SQL](/learn/modules/secure-your-azure-sql-database/)
