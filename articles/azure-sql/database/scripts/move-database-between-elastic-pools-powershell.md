---
title: 'PowerShell: Mover base de dados entre piscinas elásticas'
description: Script de exemplo Azure PowerShell para mover uma base de dados na Base de Dados SQL entre duas piscinas elásticas usando powerShell.
...
Este exemplo de script powerShell cria duas piscinas elásticas e move uma base de dados na Base de Dados SQL de uma piscina elástica para outra piscina elástica, e depois move uma base de dados de uma piscina elástica para um único tamanho de computação de base de dados.
