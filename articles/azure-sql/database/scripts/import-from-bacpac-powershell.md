---
title: 'PowerShell: Importar um ficheiro BACPAC para uma nova base de dados na Base de Dados Azure SQL'
description: Azure PowerShell exemplo script para importar um ficheiro BACPAC em uma base de dados na Base de Dados SQL
...
ms.locfileid: "91319491"
---
# <a name="use-powershell-to-import-a-bacpac-file-into-a-database-in-sql-database"></a>Utilize o PowerShell para importar um ficheiro BACPAC numa base de dados na Base de Dados SQL
[!INCLUDE[appliesto-sqldb](../../includes/appliesto-sqldb.md)]

Este exemplo de script Azure PowerShell importa uma base de dados de um ficheiro BACPAC para uma nova base de dados na Base de Dados SQL.  
...
| [Novo AzSqlDatabaseImport](/powershell/module/az.sql/new-azsqldatabaseimport) | Importa um ficheiro BACPAC e cria uma nova base de dados no servidor. |
