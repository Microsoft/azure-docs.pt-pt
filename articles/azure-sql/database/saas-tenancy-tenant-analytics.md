...
- Foi criada uma conta de trabalho e uma base de dados de contas de trabalho. Consulte os passos adequados no tutorial de [**gestão de Schema.**](./saas-tenancy-schema-management.md#create-a-job-agent-database-and-new-job-agent)
