...
3. Inicie sessão na IU da Web do dispositivo virtual. A palavra-passe predefinida é *Palavra-passe1*. 
...
6. No painel esquerdo, selecione **as definições cloud** e, em seguida, ative o seu dispositivo com o serviço Data Box Gateway no portal Azure.
    ...
    4. Pode ter de aguardar vários minutos até a atualização ser concluída com êxito. Quando a atualização estiver concluída, inicie sessão no dispositivo. A **Cloud configura** atualizações de página para indicar que o dispositivo está ativado com sucesso.
