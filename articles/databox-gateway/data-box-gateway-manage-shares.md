...
1. No portal Azure, aceda ao seu recurso Data Box Gateway e, em seguida, navegue **para a Visão Geral**. Clique em **+ Adicionar partilha** na barra de comando.
...
7. Clique em **Criar** para criar a partilha. Será notificado de que a criação da partilha está em curso. Após a criação da partilha com as definições especificadas, a lâmina **de partilha** atualiza-se para refletir a nova ação.
