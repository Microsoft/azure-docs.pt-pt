...
Sim. Serviço em nuvem blocos de "teste" pode ser configurado no Traffic Manager como pontos finais externos. Verificações de estado de funcionamento são continua a ser cobrado à tarifa de pontos finais do Azure.
...
### <a name="i-stopped-an-web-application-endpoint-in-my-traffic-manager-profile-but-i-am-not-receiving-any-traffic-even-after-i-restarted-it-how-can-i-fix-this"></a>Parado a um ponto final da aplicação web no meu perfil do Gestor de tráfego, mas não estou a receber qualquer tráfego, mesmo depois de eu reiniciado-lo. Como posso corrigir esta situação?

Quando um ponto final da aplicação web do Azure está parado o Gestor de tráfego para a verificação de seu estado de funcionamento e reinicia as verificações de estado de funcionamento apenas depois de detetar que o ponto final tem de ser reiniciados. Para evitar este atraso, desativar e reativar, em seguida, o ponto de extremidade no perfil do Gestor de tráfego depois de reiniciar o ponto final.
