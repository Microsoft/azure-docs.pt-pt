...
## <a name="priority-traffic-routing-method"></a>Método de roteamento de tráfego prioritário
...
* Migração de aplicativo para o Azure: Crie um perfil com pontos de extremidade externos e do Azure. Ajuste o peso dos pontos de extremidade para preferir os novos pontos de extremidade.
