...
**Orientação**: Azure Traffic Manager suporta a autenticação SSO com diretório Azure Ative (Azure AD). Reduza o número de identidades e credenciais que os utilizadores devem gerir, permitindo sSO para o serviço com as identidades pré-existentes da sua organização.
...
- [Como implementar gestão de identidade privilegiada](/azure/active-directory/privileged-identity-management/pim-deployment-plan)
