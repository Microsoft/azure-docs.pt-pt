...
Agora, para adicionar um runbook à conta de automação, selecione **Runbooks** no menu esquerdo. **Selecione Adicione um livro de execução** no menu e siga as instruções para criar um livro de bordo [PowerShell](../automation/automation-first-runbook-textual-powershell.md).
