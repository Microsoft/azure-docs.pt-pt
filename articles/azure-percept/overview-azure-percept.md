...
ms.locfileid: "103490114"
---
# <a name="introduction-to-azure-percept"></a>Introdução a Azure Percept

Azure Percept é uma família de hardware, software e serviços projetados para acelerar a transformação do negócio usando IoT e IA no limite. Azure Percept cobre a pilha completa de silício a serviços para resolver os desafios de integração da IA de borda em escala.  

Os desafios de integração que se enfrentam ao tentar implementar soluções de IA de ponta em escala podem ser resumidos em três pontos importantes de atrito:
...
3. Serviços e fluxos de trabalho para acelerar o modelo de IA de borda e desenvolvimento de soluções.
    ...
    - Serviços de gestão de dispositivos para escala.
    - Segurança de ponta a ponta.

## <a name="next-steps"></a>Passos seguintes

Começa com [o Azure Percept DK.](./overview-azure-percept-dk.md) 
