...
Além disso, reveja a lista de [ligações utilizadas pela Azure IoT Edge](../iot-edge/production-checklist.md#allow-connections-from-iot-edge-devices).
