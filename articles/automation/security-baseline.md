...
* [Realize deteção de intrusão de rede com o Network Watcher e ferramentas open source](https://docs.microsoft.com/azure/network-watcher/network-watcher-intrusion-detection-open-source-tools)
...
* [Reencaminhar dados de tarefa da Automatização do Azure para os registos do Azure Monitor](https://docs.microsoft.com/azure/automation/automation-manage-send-joblogs-log-analytics)

* [Integre o DSC com registos do Monitor Azure](https://docs.microsoft.com/azure/automation/automation-dsc-diagnostics)

* [Regiões suportadas para a área de trabalho do Log Analytics ligada](https://docs.microsoft.com/azure/automation/how-to/region-mappings)

* [Registos de gestão de atualização de consulta](https://docs.microsoft.com/azure/automation/automation-update-management-query-logs)
...
* [Configure o nível de recolha de dados dentro do Azure Security Center](https://docs.microsoft.com/azure/security-center/security-center-enable-data-collection#data-collection-tier)
...
* [Compreenda as consultas de registo no Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/log-query/get-started-portal)
...
* [Como alertar os dados de registo do Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/learn/tutorial-response)
...
* [Eliminar uma conta Run As ou Run As Clássica](https://docs.microsoft.com/azure/automation/manage-runas-account#delete-a-run-as-or-classic-run-as-account)

* [Gerir uma execução de automação Azure Como conta](https://docs.microsoft.com/azure/automation/manage-runas-account)
...
* [Utilizar o Azure AD para autenticar no Azure](https://docs.microsoft.com/azure/automation/automation-use-azure-ad)
...
* [Gerir permissões e segurança de funções](https://docs.microsoft.com/azure/automation/automation-role-based-access-control)
...
* [Variáveis geridas na Azure Automation](https://docs.microsoft.com/azure/automation/shared-resources/variables)
...
* [Recomendações de segurança no Centro de Segurança do Azure](https://docs.microsoft.com/azure/security-center/security-center-recommendations)

* [Referência de recomendação do Centro de Segurança](https://docs.microsoft.com/azure/security-center/recommendations-reference)
...
* [Gestão de Atualização em Azure](https://docs.microsoft.com/azure/automation/automation-update-management)
...
* [Amostra de política Azure incorporada para a Azure Automation](https://docs.microsoft.com/azure/automation/policy-samples)
...
* [Gerir módulo em Azure Automation](https://docs.microsoft.com/azure/automation/shared-resources/modules)
...
* [Visão geral da Firewall de Azure](https://docs.microsoft.com/azure/firewall/overview)

* [Visão geral do firewall de aplicação web Azure](https://docs.microsoft.com/azure/web-application-firewall/overview)
...
* [Utilizar a integração do controlo de código fonte](https://docs.microsoft.com/azure/automation/source-control-integration)

* [Informação sobre a criação de modelos do Gestor de Recursos Azure](https://docs.microsoft.com/azure/azure-resource-manager/templates/quickstart-create-templates-use-the-portal)

* [Como configurar e gerir a Política de Azure](https://docs.microsoft.com/azure/governance/policy/tutorials/create-and-manage)

* [Compreender efeitos da política do Azure](https://docs.microsoft.com/azure/governance/policy/concepts/effects)

* [Implementar uma Conta de Automação utilizando um modelo de Gestor de Recursos Azure](https://docs.microsoft.com/azure/automation/automation-create-account-template#deploy-the-template)
...
* [Referência do modelo do Gestor de Recursos Azure para os recursos da Azure Automation](https://docs.microsoft.com/azure/templates/microsoft.automation/allversions)

* [Criar uma conta de Automação utilizando um modelo de Gestor de Recursos Azure](https://docs.microsoft.com/azure/automation/automation-create-account-template)
