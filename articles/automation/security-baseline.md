...
- [Implementar uma Conta de Automação utilizando um modelo de Gestor de Recursos Azure](/azure/automation/quickstart-create-account-template#deploy-the-template)
