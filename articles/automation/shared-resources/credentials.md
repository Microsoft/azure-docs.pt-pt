...
| Cmdlets | Descrição |
|:--- |:--- |
| [Get-AzureRmAutomationCredential](/powershell/module/azurerm.automation/get-azurermautomationcredential) |Obtém informação sobre um recurso de credencial. Isso não retorna um objeto PSCredential.  |
...
> [!NOTE]
> **Get-AzureRmAutomationCredential** não devolve um **PSCredential** que podem ser utilizados para autenticação. Apenas fornece informações sobre a credencial. Se precisar de utilizar uma credencial num runbook tem de utilizar o **Get-AutomationPSCredential** para obter o **PSCredential** objeto.
