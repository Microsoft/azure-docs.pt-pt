...
Também pode utilizar uma atividade [InlineScript.](automation-powershell-workflow.md#inlinescript) `InlineScript`permite-lhe executar blocos de código noutro computador com credenciais.
