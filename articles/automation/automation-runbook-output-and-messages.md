...
Uma observação sobre o comportamento do controle de tipo de saída. Quando você digita um valor no campo tipo de saída na folha Propriedades de entrada e saída, você precisa clicar fora do controle depois de digitá-lo para que sua entrada seja reconhecida pelo controle.  
