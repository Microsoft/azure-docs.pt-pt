...
Para nós Azure, pode corrigir a deriva do portal Azure ou utilizando cmdlets de módulo Az. Os detalhes sobre este processo estão documentados em máquinas de [embarque para gestão pela Configuração do Estado da Automação Azure](automation-dsc-onboarding.md#enable-a-vm-using-azure-portal).
