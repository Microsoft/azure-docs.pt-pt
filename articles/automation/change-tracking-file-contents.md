...
description: Utilize a função de alteração de conteúdo de ficheiro do rastreio de alteração para visualizar o conteúdo de um ficheiro que tenha mudado.
services: automation
...
* [O Rastreio de Alterações](automation-change-tracking.md) está ativado na sua Conta de Automação.
...
1. Na página **'Definições** de **'Definições**de Alteração', selecione **ficheiros Windows** ou separador **Ficheiros Linux** e clique em **Adicionar**
...
1. Na página de dados da **Alteração,** vê a informação padrão antes e depois do ficheiro, na parte superior à esquerda, clique em **Ver Alterações** de Conteúdo de Ficheiros para ver o conteúdo do ficheiro.
