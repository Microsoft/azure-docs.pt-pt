---
title: Configure dados à escala para a configuração do Estado da Automação Azure
description: Este artigo diz como configurar dados à escala para a Configuração do Estado da Automação Azure.
