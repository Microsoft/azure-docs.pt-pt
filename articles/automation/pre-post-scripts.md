...
Selecionando a execução da implantação de atualização, são mostrados detalhes adicionais para os scripts anteriores e posteriores. Um link para a origem do script no momento da execução é fornecido.
