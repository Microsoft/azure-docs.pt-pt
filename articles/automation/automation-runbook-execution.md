...
> [!NOTE]
> A hora local do processo de sandbox do Azure é definida como hora UTC. Cálculos de data e hora em seus runbooks tem de ter isto em consideração.
