...
ms.locfileid: "83749173"
---
# <a name="enable-change-tracking-and-inventory-from-a-runbook"></a>Ativar o rastreio de alterações e o inventário a partir de um livro de execução
...
* [Agendar livros de execução](automation-schedules.md)
