...
1. Assim que o estado do livro de execução mostrar concluído, clique em **Saída**. A página Saída está aberta, `Hello World` onde pode ver a sua mensagem.
