...
As contas Classic Run As não são criadas por padrão quando cria uma conta Azure Automation. Se necessitar de uma conta Classic Run As para gerir os recursos clássicos do Azure, execute os seguintes passos:
...
* Para começar com os livros python 3, consulte [Tutorial: Crie um livro de bordo Python 3](learn/automation-tutorial-runbook-textual-python-3.md).
* Para obter uma referência de cmdlet PowerShell, consulte [Az.Automation](/powershell/module/az.automation&preserve-view=true#automation).
