...
Antes de remover a Gestão de Atualização, tem de parar primeiro de gerir os seus VMs. Consulte [os VMs removidos da Gestão de Atualização](update-mgmt-remove-vms.md) para os desenrolar da funcionalidade.
...
3. Na página do **espaço de trabalho Unlink,** selecione **o espaço de trabalho Unlink** e responda às solicitações.
   ...
   ![Desvincular a página do espaço de trabalho](media/update-mgmt-remove-feature/automation-unlink-workspace-blade.png)
...
Para reequiparar esta funcionalidade, consulte [Ativar a Gestão de Atualização a partir de uma conta de Automação](update-mgmt-enable-automation-account.md), Ative a Gestão de [Atualização navegando no portal Azure](update-mgmt-enable-portal.md), [Ativar a Gestão de Atualização a partir de um runbook](update-mgmt-enable-runbook.md)ou [ativar a gestão de atualização a partir de um VM Azure](update-mgmt-enable-vm.md).
