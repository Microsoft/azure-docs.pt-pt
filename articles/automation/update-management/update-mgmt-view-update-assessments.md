...
![Atualizações em falta](./media/update-mgmt-view-update-assessments/automation-view-update-assessments-missing-updates.png)
...
A próxima fase do processo é [implementar atualizações](update-mgmt-deploy-updates.md) em máquinas não conformes e rever os resultados da implementação.
