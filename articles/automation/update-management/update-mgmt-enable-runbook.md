...
ms.locfileid: "91854819"
---
# <a name="enable-update-management-from-a-runbook"></a>Ativar a Gestão de Atualizações a partir de um runbook

Este artigo descreve como pode utilizar um livro de bordo para ativar a funcionalidade [de Gestão](update-mgmt-overview.md) de Atualização para VMs no seu ambiente. Para ativar os VMs Azure em escala, tem de ativar um VM existente com a Gestão de Atualização.
...
3. Selecione o espaço de trabalho 'Log Analytics' e, em seguida, clique em **Ativar**. Enquanto a Gestão de Atualização está a ser ativada, é mostrado um banner.
    ...
    ![Ativar a Gestão de Atualizações](media/update-mgmt-enable-runbook/enable-update-management.png)
...
3. Escolha o VM da lista e clique **em Configurar** o VM para gestão.
   ...
   ![Ativar a gestão de atualização para VM](media/update-mgmt-enable-runbook/enable-update-management-vm.png)
...
5. Clique **em OK** para importar o livro de bordo para a conta Automation.
   ...
   ![Livro de importação para configuração](media/update-mgmt-enable-runbook/import-from-gallery.png)
...
1. Abra o **manual enable-multipleSolution.**
   ...
   ![Livro de corridas de solução múltipla](media/update-mgmt-enable-runbook/runbook-overview.png)
