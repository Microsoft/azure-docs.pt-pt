...
ms.locfileid: "87450668"
---
# <a name="enable-update-management-from-a-runbook"></a>Ativar a Gestão de Atualizações a partir de um runbook

Este artigo descreve como pode utilizar um livro de bordo para ativar a funcionalidade [de Gestão](update-mgmt-overview.md) de Atualização para VMs no seu ambiente. Para ativar os VMs Azure em escala, tem de ativar um VM existente utilizando a Gestão de Atualização. 
...
2. Selecione o espaço de trabalho 'Log Analytics' e, em seguida, clique em **Ativar**. Enquanto a Gestão de Atualização está a ser ativada, é mostrado um banner azul.
    ...
    ![Ativar a Gestão de Atualizações](media/update-mgmt-enable-runbook/update-onboard.png)
...
3. Escolha o VM da lista e clique **em Ativar** a configuração do VM para atualizações.
   ...
   ![Ativar a gestão de atualização para VM](media/update-mgmt-enable-runbook/enable-update.png)
