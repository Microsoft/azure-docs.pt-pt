...
![Selecione scripts](./media/update-mgmt-pre-post-scripts/select-scripts.png)
...
![Resultados de execução de implementação](./media/update-mgmt-pre-post-scripts/deployment-run.png)
...
* Para obter detalhes sobre a gestão da atualização, consulte [Gerir atualizações e patches para os seus VMs](update-mgmt-manage-updates-for-vm.md).
