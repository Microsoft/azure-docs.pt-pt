...
2. Utilize as caixas de verificação para escolher os VMs para adicionar à Gestão de Atualização. Pode adicionar máquinas para até três grupos de recursos diferentes de cada vez. Os VMs Azure podem existir em qualquer região, independentemente da localização da sua conta Automation.
    ...
    ![Lista de VMs](media/update-mgmt-enable-portal/vmlist.png)
    ...
    [![Ativar a gestão de atualização](./media/update-mgmt-enable-portal/onboard-feature.png)](./media/update-mgmt-enable-portal/onboard-feature-expanded.png#lightbox)
...
5. Um espaço de trabalho e uma conta de Automação do Log Analytics existentes são selecionados por padrão. Se pretender utilizar um espaço de trabalho e uma conta de automação do Log Analytics diferente, selecione **CUSTOM** para selecioná-los na página de Configuração Personalizada. Ao escolher um espaço de trabalho Log Analytics, é feito um cheque para determinar se está ligado a uma conta Demômpa. Se for encontrada uma conta de Automação ligada, vê o seguinte ecrã. Quando terminar, selecione **OK**.
    ...
    [![Selecione espaço de trabalho e conta](./media/update-mgmt-enable-portal/select-workspace-and-account.png)](./media/update-mgmt-enable-portal/select-workspace-and-account-expanded.png#lightbox)
...
6. Se o espaço de trabalho selecionado não estiver ligado a uma conta Demôm automação, vê o seguinte ecrã. Selecione uma conta Dem automação e selecione **OK** quando terminar.
    ...
    ![Sem espaço de trabalho](media/update-mgmt-enable-portal/no-workspace.png)
