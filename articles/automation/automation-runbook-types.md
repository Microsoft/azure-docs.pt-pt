...
| [Fluxo de Trabalho do PowerShell](#powershell-workflow-runbooks)|Runbook de texto baseado no fluxo de trabalho do Windows PowerShell. |
...
* O runbook é iniciado mais rapidamente do que os runbooks do fluxo de trabalho do PowerShell, pois ele não precisa ser compilado antes da execução.
...
* O runbook leva mais tempo para iniciar do que os runbooks do PowerShell, pois ele precisa ser compilado antes da execução.
