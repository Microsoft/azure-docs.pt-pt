...
* O runbook deve lidar com a complexidade adicional do fluxo de trabalho do PowerShell, como [objetos](automation-powershell-workflow.md#code-changes)desserializados.
