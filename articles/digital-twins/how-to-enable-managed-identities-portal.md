---
title: Ativar uma identidade gerida para eventos de encaminhamento (pré-visualização) - portal
titleSuffix: Azure Digital Twins
description: Veja como ativar uma identidade atribuída ao sistema para Azure Digital Twins e use-a para encaminhar eventos, utilizando o portal Azure.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
