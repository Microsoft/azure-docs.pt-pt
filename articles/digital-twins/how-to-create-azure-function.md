...
Pode escrever uma função Azure adicionando SDK à sua aplicação de função. A aplicação de função interage com a Azure Digital Twins utilizando o [Azure Digital Twins SDK para .NET (C#)](https://www.nuget.org/packages/Azure.DigitalTwins.Core). 
