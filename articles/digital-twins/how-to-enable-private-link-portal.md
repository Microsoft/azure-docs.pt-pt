---
title: Permitir o acesso privado com Link Privado (pré-visualização) - portal
titleSuffix: Azure Digital Twins
description: Veja como permitir o acesso privado a soluções Azure Digital Twins com Private Link, utilizando o portal Azure.
author: baanders
ms.author: baanders
ms.date: 1/25/2021
ms.topic: how-to
...
ms.locfileid: "100418259"
---
# <a name="enable-private-access-with-private-link-preview-azure-portal"></a>Permitir o acesso privado com Link Privado (pré-visualização): Portal Azure
...
Este artigo percorre o processo através do [**portal Azure**](https://portal.azure.com).
...
Ao utilizar o [portal Azure,](https://portal.azure.com)pode optar por ligar o Private Link com um ponto final privado para uma instância Azure Digital Twins como parte da configuração inicial da instância, ou capacitá-lo mais tarde num caso que já existe. 

Qualquer um destes métodos de criação dará as mesmas opções de configuração e o mesmo resultado final para o seu exemplo. Esta secção descreve como fazer cada um.
...
Nesta secção, você ativará o Private Link com um ponto final privado sobre um caso Azure Digital Twins que está atualmente a ser criado. Esta secção centra-se no passo de networking do processo de criação; para uma passagem completa da criação de um novo exemplo de Azure Digital Twins, consulte [*Como-a- Configurar um exemplo e autenticação*](how-to-set-up-instance-portal.md).
...
Nesta secção, você ativará Private Link com um ponto final privado para um caso Azure Digital Twins que já existe.
...
Este artigo mostra como atualizar o valor da bandeira da rede utilizando o [portal Azure](https://portal.azure.com). Para obter instruções sobre como fazê-lo com a ferramenta de comando Azure CLI ou ARMClient, consulte a [versão CLI](how-to-enable-private-link-cli.md) deste artigo.
