...
- Como [obter o ID de objeto para um principal de serviço](https://docs.microsoft.com/powershell/module/azurerm.resources/get-azurermadserviceprincipal).
