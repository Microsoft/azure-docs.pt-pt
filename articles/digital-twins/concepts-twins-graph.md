...
Aqui está um código de cliente exemplo que usa as [APIs DigitalTwins](/rest/api/digital-twins/dataplane/twins) para construir uma relação de um gémeo digital (o gémeo "source" ) para outro gémeo digital (o gémeo "alvo").
