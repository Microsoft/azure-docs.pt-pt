...
:::image type="content" source="media/how-to-integrate-logic-apps/create-logic-app.png" alt-text="A página 'Aplicações Lógicas' no portal Azure. Carregar no botão 'Adicionar'":::
