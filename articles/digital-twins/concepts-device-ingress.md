...
Para obter um guia passo a passo sobre como colocar dispositivos integrados, leia o [tutorial para implantar e configurar o digital gêmeos](tutorial-facilities-setup.md). Em um relance, as etapas são:
