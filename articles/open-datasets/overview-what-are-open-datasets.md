...
Com uma conta do Azure, que pode aceder a conjuntos de dados com o código de abrir ou através do Azure service interface. Os dados estão colocalizados com recursos de computação em nuvem do Azure para utilização na sua solução de machine learning.  
...
No entanto, não precisa de uma conta do Azure para aceder a conjuntos de dados abertos; eles podem ser acesso em qualquer ambiente de Python sem ou sem o Spark.
