...
Para obter mais informações, consulte a [aplicações de cliente do Azure Blockchain Workbench exemplo no GitHub](https://github.com/Azure-Samples/blockchain-devkit/tree/master/connect/mobile).
