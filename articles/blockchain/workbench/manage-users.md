...
5.  Complete the required fields for the new user. Selecione **Criar**.
...
10. Selecione **Atribuir**. The added users are displayed in the list with the administrator role assigned.
