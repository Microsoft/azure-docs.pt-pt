...
| Elemento | Descrição |
|---------|-------------|
| localização | Região onde criar o recurso do Inspetor |
...
| Elemento | Descrição |
|---------|-------------|
| localização | Região onde criar o recurso de aplicativo. |
...
| Parâmetro | Descrição |
|-----------|-------------|
| action | Use **Iniciar** para executar o Inspetor. |
...
| Parâmetro | Descrição |
|-----------|-------------|
| action | Use **parar** para interromper o Inspetor. |
