...
Nesta secção, utiliza o Código do Estúdio Visual para criar um projeto local de Funções Azure em JavaScript. Mais tarde neste artigo, publicará o seu código de função para Azure.
