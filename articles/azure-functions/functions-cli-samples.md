...
| [Criar uma aplicação de função Python e montar uma partilha de Ficheiros Azure](scripts/functions-cli-mount-files-storage-linux.md) | Ao montar uma parte na sua aplicação de função Linux, pode aproveitar os modelos de aprendizagem automática existentes ou outros dados nas suas funções. | 
...
| [Implementar a partir do Azure DevOps](scripts/functions-cli-create-function-app-vsts-continuous.md) | Crie uma aplicação de função que se desloque a partir de um repositório Azure DevOps.  |
