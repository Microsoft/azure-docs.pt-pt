---
title: Preços das Funções do Azure
description: Saiba como funciona a faturação para as Funções Azure.
...
ms.locfileid: "95002186"
---
# <a name="azure-functions-pricing"></a>Preços das Funções do Azure
