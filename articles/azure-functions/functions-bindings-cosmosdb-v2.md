...
[Ignorar os exemplos de Acionador](#trigger---c-attributes)
...
O exemplo a seguir mostra uma associação de gatilho Cosmos DB em um arquivo *Function. JSON* e uma [função Python](functions-reference-python.md) que usa a associação. A função grava mensagens de log quando Cosmos DB registros são adicionados ou modificados.
