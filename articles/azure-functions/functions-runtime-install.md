---
title: Instalação do Azure Functions Runtime
...
1. Navegue até o **portal de Azure Functions Runtime** como `https://<machinename>.<domain>/`.
...
1. Selecione a função gatilho de temporizador, no submenu à direita, nomeie sua função e altere a agenda para `*/5 * * * * *` (essa expressão cron faz com que a função de temporizador seja executada a cada cinco segundos) e clique em **criar**
