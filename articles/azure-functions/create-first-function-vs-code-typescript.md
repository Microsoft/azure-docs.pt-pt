...
Nesta secção, utiliza o Código do Estúdio Visual para criar um projeto local de Funções Azure no TypeScript. Mais adiante neste artigo, irá publicar o seu código de função no Azure. 
