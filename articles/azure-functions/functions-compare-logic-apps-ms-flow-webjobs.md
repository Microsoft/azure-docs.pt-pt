...
| --- | --- | --- |
|**[Modelo de aplicativo sem servidor](https://azure.microsoft.com/solutions/serverless/) com escala [automática](functions-scale.md#how-the-consumption-and-premium-plans-work)**|✔||
