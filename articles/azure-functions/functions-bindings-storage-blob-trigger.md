...
Aceder aos dados do blob através do parâmetro dactilografado como [InputStream](/python/api/azure-functions/azure.functions.inputstream). Consulte o exemplo do [gatilho](#example) para obter mais detalhes.
...
> [!TIP]
> Um nome de recipiente não pode conter uma placa no padrão de nome.
