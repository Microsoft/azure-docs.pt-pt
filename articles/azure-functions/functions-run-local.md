...
- From the [Portal do Azure], search for and select **Storage accounts**. 
...
| **`--additional-packages`** | List of packages to install when building native dependencies. Por exemplo: `python3-dev libevent-dev`. |
