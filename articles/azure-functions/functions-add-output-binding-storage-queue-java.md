...
Este artigo mostra-lhe como integrar a função que criou no [artigo de arranque anterior](./functions-create-first-azure-function-azure-cli.md?pivots=programming-language-java&tabs=bash,browser) com uma fila de Armazenamento Azure. A vinculação de saída que adiciona a esta função escreve dados de um pedido HTTP para uma mensagem na fila.
...
Antes de iniciar este artigo, complete os passos na [parte 1 do arranque rápido de Java.](./functions-create-first-azure-function-azure-cli.md?pivots=programming-language-java&tabs=bash,browser)
