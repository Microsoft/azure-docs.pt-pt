...
Se uma aplicação de função se reduzir para várias instâncias, apenas uma instância de uma função desencadeada pelo temporizador é executada em todas as instâncias.
