...
| Parâmetro        | Parameter Type  | Descrição |
|------------------|-----------------|-------------|
...
| Campo              | Parameter type  | Descrição |
|--------------------|-----------------|-------------|
...
| **`{content}`**    | Request content | Opcional. The JSON-formatted orchestrator function input. |
...
| Campo                  | Data type | Descrição |
|------------------------|-----------|-------------|
| **`instancesDeleted`** | número inteiro   | The number of instances deleted. For the single instance case, this value should always be `1`. |
...
| Campo                   | Data type | Descrição |
|-------------------------|-----------|-------------|
| **`instancesDeleted`**  | número inteiro   | The number of instances deleted. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Opcional. The reason for terminating the orchestration instance. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Opcional. The reason for rewinding the orchestration instance. |
...
| **`op`**          | Query string    | Opcional. The name of the user-defined operation to invoke. |
| **`{content}`**   | Request content | The JSON-formatted event payload. |
