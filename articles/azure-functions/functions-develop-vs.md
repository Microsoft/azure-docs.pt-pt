...
1. No **Explorador de Soluções**, clique com o botão direito do rato no nó do projeto e selecione **Adicionar** > **Novo item**. Select **Azure Function**, type a **Name** for the class, and click **Add**.
