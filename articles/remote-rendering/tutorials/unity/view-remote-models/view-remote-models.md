...
1. Adicione as suas credenciais de renderização remota Azure, o seu Domínio de Conta e o Domínio de Renderização Remota ao script do coordenador:\
