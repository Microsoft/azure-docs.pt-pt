...
> [!Note]
> Ao carregar um modelo de entrada, tem o cuidado de evitar nomes de ficheiros longos e/ou estruturas de pastas, de modo a evitar problemas de limite de comprimento do caminho do [Windows](https://docs.mxicrosoft.com/windows/win32/fileio/maximum-file-path-limitation) no serviço. 
