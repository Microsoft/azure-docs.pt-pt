...
Você pode [estender o tempo](../how-tos/session-rest-api.md#update-a-session) de arrendamento de uma sessão ativa, se se verificar que você precisa mais tempo.
