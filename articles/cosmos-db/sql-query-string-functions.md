---
title: Funções de corda na linguagem de consulta DB do Cosmos Azure
description: Saiba mais sobre as funções do sistema SQL de cordas em Azure Cosmos DB.
author: ginamr
...
As seguintes funções de escalar executam uma operação sobre um valor de entrada de corda e devolvem um valor de corda, numérico ou booleano:
