...
Para se conectar a um banco de dados Cosmos, você precisa da chave do banco de dados. Utilize o comando [az cosmosdb list-keys](/cli/azure/cosmosdb#az-cosmosdb-list-keys) para obter a chave primária.
