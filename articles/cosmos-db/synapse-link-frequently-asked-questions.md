...
No comunicado de pré-visualização pública, a Synapse Link é suportada pela API API AZure Cosmos DB SQL (Core) e para a API API AZure Cosmos para a MongoDB. 
