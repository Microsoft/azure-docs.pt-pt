...
|**Documentação da API**|[Documentação de referência da Python API](/python/api/overview/azure/cosmosdb)|
...
|**Plataforma suportada atual**|[Python 2.7](https://www.python.org/downloads/) ou [Python 3.6+](https://www.python.org/downloads/)|
