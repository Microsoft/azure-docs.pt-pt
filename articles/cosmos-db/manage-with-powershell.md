...
O seguinte guia descreve como usar o PowerShell para script e automatizar a gestão dos recursos API do Azure Cosmos DB Core (SQL), incluindo a conta Cosmos, base de dados, contentor e produção.
