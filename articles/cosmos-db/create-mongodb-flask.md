...
3. Em seguida, defina a variável de ambiente para a aplicação Flask com `set FLASK_APP=app.py`, `$env:FLASK_APP = app.py` para os editores de PowerShell, ou `export FLASK_APP=app.py` se estiver a utilizar um MAC. 
