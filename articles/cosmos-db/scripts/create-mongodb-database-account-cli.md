...
[!NOTE] Para saber mais sobre banco de dados e convenções de nomenclatura de contentor, veja [trabalhar com bancos de dados, contentores e itens no Azure Cosmos DB](../databases-containers-items.md).
