---
title: Roteiro PowerShell para atualizar RU/s em recursos API AZure Cosmos DB Cassandra
description: Saiba como usar um script PowerShell para atualizar a produção de um espaço-chave ou uma tabela em Azure Cosmos DB Cassandra API
author: markjbrown
...
ms.locfileid: "87506827"
---
# <a name="update-rus-for-a-keyspace-or-table-for-azure-cosmos-db---cassandra-api"></a>Atualizar RU/s para um espaço-chave ou tabela para Azure Cosmos DB - Cassandra API
