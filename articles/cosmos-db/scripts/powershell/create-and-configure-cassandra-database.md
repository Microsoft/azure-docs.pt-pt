---
title: O Azure PowerShell script-criar uma conta de API de Cassandra do Azure Cosmos DB
description: Script do Azure PowerShell de exemplo – criar uma conta de API de Cassandra do Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
