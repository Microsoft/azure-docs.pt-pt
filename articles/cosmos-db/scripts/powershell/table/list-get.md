...
| [Get-AzCosmosDBTable](/powershell/module/az.cosmosdb/get-azcosmosdbtable) | Lista tabela de tabelas tabela numa conta, ou obtém uma tabela API de tabela especificada numa Conta. |
