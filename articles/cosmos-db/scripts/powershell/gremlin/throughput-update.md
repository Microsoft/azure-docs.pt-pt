...
description: Azure PowerShell script - Azure Cosmos DB Update RU/s para Gremlin API
author: markjbrown
...
ms.locfileid: "87506701"
---
# <a name="update-rus-for-a-database-or-graph-for-azure-cosmos-db---gremlin-api"></a>Atualizar RU/s para uma base de dados ou gráfico para Azure Cosmos DB - Gremlin API
