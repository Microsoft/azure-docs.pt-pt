---
title: Azure PowerShell script – Azure Cosmos DB atualizar RU/s para API do MongoDB
description: Azure PowerShell script – Azure Cosmos DB atualizar RU/s para API do MongoDB
author: markjbrown
