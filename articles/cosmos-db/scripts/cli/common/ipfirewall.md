---
title: Crie uma conta Azure Cosmos com firewall IP
description: Crie uma conta Azure Cosmos com firewall IP
author: markjbrown
ms.author: mjbrown
...
---
# <a name="create-an-azure-cosmos-account-with-ip-firewall-using-azure-cli"></a>Crie uma conta Azure Cosmos com firewall IP usando o Azure CLI
...
> [!NOTE]
> Esta amostra demonstra a utilização de uma conta API SQL (Core). Para utilizar esta amostra para outras APIs, aplique o `ip-range-filter` parâmetro no script abaixo para `az cosmosdb account create` comandar o seu script específico da API.
