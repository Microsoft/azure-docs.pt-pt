---
title: Criar uma tabela de API de Tabela para Azure Cosmos DB
description: Criar uma tabela de API de Tabela para Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-using-azure-cli"></a>Criar uma conta e tabela do Azure Cosmos API de Tabela usando CLI do Azure
