...
6. Sobre o **NuGet** separador, selecione **procurar** na parte superior da janela e escreva **documentdb do azure** na caixa de pesquisa. Certifique-se de que o **incluir pré-lançamento** caixa de verificação.
