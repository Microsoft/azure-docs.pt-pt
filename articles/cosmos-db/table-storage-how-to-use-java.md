---
title: Usar o armazenamento de tabelas do Azure ou o Azure Cosmos DB API de Tabela do Java
...
* [API REST do armazenamento do Azure][Azure Storage REST API]
