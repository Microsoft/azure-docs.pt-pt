...
ms.locfileid: "99527830"
---
# <a name="configure-and-manage-continuous-backup-and-point-in-time-restore---using-azure-portal"></a>Configure e gerencie o backup contínuo e o ponto no tempo restauração - usando o portal Azure
...
1. Preencha os seguintes detalhes para restaurar:
   ...
   * **Localização** – Região de destino onde a conta é restaurada. A conta deve existir nesta região no momento determinado (por exemplo. Eua Ocidentais ou Leste dos EUA). Uma conta só pode ser restaurada às regiões em que a conta de origem existiu.
