...
|**Get started**|[Introdução ao SDK do .NET Azure Cosmos DB](sql-api-get-started.md)|
|**Tutorial do aplicativo Web**|[Desenvolvimento de aplicativos Web com Azure Cosmos DB](sql-api-dotnet-application.md)|
|**Estrutura com suporte atual**|[Microsoft .NET Framework 4.5](https://www.microsoft.com/download/details.aspx?id=30653)|
