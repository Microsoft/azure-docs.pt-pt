...
description: Saiba tudo sobre a API Java SQL Async e o SDK, incluindo datas de lançamento, datas de desativação e alterações feitas entre cada versão do SDK de Java assíncrono do SQL Azure Cosmos DB.
author: moderakh
...
O SDK Java assíncrono de API do SQL difere do SDK Java da API do SQL, fornecendo operações assíncronas com suporte da [biblioteca de sub-redes](https://netty.io/). O [SDK do Java da API do SQL](sql-api-sdk-java.md) pré-existente não oferece suporte a operações assíncronas. 
