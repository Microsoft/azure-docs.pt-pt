...
:::image type="content" source="./media/how-to-model-partition-example/V2-Q3.png" alt-text="Diagrama que mostra a consulta para listar as publicações de um utilizador em formato curto." border="false":::
...
:::image type="content" source="./media/how-to-model-partition-example/V2-Q6.png" alt-text="Diagrama que mostra a consulta para listar os posts mais recentes criados em formato curto." border="false":::
