---
title: Amostras Azure PowerShell para Azure Cosmos DB - Tabela API
description: Obtenha as amostras Azure PowerShell para executar várias tarefas comuns nas contas API de tabela de quadros AZure Cosmos
author: markjbrown
...
ms.locfileid: "85563837"
---
# <a name="azure-powershell-samples-for-azure-cosmos-db---table-api"></a>Amostras Azure PowerShell para Azure Cosmos DB - Tabela API

A tabela seguinte inclui links para provar scripts Azure PowerShell para Azure Cosmos DB para API de tabela.
...
|Tarefa | Description |
|---|---|
|[Criar uma conta e tabela](scripts/powershell/table/ps-table-create.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Cria uma conta e tabela Azure Cosmos. |
|[Listar ou obter tabelas](scripts/powershell/table/ps-table-list-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Lista ou arranja mesas. |
|[Obter RU/s](scripts/powershell/table/ps-table-ru-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Arranja RU/s para uma mesa. |
|[Atualizar RU/s](scripts/powershell/table/ps-table-ru-update.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Atualize RU/s para uma mesa. |
...
|[Bloquear recursos da supressão](scripts/powershell/table/powershell-table-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Evite que os recursos sejam eliminados com bloqueios de recursos. |
|||
