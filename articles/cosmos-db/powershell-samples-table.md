...
description: Obtenha as amostras Azure PowerShell para executar várias tarefas comuns nas contas API da tabela Azure Cosmos DB
author: markjbrown
...
A tabela seguinte inclui links para provar scripts Azure PowerShell para Azure Cosmos DB para API de Mesa.
...
| | |
|---|---|
|[Criar uma conta e uma tabela](scripts/powershell/table/ps-table-create.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Cria uma conta e mesa Azure Cosmos. |
|[Lista ou obter tabelas](scripts/powershell/table/ps-table-list-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Lista ou arranja mesas. |
|[Obter RU/s](scripts/powershell/table/ps-table-ru-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Pegue RU/s para uma mesa. |
|[Atualização RU/s](scripts/powershell/table/ps-table-ru-update.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Atualizar RU/s para uma mesa. |
