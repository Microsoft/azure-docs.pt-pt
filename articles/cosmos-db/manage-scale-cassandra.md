...
Para definir ou alterar a saída máxima (RUs) para escala automática utilizando o CQL, utilize o seguinte (substituindo o teclado/nome da tabela em conformidade):
