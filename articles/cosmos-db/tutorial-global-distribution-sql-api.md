...
O código a seguir mostra como definir localizações preferenciais com o SDK de Python:
...
## <a name="java-v2-sdk"></a>V2 do Java SDK

O código a seguir mostra como definir localizações preferenciais com o SDK Java:
