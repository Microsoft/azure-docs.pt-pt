...
|**Documentação da API** | [Documentação de referência da API de Java](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-cosmos/4.0.1-beta.3/index.html) |
