...
| **Controladores do cliente** | **CLI do Azure** | **API DE SQL** | **API do Azure Cosmos DB para Cassandra** | **API do Azure Cosmos DB para MongoDB** | **API do gremlin**|**API de Tabela** |
| --- | --- | --- | --- | --- | --- | --- |
| .NET | N/D | Sim | Sim | Sim | Sim | Não |
|Java|N/D|Sim|Sim|Sim|Sim|Não|
|Python|N/D|Sim|Sim|Sim|Sim|Não|
|JS/nó|N/D|Sim|Sim|Sim|Sim|Não|
