...
| **Op** | **Indefinido** | **Null** | **Rio Boolean** | **Number** | **String** | **Objeto** | **Matriz** |
|---|---|---|---|---|---|---|---|
...
| **Rio Boolean** | Indefinido | Indefinido | **Ok** | Indefinido | Indefinido | Indefinido | Indefinido |
