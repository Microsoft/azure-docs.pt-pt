...
Sim, esta ação é suportada. Pode encontrar detalhes sobre como permitir isso no [Uso do Emulador Azure Cosmos DB para desenvolvimento local e](local-emulator.md#cassandra-api) artigo de teste.
