...
|**Entrada**  |**Descrição**  |
|---------|---------|
| API |Escolha o tipo API da sua conta. |
...
Depois de preencher os dados necessários, **selecione Calcular**. O **separador Estimativa de Custos** mostra o custo total de armazenamento e produção a provisionada. Pode expandir o link 'Detalhes do **Show'** neste separador para obter a desagregação da produção necessária para diferentes pedidos CRUD. Sempre que alterar o valor de qualquer campo, **selecione Calcular** para re-calcular o custo estimado.

:::image type="content" source="./media/estimate-ru-with-capacity-planner/basic-mode.png" alt-text="Modo básico de planejador de capacidade" border="true":::

## <a name="estimate-provisioned-throughput-and-cost-using-advanced-mode"></a><a id="advanced-mode"></a>Estimativa de produção e custos previstos através do modo avançado
