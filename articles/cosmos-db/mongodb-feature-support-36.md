...
> [!NOTE]
> Este artigo é para a API da Azure Cosmos DB para o MongoDB 3.6. Para a versão MongoDB 4.0, consulte [as funcionalidades e sintaxe suportadas do MongoDB 4.0](mongodb-feature-support-40.md).
