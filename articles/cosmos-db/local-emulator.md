...
Se estiver a utilizar [API do Azure Cosmos DB para o MongoDB](mongodb-introduction.md), utilize a seguinte cadeia de ligação:
...
* [Instalar a CLI/CQLSH de Cassandra](https://cassandra.apache.org/download/)
...
* [Instalar o apache-tinkerpop-gremlin-consola-3.3.4](https://tinkerpop.apache.org/downloads.html)
...
| EnableMongoDbEndpoint | Permite que a API do MongoDB | CosmosDB.Emulator.exe /EnableMongoDbEndpoint | |
...
Não hesite em e-mail askcosmosdb@microsoft.com em qualquer altura ou por qualquer motivo.
