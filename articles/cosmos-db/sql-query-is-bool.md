---
title: IS_BOOL na linguagem de consulta do Azure Cosmos DB
...
ms.locfileid: "78303873"
---
# <a name="is_bool-azure-cosmos-db"></a>IS_BOOL (Azure Cosmos DB)
 Devolve um valor booleano indicando se o tipo da expressão especificada é um Boolean.  
...
## <a name="examples"></a>Exemplos
  ...
  O exemplo seguinte verifica objetos de JSON Boolean, número, corda, nulo, objeto, matriz e tipos indefinidos utilizando a `IS_BOOL` função.  
