---
title: Dados de primavera Azure Cosmos DB para notas e recursos de lançamento da API SQL
description: Saiba tudo sobre o Spring Data Azure Cosmos DB para a SQL API, incluindo datas de lançamento, datas de aposentadoria e alterações feitas entre cada versão do Azure Cosmos DB SQL Async Java SDK.
author: anfeldma-ms
...
ms.locfileid: "87854307"
---
# <a name="spring-data-azure-cosmos-db-for-core-sql-api-release-notes-and-resources"></a>Dados de primavera Azure Cosmos DB para Core (SQL) API: notas de lançamento e recursos
...
O Spring Data Azure Cosmos DB for Core (SQL) permite que os desenvolvedores utilizem a Azure Cosmos DB em aplicações primavera. A Spring Data Azure Cosmos DB expõe a interface de Dados da primavera para manipular bases de dados e coleções, trabalhar com documentos e emitir consultas. As APIs de Sincronização e Async (Reativa) são suportadas no mesmo artefacto Maven. 
...
> [!IMPORTANT]  
> Estas notas de lançamento são apenas para Azure Cosmos DB SQL API. 
>
