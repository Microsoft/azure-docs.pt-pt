---
title: Amostras azure PowerShell para Azure Cosmos DB - API Gremlin
description: Obtenha as amostras Azure PowerShell para executar várias tarefas comuns nas contas da API Da Azure Cosmos DB Gremlin
author: markjbrown
...
ms.locfileid: "80365720"
---
# <a name="azure-powershell-samples-for-azure-cosmos-db-gremlin-api"></a>Amostras azure PowerShell para API Azure Cosmos DB Gremlin

A tabela seguinte inclui links para provar scripts Azure PowerShell para Azure Cosmos DB para Gremlin API.
...
| | |
|---|---|
|[Criar uma conta, base de dados e gráfico](scripts/powershell/gremlin/ps-gremlin-create.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Cria uma conta Azure Cosmos, base de dados e gráfico. |
|[Lista ou obter bases de dados ou gráficos](scripts/powershell/gremlin/ps-gremlin-list-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Lista ou obter base de dados ou gráfico. |
|[Obter RU/s](scripts/powershell/gremlin/ps-gremlin-ru-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Obtenha RU/s para uma base de dados ou gráfico. |
|[Atualização RU/s](scripts/powershell/gremlin/ps-gremlin-ru-update.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Atualizar o RU/s para uma base de dados ou gráfico. |
