...
Os modelos do Gestor de Recursos Azure podem ser usados para obter rendimento de escala automática na base de dados ou recursos de nível de contentor para todas as APIs DB de Azure Cosmos. Consulte [os modelos do Azure Resource Manager para amostras do Azure Cosmos.](./templates-samples-sql.md)
