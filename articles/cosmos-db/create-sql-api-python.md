...
4. Na janela do terminal integrado, certifique-se de que está na pasta *azure-cosmos-db-python-start-start-start-starter.* Caso contrário, execute o seguinte comando para mudar para a pasta de exemplo. 
