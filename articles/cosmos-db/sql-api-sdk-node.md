...
|Documentação da API  |  [Documentação de referência javaScript SDK](https://docs.microsoft.com/javascript/api/%40azure/cosmos/?view=azure-node-latest)
