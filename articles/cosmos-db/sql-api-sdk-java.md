...
* Corrigiu um erro no manuseamento de uma consulta através do interop de serviço.

### <a name="260"></a><a name="2.6.0"></a>2.6.0
* Suporte adicional para consulta de feed de mudança a partir do momento.
