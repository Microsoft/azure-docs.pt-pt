...
- Obtenha referências para a utilização de anexos através [do .NET SDK v2 da Azure Cosmos DB](https://docs.microsoft.com/dotnet/api/microsoft.azure.documents.attachment?view=azure-dotnet)
- Obtenha referências para a utilização de anexos através [de Java SDK v2 da Azure Cosmos DB](https://docs.microsoft.com/java/api/com.microsoft.azure.documentdb.attachment?view=azure-java-stable)
