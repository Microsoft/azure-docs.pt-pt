...
A seguinte consulta devolve todos os nomes de elementos subordinados na família cujo `id` corresponde ao `WakefieldFamily`, ordenado pelo nível.
...
| **OP** | **Não definido** | **Null** | **Booleano** | **Número** | **String** | **Objeto** | **Matriz** |
|---|---|---|---|---|---|---|---|
