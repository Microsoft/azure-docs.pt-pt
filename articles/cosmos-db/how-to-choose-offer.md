---
title: Como escolher a oferta de produção certa em Azure Cosmos DB
description: Saiba como escolher entre a produção padrão (manual) a provisionada e a produção de escala automática para a sua carga de trabalho.
author: deborahc
...
Em seguida, determinar como a utilização normalizada varia ao longo do tempo. Se vir que a sua utilização normalizada é variável ou imprevisível, considere permitir a sua escala automática na sua base de dados ou no seu contentor. Em contraste, se for estável e previsível, considere permanecer na produção padrão (manual) a provisionada. 
...
:::image type="content" source="media/how-to-choose-offer/autoscale-metrics-azure-monitor.png" alt-text="Exemplo de carga de trabalho utilizando autoescala":::
