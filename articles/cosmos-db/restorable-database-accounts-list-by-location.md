---
title: Listar contas de base de dados ressuráveis por localização usando Azure Cosmos DB REST API
description: Lista todas as contas de base de dados DB do Azure Cosmos ressurráveis disponíveis na subscrição e numa região.
author: kanshiG
...
ms.locfileid: "99527902"
---
# <a name="list-restorable-database-accounts-by-location-using-azure-cosmos-db-rest-api"></a>Listar contas de base de dados ressuráveis por localização usando Azure Cosmos DB REST API

Lista todas as contas de base de dados DB do Azure Cosmos ressurráveis disponíveis na subscrição e numa região. Esta chamada requer `Microsoft.DocumentDB/locations/restorableDatabaseAccounts/read` permissão.
...
| propriedades.Restaurações restauradoras |[RestauradorLocationResource](#restorablelocationresource)[]| Lista das regiões onde a conta de base de dados pode ser restaurada. |
...
A resposta da operação List, que contém as contas de base de dados restauradoras e as suas propriedades.
...
* [Liste coleções restauradoras](restorable-database-accounts-list-by-location.md) em Azure Cosmos DB API para MongoDB usando REST API.
