...
- [Python 3.6+](https://www.python.org/downloads/) incluindo o instalador [de pacotes de pip.](https://pip.pypa.io/en/stable/installing/)
...
* O Gremlin `client` é rubricado na linha 155 em *connect.py*. Certifique-se de substituir `<YOUR_DATABASE>` e `<YOUR_CONTAINER_OR_GRAPH>` pelos valores do nome da base de dados da sua conta e nome do gráfico:
...
2. Abra o ficheiro *connect.py* e na linha 155 cole o valor URI `<YOUR_ENDPOINT>` aqui:
...
3. Vamos adicionar alguns utilizadores novos. Selecione o botão **Novo Vértex** para adicionar dados ao seu gráfico.
   ...
   :::image type="content" source="./media/create-graph-python/azure-cosmosdb-data-explorer-new-vertex.png" alt-text="A screenshot mostra o painel New Vertex onde pode introduzir valores.":::
