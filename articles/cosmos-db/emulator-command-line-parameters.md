---
title: Linha de comando e referência PowerShell para emulador DB Azure Cosmos
...
|---|---|---|---|
|[Sem argumentos] | Inicia o emulador Azure Cosmos com definições padrão. |Microsoft.Azure.Cosmos.Emulator.exe| |
