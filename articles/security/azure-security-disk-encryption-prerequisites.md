...
- Versões do Windows Server: Windows Server 2008 R2, Windows Server 2012, Windows Server 2012 R2 e superiores versões do Windows encontrado na galeria do Azure.
