---
title: Microsoft Threat Modeling Tool lança 11/1/2018
titleSuffix: Azure
...
Como originalmente notado nas notas de lançamento da [GA,](threat-modeling-tool-releases-71509112.md)lançámos uma atualização (7.1.51023.1) para a Ferramenta de Modelação de Ameaças da Microsoft que exigirá aos utilizadores da versão Preview (clientes de pré-visualização com versão < 7.1.50911.2) para fazer o upgrade para o lançamento da GA suportada. Esta versão não contém nenhuma nova funcionalidade ou correções.

- Os utilizadores da versão Preview descarregarão automaticamente a atualização quando o cliente for aberto. Se optar por não instalar a nova atualização, a versão 'Preview' da ferramenta encerrará.
