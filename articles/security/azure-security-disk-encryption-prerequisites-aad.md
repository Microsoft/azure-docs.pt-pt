...
3. Verifique se as versões instaladas dos módulos.
      ...
      ```
4. Inicie sessão no Azure com o [Connect-AzAccount](/powershell/module/az.profile/connect-azaccount) cmdlet.
