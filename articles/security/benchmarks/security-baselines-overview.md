...
As Linhas de Base de Segurança Azure ajudam-no a fortalecer a segurança dos nossos produtos através de funcionalidades melhoradas de ferramentas, rastreios e segurança e proporcionam-lhe uma experiência consistente ao garantir o seu ambiente.

As linhas de base de segurança do serviço Azure concentram-se em áreas de controlo centradas na nuvem. Estes controlos são consistentes com referências de segurança bem conhecidas, como os descritos pelo Center for Internet Security (CIS). As nossas linhas de base fornecem orientações para as áreas de controlo listadas no Ponto de Referência de [Segurança do Azure.](overview.md)
