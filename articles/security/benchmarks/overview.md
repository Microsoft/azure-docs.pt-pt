...
- Configuração Segura 
- Defesa contra Software maligno 
...
- **ID (s) de CIS**: a recomendação de parâmetro de comparação de CIS que corresponde a essa recomendação.  
...
- **Detalhes**: a lógica para a recomendação e links para orientação sobre como implementar a recomendação. Se a recomendação for suportada pela central de segurança do Azure, essas informações serão listadas aqui.  
