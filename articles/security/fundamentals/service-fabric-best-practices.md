...
Existe uma relação de certificado entre [o Azure Key Vault,](../../key-vault/general/security-features.md)o cluster de tecido de serviço, e o fornecedor de recursos que utiliza os certificados. Quando o cluster é criado, a informação sobre a relação com o certificado é armazenada num cofre chave.
