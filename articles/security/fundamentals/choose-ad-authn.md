...
|Existe um requisito de certificado SSL?|Não|Não|Sim|
|Existe uma solução de monitorização da saúde?|Não é necessário|Estatuto de agente fornecido pelo Centro de [Administração do Diretório Ativo azure](../../active-directory/hybrid/tshoot-connect-pass-through-authentication.md)|[Azure AD Connect Health](../../active-directory/hybrid/how-to-connect-health-adfs.md)|
