...
description: Saiba como a Microsoft funciona para proteger os datacenters do Azure. Os datacenters são geridos, monitorizados e administrados pelo pessoal de operações da Microsoft.
services: security
