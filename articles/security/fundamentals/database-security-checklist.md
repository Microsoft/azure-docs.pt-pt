---
title: Lista de segurança da base de dados Azure| Microsoft Docs
...
|<br>Encriptação de dados inativos| <ul><li>[Encriptação de dados transparentes,](../../azure-sql/database/transparent-data-encryption-tde-overview.md)quando os dados inativos são armazenados fisicamente em qualquer forma digital.</li></ul>|
|**Controlar Acesso**||  
