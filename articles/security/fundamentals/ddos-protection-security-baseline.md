...
description: Linha de base de segurança Azure para Azure DDoS Protection Standard
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 06/22/2020
...
A Linha de Base de Segurança Azure para a Norma de Proteção DDoS Azure contém recomendações que o ajudarão a melhorar a postura de segurança da sua implementação.
...
**Orientação**: Não aplicável; O Azure DDoS destina-se a ser ativado em redes virtuais que hospedam outros serviços, por si só é uma oferta central do Azure e a sua infraestrutura subjacente, incluindo networking, é totalmente gerida pela Microsoft.
...
**Orientação**: Não aplicável; A Microsoft mantém a fonte de tempo utilizada para os recursos Azure, como a Azure DDoS Protection.
...
* [Como configurar alertas para métricas de proteção do DDoS](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection#configure-alerts-for-ddos-protection-metrics)
...
**Orientação**: Não aplicável; A Azure DDoS Protection não processa nem produz registos relacionados com anti-malware.
...
**Orientação**: Não aplicável; A Azure DDoS Protection não processa nem produz registos relacionados com DNS.
...
* [Compreender permissões na proteção Azure DDoS](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection#permissions)
...
* [Informações sobre Azure DDos Protection API](https://docs.microsoft.com/rest/api/virtual-network/)
...
**Orientação**: Utilize uma estação de trabalho de acesso privilegiada (PAW) com autenticação multi-factor (MFA) ativada para iniciar sessão e configurar os seus pedidos de bloqueio de clientes Azure.
...
* [Como utilizar comentários de acesso a Azure AD](https://docs.microsoft.com/azure/active-directory/governance/access-reviews-overview)
...
**Orientação**: Esta recomendação não é aplicável à Proteção DDoS Azure.
...
**Orientação**: Não aplicável; o seu plano de Proteção DDoS será aprovisionado no grupo de recursos que definir. Não há nenhum ponto final público para proteger ou isolar.
...
**Orientação**: A Microsoft gere a infraestrutura subjacente à Proteção DDoS Azure e implementou rigorosos controlos para evitar a perda ou exposição dos dados dos clientes.
...
**Orientação**: Não aplicável; A Azure DDoS Protection não guarda os dados do cliente em repouso.
...
**Orientação**: Não aplicável; A proteção Azure DDoS não possui dados do cliente.
...
**Orientação**: Para trabalhar com planos de proteção DDoS, a sua conta deve ser atribuída à função de contribuinte de rede ou a uma função personalizada que seja atribuída a ações específicas.

* [Gerir o controlo de acesso baseado em funções na Proteção DDoS Azure](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection)
...
**Orientação**: Não aplicável; esta recomendação destina-se a recursos computacional. A Microsoft gere a infraestrutura subjacente à Azure DDoS Protection e implementou rigorosos controlos para evitar a perda ou exposição dos dados dos clientes.
...
**Orientação**: Não aplicável; A Azure DDoS Protection não detém dados do cliente.
...
**Orientação**: Utilize o Monitor Azure com o registo de atividade azure para criar alertas para quando ocorrerem alterações nos planos de proteção do Azure DDoS, bem como outros recursos críticos ou relacionados.
...
**Orientação**: Não aplicável; A Microsoft realiza uma gestão de vulnerabilidades nos sistemas subjacentes que suportam a Azure DDoS Protection.
...
**Orientação**: Não aplicável; para trabalhar com os planos de Proteção DDoS, a sua conta deve ser atribuída à função de contribuinte de rede ou a uma função personalizada que seja atribuída às ações apropriadas. Não existem senhas, segredos ou chaves necessárias para aceder à Proteção DDoS.
...
**Orientação**: Não aplicável; A Azure DDoS Protection não utiliza identidades geridas.
...
**Orientação**: Não aplicável; esta orientação destina-se a recursos computacional. O Microsoft Anti-malware é ativado no anfitrião subjacente que suporta os serviços Azure (por exemplo, Azure DDoS Protection), no entanto não funciona com conteúdo do cliente.
...
**Orientação**: Não aplicável; A Azure DDoS Protection em si não armazena os dados do cliente.
