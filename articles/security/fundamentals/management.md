...
* Aprovisione um [certificado de gestão do Azure](/previous-versions/azure/gg551722(v=azure.100)) no Gateway de RD, para que seja o único anfitrião autorizado a aceder ao portal do Azure.
