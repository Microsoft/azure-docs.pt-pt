...
>[!NOTE]
>Para obter mais detalhes sobre a autorização do Key Vault consulte a página do cofre da chave na documentação do [Cofre da Chave Azure](../../key-vault/general/security-features.md).
...
| **Análise**                    |                    |                    |                    |
| Azure Stream Analytics           | Yes                | Sim\*\*            | -                  |
...
| SAP HANA                         | Yes                | Yes                | -                  |
| Serviço de Aplicações                      | Yes                | Sim\*\*            | -                  |
| Automatização                       | Yes                | Sim\*\*            | -                  |
| Funções do Azure                  | Yes                | Sim\*\*            | -                  |
| Portal do Azure                     | Yes                | Sim\*\*            | -                  |
| Logic Apps                       | Yes                | Yes                | -                  |
| Aplicações geridas pelo Azure       | Yes                | Sim\*\*            | -                  |
| Service Bus                      | Yes                | Yes                | -                  |
...
| **Media**                        |                    |                    |                    |
| Serviços de Multimédia                   | Yes                | Yes                | Yes                |
| **Segurança**                     |                    |                    |                    |
...
| Avere vFXT                       | Yes                | -                  | -                  |
| Cache do Azure para Redis            | Yes                | N/A\*              | -                  |
