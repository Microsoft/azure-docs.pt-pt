...
- [Respondendo às ameaças de hoje](../../security-center/security-center-managing-and-responding-alerts.md): Ajuda a identificar ameaças ativas que visam os seus recursos Azure e fornece as informações necessárias para responder rapidamente.
