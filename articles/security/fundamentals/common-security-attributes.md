...
## <a name="app-serviceazureapp-serviceapp-service-security-attributes"></a>[Serviço de Aplicações](/azure/app-service/app-service-security-attributes)
...
| Criptografia em nível de coluna (serviços de dados do Azure)| N/A | |
| Chamadas de API criptografadas| Sim | As chamadas de gerenciamento para configurar o serviço de aplicativo ocorrem por meio de chamadas [Azure Resource Manager](/azure/azure-resource-manager/index) por HTTPS. |
