...
Para obter mais informações, consulte [os certificados Export PFX com chave privada.](azure-stack-edge-gpu-manage-certificates.md#export-certificates-as-pfx-format-with-private-key)

## <a name="next-steps"></a>Passos seguintes

[Use certificados com Azure Stack Edge Pro](azure-stack-edge-gpu-manage-certificates.md)

[Crie certificados para o seu Azure Stack Edge Pro utilizando a ferramenta Azure Stack Hub Readiness Checker](azure-stack-edge-gpu-create-certificates-tool.md)

[Certificados PFX de exportação com chave privada](azure-stack-edge-gpu-manage-certificates.md#export-certificates-as-pfx-format-with-private-key)

[Erros de certificado de resolução de problemas](azure-stack-edge-gpu-certificate-troubleshooting.md)