---
title: Notas de lançamento do Azure Stack Edge Pro 2012
description: Descreve questões e resoluções abertas críticas para o lançamento de Azure Stack Edge Pro em execução em 2012.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
Este artigo aplica-se ao lançamento do **Azure Stack Edge 2012** que mapeia para a versão do software número **2.2.1438.2470**.

## <a name="whats-new"></a>Novidades

As seguintes novas funcionalidades estão disponíveis no lançamento do Azure Stack Edge 2012. 
...
## <a name="known-issues-in-2012-release"></a>Temas conhecidos no lançamento de 2012

A tabela seguinte fornece um resumo de questões conhecidas no lançamento de 2012.
