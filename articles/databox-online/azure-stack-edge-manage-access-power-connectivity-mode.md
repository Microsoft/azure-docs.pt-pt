---
title: Acesso, potência e conectividade ao dispositivo Azure Stack Edge Microsoft Docs
description: Descreve como gerir o acesso, energia e modo de conectividade para o dispositivo Azure Stack Edge que ajuda a transferir dados para o Azure
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "82569618"
---
# <a name="manage-access-power-and-connectivity-mode-for-your-azure-stack-edge"></a>Gerencie o modo de acesso, potência e conectividade para o seu Azure Stack Edge

Este artigo descreve como gerir o modo de acesso, potência e conectividade para o seu Azure Stack Edge. Estas operações são realizadas através da UI web local ou do portal Azure.
...
Para o dispositivo Azure Stack Edge, `Microsoft.DataBoxEdge` deve ser registado. Para `Microsoft.DataBoxEdge`se registar, o administrador de subscrição deve executar o seguinte comando:
