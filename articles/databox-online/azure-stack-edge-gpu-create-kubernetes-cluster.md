...
5. Tem o ponto final da API de Kubernetes a partir da página **de Dispositivo** da web UI local. Para mais informações, consulte as instruções no [ponto final da API da Kubernetes](azure-stack-edge-gpu-deploy-configure-compute.md#get-kubernetes-api-endpoint)
