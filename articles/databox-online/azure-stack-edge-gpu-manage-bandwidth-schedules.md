...
2. No painel direito, selecione **+ Programação de adicionar**.
    ...
    ![Selecione largura de banda](media/azure-stack-edge-gpu-manage-bandwidth-schedules/add-schedule-1.png)
...
3. Em **Adicionar agenda**:
   ...
   5. Selecione **Adicionar**.
      ...
      ![Adicionar horário](media/azure-stack-edge-gpu-manage-bandwidth-schedules/add-schedule-2.png)
...
3. É criada uma agenda com os parâmetros especificados. Esta agenda é então apresentada na lista de agendas de largura de banda no portal.
    ...
    ![Lista atualizada de horários de largura de banda](media/azure-stack-edge-gpu-manage-bandwidth-schedules/add-schedule-3.png)
...
2. Na lista de horários de largura de banda, selecione um horário que pretende modificar.
   ...
   ![Selecione horário de largura de banda](media/azure-stack-edge-gpu-manage-bandwidth-schedules/modify-schedule-1.png)

3. Efetue as alterações pretendidas e guarde as alterações.

    ![Modificar utilizador](media/azure-stack-edge-gpu-manage-bandwidth-schedules/modify-schedule-2.png)

4. Depois de modificar a agenda, a lista de agendas é atualizada para refletir a agenda modificada.

    ![Modificar o utilizador 2](media/azure-stack-edge-gpu-manage-bandwidth-schedules/modify-schedule-3.png)
...
2. Na lista de agendas de largura de banda, selecione a agenda que pretende eliminar. Na **programação editar,** selecione **Delete**. Quando solicitado para confirmação, selecione **Sim**.
   ...
   ![Eliminar um utilizador](media/azure-stack-edge-gpu-manage-bandwidth-schedules/delete-schedule-2.png)
...
- Saiba como [gerir as ações.](azure-stack-edge-gpu-manage-shares.md)
