...
2. Quando solicitado para confirmação, selecione **Sim**.
    ...
    ![Selecione a tecla de armazenamento de sincronização 2](media/azure-stack-edge-j-series-manage-storage-accounts/sync-storage-key-2.png)
