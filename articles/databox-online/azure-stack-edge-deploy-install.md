---
title: Tutorial para instalar - Desembalar, rack, cabo Azure Stack Edge dispositivo físico [ Microsoft Docs
description: O segundo tutorial sobre a instalação do Azure Stack Edge envolve como desembalar, grelhar e cabo o dispositivo físico.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "82571001"
---
# <a name="tutorial-install-azure-stack-edge"></a>Tutorial: Instale a borda da pilha azure

Este tutorial descreve como instalar um dispositivo físico Azure Stack Edge. O procedimento de instalação envolve desembalar, montar o rack e cabor o dispositivo. 
...
* Completou todos os passos em [Prepare-se para implantar O Edge Azure Stack](azure-stack-edge-deploy-prep.md).
...
- Reveja os requisitos de networking para a implementação do Azure Stack Edge e configure a rede datacenter de acordo com os requisitos. Para mais informações, consulte os requisitos de [rede Azure Stack Edge](azure-stack-edge-system-requirements.md#networking-port-requirements).
...
3. Desembale a caixa. Depois de desembalar a caixa, certifique-se de que tem:
    - Um único dispositivo de borda de pilha de caixa Azure
    - Dois cabos de alimentação
    - Um conjunto de kit ferroviário
    - Um folheto de Informação de Segurança, Ambiente e Regulação

Se não recebeu todos os itens listados aqui, contacte o suporte azure Stack Edge. O próximo passo é montar o seu dispositivo.
...
> [!IMPORTANT]
> Os dispositivos Azure Stack Edge devem ser montados em rack para um bom funcionamento.
...
2. Duas correias de gancho e laço
    ...
    ![Identificar conteúdos de kits ferroviários](./media/azure-stack-edge-deploy-install/identify-rail-kit-contents.png)
...
4. Para retirar os trilhos, puxe o botão de desbloqueio do trinco no ponto médio da peça final e desencaixe cada trilho.
    ...
    ![Instalar e remover trilhos sem ferramentas](./media/azure-stack-edge-deploy-install/installing-removing-tool-less-rails.png)
...
4. Deslize os suportes traseiros esquerdo e direito para a frente contra as flanges verticais traseiras e prenda-os utilizando dois pares de parafusos.
    ...
    ![Instalar e remover trilhos tooled](./media/azure-stack-edge-deploy-install/installing-removing-tooled-rails.png)
...
4. Pressione os botões de bloqueio de desbloqueio de diapositivos em ambos os trilhos e deslize o sistema para dentro da prateleira.
    ...
    ![Instalar o sistema numa prateleira](./media/azure-stack-edge-deploy-install/installing-system-rack.png)
...
3. Para fixar o sistema de envio na cremalheira ou para outros ambientes instáveis, localize o parafuso de montagem em baixo de cada trinco e aperte cada parafuso com uma chave de fendas #2 Phillips.
    ...
    ![Engatar e soltar o trinco slam](./media/azure-stack-edge-deploy-install/engaging-releasing-slam-latch.png)


## <a name="cable-the-device"></a>Ligar o dispositivo

Encaminhe os cabos e, em seguida, envie o seu dispositivo. Os seguintes procedimentos explicam como cabo o seu dispositivo Azure Stack Edge para energia e rede.
...
> - O dispositivo Azure Stack Edge deve ser ligado à rede datacenter para que possa ingerir dados a partir de servidores de fonte de dados.
...
1. Identifique as várias portas no plano traseiro do seu dispositivo.
    ...
    ![Plano de volta de um dispositivo por cabo](./media/azure-stack-edge-deploy-install/backplane-cabled.png)
...
Neste tutorial, você aprendeu sobre tópicos de Azure Stack Edge como como:
...
> [Conecte e instale a borda da pilha azure](./azure-stack-edge-deploy-connect-setup-activate.md)
