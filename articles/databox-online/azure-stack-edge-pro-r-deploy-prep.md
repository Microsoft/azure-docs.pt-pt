---
title: Tutorial para preparar portal Azure, ambiente de datacenter para implantar Azure Stack Edge Pro R
description: O primeiro tutorial sobre a implementação do Azure Stack Edge Pro R envolve a preparação do portal Azure.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "106059866"
---
# <a name="tutorial-prepare-to-deploy-azure-stack-edge-pro-r"></a>Tutorial: Prepare-se para implementar Azure Stack Edge Pro R

Este tutorial é o primeiro da série de tutoriais de implementação que são necessários para implementar completamente Azure Stack Edge Pro R. Este tutorial descreve como preparar o portal Azure para implementar um recurso Azure Stack Edge. O tutorial utiliza um dispositivo Azure Stack Edge Pro R de 1 nó enviado com uma fonte de alimentação ininterrupta (UPS).
...
Para implementar Azure Stack Edge Pro R, consulte os seguintes tutoriais na sequência prescrita.

| Para fazer este passo | Utilizar estes documentos |
| --- | --- |
...
| **[Pré-requisitos de implantação](#prerequisites)** |Estes pré-requisitos validam o ambiente está pronto para ser implantado. |
|  | |
...
|**[6. Configurar as definições de segurança](azure-stack-edge-pro-r-deploy-configure-certificates-vpn-encryption.md)** |Configure certificados, VPN, encriptação em repouso para o seu dispositivo. Utilize certificados gerados pelo dispositivo ou traga os seus próprios certificados.   |
|**[7. Ativar o dispositivo](azure-stack-edge-pro-r-deploy-activate.md)** |Utilize a chave de ativação do serviço para ativar o dispositivo. O dispositivo está pronto para configurar ações SMB ou NFS ou ligar via REST. |
...
- Reveja as informações de segurança deste dispositivo em: [Diretrizes de segurança para o seu dispositivo Azure Stack Edge](azure-stack-edge-pro-r-safety.md).
...
- A rede no seu datacenter está configurada de acordo com os requisitos de rede para o seu dispositivo Azure Stack Edge. Para obter mais informações, consulte [os requisitos do sistema Azure Stack Edge Pro R](azure-stack-edge-pro-r-system-requirements.md).

- Para condições normais de funcionamento do seu dispositivo, tem:
...
4. Selecione o tipo de dispositivo. Em **Azure Stack Edge**, escolha **Azure Stack Edge Pro R** e, em seguida, escolha **Select**. Se vir algum problema ou não conseguir selecionar o tipo de dispositivo, aceda a [problemas de ordem de resolução de problemas](azure-stack-edge-troubleshoot-ordering.md).

    ![Criar um recurso 2](media/azure-stack-edge-pro-r-deploy-prep/create-resource-2.png)

5. Com base na necessidade do seu negócio, pode selecionar **um nó único do Azure Stack Edge Pro R** ou o nó único **Azure Stack Edge Pro R com UPS**.  
...
11. Selecione **Criar**.
    ...
    ![Vá ao recurso Azure Stack Edge Pro](media/azure-stack-edge-pro-r-deploy-prep/azure-stack-edge-resource-1.png)
...
1. Selecione o recurso que criou e **selecione Overview**.

2. No painel direito, forneça um nome para o Cofre da Chave Azure ou aceite o nome predefinido. O nome do cofre pode estar entre 3 e 24 caracteres.
...
> [Instalar borda de pilha de Azure](./azure-stack-edge-pro-r-deploy-install.md)
