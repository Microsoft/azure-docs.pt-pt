...
1. No portal Azure, aceda ao seu recurso Azure Stack Edge e, em seguida, vá aos **Utilizadores**. **Selecione + Adicione** o utilizador na barra de comando.
    ...
    ![Selecione adicionar utilizador](media/azure-stack-edge-gpu-manage-users/add-user-1.png)
...
2. Especifique o nome de utilizador e a palavra-passe do utilizador que pretende adicionar. Confirme a palavra-passe e **selecione Adicionar**.
    ...
    ![Especifique o nome de utilizador e a palavra-passe](media/azure-stack-edge-gpu-manage-users/add-user-2.png)
...
![Modificar utilizador](media/azure-stack-edge-gpu-manage-users/modify-user-1.png)
...
1. No portal Azure, aceda ao seu recurso Azure Stack Edge e, em seguida, vá aos **Utilizadores**.
    ...
    ![Selecione o utilizador para eliminar](media/azure-stack-edge-gpu-manage-users/delete-user-1.png)
...
2. Selecione um utilizador na lista de utilizadores e, em seguida, **selecione Delete**. Quando lhe for perguntado, confirme a eliminação.
    ...
    ![Selecione o utilizador para eliminar 2](media/azure-stack-edge-gpu-manage-users/delete-user-2.png)

A lista de utilizadores é atualizada para refletir o utilizador eliminado.

![Lista atualizada de utilizadores](media/azure-stack-edge-gpu-manage-users/delete-user-4.png)

## <a name="next-steps"></a>Passos seguintes

- Saiba como [Gerir a largura de banda](azure-stack-edge-gpu-manage-bandwidth-schedules.md).
