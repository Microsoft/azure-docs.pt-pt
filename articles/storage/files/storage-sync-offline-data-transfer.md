...
- Planeje sua topologia de Sincronização de Arquivos do Azure final: [Planejar uma implantação de Sincronização de Arquivos do Azure](storage-sync-files-planning.md)
