---
title: Criar uma conta de armazenamento do Azure filestorage
description: Neste artigo, saiba como criar um filestorage (pré-visualização) e uma partilha de ficheiros de premium.
services: storage
author: roygara
ms.service: storage
ms.topic: conceptual
