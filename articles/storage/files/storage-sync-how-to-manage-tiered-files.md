...
ms.locfileid: "102204429"
---
# <a name="how-to-manage-tiered-files"></a>Como gerir ficheiros hierárquicos

Este artigo fornece orientações para utilizadores que tenham dúvidas relacionadas com a gestão de ficheiros hierárquicos. Para questões conceptuais sobre o tiering de nuvens, consulte [a Azure Files FAQ](storage-files-faq.md).
