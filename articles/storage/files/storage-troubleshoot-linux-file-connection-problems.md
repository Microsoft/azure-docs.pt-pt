...
description: Problemas na resolução de problemas dos Ficheiros Azure em Linux
author: jeffpatt24
ms.service: storage
...
Para resolver o problema, utilize a [ferramenta de resolução de problemas para erros de montagem de Ficheiros Azure no Linux](https://gallery.technet.microsoft.com/Troubleshooting-tool-for-02184089). Esta ferramenta:
...
É possível que esteja a sofrer estrangulamentos e os seus pedidos estão a ser enviados para uma fila. Pode verificar isto aproveitando as [métricas de armazenamento Azure no Azure Monitor](../common/storage-metrics-in-azure-monitor.md).
