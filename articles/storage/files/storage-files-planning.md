...
Para obter mais informações sobre a cópia de segurança, consulte [a cópia de segurança do ficheiro Azure](../../backup/azure-file-share-backup-overview.md?toc=%252fazure%252fstorage%252ffiles%252ftoc.json).
