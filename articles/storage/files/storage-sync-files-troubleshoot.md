...
| 0x80c80283 | -2160591491 | ECS_E_ACCESS_DENIED_DFSRRO | O ficheiro encontra-se numa pasta de replicação apenas de leitura DFS-R. | O ficheiro está localizado numa pasta de replicação apenas de leitura DFS-R. O Azure File Sync não suporta pontos finais do servidor nas pastas de replicação só de leitura do DFS-R. Veja o [guia de planeamento](./storage-sync-files-planning.md#distributed-file-system-dfs) para obter mais informações. |
...
| 0x80070005 | -2147024891 | ERROR_ACCESS_DENIED | O ficheiro falhou no nível devido ao acesso a erro negado. Este erro poderá ocorrer se o ficheiro estiver localizado numa pasta de replicação só de leitura do DFS-R. | O Azure File Sync não suporta pontos finais do servidor nas pastas de replicação só de leitura do DFS-R. Veja o [guia de planeamento](./storage-sync-files-planning.md#distributed-file-system-dfs) para obter mais informações. |
...
| 0x80c80262 | -2134375838 | ECS_E_GHOSTING_UNSUPPORTED_RP | O ficheiro falhou porque é um ponto de reparse não suportado. | Se o ficheiro for um ponto de reanálise de Eliminação de Dados Duplicados, siga os passos no [guia de planeamento](./storage-sync-files-planning.md#data-deduplication) para ativar o suporte da Eliminação de Dados Duplicados. Os ficheiros com pontos de reanálise que não sejam de Eliminação de Dados Duplicados não são suportados e não serão colocados em camadas.  |
