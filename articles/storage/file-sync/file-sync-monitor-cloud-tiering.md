...
Para obter detalhes sobre os diferentes tipos de métricas para Azure File Sync e como usá-las, consulte [Monitor Azure File Sync](file-sync-monitoring.md).
...
Se quiser alterar a sua política de nivelamento em nuvem, consulte [as políticas de tiering de nuvens](file-sync-choose-cloud-tiering-policies.md).
