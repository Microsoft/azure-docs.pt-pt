...
Para obter mais exemplos sobre como a política de data e a política de espaço livre de volume funcionam em conjunto, consulte [as políticas de tiering de nuvem de sincronização de ficheiros Azure.](file-sync-choose-cloud-tiering-policies.md)

### <a name="windows-server-data-deduplication"></a>Deduplica de dados do Windows Server
A desduplicação de dados é suportada em volumes que tenham o tiering de nuvem ativado a partir do Windows Server 2016. Para mais detalhes, consulte [o Planeamento para uma implementação do Azure File Sync](file-sync-planning.md#data-deduplication).
...
Para obter mais detalhes sobre a recolha proativa, consulte [implementar o Sync de ficheiros Azure](file-sync-deployment-guide.md#proactively-recall-new-and-changed-files-from-an-azure-file-share).
...
* [Escolha as políticas de tiering de nuvem de sincronização de ficheiros Azure](file-sync-choose-cloud-tiering-policies.md)
