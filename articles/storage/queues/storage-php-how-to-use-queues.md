---
title: Como utilizar o armazenamento de filas do PHP - armazenamento do Azure
...
* Visite o [referência da API para a biblioteca de cliente PHP do armazenamento do Azure](https://azure.github.io/azure-storage-php/)
