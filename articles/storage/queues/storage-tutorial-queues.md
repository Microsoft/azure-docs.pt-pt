...
1. Instalar o **Windows Azure. Armazenamento** pacote para o projeto com o `dotnet add package` comando. Execute o seguinte comando do dotnet da pasta de projeto na janela da consola.
