...
O código a seguir cria `QueueService` um objeto usando o nome da conta de armazenamento e a chave de conta. Substitua *myaccount* e *MyKey* pelo nome e pela chave da sua conta.
