...
description: Saiba como usar o serviço Fila do Azure para criar e excluir filas e inserir, obter e excluir mensagens. Exemplos escritos em Java.
...
Nota: Está disponível um SDK para os programadores que utilizem o Armazenamento do Azure em dispositivos Android. Para obter mais informações, consulte o [SDK do armazenamento do Azure para Android][Azure Storage SDK for Android].
...
Neste guia, você usará os recursos de armazenamento que podem ser executados em um aplicativo Java localmente ou no código em execução dentro de uma função Web ou função de trabalho no Azure.
...
Um objeto **CloudQueueClient** permite que você obtenha objetos de referência para filas. O código a seguir cria um objeto **CloudQueueClient** . (Nota: Há maneiras adicionais de criar objetos **CloudStorageAccount** ; para obter mais informações, consulte **CloudStorageAccount** na [Azure Storage Client SDK Reference].)
