...
Obter uma lista de tabelas na conta de armazenamento através de [Get-AzStorageTable](/powershell/module/azure.storage/Get-AzureStorageTable).
...
Para efetuar operações numa tabela, precisa de uma referência para a tabela específica. Obter uma referência a utilizar [Get-AzStorageTable](/powershell/module/azure.storage/Get-AzureStorageTable).
