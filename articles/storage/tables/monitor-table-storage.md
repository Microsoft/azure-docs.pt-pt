...
O armazenamento da tabela Azure recolhe os mesmos tipos de dados de monitorização que outros recursos Azure, que são descritos em [dados de monitorização a partir de recursos Azure](../../azure-monitor/essentials/monitor-azure-resource.md#monitoring-data). 
...
Para obter mais informações sobre o arquivamento de registos de recursos para o Azure Storage, consulte [os registos de recursos do Azure](../../azure-monitor/essentials/resource-logs.md#send-to-azure-storage).
...
Para obter mais informações sobre o envio de registos de recursos para centros de eventos, consulte [registos de recursos do Azure](../../azure-monitor/essentials/resource-logs.md#send-to-azure-event-hubs).
...
Para obter uma lista de todas as métricas de suporte do Azure Monitor, que inclui o armazenamento da tabela Azure, consulte [as métricas suportadas pelo Monitor Azure.](../../azure-monitor/essentials/metrics-supported.md)
...
Para obter mais informações, consulte [os dados de monitorização do Stream Azure para o centro de eventos e parceiros externos.](../../azure-monitor/essentials/stream-monitoring-data-event-hubs.md)

Os dados são armazenados na tabela **StorageTableLogs.** 

#### <a name="sample-kusto-queries"></a>Experimente consultas kusto

Aqui ficam algumas consultas que pode introduzir na barra **de pesquisa log** para ajudá-lo a monitorizar o armazenamento da sua mesa. Estas consultas funcionam com a [nova linguagem.](../../azure-monitor/logs/log-query-overview.md)
