...
Para saber mais sobre como descarregar ficheiros específicos, consulte [Baixar ficheiros específicos](./storage-use-azcopy-blobs.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#download-specific-files).
