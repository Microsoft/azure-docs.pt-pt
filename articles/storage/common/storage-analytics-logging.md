...
Para obter informações sobre listar blobs através de programação, consulte [enumerar recursos do Blob](https://msdn.microsoft.com/library/azure/hh452233.aspx) e [definição e obter as propriedades e metadados para recursos Blob](https://msdn.microsoft.com/library/azure/dd179404.aspx).  
