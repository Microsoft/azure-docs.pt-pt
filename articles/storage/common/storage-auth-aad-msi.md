...
description: Saiba como usar identidades geridas para os recursos Azure para autorizar o acesso a dados de blob e fila a partir de aplicações em execução em máquinas virtuais Azure, apps de função, conjuntos de escala de máquinas virtuais, entre outros.
services: storage
author: tamram
ms.service: storage
ms.topic: how-to
...
### <a name="assign-role-based-access-control-rbac-roles-for-access-to-data"></a>Atribuir funções de controlo de acesso baseado em funções (RBAC) para acesso a dados
...
- [Executar comandos Azure CLI ou PowerShell com credenciais AD AD para aceder a dados de bolhas ou filas](authorize-active-directory-powershell.md).
