...
- [Autenticar o acesso a blobs do Azure e filas com o Azure Active Directory](storage-auth-aad.md)
- [Conceder acesso a contentores do Azure e filas com RBAC no portal do Azure](storage-auth-aad-rbac-portal.md)
