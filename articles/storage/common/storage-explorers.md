...
| Ferramenta de cliente do armazenamento do Azure                 | Plataformas suportadas | Blob de Blocos | Blob de Página | Acrescentar Blob | Tabelas | Filas | Ficheiros |
|-------------------------------------------|---------------------|------------|-----------|-------------|--------|--------|-------|
| [Azure portal](https://portal.azure.com)                    | Web                 | Sim          | Sim         | Sim           | Sim      | Sim      | Sim     |
| [Explorador do Armazenamento do Azure](https://azure.microsoft.com/features/storage-explorer/)          | Windows, OSX        | Sim          | Sim         | Sim           | Sim      | Sim      | Sim     |
