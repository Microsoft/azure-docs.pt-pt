...
- Registos de recursos, métricas e depósitos de colisões são apenas três exemplos de dados que podem ser escritos para uma partilha de ficheiros e processados ou analisados mais tarde.
