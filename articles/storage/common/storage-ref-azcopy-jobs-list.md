---
title: Lista de empregos azcopy [ lista de empregos azcopy ] Microsoft Docs
description: Este artigo fornece informações de referência para o comando da lista de empregos da azcopy.
author: normesta
ms.service: storage
ms.topic: reference
ms.date: 10/16/2019
...
ms.locfileid: "74037563"
---
# <a name="azcopy-jobs-list"></a>azcopy jobs list

Mostra informações sobre todos os trabalhos.
