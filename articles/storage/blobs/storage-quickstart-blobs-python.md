...
* Para saber mais, consulte as [bibliotecas de clientes do Azure Storage para Python.](/azure/developer/python/sdk/storage/overview?view=storage-py-v12)
