...
[Documentação de referência da API](/dotnet/api/azure.storage.blobs) | [código fonte da Biblioteca](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/storage/Azure.Storage.Blobs) | Pacote [(NuGet)](https://www.nuget.org/packages/Azure.Storage.Blobs) | [Amostras](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/storage/Azure.Storage.Blobs/samples)
