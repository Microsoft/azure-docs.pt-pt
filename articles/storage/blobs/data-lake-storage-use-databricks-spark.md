...
2. Para copiar dados da conta *. csv* , insira o comando a seguir.
   ...
   * Substitua o `<container-name>` espaço reservado por qualquer nome que você deseja dar ao seu contêiner.
