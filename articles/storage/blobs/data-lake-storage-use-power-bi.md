...
5. Na próxima caixa de diálogo, clique em **entrar** para entrar na sua conta de armazenamento. Você será redirecionado para a página de entrada da sua organização. Siga os prompts para entrar na conta.
    ...
    ![Página de início de sessão](media/data-lake-storage-use-power-bi/sign-in.png)
...
7. A próxima caixa de diálogo mostra todos os arquivos sob a URL fornecida na etapa 4 acima, incluindo o arquivo que você carregou em sua conta de armazenamento. Verifique as informações e clique em **carregar**.
    ...
    ![Sistemas de ficheiros](media/data-lake-storage-use-power-bi/file-systems.png)
...
10. No **Editor de consultas**, na coluna **conteúdo** , clique em **binário**. O arquivo será detectado automaticamente como CSV e você deverá ver uma saída, conforme mostrado abaixo. Seus dados agora estão disponíveis em um formato que você pode usar para criar visualizações.
...
13. Vamos criar um gráfico de pizza para representar os drivers em cada cidade para um determinado país. Para fazer isso, faça as seleções a seguir.
...
14. Ao selecionar um país específico nos filtros de nível de página, agora você pode ver o número de drivers em cada cidade do país selecionado. Por exemplo, na guia **visualizações** , em filtros de **nível de página**, selecione **Brasil**.

    ![Filtros de página](media/data-lake-storage-use-power-bi/page-filters.png)

15. O gráfico de pizza é atualizado automaticamente para exibir os drivers nas cidades do Brasil.

    ![Brasil](media/data-lake-storage-use-power-bi/pie-chart-updated.png)

16. No menu **arquivo** , clique em **salvar** para salvar a visualização como um arquivo de Power bi desktop.

## <a name="publish-report-to-power-bi-service"></a>Publicar relatório em serviço do Power BI

Depois de criar as visualizações no Power BI Desktop, você pode compartilhá-las com outras pessoas publicando-as no serviço do Power BI. Para obter instruções sobre como fazer isso, consulte [publicar de Power bi desktop](https://powerbi.microsoft.com/documentation/powerbi-desktop-upload-desktop-files/).
