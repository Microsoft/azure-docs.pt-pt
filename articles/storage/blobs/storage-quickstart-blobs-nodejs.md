...
> [!NOTE]
> Para começar a usar a versão anterior do SDK, consulte [início rápido: biblioteca de cliente do armazenamento de BLOBs do Azure para JavaScript](storage-quickstart-blobs-nodejs-legacy.md).
