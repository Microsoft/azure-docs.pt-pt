---
title: 'Tutoriais: Serviços Azure com Azure Data Lake Storage Gen2'
description: Encontre tutoriais que o ajudem a aprender a usar os serviços Azure com a Azure Data Lake Storage Gen2.
author: normesta
ms.topic: conceptual
ms.author: normesta
ms.date: 02/17/2021
...
Este artigo contém links para tutoriais que mostram como usar vários serviços Azure com Data Lake Storage Gen2. 
...
| Azure Databricks | [Aceder dados de armazenamento de dados Gen2 dados com Azure Databricks usando Spark](data-lake-storage-use-databricks-spark.md)|
...
| Azure Data Explorer | [Dados de consulta no Lago de Dados Azure usando O Explorador de Dados Azure](/azure/data-explorer/data-lake-query-data) |
| Azure Cognitive Search | [Indexe e pesquisa documentos da Azure Data Lake Storage Gen2 (pré-visualização)](../../search/search-howto-index-azure-data-lake-storage.md) |

> [!NOTE]
> Esta tabela não reflete a lista completa de serviços Azure que suportam data lake storage gen2. Para ver uma lista de serviços Azure suportados, o seu nível de apoio, consulte [os serviços da Azure que suportam a Azure Data Lake Storage Gen2](data-lake-storage-supported-azure-services.md)

## <a name="next-steps"></a>Passos seguintes

- Saiba como estes serviços podem ser usados em conjunto para construir cargas de trabalho que ingerem, descarregam, processam e visualizam dados. Consulte [a Utilização do Azure Data Lake Storage Gen2 para obter grandes requisitos de dados](data-lake-storage-data-scenarios.md).
