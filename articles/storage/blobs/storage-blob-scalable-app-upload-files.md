...
A aplicação cria cinco contentores aleatoriamente nomeados e começa a carregar os ficheiros no diretório faseado para a conta de armazenamento. O número mínimo e máximo de fios é definido para 100 para garantir que um grande número de ligações simultâneas são permitidas.
