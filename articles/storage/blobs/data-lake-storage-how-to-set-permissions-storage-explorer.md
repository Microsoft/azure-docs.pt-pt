...
---
# <a name="use-azure-storage-explorer-to-manage-access-in-azure-data-lake-storage-gen2"></a>Use Gerenciador de Armazenamento do Azure para gerenciar o acesso no Azure Data Lake Storage Gen2
...
* **Acesso**: ACLs de acesso controlam o acesso a um objeto. Os arquivos e diretórios têm ACLs de acesso.
...
> [Controlo de Acesso no Azure Data Lake Storage Gen2](data-lake-storage-access-control.md)
