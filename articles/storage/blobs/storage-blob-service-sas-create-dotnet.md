...
description: Saiba como criar uma assinatura de acesso partilhado de serviço (SAS) para um recipiente ou blob utilizando a biblioteca de clientes .NET ou o JavaScript v12 SDK
services: storage
author: tamram
ms.service: storage
ms.topic: how-to
