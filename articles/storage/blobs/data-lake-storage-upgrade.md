...
A tabela seguinte descreve que API define que estão disponíveis para as suas aplicações personalizadas. Para tornar as coisas um pouco mais claras, tenha separado estes conjuntos de API em 2 tipos: gestão de APIs e sistema de ficheiros APIs.

APIs de gestão de ajudá-lo a gerir contas, ao sistema de ficheiros que APIs ajudá-lo a operar nos ficheiros e pastas.
...
| Python – sistema de ficheiros                    | [Link](https://azure-datalake-store.readthedocs.io/en/latest/)                                                                                                                                                                                                                                                                 | *Ainda não está disponível*                                                | *Ainda não está disponível*                                                                                                                                             |
...
| Produtividade         | [Azure portal](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-get-started-portal)                                                                      | *Não suportado*                                                                                                                                                              | Gerenciamento de contas *– agora disponível* <br><br>Operações de dados *–* *ainda não está disponível*                                                                   |
...
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Migração lift-and-shift**                 | [Azure Data Factory](https://docs.microsoft.com/azure/data-factory/load-azure-data-lake-storage-gen2-from-gen1) | Serviço gerido na cloud                                                                                                                | Dados e de ACLs podem ser copiadas atualmente.                                                                                                                                                                                                                                                                      |
...
| **Copiar uma vez-e-cópia incremental** | Azure Data Factory                                                                                                    | Serviço gerido na cloud                                                                                                                | Dados e de ACLs podem ser copiadas atualmente. Para suportar a cópia incremental no ADF, os dados têm de ser organizado de maneira de séries de tempo. É o intervalo mais curto entre cópias incrementais [15 minutos](https://docs.microsoft.com/azure/data-factory/how-to-create-tumbling-window-trigger). |
...
A principal tarefa aqui é converter o URI que têm um prefixo de `adl://` para o URI que tenham um `abfss://` prefixo.
...
Depois de terminar com a operação de transição, os últimos passos envolverá verificação completa. Isso seria incluem, mas não estar limitado a verificar dados foi copiada através de forma fiável, verificação de ACLs foram definidas corretamente, pipelines de ponto-a-ponto de verificação estão a funcionar corretamente etc. Depois das verificações forem concluídas, pode agora desativar os pipelines antigos, eliminar as contas de origem Gen1 de armazenamento do Data Lake e aceda a velocidade máxima em suas soluções com base na geração 2 de armazenamento do Data Lake.
