...
| | Armazenamento do Data Lake Ger1 | Data Lake Storage Gen2 - goal | Data Lake Storage Gen2 - availability status  |
|-|------------------------|-------------------------------|-----------------------------------------------|
...
| Data Operations – Logs  | Sim | Sim | *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md).<br><br> Azure Monitoring integration – *Not yet available* |
...
| Disponibilidade regional | See [here](https://azure.microsoft.com/regions/) | All [Azure regions](https://azure.microsoft.com/global-infrastructure/regions/)                                                                                                                                                                                                                                                                                                                                       | *Available now*                                                                                                                           |
| Preço                                       | See [Pricing](https://azure.microsoft.com/pricing/details/data-lake-store/)                                                                            | See [Pricing](https://azure.microsoft.com/pricing/details/storage/data-lake/)                                                                                                                                                                                                                                                                                                                                         |                                                                                                                                           |
| SLA de disponibilidade                            | [See SLA](https://azure.microsoft.com/support/legal/sla/data-lake-store/v1_0/)                                                                   | [See SLA](https://azure.microsoft.com/support/legal/sla/storage/v1_3/)                                                                                                                                                                                                                                                                                                                                                | *Available now*                                                                                                                           |
| Gestão de Dados                             | File Expiration                                                                                                                                        | Lifecycle policies                                                                                                                                                                                                                                                                                                                                                                                                          | Lifecycle policies *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md).                                                                                                                     |
...
|  API set                           |  Armazenamento do Data Lake Ger1                                                                                                                                                                                                                                                                                                   | Availability for Data Lake Storage Gen2 - with Shared Key auth | Availability for Data Lake Storage Gen2 - with OAuth auth                                                                                                  |
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK                  | [Ligação](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Available now* | *Available now* |
| Java SDK                | [Ligação](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Available now*                                                      | *Available now*                                     |
...
| API REST                 | [Ligação](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Available now*                                                      | *Available now*                                                                                                                                               |
| PowerShell | [Ligação](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *Available now* |
| CLI                 | [Ligação](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Available now*                                                      | *Available now*                                                               |
...
| **Área**             | **Availability for Data Lake Storage Gen1**                                                                                                                                    | **Availability for Data Lake Storage Gen2 – with Shared Key auth**                                                                                                           | **Availability for Data Lake Storage Gen2 – with OAuth**                                                                                        |
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
|                      | [SQL Data Warehouse](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-load-from-azure-data-lake-store)                                            | *Não suportado*                                                                                                                                                              | *Available now* [Link](https://docs.microsoft.com/sql/t-sql/statements/create-external-data-source-transact-sql?view=sql-server-2017) |
...
|                      | [Catálogo de Dados](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-with-data-catalog)                                                                       | *Not yet available*                                                                                                                                                          | *Not yet available*                                                                                                                             |
|                      | [Aplicações Lógicas](https://docs.microsoft.com/connectors/azuredatalake/)                                                                                                      | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
| Consumo          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
| Produtividade         | [Portal do Azure](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-get-started-portal)                                                                      | *Não suportado*                                                                                                                                                              | Account management *– Available now* <br><br>Data operations *–*  *Not yet available*                                                                   |
...
|                      | [Explorador do Armazenamento do Azure](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-in-storage-explorer)                                                          | *Available now*                                                                                                                                                              | *Available now*                                                                                                                                 |
...
| Área            | Parceiro  | Product/Service  | Availability for Data Lake Storage Gen1                                                                                                                                               | Availability for Data Lake Storage Gen2 – with Shared Key auth                                                   | Availability for Data Lake Storage Gen2 – with Oauth                                                             |
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| Analytics framework | Cloudera     | CDH                  | [Ligação](https://www.cloudera.com/documentation/enterprise/5-11-x/topics/admin_adls_config.html)                                                                                            | *Not yet available*                                                                                                  | [Ligação](https://www.cloudera.com/documentation/enterprise/latest/topics/admin_adls2_config.html)                                                                                                  |
|                     | Cloudera     | Altus                | [Ligação](https://www.cloudera.com/more/news-and-blogs/press-releases/2017-09-27-cloudera-introduces-altus-data-engineering-microsoft-azure-hybrid-multi-cloud-data-analytic-workflows.html) | *Não suportado*                                                                                                                  | *Not yet available*                                                                                                  |
...
|                     | Qubole       |                      | [Ligação](https://www.qubole.com/blog/big-data-analytics-microsoft-azure-data-lake-store-qubole/)                                                                                            | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
| Extração, Transformação e Carregamento                 | StreamSets   |                      | [Ligação](https://streamsets.com/blog/ingest-data-azure)                                                                                                                                     | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Informatica  |                      | [Ligação](https://kb.informatica.com/proddocs/Product%20Documentation/6/IC_Spring2017_MicrosoftAzureDataLakeStoreV2ConnectorGuide_en.pdf)                                                    | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Attunity     |                      | [Ligação](https://www.attunity.com/company/press-releases/microsoft-and-attunity-announce-strategic-partnership-for-data-migration/)                                                         | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Alteryx      |                      | [Ligação](https://help.alteryx.com/2018.2/DataSources/AzureDataLake.htm)                                                                                                                     | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | ImanisData   |                      | [Ligação](https://www.imanisdata.com/expansion-azure-support-azure-data-lake-store-integration/)                                                                                             | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
...
| Registos de atividade                                                                                          | [Ligação](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#audit-logs)   | One-off requests for logs for specific duration using support ticket – *Available now* Azure Monitoring integration - *Not yet available* |
| Registos de diagnósticos                                                                                        | [Ligação](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md). <br>Azure Monitoring integration - *Not yet available* |
| Métricas                                                                                                | *Não suportado*                                                                                               | *Available now -* [Link](https://docs.microsoft.com/azure/storage/common/storage-metrics-in-azure-monitor)                          |
...
| Estratégia                   | Pros                                                                                  | Contras                                                           | When to use?                                                                                                                                                                                             |
|--------------------------------|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Estratégia                       | Ferramentas                                                                                                             | Pros                                                                                                                             | Considerações                                                                                                                                                                                                                                                                                                                |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
