...
| Operações de dados – logs  | Sim | Solicitações one-off para logs de duração específica usando tíquete de suporte integração do monitoramento do Azure | Solicitações one-off para logs de duração específica usando tíquete de suporte – *disponível agora*<br><br> Integração do monitoramento do Azure – *ainda não disponível* |
...
| SDKs de desenvolvedor | .NET, Java, Python, Node. js  | .NET, Java, Python, Node. js, C++, Ruby, PHP, go, Android, Ios| *Ainda não disponível* |
...
| Gestão de Dados                             | Expiração do arquivo                                                                                                                                        | Políticas de ciclo de vida                                                                                                                                                                                                                                                                                                                                                                                                          | *Ainda não disponível*                                                                                                                       |

### <a name="programming-interfaces"></a>Interfaces de programação

Esta tabela descreve quais conjuntos de API estão disponíveis para seus aplicativos personalizados. Para tornar as coisas um pouco mais claras, separamos esses conjuntos de API em dois tipos: APIs de gerenciamento e APIs do sistema de arquivos.
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SDK do .NET – gerenciamento                  | [Ligação](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet)                                                                                                                                                                                                                 | *Não suportado*                                                      | *Disponível agora-* [link](https://docs.microsoft.com/rest/api/storageservices/operations-on-the-account--blob-service-)                                    |
| SDK do .NET – sistema de arquivos                  | [Ligação](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/client?view=azure-dotnet)                                                                                                                                                                                                                     | *Ainda não disponível*                                                | *Ainda não disponível*                                                                                                                                             |
| SDK do Java-gerenciamento                  | [Ligação](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Não suportado*                                                      | *Disponível agora –* [link](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob?view=azure-java-stable)                                     |
| SDK do Java – sistema de arquivos                  |   de [link](https://docs.microsoft.com/java/api/overview/azure/datalake)                                                                                                                                                                                                                                        | *Ainda não disponível*                                                | *Ainda não disponível*                                                                                                                                             |
| Node. js-gerenciamento                   |   de [link](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                               | Não suportado                                                      | *Disponível agora-* [link](https://azure.github.io/azure-storage-node/)                                                                                            |
| Node. js-sistema de arquivos                   |   de [link](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                               | *Ainda não disponível*                                                | *Ainda não disponível*                                                                                                                                             |
| Python-gerenciamento                    |   de [link](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                | *Não suportado*                                                      | *Disponível agora-* [link](https://docs.microsoft.com/python/api/overview/azure/storage/management?view=azure-python)                                       |
| Python-sistema de arquivos                    | [Ligação](https://azure-datalake-store.readthedocs.io/en/latest/)                                                                                                                                                                                                                                                                 | *Ainda não disponível*                                                | *Ainda não disponível*                                                                                                                                             |
| API REST-gerenciamento                  | [Ligação](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Não suportado*                                                      | *Disponível agora-*                                                                                                                                               |
| API REST-sistema de arquivos                  | [Ligação](https://docs.microsoft.com/rest/api/datalakestore/webhdfs-filesystem-apis)                                                                                                                                                                                                                                       | *Disponível agora*                                                    | *Disponível agora-* [link](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2)                                                      |
| PowerShell-gerenciamento e sistema de arquivos | [Ligação](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Gerenciamento – sistema de arquivos sem suporte- *ainda não disponível*        | Gerenciamento – *disponível agora-* [link](https://docs.microsoft.com/powershell/module/az.storage) <br><br>Sistema de arquivos- *ainda não disponível* |
| CLI – gerenciamento                       | [Ligação](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Não suportado*                                                      | *Disponível agora-* [link](https://docs.microsoft.com/cli/azure/storage?view=azure-cli-latest)                                                              |
| CLI-sistema de arquivos                       | [Ligação](https://docs.microsoft.com/cli/azure/dls/fs?view=azure-cli-latest)                                                                                                                                                                                                                                               | *Ainda não disponível*                                                | *Ainda não disponível*                                                                                                                                             |
| Modelos de Azure Resource Manager – gerenciamento             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Não suportado*                                                      | *Disponível agora-* [link](https://docs.microsoft.com/azure/templates/microsoft.storage/2018-07-01/storageaccounts)                                         |
...
| Área            | Parceiro  | Produto/serviço  | Disponibilidade para Data Lake Storage Gen1                                                                                                                                               | Disponibilidade para Data Lake Storage Gen2 – com autenticação de chave compartilhada                                                   | Disponibilidade para Data Lake Storage Gen2 – com o OAuth                                                             |
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
...
| Registos de diagnósticos                                                                                        | [Ligação](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | Solicitações one-off para logs de duração específica usando o tíquete de suporte – *disponível agora* integração de monitoramento do Azure- *ainda não disponível* |
...
O esquema de URI para Data Lake Storage Gen1 é mencionado [aqui](https://docs.microsoft.com/azure/hdinsight/hdinsight-hadoop-use-data-lake-store) em detalhes, mas, em grande geral, é *adl://mydatalakestore.azuredatalakestore.net/\<file_path\>.*
