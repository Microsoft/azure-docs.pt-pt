...
| :-------: | ----------------------- | ------- | ---------- |
| 12.x | [Biblioteca de clientes de armazenamento Azure Blob para .NET](/dotnet/api/overview/azure/storage.blobs-readme) | [Pacote (NuGet)](https://www.nuget.org/packages/Azure.Storage.Blobs/) | [Quickstart: Azure Blob storage client library v12 for .NET](/azure/storage/blobs/storage-quickstart-blobs-dotnet) |
...
|  Versão  | Documentação de referência | Pacote | Início Rápido |
| :-------: | ----------------------- | ------- | ---------- |
| 12.x | [Armazenamento Azure - Blobs](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-storage-blob/12.0.0/index.html) | [Pacote (Maven)](https://mvnrepository.com/artifact/com.azure/azure-storage-blob) | [Quickstart: Gerir bolhas com Java v12 SDK](/azure/storage/blobs/storage-quickstart-blobs-java) |
