...
Para obter um tutorial passo a passo, consulte [o tutorial: Hospede um site estático no armazenamento](https://docs.microsoft.com/azure/storage/blobs/storage-blob-static-website-host)de BLOBs.
