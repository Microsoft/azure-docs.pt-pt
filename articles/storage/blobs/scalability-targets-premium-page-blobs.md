...
| ------------------------------------------------- | --------------------------------------------------------------------------- |
| Capacidade do disco: 4 TB (disco individual)/ 35 TB (total acumulado de todos os discos) <br>Capacidade do instantâneo: 10 TB | Até 50 gigabits por segundo para entrada<sup>1</sup> + saída<sup>2</sup> |
