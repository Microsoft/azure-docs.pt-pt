...
|Hub de Eventos do Azure|Disponível em Geral|[Capture eventos através de Hubs de Eventos Azure em Armazenamento De Blob Azure ou Armazenamento de Lago de Dados Azure](https://docs.microsoft.com/azure/event-hubs/event-hubs-capture-overview)|
|Azure Event Grid|Disponível em Geral|[Tutorial: Implementar o padrão de captura de dados do lago para atualizar uma tabela Delta databricks](data-lake-storage-events.md)|
