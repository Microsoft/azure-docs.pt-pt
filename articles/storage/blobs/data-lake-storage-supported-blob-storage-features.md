...
ms.locfileid: "77925699"
---
# <a name="blobstoragefeaturesavailableinazuredatalakestoragegen2"></a>Funcionalidades de armazenamento blob disponíveis no Azure Data Lake Storage Gen2
...
## <a name="supportedblobstoragefeatures"></a>Recursos de armazenamento Blob suportados
...
|Métricas no Azure Monitor|Disponível em geral|[Métricas do Armazenamento do Microsoft Azure no Azure Monitor](../common/storage-metrics-in-azure-monitor.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)|
...
|APIs de armazenamento de BLOBs|Disponível em geral|[Quickstart: Biblioteca de clientes de armazenamento Azure Blob v12 para .NET](storage-quickstart-blobs-dotnet.md)<br>[Quickstart: Gerir bolhas com Java v12 SDK](storage-quickstart-blobs-java.md)<br>[Quickstart: Gerir bolhas com Python v12 SDK](storage-quickstart-blobs-python.md)<br>[Quickstart: Gerir bolhas com JavaScript v12 SDK em Node.js](storage-quickstart-blobs-nodejs.md)|
...
|Registos de diagnósticos|Pré-visualização|[Exploração analítica de armazenamento azure](../common/storage-analytics-logging.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)|
...
|Exploração madeireira no Monitor Azure|Ainda não apoiado|Ainda não disponível|
