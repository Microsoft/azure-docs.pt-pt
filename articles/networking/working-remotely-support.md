...
| [Transição para protocolo OpenVPN ou IKEv2 da SSTP](../vpn-gateway/ikev2-openvpn-from-sstp.md) | Supere o limite de ligação simultânea de 128 SSTP através da transição para o protocolo OpenVPN ou IKEv2.|
