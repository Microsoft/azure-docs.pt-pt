...
Esta secção descreve serviços que proporcionam conectividade entre os recursos do Azure, conectividade de uma rede no local para os recursos Azure, e sucursal para a conectividade de sucursais em Azure - Rede Virtual (VNet), Virtual WAN, ExpressRoute, VPN Gateway, Rede Virtual NAT Gateway, Azure DNS, serviço Azure Peering e Azure Bastion.
