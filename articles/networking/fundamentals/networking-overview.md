...
- [**Serviços de proteção de aplicações**](#protect): Proteja as suas aplicações utilizando qualquer ou uma combinação destes serviços de rede em Azure - Balancer de carga, Private Link, Proteção DDoS, Firewall, Grupos de Segurança de Rede, Firewall de Aplicações Web e Pontos Finais de Rede Virtual.
...
:::image type="content" source="./media/networking-overview/vpngateway-multisite-connection-diagram.png" alt-text="Ligações site-to-site Azure VPN Gateway":::
...
:::image type="content" source="./media/networking-overview/virtualwan1.png" alt-text="Diagrama da WAN Virtual":::
...
:::image type="content" source="./media/networking-overview/architecture.png" alt-text="Arquitetura Azure Bastion":::
...
:::image type="content" source="./media/networking-overview/flow-map.png" alt-text="Gateway NAT de rede virtual":::
...
:::image type="content" source="./media/networking-overview/private-endpoint.png" alt-text="Visão geral do ponto final privado":::
...
:::image type="content" source="./media/networking-overview/firewall-threat.png" alt-text="Descrição geral das firewalls":::
...
Os clientes podem optar por implantar [a Azure WAF com o Application Gateway,](../../web-application-firewall/ag/ag-overview.md) que fornece proteção regional às entidades no espaço de endereços públicos e privados. Os clientes também podem optar por implementar [a Azure WAF com Porta Frontal,](../../web-application-firewall/afds/afds-overview.md) que fornece proteção na borda da rede para os pontos finais públicos.

:::image type="content" source="./media/networking-overview/waf-overview.png" alt-text="Firewall de Aplicação Web":::
...
:::image type="content" source="./media/networking-overview/vnet-service-endpoints-overview.png" alt-text="Pontos finais de serviço de rede virtual":::
...
:::image type="content" source="./media/networking-overview/front-door-visual-diagram.png" alt-text="Visão geral do serviço da porta da frente":::
...
:::image type="content" source="./media/networking-overview/priority.png" alt-text="Método de encaminhamento de tráfego 'prioritário' do gestor de tráfego da Azure":::
...
:::image type="content" source="./media/networking-overview/load-balancer.png" alt-text="Exemplo do balançador de carga de Azure":::
...
:::image type="content" source="./media/networking-overview/figure1-720.png" alt-text="Exemplo de Gateway de aplicação":::
...
:::image type="content" source="./media/networking-overview/virtual-network-tap-architecture.png" alt-text="Como funciona a rede virtual TAP":::
...
- Carregue o tráfego de Internet para servidores públicos completando os passos no artigo Do equilíbrio de carga virado para a [Internet.](../../load-balancer/quickstart-load-balancer-standard-public-portal.md?toc=%2fazure%2fnetworking%2ftoc.json)