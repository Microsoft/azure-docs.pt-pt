...
| [az webapp create](/cli/azure/webapp?view=azure-cli-latest#az-webapp-create) | Cria uma aplicação web Azure dentro do plano de Serviço de Aplicações. |
