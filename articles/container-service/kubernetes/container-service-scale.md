...
> [!TIP]
> Para a versão atualizada, o que este artigo utiliza o serviço Kubernetes do Azure, veja [dimensionar um cluster do Azure Kubernetes Service (AKS)](../../aks/scale-cluster.md).
