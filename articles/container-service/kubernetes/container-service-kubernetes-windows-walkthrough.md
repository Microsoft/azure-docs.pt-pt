---
title: (PRECADO) Quickstart - Cluster Azure Kubernetes para Windows
...
---
# <a name="deprecated-deploy-kubernetes-cluster-for-windows-containers"></a>(PRECADO) Implementar cluster Kubernetes para contentores Windows
...
Para ligar ao cluster Kubernetes a partir do seu computador cliente, utilize [`kubectl`](https://kubernetes.io/docs/user-guide/kubectl/) o cliente da linha de comando Kubernetes. 
