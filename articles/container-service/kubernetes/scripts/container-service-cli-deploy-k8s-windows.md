...
---
# <a name="deprecated-create-an-azure-container-service-kubernetes-windows-cluster"></a>(DEPRECIADO) Criar um serviço de contentores Azure Kubernetes Windows Cluster
