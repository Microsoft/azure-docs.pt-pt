...
---
# <a name="deprecated-create-an-azure-container-service-kubernetes-linux-cluster"></a>(DEPRECIADO) Criar um serviço de contentores Azure Kubernetes Linux Cluster
