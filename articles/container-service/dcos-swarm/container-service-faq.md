---
title: (PRECADO) Serviço de Contentores Azure - FAQ
...
---
# <a name="deprecated-container-service-frequently-asked-questions"></a>(PRECADO) Serviço de Contentores frequentemente perguntas
...
Existem alguns problemas de DNS conhecidos no Windows cujas correções ainda estão a ser eliminadas de forma progressiva. Certifique-se de que está a utilizar o motor acs mais atualizado e a versão Windows (com [KB4074588](https://www.catalog.update.microsoft.com/Search.aspx?q=KB4074588) e [KB4089848](https://www.catalog.update.microsoft.com/Search.aspx?q=KB4089848) instalados) para que o seu ambiente possa beneficiar disto. Caso contrário, consulte a tabela abaixo para obter os passos de mitigação:
