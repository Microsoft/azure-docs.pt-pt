---
title: (PRECADO) Gerir o cluster Azure Swarm com a API docker
description: Colocar contentores num aglomerado de Enxames docker no Serviço de Contentores Azure
...
---
# <a name="deprecated-container-management-with-docker-swarm"></a>(PRECADO) Gestão de contentores com Docker Swarm
