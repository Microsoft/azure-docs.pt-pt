...
- [Criar um gateway VPN baseado em rotas utilizando o portal Azure](/azure/vpn-gateway/create-routebased-vpn-gateway-portal)
...
- [Como visualizar e recuperar eventos de Registo de Atividades Azure](/azure/azure-monitor/essentials/activity-log-view)
...
- [Começando com consultas log analytics](/azure/azure-monitor/logs/get-started-portal) 
...
O Azure Resource Manager tem a capacidade de exportar o modelo na Notação de Objetos JavaScript (JSON), que deve ser revisto para garantir que as configurações cumprem ou excedem os requisitos de segurança para a sua organização.
...
- [Configurar a autenticação multifactor](openvpn-azure-ad-mfa.md)
