...
* Para obter mais informações sobre a construção de uma VPN multicloud em escala, consulte o vídeo [Build the Best MultiCloud VPN at Scale](https://www.youtube.com/watch?v=p7h-frLDFE0).
