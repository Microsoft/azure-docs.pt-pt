...
- Para configurar o agrupamento de firewall para ter um IP virtual, você deve quebrar o cluster e expor o aparelho VPN diretamente a uma interface pública com a que o gateway pode interagir.
