...
* [Criar uma ligação Site a Site no portal do Azure](./tutorial-site-to-site-portal.md)
...
Continue a configurar a sua [ligação Site-to-Site](./tutorial-site-to-site-portal.md).