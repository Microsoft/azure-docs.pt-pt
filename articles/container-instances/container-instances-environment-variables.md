...
Primeiro, inicie o [aci/microsoft-wordcount] [ aci-wordcount] contentor na respetiva configuração predefinida, com isso [New-AzContainerGroup] [ new-Azcontainergroup] comando:
