...
description: A linha de base de segurança "Container Instances" fornece orientações processuais e recursos para a aplicação das recomendações de segurança especificadas no Benchmark de Segurança Azure.
author: msmbaldwin
...
Esta linha de base de segurança aplica orientações da [versão 1.0 do Benchmark de Segurança Azure](../security/benchmarks/overview-v1.md) às Instâncias de Contentores. A Referência de Segurança do Azure disponibiliza recomendações para proteger as suas soluções cloud no Azure.
O conteúdo é agrupado pelos **controlos de segurança definidos** pelo Azure Security Benchmark e pela orientação conexa aplicável às Instâncias de Contentores. Foram excluídos **os controlos** não aplicáveis aos casos de contentores.

 
Para ver como as instâncias do contentor mapeiam completamente o Benchmark de Segurança Azure, consulte o [ficheiro de mapeamento de base de segurança de instâncias de contentores completos](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).
...
**Orientação**: Integre os seus grupos de contentores em Instâncias de Contentores Azure com uma rede virtual Azure.  As redes virtuais Azure permitem-lhe colocar muitos dos seus recursos Azure, como grupos de contentores, numa rede de encaminhamento não internet.
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, pode ativar os registos de fluxo do grupo de segurança da rede (NSG) para o NSG ligado à sub-rede que está a ser utilizada para proteger o registo do seu contentor Azure. Pode gravar os registos de fluxo NSG numa Conta de Armazenamento Azure para gerar registos de fluxo. Se necessário para investigar atividades anómalas, ative a captura de pacotes do Azure Network Watcher.
...
**Orientação**: Ao utilizar o Registo do Contentor Azure com instâncias de contentores Azure, recomendamos que defina e implemente configurações de segurança padrão para os recursos de rede associados ao seu registo de contentores Azure.

Utilize pseudónimos da Política Azure nos espaços de nomes **Microsoft.ContainerRegistry** e **Microsoft.Network** para criar políticas personalizadas para auditar ou impor a configuração de rede dos seus registos de contentores.

Você pode usar plantas Azure para simplificar as implementações de Azure em larga escala através de artefactos de ambiente chave de embalagem, tais como modelos de gestor de recursos Azure, controlos RBAC Azure e definições de política em uma única definição de planta. Aplique facilmente o projeto a novas subscrições e ajuste o controlo e a gestão através da versão.
...
**Orientação**: Ingerir registos via Azure Monitor para agregar dados de segurança gerados por um recipiente Azure Instance. Dentro do Azure Monitor, utilize um espaço de trabalho Log Analytics para consultar e realizar análises, e utilize contas de armazenamento Azure para armazenamento a longo prazo/arquivo.
...
**Orientação**: O Azure Monitor recolhe registos de recursos (anteriormente chamados registos de diagnóstico) para eventos orientados pelo utilizador. Recolher e consumir estes dados para auditar eventos de autenticação de contentores e fornecer um rasto completo de atividade em artefactos como pull e push eventos para que você possa diagnosticar problemas de segurança com o seu grupo de contentores.
...
**Orientação**: Analise e monitorize os registos de instâncias do recipiente Azure para comportamento anómalo e reveja regularmente os resultados. Utilize o espaço de trabalho do Log Analytics do Azure Monitor para rever registos e efetuar consultas nos dados de registo.

- [Compreender o espaço de trabalho log Analytics](../azure-monitor/logs/log-analytics-tutorial.md)

- [Como realizar consultas personalizadas no Azure Monitor](../azure-monitor/logs/get-started-queries.md)

- [Como criar um grupo de contentores ativados por log e registos de consultas](container-instances-log-analytics.md)
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, utilize o espaço de trabalho Azure Log Analytics para monitorizar e alertar sobre atividades anómalas em registos de segurança e eventos relacionados com o seu registo de contentores Azure.

- [Registo de registo de contentores Azure para avaliação e auditoria de diagnóstico](../container-registry/container-registry-diagnostics-audit-logs.md)
...
**Orientação**: Não aplicável. Se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, o registo do contentor Azure não processa ou produz registos relacionados com anti-malware.
...
**Orientação**: Não aplicável. Se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, o registo do contentor Azure é um ponto final e não inicia a comunicação, e o serviço não consulta o DNS.
...
Se utilizar um registo privado baseado em nuvem como o registo do contentor Azure com instâncias de contentores Azure, para cada registo de contentores Azure, rastreie se a conta de administração incorporada está ativada ou desativada. Desative a conta quando não estiver a ser utilizada.
...
Se utilizar um registo privado baseado em nuvem como o registo do contentor Azure com instâncias de contentores Azure, se a conta de administração predefinida de um registo de contentores Azure estiver ativada, as palavras-passe complexas são automaticamente criadas e devem ser rotativas. Desative a conta quando não estiver a ser utilizada.
...
Se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, crie procedimentos para permitir a conta de administração incorporada de um registo de contentores. Desative a conta quando não estiver a ser utilizada.
...
Se utilizar um registo privado baseado em nuvem como o registo do contentor Azure com instâncias de contentores Azure, para acesso individual ao registo do contentor, utilize ins individuais de sinalização integradas com Azure AD.

- [Compreender SSO com Azure AD](../active-directory/manage-apps/what-is-single-sign-on.md)

- [Inscrição individual num registo de contentores](../container-registry/container-registry-authentication.md#individual-login-with-azure-ad)
...
**Orientação**: Tem acesso ao Azure Ative Directory (Azure AD) em fontes de registo de Eventos de Atividade, Auditoria e Risco, que lhe permitem integrar-se com qualquer ferramenta de Gestão de Informações de Segurança e Eventos (SIEM) /Ferramenta de monitorização.

Pode agilizar este processo criando Definições de Diagnóstico para contas de utilizadores AZure E enviando os registos de auditoria e assinando em registos para um espaço de trabalho do Log Analytics. Pode configurar os alertas desejados dentro do log analytics workspace.
...
- [Como ver a Azure AD sinais de risco](../active-directory/identity-protection/overview-identity-protection.md)
...
**Orientação**: Não disponível; O Lockbox do cliente não é atualmente suportado para instâncias de contentores Azure.
...
- [Bloqueie uma imagem de contentor num registo de contentores Azure](../container-registry/container-registry-image-lock.md)
...
- [Restringir o acesso a um registo de contentores Azure utilizando uma rede virtual Azure ou regras de firewall](../container-registry/container-registry-vnet.md)
...
Para a plataforma subjacente, gerida pela Microsoft, a Microsoft trata todos os dados dos clientes como sensíveis e faz grandes esforços para se proteger contra a perda e exposição de dados dos clientes. Para garantir que os dados dos clientes dentro do Azure permanecem seguros, a Microsoft implementou e mantém um conjunto de controlos e capacidades robustos de proteção de dados.
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, funcionalidades de identificação, classificação e prevenção de perdas ainda não estão disponíveis para o Registo do Contentor de Azure. Implementar solução de terceiros, se necessário para efeitos de conformidade.
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o Registo de Contentores Azure com Instâncias de Contentores Azure, utilize o controlo de acesso baseado em funções Azure (Azure RBAC) para obter acesso a dados e recursos num registo de contentores Azure.

- [Como configurar o Azure RBAC em Azure](../role-based-access-control/role-assignments-portal.md)

- [Funções e permissões do Registo de Contentores de Azure](../container-registry/container-registry-roles.md)
...
**Orientação**: Utilize a encriptação em repouso em todos os recursos Azure. Se utilizar um registo privado baseado em nuvem como o registo do contentor Azure com instâncias de contentores Azure, por padrão, todos os dados de um registo de contentores Azure são encriptados em repouso utilizando as teclas geridas pela Microsoft.

- [Compreender a encriptação de dados inativos no Azure](../security/fundamentals/encryption-atrest.md)

- [Chaves geridas pelo cliente no Registo do Contentor Azure](../container-registry/container-registry-customer-managed-keys.md)
...
**Orientação**: Aproveite as soluções para digitalizar imagens de contentores num registo privado e identificar potenciais vulnerabilidades. É importante entender a profundidade da deteção de ameaças que as diferentes soluções fornecem. Siga as recomendações do Azure Security Center sobre a realização de avaliações de vulnerabilidade nas imagens do seu contentor. Opcionalmente implementar soluções de terceiros a partir do Azure Marketplace para realizar avaliações de vulnerabilidade de imagem.
...
**Orientação**: Pode utilizar uma solução de terceiros para corrigir imagens de aplicações. Além disso, se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, pode executar tarefas de Registo de Contentores Azure para automatizar atualizações para aplicar imagens num registo de contentores com base em patches de segurança ou outras atualizações em imagens base.
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, integre o registo do contentor Azure (ACR) com o Azure Security Center para permitir a digitalização periódica de imagens de contentores para vulnerabilidades. Implementar opcionalmente soluções de terceiros a partir do Azure Marketplace para realizar análises periódicas de vulnerabilidade de imagem.
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o registo de contentores Azure com instâncias de contentores Azure, integre o Registo de Contentores Azure (ACR) com o Azure Security Center para permitir a digitalização periódica de imagens de contentores para vulnerabilidades e para classificar riscos. Implementar opcionalmente soluções de terceiros do Azure Marketplace para realizar análises periódicas de vulnerabilidade de imagem e classificação de risco.
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o Registo de Contentores Azure (ACR) com instâncias de contentores Azure, a ACR mantém metadados incluindo tags e manifestos para imagens num registo. Siga as práticas recomendadas para a marcação de artefactos.
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o Registo de Contentores Azure (ACR) com instâncias de contentores Azure, analise e monitorize os registos do registo do contentor Azure para um comportamento anómalo e reveja regularmente os resultados. Utilize o log analytics workspace do Azure Monitor para rever registos e efetuar consultas nos dados de registo.
...
- [Por exemplo, como controlar a execução de scripts PowerShell em Ambientes windows](/powershell/module/microsoft.powershell.security/set-executionpolicy?amp;preserve-view=true&view=powershell-7)
...
Se utilizar um registo privado baseado em nuvem como o Registo de Contentores Azure (ACR) com instâncias de contentores Azure, audite a conformidade dos registos de contentores da Azure utilizando a Política de Azure:.
...
**Orientação**: Se utilizar definições de política Azure personalizadas, utilize a Azure Repos para armazenar e gerir o seu código de forma segura.
...
**Orientação**: Não aplicável; este controlo aplica-se apenas aos recursos computacional.
...
Aplique a Azure Policy para impor restrições ao tipo de recursos que podem ser criados nas suas subscrições.
...
- [Como autenticar para o Cofre de Chaves](container-instances-managed-identity.md)

- [Como atribuir uma política de acesso ao Cofre de Chaves](../key-vault/general/assign-access-policy-portal.md)

- [Como utilizar identidades geridas com o Azure Container Instances](../container-registry/container-registry-tasks-authentication-managed-identity.md)

- [Como encriptar dados com instâncias de contentores](container-instances-encrypt-data.md)
...
- [Utilize uma identidade gerida a Azure para autenticar num registo de contentores Azure](../container-registry/container-registry-authentication-managed-identity.md)
...
**Orientação**: O Microsoft Antimalware está ativado no anfitrião subjacente que suporta os serviços Azure (por exemplo, Instâncias de Contentores Azure), no entanto não funciona com dados do cliente.
...
**Orientação**: Se utilizar um registo privado baseado em nuvem como o Registo de Contentores Azure (ACR) com instâncias de contentores Azure, os dados no seu registo de contentores Microsoft Azure são sempre replicados automaticamente para garantir a durabilidade e alta disponibilidade. O Registo do Contentor Azure copia os seus dados de modo a que esteja protegido contra eventos planeados e não planeados.

Opcionalmente, re replicar um registo de contentores para manter réplicas de registo em várias regiões de Azure.

- [Geo-replicação no Registo do Contentor de Azure](../container-registry/container-registry-geo-replication.md)
...
- [Encriptar dados de implantação com instâncias de contentores](container-instances-encrypt-data.md)
...
- [Como restaurar as chaves do cofre da chave Azure em Azure](/powershell/module/az.keyvault/restore-azkeyvaultkey?amp;preserve-view=true&view=azps-4.8.0)
...
- [Publicação do NIST - Guia de Testes, Formação e Programas de Exercício para Planos e Capacidades de TI](https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-84.pdf)
