...
ms.locfileid: "106078610"
---
# <a name="azure-security-baseline-for-container-instances"></a>Linha de base de segurança Azure para instâncias de contentores

Esta linha de base de segurança aplica orientações da [versão Azure Security Benchmark1.0](../security/benchmarks/overview-v1.md) para As Instâncias de Contentores. A Referência de Segurança do Azure disponibiliza recomendações para proteger as suas soluções cloud no Azure. O conteúdo é agrupado pelos **controlos de segurança definidos** pelo Azure Security Benchmark e pela orientação conexa aplicável às Instâncias de Contentores. Foram excluídos **os controlos** não aplicáveis às Instâncias de Contentores, ou para os quais a responsabilidade é da Microsoft.
...
Se utilizar um registo privado baseado em nuvem como o registo do contentor Azure com instâncias de contentores Azure, para acesso individual ao registo do contentor, utilize um sinal individual integrato com Azure AD.
...
- [Por exemplo, como controlar a execução de scripts PowerShell em Ambientes windows](/powershell/module/microsoft.powershell.security/set-executionpolicy)
...
- [Como restaurar as chaves do cofre da chave Azure em Azure](/powershell/module/az.keyvault/restore-azkeyvaultkey)
