...
Para verificar se a imagem está armazenada no seu registo, verifique o comando [do repositório az acr:](/cli/azure/acr/repository#az_acr_repository_show)
