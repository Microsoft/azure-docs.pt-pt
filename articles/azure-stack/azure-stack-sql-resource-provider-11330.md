...
- **Falha de rotação secreta do fornecedor de recursos SQL**. Foi corrigido o problema resulta no seguinte código de erro quando alternar segredos:
