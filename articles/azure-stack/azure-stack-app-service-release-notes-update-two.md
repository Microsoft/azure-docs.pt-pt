...
- As atualizações **runtime das funções do Azure** ao **v1.0.11612**.
...
- **Atualizações para as seguintes arquiteturas de aplicações e ferramentas**:
  ...
  - Adicionado **NPM** versões:
    - 5.6.0
  - Componentes atualizados do .NET Core para ser consistente com o serviço de aplicações do Azure na nuvem pública.
  - Kudu atualizado
