...
> [!NOTE]
> Imagens personalizadas devem ser criadas com a versão mais recente de WALA pública ou com a versão 2.2.20. As versões mais antigas que 2.2.20 e entre 2.2.20 e 2.2.35.1 (exclusivo) poderão não funcionar corretamente no Azure Stack. 
>
