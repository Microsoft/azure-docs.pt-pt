---
title: Ver e configurar telemetria de proteção DDoS
...
ms.locfileid: "92905528"
---
# <a name="view-and-configure-ddos-protection-telemetry"></a>Ver e configurar telemetria de proteção DDoS
...
Para simular um ataque DDoS para validar a telemetria, consulte [validar a deteção de DDoS](test-through-simulations.md).
...
> [Configure relatórios de mitigação de ataques DDoS e registos de fluxo](reports-and-flow-logs.md)