---
title: Implantar associações para o aplicativo gerenciado do Azure usando a política
...
![Atribuir política interna](media/builtin-policy/assign-builtin-policy-managedapp.png)
