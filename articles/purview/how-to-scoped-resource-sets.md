...
1. Vá ao centro de gestão. Selecione conjuntos de **recursos Scoped** no menu. Selecione **+ Novo** para criar um novo conjunto de regras de configuração.
...
1. Introduza o âmbito da configuração do conjunto de recursos do seu âmbito de aplicação. Selecione o tipo de conta de armazenamento e o nome da conta de armazenamento que deseja criar uma regra definida. Cada conjunto de regras é aplicado em relação a um âmbito de trajetória de pasta especificado no campo de caminhos da **pasta.**
   ...
   :::image type="content" source="media/how-to-scoped-resource-sets/create-new-scoped-resource-set-scope.png" alt-text="Criar configurações de conjunto de recursos âmbito" border="true":::
...
## <a name="order-of-scoped-resource-set-rules-getting-applied"></a>Ordem das regras definidas por recursos alargados a serem aplicadas
...
#### <a name="scoped-resource-set-rule"></a>Regra definida por recursos alargados
