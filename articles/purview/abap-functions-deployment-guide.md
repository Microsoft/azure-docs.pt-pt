...
3.  Navegue para o \" separador código \" Fonte. Existem duas formas de implementar código para a função:
    ...
    a.  A partir do menu principal, faça o upload do ficheiro de texto [Z \_ MITI \_ DOWNLOAD](https://github.com/Azure/Purview-Samples/tree/master/connectors/sap) selecionando Utilities= \> Mais Utilitários= \> Upload/Download= \> Upload.
