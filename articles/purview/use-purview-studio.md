---
title: Use o Azure Purview Studio
description: Este artigo descreve como usar o Azure Purview Studio.
author: nayenama
ms.author: nayenama
ms.service: purview
...
5. A barra de navegação à esquerda ajuda-o a localizar as páginas principais da aplicação. Os botões que são apresentados dependem da função atribuída à sua conta de utilizador.
   ...
   * Para *o administrador de fontes de dados* ou *curador/leitor* de dados, os botões são **Home**, **Sources**, **Glossary,** **Insights** e **Management Center**.
