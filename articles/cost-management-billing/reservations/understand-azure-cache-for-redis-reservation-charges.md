...
Depois de comprar capacidade reservada da Cache do Azure para Redis, o desconto de reserva é aplicado automaticamente às instâncias de caches que correspondam aos atributos e à quantidade da reserva. As reservas só abrangem os custos de computação da Cache do Azure para Redis. É-lhe cobrada uma taxa normal de armazenamento e rede. A capacidade reservada só está disponível para caches de [escalão premium](/azure/azure-cache-for-redis/cache-premium-tier-intro).
