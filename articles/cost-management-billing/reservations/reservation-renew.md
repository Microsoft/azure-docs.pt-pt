...
3. Selecione **Comprar automaticamente uma nova reserva ao expirar**.  
  ![Exemplo que mostra a renovação da reserva](./media/reservation-renew/reservation-renewal.png)
...
- Para saber mais sobre as Reservas do Azure, veja [O que são as Reservas do Azure?](save-compute-costs-reservations.md)
