...
1. Clique no separador **Azure Marketplace e reservas**.  ![Imagem do separador do Azure Marketplace e reservas](./media/understand-azure-marketplace-charges/invoice-tabs.png)
