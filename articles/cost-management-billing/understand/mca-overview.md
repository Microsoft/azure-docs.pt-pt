...
description: Saiba mais sobre a conta de faturação do Contrato de Cliente Microsoft, incluindo os perfis de faturação e os métodos de pagamento das faturas.
author: bandersmsft
...
![Um diagrama a mostrar a hierarquia de faturação do Contrato de Cliente da Microsoft](./media/mca-overview/mca-billing-hierarchy.png)
...
Pode ver a fatura, transferir documentos e alterar definições para receber faturas posteriores por e-mail no portal do Azure. Para obter mais informações, veja [Transferir as faturas para um Contrato de Cliente da Microsoft](../manage/download-azure-invoice-daily-usage-date.md#download-invoices-for-a-microsoft-customer-agreement).
...
| Tipo             | Definição  |
|------------------|-------------|
|Créditos do Azure    |  Os créditos são automaticamente aplicados aos custos elegíveis na sua fatura, o que reduz o valor que tem de pagar. Para obter mais informações, veja [Controlar o saldo de crédito do Azure do perfil de faturação](../manage/mca-check-azure-credits-balance.md). |
...
- [Criar uma subscrição do Azure adicional para o Contrato de Cliente da Microsoft](../manage/create-subscription.md)
