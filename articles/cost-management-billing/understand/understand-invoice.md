...
![Secção Resumo da fatura](./media/understand-invoice/invoice-summary-section.png)
...
![Secção Custos de utilização](./media/understand-invoice/usage-charges-section.png)
...
Se existir um custo na fatura sobre o qual gostaria de obter mais informações, veja como [Compreender a sua fatura do Microsoft Azure.](review-individual-bill.md)
