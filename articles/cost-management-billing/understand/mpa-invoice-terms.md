...
A secção **Detalhes de faturação por produto** lista os custos totais de cada produto associado a este perfil de faturação. Pode visualizar a discriminação diária dos custos de cada produto no ficheiro CSV de utilização e custos do Azure. Para saber mais sobre como reconciliar o PDF da fatura com o CSV de utilização e custos do Azure, veja [Compreender a fatura do Contrato de Parceiro da Microsoft](review-partner-agreement-bill.md).
