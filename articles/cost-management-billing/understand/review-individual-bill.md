...
No ficheiro CSV de utilização, filtre por *MeterName* para o Recurso correspondente mostrado na fatura. Em seguida, some o valor do *Custo* dos itens na coluna. Veja a seguir um exemplo.
