...
Tem de ter uma conta de faturação do *Programa Microsoft Online Services* paga. A conta é criada quando se inscreve no Azure através do site do Azure. Por exemplo, se tiver uma conta com tarifas pay as you go ou se for um subscritor do Visual Studio.

As faturas das Contas Gratuitas do Azure só são criadas quando o valor mensal do crédito é excedido.
...
- Não tem permissão para ver faturas. É possível que não veja faturas antigas a menos que seja o Administrador de Conta.
...
Os custos de serviços externos são faturados separadamente. Os custos não aparecem na fatura do Azure.
