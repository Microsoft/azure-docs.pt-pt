...
Para obter mais informações sobre as contas do Azure, veja [Adicionar uma conta](https://docs.microsoft.com/azure/cost-management-billing/manage/ea-portal-administration#add-an-account).
