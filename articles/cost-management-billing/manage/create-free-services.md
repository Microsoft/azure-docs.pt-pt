...
Pode criar várias instâncias dos serviços gratuitamente, desde que o total da utilização esteja dentro do limite de utilização. Por exemplo, com a conta gratuita do Azure obtém 750 horas gratuitas de uma máquina virtual Windows B1S todos os meses. Pode utilizar as 750 horas em qualquer combinação que deseje. Por exemplo, pode criar cinco máquinas virtuais Windows B1S e utilizá-las durante 150 horas cada uma.
