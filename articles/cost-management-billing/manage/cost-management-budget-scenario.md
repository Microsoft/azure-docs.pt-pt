...
4. Defina o **Nome** do Webhook como **Opcional**. A propriedade **Ativada** deve ser **Sim**. O valor **Expira em** não precisa de ser alterado. Para obter mais informações sobre as propriedades do Webhook, veja [Webhook properties](../../automation/automation-webhooks.md#webhook-properties) (Propriedades de webhook).
