...
Para obter informações sobre como atribuir acesso aos dados de gerenciamento de custos do Azure, consulte [assign Access to data](../../cost-management/assign-access-acm-data.md).
