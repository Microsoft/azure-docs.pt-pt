...
Para obter mais informações, consulte [do Azure Migrate](../../site-recovery/migrate-overview.md).
...
Para obter mais informações sobre a automatização com base no orçamento, consulte [automatização com base do orçamento](../manage/cost-management-budget-scenario.md).
...
Para obter mais informações, consulte [quais são as reservas do Azure?](../reservations/save-compute-costs-reservations.md).
...
- Se estiver familiarizado com a gestão de custos, leia [o que é o Azure Cost Management?](../cost-management-billing-overview.md) para saber como o ajuda a monitorizar e controlar os gastos do Azure e para otimizar o uso de recursos.
