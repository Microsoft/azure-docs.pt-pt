...
>**Introdução**: para saber mais sobre como usar o APIs de cobrança, confira [visão geral de APIs de uso e RateCard de cobrança do Azure](../../cost-management-billing/manage/usage-rate-card-overview.md).
