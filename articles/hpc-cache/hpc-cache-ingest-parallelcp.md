...
O script a seguir adicionará o `parallelcp`executável. (Esse script foi criado para o Ubuntu; se estiver usando outra distribuição, você ``parallel`` deverá instalar o separadamente.)
