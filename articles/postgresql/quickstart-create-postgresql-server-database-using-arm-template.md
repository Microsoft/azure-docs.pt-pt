---
title: Crie um Azure DB para PostgreSQL usando um modelo ARM
description: Neste artigo, aprenda a criar uma Base de Dados Azure para servidor PostgreSQL utilizando um modelo de Gestor de Recursos Azure.
author: mgblythe
...
Cria uma Base de Dados Azure para servidor PostgreSQL com um conjunto configurado de recursos de computação e armazenamento. Para saber mais, consulte os níveis de preços na Base de [Dados Azure para PostgreSQL - Servidor Único](concepts-pricing-tiers.md). Irá criar o servidor dentro de um [grupo de recursos do Azure](../azure-resource-manager/management/overview.md).

### <a name="review-the-template"></a>Reveja o modelo

O modelo utilizado neste quickstart é de [modelos de quickstart Azure](https://github.com/Azure/azure-quickstart-templates/tree/master/101-managed-postgresql-with-vnet/).
...
A base de dados mais Azure para amostras de modelos PostgreSQL pode ser encontrada em [modelos de quickstart Azure](https://azure.microsoft.com/resources/templates/?resourceType=Microsoft.Dbforpostgresql&pageNumber=1&sort=Popular).

## <a name="deploy-the-template"></a>Implementar o modelo

# <a name="portal"></a>[Portal](#tab/azure-portal)

Selecione o seguinte link para implementar a Base de Dados Azure para o modelo de servidor PostgreSQL no portal Azure:
...
Na base de **dados Azure deploy para PostgreSQL com página VNet:**
...
3. Introduza um **Nome de Servidor,** **Registo do Administrador**e **Palavra-passe**de login do administrador .
    ...
    ![Implementar base de dados Azure para PostgreSQL com janela VNet, modelo de quickstart Azure, portal Azure](./media/quickstart-create-postgresql-server-database-using-arm-template/deploy-azure-database-for-postgresql-with-vnet.png)
...
4. Altere as outras definições predefinidas se quiser:
    ...
    * **Tamanho Sku**: o tamanho do armazenamento, em megabytes, da Base de Dados Azure para servidor PostgreSQL (padrão *51200*).
    ...
    * **Versão Postgresql**: a versão do servidor PostgreSQL para implementar, tais como *9.5*, *9.6*, *10*ou *11* (o padrão).
    ...
    * **Nome da sub-rede**: o nome da sub-rede *(azure_postgresql_subnet*por defeito ).
...
Utilize o seguinte código interativo para criar uma nova Base de Dados Azure para o servidor PostgreSQL utilizando o modelo. O código solicita-lhe o novo nome do servidor, o nome e a localização de um novo grupo de recursos e um nome de conta de administrador e senha.
...
1. No [portal Azure,](https://portal.azure.com)procure e selecione Base de **Dados Azure para servidores PostgreSQL**.

2. Na lista de bases de dados, selecione o seu novo servidor. Aparece a página **de visão geral** da sua nova Base de Dados Azure para o servidor PostgreSQL.

# <a name="powershell"></a>[PowerShell](#tab/PowerShell)

Execute o seguinte código interativo para visualizar detalhes sobre a sua Base de Dados Azure para servidor PostgreSQL. Terá de introduzir o nome do novo servidor.
...
Execute o seguinte código interativo para visualizar detalhes sobre a sua Base de Dados Azure para servidor PostgreSQL. Terá de introduzir o nome e o grupo de recursos do novo servidor.
