...
Pode ver a lista de réplicas de um servidor principal.
...
Para eliminar um servidor de master ou a réplica, use o mesmo comando como para eliminar a base de dados autónomo para o servidor PostgreSQL. 
