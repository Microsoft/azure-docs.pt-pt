...
> [!Note] 
> Azure Database for PostgreSQL predefinições para TLS ser desativado para todos os novos servidores.
>
> Atualmente, as versões TLS suportadas pela Azure Database para PostgreSQL são TLS 1.0, 1.1 e 1.2. Uma vez aplicada a uma versão TLS mínima específica, não pode alterá-la para desativada.
