---
title: Conselheiro Azure para PostgreSQL
description: Saiba mais sobre as recomendações do Azure Advisor para PostgreSQL.
author: alau-ms
ms.author: alau
...
ms.locfileid: "107310058"
---
# <a name="azure-advisor-for-postgresql"></a>Conselheiro Azure para PostgreSQL
Saiba como o Azure Advisor é aplicado na Base de Dados Azure para PostgreSQL e obtenha respostas a perguntas comuns.
## <a name="what-is-azure-advisor-for-postgresql"></a>O que é Azure Advisor for PostgreSQL?
O sistema Azure Advisor utiliza telemetria para emitir recomendações de desempenho e fiabilidade para a sua base de dados PostgreSQL. As recomendações do conselho dividem-se entre as nossas ofertas de base de dados PostgreSQL:
* Base de Dados do Azure para PostgreSQL – Servidor Único
* Base de Dados Azure para PostgreSQL - Servidor Flexível
* Base de Dados do Azure para PostgreSQL – Hyperscale (Citus)
...
A Azure Database for PostgreSQL prioriza os seguintes tipos de recomendações:
* **Desempenho**: Para melhorar a velocidade do seu servidor PostgreSQL. Isto inclui a utilização do CPU, pressão de memória, agrupamento de ligações, utilização do disco e parâmetros do servidor específicos do produto. Para mais informações, consulte [recomendações de Desempenho Do Conselheiro](../advisor/advisor-performance-recommendations.md).
* **Fiabilidade**: Para garantir e melhorar a continuidade das suas bases de dados críticas ao negócio. Isto inclui limites de armazenamento, limites de ligação e recomendações de distribuição de dados de hiperescala. Para mais informações, consulte [recomendações de Fiabilidade do Conselheiro](../advisor/advisor-high-availability-recommendations.md).
...
* **Horário diário**: Para bases de dados Azure PostgreSQL, verificamos a telemetria do servidor e emitimos recomendações num horário diário. Se fizer uma alteração na configuração do servidor, as recomendações existentes permanecerão visíveis até reexaminarmos a telemetria no dia seguinte. 
