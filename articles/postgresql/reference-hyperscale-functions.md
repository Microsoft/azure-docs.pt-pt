...
> [!NOTE]
>
> Grupos de servidores de hiperescala que executam versões mais antigas do Citus Engine podem não oferecer todas as funções listadas abaixo.
