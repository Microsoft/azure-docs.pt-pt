...
O serviço banco de dados do Azure para PostgreSQL fornece um alto nível de disponibilidade garantido. O SLA (contrato de nível de serviço) com suporte financeiro é de 99,99% na disponibilidade geral. Praticamente não há nenhum tempo de inatividade de aplicativo ao usar esse serviço.
...
Semelhante ao modelo de alta disponibilidade, quando um banco de dados do Azure para PostgreSQL é aumentado ou reduzido verticalmente, uma nova instância de servidor com o tamanho especificado é criada. O armazenamento de dados existente é desanexado da instância original e anexado à nova instância.
...
- Saiba mais sobre como [lidar com erros de conectividade transitórios](concepts-connectivity.md)
