...
Também pode considerar a utilização [de Link Privado](concepts-data-access-and-security-private-link.md) para ligações. O Private Link fornece um endereço IP privado no seu VNet para o servidor PostgreSQL.
