---
title: Encriptação de dados para Base de Dados Azure para PostgreSQL - Resolução de problemas de servidor único
description: Saiba como resolver a encriptação de dados para a sua Base de Dados Azure para PostgreSQL - Servidor único
author: kummanish
ms.author: manishku
...
ms.locfileid: "77371504"
---
# <a name="troubleshooting-data-encryption-with-customer-managed-keys-in-azure-database-for-postgresql---single-server"></a>Encriptação de dados de resolução de problemas com chaves geridas pelo cliente na Base de Dados Azure para PostgreSQL - Servidor único
Este artigo descreve como identificar e resolver problemas/erros comuns que ocorrem numa Base de Dados Azure para PostgreSQL - Servidor único configurado com encriptação de dados utilizando a chave gerida pelo cliente.
...
* A Base de Dados Azure para PostgreSQL - Identidade gerida por instâncias de um servidor único foi acidentalmente eliminada.
* As permissões concedidas à Base de Dados Azure para a identidade gerida postgresQL para as teclas não são suficientes (não incluem Get, Wrap e Desembrulhar).
* As permissões para a Base de Dados Azure para a identidade gerida por instâncias do servidor postgresQL foram revogadas ou eliminadas.
...
[Configurar a encriptação de dados com uma chave gerida pelo cliente para a sua base de dados Azure para postgreSQL utilizando o portal Azure](howto-data-encryption-portal.md).