...
Quando configurar a encriptação de dados para utilizar uma chave gerida pelo cliente no Cofre de Chaves Azure, o servidor requer acesso contínuo à chave. Se o servidor perder o acesso à chave gerida pelo cliente no Cofre da Chave Azure, negará todas as ligações, devolverá a mensagem de erro adequada e mudará o seu estado para ***Inacessível*** no portal Azure.
