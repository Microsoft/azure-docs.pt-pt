...
description: Este quickstart fornece uma amostra de código C# (.NET) que pode utilizar para ligar e consultar dados da Base de Dados Azure para o PostgreSQL - Servidor Flexível.
author: mksuni
ms.author: sumuth
...
ms.locfileid: "98606131"
---
# <a name="quickstart-use-net-c-to-connect-and-query-data-in-azure-database-for-postgresql---flexible-server"></a>Quickstart: Utilize .NET (C#) para ligar e consultar dados na Base de Dados Azure para PostgreSQL - Servidor Flexível
...
- Criar uma base de dados Azure para servidor flexível PostgreSQL utilizando [o portal Azure](./quickstart-create-server-portal.md) <br/> ou [Azure CLI](./quickstart-create-server-cli.md) se não tiver um.
- Utilize a base *de dados de postais* vazia disponível no servidor ou crie uma [nova base de dados](./quickstart-create-server-portal.md#connect-to-the-postgresql-database-using-psql).
