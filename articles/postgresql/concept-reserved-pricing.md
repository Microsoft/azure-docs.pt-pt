...
Por exemplo, suponhamos que está a executar uma base de dados Gen5 – 32 vCore PostgreSQL e duas bases de dados Gen5 – 16 vCore PostgreSQL. Além disso, supõe-se que planeie implementar dentro do próximo mês um servidor de base de dados gen5 – 32 vCore e um servidor de base de dados Gen5 – 16 vCore otimizado para a memória. Suponhamos que saiba que vai precisar destes recursos pelo menos por um ano. Neste caso, você deve comprar um vCore de 64 (2x32), reserva de um ano para uma única base de dados geral - Gen5 e um 48 (2x16 + 16) reserva de um ano para memória única de base de dados otimizada - Gen5
