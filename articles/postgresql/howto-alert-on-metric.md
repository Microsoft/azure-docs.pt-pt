---
title: Configurar alertas de métricas da base de dados do Azure para PostgreSQL - servidor único no portal do Azure
description: Este artigo descreve como configurar e alertas de métricas de acesso da base de dados do Azure para PostgreSQL - servidor único a partir do portal do Azure.
author: rachel-msft
ms.author: raagyema
...
ms.locfileid: "65067309"
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-postgresql---single-server"></a>Utilizar o portal do Azure para configurar alertas em métricas da base de dados do Azure para PostgreSQL - servidor único
