...
Geralmente, os problemas de ligação à Hiperescala podem ser classificados da seguinte forma:
...
* Configuração da firewall do nó coordenador: Certifique-se de que a firewall do servidor Hyperscale está configurada para permitir ligações do seu cliente, incluindo servidores proxy e gateways.
