...
## <a name="retired-postgresql-engine-versions-not-supported-in-azure-postgresql"></a>Versões de motor pós-SQL aposentadas não suportadas no Azure PostgreSQL
...
- Se algum problema de suporte que possa experimentar se referir à base de dados PostgreSQL, não poderemos fornecer-lhe apoio. Nesses casos, terá de atualizar a sua base de dados para que lhe forneçamos qualquer suporte.
...
- Em caso de vulnerabilidade séria de segurança na base de dados identificada na versão de base de dados reformada, o Azure pode optar por atualizar automaticamente a sua base de dados para uma versão superior.
