...
- Na base de dados Azure alvo para o servidor PostgreSQL, considere fazer o seguinte antes da restauração:
    - Desligue o rastreio do desempenho da consulta, uma vez que estas estatísticas não são necessárias durante a migração. Pode fazê-lo definindo pg_stat_statements.track, pg_qs.query_capture_mode e pgms_wait_sampling.query_capture_mode a NENHUM.
