...
* Certifique-se de que a sua região de espaço de trabalho Log Analytics, a região de conta de automação e a sua região alvo são todas as regiões apoiadas pelos mapeamentos da região [aqui.](https://docs.microsoft.com/azure/automation/how-to/region-mappings)
...
Para mais detalhes sobre como mover os seus VMs, consulte este [artigo](https://docs.microsoft.com/azure/resource-mover/tutorial-move-region-virtual-machines).
