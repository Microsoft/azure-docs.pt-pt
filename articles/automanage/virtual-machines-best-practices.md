...
|Adicionar Conta de Automatização    |A Azure Automation suporta a gestão ao longo do ciclo de vida da sua infraestrutura e aplicações. Saiba [mais.](../automation/automation-intro.md)    |Azure VM Melhores Práticas – Produção, Azure VM Melhores Práticas – Dev/Teste    |Não    |
...
<sup>1 Os</sup> perfis de configuração estão disponíveis quando está a ativar a auto-produção. Saiba [mais.](automanage-virtual-machines.md) Também pode ajustar as definições padrão do perfil de configuração e definir as suas preferências dentro das melhores práticas.
