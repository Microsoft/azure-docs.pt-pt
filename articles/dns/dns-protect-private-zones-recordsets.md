...
![Nível de grupo de recursos RBAC através do portal Azure](./media/dns-protect-private-zones-recordsets/rbac1.png)
...
### <a name="private-zone-level-rbac"></a>Rbac de zona privada
...
Permissões RBAC ao nível da zona podem ser concedidas através do portal Azure.  Controlo **de acesso aberto (IAM)** para a zona, selecione **Adicionar,** em seguida, selecione a função **Contribuinte da Zona DNS** Privada. Selecione os utilizadores ou grupos necessários para conceder permissões.
