...
description: Neste tutorial aprende-se a configurar o Azure DNS para acolher as suas zonas DNS.
services: dns
author: rohinkoul
ms.service: dns
ms.topic: tutorial
...
1. Com a zona DNS criada, no painel **Favoritos** do portal do Azure, selecione **Todos os recursos**. Na página **Todos os recursos**, selecione a zona de DNS. Se a subscrição que selecionou já tiver vários recursos, pode introduzir o seu nome de domínio na caixa de **nomes Filter para** aceder facilmente ao gateway da aplicação. 

1. Obtenha os servidores de nome na página da zona DNS. Neste exemplo, a zona contoso.net foi atribuída a servidores *de nomes ns1-01.azure-dns.com*, *ns2-01.azure-dns.net*, *ns3-01.azure-dns.org*, e *ns4-01.azure-dns.info:*
