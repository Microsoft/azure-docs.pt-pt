...
* Para obter mais informações sobre como trabalhar com bloqueios de recursos, consulte [Bloquear recursos com Azure Resource Manager](../azure-resource-manager/resource-group-lock-resources.md).
