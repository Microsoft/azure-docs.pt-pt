...
| Serviços Cloud do Azure |[IP público](dns-custom-domain.md#public-ip-address) |Para endereços IP distribuídos estáticamente, pode criar um registo DNS A. Para endereços IP dinamicamente atribuídos, deve criar um registo CNAME que mapeie para o nome *cloudapp.net.*|
