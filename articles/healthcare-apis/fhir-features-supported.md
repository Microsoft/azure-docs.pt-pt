...
| patch                          | Não        | Não        | Não        |                                                     |
| delete                         | Sim       | Sim       | Sim       |  Ver Nota Abaixo                                                   |
...
| `_count`                | Sim       | Sim       | Sim       | `_count` está limitado a 1000 caracteres. Se for fixado para mais de 1000, apenas 1000 serão devolvidos e um aviso será devolvido no pacote. |
