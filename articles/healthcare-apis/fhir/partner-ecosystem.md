---
title: Ecossistema parceiro em torno da Azure API para FHIR
description: Este artigo destaca alguns parceiros que fornecem serviços exclusivos de IP ou consultoria para construir uma solução de ponta a ponta com a Azure API para fHIR
...
ms.locfileid: "103019691"
---
# <a name="partner-ecosystem-for-azure-api-for-fhir"></a>Ecossistema parceiro para Azure API para FHIR
Estamos entusiasmados com o facto de a Azure API para a FHIR ter sido lançada em geral disponibilidade para todos os Clientes Azure. Estamos ainda mais entusiasmados com as soluções que irá construir com o nosso serviço.  

Ao criar uma solução de ponta a ponta construída em torno da Azure API para fHIR, poderá necessitar da ajuda de um parceiro para o seu IP único ou para ajudar a coser tudo. Estamos a trabalhar arduamente para criar este ecossistema de parceiros diversos e gostaria de apresentá-lo a alguns deles.


| Parceiro          | Capacidades                               | Países/Regiões Apoiados         | Contacto                                                                                                                                |
|------------------|--------------------------------------------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| Medalha            | Des-identificação, conversão Legacy-FHIR  | E.U.A.                         | [Contacto](https://asab.squarespace.com/asab-medal/)                                                                                           |
| Rapsódia         | Conversão Legacy-FHIR                     | EUA, Austrália, Nova Zelândia | [Contacto](https://rhapsody.health/contact-us)                                                                                          |
| iNTERFACEWARE    | Conversão Legacy-FHIR                     | EUA                 | [Contacto](https://www.interfaceware.com/contact)                                                                                  |
