...
description: Descreve os conceitos de reprovisionamento de dispositivos para o serviço de provisionamento de dispositivos no Hub IoT do Azure
author: wesmc7777
ms.author: wesmc
ms.date: 04/04/2019
ms.topic: conceptual
...
| API REST | SDK DO C | SDK Python |  SDK de Node | SDK Java | SDK .NET |
| -------- | ----- | ---------- | --------- | -------- | -------- |
