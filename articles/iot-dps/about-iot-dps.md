...
* **O suporte multi-hub** permite que o DPS ligue os dispositivos a um hub IoT no tempo de execução. O DPS pode falar com centros em várias subscrições do Azure.
