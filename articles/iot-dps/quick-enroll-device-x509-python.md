...
description: Este início rápido utiliza inscrições em grupo. Neste guia de início rápido, você registrará dispositivos X. 509 no DPS (serviço de provisionamento de dispositivos) do Hub IoT do Azure usando o Python
author: wesmc7777
ms.author: wesmc
ms.date: 11/08/2019
ms.topic: quickstart
