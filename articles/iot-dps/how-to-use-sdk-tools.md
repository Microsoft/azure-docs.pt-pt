...
1. [Preparar o ambiente de desenvolvimento](https://docs.microsoft.com/azure/iot-dps/quick-enroll-device-x509-java) e clonar o repositório GitHub:
   ...
   ```
2. Navegue para a pasta ```azure-iot-sdk-java/provisioning/provisioning-tool/tpm-simulator/```do simulador TPM em baixo . .
...
4. Navegue até à raiz do Gerador ```azure-iot-sdk-java/provisioning/provisioning-tools/provisioning-x509-cert-generator```de Certificados X.509 em .
