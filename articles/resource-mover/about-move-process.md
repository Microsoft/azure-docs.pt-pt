...
| **Passo 6: Eliminar fonte** | Depois de cometer o movimento e verificar os recursos na região alvo, pode eliminar o recurso de origem. | Após a sua commissão, um estado de recursos desloca-se para *eliminar a fonte pendente*. Em seguida, pode selecionar o recurso de origem e eliminá-lo.<br/><br/> - Apenas os recursos na *fonte de exclusão do* estado pendente podem ser eliminados. <br/><br/>A eliminação de um grupo de recursos ou do SQL Server no portal Resource Mover não é suportada. Estes recursos só podem ser eliminados da página de propriedades de recursos. |
