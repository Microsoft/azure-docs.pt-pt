...
5. Na **região dos Metadados,** selecione onde pretende armazenar metadados sobre os recursos que está a mover.  Um grupo de recursos é criado especificamente para este fim. e selecione **Seguinte**.
