...
description: Neste artigo, você aprenderá a armazenar resultados de consulta para armazenamento usando piscina SQL sem servidor (pré-visualização).
...
ms.locfileid: "93322619"
---
# <a name="store-query-results-to-storage-using-serverless-sql-pool-preview-in-azure-synapse-analytics"></a>Armazenar resultados de consulta para armazenamento usando piscina SQL sem servidor (pré-visualização) em Azure Synapse Analytics

Neste artigo, você aprenderá a armazenar resultados de consulta para armazenamento usando piscina SQL sem servidor (pré-visualização).
