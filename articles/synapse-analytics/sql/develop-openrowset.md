...
Especifica a página de código dos dados no ficheiro de dados. O valor predefinido é de 65001 (codificação UTF-8). Consulte mais detalhes sobre esta opção [aqui.](/sql/t-sql/functions/openrowset-transact-sql?view=sql-server-ver15#codepage)
