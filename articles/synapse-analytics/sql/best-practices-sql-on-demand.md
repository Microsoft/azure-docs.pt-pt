...
Reveja o artigo [de resolução de problemas](../sql-data-warehouse/sql-data-warehouse-troubleshoot.md?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json) para encontrar soluções para problemas comuns. Se você está trabalhando com piscina SQL dedicada em vez de piscina SQL sem servidor, consulte [as melhores práticas para piscinas SQL dedicadas](best-practices-sql-pool.md) para orientação específica.
