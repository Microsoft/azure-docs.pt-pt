...
ms.locfileid: "96451587"
---
# <a name="connect-to-synapse-sql-with-visual-studio-and-ssdt"></a>Ligar ao Synapse SQL com o Visual Studio e o SSDT
...
> [!NOTE]
> A piscina SQL sem servidor não é suportada por SSDT.
