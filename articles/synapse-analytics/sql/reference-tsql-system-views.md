...
description: Links para a documentação para visualizações do sistema suportados em Synapse SQL.
author: filippopovic
...
---
# <a name="system-views-supported-in-synapse-sql"></a>Vistas do sistema suportadas em Synapse SQL
Links para a documentação para declarações T-SQL suportadas em Synapse SQL.

> [!NOTE]
> Synapse SQL on-demand suporta apenas vistas de catálogo do SQL Server.  

## <a name="sql-pool-catalog-views"></a>Vistas do catálogo da piscina SQL
...
* [sys.pdw_materialized_view_column_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (Pré-visualização)
* [sys.pdw_materialized_view_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (Pré-visualização)
...
## <a name="sql-pool-dynamic-management-views-dmvs"></a>Vistas de gestão dinâmica de piscina SQL (DMVs)
...
Os seguintes DMVs são aplicáveis ao pool SQL, mas devem ser executados ligando-se à base de dados **principal.**

* [sys.database_service_objetives](/sql/relational-databases/system-catalog-views/sys-database-service-objectives-azure-sql-database?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.assembléias](/sql/relational-databases/system-catalog-views/sys-assemblies-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.certificados](/sql/relational-databases/system-catalog-views/sys-certificates-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.colunas](/sql/relational-databases/system-catalog-views/sys-columns-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.credenciais](/sql/relational-databases/system-catalog-views/sys-credentials-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [bases de dados sys.](/sql/relational-databases/system-catalog-views/sys-databases-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.divisórias](/sql/relational-databases/system-catalog-views/sys-partitions-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [sys.procedimentos](/sql/relational-databases/system-catalog-views/sys-procedures-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.estatísticas](/sql/relational-databases/system-catalog-views/sys-stats-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.sys.synonyms](/sql/relational-databases/system-catalog-views/sys-synonyms-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.vistas](/sql/relational-databases/system-catalog-views/sys-views-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)

## <a name="sql-server-dmvs-available-in-sql-pool"></a>DMVs do servidor SQL disponíveis em piscina SQL

A piscina SQL expõe muitas das vistas dinâmicas de gestão do SQL Server (DMVs). Estas vistas, quando consultadas na piscina SQL, estão a reportar o estado das Bases de Dados SQL em execução nas distribuições.

O sQL pool e o Armazém de Dados Paralelos do Sistema de Plataformas Analíticas (PDW) utilizam as mesmas vistas do sistema. Cada DMV tem uma coluna chamada pdw_node_id, que é o identificador para o nó Compute.

> [!NOTE]
> Para utilizar estas vistas, insira 'pdw_nodes_' no nome, como mostra a tabela seguinte:

| Nome DMV na piscina SQL | Artigo Transact-SQL do Servidor SQL|
|:--- |:--- |
...
| sys.dm_pdw_nodes_tran_ative_snapshot_database_transactions |[sys.dm_tran_ative_snapshot_database_transactions](/sql/relational-databases/system-dynamic-management-views/sys-dm-tran-active-snapshot-database-transactions-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) |
| sys.dm_pdw_nodes_tran_ative_transactions |[sys.dm_tran_ative_transactions](/sql/relational-databases/system-dynamic-management-views/sys-dm-tran-active-transactions-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-pool"></a>DMVs PolyBase Do SQL Server 2016 disponíveis em piscina SQL
...
* [COLUNAS](/sql/relational-databases/system-information-schema-views/columns-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [ROTINAS](/sql/relational-databases/system-information-schema-views/routines-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
Para obter mais informações de referência, consulte [as declarações t-SQL em elementos de língua Synapse SQL](/azure/synapse-analytics/sql-data-warehouse/sql-data-warehouse-reference-tsql-language-elements)e [T-SQL em Synapse SQL](/azure/synapse-analytics/sql-data-warehouse/sql-data-warehouse-reference-tsql-statements).
