...
Para mais informações, também pode [visitar o guia do utilizador da Conda](https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/create-custom-channels.html) para criar canais personalizados. 
