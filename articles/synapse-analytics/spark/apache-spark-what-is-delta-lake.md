...
A versão atual do Delta Lake incluída com a Azure Synapse conta com suporte linguístico para Scala, PySpark e .NET. Existem links na parte inferior da página para exemplos e documentação mais detalhados.
