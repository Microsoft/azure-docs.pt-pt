...
A piscina SQL não suporta atualmente [.@NESTLEVEL](/sql/t-sql/functions/nestlevel-transact-sql?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest) Como tal, é preciso rastrear o nível do ninho. É improvável que exceda o limite de oito ninhos. Mas, se o fizeres, precisas de reformular o teu código para encaixar os níveis de nidificação dentro deste limite.
