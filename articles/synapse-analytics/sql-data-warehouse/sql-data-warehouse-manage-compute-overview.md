...
description: Saiba mais sobre as capacidades de escala de desempenho para piscina SQL dedicada (anteriormente SQL DW) em Azure Synapse Analytics. Dimensione ajustando OS DWUs, ou reduzindo os custos, fazendo uma pausa na piscina de SQL dedicada.
