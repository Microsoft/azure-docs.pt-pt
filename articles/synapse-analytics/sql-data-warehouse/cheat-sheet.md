...
Finalmente, usando a Gen2 de [piscina SQL,](sql-data-warehouse-overview-what-is.md#sql-analytics-and-sql-pool-in-azure-synapse)cada classe de recursos recebe 2,5 vezes mais memória do que a Gen1.
