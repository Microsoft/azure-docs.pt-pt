...
Para obter mais informações, consulte [Integrar-se com o Power BI,](/power-bi/connect-data/service-azure-sql-data-warehouse-with-direct-connect)ou a [documentação Power BI](https://powerbi.microsoft.com/blog/exploring-azure-sql-data-warehouse-with-power-bi/).
