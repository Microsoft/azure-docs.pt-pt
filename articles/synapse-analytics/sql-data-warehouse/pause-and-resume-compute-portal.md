...
Pode utilizar o portal Azure para parar e retomar os recursos de computação do synapse SQL (data warehouse). Se não tiver uma subscrição Azure, crie uma conta [gratuita](https://azure.microsoft.com/free/) antes de começar.
...
5. Uma pergunta de confirmação aparece perguntando se quer continuar. Clique **sim**.
...
5. Uma pergunta de confirmação aparece perguntando se quer começar. Clique **sim**.
