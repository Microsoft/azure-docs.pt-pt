---
title: Resolução de problemas Sinaapse SQL
...
| Como melhorar o desempenho com escala                      | Por vezes, a solução para melhorar o desempenho é simplesmente adicionar mais poder de computação às suas [consultas, escalando a sua piscina SQL](sql-data-warehouse-manage-compute-overview.md). |
