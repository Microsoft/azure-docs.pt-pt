...
- [O utilitário AZCopy](../../storage/common/storage-choose-data-transfer-solution.md) transfere dados para o Armazenamento Azure através da internet pública. Isto funciona se os seus tamanhos de dados forem inferiores a 10 TB. Para efetuar cargas regularmente com a AZCopy, teste a velocidade da rede para ver se é aceitável. 
...
- [A declaração da PolyBase e copy com a Azure Data Factory (ADF)](../../data-factory/load-azure-sql-data-warehouse.md) é outra ferramenta de orquestração.  Define um oleoduto e programa empregos. 
