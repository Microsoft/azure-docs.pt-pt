---
title: Quickstart - Crie uma piscina SQL Synapse (pré-visualização) usando o Synapse Studio
...
1. Não adicionaremos nenhuma etiqueta por enquanto, por isso selecione **Next: Review + create**.
