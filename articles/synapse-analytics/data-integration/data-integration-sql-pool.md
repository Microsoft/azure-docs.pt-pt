...
Para obter mais informações sobre a integração de dados para a Azure Synapse Analytics, consulte os [dados de Ingeste no artigo da Azure Data Lake Storage Gen2.](data-integration-data-lake.md)