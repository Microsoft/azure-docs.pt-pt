...
2. Selecione um ou mais ficheiros e, em seguida, crie um novo script SQL ou um notebook Spark para ver o conteúdo dos ficheiros. Se quiser criar um caderno, terá de criar uma [piscina Apache Spark no espaço de trabalho.](spark/apache-spark-notebook-create-spark-use-sql.md)
...
- [Criar piscina apache spark](spark/apache-spark-notebook-create-spark-use-sql.md)
