...
Ao contrário de piscinas SQL dedicadas, a faturação para SQL on demand baseia-se na quantidade de dados digitalizados para executar a consulta, e não no número de recursos utilizados para executar a consulta.
