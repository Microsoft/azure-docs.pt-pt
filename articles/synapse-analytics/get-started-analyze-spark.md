...
1. Executar o seguinte código para fazer a mesma análise que fizemos anteriormente com a piscina SQL dedicada **SQLDB1**. Este código guarda os resultados da análise numa tabela chamada **nyctaxi.passengercountstats** e visualiza os resultados.
...
Anteriormente copiamos dados da tabela de piscinas SQL dedicada **SQLDB1.dbo.Trip** para a mesa Spark **nyctaxi.trip**. Depois, usando a Spark, agregamos os dados na tabela Spark **nyctaxi.passengercountstats.** Agora vamos copiar os dados de **nyctaxi.passengercountstats** em uma mesa de bilhar SQL dedicada chamada **SQLDB1.dbo.PassengerCountStats**.
