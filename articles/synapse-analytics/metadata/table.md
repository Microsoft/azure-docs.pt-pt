...
Isto cria a tabela `myParquetTable` na base de `mytestdb` dados. Depois de um curto atraso, você pode ver a mesa em SQL on demand. Por exemplo, executar a seguinte declaração da SQL a pedido.
