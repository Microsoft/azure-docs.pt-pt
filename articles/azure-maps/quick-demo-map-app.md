...
description: Saiba como criar uma aplicação web de demonstração para pesquisa de mapas interativos utilizando o Microsoft Azure Maps web SDK.
author: anastasia-ms
ms.author: v-stharr
ms.date: 7/10/2020
ms.topic: quickstart
