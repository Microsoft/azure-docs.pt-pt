...
description: Neste artigo, você vai aprender sobre como usar expressões de estilo orientadas por dados no Microsoft Azure Maps Web SDK.
author: rbrundritt
ms.author: richbrun
ms.date: 4/4/2019
ms.topic: conceptual
...
| Expressão | Tipo de retorno | Description |
|------------|-------------|-------------|
