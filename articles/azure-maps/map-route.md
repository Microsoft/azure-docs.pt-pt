...
No código acima, o primeiro bloco de código constrói um objeto de mapa e define o mecanismo de autenticação a utilizar a chave de subscrição. Pode ver [criar um mapa](./map-create.md) para obter instruções.
...
O sexto bloco de código consulta o serviço de encaminhamento de mapas do Azure, que faz parte do [módulo do serviço](https://atlas.microsoft.com/sdk/javascript/mapcontrol/2/atlas-service.min.js). O [calculateRouteDirections](https://docs.microsoft.com/javascript/api/azure-maps-rest/atlas.service.routeurl?view=azure-iot-typescript-latest#methods) método da RouteURL é usado para obter uma rota entre os pontos inicial e final. Uma coleção de recursos de GeoJSON da resposta é extraída, em seguida, usando o `geojson.getFeatures()` método e é adicionado à origem de dados. Ela então processa a resposta como uma rota no mapa. Para obter mais informações sobre como adicionar uma linha para o mapa, consulte [adicionar uma linha no mapa](./map-add-shape.md#addALine).
...
Uma [camada de símbolo](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.layer.symbollayer?view=azure-iot-typescript-latest) usa ou ícones de texto para processar dados com base no ponto encapsulados no [DataSource](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.source.datasource?view=azure-iot-typescript-latest) como símbolos no mapa. O quinto bloco de código cria e adiciona uma camada de símbolo ao mapa. Ver as propriedades de uma camada de símbolo em [SymbolLayerOptions](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.symbollayeroptions?view=azure-iot-typescript-latest).
...
O último bloco de código utiliza a [API buscar](https://fetch.spec.whatwg.org/) para fazer um pedido de pesquisa para o [API de rota do Azure Maps](https://docs.microsoft.com/rest/api/maps/route/getroutedirections). A resposta, em seguida, é analisada. Se a resposta foi concluída com êxito, as informações de latitude e longitude são utilizadas para criar uma linha de uma matriz ao ligar esses pontos. Os dados de linha, em seguida, são adicionados à origem de dados para processar a rota no mapa. Pode ver [adicionar uma linha no mapa](./map-add-shape.md#addALine) para obter instruções.
