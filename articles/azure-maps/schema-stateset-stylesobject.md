...
|-----------|----------|-------------|-------------|
| `keyName` | cadeia | O *state* estado ou nome de propriedade dinâmica. A `keyName` deve ser único dentro da `StyleObject` matriz.| Sim |
| `type` | cadeia | Valor é "numérico". | Sim |
...
| Propriedade | Tipo | Descrição | Obrigatório |
|-----------|----------|-------------|-------------|
| `keyName` | cadeia |  O *state* estado ou nome de propriedade dinâmica.  A `keyName` deve ser único dentro da matriz de estilo.| Sim |
| `type` | cadeia |Valor é "boolean". | Sim |
