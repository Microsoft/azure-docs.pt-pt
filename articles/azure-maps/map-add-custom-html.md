...
> [!IMPORTANT]
> Ao contrário da maioria das camadas no controle da Web do Azure Maps que usam WebGL para renderização, os marcadores de HTML usam elementos DOM tradicionais para renderização. Como tal, quanto mais marcadores HTML adicionados a uma página, mais elementos DOM existem. O desempenho pode diminuir depois de adicionar algumas centenas de marcadores de HTML. Para conjuntos de dados maiores, considere o clustering dos dados ou o uso de um símbolo ou camada de bolha.
