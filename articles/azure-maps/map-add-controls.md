...
Este artigo mostra-lhe como adicionar controlos a um mapa. Você também vai aprender a criar um mapa com todos os controlos e um [picker de estilo](./choose-map-style.md).
