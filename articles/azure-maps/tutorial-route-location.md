...
description: Aprenda a encontrar uma rota para um ponto de interesse. Veja como definir coordenadas de endereço e consultar o serviço de Rota Azure Maps para as direções ao ponto.
author: anastasia-ms
ms.author: v-stharr
ms.date: 01/14/2020
ms.topic: tutorial
