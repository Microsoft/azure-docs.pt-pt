...
description: Saiba como utilizar a biblioteca JavaScript do lado do cliente do Microsoft Azure Maps para tornar os mapas e incorporar a funcionalidade Azure Maps na sua aplicação web ou móvel.
author: anastasia-ms
ms.author: v-stharr
ms.date: 07/20/2020
ms.topic: conceptual
