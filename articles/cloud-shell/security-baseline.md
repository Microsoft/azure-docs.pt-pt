...
ms.locfileid: "92210243"
---
# <a name="azure-security-baseline-for-cloud-shell"></a>Linha de segurança Azure para Cloud Shell

Esta linha de base de segurança aplica orientações da [versão 1.0 do Benchmark de Segurança Azure](../security/benchmarks/overview-v1.md) para cloud Shell. O Azure Security Benchmark fornece recomendações sobre como pode proteger as suas soluções em nuvem no Azure.
