...
Se quiser saltar diretamente para o código, veja o [quickstart Python](https://github.com/Azure-Samples/azure-cache-redis-samples/tree/main/quickstart/python) no GitHub.
