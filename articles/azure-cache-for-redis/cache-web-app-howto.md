...
2. Adicione as `using` seguintes declarações na parte superior do ficheiro.
...
3. Adicione os seguintes membros à `HomeController` classe para apoiar uma nova `RedisCache` ação que executa alguns comandos contra a nova cache.
