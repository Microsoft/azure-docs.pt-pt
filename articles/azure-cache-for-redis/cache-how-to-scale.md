---
title: Como dimensionar o cache do Azure para Redis | Microsoft Docs
description: Saiba como dimensionar seu cache do Azure para instâncias de Redis
services: cache
documentationcenter: ''
author: yegu-ms
manager: jhubbard
