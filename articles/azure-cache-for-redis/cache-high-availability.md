...
| [Redundância entre zonas](#zone-redundancy) | Configuração replicada em vários nóns em AZs, com falha automática | Até 99,99% (ver [detalhes)](https://azure.microsoft.com/support/legal/sla/cache/v1_0/) |-|Pré-visualizar|✔|
