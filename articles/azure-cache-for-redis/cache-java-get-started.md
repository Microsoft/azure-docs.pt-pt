...
Se quiser saltar diretamente para o código, consulte o [arranque rápido](https://github.com/Azure-Samples/azure-cache-redis-samples/tree/main/quickstart/java) de Java no GitHub.
