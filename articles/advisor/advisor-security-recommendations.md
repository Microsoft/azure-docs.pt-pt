---
title: Tornar os recursos mais seguros com o Azure Advisor
...
O Azure Advisor fornece-lhe uma visão consistente e consolidada das recomendações para todos os seus recursos Azure. Integra-se com o Azure Security Center para lhe trazer recomendações de segurança. Pode obter recomendações de segurança a partir do separador **Segurança** no painel de instrumentos Do Advisor.
