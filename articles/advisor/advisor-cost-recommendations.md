...
### <a name="synapse-analytics-formerly-sql-data-warehouse-reserved-capacity"></a>Synapse Analytics (antigo ARMAZÉM DE DADOS SQL) reservado capacidade
