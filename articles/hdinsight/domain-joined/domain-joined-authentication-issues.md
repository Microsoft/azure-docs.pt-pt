...
* Se tiver uma [máquina de janelas de domínio,](../../active-directory-domain-services/manage-domain.md)pode utilizar as ferramentas padrão do Windows AD para navegar. Isto requer uma conta de trabalho no domínio.
