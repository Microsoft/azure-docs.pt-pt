...
1. Observe as chaves que começam `fs.azure.account.key` com . O nome da conta será uma parte da chave vista nesta imagem de amostra:
   ...
   :::image type="content" source="./media/hdinsight-hadoop-add-storage/apache-ambari-verification.png" alt-text="verificação através de Apache Ambari":::
