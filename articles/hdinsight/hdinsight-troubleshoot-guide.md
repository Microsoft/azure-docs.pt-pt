...
| Troncos e despejos | - [Aceder a registos de aplicações apache Hadoop YARN no Linux](hdinsight-hadoop-access-yarn-app-logs-linux.md)<br>- [Permitir despejos de pilhas para serviços Apache Hadoop em Linux](hdinsight-hadoop-collect-debug-heap-dump-linux.md)<br>- [Analisar registos HDInsight](hdinsight-debug-jobs.md)|
