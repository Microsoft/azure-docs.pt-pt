...
| --- | --- |
| Azure HDInsight SDK for .NET (SDK do Azure HDInsight para .NET)|Ver [Azure HDInsight SDK para .NET](/dotnet/api/overview/azure/hdinsight) |
