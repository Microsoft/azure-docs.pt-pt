...
1. Crie as regras a seguir na seção **marcas de serviço** :
   ...
   | **Nome** | **Protocolo** | **Endereço de origem** | **Marcas de serviço** | **Porta de destino** | **Notas** |
   | --- | --- | --- | --- | --- | --- |
