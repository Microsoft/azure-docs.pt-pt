...
1. Expanda o cluster HDInsight para o que pretende implementar esta aplicação. Uma entrada com o texto **(Conta de Armazenamento Padrão)** é listada.
   ...
   :::image type="content" source="./media/apache-hadoop-dotnet-csharp-mapreduce-streaming/hdinsight-storage-account.png" alt-text="Conta de armazenamento, cluster HDInsight, Server Explorer, Visual Studio" border="true":::
...
1. Para fazer o upload dos ficheiros .exe, utilize um dos seguintes métodos:
    ...
    * Se estiver a utilizar uma **conta de armazenamento Azure,** selecione o ícone **Upload Blob.**
        ...
        :::image type="content" source="./media/apache-hadoop-dotnet-csharp-mapreduce-streaming/hdinsight-upload-icon.png" alt-text="HdInsight ícone de upload para mapper, Visual Studio" border="true":::
