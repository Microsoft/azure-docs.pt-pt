...
* Um cluster HDInsight, Azure SQL Server e base de dados como definido a partir [criar o cluster e a base de dados SQL](./hdinsight-use-sqoop.md#create-cluster-and-sql-database).
