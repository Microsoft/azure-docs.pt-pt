...
1. Editar o código abaixo para rubricar os valores para variáveis: `ExistingClusterName, ExistingClusterUsername, ExistingClusterPassword,DefaultStorageAccountName,DefaultStorageAccountKey,DefaultStorageContainerName` . Em seguida, use o código revisto como todo o conteúdo do **Programa.cs** em Estúdio Visual.
...
:::image type="content" source="./media/apache-hadoop-use-hive-dotnet-sdk/hdinsight-hadoop-use-hive-net-sdk-output.png" alt-text="Saída de trabalho da DDInsight Hadoop Hive" border="true":::
...
* [HdInsight .NET SDK referência](/dotnet/api/overview/azure/hdinsight)
