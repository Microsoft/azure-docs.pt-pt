...
* Uma __conta de armazenamento do Lago de Dados Azure__ que está associada ao cluster HDInsight. Para obter mais informações sobre a utilização do Azure Data Lake Storage com HDInsight, consulte [Quickstart: Configurar clusters em HDInsight](../storage/data-lake-storage/quickstart-create-connect-hdi-cluster.md).
...
* Utilize a [API HDInsight REST](https://msdn.microsoft.com/library/azure/mt622197.aspx) para aprender a usar o REST para executar ações de gestão em clusters HDInsight.
