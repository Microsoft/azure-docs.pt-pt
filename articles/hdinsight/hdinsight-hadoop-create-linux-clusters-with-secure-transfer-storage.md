...
Para a conta de armazenamento Azure CLI [az criar,](https://docs.microsoft.com/cli/azure/storage/account?view=azure-cli-latest#az-storage-account-create)certifique-se de que o parâmetro `--https-only` está definido para `true` .
