...
:::image type="content" source="./media/ml-services-quickstart-job-rstudio/connect-to-r-studio1.png" alt-text="Visão geral da consola web do estúdio R" border="true":::
