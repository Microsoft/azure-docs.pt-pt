...
**Menu esquerdo:**  
  ...
  - **Menu Definições**  
    ...
    |Ger1 de Armazenamento do Data Lake|Configure o acesso ao Data Lake Storage Gen1.  Consulte [Quickstart: Instale clusters em HDInsight](./hdinsight-hadoop-provision-linux-clusters.md).|
