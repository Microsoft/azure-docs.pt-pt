...
[Azure HDInsight SDK para Python](/python/api/overview/azure/hdinsight#sdk-installation)
...
Os snippets de código para esta funcionalidade SDK adicional podem ser encontrados na [documentação de referência hdInsight SDK para a documentação de referência python](/python/api/overview/azure/hdinsight).