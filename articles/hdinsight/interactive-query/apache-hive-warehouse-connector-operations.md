...
1. Ver os resultados com o seguinte comando:
    ...
    :::image type="content" source="./media/apache-hive-warehouse-connector/hive-warehouse-connector-show-hive-table.png" alt-text="conector de armazém de colmeia mostra tabela de colmeia" border="true":::
