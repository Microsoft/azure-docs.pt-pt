...
Para os nós operários D14v2, o valor recomendado para a fila llap é **de 80**.   
...
Se precisar de ajustar o número de executores, recomenda-se que considere 4 GB de memória por executor como especificado pelo *hive.tez.container.size* e certifique-se de que a memória total necessária para todos os executores não exceda a memória total disponível para o recipiente de daemon LLAP.  
