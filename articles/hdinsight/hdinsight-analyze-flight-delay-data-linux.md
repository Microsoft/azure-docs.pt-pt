...
description: Tutorial - Saiba como extrair dados de um conjunto de dados do CSV não processado, transformá-los utilizando o Hive no HDInsight e, em seguida, carregá-los no banco de dados SQL do Azure com o Apache Sqoop.
...
ms.locfileid: "67296534"
---
# <a name="tutorial-extract-transform-and-load-data-using-apache-hive-in-azure-hdinsight"></a>Tutorial: Extrair, transformar e carregar dados com o Apache Hive no HDInsight do Azure

Neste tutorial, pega um arquivo de dados não processado do CSV de dados de voo publicamente disponível, importe-o para um armazenamento de cluster do HDInsight e, em seguida, transforme os dados com [Apache Hive](https://hive.apache.org/) no Azure HDInsight. Depois dos dados são transformados, carregar dados para uma base de dados SQL do Azure com [Apache Sqoop](https://sqoop.apache.org/).
...
* Uma base de dados SQL do Azure. Vai utilizar uma base de dados SQL do Azure como arquivo de dados de destino. Se não tiver uma base de dados SQL, veja [Criar uma base de dados SQL do Azure no portal do Azure](../sql-database/sql-database-single-database-get-started.md).
...
Neste tutorial, que realizou bruto de um ficheiro de dados do CSV, importado-lo para um armazenamento de cluster do HDInsight e, em seguida, transformados os dados utilizando o Apache Hive no HDInsight do Azure.  Avance para o próximo tutorial para saber como utilizar o Azure Data Factory para criar clusters do HDInsight Hadoop a pedido.
...
* [Tutorial: Extrair, transformar e carregar dados com o Apache Hive no HDInsight do Azure](../storage/blobs/data-lake-storage-tutorial-extract-transform-load-hive.md)
...
* [Utilizar o Apache Oozie com o HDInsight](hdinsight-use-oozie-linux-mac.md)
* [Utilizar o Apache Sqoop com o HDInsight](hadoop/apache-hadoop-use-sqoop-mac-linux.md)