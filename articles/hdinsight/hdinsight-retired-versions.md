---
title: Versões aposentadas Azure HDInsight
description: Saiba mais sobre versões aposentadas em Azure HDInsight.
...
ms.locfileid: "103490250"
---
# <a name="retired-hdinsight-versions"></a>Versões HDInsight aposentadas

Neste artigo, aprende-se sobre versões aposentadas em HDInsight.

## <a name="retired-version-list"></a>Lista de versão aposentada

A tabela seguinte lista as versões aposentadas do HDInsight.
...
| HDInsight 1.6 |HDP 1.1 | |28 de outubro de 2013 |26 de abril de 2014 |31 de maio de 2015 |No |Não |

## <a name="next-steps"></a>Próximos passos

- [Componentes e versões Apache suportados em HDInsight](./hdinsight-component-versioning.md)
