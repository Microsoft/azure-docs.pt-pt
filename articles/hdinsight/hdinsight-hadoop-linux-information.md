...
* `wasbs:///`: Aceder ao armazenamento predefinido através de comunicação encriptada.  O esquema de wasbs é suportado apenas a partir da versão 3.6 da HDInsight.
...
* `abfs://`: Aceder ao armazenamento predefinido através de comunicação encriptada.
