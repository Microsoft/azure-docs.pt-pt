...
* Ligações a amostras para tarefas de criação de clusters.
* Links para conteúdo de referência para outras tarefas de gestão.
...
[Azure HDInsight SDK for .NET](/dotnet/api/overview/azure/hdinsight#sdk-installation) (SDK do Azure HDInsight para .NET)

## <a name="cluster-management---creation"></a>Gestão de clusters - criação
...
Os snippets de código para esta funcionalidade SDK adicional podem ser encontrados no [HDInsight SDK para documentação de referência .NET](/dotnet/api/overview/azure/hdinsight&preserve-view=true).
