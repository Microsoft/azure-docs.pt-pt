...
Os snippets de código para esta funcionalidade SDK adicional podem ser encontrados no [HDInsight SDK para documentação de referência .NET](/dotnet/api/overview/azure/hdinsight).
