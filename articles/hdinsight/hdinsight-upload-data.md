...
* Um cluster do Azure HDInsight. Para obter instruções, consulte [Iniciar com Azure HDInsight](hadoop/apache-hadoop-linux-tutorial-get-started.md).
