...
Os binários do Storm para a pilha HDP `/usr/hdp/current/storm-client`atual estão em. A localização é o mesmo para nós principais e nós de trabalho.
