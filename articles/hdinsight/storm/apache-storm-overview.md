...
Para obter informações sobre cenários do mundo real, consulte o documento [como as empresas estão usando Apache Storm](https://storm.apache.org/Powered-By.html) .
