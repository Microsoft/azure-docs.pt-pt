...
* Apache Storm
  ...
  * Ferramenta de interface de linha de comando (CLI)
    ...
    :::image type="content" source="./media/hdinsight-administer-use-powershell/hdinsight-portal-scale-cluster-storm-rebalance.png" alt-text="Reequilibrar escala de tempestade HDInsight":::
