...
A partir desta versão, os clientes podem utilizar urLs de encriptação sem versão Azure KeyValut para encriptação de chaves gerida pelo cliente em repouso. O HDInsight roda automaticamente as teclas à medida que caducam ou são substituídas por novas versões. Saiba mais detalhes [aqui.](https://docs.microsoft.com/azure/hdinsight/disk-encryption)
