...
1. Para determinar quais configurações do Spark precisam ser definidas e para quais valores, consulte o que causa uma exceção de OutofMemoryError do aplicativo de Apache Spark.
