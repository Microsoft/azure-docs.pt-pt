...
Para instruções de instalação, consulte a instalação do [Kit de Ferramentas Azure para eclipse](https://docs.microsoft.com/azure/developer/java/toolkit-for-eclipse/installation).
