...
ms.locfileid: "67066162"
---
# <a name="quickstart-create-apache-spark-cluster-in-azure-hdinsight-using-azure-portal"></a>Início rápido: Criar cluster do Apache Spark no HDInsight do Azure através do portal do Azure
