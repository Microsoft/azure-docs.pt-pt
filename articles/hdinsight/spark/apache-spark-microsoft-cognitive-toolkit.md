...
1. A partir do Bloco de Notas do Jupyter, **selecione Upload** no canto superior direito e, em seguida, navegue para o download e selecione o ficheiro `CNTK_model_scoring_on_Spark_walkthrough.ipynb` .
    ...
    :::image type="content" source="./media/apache-spark-microsoft-cognitive-toolkit/hdinsight-microsoft-cognitive-toolkit-load-jupyter-notebook.png " alt-text="Upload Jupyter Notebook para Azure HDInsight Spark cluster" border="true":::
