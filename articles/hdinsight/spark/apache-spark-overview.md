...
HDInsight Spark agrupa um [controlador ODBC](/sql/connect/odbc/download-odbc-driver-for-sql-server?view=sql-server-ver15) para a conectividade a partir de ferramentas BI, como o Microsoft Power BI.
