...
:::image type="content" source="./media/apache-spark-overview/hdinsight-spark-overview.png" alt-text="Spark: uma arquitetura unificada" border="false":::
...
:::image type="content" source="./media/apache-spark-overview/map-reduce-vs-spark1.png" alt-text="MapReduce tradicional vs. Faísca" border="false":::
...
| Facilidade de utilização |O cluster de faíscas em HDInsight inclui cadernos Jupyter e Cadernos Apache Zeppelin. Pode utilizar estes blocos de notas para o processamento e a visualização de dados interativos. Consulte [os cadernos Apache Zeppelin com dados de Faíscas](apache-spark-zeppelin-notebook.md) e Carga Apache [e execute consultas num cluster Apache Spark](apache-spark-load-data-run-query.md).|
...
HDInsight Spark agrupa um [controlador ODBC](/sql/connect/odbc/download-odbc-driver-for-sql-server) para a conectividade a partir de ferramentas BI, como o Microsoft Power BI.

## <a name="spark-cluster-architecture"></a>Arquitetura de cluster do Spark

:::image type="content" source="./media/apache-spark-overview/hdi-spark-architecture.png" alt-text="A arquitetura do Spark no HDInsight" border="false":::
