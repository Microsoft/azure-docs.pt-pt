...
| Opção | Documentos |
|---|---|
| Data Lake Storage Gen2 | [Utilizar o Azure Data Lake Storage Gen2 com clusters do Azure HDInsight](../hdinsight-hadoop-use-data-lake-storage-gen2.md) |
| Ger1 de Armazenamento do Data Lake | [Use data lake storage Gen1 com clusters Azure HDInsight](../hdinsight-hadoop-use-data-lake-store.md) |
