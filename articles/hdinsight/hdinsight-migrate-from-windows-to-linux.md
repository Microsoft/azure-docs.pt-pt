...
Ver [criar uma aplicação Apache HBase baseado em Java](hbase/apache-hbase-build-java-maven-linux.md) para um cliente de exemplo que define esse valor.
