...
:::image type="content" source="./media/apache-kafka-introduction/kafka-cluster-diagram.png" alt-text="Diagrama de configuração do cluster do Kafka" border="false":::
