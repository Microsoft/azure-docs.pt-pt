...
Cada região do Azure tem um número específico de domínios de falha. Para uma lista de domínios e o número de domínios de avaria que contêm, consulte a documentação sobre [os conjuntos de disponibilidade](../../virtual-machines/windows/manage-availability.md).
