...
* Regras da aplicação que definem nomes de domínio completamente qualificado (FQDNs) que podem ser acedidos a partir de uma sub-rede. O FQDN também pode [incluir instâncias do SQL](sql-fqdn-filtering.md).
