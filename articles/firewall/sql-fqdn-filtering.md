...
Para saber sobre os modos de procuração e redirecionamento da SQL, consulte a arquitetura de conectividade da base de [dados Azure SQL](../azure-sql/database/connectivity-architecture.md).