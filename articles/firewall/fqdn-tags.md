...
|Tag FQDN  |Descrição  |
|---------|---------|
|Windows Update     |Permitir o acesso de saída ao Microsoft Update, conforme descrito em [Como Configurar uma Firewall para atualizações de software](https://technet.microsoft.com/library/bb693717.aspx).|
