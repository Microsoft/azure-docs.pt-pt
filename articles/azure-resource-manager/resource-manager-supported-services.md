...
Para obter uma lista que mapeia os fornecedores de recursos para os serviços do Azure, consulte [fornecedores de recursos para serviços do Azure](azure-services-resource-providers.md).
