...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | configurationStores | grupo de recursos | 5-50 | Alfanuméricos, sublinhados e hifens. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | bloquea | escopo da atribuição | 1-90 | Alfanuméricos, pontos, sublinhados, hifens e parênteses.<br><br>Não pode terminar no período. |
...
> | galerias/imagens/versões | imagem | inteiro de 32 bits | Números e pontos. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | containerGroups | grupo de recursos | 1-63 | Letras minúsculas, números e hifens.<br><br>Não é possível iniciar ou terminar com hífen. Os hífens consecutivos não são permitidos. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | registros | global | 5-50 | Alfanuméricos. |
> | registros/buildTasks | registry | 5-50 | Alfanuméricos. |
> | registros/buildTasks/etapas | Compilar tarefa | 5-50 | Alfanuméricos. |
> | registros/replicações | registry | 5-50 | Alfanuméricos. |
> | registros/scopeMaps | registry | 5-50 | Alfanuméricos, hifens e sublinhados. |
> | registros/tarefas | registry | 5-50 | Alfanuméricos, hifens e sublinhados. |
> | registros/tokens | registry | 5-50 | Alfanuméricos, hifens e sublinhados. |
> | registros/WebHooks | registry | 5-50 | Alfanuméricos. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | SAS | grupo de recursos | 1-180 | Não é possível usar:<br>`%&\\?/`<br><br>Não é possível terminar com período ou espaço. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | sejam | grupo de recursos | 3-24 | Alfanuméricos, hifens, sublinhados e pontos. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | áreas de trabalho | grupo de recursos | 3-30 | Alfanuméricos, sublinhados e hifens |
...
> | fábricas/integrationRuntimes | padrões | 3-63 | Alfanuméricos e hifens.<br><br>Comece e termine com alfanumérico. |
...
> | fábricas/gatilhos/rerunTriggers | of | 1-260 | Não é possível usar:<br>`<>*#.%&:\\+?/`<br><br>Comece com alfanumérico. |
...
> | contas/dataLakeStoreAccounts | conta | 3-24 | Letras minúsculas e números. |
> | contas/firewallRules | conta | 3-50 | Alfanuméricos, hifens e sublinhados. |
> | contas/storageAccounts | conta | 3-60 | Alfanuméricos, hifens e sublinhados. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | prático | grupo de recursos | 1-50 | Alfanuméricos, sublinhados e hifens. |
...
> | Tópicos do | grupo de recursos | 3-50 | Alfanuméricos e hifens. |
...
> | namespaces/Eventhubs | espaço de nomes | 1-50 | Alfanuméricos, pontos, hifens e sublinhados.<br><br>Comece e termine com letra ou número. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | sejam | grupo de recursos | 2-64 | Alfanuméricos e hifens.<br><br>Comece com a letra. |
...
> | fluxos | grupo de recursos | 1-80 | Alfanuméricos, hifens, sublinhados, pontos e parênteses. |
...
> | áreas de trabalho | grupo de recursos | 1-260 | Não é possível usar:<br>`<>*%&:?+/\\`<br><br>Não é possível terminar com um espaço. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | áreas de trabalho | grupo de recursos | 3-33 | Alfanuméricos e hifens. |
> | espaços de trabalho/computações | área de trabalho | 2-16 | Alfanuméricos e hifens. |
...
> | namespaces/notificationHubs | espaço de nomes | 1-260 | Alfanuméricos, pontos, hifens e sublinhados.<br><br>Iniciar alfanumérico. |
...
> | áreas de trabalho | grupo de recursos | 4-63 | Alfanuméricos e hifens.<br><br>Comece e termine com alfanumérico. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | unidades | . | 3-63 | Letras minúsculas ou números<br><br>Comece com uma letra minúscula. |
...
> | resourcegroups | subscrição | 1-90 | Alfanuméricos, sublinhados, parênteses, hifens, pontos e caracteres Unicode que correspondem à [documentação do Regex](/rest/api/resources/resourcegroups/createorupdate).<br><br>Não é possível terminar com período. |
...
> | namespaces/migrationConfigurations | espaço de nomes |  | Sempre deve ser **$Default**. |
> | namespaces/filas | espaço de nomes | 1-260 | Alfanuméricos, pontos, hifens, sublinhados e barras.<br><br>Comece e termine com alfanumérico. |
...
> | namespaces/tópicos | espaço de nomes | 1-260 | Alfanuméricos, pontos, hifens, sublinhados e barras.<br><br>Comece e termine com alfanumérico. |
...
> | namespaces/tópicos/assinaturas | tópico | 1-50 | Alfanuméricos, pontos, hifens e sublinhados.<br><br>Comece e termine com alphnumeric. |
> | namespaces/tópicos/assinaturas/regras | subscrição | 1-50 | Alfanuméricos, pontos, hifens e sublinhados.<br><br>Comece e termine com alphnumeric. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | clusters | . | 4-23 | Letras minúsculas, números e hifens.<br><br>Comece com uma letra minúscula. Terminar com letra minúscula ou número. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | esses | grupo de recursos | 2-50 | Alfanuméricos e hifens.<br><br>Comece com a letra. Terminar com alfanumérico. |
...
> | Entidade | Âmbito | Comprimento | Carateres Válidos |
> | --- | --- | --- | --- |
> | sistemas | grupo de recursos | 1-90 | Não é possível usar:<br>`'<>%&:\?/#` |
