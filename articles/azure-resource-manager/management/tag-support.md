...
> | espaços de trabalho / armazenamentoEncryption | No | No |
...
> | serviços / privateEndpointConnections | Yes | Yes |
> | serviços / privateLinkResources | Yes | Yes |
...
> | fornecedores / vendorskus / pré-visualizaçãoSubscrições | No | No |
> | funções de rede virtual | Yes | Yes |
> | virtualnetworkfunctionvendores | No | No |
