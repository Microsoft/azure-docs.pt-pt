...
> | registos / GetCredentials | No | Não |
...
> | datacatalogs / fontes de dados | Não | Não |
> | datacatalogs / fontes de dados / digitalizações | Não | Não |
> | datacatalogs / fontes de dados / digitalizações / conjuntos de dados | Não | Não |
> | datacatalogs / fontes de dados / digitalizações / gatilhos | Não | Não |
...
> | coleções / seguranças | Não | Não |
> | modeloImagem | Não | Não |
...
> [!NOTE]
> A base de dados Master não suporta tags, mas outras bases de dados, incluindo bases de dados do Armazém de Dados Azure SQL, tags de suporte. As bases de dados do Armazém de Dados Azure SQL devem estar no estado ativo (não pausado).
...
> | recomendações | No | Não |
> | recursoHealthMetadata | No | Não |
> | tempos de execução | No | Não |
> | serverFarms | Sim | Sim |
> | serverFarms / eventGridFilters | No | Não |
> | sites | Sim | Sim |
> | sites / config  | No | Não |
> | sites / eventGridFilters | No | Não |
> | sites / hostNameBindings | No | Não |
> | sites / redeConfig | No | Não |
> | sites / premieraddons | Sim | Sim |
> | sites / slots | Sim | Sim |
> | sites / slots / eventGridFilters | No | Não |
> | sites / slots / hostNameBindings | No | Não |
> | sites / slots / redeConfig | No | Não |
> | fonteControls | No | Não |
> | staticSites | Sim | Sim |
> | validar | No | Não |
> | verificarHostingEnvironmentVnet | No | Não |
...
> | ------------- | ----------- | ----------- |
> | diagnósticoS | No | Não |
> | diagnósticoSettingsCategories | No | Não |
...
> | ------------- | ----------- | ----------- |
> | componentes | No | Não |
> | componentesSummary | No | Não |
> | monitorInstâncias | No | Não |
> | monitorInstancesSummary | No | Não |
> | monitores | No | Não |
