...
ms.locfileid: "84020154"
---
# <a name="resource-providers-for-azure-services"></a>Fornecedores de recursos para serviços Azure

Este artigo mostra como os espaços de nome do fornecedor de recursos mapeiam os serviços do Azure.

## <a name="match-resource-provider-to-service"></a>Prestador de recursos de correspondência para o serviço
...
| Microsoft.Automação | [Automatização](../../automation/index.yml) |
...
| Microsoft.ClassicInfrastructureMigrate | Migração de modelos de implantação clássica |
...
| Microsoft.Dispositivos | [Azure IoT Hub](/azure/iot-hub/)<br />[Serviço Aprovisionamento de Dispositivos no Hub IoT do Azure](/azure/iot-dps/) |
...
| Microsoft.Sql | [Base de Dados SQL do Azure](../../azure-sql/database/index.yml)<br /> [Instância Gerida do Azure SQL](../../azure-sql/managed-instance/index.yml) <br />[Azure Synapse Analytics](/azure/sql-data-warehouse/) |
