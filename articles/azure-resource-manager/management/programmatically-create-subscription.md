...
| `managementGroupId` | Não      | Cadeia | A ID do grupo de gerenciamento ao qual a assinatura será adicionada. Para obter a lista de grupos de gerenciamento, consulte [API de lista de grupos de gerenciamento](/rest/api/resources/managementgroups/list). Use a ID de um grupo de gerenciamento da API. |
