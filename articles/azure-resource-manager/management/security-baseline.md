...
ms.locfileid: "93133608"
---
# <a name="azure-security-baseline-for-azure-resource-manager"></a>Linha de segurança Azure para gestor de recursos Azure

Esta linha de base de segurança aplica orientações da [versão 1.0 do Azure Security Benchmark](../../security/benchmarks/overview-v1.md) ao Microsoft Azure Resource Manager. O Azure Security Benchmark fornece recomendações sobre como pode proteger as suas soluções em nuvem no Azure.
