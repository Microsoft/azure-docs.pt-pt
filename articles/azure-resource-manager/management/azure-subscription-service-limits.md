...
Para obter mais informações sobre os limites dos Ficheiros Azure, consulte os [objetivos de escalabilidade e desempenho dos Ficheiros Azure.](../../storage/files/storage-files-scale-targets.md)
