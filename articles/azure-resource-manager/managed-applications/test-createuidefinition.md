...
* Um **createUiDefinition.jsarquivado.** Se não tiver este ficheiro, copie o [ficheiro da amostra.](https://github.com/Azure/azure-quickstart-templates/blob/master/100-marketplace-sample/createUiDefinition.json)
...
Depois de validar a interface do portal, saiba como disponibilizar a sua [aplicação gerida pelo Azure no Mercado.](../../marketplace/partner-center-portal/create-new-azure-apps-offer.md)