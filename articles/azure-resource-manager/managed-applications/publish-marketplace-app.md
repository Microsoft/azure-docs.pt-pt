...
1. Adicione um novo pacote. Preencha a secção **Detalhes do Pacote** no seguinte formulário:
   ...
   * **ID do locatário**: a ID do locatário para a conta para obter acesso.
...
![Descrição geral do Mercado](./media/publish-marketplace-app/publishvm11.png)
...
* Para obter informações sobre o que acontece depois que você clica em **publicar**, consulte [publicar a oferta de aplicativo do Azure](../../marketplace/cloud-partner-portal/azure-applications/cpp-publish-offer.md)
