...
Para obter uma descrição completa de como usar o **copyIndex**, consulte [criar várias instâncias de recursos no Azure Resource Manager](create-multiple-instances.md).
