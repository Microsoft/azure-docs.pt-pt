...
![Referência de modelo do Resource Manager implantar conta de armazenamento criptografada](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-tutorial-deploy-encrypted-storage-account.png)
...
3. Selecione referência/modelo de referência/ **armazenamento/&lt;versão > contas/Storage** , conforme mostrado na seguinte captura de tela:
    ...
    ![Conta de armazenamento de referência do modelo do Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts.png)
...
4. Encontre as informações de definição relacionadas com a encriptação.
    ...
    ![Encriptação da conta de armazenamento de referência do modelo do Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption.png)
    ...
    ![Objeto de encriptação da conta de armazenamento de referência do modelo do Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption-object.png)
...
![Recursos de conta de armazenamento encriptada de modelo do Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resources.png)
...
![Conta de armazenamento encriptada do Azure Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-account.png)
