...
Para definir o modo de implantação ao `Mode` ser implantado com o PowerShell, utilize o parâmetro.
...
Para definir o modo de implantação ao ser `mode` implantado com o Azure CLI, utilize o parâmetro.
