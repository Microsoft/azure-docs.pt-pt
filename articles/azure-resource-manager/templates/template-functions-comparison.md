...
A função é frequentemente utilizada com o elemento `condition` para testar se um recurso é implantado.
...
| verificarStrings | Bool | Verdadeiro |
| verificarArrays | Bool | Verdadeiro |
| verificarObjetos | Bool | Verdadeiro |
