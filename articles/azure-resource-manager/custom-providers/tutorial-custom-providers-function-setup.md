...
![Visão geral do provedor personalizado mostrando associações de tabela](./media/create-custom-provider/azure-functions-table-bindings.png)
...
![Visão geral do provedor personalizado mostrando métodos HTTP](./media/create-custom-provider/azure-functions-http-methods.png)
...
Para saber como criar um ponto de extremidade do provedor personalizado RESTful, consulte [tutorial: Criando um ponto de extremidade do provedor personalizado RESTful](./tutorial-custom-providers-function-authoring.md).
