...
1. Selecione **Experimente** para abrir o Cloud Shell e cole o seguinte script do PowerShell na janela do Shell.
...
2. Atualize o valor dos três elementos a seguir do recurso de extensão SQL:
