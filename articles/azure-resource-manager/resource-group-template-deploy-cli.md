...
Para passar parâmetros embutidos, forneça os valores `parameters`em. Por exemplo, para passar uma cadeia de caracteres e uma matriz para um modelo é um shell bash, use:
