...
*   Azure PowerShell instalado no computador cliente. [Baixar Azure PowerShell](/powershell/azure/azurerm/install-azurerm-ps).
...
3. Na **Automatização** de Adicionar:
   ...
   6. Para obter um link para acesso rápido no painel de instrumentos, verifique **Pin para painel de instrumentos**. Clique em **Criar**.
      ...
      Para mais informações, aceda à [conta Criar uma Conta Como](../automation/manage-runas-account.md)Executada.
