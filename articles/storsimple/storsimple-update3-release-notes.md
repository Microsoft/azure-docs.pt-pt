...
| 5 |Cópia de segurança |Em certos casos raros, nas versões anteriores do software, quando o utilizador fez uma cópia de segurança de um clone remoto, eles iriam encontrar erros na nuvem e a operação seria errada. Nesta versão, o problema é corrigido e a operação completa-se com sucesso. |Sim |Sim |
