...
|Posso transferir a propriedade de uma assinatura Azure para outro diretório? | Sim       | Não       | Associe uma subscrição existente ao seu diretório AD Azure | Consulte [Para associar uma subscrição existente ao seu diretório AD Azure](../active-directory/fundamentals/active-directory-how-subscriptions-associated-directory.md). Poderá demorar até 10 minutos para que tudo seja apresentado corretamente.|
