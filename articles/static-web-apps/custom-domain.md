...
Um registo CNAME mapeia um domínio para outro. Pode utilizar um registo CNAME para `www.example.com` mapear o domínio gerado automaticamente que é fornecido pela Azure Static Web Apps.
