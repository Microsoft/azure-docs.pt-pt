...
> [!IMPORTANT]
> A funcionalidade definida no *routes.jsem* ficheiro é agora depreciada e melhor implementada no [ficheiro de configuração](./configuration.md#routes)de Aplicações Web Estáticas Azure .
...
A tabela que se segue lista a localização adequada para colocar o seu _routes.jsem_ arquivo para uma série de quadros e bibliotecas frontais.
