...
> [!IMPORTANT]
> Navegue [http://localhost:4280](http://localhost:4280) para aceder à aplicação servida pelo CLI.
...
1. Navegue [http://localhost:4280](http://localhost:4280) para ver a aplicação no navegador.
