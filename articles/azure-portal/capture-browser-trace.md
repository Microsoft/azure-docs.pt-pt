...
1. Prima F12 ![ou selecione](media/capture-browser-trace/chromium-icon-settings.png) > Screenshot do ícone de configurações do navegador**Mais ferramentas Ferramentas** > **Developer**.
...
1. Pare o gravador de passos e guarde o ficheiro.

1. De volta ao painel de ferramentas de desenvolvimento do navegador, selecione o separador **Consola.** **Save as...**
...
1. Prima F12 ![ou selecione](media/capture-browser-trace/edge-icon-settings.png) > Screenshot do ícone de configurações do navegador**Mais ferramentas Ferramentas** > **Developer**.
...
1. Pare o gravador de ecrã e guarde o ficheiro.
