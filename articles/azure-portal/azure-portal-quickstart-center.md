...
* **Guias de instalação**: Projetado para o administrador de ti e o arquiteto de nuvem, nossos guias apresentam os principais conceitos para a adoção do Azure. As etapas estruturadas ajudam você a tomar medidas conforme você aprende, aplicando as práticas recomendadas da Microsoft. O guia de migração o ajudará a avaliar a preparação e o plano conforme você se prepara para mudar para o Azure.
...
2. Selecione **todos os serviços** na seção superior da barra lateral.
1. Selecione**centro de início rápido** **geral** > . Selecione o ícone de estrela para salvar em seus **favoritos**.
