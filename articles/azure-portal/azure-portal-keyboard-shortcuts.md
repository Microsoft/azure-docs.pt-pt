---
title: Atalhos de teclado do portal Azure
...
## <a name="keyboard-shortcuts-for-specific-pages-in-the-azure-portal"></a>Atalhos de teclado para páginas específicas no portal Azure

- [Explorador do Azure Resource Graph](../governance/resource-graph/reference/keyboard-shortcuts.md)

## <a name="next-steps"></a>Passos seguintes

- [Ativar o alto contraste ou a alteração de tema](set-preferences.md#choose-a-theme-or-enable-high-contrast)
