---
title: Como criar um pedido de apoio ao Azure Microsoft Docs
...
Com base no feedback do cliente, atualizámos a experiência de pedido de suporte para nos concentrarmos em três objetivos principais:
...
* **Eficiente**: Recolha as informações-chave de que o seu agente de suporte necessita para resolver eficazmente o seu problema.
...
2. Selecione **Novo pedido de suporte**. Siga as instruções para nos fornecer informações sobre o seu problema. Sugerimos algumas soluções possíveis, recolhemos detalhes sobre o assunto e ajudamos-te a submeter e rastrear o pedido de apoio.
...
2. Siga as instruções para nos fornecer informações sobre o problema que está tendo. Quando inicia o processo de pedido de suporte a partir do recurso, algumas opções são pré-selecionadas para si.
...
> [!NOTE]
> O Azure oferece apoio ilimitado para a gestão de subscrições, que inclui faturação, ajustamentos de quotas e transferências de conta. Para apoio técnico, precisa de um plano de apoio. [Saiba mais sobre planos de apoio.](https://azure.microsoft.com/support/plans)
>
>
...
Em seguida, recolhemos detalhes adicionais sobre o problema. Fornecer informações detalhadas e detalhadas neste passo ajuda-nos a encaminhar o seu pedido de apoio para o agente certo.
...
Depois de termos toda a informação sobre o problema, escolha como obter apoio. Na secção **método de suporte** de **Detalhes,** selecione a gravidade do impacto. Forneça o seu método de contacto preferido, uma boa altura para o contactar e o seu idioma de suporte.

Em seguida, preencha a secção **de informações de contato** para que saibamos como contactá-lo.

### <a name="review--create"></a>Revisão + criar

Preencha todas as informações necessárias em cada separador e, em seguida, selecione **Review + create**. Verifique os detalhes que vai enviar para o Suporte. Volte a qualquer separador para fazer uma mudança, se necessário. Quando estiver satisfeito, o pedido de apoio está completo, selecione **Criar**.

Um agente de apoio entrará em contacto consigo utilizando o método indicado. Para obter informações sobre o tempo inicial de resposta, consulte [o âmbito de suporte e a capacidade de resposta](https://azure.microsoft.com/support/plans/response/).

## <a name="all-support-requests"></a>Todos os pedidos de apoio

Pode ver os detalhes e o estado dos pedidos de apoio indo para **a Help + apoiar**todos os  >   **pedidos de suporte.**

![Todos os pedidos de apoio](./media/how-to-create-azure-support-request/allrequestslower.png)

Nesta página, pode filtrar pedidos de suporte por **Subscrição,** Data **Criada** (UTC) e **Estado.** Além disso, pode ordenar e procurar pedidos de apoio nesta página.

Selecione um pedido de apoio para visualizar detalhes, incluindo a gravidade e o tempo esperado que levará para um agente de suporte responder.

Se quiser alterar a gravidade do pedido, selecione **Impacto do Negócio**. Escolha entre uma lista de severidades a atribuir.

> [!NOTE]
> O nível máximo de gravidade depende do seu plano de apoio. [Saiba mais sobre planos de apoio.](https://azure.microsoft.com/support/plans)
>
>
...
* Obtenha ajuda dos seus pares na página de perguntas da [Microsoft Q&](https://docs.microsoft.com/answers/products/azure)
