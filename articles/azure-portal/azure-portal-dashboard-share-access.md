...
Seu painel agora está publicado. Se as permissões herdadas da subscrição forem adequadas, não precisa de fazer mais nada. Outros utilizadores da sua organização podem aceder e modificar o dashboard com base na sua função de nível de subscrição.
...
1. Selecione o papel que representa as permissões para conceder. Para este exemplo, selecione **colaborador**.
...
1. Quando terminar de adicionar usuários ou grupos, selecione **OK**.

    A nova atribuição é adicionada à lista de usuários. O seu **Acesso** está listado como **Atribuído** e não **herdado.**
