...
<ul class="panelContent cardsW">
    ...
                        <p><a href="/python/api/azure-mgmt-datalake-store/">Python (Gestão de Conta)</a></p>
                        <p><a href="https://docs.microsoft.com/python/api/azure-datalake-store/azure.datalake.store.core">Python (Gestão do Sistema de Ficheiros)</a></p>
                    </div>
                </div>
            </div>
        </div>
