---
title: Ofertas de parceiros - Soluções parceiras da Azure
description: Conheça as soluções oferecidas pelos parceiros na Azure.
author: tfitzmac
ms.topic: conceptual
...
As organizações parceiras oferecem soluções que pode usar no Azure para melhorar a sua infraestrutura em nuvem. Estas soluções estão totalmente integradas no Azure. Trabalha com estas soluções da mesma forma que trabalharia com soluções da Microsoft. Utiliza um fornecedor de recursos, tipos de recursos e SDKs para gerir a solução.
