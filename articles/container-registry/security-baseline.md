...
**Orientação**: Se utilizar definições de Política Azure personalizadas, utilize o Azure Repos para armazenar e gerir de forma segura o seu código.
