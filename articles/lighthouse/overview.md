...
ms.locfileid: "88163225"
---
# <a name="what-is-azure-lighthouse"></a>O que é o Azure Lighthouse?

O Azure Lighthouse oferece um único plano de controlo para visualizar e gerir os recursos do Azure em vários inquilinos com maior automatização, escala e maior governação. Com o Azure Lighthouse, os prestadores de serviços podem fornecer serviços geridos usando ferramentas de gestão abrangentes e robustas incorporadas na plataforma Azure. Esta oferta também pode beneficiar organizações de TI empresariais que gerem recursos em vários inquilinos.
