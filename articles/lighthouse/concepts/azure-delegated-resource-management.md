...
Pode publicar o novo tipo de oferta de [Serviço Gerido ao Azure Marketplace](../how-to/publish-managed-services-offers.md) para facilmente embarcar clientes a bordo para a gestão de recursos delegados do Azure. Em alternativa, pode concluir o processo de [embarque implantando modelos](../how-to/onboard-customer.md)do Gestor de Recursos Azure .
...
2. Especifica este acesso e a bordo do cliente à Azure dedelegada gestão de recursos de uma de duas formas:
   - Publique uma oferta de [serviço gerida pelo Azure Marketplace](../how-to/publish-managed-services-offers.md) (privada ou pública) que o cliente irá aceitar
