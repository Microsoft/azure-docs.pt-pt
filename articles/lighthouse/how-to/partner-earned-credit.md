...
1. Quando [embarcar num cliente utilizando modelos ARM,](onboard-customer.md)certifique-se de que inclui uma autorização que inclui a Conta de Automação PEC como utilizador com uma [função incorporada Azure que é elegível para PEC](/partner-center/azure-roles-perms-pec).
