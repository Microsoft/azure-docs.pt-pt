...
> [Implementar e executar uma simulação de dispositivo IoT em Azure](https://github.com/Azure/azure-iot-pcs-device-simulation/blob/master/README.md)
