...
Para saber mais sobre a instalação do tempo de funcionamento do IoT Edge, consulte [instalar o tempo de execução Azure IoT Edge no Linux (x64)](../iot-edge/how-to-install-iot-edge.md).
