...
1. Selecione a sua aplicação e, em seguida, clique em **Manifesto**. Pode ver as duas funções de [aplicação existentes definidas](/azure/architecture/multitenant-identity/app-roles) para a aplicação:
