...
- Pool de endereços de back-end: Serviço de Aplicações
...
## <a name="solution-rewrite-the-location-header"></a>Soluções Reescrever o cabeçalho de local
