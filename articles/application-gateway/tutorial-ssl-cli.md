...
ms.locfileid: "107772686"
---
# <a name="create-an-application-gateway-with-tls-termination-using-the-azure-cli"></a>Criar um gateway de aplicação com a terminação TLS com a CLI do Azure
