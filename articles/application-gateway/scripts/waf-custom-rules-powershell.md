...
- Para obter mais informações sobre as regras personalizadas da WAF, consulte [as regras personalizadas para firewall de aplicações web](../custom-waf-rules-overview.md)
