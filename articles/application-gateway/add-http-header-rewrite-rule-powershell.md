...
Neste exemplo, o conjunto de reescrita seria associado instantaneamente contra uma regra de encaminhamento básico. Em caso de regra de encaminhamento baseado em caminho, a associação não seria ativada por defeito. O conjunto de reescrita pode ser ativado através da verificação dos caminhos em que necessita de ser aplicado através do portal ou fornecendo um mapa de caminhos URL que especifique o RewriteRuleSet contra cada opção de caminho.  
