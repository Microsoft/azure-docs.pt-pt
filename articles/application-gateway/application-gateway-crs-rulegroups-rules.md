...
### <a name="crs911"></a> <p x-ms-format-detection="none">SOLICITAÇÃO-911-MÉTODO-IMPOSIÇÃO</p>
...
### <a name="crs913"></a> <p x-ms-format-detection="none">SOLICITAÇÃO-913-VERIFICAÇÃO DE DETECÇÃO</p>
...
### <a name="crs920"></a> <p x-ms-format-detection="none">SOLICITAÇÃO-920-PROTOCOLO-IMPOSIÇÃO</p>
...
### <a name="crs932"></a> <p x-ms-format-detection="none">SOLICITAÇÃO-932-APLICATIVO-ATAQUE-RCE</p>
...
### <a name="crs933"></a> <p x-ms-format-detection="none">SOLICITAÇÃO-933-APLICATIVO-ATAQUE-PHP</p>
...
|942130|Ataque de injeção de SQL: Tautology SQL detectado.|
