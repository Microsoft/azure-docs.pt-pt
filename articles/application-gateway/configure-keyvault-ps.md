...
description: Saiba como usar um script Azure PowerShell para integrar o cofre da chave com o seu gateway de aplicação para certificados de rescisão TLS/SSL.
...
```
> [!IMPORTANT]
> O nome do cofre deve ser universalmente único.
