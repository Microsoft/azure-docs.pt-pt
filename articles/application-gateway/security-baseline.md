...
* [Compreender restrições e requisitos em torno da utilização de NSGs com Gateway de aplicação Azure](https://docs.microsoft.com/azure/application-gateway/configuration-overview)
...
* [FAQ para diagnóstico e registo para gateway de aplicação Azure](https://docs.microsoft.com/azure/application-gateway/application-gateway-faq#diagnostics-and-logging)
...
* [Compreenda as funcionalidades do Gateway de Aplicações Azure](https://docs.microsoft.com/azure/application-gateway/features)

* [Compreenda Azure WAF](https://docs.microsoft.com/azure/web-application-firewall/ag/ag-overview)
...
* [Visão geral da configuração do Gateway de aplicação Azure](https://docs.microsoft.com/azure/application-gateway/configuration-overview)
...
* [Como ativar as definições de diagnóstico para O Gateway de Aplicação Azure](https://docs.microsoft.com/azure/application-gateway/application-gateway-diagnostics)

* [Como ativar insights de aplicações](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview)
...
* [Como utilizar o Monitor Azure para redes](https://docs.microsoft.com/azure/azure-monitor/insights/network-insights-overview)
...
* [Como configurar definições de diagnóstico para Azure WAF](https://docs.microsoft.com/azure/application-gateway/application-gateway-diagnostics)
...
* [Como configurar tLS de ponta a ponta usando gateway de aplicação Azure](https://docs.microsoft.com/azure/application-gateway/end-to-end-ssl-portal)
...
**Orientação**: Utilize o controlo de acesso baseado em funções (RBAC) para controlar o acesso ao plano de controlo Azure Application Gateway (portal Azure).
...
* [Cobertura de recursos (incluindo avaliação de vulnerabilidade) para serviços Azure PaaS](https://docs.microsoft.com/azure/security-center/features-paas)
...
* [Como configurar a rescisão SSL com certificados Key Vault utilizando a Azure PowerShell](https://docs.microsoft.com/azure/application-gateway/configure-keyvault-ps)
...
* [Compreenda os conjuntos de regras waf geridos pelo Azure](https://docs.microsoft.com/azure/web-application-firewall/ag/ag-overview#waf-policy)
...
A Azure DevOps Services aproveita muitas das funcionalidades de armazenamento do Azure para garantir a disponibilidade de dados em caso de falha de hardware, perturbação do serviço ou desastre na região. Além disso, a equipa Azure DevOps segue procedimentos para proteger os dados de eliminação acidental ou maliciosa.
...
* [Como backup certificados de cofre chave em Azure](https://docs.microsoft.com/powershell/module/azurerm.keyvault/backup-azurekeyvaultcertificate)
...
* [Como restaurar os certificados de cofre chave](https://docs.microsoft.com/powershell/module/azurerm.keyvault/restore-azurekeyvaultcertificate)
