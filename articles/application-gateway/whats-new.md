...
|Páginas de erros personalizadas     |Com páginas de erro personalizadas, pode criar uma página de erro dentro do formato dos restantes websites. Para o ativar, consulte criar páginas de [erro personalizadas do Gateway](custom-error.md)de aplicação .|Setembro de 2018|
