...
|CRUD/regravações de cabeçalho     |Agora você pode reescrever cabeçalhos HTTP. Consulte [o tutorial: Crie um gateway de aplicativo e reescreva os cabeçalhos HTTP @ no__t-0 para obter mais informações.|Dezembro de 2018|
...
|Páginas de erros personalizados     |Com páginas de erro personalizadas, você pode criar uma página de erro dentro do formato do restante dos seus sites. Para habilitar isso, consulte [criar páginas de erro personalizadas do gateway de aplicativo](custom-error.md).|Setembro de 2018|
