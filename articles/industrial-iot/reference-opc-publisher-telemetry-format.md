---
title: Formato de Telemetria editor da Microsoft OPC
description: Este artigo fornece uma visão geral do ficheiro de definições de configuração
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787584"
---
# <a name="opc-publisher-telemetry-format"></a>Formato de Telemetria editor da OPC

Opc Publisher versão 2.6 e acima suporta o formato OPC UA PubSub JSON conforme especificado na [parte 14 da especificação OPC UA](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) e é assim:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Além disso, todas as versões da OPC Publisher suportam um formato de telemetria JSON simples e não padronizado, que é compatível com [a Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) e é assim:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>Formato de ficheiro de configuração de telemetria da editora OPC
```
