...
Pode verificar as suas permissões de acesso no portal Azure seguindo as instruções do controlo de acesso baseado em [funções da Azure](../../role-based-access-control/check-access.md).
