...
## <a name="application-development"></a>Desenvolvimento de aplicações
...
--- | ---
Content-Type  | O formato da solicitação (Content-Type: Application/<format>). Para APIs do Azure FarmBeats Datahub, o formato é JSON. Tipo de conteúdo: aplicativo/JSON
