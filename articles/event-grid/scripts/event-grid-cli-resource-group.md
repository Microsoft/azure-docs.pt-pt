...
description: Este artigo fornece uma amostra de script Azure CLI que mostra como subscrever eventos Azure Event Grid para um grupo de recursos.
ms.devlang: azurecli
ms.topic: sample
ms.date: 07/08/2020
