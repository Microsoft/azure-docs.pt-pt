---
title: Azure PowerShell-assinar a conta de armazenamento de BLOBs
description: Grade de eventos do Azure & Azure PowerShell amostra de script-assinar a conta de armazenamento de BLOBs
services: event-grid
