...
Quando um evento é desencadeado, o serviço De Grelha de Eventos envia dados sobre esse evento para subscrever o ponto final. Esta secção contém um exemplo de como seriam esses dados para cada evento.
...
| Propriedade | Tipo | Description |
| -------- | ---- | ----------- |
| `ModelName` | cadeia (de carateres) | O nome do modelo que foi registado. |
| `ModelVersion` | string | A versão do modelo que foi registado. |
...
| Propriedade | Tipo | Description |
| -------- | ---- | ----------- |
| `ServiceName` | cadeia (de carateres) | O nome do serviço implantado. |
| `ServiceComputeType` | string | O tipo de cálculo (por exemplo, ACI, AKS) do serviço implantado. |
  | `ModelIds` | string | Uma lista separada por vírgulas de identificações de modelos. Os IDs dos modelos implantados no serviço. |
...
| Propriedade | Tipo | Description |
| -------- | ---- | ----------- |
| `experimentId` | cadeia (de carateres) | A identificação da experiência a que a corrida pertence. |
...
| Propriedade | Tipo | Description |
| -------- | ---- | ----------- |
| `DataDriftId` | cadeia (de carateres) | A identificação do monitor de deriva de dados que desencadeou o evento. |
