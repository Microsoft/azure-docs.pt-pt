...
2. Na página **'Criar' regra de alerta,** verifique se o seu tópico está selecionado para o recurso. Em seguida, clique **em Selecionar a condição**. 
    ...
    :::image type="content" source="./media/monitor-event-delivery/alert-select-condition.png" alt-text="Página de alertas - Novo botão de regra de alerta":::    
3. Na página lógica de **sinal de configuração,** siga estes passos:
    1. Selecione uma métrica ou uma entrada de registo de atividade. Neste exemplo, é selecionado **o Dead Lettered Events.** 
        ...
        :::image type="content" source="./media/monitor-event-delivery/select-dead-lettered-events.png" alt-text="Página de alertas - Novo botão de regra de alerta":::        
    2. Selecione dimensões (opcional). 
        
        :::image type="content" source="./media/monitor-event-delivery/configure-signal-logic.png" alt-text="Página de alertas - Novo botão de regra de alerta":::        
    ...
    3. Rola para baixo. Na secção **lógica alerta,** selecione um **Operador,** **tipo de agregação,** e introduza um **valor Threshold**, e selecione **Fazer**. Neste exemplo, um alerta é desencadeado quando o número total de eventos mortos é superior a 10. 
        ...
        :::image type="content" source="./media/monitor-event-delivery/alert-logic.png" alt-text="Página de alertas - Novo botão de regra de alerta":::                
4. De volta à página **de regra de alerta Criar,** clique em Selecionar grupo de **ação**.

    :::image type="content" source="./media/monitor-event-delivery/select-action-group-button.png" alt-text="Página de alertas - Novo botão de regra de alerta":::
...
6. Na página do **grupo de ação Add,** siga estes passos:
    ...
    1. Selecione **OK** para fechar a página. 
        ...
        :::image type="content" source="./media/monitor-event-delivery/add-action-group-page.png" alt-text="Página de alertas - Novo botão de regra de alerta":::                   
7. Volte à página **de regra de alerta Criar,** insira um nome para a regra de alerta e, em seguida, selecione Criar a regra de **alerta**.
    ...
    :::image type="content" source="./media/monitor-event-delivery/alert-rule-name.png" alt-text="Página de alertas - Novo botão de regra de alerta":::  
8. Agora, na página **alertas** do tópico, vê-se um link para gerir as regras de alerta se ainda não houver alertas. Se houver alertas, selecione **as regras de alerta do Gestor** na barra de ferramentas.  
    ...
    :::image type="content" source="./media/monitor-event-delivery/manage-alert-rules.png" alt-text="Página de alertas - Novo botão de regra de alerta":::
...
:::image type="content" source="./media/set-alerts/delivery-failed-events.png" alt-text="Página de alertas - Novo botão de regra de alerta":::
...
:::image type="content" source="./media/monitor-event-delivery/metric-page-create-alert-button.png" alt-text="Página de alertas - Novo botão de regra de alerta":::   
