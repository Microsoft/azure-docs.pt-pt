---
title: Serviços de Comunicação Azure como fonte de rede de eventos
description: Este artigo descreve como usar os Serviços de Comunicação Azure como fonte de eventos da Grade de Eventos.
ms.topic: conceptual
ms.date: 02/11/2021
ms.author: mikben
...
> [!NOTE]
> Para saber mais sobre como a residência de dados se relaciona com o tratamento de eventos, visite a [documentação conceptual da Residência de Dados](../communication-services/concepts/privacy.md)
...
Pode utilizar o portal Azure ou O CLI Azure para subscrever eventos emitidos pelo seu recurso de Serviços de Comunicação. Começar com eventos de manipulação, analisando [como lidar com eventos DE SMS em Serviços de Comunicação](../communication-services/quickstarts/telephony-sms/handle-sms-events.md)
...
| Título | Descrição |
| --- | --- |
| [Como lidar com eventos DE SMS em Serviços de Comunicação](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Manusear todos os eventos SMS recebidos pelo seu Serviço de Comunicação utilizando o WebHook. |
...
| Título | Descrição |
|---------|---------|
| [Quickstart: Lidar com eventos DE SMS](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Mostra como subscrever eventos SMS usando a Grade de Eventos.   |
