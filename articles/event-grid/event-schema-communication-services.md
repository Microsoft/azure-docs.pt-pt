...
Este artigo fornece as propriedades e esquema para eventos dos Serviços de Comunicação Azure. Para uma introdução aos esquemas de eventos, consulte [o esquema do evento Azure Event Grid](event-schema.md).
...
| Microsoft.Communication.ChatMessageReceived*                | Publicado quando uma mensagem é recebida para um utilizador num fio de chat do qual o utilizador é membro.        |
...
Quando um evento é desencadeado, o serviço De Grelha de Eventos envia dados sobre esse evento para subscrever pontos finais. Esta secção contém um exemplo de como seriam esses dados para cada evento.
