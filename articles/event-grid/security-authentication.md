...
> [!NOTE]
> Utilizar certificados autoassinados para a validação não é suportada. Utilize um certificado assinado por uma autoridade de certificação (AC) em vez disso.
