...
Todos os tópicos e domínios personalizados em Event Grid pertencem a um nível básico ou a um nível premium. Começando `2020-04-01-preview` pela versão API, pode escolher o nível desejado como parte da criação de um tópico ou domínio. O valor padrão é de nível básico. Os tópicos e domínios criados usando versões API mais antigas padrão para o nível básico. Para alterar o nível de preços dos seus tópicos e domínios, consulte como atualizar o [nível para tópicos e domínios](update-tier.md).
