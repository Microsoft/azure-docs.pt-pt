...
|**Alterações de provisionamento e configuração a partir do portal Azure**|Ambiente de cliente -> Ambiente de clientes Azure ->|Opcional|Não|Apenas direto|As alterações de provisão e configuração podem ser feitas localmente usando o Azure Data Studio ou o Azdata CLI.  No modo Ligado Diretamente, também poderá providenciar e fazer alterações de configuração a partir do portal Azure. **Pendente de disponibilidade do modo ligado diretamente**|
