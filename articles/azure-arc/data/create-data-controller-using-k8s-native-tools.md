...
Em primeiro lugar, crie uma cópia do [ficheiro de modelo](https://raw.githubusercontent.com/microsoft/azure_arc/master/arc_data_services/deploy/yaml/data-controller.yaml) localmente no seu computador para que possa modificar algumas das definições.
