...
* Se você já tiver instalado o agente, execute o comando `/opt/azcmagent/bin/hybridrp_proxy add http://{proxy-url}:{proxy-port}`, que configura o proxy e reinicia o agente.
