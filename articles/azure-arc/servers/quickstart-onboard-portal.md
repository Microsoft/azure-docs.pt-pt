...
1. Para desinstalar o agente windows da máquina, faça o seguinte:
    ...
    Se pretender escrever a não instalação, pode utilizar o seguinte exemplo, que recupera o código do produto e desinstala o agente utilizando a linha de comando Msiexec.exe - `msiexec /x {Product Code}`. Para tal:  
...
> [Atribuir uma política a máquinas conectadas](../../governance/policy/assign-policy-portal.md)
