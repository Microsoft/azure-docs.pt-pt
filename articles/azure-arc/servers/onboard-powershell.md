...
Execute os seguintes passos para configurar o servidor ou máquina do Windows alvo com servidores ativados Azure Arc. A remoing PowerShell deve ser ativada no computador remoto. Utilize o `Enable-PSRemoting` cmdlet para ativar a remose powerShell.
...
Seguem-se os resultados do comando:
