...
- Algumas distribuições não são atualmente suportadas pelo agente Log Analytics para o Linux. O agente requer dependências adicionais para ser instalado, incluindo Python 2. Reveja [aqui](../../azure-monitor/platform/agents-overview.md#supported-operating-systems)a matriz de suporte e os pré-requisitos.
