...
:::image type="content" source="media/agent-overview/connected-machine-agent.png" alt-text="Visão geral do agente de servidores ativado pelo Arco." border="false":::
