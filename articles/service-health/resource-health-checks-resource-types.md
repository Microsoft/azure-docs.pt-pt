---
title: Tipos de Recursos Suportados através de | de Saúde de Recursos Azure Microsoft Docs
...
|Verificações executadas|
|---|
|<ul><li>O Bastion Host está a funcionar?</li></ul>|
