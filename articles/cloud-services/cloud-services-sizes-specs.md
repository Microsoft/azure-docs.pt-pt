...
Para obter informações e considerações sobre a utilização destes tamanhos, consulte [os tamanhos VM de cálculo de alto desempenho](../virtual-machines/sizes-hpc.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
