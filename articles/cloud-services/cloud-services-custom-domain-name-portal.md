...
Por exemplo, o seguinte registo CNAME encaminha todo o tráfego dos **www\.contoso.com** para **contoso.cloudapp.net**, o nome de domínio personalizado da sua aplicação implementada:
