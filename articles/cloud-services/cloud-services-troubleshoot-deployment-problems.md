...
Para mais informações, consulte o blog post [Role Instance Restarts Devido a atualizações de OS](https://blogs.msdn.com/b/kwill/archive/2012/09/19/role-instance-restarts-due-to-os-upgrades.aspx)
...
2. No painel **propriedades** do portal Azure, considere as seguintes condições para resolver o seu problema:
   ...
   * Ver os dados de diagnóstico e os cenários de resolução de problemas no blog post [Azure PaaS Compute Diagnostics Data](https://blogs.msdn.com/b/kwill/archive/2013/08/09/windows-azure-paas-compute-diagnostics-data.aspx).
