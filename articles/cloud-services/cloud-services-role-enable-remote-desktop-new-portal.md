...
1. Clique **em Cloud Services**, selecione o nome do serviço na nuvem e, em seguida, selecione Remote **Desktop**.
    ...
    ![Ambiente de trabalho remoto dos serviços em nuvem](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop.png)
...
3. Clique **em Connect** para descarregar um ficheiro RDP para a instância de função.
    ...
    ![Ambiente de trabalho remoto dos serviços em nuvem](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop_Connect.png)
