...
ms.locfileid: "93328745"
---
# <a name="azure-security-baseline-for-azure-cloud-services"></a>Linha de segurança Azure para serviços em nuvem Azure

Esta linha de base de segurança aplica orientações da [versão 1.0 do Azure Security Benchmark](../security/benchmarks/overview-v1.md) para os Serviços cloud do Microsoft Azure. O Azure Security Benchmark fornece recomendações sobre como pode proteger as suas soluções em nuvem no Azure.
...
- [Observação de rede virtual](https://docs.microsoft.com/azure/cloud-services/cloud-services-connectivity-and-networking-faq?&amp;preserve-view=true#how-can-i-use-azure-resource-manager-virtual-networks-with-cloud-services)
...
- [Lista de serviços apoiados pela Azure Policy](https://docs.microsoft.com/cli/azure/azure-services-the-azure-cli-can-manage?&amp;preserve-view=true)
...
- [Como posso bloquear/desativar o tráfego de entrada para o URL padrão do meu serviço na nuvem](https://docs.microsoft.com/azure/cloud-services/cloud-services-connectivity-and-networking-faq?&amp;preserve-view=true#how-can-i-blockdisable-incoming-traffic-to-the-default-url-of-my-cloud-service)

- [Proteção Azure DDOS](https://docs.microsoft.com/azure/cloud-services/cloud-services-connectivity-and-networking-faq?&amp;preserve-view=true#how-do-i-prevent-receiving-thousands-of-hits-from-unknown-ip-addresses-that-might-indicate-a-malicious-attack-to-the-cloud-service)
...
- [Para mais informações sobre a configuração da visita de registos de fluxo](https://docs.microsoft.com/cli/azure/azure-services-the-azure-cli-can-manage?&amp;preserve-view=true)
...
- [Ligue os diagnósticos no Estúdio Visual antes da implementação](https://docs.microsoft.com/visualstudio/azure/vs-azure-tools-diagnostics-for-cloud-services-and-virtual-machines?&amp;preserve-view=true#to-turn-on-diagnostics-in-visual-studio-before-deployment)
...
- [Configurar diagnósticos para o serviço Azure Cloud (Classic) e máquinas virtuais](https://docs.microsoft.com/visualstudio/azure/vs-azure-tools-diagnostics-for-cloud-services-and-virtual-machines?toc=%2Fazure%2Fcloud-services%2Ftoc.json&amp;preserve-view=true)
...
- [Quais são as funcionalidades e capacidades que a Azure básica IPS/IDS e DDOS fornece](https://docs.microsoft.com/azure/cloud-services/cloud-services-configuration-and-management-faq?&amp;preserve-view=true#what-are-the-features-and-capabilities-that-azure-basic-ipsids-and-ddos-provides)
...
**Orientação** : Utilize as APIs de REPOUSO do Serviço de Nuvem Azure para inventariar os seus recursos do Serviço Azure Cloud para obter informações sensíveis. Faça uma pesquisa dos recursos de serviço na nuvem implantados para obter a configuração e os recursos .pkg.
...
- [Como posso adicionar uma extensão antimalware para os meus Serviços Azure Cloud de forma automatizada](https://docs.microsoft.com/azure/cloud-services/cloud-services-configuration-and-management-faq?&amp;preserve-view=true#how-can-i-add-an-antimalware-extension-for-my-cloud-services-in-an-automated-way)
