...
> [!NOTE]
> Os procedimentos nesta tarefa se aplicam aos serviços de nuvem do Azure; para serviços de aplicativos, consulte [isto](../app-service/configure-ssl-bindings.md).
>
