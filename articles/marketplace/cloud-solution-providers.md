...
![País, competência e filtros de habilidades para pesquisa de parceiros](media/marketplace-publishers-guide/csp-add-resellers.png)
...
Inscreva-se no [Partner Center](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) ou no Cloud [Partner Portal](https://cloudpartner.azure.com/) para criar e configurar a sua oferta.
