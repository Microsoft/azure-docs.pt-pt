---
title: Suporte ao mercado comercial da Microsoft - Azure Marketplace
description: Apoiar informações e links para Azure Marketplace e AppSource no Partner Center
...
ms.locfileid: "93130838"
---
# <a name="support-for-the-microsoft-commercial-marketplace"></a>Suporte para o mercado comercial da Microsoft

Tem alguma dúvida sobre o início como editor de marketplace comercial da Microsoft? Aqui está uma lista de opções de apoio para o mercado comercial. Além dos seguintes recursos, também pode obter muitas das suas perguntas respondidas no [canal Marketplace do Fórum Comunitário C+AI.](https://www.microsoftpartnercommunity.com/t5/Marketplace/bd-p/2222)  

## <a name="onboarding"></a>Inclusão

Abra um bilhete com [o suporte da editora microsoft marketplace](https://aka.ms/marketplacepublishersupport) para problemas com o embarque e o início.
...
|:--- |:--- |  
| Fóruns da MSDN: Marketplace localizado no [Microsoft Q&Uma página de perguntas](/answers/products/azure) | Fórum microsoft Developer Network. |  
...
* Visite a [página de guia de editores de mercado comercial.](index.yml)
* Saiba mais sobre [o suporte ao programa de marketplace comercial no Partner Center.](support.md)
