...
Para saber mais sobre a adição de domínios personalizados no Azure Ative Directory, consulte [Adicionar ou associar um domínio em Azure AD](/azure/active-directory/fundamentals/add-custom-domain).
...
![Diagrama para resolução de problemas de sessão de trabalho de assinatura](./media/manage-accounts/onboarding-aad-flow.png)
