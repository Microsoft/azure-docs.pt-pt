...
3. O **painel de ajuda e apoio** aparecerá do lado direito da página. 
   ...
   ![Suporte menu suspenso](./media/commercial-marketplace-support-pane.png)
...
Caso não encontre a sua resposta em **soluções recomendadas,** clique em **fornecer detalhes de problemas**.  Preencha o formulário e todos os campos necessários para ajudar a acelerar o processo de resolução.  Em seguida, clique **em submeter**.
