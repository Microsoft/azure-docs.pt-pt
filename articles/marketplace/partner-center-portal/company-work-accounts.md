...
Para saber mais sobre a adição de domínios personalizados no Azure Ative Directory, consulte [Adicionar ou associar um domínio em Azure AD](../../active-directory/active-directory-add-domain.md).
