---
title: Registar uma aplicação SaaS | O Azure Marketplace
...
A aplicação protegida por AD do Azure pode agora utilizar o [SaaS preenchimento API versão 2](./pc-saas-fulfillment-api-v2.md).
