---
title: Obtenha um SAS URI para a sua imagem VM - Azure Marketplace
...
ms.locfileid: "89144535"
---
# <a name="get-a-sas-uri-for-your-vm-image"></a>Obtenha um SAS URI para a sua imagem em VM
...
2. **Microsoft Azure CLI** – Recomendado para sistemas operativos não Windows e ambientes de integração automatizado ou contínuo.

### <a name="using-tool-1-microsoft-storage-explorer"></a>Ferramenta 1: Microsoft Storage Explorer

1. Descarregue e instale [o Microsoft Azure Storage Explorer](https://azure.microsoft.com/features/storage-explorer/).
2. Abra o explorador e no menu esquerdo, selecione **Adicionar Conta**.
3. Na caixa de diálogo **de armazenamento Connect to Azure,** selecione Adicionar uma Conta **Azure** e inscreva-se na sua conta Azure.
4. No painel do Explorador esquerdo, expanda o nó **de Contas de Armazenamento.**
5. Clique com o botão direito no VHD e selecione **Obter Obter Assinatura de Acesso a Partilha**.
6. Na caixa de diálogo **assinatura de acesso partilhado,** complete os seguintes campos:
...
8. Copie o URI e guarde-o num ficheiro de texto num local seguro.
    ...
    ![A copiar o URI.](media/vm/create-sas-uri-shared-access-signature-details.png)

    Este SAS URI gerado destina-se ao acesso ao nível do contentor. Para torná-lo específico, edite o ficheiro de texto para adicionar o nome VHD.
...
1. Repita estes passos para cada VHD nos planos que publicará.
...
- Leia [Criar uma oferta de máquina virtual Azure](azure-vm-create-offer.md).
