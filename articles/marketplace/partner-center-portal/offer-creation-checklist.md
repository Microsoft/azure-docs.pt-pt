...
| [Oferta página de configuração](#offer-setup-page) | Permite-lhe optar por usar as principais funcionalidades e escolher como vender a sua oferta através da Microsoft.  |
| [Página Propriedades](#properties-page) | Defina as categorias e indústrias usadas para agrupar a sua oferta nos mercados, os contratos legais que suportam a sua oferta e a sua versão de aplicação. |
...
| [Página de listagem de plano](#plan-listing-page)  | Só disponível se escolher para vender a oferta através da Microsoft. Defina os detalhes utilizados para listar o Plano no mercado.  |
| [Definir a página de preços e disponibilidade](#plan-pricing-and-availability-page)  | Só disponível se escolher para vender a oferta através da Microsoft.  Recolhe as características do negócio (modelo de preços), público e disponibilidade de mercado para cada plano (versão) da sua oferta.  |
...
| [Rever e publicar página](#review-and-publish-page)  | Selecione as alterações que pretende publicar, consulte o estado de cada página e forneça notas à equipa de certificação.  |
|
...
| Logotipos da loja (Pequeno, Médio, Grande)  | É necessário o logotipo grande (de 216 x 216 a 350 x 350 px). O Partner Center utilizará isto para criar um logótipo Small (48 x 48 px) e Medium (90 x 90 px). Pode substituir opcionalmente estas imagens por diferentes imagens mais tarde. Os logótipos devem estar no formato PNG. |
...
## <a name="plan-pricing-and-availability-page"></a>Definir a página de preços e disponibilidade
