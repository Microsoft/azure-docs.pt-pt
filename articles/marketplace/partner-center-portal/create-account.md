...
1. No Partner Center, selecione **configurações** > **configurações do desenvolvedor** > **programas**@no__t-**5 introdução e insira**seu endereço de email comercial.
