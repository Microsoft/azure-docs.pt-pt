...
- O nome legal, endereço e contacto primário da sua empresa. Esta pessoa pode ser tu.

Vamos verificar esta informação durante o processo de criação de conta.

Há duas formas de criar uma conta:

- Se é novo no Partner Center e não tem uma conta microsoft partner network (MPN), vá para [Criar uma conta utilizando a página de inscrição do Partner Center](#create-an-account-by-using-the-partner-center-enrollment-page).
- Se já está inscrito na Microsoft Partner Network, crie uma conta diretamente do Partner Center indo para [criar uma conta utilizando as inscrições existentes no Partner Center](#create-an-account-by-using-existing-microsoft-partner-center-enrollments).

## <a name="create-an-account-by-using-the-partner-center-enrollment-page"></a>Criar uma conta utilizando a página de inscrição do Centro parceiro
...
- [Registe-se na página de inscrição do Centro parceiro](#register-on-the-partner-center-enrollment-page)
...
>[!NOTE]
>Para ver se a sua empresa já tem uma conta de trabalho, aprenda a criar uma nova conta de trabalho, ou aprenda a configurar várias contas de trabalho para utilizar com o Partner Center, visite [a sua conta de trabalho da empresa e o Partner Center.](./company-work-accounts.md)
...
Existem dois tipos de matrículas existentes que pode utilizar para configurar a sua conta de mercado comercial. Escolha o que se aplica a si:

- Se tiver uma inscrição existente na Microsoft Partner Network, crie a sua conta utilizando [o Inscrito na Rede de Parceiros da Microsoft](#what-if-im-already-enrolled-in-the-microsoft-partner-network).
- Se tiver um programa de desenvolvimento existente, crie a sua conta utilizando [E se eu já estiver inscrito num programa de programação?](#what-if-im-already-enrolled-in-a-developer-program)

Para ambos os tipos de matrículas, você:

- Inscreva-se no Partner Center com as suas credenciais existentes.
...
Inscreva-se no [Partner Center](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/partnership) com a sua conta Microsoft Partner Network para ligar o domínio da conta de e-mail de trabalho da sua empresa à sua nova conta Partner Center. Depois de associar estas duas contas, os colaboradores da sua empresa podem inscrever-se no Partner Center com os seus nomes de utilizadores de conta de trabalho e senhas.

>[!NOTE]
>Para ver se a sua empresa já tem uma conta de trabalho, aprenda a criar uma nova conta de trabalho, ou aprenda a configurar várias contas de trabalho para utilizar com o Partner Center, visite [a sua conta de trabalho da empresa e o Partner Center.](./company-work-accounts.md)

Depois de iniciar sposição, termine de configurar a sua conta fazendo o seguinte:
...
1. A partir do [Partner Center](https://partner.microsoft.com/), selecione **Definições**de  >  **Partner Settings**  >  **Definições de Definições De**  >  **Definições Começar**.
...
Inscreva-se no [Partner Center](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/partnership) com a sua conta Microsoft Partner Center para se inscrever no programa de marketplace comercial na mesma conta. Ao registar-se no mercado comercial com a mesma conta, pode ver tanto as suas inscrições existentes como as suas inscrições no mercado comercial no painel esquerdo do Partner Center.

Depois de iniciar sposição no Partner Center, termine de configurar a sua conta fazendo o seguinte:

1. No Partner Center, selecione **Definições**  >  **de Definições**  >  de Definições De Definições Iniciar e**insira**o seu endereço de  >  **Get Started**e-mail de trabalho.
...
Uma organização pode ter vários editores associados a uma conta de mercado comercial. Um utilizador existente pode adicionar mais editores depois de iniciar sessão no Partner Center selecionando **As Definições de Conta**  >  **Editores**  >  **Add Publishers**.
...
Utilizadores adicionais do mesmo inquilino do Azure Ative Directory podem adicionar um novo editor fazendo o seguinte:
