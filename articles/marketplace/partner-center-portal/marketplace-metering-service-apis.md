---
title: Serviço de medição do mercado APIs [ Serviço de medição de mercado] Mercado Azure
description: Evento de utilização para ofertas SaaS no Azure Marketplace.
author: dsindona
ms.author: dsindona
