...
| Tipo de Oferta: Aplicação Azure| Ordem, | Utilize o tipo de oferta de solução Azure Application quando a sua solução requer uma automatização adicional de implementação e configuração para além de um simples VM.||
