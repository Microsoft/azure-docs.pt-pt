---
title: Configure test drives no mercado comercial da Microsoft
description: Aprenda sobre test drives. As unidades de teste permitem que novos clientes testem a sua oferta antes de se comprometerem com a compra.
author: dsindona
ms.author: dsindona
...
ms.locfileid: "82786551"
---
# <a name="learn-about-test-drive-for-your-offer"></a>Saiba mais sobre o test drive para a sua oferta

A opção **Test drive** no mercado comercial da Microsoft permite configurar uma visita prática e auto-guiada das principais funcionalidades do seu produto. Com um test drive, os novos clientes podem experimentar a sua oferta antes de se comprometerem a comprá-la. Para mais informações, veja [o que é test drive?](../cloud-partner-portal/test-drive/what-is-test-drive.md)

Se já não quiser fornecer um test drive para a sua oferta, volte à página de **configuração da Oferta** e desmarque **o test drive Enable**.
...
Há um modelo de implantação que contém todos os recursos Azure que compõem a sua solução. Isto é adequado para produtos que utilizam apenas recursos Azure. Saiba mais sobre a criação de um [test drive Azure Resource Manager](../cloud-partner-portal/test-drive/azure-resource-manager-test-drive.md).
...
- **ID da aplicação Azure AD** (obrigatório): Introduza o id da [aplicação](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal#get-values-for-signing-in)Azure Ative Directory (AD). Para encontrar este ID, inscreva-se no [portal Azure,](https://portal.azure.com/)selecione o separador Ative Directy no menu esquerdo, `50c464d3-4930-494c-963c-1e951d15360e`selecione registos de **Aplicações,** em seguida, procure o número de ID da **aplicação** listado (por exemplo, ).
