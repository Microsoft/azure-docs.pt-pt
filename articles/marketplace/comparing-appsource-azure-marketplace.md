...
|:--- |:--- | :--- |
| **Flexibilidade de faturação** | O Azure Marketplace suporta tipos de ofertas gratuitas, experimentais, BYOL e transact. As ofertas transactais são baseadas em consumo ou baseadas em subscrições. As ofertas baseadas no consumo são cobradas por uso de hora a hora e podem fornecer um período livre inicial. Os serviços baseados em assinaturas são cobrados mensalmente ou anualmente a uma taxa por assento ou forfetado.| O AppSource suporta tipos de ofertas gratuitas, experimentais, BYOL e transact. As ofertas transact são produtos SaaS baseados em subscrição que podem ser faturando mensalmente ou anualmente por assento ou taxa fixa. |
