...
### <a name="select-solution-areas"></a>Selecione áreas de solução

As áreas de solução ajudam a definir ainda mais a sua solução. Isto ajuda as equipas de vendas da Microsoft a encontrar e a compreender a proposta de valor da sua solução. Deve selecionar pelo menos uma e até um máximo de três áreas de solução para a sua oferta. Para cada área de solução, pode optar por duas sub-áreas de solução.

1. Selecione a área de **solução + Adicionar (3 Max).**
1. Selecione uma área de solução da lista de drop-down que aparece.
1. Selecione pelo menos uma e até duas sub-áreas de solução. Para selecionar várias sub-áreas, utilize a `Ctrl` chave (no Windows) ou `Command` a tecla (no macOS).
1. Para adicionar outra área de solução, repita os passos 1 a 3.

## <a name="upload-documents"></a>Carregar documentos

Deve fornecer documentos colaterais que forneçam detalhes sobre a sua oferta. As equipas de vendas da Microsoft utilizam estas informações para avaliar se a sua oferta é adequada às necessidades dos clientes, de forma a recomendar e vender a sua oferta. Quanto mais informação fornecer, mais informações as equipas de vendas da Microsoft terão de compreender e promover o seu produto.

Os tipos de ficheiros suportados são .pdf, .ppt, .pptx, .doc, .docx, .xls, .xlsx, .jpg, .png e .mp4. Os modelos para alguns documentos são fornecidos na Tabela 2 abaixo.

> [!NOTE]
> A **solução/oferta de um pager** e **o deck de pitch Solution/offer** são necessários para obter o estado de Co-venda Ready. São também pré-requisitos para que algumas ofertas sejam a Azure IP Co-venda incentivada. O diagrama de arquitetura de referência também é necessário para o estatuto de co-venda de IP Azure. Os outros documentos descritos nesta tabela são opcionais, mas recomendados.

***Quadro 2: Documentos que suportam co-venda***

| **Documentos**    | **Descrição**  |
| :------------------- | :-------------------|
| *Solução/oferta de um pager (Obrigatório)* | Impulsionar a consciencialização entre potenciais clientes com um pager profissionalmente projetado que mostra a proposta de valor da sua solução.<br><br>Pode utilizar um dos modelos relevantes para fornecer uma descrição pronta para o cliente da sua oferta:<br><ul><li> [Modelo de um pager do Microsoft Azure](https://aka.ms/Customer-One-Pager_MicrosoftAzure)</li><li>[Modelo de página 365 da Microsoft Dynamics](https://aka.ms/Customer-One-Pager_MicrosoftDynamics365)</li> <li>[Modelo de um pager microsoft 365](https://aka.ms/Customer-One-Pager_MicrosoftOffice365) </li><li>[Modelo de um pager do Windows 10](https://aka.ms/Customer-One-Pager_Windows)</li></ul> <br> As equipas de vendas da Microsoft podem partilhar esta informação com os clientes para ajudar a determinar se a sua oferta pode ser um bom ajuste, e para garantir que está pronta para o cliente. |
| *Deck de arremesso de solução/oferta (Obrigatório)* | Pode utilizar o [modelo de apresentação](https://aka.ms/GTMServices_CustomerPresentation) do Cliente para criar o seu deck de pitch. Este convés deve fazer referência ao [diagrama de arquitetura de referência.](reference-architecture-diagram.md) O objetivo deste slide deck é lançar a sua oferta e a sua proposta de valor. Depois de garantir que a sua oferta está pronta para o cliente, as equipas de vendas da Microsoft podem partilhar esta apresentação com os clientes para articular o valor que a sua empresa e a Microsoft trazem ao implementar uma solução conjunta. A apresentação deve abranger o que a sua oferta faz, como pode ajudar os clientes, para que indústrias a oferta é relevante, e como se compara com soluções concorrentes. |
| *Estudo de caso do cliente* (Opcional)| Utilize o [modelo de estudo de caso](https://aka.ms/GTM_Case_Study_Template) para criar o seu estudo de caso de cliente. Estas informações mostram a um potencial cliente como você e a Microsoft implementaram com sucesso a sua oferta em casos anteriores. |
| *O cliente verificável ganha* (Opcional) | Forneça exemplos específicos de sucessos do cliente após a implementação da sua oferta. |
| *Deck de arremesso de canal* (opcional) | Um slide deck com informações que ajudam os revendedores de canais a aprender mais sobre a sua oferta e a preparar as suas equipas de vendas para vendê-la. Este deck normalmente inclui um pitch de elevador, informações sobre clientes-alvo, perguntas para perguntar aos clientes, pontos de conversa e links para vídeos, documentação e informações de suporte. |
| *Diagrama de arquitetura de referência* (Exigido para o estado de co-venda do Azure IP) | Um diagrama que representa a sua oferta e a sua relação com os serviços na nuvem da Microsoft. Também pode demonstrar como a sua oferta satisfaz os requisitos técnicos para o estado de co-venda Azure IP Co-sell. [Saiba mais sobre o diagrama de arquitetura de referência.](reference-architecture-diagram.md) |
| *Outros documentos* (Opcional) | Você pode carregar até cinco documentos ou vídeos adicionais para ajudar as equipas de vendas da Microsoft e os revendedores de canais a saber mais sobre a sua oferta, organização e como é diferente de outras ofertas. |
|||

- Depois de criar os seus documentos, arraste-os para a caixa apropriada nos **Documentos** ou **selecione navegue nos seus ficheiros** para fazer o upload de um documento a partir do seu computador.

    [![Ilustra a secção de documentação co-venda do Co-sell com o separador Microsoft.](./media/co-sell/co-sell-documents-section.png)](./media/co-sell/co-sell-documents-section.png#lightbox)

## <a name="product-landing-page"></a>Página de aterragem do produto
...
1. Abra o . Ficheiro CSV numa aplicação como o Microsoft Excel e, em seguida, preencha cada linha com informações sobre o contacto.
    ...
    ***Quadro 3: Descrição das funções***
    ...
    - Países/Regiões (Obrigatório): Ao preencher o modelo, utilize os códigos de dois países [e regiões de co-venda.](commercial-marketplace-co-sell-countries.md) Se o contacto abranger todos os países e regiões, utilize o código de três letras "OOO". Se um contacto abranger mais de um país ou região, insira cada um dos dois códigos de letra separados por uma vírgula. Por exemplo, insira "US, CA, FR" sem aspas no modelo.
        ...
        Os países e regiões devem refletir o território de cada contacto. As equipas de vendas da Microsoft e os revendedores de canais utilizarão estas informações quando solicitarem informações ou colaborarem nas vendas dentro de um país ou região específico.
