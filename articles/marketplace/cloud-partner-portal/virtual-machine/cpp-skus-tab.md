---
title: Separador de SKUs de máquina virtual no Portal de parceiros da Cloud para o Azure Marketplace
...
![Separador SKU do formulário de nova oferta de mensagens em fila para máquinas virtuais](./media/publishvm_006.png)

A tabela seguinte descreve a finalidade, conteúdo e a formatação desses campos.  Campos obrigatórios são indicted por um asterisco (*).
...
|  *Detalhes SKU*   |  |
| **Título\***        | Nome amigável para a oferta para exibição no marketplace. Comprimento máximo de 50 carateres. |
...
* Microsoft classifica alguns países/regiões como *imposto remitted países*.  Em tais países/regiões, a Microsoft cobra impostos de clientes depois paga impostos de (remits) para o Governo.  Em outros países/regiões, os parceiros são, normalmente, responsáveis por coletar impostos de seus clientes e pagar impostos ao. Se optar por vender nos países/regiões último, tem de ter a capacidade de calcular e pagar impostos locais.  <!-- TD: Find a good reference on taxing policies. The best I found was in the UWP section: https://docs.microsoft.com/windows/uwp/publish/tax-details-for-paid-apps -->
...
Opcionalmente, especificará [Test-Drive](./cpp-test-drive-tab.md) informações se estiver dando suporte esta funcionalidade; caso contrário, fornecer [marketplace](./cpp-marketplace-tab.md) dados da sua oferta.
