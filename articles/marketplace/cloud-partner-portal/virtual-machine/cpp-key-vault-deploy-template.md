---
title: Modelo de implantação do cofre de chaves Azure [ Mercado Azure
description: Lista o modelo do Gestor de Recursos Azure necessário para implementar uma nova instância do Cofre de Chaves Azure.
author: dsindona
