---
title: Página de todas as ofertas para o Azure Marketplace
description: Descrição geral do todas oferece página no Portal de parceiros de Cloud para o Azure Marketplace.
...
O próximo item de barra de menus de navegação apresenta uma [página de aprovações](./cpp-approvals-page.md), que apresenta uma lista aprovada de ofertas.  Já aprovadas ofertas são publicadas ou no processo de ser publicadas.
