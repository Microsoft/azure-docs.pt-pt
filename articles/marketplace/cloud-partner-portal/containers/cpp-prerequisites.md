---
title: Os contentores do Azure oferecem a pré-requisitos | Documentos da Microsoft
...
Para publicar uma nova imagem de contentor, terá de cumprir os seguintes pré-requisitos:

- Acesso ao Portal de parceiro de Cloud. Para obter mais informações, consulte o guia de publicação do Azure Marketplace e AppSource.
- Contrato para os termos do Azure Marketplace
- Aloje o seu elemento de técnicas de contentor no Azure Container Registry.
- Ter seus metadados do contentor pronto a utilizar. Por exemplo, a seguinte lista parcial:
  - Um título
