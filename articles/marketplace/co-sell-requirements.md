---
title: Requisitos de co-venda | Mercado Azure
description: Conheça os requisitos que uma oferta no mercado comercial da Microsoft deve cumprir para se qualificar para co-vender o estatuto de co-venda ou co-venda.
...
Para uma oferta para obter o estatuto de co-venda, deve cumprir os seguintes requisitos:
...
Ao publicar ou atualizar a sua oferta, forneça todas as informações necessárias sobre o **separador Co-venda com** o separador Microsoft, conforme detalhado na [Configure Co-sell para uma oferta de mercado comercial.](commercial-marketplace-co-sell.md) Isto inclui a disponibilização dos seguintes documentos:

- Solução/oferta de um pager
- Deck de pitch de solução/oferta

Fornecemos modelos para ajudá-lo a criar estes documentos. Para obter mais informações sobre as informações necessárias e opcionais para a Co-venda com o separador Microsoft, consulte [a Configure Co-sell para uma oferta de mercado comercial.](commercial-marketplace-co-sell.md)
...
Depois de alcançar o estatuto de Co-venda pronto, existem três requisitos adicionais para alcançar o estatuto de Co-venda Azure IP Co-venda:

Requisito 1 - atingir o seguinte:

- A _nível organizacional,_ gere pelo menos $100.000 USD do limiar de Receita Consumida do Azure durante o período de 12 meses. Isto pode ser obtido através de uma combinação de soluções Azure. Se a oferta for transacionável no mercado comercial, pode cumprir este requisito cumprindo um limiar de receita faturado de USD de $100.000.

Requisito 2 - Passe a validação técnica da Microsoft para uma solução baseada em Azure:
- A validação técnica deve confirmar que mais de 50% da infraestrutura da sua oferta utiliza código IP repetível no Azure. Note que as soluções de VMs e Azure Application transacionáveis no mercado comercial cumprirão este requisito por defeito.
