...
> [!Note]
> Os serviços de consultoria no Azure Marketplace devem focar-se em ofertas para um público técnico e enfatizar as soluções e serviços técnicos do Azure.
>
...
3. **Enviar** – Forneça as informações necessárias que constam das instruções. Todos os conteúdos e materiais de apoio devem ser apresentados em inglês.
...
* **Avaliação** – Avaliação do ambiente de um cliente para determinar a aplicabilidade de uma solução e fornecer uma estimativa de custo e tempo.
...
* **Implementação** – Uma instalação completa que resulta numa solução de pleno funcionamento. Recomendamos limitá-lo a soluções que possam ser implementadas em duas semanas ou menos.
...
> [!NOTE]
> O tipo de serviço *briefing* deve ser fornecido *pessoalmente*. Você pode fornecer os outros quatro serviços de consultoria de duas maneiras:
...
|**Briefing**    |   Articular o que o cliente pode esperar. Lembre-se, *o briefing* deve ser fornecido pessoalmente. Se estiver a prestar um serviço virtual, escolha um tipo de oferta diferente.    |  Otimize o resumo da sua oferta com as suas principais palavras-chave SEO.       |
