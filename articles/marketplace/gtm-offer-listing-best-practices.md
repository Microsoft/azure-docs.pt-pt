...
| [**Azure Marketplace**](https://azuremarketplace.microsoft.com/marketplace/apps) (IT Pros e Developers)  | [**AppSource**](https://appsource.microsoft.com/marketplace/apps) (Utilizadores Empresariais)|
| :------------------- |:----------------|
|**Análise** | **Análise** |
| &nbsp;&nbsp;Insights de Dados | &nbsp;&nbsp;Análise Avançada  |
| &nbsp;&nbsp;Análise de Dados |  &nbsp;&nbsp;Relatório de & de Visualização |
| &nbsp;&nbsp;Big Data | **IA + Machine Learning**  |
| &nbsp;&nbsp;Análise Preditiva | &nbsp;&nbsp;IA para Negócios |
| &nbsp;&nbsp;Análise em tempo real/streaming | &nbsp;&nbsp;Aplicativos bot |
| **IA + Machine Learning** | **Colaboração** |
| &nbsp;&nbsp;Serviço bot | &nbsp;&nbsp;Contato & Pessoas |
| &nbsp;&nbsp;Serviços Cognitivos | &nbsp;&nbsp;Gestão de Reuniões |
| &nbsp;&nbsp;Serviço ML | &nbsp;&nbsp;Gestão de & de Design de Site |
| &nbsp;&nbsp;ML automatizado | &nbsp;&nbsp;Gestão de projetos de & de tarefas |
| &nbsp;&nbsp;Automação de processos de negócio/robótica | &nbsp;&nbsp;Conferência de vídeo & de voz |
| &nbsp;&nbsp;Rotulagem de dados | **Conformidade & Legal** |
| &nbsp;&nbsp;Preparação de dados | &nbsp;&nbsp;Auditoria & Fiscal |
| &nbsp;&nbsp;Mineração de Conhecimento | &nbsp;&nbsp;Legal |
| &nbsp;&nbsp;Operações do ML | &nbsp;&nbsp;Dados, Governação & Privacidade |
| **Blockchain**  | &nbsp;&nbsp;Segurança & de Saúde |
| &nbsp;&nbsp;Aceleradores de aplicativos | **Customer Service**  |
| &nbsp;&nbsp;Ledger de nó único | &nbsp;&nbsp;Centro de Contacto |
| &nbsp;&nbsp;Ledger multi-nódoa | &nbsp;&nbsp;Serviço cara a cara |
| &nbsp;&nbsp;Ferramentas | &nbsp;&nbsp;Serviço de empregados de & de back office |
| **Computação**  | &nbsp;&nbsp;Gestão de Casos de & Conhecimento |
| &nbsp;&nbsp;Infraestrutura de Aplicação | &nbsp;&nbsp;Redes sociais & Envolvimento Omnicanal |
| &nbsp;&nbsp;Sistemas Operativos | **Departamento Financeiro** |
| &nbsp;&nbsp;Cache | &nbsp;&nbsp;Contabilidade |
| **Contentores**  | &nbsp;&nbsp;Gestão de Ativos |
| &nbsp;&nbsp;Começar com contentores | &nbsp;&nbsp;Reportagem de & de analítica, consolidação |
| &nbsp;&nbsp;Aplicativos de contentores | &nbsp;&nbsp;Credit & Collections |
| &nbsp;&nbsp;Imagens de contentores | &nbsp;&nbsp;Conformidade & Gestão de Riscos |
| **Bases de dados**  | **Geolocalização** |
| &nbsp;&nbsp;Bases de Dados NoSQL | &nbsp;&nbsp;Mapas |
| &nbsp;&nbsp;Bases de Dados Relacionais | &nbsp;&nbsp;Notícias & Tempo |
| &nbsp;&nbsp;Bases de dados de livros/blockchain | **Human Resources** |
| &nbsp;&nbsp;Lagos de Dados | &nbsp;&nbsp;Aquisição de Talento |
| &nbsp;&nbsp;Armazém de Dados | &nbsp;&nbsp;Gestão de Talentos |
| **Ferramentas de Programação**  | &nbsp;&nbsp;Operações de RH |
| &nbsp;&nbsp;Ferramentas | &nbsp;&nbsp;Planeamento da força de trabalho & Analytics |
| &nbsp;&nbsp;Scripts | **Ferramentas de gestão de & de TI** |
| &nbsp;&nbsp;Serviço de Desenvolvedores | &nbsp;&nbsp;Soluções de Gestão |
| **DevOps**  | &nbsp;&nbsp;Aplicações empresariais |
| **Integração**  | **Internet das Coisas** |
| &nbsp;&nbsp;Mensagens | &nbsp;&nbsp;Operações de & de Gestão de Ativos |
| **Ferramentas de gestão de & de TI**  | &nbsp;&nbsp;Produtos Conectados |
| &nbsp;&nbsp;Soluções de Gestão | &nbsp;&nbsp;Cadeia de abastecimento inteligente |
| &nbsp;&nbsp;Aplicações empresariais | &nbsp;&nbsp;Manutenção Preditiva |
| **Identidade**  | &nbsp;&nbsp;Monitorização remota |
| &nbsp;&nbsp;Gestão de Acessos | &nbsp;&nbsp;Segurança & Segurança |
| **Internet das Coisas**  | &nbsp;&nbsp;Recursos & de Infraestrutura Inteligente |
| &nbsp;&nbsp;Conectividade IoT | &nbsp;&nbsp;Veículos & Mobilidade |
| &nbsp;&nbsp;Serviços IoT Core | **Marketing** |
| &nbsp;&nbsp;Módulos IoT Edge | &nbsp;&nbsp;Publicidade |
| &nbsp;&nbsp;Soluções IoT | &nbsp;&nbsp;Analytics |
| &nbsp;&nbsp;Visualização & de análise de dados | &nbsp;&nbsp;Gestão de Campanha & Automação |
| **Media**  | &nbsp;&nbsp;E-mail Marketing |
| &nbsp;&nbsp;Serviços de Mídia | &nbsp;&nbsp;Gestão de Eventos & Recursos |
| &nbsp;&nbsp;Proteção de Conteúdos | &nbsp;&nbsp;Análise & de Investigação |
| &nbsp;&nbsp;Live & On-Demand Streaming | &nbsp;&nbsp;Mídia Social |
...
| &nbsp;&nbsp;Balançadores de Carga | **Produtividade** |
| **Segurança**  | &nbsp;&nbsp;Criação de Conteúdos & Gestão |
| &nbsp;&nbsp;Gestão de Acesso & Identidade | &nbsp;&nbsp;Gestão de Documentos |
| &nbsp;&nbsp;Proteção contra ameaças | &nbsp;&nbsp;Gestão de e-mail |
| &nbsp;&nbsp;Proteção de Informação | &nbsp;&nbsp;Tradução & Linguagem |
| **Armazenamento**  | &nbsp;&nbsp;Consulte a & Referência |
| &nbsp;&nbsp;Recuperação de & de apoio | &nbsp;&nbsp;Gamificação |
| &nbsp;&nbsp;Armazenamento Híbrido da Empresa | **Vendas** |
| &nbsp;&nbsp;Partilha de ficheiros | &nbsp;&nbsp;Televendas |
| &nbsp;&nbsp;Gestão do ciclo de vida dos dados | &nbsp;&nbsp;Configuração, Preço, Cotação (CPQ) |
| **Web**  | &nbsp;&nbsp;Gestão de Contratos |
| &nbsp;&nbsp;Blogs & CMSs | &nbsp;&nbsp;CRM |
| &nbsp;&nbsp;Aplicativos Web de início | &nbsp;&nbsp;E-commerce |
| &nbsp;&nbsp;E-commerce | &nbsp;&nbsp;Enriquecimento de Dados empresariais  |
| &nbsp;&nbsp;Quadros de aplicativos web | &nbsp;&nbsp;Habilitação de Vendas  |
| &nbsp;&nbsp;Aplicativos Web |  |
...
| **Governo** |  Inteligência & Defesa <br> Governo Civil <br> Segurança Pública & Justiça |
