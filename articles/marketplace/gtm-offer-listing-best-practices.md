---
title: Oferta de melhores práticas - Mercado comercial da Microsoft
description: Saiba mais sobre as melhores práticas de listagem para as suas ofertas Microsoft AppSource e Azure Marketplace.
author: qianw211
...
Este artigo dá sugestões para criar e envolver ofertas de mercado comercial. As tabelas a seguir delineiam as melhores práticas para completar informações de oferta no Partner Center. Para uma análise de como as suas ofertas estão a funcionar, vá ao [dashboard Marketplace Insights](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/marketplaceinsights) no Partner Center. 
...
| Pesquisar palavras-chave (3 max) | As palavras-chave de pesquisa podem ajudar os utilizadores de negócios a encontrar a sua oferta quando pesquisam <ul>  <li>no Microsoft AppSource</li> <li>no Azure Marketplace</li><li>usando motores de busca</li> </ul> Para que a sua listagem apareça nestas pesquisas, é necessário: <ul> <li> Identifique as três principais palavras-chave de pesquisa para a sua oferta; </li> <li> incorporar as palavras-chave de pesquisa no resumo e descrição da sua oferta; </li> <li> listar as palavras-chave de pesquisa aqui. </li> </ul> |

### <a name="category"></a>Categoria

Microsoft AppSource e Azure Marketplace são montras que servem requisitos diferentes e únicos do cliente. Escolha a montra e as categorias certas para cada oferta para direcionar os seus clientes por função. 
...
| Logotipo de oferta (formato PNG, 216 &nbsp; &times; &nbsp; 216): página de detalhes da aplicação | Desenhe e otimize o seu logótipo para um meio digital:<br>Faça upload do logótipo em formato PNG para a página de listagem de dados da sua oferta. |
...
Saiba mais sobre os seus benefícios de [mercado comercial.](./gtm-your-marketplace-benefits.md)
