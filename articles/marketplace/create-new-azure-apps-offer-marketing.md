---
title: Como vender a sua oferta de aplicação Azure
description: Conheça as opções de co-venda com a Microsoft e revenda através das opções de programa Cloud Solution Providers (CSP) para a sua oferta de aplicações Azure no mercado comercial da Microsoft.
author: aarathin
ms.author: aarathin
...
ms.locfileid: "96621438"
---
# <a name="how-to-sell-your-azure-application-offer"></a>Como vender a sua oferta de aplicação Azure

Este artigo descreve opções adicionais que pode escolher se estiver a vender a sua oferta de Aplicação Azure através da Microsoft. Pode co-vender a sua oferta com a Microsoft, revendê-la através do [programa Cloud Solution Providers (CSP),](cloud-solution-providers.md)ou ambos.
...
- [Como testar e publicar uma oferta de aplicação Azure](create-new-azure-apps-offer-test-publish.md)
