---
title: Perguntas frequentes sobre a migração para Centro parceiro . Mercado Azure
description: Este artigo aborda perguntas comumente feitas sobre a migração de ofertas do Cloud Partner Portal para partner Center.
author: anbene
...
ms.locfileid: "81274383"
---
# <a name="frequently-asked-questions-for-migrating-from-the-cloud-partner-portal-to-partner-center"></a>Perguntas frequentes para migrar do Portal do Parceiro cloud para o Partner Center
...
As ofertas serão migradas para o Partner Center a partir de 13 de abril durante todo o mês de maio. Durante este período de tempo poderá aceder ao Portal do Parceiro cloud, como de costume, exceto que o tempo que oferece está agendado para a migração.
Enquanto as suas ofertas estão a ser migradas, terão o estatuto "Locked – moving to Partner Center", como se pode ver na seguinte imagem. Este período de migração deve ser inferior a 24 horas. Durante este tempo, não poderá fazer quaisquer atualizações sobre as suas ofertas. Receberá uma notificação por e-mail depois de completarmos a migração das suas ofertas.

:::image type="content" source="media/migration-faq/all-offers-1.png" alt-text="Ilustra o estado das ofertas migratórias.":::
