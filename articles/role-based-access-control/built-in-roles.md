---
title: Papéis azure embutidos - Azure RBAC
description: Este artigo descreve as funções azure incorporadas para o controlo de acesso baseado em funções Azure (Azure RBAC). Lista Ações, NãoAções, Ações de Dados e NotDataActions.
...
> | --- | --- | --- |
> | **General** |  |  |
> | [Contribuinte](#contributor) | Permite-lhe gerir tudo, menos dar acesso aos recursos. | b24988ac-6180-42a0-ab88-20f7382dd24c |
...
> | [Administrador de Acesso do Utilizador](#user-access-administrator) | Permite-lhe gerir o acesso dos utilizadores aos recursos do Azure. | 18d7d88d-d35e-4fb5-a5c3-7773c20a72d9 |
> | **Computação** |  |  |
...
> | [Contribuinte da Caixa de Dados](#data-box-contributor) | Permite-lhe gerir tudo ao abrigo do Serviço data box, exceto dar acesso a outros. | adição466c9-e687-43fc-8d98-dfcf8d720be5 |
...
> | [Função de serviço de serviço de operador chave de conta de armazenamento](#storage-account-key-operator-service-role) | Permite a listagem e regeneração das chaves de acesso à conta de armazenamento. | 81a9662b-bebf-436f-a333-f67b2980f12 |
...
> | **Web** |  |  |
> | [Leitor de dados do Azure Maps](#azure-maps-data-reader) | Concede acesso a dados relacionados com mapas de leitura a partir de uma conta de mapas Azure. | 423170ca-a8f6-4b0f-8487-9e4eb8f49bfa |
...
> | [Colaborador do Plano Web](#web-plan-contributor) | Permite-lhe gerir os planos web para websites, mas não ter acesso aos mesmos. | 2cc479cb-7b4d-49a8-b449-8c00f00a4b |
...
> | **Bases de Dados** |  |  |
> | [Cosmos DB Papel de leitor de conta](#cosmos-db-account-reader-role) | Pode ler os dados da conta Azure Cosmos DB. Consulte o Contribuinte de [Conta DocumentDB](#documentdb-account-contributor) para gerir as contas da Azure Cosmos DB. | fbdf93bf-df7d-467e-a4d2-9458a1360c8 |
...
> | [Colaborador de Serviços de Domínio HDInsight](#hdinsight-domain-services-contributor) | Pode ler, criar, modificar e eliminar as operações relacionadas com os serviços de domínio necessários para o Pacote de Segurança Empresarial HDInsight | 8d8d5a11-05d3-4bda-a417-a08778121c7c7c |
> | [Contribuidor do Log Analytics](#log-analytics-contributor) | O Log Analytics Contributor pode ler todos os dados de monitorização e editar as definições de monitorização. As definições de monitorização de edição incluem a adição da extensão VM aos VMs; chaves da conta de armazenamento de leitura para poder configurar a recolha de registos do Armazenamento Azure; criação e configuração de contas de Automação; adicionando soluções; e configurar diagnósticos Azure em todos os recursos do Azure. | 92aaf0da-9dab-42b6-94a3-d43ce8d16293 |
...
> | [Papel do operador de serviço de gestão da API](#api-management-service-operator-role) | Pode gerir o serviço, mas não as APIs | e022efe7-f5ba-4159-bbe4-b4f577e9b61 |
...
> | [Colaborador de Subscrição de EventosGrid](#eventgrid-eventsubscription-contributor) | Permite-lhe gerir as operações de subscrição de eventos EventGrid. | 428e0ff0-5e57-4d9c-a221-2c70d0e0a43 |
...
> | [Contribuinte chave do cofre](#key-vault-contributor) | Permite-lhe gerir cofres chave, mas não acesso a eles. | f25e0fa2-a7c8-4377-a976-54943a7a395 |
> | [Administrador de Segurança](#security-admin) | Ver e atualizar permissões para o Centro de Segurança. As mesmas permissões que o papel do Leitor de Segurança e também podem atualizar a política de segurança e descartar alertas e recomendações. | fb1c8493-542b-48eb-b624-b4c8fea62acd |
...
> | [Leitor de Segurança](#security-reader) | Consulte as permissões para o Centro de Segurança. Pode ver recomendações, alertas, uma política de segurança e estados de segurança, mas não pode fazer alterações. | 39bc4728-0917-49c7-9d2c-d95423bc2eb4 |
> | **DevOps** |  |  |
...
> | [Novo contribuinte de conta APM da Relíquia](#new-relic-apm-account-contributor) | Permite-lhe gerir as contas e aplicações da New Relic Application Performance Management, mas não o acesso às mesmas. | 5d28c62d-5b37-4476-8438-e58778df237 |
...
> | [Contribuidor de Política de Recursos](#resource-policy-contributor) | Utilizadores com direitos de criar/modificar a política de recursos, criar bilhetes de apoio e ler recursos/hierarquia. | 36243c78-bf99-498c-9df9-86d9f8d28608 |
...
> | [Operador de recuperação do site](#site-recovery-operator) | Permite-lhe falhar e falhar, mas não realizar outras operações de gestão de recuperação do site | 494ae06-db33-4328-bf46-533a6560a3ca |
...
> | [Colaborador de etiquetas](#tag-contributor) | Permite-lhe gerir etiquetas em entidades, sem fornecer acesso às próprias entidades. | 4a9ae827-6dc8-4573-8ac7-8239d42a03f |
> | **Outros** |  |  |
...
> | Microsoft.Network/loadBalancers/sondas/join/action | Permite a utilização de sondas de um equilibrador de carga. Por exemplo, com esta permissão healthHealthA propriedade de conjunto de escala VM pode fazer referência à sonda. Não é alertável. |
> | Microsoft.Network/loadBalancers/read | Obtém uma definição de equilibrador de carga |
...
> | Microsoft.Network/publicIPAddresss/join/action | Junta-se a um endereço IP público. Não alertável. |
> | Microsoft.Network/publicIPAddresss/read | Obtém uma definição de endereço IP público. |
> | Microsoft.Network/virtualNetworks/read | Obtenha a definição de rede virtual |
...
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/read | Devolve detalhes do objeto do item protegido |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/write | Criar um item protegido de reserva |
...
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/blobs/delete | Devolve o resultado da aleletação de uma bolha |
> | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/read | Devolve uma bolha ou uma lista de bolhas |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/blobs/write | Devolve o resultado de escrever uma bolha |
> | **NotDataActions** |  |
> | *nenhum* |  |
...
> | Microsoft.Network/networkSecurityGroups/join/action | Junta-se a um grupo de segurança da rede. Não alertável. |
> | Microsoft.Recursos/subscrições/recursosGroups/read | Obtém ou lista grupos de recursos. |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/eliminar | Devolve o resultado da aparação de um contentor |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/read | Lista de devoluções de contentores |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/containers/write | Devolve o resultado do recipiente de colocação blob |
> | **NotActions** |  |
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/blobs/delete | Devolve o resultado da aleletação de uma bolha |
...
> | Microsoft.RecoveryServices/Vaults/backupUsageResumos/read | Resumidos resumos para itens protegidos e servidores protegidos para um serviço de recuperação . |
...
> | Microsoft.RecoveryServices/Vaults/monitoralerts/read | Recebe os alertas para o cofre dos serviços de recuperação. |
...
> | Microsoft.RecoveryServices/Vaults/monitoralerts/write | Resolve o alerta. |
...
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/operaçãoResults/read | Obtém resultado da Operação realizada no Recipiente de Proteção. |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/backup/action | Executa backup para objeto protegido. |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/operationResults/read | Obtém resultado da operação realizada em itens protegidos. |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/operationsStatus/read | Devolve o estado da Operação realizada em Itens Protegidos. |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/read | Devolve detalhes do objeto do item protegido |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/recoveryPoints/provisionInstantItemRecovery/action | Fornecimento de Recuperação instantânea de artigos para artigoprotegido |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/recoveryPoints/read | Obtenha pontos de recuperação para itens protegidos. |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/recoveryPoints/restore/action | Restaurar pontos de recuperação para itens protegidos. |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/recoveryPoints/revokeInstantItemRecovery/action | Revogar a recuperação instantânea do item para o item protegido |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/protectedItems/write | Criar um item protegido de reserva |
...
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectableContainers/read | Obtenha todos os recipientes protegidos |
> | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContentors/itens/read | Pegue todos os itens em um recipiente |
> | Microsoft.RecoveryServices/locations/backupStatus/action | Verifique o estado de backup para cofres de serviços de recuperação |
> | Microsoft.RecoveryServices/locations/backupPreValidateProtection/action |  |
> | Microsoft.RecoveryServices/locations/backupValidateFeatures/action | Validar funcionalidades |
> | Microsoft.RecoveryServices/Vaults/monitoralerts/write | Resolve o alerta. |
...
> | Microsoft.BigAnalytics/contas/Write |  |
> | Microsoft.DataLakeAnalytics/contas/Delete | Elimine uma conta DataLakeAnalytics. |
...
> | Microsoft.DataLakeAnalytics/contas/dataLakeStoreAccounts/Delete | Desligue uma conta DataLakeStore a partir de uma conta DataLakeAnalytics. |
> | Microsoft.DataLakeAnalytics/contas/storageAccounts/Write | Criar ou atualizar uma conta de Armazenamento ligada a uma conta DataLakeAnalytics. |
> | Microsoft.DataLakeAnalytics/contas/storageAccounts/Delete | Desvincular uma conta de Armazenamento a partir de uma conta DataLakeAnalytics. |
> | Microsoft.DataLakeAnalytics/contas/firewallRules/Write | Criar ou atualizar uma regra de firewall. |
> | Microsoft.DataLakeAnalytics/contas/firewallRules/Delete | Apague uma regra de firewall. |
...
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/blobs/delete | Apague uma bolha. |
> | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/read | Devolva uma bolha ou uma lista de bolhas. |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/blobs/move/action | Move a bolha de um caminho para outro |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/blobs/write | Escreva para uma bolha. |
> | **NotDataActions** |  |
> | *nenhum* |  |
...
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.Armazenamento/armazenamentoContas/blobServices/contentores/blobs/* | Permissões completas em bolhas. |
> | **NotDataActions** |  |
> | *nenhum* |  |
...
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.Storage/storageAccounts/fileServices/fileshares/files/fileshares/read | Devolve um ficheiro/pasta ou uma lista de ficheiros/pastas. |
> | Microsoft.Storage/storageAccounts/fileServices/fileshares/files/files/write | Devolve o resultado de escrever um ficheiro ou criar uma pasta. |
> | Microsoft.Storage/storageAccounts/fileServices/fileshares/files/fileshares/delete | Devolve o resultado da adesão de um ficheiro/pasta. |
> | **NotDataActions** |  |
> | *nenhum* |  |
...
> | Microsoft.Storage/storageAccounts/fileServices/fileshares/files/files/write | Devolve o resultado de escrever um ficheiro ou criar uma pasta. |
> | Microsoft.Storage/storageAccounts/fileServices/fileshares/files/fileshares/delete | Devolve o resultado da adesão de um ficheiro/pasta. |
> | Microsoft.Storage/storageAccounts/fileServices/fileshares/files/files/modificações/ação | Devolve o resultado da modificação da permissão num ficheiro/pasta. |
> | **NotDataActions** |  |
> | *nenhum* |  |
...
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.Armazenamento/armazenamentoContas/filaServiços/filas/mensagens/exclusão | Apague uma ou mais mensagens de uma fila. |
> | Microsoft.Armazenamento/armazenamentoContas/filaServiços/filas/mensagens/leitura | Espreite ou recupere uma ou mais mensagens de uma fila. |
> | Microsoft.Armazenamento/armazenamentoContas/filaServiços/filas/mensagens/escrita | Adicione uma mensagem a uma fila. |
> | **NotDataActions** |  |
> | *nenhum* |  |
...
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.Armazenamento/armazenamentoContas/filaServiços/filas/mensagens/leitura | Olha uma mensagem. |
...
### <a name="acrquarantinereader"></a>AcrQuarentenaReader
...
> | Microsoft.DocumentDB/databaseAccounts/regenerakey/* |  |
...
> | Microsoft.Sql/managedInstances/bases de dados/securityAlertPolicies/* |  |
> | Microsoft.Sql/managedInstances/bases de dados/sensibilidadeLabels/* |  |
> | Microsoft.Sql/managedInstances/bases de dados/vulnerabilidadeS/* |  |
> | Microsoft.Sql/managedInstances/securityAlertPolicies/* |  |
> | Microsoft.Sql/managedInstances/vulnerabilidadeAssessments/* |  |
> | Microsoft.Sql/servidores/bases de dados/auditingPolicies/* | Editar políticas de auditoria |
> | Microsoft.Sql/servidores/bases de dados/auditamentoDefinições/* | Editar definições de auditoria |
> | Microsoft.Sql/servidores/bases de dados/auditRecords/read | Recuperar os registos de auditoria blob da base de dados |
> | Microsoft.Sql/servidores/bases de dados/conexõesPolíticas/* | Editar políticas de conexão |
> | Microsoft.Sql/servidores/bases de dados/currentSensitivityLabels/* |  |
> | Microsoft.Sql/servidores/bases de dados/dataMaskingPolicies/* | Editar políticas de mascaramento de dados |
> | Microsoft.Sql/servidores/bases de dados/Definições de Auditoria/* estendidas |  |
> | Microsoft.Sql/servidores/bases de dados/recomendadoSEtiquetas de Sensibilidade/* |  |
> | Microsoft.Sql/servidores/bases de dados/schemas/tables/columns/sensitivityLabels/* |  |
> | Microsoft.Sql/servidores/bases de dados/securityAlertPolicies/* | Editar políticas de alerta de segurança |
> | Microsoft.Sql/servidores/bases de dados/segurançaMetrics/* | Editar métricas de segurança |
> | Microsoft.Sql/servidores/bases de dados/sensibilidadeEtiquetas/* |  |
> | Microsoft.Sql/servidores/bases de dados/vulnerabilidadeS/* |  |
> | Microsoft.Sql/servidores/bases de dados/vulnerabilidadeAssessmentScans/* |  |
> | Microsoft.Sql/servidores/bases de dados/vulnerabilidadeAssessmentSettings/* |  |
...
> | Microsoft.Sql/managedInstances/vulnerabilidadeAssessments/* |  |
> | Microsoft.Sql/servidores/auditingPolicies/* | Criar e gerir políticas de auditoria de servidores SQL |
> | Microsoft.Sql/servidores/auditamentoDefinições/* | Criar e gerir a definição de auditoria do servidor SQL |
> | Microsoft.Sql/servidores/extendedAuditingSettings/read | Recuperar detalhes da política de auditoria de blob de servidor alargado configurada num determinado servidor |
> | Microsoft.Sql/servidores/bases de dados/auditingPolicies/* | Criar e gerir políticas de auditoria da base de dados do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/auditamentoDefinições/* | Criar e gerir as definições de auditoria da base de dados do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/auditRecords/read | Recuperar os registos de auditoria blob da base de dados |
> | Microsoft.Sql/servidores/bases de dados/conexõesPolíticas/* | Criar e gerir políticas de ligação à base de dados do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/currentSensitivityLabels/* |  |
> | Microsoft.Sql/servidores/bases de dados/dataMaskingPolicies/* | Criar e gerir políticas de máscara de dados de dados de servidores SQL |
> | Microsoft.Sql/servidores/bases de dados/Definições/leitura de auditoria alargada | Recuperar detalhes da política de auditoria de blob alargada configurada numa determinada base de dados |
> | Microsoft.Sql/servidores/bases de dados/leitura | Devolva a lista de bases de dados ou obtenha as propriedades para a base de dados especificada. |
> | Microsoft.Sql/servidores/bases de dados/recomendadoSEtiquetas de Sensibilidade/* |  |
> | Microsoft.Sql/servidores/bases de dados/schemas/read | Arranja um esquema de base de dados. |
> | Microsoft.Sql/servidores/bases de dados/schemas/tables/columns/read | Arranja uma coluna de base de dados. |
> | Microsoft.Sql/servidores/bases de dados/schemas/tables/columns/sensitivityLabels/* |  |
> | Microsoft.Sql/servidores/bases de dados/schemas/tables/read | Arranja uma mesa de base de dados. |
> | Microsoft.Sql/servidores/bases de dados/securityAlertPolicies/* | Criar e gerir políticas de alerta de segurança de base de dados de servidores SQL |
> | Microsoft.Sql/servidores/bases de dados/segurançaMetrics/* | Criar e gerir métricas de segurança da base de dados do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/sensibilidadeEtiquetas/* |  |
...
> | Microsoft.Sql/managedInstances/securityAlertPolicies/* |  |
> | Microsoft.Sql/managedInstances/vulnerabilidadeAssessments/* |  |
> | Microsoft.Sql/servidores/auditingPolicies/* | Editar políticas de auditoria de servidores SQL |
> | Microsoft.Sql/servidores/auditamentoDefinições/* | Editar as definições de auditoria do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/auditingPolicies/* | Editar políticas de auditoria da base de dados do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/auditamentoDefinições/* | Editar definições de auditoria de bases de dados do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/auditRecords/read | Recuperar os registos de auditoria blob da base de dados |
> | Microsoft.Sql/servidores/bases de dados/conexõesPolíticas/* | Editar políticas de ligação à base de dados do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/currentSensitivityLabels/* |  |
> | Microsoft.Sql/servidores/bases de dados/dataMaskingPolicies/* | Editar políticas de mascaramento de dados de dados de servidores SQL |
> | Microsoft.Sql/servidores/bases de dados/Definições de Auditoria/* estendidas |  |
> | Microsoft.Sql/servidores/bases de dados/recomendadoSEtiquetas de Sensibilidade/* |  |
> | Microsoft.Sql/servidores/bases de dados/schemas/tables/columns/sensitivityLabels/* |  |
> | Microsoft.Sql/servidores/bases de dados/securityAlertPolicies/* | Editar políticas de alerta de segurança de base de dados de servidores SQL |
> | Microsoft.Sql/servidores/bases de dados/segurançaMetrics/* | Editar métricas de segurança da base de dados do servidor SQL |
> | Microsoft.Sql/servidores/bases de dados/sensibilidadeEtiquetas/* |  |
> | Microsoft.Sql/servidores/bases de dados/vulnerabilidadeS/* |  |
> | Microsoft.Sql/servidores/bases de dados/vulnerabilidadeAssessmentScans/* |  |
> | Microsoft.Sql/servidores/bases de dados/vulnerabilidadeAssessmentSettings/* |  |
> | Microsoft.Sql/servidores/definições de auditoria/* |  |
> | Microsoft.Sql/servidores/securityAlertPolicies/* | Editar políticas de alerta de segurança do servidor SQL |
> | Microsoft.Sql/servidores/vulnerabilidadeS/* |  |
> | **Ações de Dados** |  |
> | *nenhum* |  |
> | **NotDataActions** |  |
...
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.EventHub/*/enviar/ação |  |
> | **NotDataActions** |  |
> | *nenhum* |  |
...
> | Microsoft.OperationalInsights/workspaces/purga/ação | Eliminar dados especificados do espaço de trabalho |
> | **NotActions** |  |
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | *nenhum* |  |
...
> | Microsoft.Insights/diagnósticoDefinições/leitura | Leia uma definição de diagnóstico de recursos |
> | Microsoft.Insights/logDefinis/read | Ler definições de registo |
> | Microsoft.Insights/metricdefinições/read | Ler definições métricas |
> | Microsoft.Insights/metrics/read | Leia as métricas |
> | Microsoft.ResourceHealth/availabilityStatuses/read | Obtém o estado de disponibilidade de todos os recursos no âmbito especificado |
...
> | Microsoft.MixedReality/SpatialAnchorsAccounts/consulta/read | Localizar âncoras espaciais |
...
> | *nenhum* |  |
> | **Ações de Dados** |  |
> | Microsoft.ServiceBus/*/enviar/ação |  |
> | **NotDataActions** |  |
> | *nenhum* |  |
...
> | Microsoft.Insights/diagnósticoDefinições/*/read | Obtém definições de diagnóstico para Aplicações Lógicas |
...
> | Microsoft.Logic/workflows/enable/action | Permite o fluxo de trabalho. |
> | Microsoft.Logic/workflows/validação/ação | Valida o fluxo de trabalho. |
> | Microsoft.Recursos/implementações/operações/leitura | Obtém ou lista operações de implantação. |
> | Microsoft.Recursos/subscrições/resultados de operação/leitura | Obtenha os resultados da operação de subscrição. |
> | Microsoft.Recursos/subscrições/recursosGroups/read | Obtém ou lista grupos de recursos. |
> | Microsoft.Support/* | Criar e atualizar um bilhete de apoio |
...
> | Microsoft.OperationalInsights/workspaces/consulta/read | Executar consultas sobre os dados no espaço de trabalho |
...
Ver e atualizar permissões para o Centro de Segurança. As mesmas permissões que o papel do Leitor de Segurança e também podem atualizar a política de segurança e descartar alertas e recomendações.
...
Consulte as permissões para o Centro de Segurança. Pode ver recomendações, alertas, uma política de segurança e estados de segurança, mas não pode fazer alterações.
...
> | Microsoft.DevTestLab/labs/policySets/assessPolicies/action | Avalia a política do laboratório. |
> | Microsoft.DevTestLab/labs/virtualMachines/claim/action | Apropriar-se de uma máquina virtual existente |
> | Microsoft.DevTestLab/labs/virtualmachines/listAplicávelAgendas/action | Lista os horários de início/paragem aplicáveis, caso seja. |
...
> | Microsoft.Network/networkInterfaces/read | Obtém uma definição de interface de rede.  |
> | Microsoft.Network/networkInterfaces/write | Cria uma interface de rede ou atualiza uma interface de rede existente.  |
> | Microsoft.Network/publicIPAddresss/*/read | Leia as propriedades de um endereço IP público |
> | Microsoft.Network/publicIPAddresss/join/action | Junta-se a um endereço IP público. Não alertável. |
> | Microsoft.Network/publicIPAddresss/read | Obtém uma definição de endereço IP público. |
> | Microsoft.Network/virtualNetworks/subnets/join/action | Junta-se a uma rede virtual. Não alertável. |
> | Microsoft.Recursos/implementações/operações/leitura | Obtém ou lista operações de implantação. |
> | Microsoft.Recursos/implementações/leitura | Obtém ou lista destacamentos. |
> | Microsoft.Recursos/subscrições/recursosGroups/read | Obtém ou lista grupos de recursos. |
> | Microsoft.Storage/storageAccounts/listKeys/action | Devolve as chaves de acesso da conta de armazenamento especificada. |
> | **NotActions** |  |
...
> | Microsoft.OperationalInsights/workspaces/write | Cria um novo espaço de trabalho ou ligações a um espaço de trabalho existente, fornecendo o id do cliente a partir do espaço de trabalho existente. |
...
> | Microsoft.Automação/automatizaçãoContas/empregos/currículo/ação | Retoma um trabalho de Automação Azure |
> | Microsoft.Automação/automatizaçãoContas/empregos/stop/action | Interrompe um trabalho de Automação Azure |
> | Microsoft.Automação/automatizaçãoContas/empregos/streams/read | Obtém um fluxo de trabalho da Azure Automation |
...
> | Microsoft.Automação/automatizaçãoContas/empregos/suspensão/ação | Suspende um trabalho de Automação Azure |
> | Microsoft.Automação/automatizaçãoContas/empregos/escrita | Cria um trabalho de Automação Azure |
> | Microsoft.Automação/automatizaçãoContas/jobAgendas/read | Obtém um horário de trabalho da Azure Automation |
> | Microsoft.Automação/automatizaçãoContas/jobAgendas/write | Cria um horário de trabalho da Automação Azure |
...
Pode atribuir plantas publicadas existentes, mas não pode criar novas plantas. Note que isto só funciona se a atribuição for feita com uma identidade gerida atribuída pelo utilizador.
...
> | Microsoft.Management/managementGroups/subscrições/write | Associa a subscrição existente com o grupo de gestão. |
...
> | Microsoft.RecoveryServices/vaults/replicationEvents/read | Leia quaisquer Eventos |
> | Microsoft.RecoveryServices/vaults/replicationFabrics/checkConsistência/ação | Verifica a consistência do tecido |
...
> | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectItems/read | Leia quaisquer itens protegidos |
...
> | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectionContainers/read | Leia quaisquer mapeamentos de contentores de proteção |
...
Permite-lhe gerir etiquetas em entidades, sem fornecer acesso às próprias entidades.
