---
title: Listar definições de função no RBAC do Azure usando portal do Azure, Azure PowerShell ou CLI do Azure | Microsoft Docs
description: Saiba como listar funções internas e personalizadas no RBAC do Azure usando portal do Azure, Azure PowerShell ou CLI do Azure.
