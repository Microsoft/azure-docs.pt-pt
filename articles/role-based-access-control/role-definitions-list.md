...
Para listar todas as funções no Azure CLI, utilize [a lista de definição de funções az](/cli/azure/role/definition#az_role_definition_list).
...
Para listar detalhes de uma [função, utilize a lista de definição de função az](/cli/azure/role/definition#az_role_definition_list).
