...
> | Ação | Microsoft.AAD/domainServices/replicaSets/delete | Eliminar o Site do Cluster |
> | Ação | Microsoft.AAD/domainServices/replicaSets/read | Site do Cluster de leitura |
> | Ação | Microsoft.AAD/domainServices/replicaSets/write | Escrever o Site do Cluster |
...
> | Ação | Microsoft.ADHybridHealthService/services/reports/blobUris/read | Obtém o relatório de IP em risco todos os URIs dos últimos 7 dias. |
...
> | Ação | Microsoft.ADHybridHealthService/services/reports/generateBlobUri/action | Gera o relatório de IP em risco e devolve um URI apontando para ele. |
...
> | Ação | Microsoft.ADHybridHealthService/services/servicemembers/metrics/read | Obtém a lista de conectores e nomes de perfil de execução para o determinado serviço e o membro de serviço. |
...
> | Ação | Microsoft.AlertsManagement/smartDetectorAlertRules/delete | Eliminar regra de alerta inteligentes detetor numa determinada subscrição |
> | Ação | Microsoft.AlertsManagement/smartDetectorAlertRules/read | Obter todas as detetor inteligente regras de alerta para os filtros de entrada |
> | Ação | Microsoft.AlertsManagement/smartDetectorAlertRules/write | Criar ou atualizar regra de alerta inteligentes detetor numa determinada subscrição |
...
> | Ação | Microsoft.ApiManagement/service/apis/delete | Elimina a instância do serviço de gestão de API de API especificada. |
> | Ação | Microsoft.ApiManagement/service/apis/diagnostics/delete | Elimina o diagnóstico especificado a partir de uma API. |
> | Ação | Microsoft.ApiManagement/service/apis/diagnostics/read | Apresenta uma lista de todos os diagnósticos de uma API. ou obtém os detalhes do diagnóstico de uma API especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/diagnostics/write | Cria um novo diagnóstico de uma API ou atualiza um já existente. ou os detalhes do diagnóstico de uma API especificados pelo respetivo identificador de atualizações. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/attachments/delete | Elimina o comentário especificado de um problema. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/attachments/read | Listas de todos os anexos para o problema associado com a API especificada. ou obtém os detalhes do problema de anexo de uma API especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/attachments/write | Cria um novo anexo para o problema numa API ou atualiza um já existente. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/comments/delete | Elimina o comentário especificado de um problema. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/comments/read | Listas de todos os comentários para o problema associado com a API especificada. ou obtém os detalhes do problema de comentário para uma API especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/comments/write | Cria um novo comentário para o problema numa API ou atualiza um já existente. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/delete | Elimina o problema especificado a partir de uma API. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/read | Apresenta uma lista de todos os problemas associados com a API especificada. ou obtém os detalhes do problema de uma API especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/write | Cria um novo problema de uma API ou atualiza um já existente. ou atualizações existente emitir para uma API. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/delete | Elimina a operação especificada na API. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/policies/delete | Elimina a configuração da política na operação de Api. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/policies/read | Obter a lista de configuração de política ao nível da operação de API. ou obtenha a configuração da política ao nível da operação de API. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/policies/write | Cria ou atualiza a configuração da política para o nível de operação de API. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/policy/delete | Eliminar a configuração de política ao nível da operação |
> | Ação | Microsoft.ApiManagement/service/apis/operations/policy/read | Obter a configuração de política ao nível da operação |
> | Ação | Microsoft.ApiManagement/service/apis/operations/policy/write | Criar configuração de política na operação de nível |
> | Ação | Microsoft.ApiManagement/service/apis/operations/read | Apresenta uma lista de uma coleção de operações para a API especificada. ou obtém os detalhes da operação de API especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/tags/delete | Anular a exposição a marca da operação. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/tags/read | Apresenta uma lista de todas as marcas associadas com a operação. ou obtenha de etiqueta associada com a operação. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/tags/write | Atribua etiqueta para a operação. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/write | Cria uma nova operação na API ou atualiza um já existente. ou os detalhes da operação na API especificados pelo respetivo identificador de atualizações. |
> | Ação | Microsoft.ApiManagement/service/apis/operationsByTags/read | Apresenta uma lista de uma coleção de operações associadas a etiquetas. |
> | Ação | Microsoft.ApiManagement/service/apis/policies/delete | Elimina a configuração da política da API. |
> | Ação | Microsoft.ApiManagement/service/apis/policies/read | Obter a configuração de política ao nível da API. ou obtenha a configuração da política no nível da API. |
> | Ação | Microsoft.ApiManagement/service/apis/policies/write | Cria ou atualiza a configuração da política para a API. |
> | Ação | Microsoft.ApiManagement/service/apis/policy/delete | Eliminar a configuração de política ao nível da API |
> | Ação | Microsoft.ApiManagement/service/apis/policy/read | Obter a configuração de política ao nível da API |
> | Ação | Microsoft.ApiManagement/service/apis/policy/write | Criar configuração de política na API de nível |
> | Ação | Microsoft.ApiManagement/service/apis/products/read | Apresenta uma lista de todos os produtos, o que a API faz parte do. |
> | Ação | Microsoft.ApiManagement/service/apis/read | Apresenta uma lista de todas as APIs de instância de serviço de gestão de API. ou obtém os detalhes da API especificada pelo respetivo identificador. |
...
> | Ação | Microsoft.ApiManagement/service/apis/releases/read | Apresenta uma lista de todas as versões de uma API.<br>Uma versão de API é criada quando fazer uma revisão de API atual.<br>Versões também são utilizadas para reversão para revisões anteriores.<br>Os resultados serão paginar e podem ser limitados pelos parâmetros $top e $skip.<br>ou devolve os detalhes de uma API de versão. |
> | Ação | Microsoft.ApiManagement/service/apis/releases/write | Cria uma nova versão para a API. ou os detalhes da versão da API especificados pelo respetivo identificador de atualizações. |
> | Ação | Microsoft.ApiManagement/service/apis/revisions/delete | Remove todas as revisões de uma API |
> | Ação | Microsoft.ApiManagement/service/apis/revisions/read | Apresenta uma lista de todas as revisões de uma API. |
> | Ação | Microsoft.ApiManagement/service/apis/schemas/delete | Elimina a configuração de esquema de API. |
> | Ação | Microsoft.ApiManagement/service/apis/schemas/read | Obter a configuração de esquema no nível da API. ou obtenha a configuração de esquema no nível da API. |
> | Ação | Microsoft.ApiManagement/service/apis/schemas/write | Cria ou atualiza a configuração de esquema para a API. |
> | Ação | Microsoft.ApiManagement/service/apis/tagDescriptions/delete | Elimine descrição da etiqueta para a Api. |
> | Ação | Microsoft.ApiManagement/service/apis/tagDescriptions/read | Apresenta uma lista de todas as descrições de etiquetas no âmbito da API. Modelar semelhante do swagger - tagDescription é definida no nível da API mas tag podem ser atribuídos às operações ou obter a descrição da etiqueta no âmbito da API |
> | Ação | Microsoft.ApiManagement/service/apis/tagDescriptions/write | Criar/atualizar descrição da etiqueta no âmbito da Api. |
> | Ação | Microsoft.ApiManagement/service/apis/tags/delete | Anular a exposição a marca da Api. |
> | Ação | Microsoft.ApiManagement/service/apis/tags/read | Apresenta uma lista de todas as marcas associadas com a API. ou obtenha de etiqueta associada com a API. |
> | Ação | Microsoft.ApiManagement/service/apis/tags/write | Atribua etiqueta para a Api. |
> | Ação | Microsoft.ApiManagement/service/apis/write | Cria nova ou de atualizações de API especificada existente da instância de serviço de gestão de API. Atualizações ou a API especificada da instância de serviço de gestão de API. |
> | Ação | Microsoft.ApiManagement/service/apisByTags/read | Apresenta uma lista de uma coleção de apis associadas com etiquetas. |
> | Ação | Microsoft.ApiManagement/service/apiVersionSets/delete | Elimina o conjunto da versão de Api específica. |
> | Ação | Microsoft.ApiManagement/service/apiVersionSets/read | Apresenta uma lista de uma coleção de conjuntos da versão de API na instância do serviço especificado. ou obtém os detalhes do conjunto de versão de Api especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/apiVersionSets/versions/read | Obter lista de entidades de versão |
> | Ação | Microsoft.ApiManagement/service/apiVersionSets/write | Cria ou atualiza um conjunto de versão de Api. Atualizações ou os detalhes do VersionSet de Api especificada pelo respetivo identificador. |
...
> | Ação | Microsoft.ApiManagement/service/authorizationServers/delete | Elimina a instância de servidor de autorização específico. |
> | Ação | Microsoft.ApiManagement/service/authorizationServers/read | Apresenta uma lista de uma coleção de servidores de autorização definida dentro de uma instância de serviço. ou obtém os detalhes do servidor de autorização especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/authorizationServers/write | Cria o novo servidor de autorização ou atualiza um servidor de autorização existente. Atualizações ou os detalhes do servidor de autorização especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/backends/delete | Elimina o back-end especificado. |
> | Ação | Microsoft.ApiManagement/service/backends/read | Apresenta uma lista de uma coleção de back-ends na instância do serviço especificado. ou obtém os detalhes de back-end especificado pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/backends/reconnect/action | Notifica o proxy APIM para criar uma nova ligação para o back-end após o tempo limite especificado. Não se foi especificado nenhum tempo de limite, é utilizado o tempo limite de 2 minutos. |
...
> | Ação | Microsoft.ApiManagement/service/caches/delete | Elimina o Cache específico. |
> | Ação | Microsoft.ApiManagement/service/caches/read | Apresenta uma lista de uma coleção de todas as Caches externas na instância do serviço especificado. ou obtém os detalhes da Cache especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/caches/write | Cria ou atualiza um Cache externo a ser utilizado na instância de gestão de Api. Atualizações ou os detalhes da cache especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/certificates/delete | Elimina o certificado específico. |
> | Ação | Microsoft.ApiManagement/service/certificates/read | Apresenta uma lista de uma coleção de todos os certificados na instância do serviço especificado. ou obtém os detalhes do certificado especificado pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/certificates/write | Cria ou atualiza o certificado que está a ser utilizado para a autenticação com o back-end. |
...
> | Ação | Microsoft.ApiManagement/service/diagnostics/read | Apresenta uma lista de todos os diagnósticos da instância de serviço de gestão de API. ou obtém os detalhes do diagnóstico especificado pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/diagnostics/write | Cria um novo diagnóstico ou atualiza um já existente. Atualizações ou os detalhes do diagnóstico especificado pelo respetivo identificador. |
...
> | Ação | Microsoft.ApiManagement/service/groups/delete | Elimina o grupo específico de instância do serviço de gestão de API. |
> | Ação | Microsoft.ApiManagement/service/groups/read | Apresenta uma lista de uma coleção de grupos definidos dentro de uma instância de serviço. ou obtém os detalhes do grupo especificado pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/groups/users/delete | Remova utilizador existente do grupo existente. |
> | Ação | Microsoft.ApiManagement/service/groups/users/read | Apresenta uma lista de uma coleção de entidades de utilizador associado ao grupo. |
> | Ação | Microsoft.ApiManagement/service/groups/users/write | Adicionar utilizador existente para o grupo existente |
> | Ação | Microsoft.ApiManagement/service/groups/write | Cria ou atualiza um grupo. Atualizações ou os detalhes do grupo especificado pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/identityProviders/delete | Elimina a configuração do fornecedor de identidade especificada. |
> | Ação | Microsoft.ApiManagement/service/identityProviders/read | Apresenta uma lista de uma coleção de fornecedor de identidade configurado na instância do serviço especificado. Obtém os detalhes de configuração do fornecedor de identidade configurada ou numa instância de serviço especificado. |
> | Ação | Microsoft.ApiManagement/service/identityProviders/write | Cria ou atualiza a configuração de IdentityProvider. ou atualiza uma configuração de IdentityProvider existente. |
> | Ação | Microsoft.ApiManagement/service/issues/read | Apresenta uma lista de uma coleção de problemas na instância do serviço especificado. ou detalhes do problema é a gestão de API |
...
> | Ação | Microsoft.ApiManagement/service/loggers/delete | Elimina o agente de log especificado. |
> | Ação | Microsoft.ApiManagement/service/loggers/read | Apresenta uma lista de uma coleção de agentes na instância do serviço especificado. ou obtém os detalhes de agente especificado pelo respetivo identificador. |
...
> | Ação | Microsoft.ApiManagement/service/notifications/read | Apresenta uma lista de uma coleção de propriedades definidas dentro de uma instância de serviço. ou obtém os detalhes da notificação especificado pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientEmails/delete | Remove o e-mail da lista de notificação. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientEmails/read | Obtém a lista de mensagens de E-Mail de destinatário da notificação subscrever uma notificação. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientEmails/write | Adiciona o endereço de E-Mail para a lista de destinatários da notificação. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientUsers/delete | Remove o utilizador de gestão de API a partir da lista de notificação. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientUsers/read | Obtém a lista do utilizador de destinatário da notificação subscrever a notificação. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientUsers/write | Adiciona o utilizador de gestão de API à lista de destinatários da notificação. |
> | Ação | Microsoft.ApiManagement/service/notifications/write | Criar ou notificação de editor de gestão de API de atualização. |
> | Ação | Microsoft.ApiManagement/service/openidConnectProviders/delete | Elimina o OpenID Connect provedor específico da instância de serviço de gestão de API. |
> | Ação | Microsoft.ApiManagement/service/openidConnectProviders/read | Listas de todos os fornecedores de ligação do OpenId. ou obtém específico fornecedor de ligação OpenID. |
> | Ação | Microsoft.ApiManagement/service/openidConnectProviders/write | Cria ou atualiza o fornecedor de ligação OpenID. Atualizações ou o fornecedor de ligação do OpenID específico. |
> | Ação | Microsoft.ApiManagement/service/operationresults/read | Obtém o estado atual da operação de longa |
> | Ação | Microsoft.ApiManagement/service/policies/delete | Elimina a configuração de política global do serviço de gestão de Api. |
> | Ação | Microsoft.ApiManagement/service/policies/read | Apresenta uma lista de todas as definições de política Global do serviço de gestão de Api. ou obtenha a definição de política Global do serviço de gestão de Api. |
> | Ação | Microsoft.ApiManagement/service/policies/write | Cria ou atualiza a configuração da política global do serviço de gestão de Api. |
> | Ação | Microsoft.ApiManagement/service/policy/delete | Eliminar a configuração de política ao nível do inquilino |
> | Ação | Microsoft.ApiManagement/service/policy/read | Obter a configuração de política ao nível do inquilino |
> | Ação | Microsoft.ApiManagement/service/policy/write | Criar configuração de política de nível no inquilino |
> | Ação | Microsoft.ApiManagement/service/policySnippets/read | Apresenta uma lista de todos os fragmentos de política. |
> | Ação | Microsoft.ApiManagement/service/portalsettings/read | Obter o início de sessão nas definições para o Portal ou início de sessão de Get configurar definições para o Portal ou obter as definições de delegação para o Portal. |
> | Ação | Microsoft.ApiManagement/service/portalsettings/write | Atualize as definições de início de sessão. ou definições de criação ou atualização de início de sessão. ou as definições de atualização inscrever-se ou as definições de atualização inscrever-se ou as definições de delegação de atualização. ou definições de criação ou atualização de delegação. |
> | Ação | Microsoft.ApiManagement/service/products/apis/delete | Elimina a API especificada do produto especificado. |
> | Ação | Microsoft.ApiManagement/service/products/apis/read | Listas de uma coleção de APIs associadas com um produto. |
> | Ação | Microsoft.ApiManagement/service/products/apis/write | Adiciona uma API ao produto especificado. |
> | Ação | Microsoft.ApiManagement/service/products/delete | Elimine o produto. |
> | Ação | Microsoft.ApiManagement/service/products/groups/delete | Elimina a associação entre o grupo especificado e o produto. |
> | Ação | Microsoft.ApiManagement/service/products/groups/read | Lista a coleção de grupos de desenvolvedor associados com o produto especificado. |
> | Ação | Microsoft.ApiManagement/service/products/groups/write | Adiciona a associação entre o grupo de desenvolvedor especificado com o produto especificado. |
> | Ação | Microsoft.ApiManagement/service/products/policies/delete | Elimina a configuração de política, o produto. |
> | Ação | Microsoft.ApiManagement/service/products/policies/read | Obter a configuração de política ao nível do produto. ou obtenha a configuração da política ao nível do produto. |
> | Ação | Microsoft.ApiManagement/service/products/policies/write | Cria ou atualiza a configuração da política para o produto. |
> | Ação | Microsoft.ApiManagement/service/products/policy/delete | Eliminar a configuração de política ao nível do produto |
> | Ação | Microsoft.ApiManagement/service/products/policy/read | Obter a configuração de política ao nível do produto |
> | Ação | Microsoft.ApiManagement/service/products/policy/write | Criar configuração de política no produto nível |
> | Ação | Microsoft.ApiManagement/service/products/read | Apresenta uma lista de uma coleção de produtos na instância do serviço especificado. ou obtém os detalhes do produto especificado pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/products/subscriptions/read | Lista o conjunto de subscrições para o produto especificado. |
> | Ação | Microsoft.ApiManagement/service/products/tags/delete | Anular a exposição a marca do produto. |
> | Ação | Microsoft.ApiManagement/service/products/tags/read | Apresenta uma lista de todas as marcas associadas com o produto. ou obtenha de etiqueta associada ao produto. |
> | Ação | Microsoft.ApiManagement/service/products/tags/write | Atribua etiqueta para o produto. |
> | Ação | Microsoft.ApiManagement/service/products/write | Cria ou atualiza um produto. ou atualizar detalhes do produto existente. |
> | Ação | Microsoft.ApiManagement/service/productsByTags/read | Apresenta uma lista de uma coleção de produtos associados com etiquetas. |
> | Ação | Microsoft.ApiManagement/service/properties/delete | Elimina a propriedade específica da instância do serviço de gestão de API. |
> | Ação | Microsoft.ApiManagement/service/properties/read | Apresenta uma lista de uma coleção de propriedades definidas dentro de uma instância de serviço. ou obtém os detalhes da propriedade especificada pelo respetivo identificador. |
...
> | Ação | Microsoft.ApiManagement/service/regions/read | Apresenta uma lista de todas as regiões do azure na qual o serviço existe. |
...
> | Ação | Microsoft.ApiManagement/service/subscriptions/read | Apresenta uma lista de todas as subscrições da instância de serviço de gestão de API. ou obtém a entidade de subscrição especificada. |
> | Ação | Microsoft.ApiManagement/service/subscriptions/regeneratePrimaryKey/action | Regenera a chave primária de uma subscrição existente da instância de serviço de gestão de API. |
> | Ação | Microsoft.ApiManagement/service/subscriptions/regenerateSecondaryKey/action | Regenera a chave secundária de uma subscrição existente da instância de serviço de gestão de API. |
> | Ação | Microsoft.ApiManagement/service/subscriptions/write | Cria ou atualiza a subscrição de utilizador especificado para o produto especificado. Atualizações ou os detalhes de uma subscrição especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/tagResources/read | Apresenta uma lista de uma coleção de recursos associados com etiquetas. |
> | Ação | Microsoft.ApiManagement/service/tags/delete | Elimina uma etiqueta específica da instância de serviço de gestão de API. |
> | Ação | Microsoft.ApiManagement/service/tags/read | Apresenta uma lista de uma coleção de etiquetas definido dentro de uma instância de serviço. ou obtém os detalhes da etiqueta especificada pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/tags/write | Cria uma etiqueta. Atualizações ou os detalhes da etiqueta especificada pelo respetivo identificador. |
...
> | Ação | Microsoft.ApiManagement/service/tenant/read | Obter a definição de política Global do serviço de gestão de Api. ou Obtenha detalhes de informações de acesso de inquilino |
...
> | Ação | Microsoft.ApiManagement/service/users/delete | Elimina o utilizador específico. |
> | Ação | Microsoft.ApiManagement/service/users/generateSsoUrl/action | Obtém um URL de redirecionamento que contém um token de autenticação para um determinado utilizador a iniciar sessão no portal do programador. |
> | Ação | Microsoft.ApiManagement/service/users/groups/read | Apresenta uma lista de todos os grupos de utilizadores. |
> | Ação | Microsoft.ApiManagement/service/users/identities/read | Lista de todas as identidades de utilizador. |
> | Ação | Microsoft.ApiManagement/service/users/keys/read | Obter chaves associadas a utilizador |
> | Ação | Microsoft.ApiManagement/service/users/read | Apresenta uma lista de uma coleção de utilizadores registados na instância do serviço especificado. ou obtém os detalhes de utilizador especificado pelo respetivo identificador. |
> | Ação | Microsoft.ApiManagement/service/users/subscriptions/read | Lista o conjunto de subscrições do utilizador especificado. |
> | Ação | Microsoft.ApiManagement/service/users/token/action | Obtém a autorização de acesso partilhado Token para o utilizador. |
> | Ação | Microsoft.ApiManagement/service/users/write | Cria ou atualiza um utilizador. Atualizações ou os detalhes de utilizador especificado pelo respetivo identificador. |
...
> | Ação | Microsoft.Authorization/classicAdministrators/operationstatuses/read | Obtém o administrador de Estados de funcionamento da subscrição. |
...
> | Ação | Microsoft.Authorization/denyAssignments/delete | Elimine uma atribuição de negar no âmbito especificado. |
> | Ação | Microsoft.Authorization/denyAssignments/read | Obtenha informações sobre uma atribuição de negação. |
> | Ação | Microsoft.Authorization/denyAssignments/write | Crie uma atribuição de negar no âmbito especificado. |
> | Ação | Microsoft.Authorization/elevateAccess/action | Garante ao chamador acesso de administrador de acesso de utilizador no âmbito do inquilino |
...
> | Ação | Microsoft.Authorization/locks/write | Adicione bloqueios no âmbito especificado. |
> | Ação | Microsoft.Authorization/operations/read | Obtém a lista de operações |
> | Ação | Microsoft.Authorization/permissions/read | Apresenta uma lista de todas as permissões que o chamador tem num determinado âmbito. |
> | Ação | Microsoft.Authorization/policyAssignments/delete | Elimine uma atribuição de política no âmbito especificado. |
> | Ação | Microsoft.Authorization/policyAssignments/read | Obtenha informações sobre uma atribuição de política. |
...
> | Ação | Microsoft.Authorization/policySetDefinitions/delete | Elimine uma definição de conjunto de políticas. |
> | Ação | Microsoft.Authorization/policySetDefinitions/read | Obtenha informações sobre uma definição de conjunto de políticas. |
> | Ação | Microsoft.Authorization/policySetDefinitions/write | Crie uma definição de política personalizada do conjunto. |
> | Ação | Microsoft.Authorization/providerOperations/read | Obter operações para todos os fornecedores de recursos que podem ser utilizadas em definições de funções. |
> | Ação | Microsoft.Authorization/roleAssignments/delete | Elimine uma atribuição de função no âmbito especificado. |
> | Ação | Microsoft.Authorization/roleAssignments/read | Obtenha informações sobre uma atribuição de função. |
> | Ação | Microsoft.Authorization/roleAssignments/write | Crie uma atribuição de função no âmbito especificado. |
> | Ação | Microsoft.Authorization/roleDefinitions/delete | Elimine a definição de função personalizada especificada. |
> | Ação | Microsoft.Authorization/roleDefinitions/read | Obtenha informações sobre uma definição de função. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.AzureActiveDirectory/b2cDirectories/delete | Eliminar recurso do diretório B2C |
> | Ação | Microsoft.AzureActiveDirectory/b2cDirectories/read | Ver recursos de diretório B2C |
> | Ação | Microsoft.AzureActiveDirectory/b2cDirectories/write | Criar ou atualizar o recurso de diretório B2C |
> | Ação | Microsoft.AzureActiveDirectory/b2ctenants/read | Apresenta uma lista de todos os inquilinos de B2C em que o utilizador é membro |
> | Ação | Microsoft.AzureActiveDirectory/operations/read | Ler todas as operações API disponíveis para o fornecedor de recursos Microsoft. azureactivedirectory |
> | Ação | Microsoft.AzureActiveDirectory/register/action | Registar subscrição para o fornecedor de recursos Microsoft. azureactivedirectory |
...
> | Ação | Microsoft.BingMaps/mapApis/listSingleSignOnToken/action | Ler Token de autorização para o recurso de início de sessão único |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Blockchain/blockchainMembers/delete | Elimina um membro de Blockchain existente. |
> | Ação | Microsoft.Blockchain/blockchainMembers/listApiKeys/action | Obtém ou lista de chaves de Api de membro de Blockchain existentes. |
> | Ação | Microsoft.Blockchain/blockchainMembers/read | Obtém ou lista existente de Blockchain de membro ou membros. |
...
> | Ação | Microsoft.Blockchain/blockchainMembers/transactionNodes/delete | Elimina um nó de transação de membro de Blockchain existente. |
> | Ação | Microsoft.Blockchain/blockchainMembers/transactionNodes/listApiKeys/action | Obtém ou lista existente Blockchain membro transação nó chaves de Api. |
> | Ação | Microsoft.Blockchain/blockchainMembers/transactionNodes/read | Obtém ou lista de nós de transação de membro de Blockchain existente. |
> | Ação | Microsoft.Blockchain/blockchainMembers/transactionNodes/write | Cria ou atualiza um nó de transação de membro de Blockchain. |
> | Ação | Microsoft.Blockchain/blockchainMembers/write | Cria ou atualiza um membro de Blockchain. |
> | Ação | Microsoft.Blockchain/locations/blockchainMemberOperationResults/read | Obtém os resultados da operação de membros de Blockchain. |
> | Ação | Microsoft.Blockchain/locations/checkNameAvailability/action | Verifica esse nome de recurso é válido e não está em utilização. |
> | Ação | Microsoft.Blockchain/operations/read | Liste todas as operações de fornecedor de recursos do Microsoft Blockchain. |
> | Ação | Microsoft.Blockchain/register/action | Regista a subscrição para o fornecedor de recursos de Blockchain. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Blueprint/blueprintAssignments/assignmentOperations/read | Ler quaisquer artefactos de esquema |
...
> | Ação | Microsoft.Blueprint/blueprintAssignments/whoisblueprint/action | Obter o objeto principal do serviço Azure esquemas ID. |
...
> | Ação | Microsoft.Cache/locations/operationresults/read | Obtém o resultado de uma longa que executa a operação para o qual o cabeçalho "Location" foi devolvido anteriormente ao cliente |
> | Ação | Microsoft.Cache/operations/read | Lista as operações que suporta o fornecedor "Microsoft. cache". |
> | Ação | Microsoft.Cache/redis/delete | Eliminar a Cache de Redis completa |
> | Ação | Microsoft.Cache/redis/export/action | Exportar dados Redis para blobs de armazenamento com prefixo no formato especificado |
> | Ação | Microsoft.Cache/redis/firewallRules/delete | Eliminar regras de firewall do IP de uma Cache de Redis |
> | Ação | Microsoft.Cache/redis/firewallRules/read | Obter as regras de firewall do IP de uma Cache de Redis |
> | Ação | Microsoft.Cache/redis/firewallRules/write | Editar as regras de firewall do IP de uma Cache de Redis |
...
> | Ação | Microsoft.Cache/redis/listUpgradeNotifications/read | Liste as notificações de atualização mais recente para o inquilino de cache. |
> | Ação | Microsoft.Cache/redis/metricDefinitions/read | Obtém as métricas disponíveis para uma Cache de Redis |
> | Ação | Microsoft.Cache/redis/patchSchedules/delete | Eliminar a agenda de correção de um Cache de Redis |
...
> | Ação | Microsoft.Cache/redis/read | Ver definições e a configuração da Cache de Redis no portal de gestão |
> | Ação | Microsoft.Cache/redis/regenerateKey/action | Altere o valor das chaves de acesso da Cache de Redis no portal de gestão |
> | Ação | Microsoft.Cache/redis/start/action | Inicie uma instância de cache. |
> | Ação | Microsoft.Cache/redis/stop/action | Pare uma instância da cache. |
> | Ação | Microsoft.Cache/redis/write | Modificar as definições da Cache de Redis e a configuração no portal de gestão |
...
> | Ação | Microsoft.Capacity/calculateexchange/action | Calcula a quantidade de exchange e o preço de compra de novos e retorna a política de erros. |
...
> | Ação | Microsoft.Capacity/exchange/action | Qualquer reserva do Exchange |
...
> | Ação | Microsoft.Capacity/reservationorders/calculaterefund/action | Calcula a quantidade de reembolso e o preço de compra de novos e retorna a política de erros. |
...
> | Ação | Microsoft.Cdn/register/action | Regista a subscrição para o fornecedor de recursos CDN e permite a criação de perfis da CDN. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/active/write | Define o nome de domínio Active Directory. |
> | Ação | Microsoft.ClassicCompute/domainNames/availabilitySets/read | Mostre a conjunto de disponibilidade para o recurso. |
> | Ação | Microsoft.ClassicCompute/domainNames/capabilities/read | Mostra o domínio de recursos de nome |
...
> | Ação | Microsoft.ClassicCompute/domainNames/deploymentslots/state/write | Adicione o estado do bloco de implementação. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/extensions/operationStatuses/read | Lê o estado da operação para o domínio das extensões de nomes. |
> | Ação | Microsoft.ClassicCompute/domainNames/extensions/read | Devolve extensões de nome de domínio. |
> | Ação | Microsoft.ClassicCompute/domainNames/extensions/write | Adicione as extensões de nome de domínio. |
> | Ação | Microsoft.ClassicCompute/domainNames/internalLoadBalancers/delete | Remova um novo Balanceador de carga interno. |
> | Ação | Microsoft.ClassicCompute/domainNames/internalLoadBalancers/operationStatuses/read | Lê o estado da operação de nomes de domínio balanceadores de carga internos. |
> | Ação | Microsoft.ClassicCompute/domainNames/internalLoadBalancers/read | Obtém os balanceadores de carga interno. |
> | Ação | Microsoft.ClassicCompute/domainNames/internalLoadBalancers/write | Cria um novo Balanceador de carga interno. |
> | Ação | Microsoft.ClassicCompute/domainNames/loadBalancedEndpointSets/operationStatuses/read | Lê o estado da operação de nomes de domínio conjuntos de ponto final com balanceamento de carga. |
> | Ação | Microsoft.ClassicCompute/domainNames/loadBalancedEndpointSets/read | Obtenha os conjuntos de ponto final com balanceamento de carga. |
> | Ação | Microsoft.ClassicCompute/domainNames/loadBalancedEndpointSets/write | Adicione o conjunto de ponto final com balanceamento de carga. |
> | Ação | Microsoft.ClassicCompute/domainNames/operationstatuses/read | Obter estado da operação do nome do domínio. |
> | Ação | Microsoft.ClassicCompute/domainNames/operationStatuses/read | Lê o estado da operação para o domínio das extensões de nomes. |
> | Ação | Microsoft.ClassicCompute/domainNames/read | Devolva os nomes de domínio dos recursos. |
> | Ação | Microsoft.ClassicCompute/domainNames/serviceCertificates/delete | Elimine os certificados de serviço utilizados. |
> | Ação | Microsoft.ClassicCompute/domainNames/serviceCertificates/operationStatuses/read | Lê o estado da operação para o domínio de certificados do serviço de nomes. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/slots/operationStatuses/read | Lê o estado da operação para o domínio de ranhuras de nomes. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/extensionReferences/delete | Remova a referência de extensão para a função de bloco de implementação. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/extensionReferences/read | Devolve a referência de extensão para a função de bloco de implementação. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/extensionReferences/write | Adiciona ou modifica a referência de extensão para a função de bloco de implementação. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/operationstatuses/read | Obter o estado da operação para a função de bloco de nomes de domínio. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/providers/Microsoft.Insights/diagnosticSettings/read | Obter as definições de diagnóstico. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/providers/Microsoft.Insights/diagnosticSettings/write | Adicionar ou modificar as definições de diagnóstico. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/read | Obter a função de bloco de implementação. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/roleInstances/downloadremotedesktopconnectionfile/action | Transfere o ficheiro de conexão de área de trabalho remoto para a instância de função na função de bloco de nome de domínio. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/roleInstances/operationStatuses/read | Obtém o estado da operação para a instância de função na função de bloco de nomes de domínio. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/roleInstances/reimage/action | Recria imagens a instância de função. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/roleInstances/restart/action | Reinicia instâncias de função. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/skus/read | Obtenha o sku da função de bloco de implementação. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/roles/write | Adicione função de bloco de implementação. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/start/action | Inicia um bloco de implementação. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/state/start/write | Altera o estado de ranhura de implementação para parado. |
> | Ação | Microsoft.ClassicCompute/domainNames/slots/state/stop/write | Altera o estado de ranhura de implementação para iniciado. |
...
> | Ação | Microsoft.ClassicCompute/domainNames/swap/action | Troca o bloco de teste para o bloco de produção. |
...
> | Ação | Microsoft.ClassicCompute/operatingSystemFamilies/read | Lista as famílias de sistemas operativos de convidado disponíveis no Microsoft Azure e também lista as versões de sistema operativo disponíveis para cada família. |
...
> | Ação | Microsoft.ClassicCompute/operationStatuses/read | Lê o estado da operação para o recurso. |
> | Ação | Microsoft.ClassicCompute/quotas/read | Obtenha a quota da subscrição. |
...
> | Ação | Microsoft.ClassicCompute/virtualMachines/associatedNetworkSecurityGroups/operationStatuses/read | Lê que o estado da operação das máquinas virtuais associados a grupos de segurança de rede. |
...
> | Ação | Microsoft.ClassicCompute/virtualMachines/downloadRemoteDesktopConnectionFile/action | Transfere o ficheiro RDP para a máquina virtual. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/extensions/operationStatuses/read | Lê o estado da operação para as extensões de máquinas virtuais. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/extensions/read | Obtém a extensão de máquina virtual. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/extensions/write | Coloca a extensão de máquina virtual. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/metricdefinitions/read | Obter a definição de métrica de máquina virtual. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/metrics/read | Obtém as métricas. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/networkInterfaces/associatedNetworkSecurityGroups/delete | Elimina o grupo de segurança de rede associado com a interface de rede. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/networkInterfaces/associatedNetworkSecurityGroups/operationStatuses/read | Lê que o estado da operação das máquinas virtuais associados a grupos de segurança de rede. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/networkInterfaces/associatedNetworkSecurityGroups/read | Obtém o grupo de segurança de rede associado com a interface de rede. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/networkInterfaces/associatedNetworkSecurityGroups/write | Adiciona um grupo de segurança de rede associado a interface de rede. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/operationStatuses/read | Lê o estado da operação das máquinas virtuais. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/performMaintenance/action | Efetua a manutenção na máquina virtual. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/providers/Microsoft.Insights/diagnosticSettings/read | Obter as definições de diagnóstico. |
> | Ação | Microsoft.ClassicCompute/virtualMachines/providers/Microsoft.Insights/diagnosticSettings/write | Adicionar ou modificar as definições de diagnóstico. |
...
> | Ação | Microsoft.ClassicCompute/virtualMachines/shutdown/action | Encerre a máquina virtual. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.ClassicNetwork/expressroutecrossconnections/operationstatuses/read | Obtenha uma rota rápida entre o estado da operação de ligação. |
> | Ação | Microsoft.ClassicNetwork/expressroutecrossconnections/peerings/delete | Elimine rota rápida cruzada ligação peering. |
> | Ação | Microsoft.ClassicNetwork/expressroutecrossconnections/peerings/operationstatuses/read | Obtenha uma rota rápida cruzada ligação peering o estado da operação. |
> | Ação | Microsoft.ClassicNetwork/expressroutecrossconnections/peerings/read | Obtenha o expressroute entre ligação peering. |
> | Ação | Microsoft.ClassicNetwork/expressroutecrossconnections/peerings/write | Adicione rota rápida cruzada ligação peering. |
> | Ação | Microsoft.ClassicNetwork/expressroutecrossconnections/read | Introdução rápida encaminhar cruzada ligações. |
> | Ação | Microsoft.ClassicNetwork/expressroutecrossconnections/write | Adicionar rota rápida em várias ligações. |
...
> | Ação | Microsoft.ClassicNetwork/networkSecurityGroups/operationStatuses/read | Lê o estado da operação para o grupo de segurança de rede. |
> | Ação | Microsoft.ClassicNetwork/networksecuritygroups/providers/Microsoft.Insights/diagnosticSettings/read | Obtém as grupos de segurança de rede para definições de diagnóstico |
...
> | Ação | Microsoft.ClassicNetwork/networksecuritygroups/providers/Microsoft.Insights/logDefinitions/read | Obtém os eventos para o grupo de segurança de rede |
...
> | Ação | Microsoft.ClassicNetwork/networkSecurityGroups/securityRules/operationStatuses/read | Lê o estado da operação para as regras de segurança de grupo de segurança de rede. |
...
> | Ação | Microsoft.ClassicNetwork/quotas/read | Obtenha a quota da subscrição. |
> | Ação | Microsoft.ClassicNetwork/register/action | Registe-se à rede clássica |
...
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/gateways/clientRootCertificates/listPackage/action | Lista o pacote de certificado do gateway de rede virtual. |
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/gateways/clientRootCertificates/read | Encontre o cliente certificados de raiz. |
...
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/gateways/connections/connect/action | Liga-se de uma ligação de gateway site para site. |
...
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/gateways/delete | Elimina o gateway de rede virtual. |
...
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/gateways/listCircuitServiceKey/action | Obtém a chave de serviço de circuito. |
...
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/join/action | Associa a rede virtual. |
...
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/read | Obtenha a rede virtual. |
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/remoteVirtualNetworkPeeringProxies/delete | Elimina o proxy de peering de rede virtual remota. |
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/remoteVirtualNetworkPeeringProxies/read | Obtém o proxy de peering de rede virtual remota. |
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/remoteVirtualNetworkPeeringProxies/write | Adiciona ou atualiza o proxy de peering de rede virtual remota. |
...
> | Ação | Microsoft.ClassicNetwork/virtualNetworks/virtualNetworkPeerings/read | Obtém o peering de rede virtual. |
...
> | Ação | Microsoft.ClassicStorage/osPlatformImages/read | Obtém a imagem de plataforma do sistema operativo. |
> | Ação | Microsoft.ClassicStorage/publicImages/read | Obtém a imagem pública da máquina virtual. |
> | Ação | Microsoft.ClassicStorage/quotas/read | Obtenha a quota da subscrição. |
> | Ação | Microsoft.ClassicStorage/register/action | Registe-se para o armazenamento clássico |
...
> | Ação | Microsoft.ClassicStorage/storageAccounts/delete | Elimine a conta de armazenamento. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/disks/delete | Elimina um disco de conta de armazenamento fornecida. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/disks/operationStatuses/read | Lê o estado da operação para o recurso. |
...
> | Ação | Microsoft.ClassicStorage/storageAccounts/images/operationstatuses/read | Devolve o estado de operação de imagem da conta de armazenamento. |
...
> | Ação | Microsoft.ClassicStorage/storageAccounts/operationStatuses/read | Lê o estado da operação para o recurso. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/osImages/delete | Elimina uma imagem de sistema operativo de conta de armazenamento fornecida. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/osImages/read | Devolve a imagem de sistema operativo de conta de armazenamento. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/osImages/write | Adiciona uma imagem de sistema operativo de conta de armazenamento fornecida. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/prepareMigration/action | Prepara a migração de uma conta de armazenamento. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/read | Devolva a conta de armazenamento com a conta fornecida. |
...
> | Ação | Microsoft.ClassicStorage/storageAccounts/services/diagnosticSettings/read | Obter as definições de diagnóstico. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/services/diagnosticSettings/write | Adicionar ou modificar as definições de diagnóstico. |
...
> | Ação | Microsoft.ClassicStorage/storageAccounts/vmImages/delete | Elimina uma imagem de máquina virtual especificada. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/vmImages/operationstatuses/read | Obtém um Estado de operação de imagem de máquina virtual especificada. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/vmImages/read | Devolve a imagem de máquina virtual. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/vmImages/write | Adiciona uma imagem de máquina virtual especificada. |
> | Ação | Microsoft.ClassicStorage/storageAccounts/write | Adiciona uma nova conta de armazenamento. |
> | Ação | Microsoft.ClassicStorage/vmImages/read | Apresenta uma lista de imagens de máquinas virtuais. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/analyze/action | Esta operação extrai um conjunto avançado de recursos visuais com base no conteúdo de imagem.  |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/areaofinterest/action | Esta operação devolve uma caixa delimitadora em torno da área mais importante da imagem. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/describe/action | Esta operação gera uma descrição de uma imagem na linguagem legível humana com sentenças completas.<br> A descrição baseia-se uma coleção de marcas de conteúdo, que também são devolvidas pela operação.<br>Pode ser gerada mais do que uma descrição para cada imagem.<br> As descrições são ordenadas pelo respetiva pontuação de confiança.<br>Todas as descrições são em inglês. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/detect/action | Esta operação Performs deteção de objetos na imagem especificada.  |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/generatethumbnail/action | Esta operação gera uma imagem em miniatura com a largura especificadas pelo utilizador e a altura.<br> Por predefinição, o serviço analisa a imagem, identifica a região de interesse (ROI) e gera as coordenadas de recorte inteligentes com base no ROI.<br> Corte inteligente ajuda quando especifica uma proporção de aspecto que é diferente do que a imagem de entrada |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/models/analyze/action | Esta operação reconhece o conteúdo dentro de uma imagem ao aplicar um modelo de domínio específico.<br> A lista de modelos de domínios específicos que são suportados pela API de visão do computador pode ser obtida usando a solicitação GET /models.<br> Atualmente, a API fornece modelos de domínios específicos a seguir: celebridades, pontos de referência. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/models/read | Esta operação devolve a lista de modelos de domínios específicos que são suportados pela API de visão do computador.  Atualmente, a API suporta modelos de domínios específicos a seguir: reconhecedor celebridade, reconhecedor de ponto de referência. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/ocr/action | Reconhecimento Ótico de carateres (OCR) Deteta texto numa imagem e extrai os carateres reconhecidos para um fluxo de carateres máquina utilizável.    |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/recognizetext/action | Use essa interface para obter o resultado de uma operação de reconhecer texto. Quando utiliza a interface de reconhecer texto, a resposta contém um campo chamado "Localização da operação". O campo de "Localização da operação" contém o URL que tem de utilizar para a operação obter Resultado da operação texto reconhecer. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/tag/action | Esta operação gera uma lista de palavras ou etiquetas, o que são relevantes para o conteúdo da imagem fornecido.<br>A API de imagem digitalizada pode devolver etiquetas com base nos objetos, está a viver seres, paisagens ou ações encontradas nas imagens.<br>Ao contrário de categorias, as etiquetas não estão organizadas de acordo com um sistema de classificação hierárquica, mas correspondem ao conteúdo da imagem.<br>As etiquetas podem conter sugestões para evitar ambiguidade ou fornecer contexto, por exemplo violoncelo"tag" pode ser acompanhado a sugestão "instrumento musical".<br>Todas as etiquetas são em inglês. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/textoperations/read | Essa interface é utilizada para apresentar a reconhecer o resultado da operação de texto. O URL para essa interface deve ser obtido a partir <b>"Localização da operação"</b> campo devolvido da interface de reconhecer texto. |
...
> | DataAction | Microsoft.CognitiveServices/accounts/LUIS/predict/action | Obtém a predição de ponto de extremidade publicados para a consulta indicada. |
...
> | Ação | Microsoft.CognitiveServices/accounts/skus/read | Lê SKUs disponíveis para um recurso existente. |
...
> | Ação | Microsoft.CognitiveServices/register/action | Regista a subscrição para os serviços cognitivos |
...
> | Ação | Microsoft.Compute/galleries/images/read | Obtém as propriedades de imagem da Galeria |
> | Ação | Microsoft.Compute/galleries/images/versions/delete | Elimina a versão de imagem da Galeria |
> | Ação | Microsoft.Compute/galleries/images/versions/read | Obtém as propriedades de versão da imagem de galeria |
> | Ação | Microsoft.Compute/galleries/images/versions/write | Cria uma nova versão de imagem de galeria ou atualiza um já existente |
> | Ação | Microsoft.Compute/galleries/images/write | Cria uma nova imagem de galeria ou atualiza um já existente |
> | Ação | Microsoft.Compute/galleries/read | Obtém as propriedades de galeria |
> | Ação | Microsoft.Compute/galleries/write | Cria uma nova galeria ou atualiza um já existente |
> | Ação | Microsoft.Compute/hostGroups/delete | Elimina o grupo de anfitriões |
> | Ação | Microsoft.Compute/hostGroups/read | Obter as propriedades de um grupo de anfitriões |
> | Ação | Microsoft.Compute/hostGroups/write | Cria um novo grupo de anfitriões ou atualiza um grupo de anfitriões existentes |
> | Ação | Microsoft.Compute/hosts/delete | Elimina o anfitrião |
> | Ação | Microsoft.Compute/hosts/read | Obter as propriedades de um anfitrião |
> | Ação | Microsoft.Compute/hosts/write | Cria um novo anfitrião ou atualiza um anfitrião existente |
> | Ação | Microsoft.Compute/images/delete | Elimina a imagem |
> | Ação | Microsoft.Compute/images/read | Obter as propriedades da imagem |
> | Ação | Microsoft.Compute/images/write | Cria uma nova imagem ou atualiza um já existente |
...
> | Ação | Microsoft.Compute/locations/publishers/artifacttypes/offers/skus/read | Obter as propriedades de um Sku de imagem de plataforma |
...
> | Ação | Microsoft.Compute/locations/publishers/artifacttypes/types/versions/read | Obter as propriedades de uma versão de VMExtension |
> | Ação | Microsoft.Compute/locations/publishers/read | Obter as propriedades de um publicador |
> | Ação | Microsoft.Compute/locations/runCommands/read | Apresenta uma lista de comandos de execução disponíveis na localização |
> | Ação | Microsoft.Compute/locations/usages/read | Obtém os limites de serviço e quantidades de utilização atual de recursos de computação da subscrição numa localização |
> | Ação | Microsoft.Compute/locations/vmSizes/read | Apresenta uma lista de tamanhos de máquina virtual de disponibilidade numa localização |
...
> | Ação | Microsoft.Compute/proximityPlacementGroups/read | Obter as propriedades de um grupo de colocação de proximidade |
> | Ação | Microsoft.Compute/proximityPlacementGroups/write | Cria um novo grupo de colocação de proximidade ou atualiza um já existente |
> | Ação | Microsoft.Compute/register/action | Regista a subscrição no fornecedor de recursos Microsoft. Compute |
> | Ação | Microsoft.Compute/restorePointCollections/delete | Elimina o restauro do ponto de coleção e continha os pontos de restauro |
...
> | Ação | Microsoft.Compute/restorePointCollections/restorePoints/retrieveSasUris/action | Obter as propriedades de um ponto de restauro juntamente com URIs de SAS do blob |
> | Ação | Microsoft.Compute/restorePointCollections/restorePoints/write | Cria um novo ponto de restauro |
> | Ação | Microsoft.Compute/restorePointCollections/write | Cria uma nova coleção de ponto de restauro ou atualiza um já existente |
...
> | Ação | Microsoft.Compute/sharedVMImages/write | Cria uma nova SharedVMImage ou atualiza um já existente |
> | Ação | Microsoft.Compute/skus/read | Obtém a lista de SKUs de Microsoft. Compute disponíveis para a sua subscrição |
...
> | Ação | Microsoft.Compute/unregister/action | Anula o registo da subscrição no fornecedor de recursos Microsoft. Compute |
...
> | Ação | Microsoft.Compute/virtualMachines/convertToManagedDisks/action | Converte os discos de baseados em blob da máquina virtual em discos geridos |
...
> | Ação | Microsoft.Compute/virtualMachines/extensions/delete | Elimina a extensão de máquina virtual |
> | Ação | Microsoft.Compute/virtualMachines/extensions/read | Obter as propriedades de uma extensão de máquina virtual |
> | Ação | Microsoft.Compute/virtualMachines/extensions/write | Cria uma nova extensão de máquina virtual ou atualiza um já existente |
...
> | Ação | Microsoft.Compute/virtualMachines/instanceView/read | Obtém o estado de runtime detalhadas da máquina virtual e os respetivos recursos |
> | DataAction | Microsoft.Compute/virtualMachines/login/action | Iniciar sessão a uma máquina virtual como um usuário normal |
> | DataAction | Microsoft.Compute/virtualMachines/loginAsAdmin/action | Iniciar sessão a uma máquina virtual com o administrador do Windows ou Linux privilégios de utilizador de raiz |
...
> | Ação | Microsoft.Compute/virtualMachines/reimage/action | Recria a imagem a máquina virtual que está a utilizar o disco de diferenciação. |
...
> | Ação | Microsoft.Compute/virtualMachines/vmSizes/read | Apresenta uma lista de tamanhos disponíveis, que a máquina virtual pode ser atualizada para |
> | Ação | Microsoft.Compute/virtualMachines/write | Cria uma nova máquina virtual ou atualiza uma máquina virtual existente |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/deallocate/action | Desliga e liberta os recursos de computação para as instâncias do conjunto de dimensionamento de Máquina Virtual  |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/delete | Elimina o conjunto de dimensionamento de máquinas virtuais |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/delete/action | Elimina as instâncias do conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/extensions/delete | Elimina o dimensionamento de máquinas virtuais Definir extensão |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/extensions/read | Obtém as propriedades de uma extensão de conjunto de dimensionamento da Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/extensions/write | Cria um novo dimensionamento Definir extensão da Máquina Virtual ou atualiza um já existente |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/forceRecoveryServiceFabricPlatformUpdateDomainWalk/action | Percorrer manualmente os domínios de atualização de plataforma de um conjunto de dimensionamento de Máquina Virtual para concluir uma atualização pendente que está parada do service fabric |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/instanceView/read | Obtém a vista de instância do conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/manualUpgrade/action | Atualiza manualmente as instâncias para o modelo mais recente do conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/networkInterfaces/read | Obter propriedades de todas as interfaces de rede de um conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/osRollingUpgrade/action | Inicia uma atualização sem interrupção para mover todas as instâncias de conjunto de dimensionamento de Máquina Virtual para a versão de SO da imagem de plataforma mais recente disponível. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/osUpgradeHistory/read | Obtém o histórico de atualizações do SO para um conjunto de dimensionamento de Máquina Virtual |
...
> | Ação | Microsoft.Compute/virtualMachineScaleSets/powerOff/action | Desliga as instâncias do conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/publicIPAddresses/read | Obter propriedades de todos os endereços IP públicos de um conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/read | Obter as propriedades de um conjunto de dimensionamento de Máquina Virtual |
...
> | Ação | Microsoft.Compute/virtualMachineScaleSets/reimage/action | Recria imagens de instâncias do conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/reimageAll/action | Recria imagens de todos os discos (disco de SO e discos de dados) para as instâncias de um conjunto de dimensionamento de Máquina Virtual  |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/restart/action | Reinicia as instâncias do conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/rollingUpgrades/cancel/action | Cancela a atualização sem interrupção de um conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/rollingUpgrades/read | Obter o estado mais recente da atualização gradual para um conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/scale/action | Verificar se um conjunto de dimensionamento de Máquina Virtual existente pode ser reduzido / aumentado horizontalmente para contagem de instâncias especificada |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/skus/read | Lista os SKUs válidos para um conjunto de dimensionamento de Máquina Virtual existente |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/start/action | Inicia as instâncias do conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/deallocate/action | Desliga e liberta os recursos de computação para uma Máquina Virtual no conjunto de dimensionamento de VM. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/delete | Elimine uma Máquina Virtual específica num conjunto de dimensionamento de VM. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/instanceView/read | Obtém a vista de instância de uma Máquina Virtual num conjunto de dimensionamento de VM. |
...
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/networkInterfaces/read | Obter propriedades de uma ou todas as interfaces de rede de uma máquina virtual criada através do conjunto de dimensionamento de Máquina Virtual |
...
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/powerOff/action | Powers desligar a máquina de Virtual de instância num conjunto de dimensionamento de VM. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/read | Obtém as propriedades de uma Máquina Virtual num conjunto de dimensionamento de VM |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/redeploy/action | Reimplementa a instância de Máquina Virtual num conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/reimage/action | Recria imagens uma instância de Máquina Virtual num conjunto de dimensionamento de Máquina Virtual. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/reimageAll/action | Recria imagens todos os discos (disco de SO e discos de dados) para a instância de Máquina Virtual num conjunto de dimensionamento de Máquina Virtual. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/restart/action | Reinicia uma instância de Máquina Virtual no conjunto de dimensionamento de VM. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/runCommand/action | Executa um script predefinido na instância de Máquina Virtual num conjunto de dimensionamento de Máquina Virtual. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/start/action | Inicia uma instância de Máquina Virtual num conjunto de dimensionamento de VM. |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/write | Atualiza as propriedades de uma Máquina Virtual no conjunto de dimensionamento de VM |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/vmSizes/read | Listar tamanhos disponíveis para criar ou atualizar uma máquina virtual num conjunto de dimensionamento de Máquina Virtual |
> | Ação | Microsoft.Compute/virtualMachineScaleSets/write | Cria um novo conjunto de dimensionamento de Máquina Virtual ou atualiza um já existente |
...
> | Ação | Microsoft.Consumption/tenants/read | Inquilinos de lista |
...
> | Ação | Microsoft.ContainerInstance/containerGroups/containers/logs/read | Obter registos para um contentor específico. |
...
> | Ação | Microsoft.ContainerInstance/register/action | Regista a subscrição para o fornecedor de recursos de instância de contentor e permite a criação de grupos de contentores. |
...
> | Ação | Microsoft.ContainerRegistry/registries/artifacts/delete | Elimine artefactos num registo de contentor. |
...
> | Ação | Microsoft.ContainerRegistry/registries/metadata/read | Obtém os metadados de um repositório específico para um registo de contentor |
> | Ação | Microsoft.ContainerRegistry/registries/metadata/write | Atualiza os metadados de um repositório para um registo de contentor |
...
> | Ação | Microsoft.ContainerService/managedClusters/agentPools/delete | Elimina um conjunto de agentes |
> | Ação | Microsoft.ContainerService/managedClusters/agentPools/read | Obtém um conjunto de agentes |
> | Ação | Microsoft.ContainerService/managedClusters/agentPools/write | Cria um novo conjunto de agentes ou atualiza um já existente |
...
> | Ação | Microsoft.ContentModerator/applications/listSecrets/action | Lista os segredos |
...
> | Ação | Microsoft.CostManagement/cloudConnectors/read | Liste cloudConnectors para o usuário autenticado. |
...
> | Ação | Microsoft.CostManagement/exports/run/action | Exporta a execução. |
> | Ação | Microsoft.CostManagement/exports/write | Criar ou atualizar a exportação especificada. |
> | Ação | Microsoft.CostManagement/externalBillingAccounts/externalSubscriptions/read | Liste externalSubscriptions dentro de um externalBillingAccount para o usuário autenticado. |
> | Ação | Microsoft.CostManagement/externalBillingAccounts/read | Liste externalBillingAccounts para o usuário autenticado. |
> | Ação | Microsoft.CostManagement/externalSubscriptions/read | Liste externalSubscriptions para o usuário autenticado. |
> | Ação | Microsoft.CostManagement/externalSubscriptions/write | Atualizar o grupo de gestão associadas de externalSubscription |
...
> | Ação | Microsoft.CostManagement/register/action | Registre-se a ação de âmbito do Microsoft.CostManagement por uma subscrição. |
...
> | Ação | Microsoft.CostManagement/tenants/register/action | Registre-se a ação de âmbito do Microsoft.CostManagement por um inquilino. |
...
> | Ação | Microsoft.CustomerInsights/hubs/providers/Microsoft.Insights/diagnosticSettings/read | Obtém a definição de diagnóstico para o recurso |
> | Ação | Microsoft.CustomerInsights/hubs/providers/Microsoft.Insights/diagnosticSettings/write | Cria ou atualiza a definição de diagnóstico para o recurso |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.DataBox/jobs/bookShipmentPickUp/action | Permite para marcar uma recolha para envios de devolução. |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/getExtendedInformation/action | Obtém o recurso de outras informações sobre o |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/operationsStatus/read | Apresenta uma lista ou obtém o estado da operação |
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/orders/delete | Elimina os pedidos |
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/orders/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/securitySettings/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/read | Apresenta uma lista ou obtém as partilhas |
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/read | Apresenta uma lista ou obtém as partilhas |
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/refresh/action | Atualizar os metadados de partilha com os dados da cloud |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/triggers/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/users/operationResults/read | Apresenta uma lista ou obtém o resultado da operação |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Databricks/register/action | Registre-se ao Databricks. |
> | Ação | Microsoft.Databricks/workspaces/delete | Remove uma área de trabalho do Databricks. |
...
> | Ação | Microsoft.Databricks/workspaces/providers/Microsoft.Insights/diagnosticSettings/write | Adicionar ou modificar as definições de diagnóstico. |
...
> | Ação | Microsoft.Databricks/workspaces/read | Obtém uma lista de áreas de trabalho do Databricks. |
> | Ação | Microsoft.Databricks/workspaces/write | Cria uma área de trabalho do Databricks. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.DataCatalog/catalogs/delete | Elimine o recurso de catálogos para fornecedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/catalogs/read | Ler recurso de catálogos para fornecedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/catalogs/write | Escreva o recurso de catálogos para fornecedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/checkNameAvailability/read | Verifica a disponibilidade de nome de catálogo para o fornecedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/datacatalogs/delete | Elimine o recurso de DataCatalog para fornecedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/datacatalogs/read | Ler recurso DataCatalog para fornecedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/datacatalogs/write | Escreva DataCatalog recursos para o fornecedor de recursos do catálogo de dados. |
...
> | Ação | Microsoft.DataCatalog/register/action | Registre-se a subscrição para o fornecedor de recursos do catálogo de dados |
> | Ação | Microsoft.DataCatalog/unregister/action | Anular o registo da subscrição para o fornecedor de recursos do catálogo de dados |
...
> | Ação | Microsoft.DataFactory/factories/getDataPlaneAccess/action | Obtém acesso ao serviço de plano de dados do ADF. |
> | Ação | Microsoft.DataFactory/factories/getDataPlaneAccess/read | Acesso de leitura ao serviço de plano de dados do ADF. |
> | Ação | Microsoft.DataFactory/factories/getFeatureValue/action | Obter o valor de funcionalidade de controlo de exposição para a localização específica. |
> | Ação | Microsoft.DataFactory/factories/getFeatureValue/read | Lê o valor de funcionalidade de controlo de exposição para a localização específica. |
...
> | Ação | Microsoft.DataLakeAnalytics/accounts/virtualNetworkRules/delete | Elimine uma regra de rede virtual. |
...
> | Ação | Microsoft.DataLakeStore/accounts/virtualNetworkRules/delete | Elimine uma regra de rede virtual. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.DataMigration/locations/operationResults/read | Obter o estado de uma operação de longa execução relacionados com uma resposta aceite 202 |
> | Ação | Microsoft.DataMigration/locations/operationStatuses/read | Obter o estado de uma operação de longa execução relacionados com uma resposta aceite 202 |
> | Ação | Microsoft.DataMigration/register/action | Regista a subscrição com o fornecedor de serviço de migração de base de dados do Azure |
> | Ação | Microsoft.DataMigration/services/addWorker/action | Adiciona uma função de trabalho do DMS para trabalhadores de availiable do serviço |
> | Ação | Microsoft.DataMigration/services/checkStatus/action | Verifique se o serviço está implementado e em execução |
> | Ação | Microsoft.DataMigration/services/configureWorker/action | Configura uma função de trabalho DMS trabalhadores de availiable do serviço |
> | Ação | Microsoft.DataMigration/services/delete | Elimina um recurso e todos os seus filhos |
> | Ação | Microsoft.DataMigration/services/projects/accessArtifacts/action | Gerar um URL que pode ser utilizado para obter ou colocar artefactos do projeto |
...
> | Ação | Microsoft.DataMigration/services/projects/files/read | Ler as informações sobre os recursos |
> | Ação | Microsoft.DataMigration/services/projects/files/read/action | Obter um URL que pode ser usado para ler o conteúdo do ficheiro |
> | Ação | Microsoft.DataMigration/services/projects/files/readWrite/action | Obter um URL que pode ser utilizado para ler ou escrever o conteúdo do ficheiro |
> | Ação | Microsoft.DataMigration/services/projects/files/write | Criar ou atualizar recursos e as respetivas propriedades |
> | Ação | Microsoft.DataMigration/services/projects/read | Ler as informações sobre os recursos |
> | Ação | Microsoft.DataMigration/services/projects/tasks/cancel/action | Cancelar a tarefa se estiver em execução |
> | Ação | Microsoft.DataMigration/services/projects/tasks/delete | Elimina um recurso e todos os seus filhos |
> | Ação | Microsoft.DataMigration/services/projects/tasks/read | Ler as informações sobre os recursos |
> | Ação | Microsoft.DataMigration/services/projects/tasks/write | Executar tarefas de tarefas do serviço de migração de base de dados do Azure |
> | Ação | Microsoft.DataMigration/services/projects/write | Executar tarefas de tarefas do serviço de migração de base de dados do Azure |
> | Ação | Microsoft.DataMigration/services/read | Ler as informações sobre os recursos |
> | Ação | Microsoft.DataMigration/services/removeWorker/action | Remove uma função de trabalho DMS trabalhadores de availiable do serviço |
> | Ação | Microsoft.DataMigration/services/serviceTasks/cancel/action | Cancelar a tarefa se estiver em execução |
> | Ação | Microsoft.DataMigration/services/serviceTasks/delete | Elimina um recurso e todos os seus filhos |
> | Ação | Microsoft.DataMigration/services/serviceTasks/read | Ler as informações sobre os recursos |
> | Ação | Microsoft.DataMigration/services/serviceTasks/write | Executar tarefas de tarefas do serviço de migração de base de dados do Azure |
> | Ação | Microsoft.DataMigration/services/slots/delete | Elimina um recurso e todos os seus filhos |
> | Ação | Microsoft.DataMigration/services/slots/read | Ler as informações sobre os recursos |
> | Ação | Microsoft.DataMigration/services/slots/write | Criar ou atualizar recursos e as respetivas propriedades |
> | Ação | Microsoft.DataMigration/services/start/action | Iniciar o serviço DMS para permitir que o mesmo processe migrações novamente |
> | Ação | Microsoft.DataMigration/services/stop/action | Parar o serviço DMS para minimizar os respetivos custos |
...
> | Ação | Microsoft.DataMigration/services/write | Criar ou atualizar recursos e as respetivas propriedades |
> | Ação | Microsoft.DataMigration/skus/read | Obter uma lista de SKUs suportados por recursos DMS. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.DBforMariaDB/checkNameAvailability/action | Certifique-se de que se fornecido server nome está disponível para o aprovisionamento em todo o mundo para uma determinada subscrição. |
> | Ação | Microsoft.DBforMariaDB/locations/azureAsyncOperation/read | Devolver resultados da operação de servidor MariaDB |
> | Ação | Microsoft.DBforMariaDB/locations/operationResults/read | Retorno ResourceGroup com base em resultados da operação de servidor MariaDB |
> | Ação | Microsoft.DBforMariaDB/locations/operationResults/read | Devolver resultados da operação de servidor MariaDB |
> | Ação | Microsoft.DBforMariaDB/locations/performanceTiers/read | Devolve a lista de escalões de desempenho disponíveis. |
> | Ação | Microsoft.DBforMariaDB/locations/securityAlertPoliciesAzureAsyncOperation/read | Devolve a lista de resultado de operação da deteção de ameaças de servidor. |
> | Ação | Microsoft.DBforMariaDB/locations/securityAlertPoliciesOperationResults/read | Devolve a lista de resultado de operação da deteção de ameaças de servidor. |
> | Ação | Microsoft.DBforMariaDB/operations/read | Devolve a lista de operações de MariaDB. |
> | Ação | Microsoft.DBforMariaDB/performanceTiers/read | Devolve a lista de escalões de desempenho disponíveis. |
> | Ação | Microsoft.DBforMariaDB/register/action | Registar fornecedor de recursos de MariaDB |
> | Ação | Microsoft.DBforMariaDB/servers/administrators/delete | Elimina um administrador existente do servidor de MariaDB. |
> | Ação | Microsoft.DBforMariaDB/servers/administrators/read | Obtém uma lista de administradores de servidor MariaDB. |
> | Ação | Microsoft.DBforMariaDB/servers/administrators/write | Cria ou atualiza o administrador de servidor da MariaDB com os parâmetros especificados. |
...
> | Ação | Microsoft.DBforMariaDB/servers/advisors/read | Devolver a lista de consultores |
> | Ação | Microsoft.DBforMariaDB/servers/advisors/read | Devolver uma classificação |
...
> | Ação | Microsoft.DBforMariaDB/servers/databases/delete | Elimina uma base de dados existente do MariaDB. |
> | Ação | Microsoft.DBforMariaDB/servers/databases/read | Devolve a lista de bases de dados de MariaDB ou obtém as propriedades da base de dados especificado. |
> | Ação | Microsoft.DBforMariaDB/servers/databases/write | Cria uma base de dados da MariaDB com os parâmetros especificados ou atualizar as propriedades para a base de dados especificada. |
...
> | Ação | Microsoft.DBforMariaDB/servers/logFiles/read | Devolve a lista de MariaDB LogFiles. |
...
> | Ação | Microsoft.DBforMariaDB/servers/queryTexts/action | Devolver os textos para obter uma lista de consultas |
> | Ação | Microsoft.DBforMariaDB/servers/queryTexts/action | Devolver o texto de uma consulta |
...
> | Ação | Microsoft.DBforMariaDB/servers/replicas/read | Obter a ler as réplicas de um servidor de MariaDB |
...
> | Ação | Microsoft.DBforMariaDB/servers/topQueryStatistics/read | Devolve a lista de estatísticas de consulta para as consultas principais. |
...
> | Ação | Microsoft.DBforMariaDB/servers/waitStatistics/read | Devolver uma estatística de espera |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.DBforMySQL/checkNameAvailability/action | Certifique-se de que se fornecido server nome está disponível para o aprovisionamento em todo o mundo para uma determinada subscrição. |
> | Ação | Microsoft.DBforMySQL/locations/azureAsyncOperation/read | Devolver resultados da operação de servidor MySQL |
> | Ação | Microsoft.DBforMySQL/locations/operationResults/read | Retorno ResourceGroup com base em resultados da operação de servidor MySQL |
> | Ação | Microsoft.DBforMySQL/locations/operationResults/read | Devolver resultados da operação de servidor MySQL |
> | Ação | Microsoft.DBforMySQL/locations/performanceTiers/read | Devolve a lista de escalões de desempenho disponíveis. |
> | Ação | Microsoft.DBforMySQL/locations/securityAlertPoliciesAzureAsyncOperation/read | Devolve a lista de resultado de operação da deteção de ameaças de servidor. |
> | Ação | Microsoft.DBforMySQL/locations/securityAlertPoliciesOperationResults/read | Devolve a lista de resultado de operação da deteção de ameaças de servidor. |
> | Ação | Microsoft.DBforMySQL/operations/read | Devolve a lista de operações do MySQL. |
> | Ação | Microsoft.DBforMySQL/performanceTiers/read | Devolve a lista de escalões de desempenho disponíveis. |
> | Ação | Microsoft.DBforMySQL/register/action | Registar fornecedor de recursos do MySQL |
...
> | Ação | Microsoft.DBforMySQL/servers/advisors/read | Devolver a lista de consultores |
> | Ação | Microsoft.DBforMySQL/servers/advisors/read | Devolver uma classificação |
...
> | Ação | Microsoft.DBforMySQL/servers/databases/delete | Elimina uma base de dados MySQL. |
> | Ação | Microsoft.DBforMySQL/servers/databases/read | Devolve a lista de bases de dados MySQL ou obtém as propriedades da base de dados especificado. |
> | Ação | Microsoft.DBforMySQL/servers/databases/write | Cria uma base de dados MySQL com os parâmetros especificados ou atualizar as propriedades para a base de dados especificada. |
...
> | Ação | Microsoft.DBforMySQL/servers/logFiles/read | Devolve a lista de PostgreSQL LogFiles. |
...
> | Ação | Microsoft.DBforMySQL/servers/queryTexts/action | Devolver os textos para obter uma lista de consultas |
> | Ação | Microsoft.DBforMySQL/servers/queryTexts/action | Devolver o texto de uma consulta |
...
> | Ação | Microsoft.DBforMySQL/servers/replicas/read | Obter a ler as réplicas de um servidor MySQL |
...
> | Ação | Microsoft.DBforMySQL/servers/topQueryStatistics/read | Devolve a lista de estatísticas de consulta para as consultas principais. |
...
> | Ação | Microsoft.DBforMySQL/servers/waitStatistics/read | Devolver uma estatística de espera |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.DBforPostgreSQL/checkNameAvailability/action | Certifique-se de que se fornecido server nome está disponível para o aprovisionamento em todo o mundo para uma determinada subscrição. |
> | Ação | Microsoft.DBforPostgreSQL/locations/azureAsyncOperation/read | Devolver resultados da operação de servidor PostgreSQL |
> | Ação | Microsoft.DBforPostgreSQL/locations/operationResults/read | Retorno ResourceGroup com base em resultados da operação de servidor PostgreSQL |
> | Ação | Microsoft.DBforPostgreSQL/locations/operationResults/read | Devolver resultados da operação de servidor PostgreSQL |
> | Ação | Microsoft.DBforPostgreSQL/locations/performanceTiers/read | Devolve a lista de escalões de desempenho disponíveis. |
> | Ação | Microsoft.DBforPostgreSQL/locations/securityAlertPoliciesAzureAsyncOperation/read | Devolve a lista de resultado de operação da deteção de ameaças de servidor. |
> | Ação | Microsoft.DBforPostgreSQL/locations/securityAlertPoliciesOperationResults/read | Devolve a lista de resultado de operação da deteção de ameaças de servidor. |
> | Ação | Microsoft.DBforPostgreSQL/operations/read | Devolve a lista de operações do PostgreSQL. |
> | Ação | Microsoft.DBforPostgreSQL/performanceTiers/read | Devolve a lista de escalões de desempenho disponíveis. |
> | Ação | Microsoft.DBforPostgreSQL/register/action | Registar fornecedor de recursos do PostgreSQL |
> | Ação | Microsoft.DBforPostgreSQL/servers/administrators/delete | Elimina um administrador existente do servidor PostgreSQL. |
> | Ação | Microsoft.DBforPostgreSQL/servers/administrators/read | Obtém uma lista de administradores de servidor PostgreSQL. |
...
> | Ação | Microsoft.DBforPostgreSQL/servers/databases/delete | Elimina uma base de dados PostgreSQL. |
> | Ação | Microsoft.DBforPostgreSQL/servers/databases/read | Devolve a lista de bases de dados PostgreSQL ou obtém as propriedades da base de dados especificado. |
> | Ação | Microsoft.DBforPostgreSQL/servers/databases/write | Cria uma base de dados do PostgreSQL com os parâmetros especificados ou atualizar as propriedades para a base de dados especificada. |
...
> | Ação | Microsoft.DBforPostgreSQL/servers/logFiles/read | Devolve a lista de PostgreSQL LogFiles. |
...
> | Ação | Microsoft.DBforPostgreSQL/servers/queryTexts/read | Devolver os textos para obter uma lista de consultas |
...
> | Ação | Microsoft.DBforPostgreSQL/servers/replicas/read | Obter a ler as réplicas de um servidor PostgreSQL |
...
> | Ação | Microsoft.DBforPostgreSQL/serversv2/configurations/read | Devolve a lista de configurações para um servidor ou obtém as propriedades para a configuração especificada. |
...
> | Ação | Microsoft.DBforPostgreSQL/serversv2/firewallRules/read | Devolve a lista de firewall de regras para um servidor ou obtém as propriedades para a regra de firewall especificada. |
...
> | Ação | Microsoft.DBforPostgreSQL/serversv2/providers/Microsoft.Insights/diagnosticSettings/read | Obtém a definição disagnostic para o recurso |
...
> | Ação | Microsoft.DBforPostgreSQL/serversv2/providers/Microsoft.Insights/logDefinitions/read | Obtém os registos disponíveis para os servidores de Postgres |
> | Ação | Microsoft.DBforPostgreSQL/serversv2/providers/Microsoft.Insights/metricDefinitions/read | Tipos de retorno da métricas que estão disponíveis para bases de dados |
> | Ação | Microsoft.DBforPostgreSQL/serversv2/read | Devolve a lista de servidores ou obtém as propriedades para o servidor especificado. |
...
> | Ação | Microsoft.DevSpaces/locations/checkContainerHostMapping/action | Verifique o mapeamento de controlador existente para um anfitrião de contentor |
> | Ação | Microsoft.DevSpaces/locations/operationresults/read | Estado de leitura para uma operação assíncrona |
...
> | Ação | Microsoft.DevTestLab/labs/idleShutdowns/delete | Elimine encerramentos inativos. |
> | Ação | Microsoft.DevTestLab/labs/idleShutdowns/read | Leia encerramentos inativos. |
> | Ação | Microsoft.DevTestLab/labs/idleShutdowns/write | Adiciona ou modifica encerramentos inativos. |
...
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/delete | Elimine galerias partilhadas. |
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/read | Leia galerias partilhadas. |
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/sharedImages/delete | Elimine Imagens partilhadas. |
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/sharedImages/read | Leia Imagens partilhadas. |
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/sharedImages/write | Adicionar ou modificar imagens partilhadas. |
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/write | Adiciona ou modifica as galerias partilhadas. |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/delete | Elimine uma coleção. Apenas aplicável a tipos de API: 'mongodb'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'mongodb'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/read | Ler uma coleção ou lista de todas as coleções. Apenas aplicável a tipos de API: 'mongodb'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'mongodb'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/read | Leia um débito de coleção. Apenas aplicável a tipos de API: 'mongodb'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/write | Atualize um débito de coleção. Apenas aplicável a tipos de API: 'mongodb'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/write | Criar ou atualizar uma coleção. Apenas aplicável a tipos de API: 'mongodb'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/delete | Elimine um contentor. Apenas aplicável a tipos de API: 'sql'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'sql'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/read | Ler um contentor ou listar todos os contentores. Apenas aplicável a tipos de API: 'sql'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'sql'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/read | Leia um débito de contentores. Apenas aplicável a tipos de API: 'sql'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/write | Atualize um débito de contentores. Apenas aplicável a tipos de API: 'sql'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/write | Criar ou atualizar um contentor. Apenas aplicável a tipos de API: 'sql'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/delete | Elimine uma base de dados. Apenas aplicável a tipos de API: 'sql', 'mongodb', 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/delete | Elimine um gráfico. Apenas aplicável a tipos de API: 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/read | Ler um gráfico ou lista de todos os gráficos. Apenas aplicável a tipos de API: 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'gremlin'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/read | Leia um débito de gráfico. Apenas aplicável a tipos de API: 'gremlin'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/write | Atualize um débito de gráfico. Apenas aplicável a tipos de API: 'gremlin'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/write | Criar ou atualizar um gráfico. Apenas aplicável a tipos de API: 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'sql', 'mongodb', 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/read | Ler um banco de dados ou liste todas as bases de dados. Apenas aplicável a tipos de API: 'sql', 'mongodb', 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'sql', 'mongodb', 'gremlin'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/read | Leia um débito de base de dados. Apenas aplicável a tipos de API: 'sql', 'mongodb', 'gremlin'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/write | Atualize um débito de base de dados. Apenas aplicável a tipos de API: 'sql', 'mongodb', 'gremlin'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/write | Crie uma base de dados. Apenas aplicável a tipos de API: 'sql', 'mongodb', 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/delete | Elimine um keyspace. Apenas aplicável a tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/read | Ler um keyspace ou lista de todos os keyspaces. Apenas aplicável a tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'cassandra'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/read | Leia um débito de keyspace. Apenas aplicável a tipos de API: 'cassandra'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/write | Atualize um débito de keyspace. Apenas aplicável a tipos de API: 'cassandra'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/delete | Elimine uma tabela. Apenas aplicável a tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/read | Ler uma tabela ou lista de todas as tabelas. Apenas aplicável a tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: 'cassandra'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/read | Leia um débito de tabela. Apenas aplicável a tipos de API: 'cassandra'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/write | Atualize um débito de tabela. Apenas aplicável a tipos de API: 'cassandra'. Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/write | Criar ou atualizar uma tabela. Apenas aplicável a tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/write | Crie um keyspace. Apenas aplicável a tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/delete | Elimine uma tabela. Apenas aplicável a tipos de API: "tabela". |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: "tabela". |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/read | Ler uma tabela ou lista de todas as tabelas. Apenas aplicável a tipos de API: "tabela". |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/operationResults/read | Ler o status da operação assíncrona. Apenas aplicável a tipos de API: "tabela". Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/read | Leia um débito de tabela. Apenas aplicável a tipos de API: "tabela". Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/write | Atualize um débito de tabela. Apenas aplicável a tipos de API: "tabela". Apenas aplicável para a definição de tipos: 'Débito'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/write | Criar ou atualizar uma tabela. Apenas aplicável a tipos de API: "tabela". |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/delete | Eliminar um proxy de ligação de ponto final privado da conta de base de dados |
> | Ação | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/read | Ler um proxy de ligação de ponto final privado da conta de base de dados |
> | Ação | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/validate/action | Validar um proxy de ligação de ponto final privado da conta de base de dados |
> | Ação | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/write | Criar ou atualizar um proxy de ligação de ponto final privado da conta de base de dados |
...
> | Ação | Microsoft.DocumentDB/locations/operationsStatus/read | Lê o estado das operações assíncronas |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.EventHub/availableClusterRegions/read | Operação de lista de clusters de pré-aprovisionado disponíveis por região do Azure de leitura. |
...
> | Ação | Microsoft.EventHub/clusters/delete | Elimina um recurso de Cluster existente. |
> | Ação | Microsoft.EventHub/clusters/namespaces/read | IDs de ARM de espaço de nomes de lista para espaços de nomes dentro de um cluster. |
> | Ação | Microsoft.EventHub/clusters/operationresults/read | Obtenha o estado de uma operação de cluster assíncrono. |
...
> | Ação | Microsoft.EventHub/namespaces/authorizationRules/listkeys/action | Obter a cadeia de ligação para o espaço de nomes |
> | Ação | Microsoft.EventHub/namespaces/authorizationRules/read | Obter a lista de descrição de regras de autorização de espaços de nomes. |
...
> | Ação | Microsoft.EventHub/namespaces/disasterRecoveryConfigs/authorizationRules/listkeys/action | Obtém a autorização chaves de regras para o espaço de nomes de principal de recuperação após desastre |
> | Ação | Microsoft.EventHub/namespaces/disasterRecoveryConfigs/authorizationRules/read | Obter regras de autorização de desastre recuperação primário do espaço de nomes |
> | Ação | Microsoft.EventHub/namespaces/disasterRecoveryConfigs/breakPairing/action | Desativa a recuperação após desastre e para a replicação de alterações do primário para espaços de nomes secundários. |
> | Ação | Microsoft.EventHub/namespaces/disasterrecoveryconfigs/checkNameAvailability/action | Verifica a disponibilidade do alias do espaço de nomes em determinada subscrição. |
...
> | Ação | Microsoft.EventHub/namespaces/disasterRecoveryConfigs/read | Obtém a configuração de recuperação após desastre associada no espaço de nomes. |
> | Ação | Microsoft.EventHub/namespaces/disasterRecoveryConfigs/write | Cria ou atualiza a configuração de recuperação após desastre associada no espaço de nomes. |
...
> | Ação | Microsoft.EventHub/namespaces/ipFilterRules/read | Obter o recurso de filtro IP |
...
> | Ação | Microsoft.EventHub/namespaces/networkrulesets/delete | Eliminar o recurso de regra VNET |
> | Ação | Microsoft.EventHub/namespaces/networkrulesets/read | Obtém o recurso de NetworkRuleSet |
...
> | Ação | Microsoft.EventHub/namespaces/read | Obter a lista de descrição do recurso de espaço de nomes |
> | Ação | Microsoft.EventHub/namespaces/removeAcsNamepsace/action | Remover espaço de nomes do ACS |
> | Ação | Microsoft.EventHub/namespaces/virtualNetworkRules/delete | Eliminar o recurso de regra VNET |
> | Ação | Microsoft.EventHub/namespaces/virtualNetworkRules/read | Obtém o recurso de regra VNET |
...
> | Ação | Microsoft.EventHub/register/action | Regista a subscrição para o fornecedor de recursos do EventHub e ativa a criação de recursos do EventHub |
...
> | Ação | Microsoft.Features/providers/features/read | Obtém a funcionalidade de uma subscrição no fornecedor de recursos específico. |
...
> | Ação | Microsoft.Features/providers/features/unregister/action | Anula o registo de funcionalidade para uma subscrição de um fornecedor de recursos específico. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.GuestConfiguration/guestConfigurationAssignments/delete | Elimine atribuição de configuração de convidado. |
...
> | Ação | Microsoft.GuestConfiguration/register/action | Regista a subscrição para o fornecedor de recursos de Microsoft.GuestConfiguration. |
...
> | Ação | Microsoft.HDInsight/clusters/getGatewaySettings/action | Obter as definições do gateway para o Cluster do HDInsight |
...
> | Ação | Microsoft.HDInsight/clusters/updateGatewaySettings/action | Atualizar as definições do gateway para o Cluster do HDInsight |
...
> | Ação | Microsoft.HDInsight/locations/checkNameAvailability/read | Verificar a disponibilidade de nome |
...
> | Ação | Microsoft.Insights/ActivityLogAlerts/Activated/Action | Atividade registo de alerta ativado |
> | Ação | Microsoft.Insights/ActivityLogAlerts/Delete | Eliminar um alerta de registo de atividades |
> | Ação | Microsoft.Insights/ActivityLogAlerts/Read | Ler um alerta de registo de atividades |
> | Ação | Microsoft.Insights/ActivityLogAlerts/Write | Criar ou atualizar um alerta de registo de atividades |
> | Ação | Microsoft.Insights/AlertRules/Activated/Action | Alerta de métrica clássico ativada |
...
> | Ação | Microsoft.Insights/AlertRules/Resolved/Action | Alerta de métrica clássico resolvida |
> | Ação | Microsoft.Insights/AlertRules/Throttled/Action | Regra de alerta métrica clássica otimizada |
...
> | Ação | Microsoft.Insights/AutoscaleSettings/Scaledown/Action | Dimensionamento automático reduzir verticalmente iniciada |
> | Ação | Microsoft.Insights/AutoscaleSettings/ScaledownResult/Action | Dimensionamento automático reduzir verticalmente concluída |
> | Ação | Microsoft.Insights/AutoscaleSettings/Scaleup/Action | Dimensionamento automático aumentar verticalmente iniciada |
> | Ação | Microsoft.Insights/AutoscaleSettings/ScaleupResult/Action | Dimensionamento automático aumentar verticalmente concluída |
> | Ação | Microsoft.Insights/AutoscaleSettings/Write | Criar ou atualizar uma definição de dimensionamento automático |
> | Ação | Microsoft.Insights/Baseline/Read | Leia uma linha de base em métrica (pré-visualização) |
> | Ação | Microsoft.Insights/CalculateBaseline/Read | Calcular a linha de base para valores de métrica (pré-visualização) |
> | Ação | Microsoft.Insights/Components/AnalyticsItems/Delete | A eliminar um item de análise do Application Insights |
> | Ação | Microsoft.Insights/Components/AnalyticsItems/Read | Ler um item de análise do Application Insights |
...
> | Ação | Microsoft.Insights/Components/AnalyticsTables/Delete | A eliminar um Application Insights analytics esquema de tabela |
> | Ação | Microsoft.Insights/Components/AnalyticsTables/Read | Ler um Application Insights analytics esquema de tabela |
> | Ação | Microsoft.Insights/Components/AnalyticsTables/Write | Escrever um Application Insights analytics esquema de tabela |
> | Ação | Microsoft.Insights/Components/Annotations/Delete | A eliminar uma anotação do Application Insights |
> | Ação | Microsoft.Insights/Components/Annotations/Read | Ler uma anotação do Application Insights |
> | Ação | Microsoft.Insights/Components/Annotations/Write | Escrever uma anotação do Application Insights |
> | Ação | Microsoft.Insights/Components/Api/Read | Leitura de dados de componente do Application Insights API |
> | Ação | Microsoft.Insights/Components/ApiKeys/Action | Gerar uma chave de API do Application Insights |
> | Ação | Microsoft.Insights/Components/ApiKeys/Delete | A eliminar uma chave de API do Application Insights |
> | Ação | Microsoft.Insights/Components/ApiKeys/Read | A ler uma chave de API do Application Insights |
> | Ação | Microsoft.Insights/Components/BillingPlanForComponent/Read | Ler um plano de faturação para componente do Application Insights |
> | Ação | Microsoft.Insights/Components/CurrentBillingFeatures/Read | Ler as atuais funcionalidades de faturação para componente do Application Insights |
> | Ação | Microsoft.Insights/Components/CurrentBillingFeatures/Write | Escrever as atuais funcionalidades de faturação para componente do Application Insights |
> | Ação | Microsoft.Insights/Components/DefaultWorkItemConfig/Read | Ler uma configuração de integração de ALM do Application Insights padrão |
> | Ação | Microsoft.Insights/Components/Delete | A eliminar uma configuração de componente do application insights |
> | Ação | Microsoft.Insights/Components/Events/Read | Obter registos do Application Insights com o formato de consulta de OData |
> | Ação | Microsoft.Insights/Components/ExportConfiguration/Action | Ação de definições de exportação do Application Insights |
> | Ação | Microsoft.Insights/Components/ExportConfiguration/Delete | A eliminar o Application Insights exportar definições |
> | Ação | Microsoft.Insights/Components/ExportConfiguration/Read | Definições de exportação do Application Insights de leitura |
> | Ação | Microsoft.Insights/Components/ExportConfiguration/Write | Definições de exportação do Application Insights da escrita |
> | Ação | Microsoft.Insights/Components/ExtendQueries/Read | Resultados da consulta expandida do componente do Application Insights de leitura |
> | Ação | Microsoft.Insights/Components/Favorites/Delete | A eliminar um favorito do Application Insights |
> | Ação | Microsoft.Insights/Components/Favorites/Read | A ler um favorito do Application Insights |
> | Ação | Microsoft.Insights/Components/Favorites/Write | Escrever um favorito do Application Insights |
> | Ação | Microsoft.Insights/Components/FeatureCapabilities/Read | Capacidades da funcionalidade do componente leitura Application Insights |
> | Ação | Microsoft.Insights/Components/GetAvailableBillingFeatures/Read | Funcionalidades de faturação do Application Insights da leitura componente disponíveis |
> | Ação | Microsoft.Insights/Components/GetToken/Read | A ler um token de componente do Application Insights |
> | Ação | Microsoft.Insights/Components/MetricDefinitions/Read | Ler definições de métricas de componente do Application Insights |
> | Ação | Microsoft.Insights/Components/Metrics/Read | Métricas do componente do Application Insights de leitura |
...
> | Ação | Microsoft.Insights/Components/Operations/Read | Obter o estado das operações de longa no Application Insights |
> | Ação | Microsoft.Insights/Components/PricingPlans/Read | Ler um plano de preços do componente do Application Insights |
> | Ação | Microsoft.Insights/Components/PricingPlans/Write | Escrever um plano de preços do componente do Application Insights |
> | Ação | Microsoft.Insights/Components/ProactiveDetectionConfigs/Read | Configuração de deteção proativa do Application Insights de leitura |
> | Ação | Microsoft.Insights/Components/ProactiveDetectionConfigs/Write | Escrever configuração de deteção proativa do Application Insights |
> | Ação | Microsoft.Insights/Components/providers/Microsoft.Insights/MetricDefinitions/Read | Ler definições de métrica |
> | Ação | Microsoft.Insights/Components/Purge/Action | Remover os dados do Application Insights |
> | Ação | Microsoft.Insights/Components/Query/Read | Execute consultas de registos do Application Insights |
> | Ação | Microsoft.Insights/Components/QuotaStatus/Read | Ler o estado de quota de componente do Application Insights |
> | Ação | Microsoft.Insights/Components/Read | Ler uma configuração de componente do application insights |
> | Ação | Microsoft.Insights/Components/SyntheticMonitorLocations/Read | Localizações de webtest do Application Insights de leitura |
> | Ação | Microsoft.Insights/Components/Webtests/Read | A ler uma configuração de webtest |
> | Ação | Microsoft.Insights/Components/WorkItemConfigs/Delete | A eliminar uma configuração de integração de ALM do Application Insights |
...
> | Ação | Microsoft.Insights/Components/WorkItemConfigs/Write | Escrever uma configuração de integração de ALM do Application Insights |
> | Ação | Microsoft.Insights/Components/Write | Escrever para uma configuração de componente do application insights |
...
> | Ação | Microsoft.Insights/EventCategories/Read | Leia as categorias de eventos de registo de atividades disponíveis |
> | Ação | Microsoft.Insights/eventtypes/digestevents/Read | Resumo do tipo de evento de gestão de leitura |
> | Ação | Microsoft.Insights/eventtypes/values/Read | Eventos de registo de atividades de leitura |
> | Ação | Microsoft.Insights/ExtendedDiagnosticSettings/Delete | Eliminar um registo de fluxo de rede para definição de diagnóstico |
> | Ação | Microsoft.Insights/ExtendedDiagnosticSettings/Read | Ler um registo de fluxo de rede para definição de diagnóstico |
> | Ação | Microsoft.Insights/ExtendedDiagnosticSettings/Write | Criar ou atualizar uma definição de diagnóstico de registo de fluxo rede |
> | Ação | Microsoft.Insights/ListMigrationDate/Action | Data de migração de subscrição back-Get |
> | Ação | Microsoft.Insights/ListMigrationDate/Read | Data de migração de subscrição de back-Get |
...
> | Ação | Microsoft.Insights/Logs/Alert/Read | Ler dados de tabela alerta |
> | Ação | Microsoft.Insights/Logs/AlertHistory/Read | Ler dados da tabela AlertHistory |
> | Ação | Microsoft.Insights/Logs/ApplicationInsights/Read | Ler dados a partir da tabela do Application Insights |
...
> | Ação | Microsoft.Insights/Logs/ComputerGroup/Read | Ler dados a partir da tabela de grupo de computador |
> | Ação | Microsoft.Insights/Logs/ConfigurationChange/Read | Ler dados da tabela ConfigurationChange |
> | Ação | Microsoft.Insights/Logs/ConfigurationData/Read | Ler dados a partir da tabela de ConfigurationData |
...
> | Ação | Microsoft.Insights/Logs/DeviceHealth/Read | Ler dados a partir da tabela de DeviceHealth |
...
> | Ação | Microsoft.Insights/Logs/Event/Read | Ler dados a partir da tabela de eventos |
...
> | Ação | Microsoft.Insights/Logs/Heartbeat/Read | Ler dados a partir da tabela de Heartbeat |
...
> | Ação | Microsoft.Insights/Logs/Operation/Read | Ler dados a partir da tabela de operação |
> | Ação | Microsoft.Insights/Logs/OutboundConnection/Read | Ler dados da tabela OutboundConnection |
> | Ação | Microsoft.Insights/Logs/Perf/Read | Ler dados a partir da tabela de desempenho |
> | Ação | Microsoft.Insights/Logs/ProtectionStatus/Read | Ler dados da tabela ProtectionStatus |
> | Ação | Microsoft.Insights/Logs/Read | Leitura de dados de todos os seus registos |
...
> | Ação | Microsoft.Insights/Logs/Syslog/Read | Ler dados a partir da tabela de Syslog |
...
> | Ação | Microsoft.Insights/Logs/Update/Read | Ler dados a partir da tabela de atualizações |
...
> | Ação | Microsoft.Insights/Logs/Usage/Read | Ler dados a partir da tabela de utilização |
...
> | Ação | Microsoft.Insights/Logs/WireData/Read | Ler dados a partir da tabela de WireData |
...
> | Ação | Microsoft.Insights/MetricBaselines/Read | Linhas de base de métrica de leitura |
...
> | Ação | Microsoft.Insights/Metricnamespaces/Read | Espaços de nomes de métrica de leitura |
...
> | Ação | Microsoft.Insights/ScheduledQueryRules/Read | Ler uma regra de consulta agendada |
> | Ação | Microsoft.Insights/ScheduledQueryRules/Write | Escrever uma regra de consulta agendada |
> | Ação | Microsoft.Insights/Tenants/Register/Action | Inicializa o fornecedor de Microsoft Insights |
...
> | Ação | Microsoft.Insights/Webtests/MetricDefinitions/Read | Ler definições de métricas de webtest |
> | Ação | Microsoft.Insights/Webtests/Metrics/Read | Ler métricas de webtest |
> | Ação | Microsoft.Insights/Webtests/Read | A ler uma configuração de webtest |
> | Ação | Microsoft.Insights/Webtests/Write | Escrever para uma configuração de webtest |
...
> | Ação | Microsoft.KeyVault/vaults/eventGridFilters/delete | Notifica o Microsoft. keyvault de que está a ser eliminada uma subscrição de EventGrid para o Key Vault |
> | Ação | Microsoft.KeyVault/vaults/eventGridFilters/read | Notifica o Microsoft. keyvault de que está a ser visualizada uma subscrição de EventGrid para o Key Vault |
> | Ação | Microsoft.KeyVault/vaults/eventGridFilters/write | Notifica o Microsoft. keyvault de que está a ser criada uma nova subscrição de EventGrid para o Key Vault |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Kusto/Clusters/Activate/action | O início do cluster. |
> | Ação | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/delete | Elimina um recurso de configuração de base de dados anexados. |
> | Ação | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/read | Lê um recurso de configuração de base de dados anexados. |
> | Ação | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/write | Escreve um recurso de configuração de base de dados anexados. |
> | Ação | Microsoft.Kusto/Clusters/CheckNameAvailability/action | Verifica a disponibilidade de nome de cluster. |
> | Ação | Microsoft.Kusto/Clusters/Databases/AddPrincipals/action | Adiciona entidades de base de dados. |
...
> | Ação | Microsoft.Kusto/Clusters/Databases/EventHubConnections/write | Escreve um recurso de ligações de Hub de eventos. |
> | Ação | Microsoft.Kusto/Clusters/Databases/EventHubConnectionValidation/action | Valida a ligação do Hub de eventos de base de dados. |
> | Ação | Microsoft.Kusto/Clusters/Databases/ListPrincipals/action | Listas de base de dados principais. |
> | Ação | Microsoft.Kusto/Clusters/Databases/read | Lê um recurso de base de dados. |
> | Ação | Microsoft.Kusto/Clusters/Databases/RemovePrincipals/action | Remove de base de dados principais. |
...
> | Ação | Microsoft.Kusto/Clusters/SKUs/read | Lê um recurso SKU do cluster. |
> | Ação | Microsoft.Kusto/Clusters/Start/action | O início do cluster. |
> | Ação | Microsoft.Kusto/Clusters/Stop/action | Interrompe o cluster. |
> | Ação | Microsoft.Kusto/Clusters/write | Escreve um recurso de cluster. |
> | Ação | Microsoft.Kusto/Locations/CheckNameAvailability/action | Verifica a disponibilidade de nome de recurso. |
...
> | Ação | Microsoft.Kusto/Register/action | Regista a subscrição para o fornecedor de recursos do Kusto. |
> | Ação | Microsoft.Kusto/SKUs/read | Lê um recurso SKU. |
> | Ação | Microsoft.Kusto/Unregister/action | Anula o registo da subscrição para o fornecedor de recursos do Kusto. |
...
> | Ação | Microsoft.LabServices/labAccounts/labs/environmentSettings/ResetPassword/action | Repõe a palavra-passe da máquina virtual do modelo. |
> | Ação | Microsoft.LabServices/labAccounts/labs/environmentSettings/SaveImage/action | Salva a imagem de modelo atual para a Galeria partilhada na conta de laboratório |
...
> | Ação | Microsoft.LabServices/users/ListAllEnvironments/action | Lista de todos os ambientes para o utilizador |
...
> | Ação | Microsoft.Logic/integrationAccounts/agreements/listContentCallbackUrl/action | Obtém o URL de retorno de chamada para o conteúdo do acordo na conta de integração. |
...
> | Ação | Microsoft.Logic/integrationAccounts/assemblies/listContentCallbackUrl/action | Obtém o URL de retorno de chamada para o conteúdo da assemblagem na conta de integração. |
...
> | Ação | Microsoft.Logic/integrationAccounts/batchConfigurations/delete | Elimina a configuração de lote na conta de integração. |
...
> | Ação | Microsoft.Logic/integrationAccounts/join/action | Associa a conta de integração. |
> | Ação | Microsoft.Logic/integrationAccounts/listCallbackUrl/action | Obtém o URL de retorno de chamada para a conta de integração. |
...
> | Ação | Microsoft.Logic/integrationAccounts/maps/listContentCallbackUrl/action | Obtém o URL de retorno de chamada para o conteúdo do mapa na conta de integração. |
...
> | Ação | Microsoft.Logic/integrationAccounts/partners/listContentCallbackUrl/action | Obtém o URL de retorno de chamada para o conteúdo de parceiro na conta de integração. |
...
> | Ação | Microsoft.Logic/integrationAccounts/providers/Microsoft.Insights/logDefinitions/read | Lê as definições de registo de conta de integração. |
...
> | Ação | Microsoft.Logic/integrationAccounts/schemas/listContentCallbackUrl/action | Obtém o URL de retorno de chamada para o conteúdo do esquema na conta de integração. |
...
> | Ação | Microsoft.Logic/integrationServiceEnvironments/managedApis/apiOperations/read | Lê que o ambiente de serviço de integração gerido operação de API. |
> | Ação | Microsoft.Logic/integrationServiceEnvironments/managedApis/read | Lê que o ambiente de serviço de integração de API gerenciada. |
> | Ação | Microsoft.Logic/integrationServiceEnvironments/operationStatuses/read | Lê a integração de Estados de funcionamento do ambiente de serviço. |
...
> | Ação | Microsoft.Logic/register/action | Regista o fornecedor de recursos da Microsoft para uma determinada subscrição. |
...
> | Ação | Microsoft.Logic/workflows/enable/action | Permite que o fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/listCallbackUrl/action | Obtém o URL de retorno de chamada para o fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/listSwagger/action | Obtém o fluxo de trabalho definições do swagger. |
> | Ação | Microsoft.Logic/workflows/move/action | Move o fluxo de trabalho de sua existente id de subscrição, grupo de recursos, e/ou nome para um id de subscrição diferente, grupo de recursos e/ou nome. |
> | Ação | Microsoft.Logic/workflows/providers/Microsoft.Insights/diagnosticSettings/read | Lê o fluxo de trabalho definições de diagnóstico. |
...
> | Ação | Microsoft.Logic/workflows/providers/Microsoft.Insights/metricDefinitions/read | Lê o fluxo de trabalho definições de métricas. |
...
> | Ação | Microsoft.Logic/workflows/runs/actions/listExpressionTraces/action | Obtém o rastreios de expressão de ação de execução de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/actions/read | Lê o ação de execução de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/actions/repetitions/listExpressionTraces/action | Obtém o rastreios de expressão de repetição de ação de execução de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/actions/repetitions/read | Lê o repetição da ação de execução de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/actions/repetitions/requestHistories/read | Lê o histórico de pedido de ação de repetição da execução de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/actions/requestHistories/read | Lê o histórico do pedido de ação de execução de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/actions/scoperepetitions/read | Lê o repetição do âmbito de ação de execução de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/cancel/action | Cancela a execução de um fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/delete | Elimina uma execução de um fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/operations/read | Lê o estado da operação de execução de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/runs/read | Lê a execução de fluxo de trabalho. |
...
> | Ação | Microsoft.Logic/workflows/triggers/histories/resubmit/action | Submete novamente o acionador de fluxo de trabalho. |
> | Ação | Microsoft.Logic/workflows/triggers/listCallbackUrl/action | Obtém o URL de retorno de chamada para o acionador. |
...
> | Ação | Microsoft.Logic/workflows/versions/triggers/listCallbackUrl/action | Obtém o URL de retorno de chamada para o acionador. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.MachineLearningServices/locations/computeoperationsstatus/read | Obtém o estado de uma operação de computação específica |
...
> | DataAction | Microsoft.MachineLearningServices/workspaces/experiments/write | Cria ou atualiza experimentações nas áreas de trabalho do Machine Learning Services |
...
> | Ação | Microsoft.Maps/operations/read | Leia as operações de fornecedor |
...
> | Ação | Microsoft.Marketplace/register/action | Regista o fornecedor de recursos de Microsoft.Marketplace na subscrição. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Migrate/assessmentprojects/assessments/read | Avaliações de listas dentro de um projeto |
...
> | Ação | Microsoft.Migrate/assessmentprojects/groups/assessments/downloadurl/action | Downloads do URL de um relatório de avaliação |
...
> | Ação | Microsoft.Migrate/assessmentprojects/groups/updateMachines/action | Grupo de atualização ao adicionar ou remover computadores |
> | Ação | Microsoft.Migrate/assessmentprojects/groups/write | Cria um novo grupo ou atualiza um grupo existente |
> | Ação | Microsoft.Migrate/assessmentprojects/hypervcollectors/delete | Elimina o recoletor de Hyper-v |
> | Ação | Microsoft.Migrate/assessmentprojects/hypervcollectors/read | Obtém as propriedades de recoletor de Hyper-v |
> | Ação | Microsoft.Migrate/assessmentprojects/hypervcollectors/write | Cria um novo recoletor de Hyper-v ou atualiza um recoletor de Hyper-v existente |
...
> | Ação | Microsoft.Migrate/assessmentprojects/vmwarecollectors/delete | Elimina o recoletor de VMware |
> | Ação | Microsoft.Migrate/assessmentprojects/vmwarecollectors/read | Obtém as propriedades de recoletor de VMware |
> | Ação | Microsoft.Migrate/assessmentprojects/vmwarecollectors/write | Cria um novo recoletor de VMware ou atualiza um existente recoletor de VMware |
...
> | Ação | Microsoft.Migrate/migrateprojects/MigrateEvents/Delete | Elimina um evento de migrar |
> | Ação | Microsoft.Migrate/migrateprojects/MigrateEvents/read | Obtém as propriedades de um para migrar os eventos. |
> | Ação | Microsoft.Migrate/migrateprojects/read | Obtém as propriedades do projeto de migração |
> | Ação | Microsoft.Migrate/migrateprojects/registerTool/action | Regista a ferramenta para um projeto de migração |
...
> | Ação | Microsoft.Migrate/migrateprojects/solutions/getconfig/action | Obtém a configuração de solução de projeto de migração |
> | Ação | Microsoft.Migrate/migrateprojects/solutions/read | Obtém as propriedades de solução de projeto de migração |
> | Ação | Microsoft.Migrate/migrateprojects/solutions/write | Cria uma nova solução de projeto para migrar ou atualiza uma solução de projeto de migração existente |
...
> | Ação | Microsoft.Migrate/Operations/read | Lista as operações disponíveis no fornecedor de recursos de Microsoft.Migrate |
> | Ação | Microsoft.Migrate/projects/assessments/read | Avaliações de listas dentro de um projeto |
...
> | Ação | Microsoft.Migrate/projects/groups/assessments/downloadurl/action | Downloads do URL de um relatório de avaliação |
...
> | Ação | Microsoft.Migrate/register/action | Regista a subscrição no fornecedor de recursos de Microsoft.Migrate |
...
> | Ação | Microsoft.Network/applicationGateways/backendAddressPools/join/action | Associa um conjunto de endereços de back-end de gateway de aplicação. Não. o alerta. |
...
> | Ação | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/delete | Elimina uma política de WAF do Gateway de aplicação |
> | Ação | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/read | Obtém uma política de WAF do Gateway de aplicação |
> | Ação | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/write | Cria uma política de WAF do Gateway de aplicação ou atualiza uma política de WAF do Gateway de aplicação |
> | Ação | Microsoft.Network/applicationSecurityGroups/delete | Elimina um grupo de segurança de aplicações |
> | Ação | Microsoft.Network/applicationSecurityGroups/joinIpConfiguration/action | Associa uma configuração de IP para grupos de segurança do aplicativo. Não. o alerta. |
> | Ação | Microsoft.Network/applicationSecurityGroups/joinNetworkSecurityRule/action | Associa uma regra de segurança para grupos de segurança do aplicativo. Não. o alerta. |
...
> | Ação | Microsoft.Network/ddosProtectionPlans/join/action | Associa um plano de proteção contra DDoS. Não. o alerta. |
...
> | Ação | Microsoft.Network/expressRouteCircuits/join/action | Associa um circuito do Expressroute. Não. o alerta. |
...
> | Ação | Microsoft.Network/expressRouteCrossConnections/join/action | Associações uma via expressa cruzam ligação. Não. o alerta. |
...
> | Ação | Microsoft.Network/expressRouteGateways/join/action | Associa um Gateway do Expressroute. Não. o alerta. |
...
> | Ação | Microsoft.Network/expressRoutePorts/join/action | Associa as portas de Express Route. Não. o alerta. |
...
> | Ação | Microsoft.Network/frontDoorWebApplicationFirewallManagedRuleSets/read | Firewall de aplicações Web obtém geridos conjuntos de regras |
...
> | Ação | Microsoft.Network/loadBalancers/backendAddressPools/join/action | Associa um conjunto de endereços de back-end de Balanceador de carga. Não. o alerta. |
...
> | Ação | Microsoft.Network/loadBalancers/frontendIPConfigurations/join/action | Associa uma configuração de IP de front-end de Balanceador de carga. Não. o alerta. |
...
> | Ação | Microsoft.Network/loadBalancers/inboundNatPools/join/action | É associado um balanceador de carga conjunto NAT de entrada. Não. o alerta. |
...
> | Ação | Microsoft.Network/loadBalancers/inboundNatRules/join/action | Associa uma regra de nat de entrada do Balanceador de carga. Não. o alerta. |
...
> | Ação | Microsoft.Network/loadBalancers/probes/join/action | Permite o uso de sondas do Balanceador de carga. Por exemplo, com esta propriedade healthProbe de permissão de dimensionamento de VMS conjunto pode referenciar a sonda. Não. o alerta. |
...
> | Ação | Microsoft.Network/locations/autoApprovedPrivateLinkServices/read | Obtém automaticamente aprovada de serviços de ligação privada |
> | Ação | Microsoft.Network/locations/availableDelegations/read | Obtém as delegações disponíveis |
> | Ação | Microsoft.Network/locations/availablePrivateEndpointTypes/read | Obtém o ponto final privado disponíveis recursos |
...
> | Ação | Microsoft.Network/locations/checkPrivateLinkServiceVisibility/action | Visibilidade do serviço de ligação privada de verificações |
...
> | Ação | Microsoft.Network/networkInterfaces/ipconfigurations/join/action | Associa uma configuração de IP da Interface de rede. Não. o alerta. |
...
> | Ação | Microsoft.Network/networkInterfaces/join/action | Associa uma Máquina Virtual a uma interface de rede. Não. o alerta. |
...
> | Ação | Microsoft.Network/networkSecurityGroups/join/action | Associa um grupo de segurança de rede. Não. o alerta. |
...
> | Ação | Microsoft.Network/privateDnsOperationResults/read | Obtém os resultados de um DNS privado operação |
> | Ação | Microsoft.Network/privateDnsOperationStatuses/read | Obtém o estado de um DNS privado operação |
> | Ação | Microsoft.Network/privateDnsZones/A/delete | Remover o conjunto de registos de um determinado nome e tipo A partir de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/A/read | Obtenha o conjunto de registos do tipo "A" dentro de uma zona DNS privada, no formato JSON. O conjunto de registos contém uma lista de registos, bem como o valor de TTL, marcas e etag. |
> | Ação | Microsoft.Network/privateDnsZones/A/write | Criar ou atualizar um conjunto de registos do tipo "A" dentro de uma zona DNS privada. Os registos especificados substituirá os atuais registos no conjunto de registos. |
> | Ação | Microsoft.Network/privateDnsZones/AAAA/delete | Remover o conjunto de registos de um determinado nome e tipo 'AAAA' de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/AAAA/read | Obtenha o conjunto de registos do tipo 'AAAA' dentro de uma zona DNS privada, no formato JSON. O conjunto de registos contém uma lista de registos, bem como o valor de TTL, marcas e etag. |
> | Ação | Microsoft.Network/privateDnsZones/AAAA/write | Criar ou atualizar um conjunto de registos do tipo 'AAAA' dentro de uma zona DNS privada. Os registos especificados substituirá os atuais registos no conjunto de registos. |
> | Ação | Microsoft.Network/privateDnsZones/ALL/read | Obtém conjuntos de registos de DNS privado em todos os tipos |
> | Ação | Microsoft.Network/privateDnsZones/CNAME/delete | Remover o conjunto de registos de um determinado nome e tipo CNAME de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/CNAME/read | Obtenha o conjunto de registos do tipo CNAME dentro de uma zona DNS privada, no formato JSON. |
> | Ação | Microsoft.Network/privateDnsZones/CNAME/write | Criar ou atualizar um conjunto de registos do tipo "CNAME" dentro de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/delete | Elimine uma zona de DNS privado. |
> | Ação | Microsoft.Network/privateDnsZones/MX/delete | Remover o conjunto de registos de um determinado nome e tipo "MX" de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/MX/read | Obtenha o conjunto de registos do tipo "MX" dentro de uma zona DNS privada, no formato JSON. O conjunto de registos contém uma lista de registos, bem como o valor de TTL, marcas e etag. |
> | Ação | Microsoft.Network/privateDnsZones/MX/write | Criar ou atualizar um conjunto de registos do tipo "MX" dentro de uma zona DNS privada. Os registos especificados substituirá os atuais registos no conjunto de registos. |
> | Ação | Microsoft.Network/privateDnsZones/PTR/delete | Remover o conjunto de registos de um determinado nome e tipo PTR de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/PTR/read | Obtenha o conjunto de registos do tipo PTR dentro de uma zona DNS privada, no formato JSON. O conjunto de registos contém uma lista de registos, bem como o valor de TTL, marcas e etag. |
> | Ação | Microsoft.Network/privateDnsZones/PTR/write | Criar ou atualizar um conjunto de registos do tipo "PTR" dentro de uma zona DNS privada. Os registos especificados substituirá os atuais registos no conjunto de registos. |
> | Ação | Microsoft.Network/privateDnsZones/read | Obtenha o DNS privado propriedades da zona, no formato JSON. Tenha em atenção que este comando não recupera as redes virtuais para o qual está ligada a zona DNS privada ou os conjuntos de registos contidos na zona. |
> | Ação | Microsoft.Network/privateDnsZones/recordsets/read | Obtém conjuntos de registos de DNS privado em todos os tipos |
> | Ação | Microsoft.Network/privateDnsZones/SOA/read | Obtenha o conjunto de registos do tipo SOA dentro de uma zona DNS privada, no formato JSON. |
> | Ação | Microsoft.Network/privateDnsZones/SOA/write | Atualize um conjunto de registos do tipo "SOA" dentro de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/SRV/delete | Remover o conjunto de registos de um determinado nome e tipo SRV de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/SRV/read | Obtenha o conjunto de registos do tipo SRV dentro de uma zona DNS privada, no formato JSON. O conjunto de registos contém uma lista de registos, bem como o valor de TTL, marcas e etag. |
> | Ação | Microsoft.Network/privateDnsZones/SRV/write | Criar ou atualizar um conjunto de registos do tipo "SRV" dentro de uma zona DNS privada. Os registos especificados substituirá os atuais registos no conjunto de registos. |
> | Ação | Microsoft.Network/privateDnsZones/TXT/delete | Remover o conjunto de registos de um determinado nome e tipo TXT de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/TXT/read | Obtenha o conjunto de registos do tipo "TXT" dentro de uma zona DNS privada, no formato JSON. O conjunto de registos contém uma lista de registos, bem como o valor de TTL, marcas e etag. |
> | Ação | Microsoft.Network/privateDnsZones/TXT/write | Criar ou atualizar um conjunto de registos do tipo "TXT" dentro de uma zona DNS privada. Os registos especificados substituirá os atuais registos no conjunto de registos. |
> | Ação | Microsoft.Network/privateDnsZones/virtualNetworkLinks/delete | Elimine uma ligação de zona de DNS privado para a rede virtual. |
> | Ação | Microsoft.Network/privateDnsZones/virtualNetworkLinks/read | Obtenha o DNS privado zona ligação às propriedades de rede virtual, no formato JSON. |
> | Ação | Microsoft.Network/privateDnsZones/virtualNetworkLinks/write | Criar ou atualizar uma ligação de zona DNS privada, a rede virtual. |
> | Ação | Microsoft.Network/privateDnsZones/write | Criar ou atualizar uma zona DNS privada dentro de um grupo de recursos. Tenha em atenção que este comando não pode ser utilizado para criar ou atualizar ligações de rede virtual ou conjuntos de registos na zona. |
> | Ação | Microsoft.Network/privateEndpoints/delete | Elimina um recurso de ponto final privado. |
> | Ação | Microsoft.Network/privateEndpoints/read | Obtém um recurso de ponto final privado. |
> | Ação | Microsoft.Network/privateEndpoints/write | Cria um novo ponto final privado ou atualiza um ponto de extremidade privado existente. |
...
> | Ação | Microsoft.Network/publicIPAddresses/join/action | Associa um endereço ip público. Não. o alerta. |
...
> | Ação | Microsoft.Network/publicIPPrefixes/join/action | Associa um PublicIPPrefix. Não. o alerta. |
...
> | Ação | Microsoft.Network/routeFilters/join/action | Associa um filtro de rota. Não. o alerta. |
...
> | Ação | Microsoft.Network/routeTables/join/action | Associa uma tabela de rotas. Não. o alerta. |
...
> | Ação | Microsoft.Network/serviceEndpointPolicies/join/action | Junta-se uma política de ponto final de serviço. Não. o alerta. |
> | Ação | Microsoft.Network/serviceEndpointPolicies/joinSubnet/action | Associa uma sub-rede para políticas de ponto final de serviço. Não. o alerta. |
...
> | Ação | Microsoft.Network/virtualNetworks/bastionHosts/default/action | Obtém as referências de anfitrião de bastião numa rede Virtual. |
...
> | Ação | Microsoft.Network/virtualNetworks/subnets/join/action | Junta-se a uma rede virtual. Não. o alerta. |
> | Ação | Microsoft.Network/virtualNetworks/subnets/joinViaServiceEndpoint/action | Associa o recurso, como a conta de armazenamento ou base de dados SQL a uma sub-rede. Não. o alerta. |
...
> | Ação | Microsoft.Network/virtualNetworkTaps/join/action | Associa um toque de rede virtual. Não. o alerta. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.NotificationHubs/CheckNamespaceAvailability/action | Verifica se é ou não um determinado nome de recurso de espaço de nomes disponível dentro do serviço NotificationHub. |
> | Ação | Microsoft.NotificationHubs/Namespaces/authorizationRules/action | Obter a lista de descrição de regras de autorização de espaços de nomes. |
...
> | Ação | Microsoft.NotificationHubs/Namespaces/authorizationRules/listkeys/action | Obter a cadeia de ligação para o espaço de nomes |
> | Ação | Microsoft.NotificationHubs/Namespaces/authorizationRules/read | Obter a lista de descrição de regras de autorização de espaços de nomes. |
> | Ação | Microsoft.NotificationHubs/Namespaces/authorizationRules/regenerateKeys/action | Espaço de nomes autorização regra regenerar primária/secundária, especifique a chave tem de ser regenerada |
...
> | Ação | Microsoft.NotificationHubs/Namespaces/CheckNotificationHubAvailability/action | Verifica se determinado nome do NotificationHub está disponível dentro de um espaço de nomes. |
> | Ação | Microsoft.NotificationHubs/Namespaces/Delete | Eliminar recurso de espaço de nomes |
> | Ação | Microsoft.NotificationHubs/Namespaces/NotificationHubs/authorizationRules/action | Obter a lista de regras de autorização do Hub de notificações |
> | Ação | Microsoft.NotificationHubs/Namespaces/NotificationHubs/authorizationRules/delete | Eliminar regras de autorização do Hub de notificação |
> | Ação | Microsoft.NotificationHubs/Namespaces/NotificationHubs/authorizationRules/listkeys/action | Obter a cadeia de ligação para o Hub de notificação |
> | Ação | Microsoft.NotificationHubs/Namespaces/NotificationHubs/authorizationRules/read | Obter a lista de regras de autorização do Hub de notificações |
> | Ação | Microsoft.NotificationHubs/Namespaces/NotificationHubs/authorizationRules/regenerateKeys/action | Notificação Hub autorização regra regenerar primária/secundária, especifique a chave tem de ser regenerada |
...
> | Ação | Microsoft.NotificationHubs/Namespaces/NotificationHubs/debugSend/action | Envie notificação push de teste. |
> | Ação | Microsoft.NotificationHubs/Namespaces/NotificationHubs/Delete | Eliminar recurso do Hub de notificação |
...
> | Ação | Microsoft.NotificationHubs/Namespaces/read | Obter a lista de descrição do recurso de espaço de nomes |
...
> | Ação | Microsoft.NotificationHubs/operations/read | Devolve uma lista de operações com suporte para o fornecedor de Hubs de notificação |
...
> | Ação | microsoft.operationalinsights/unregister/action | Anula o registo da subscrição. |
...
> | Ação | microsoft.operationalinsights/workspaces/operations/read | Obtém o estado de uma operação de área de trabalho OperationalInsights. |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/Alert/read | Ler dados de tabela alerta |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/ApplicationInsights/read | Ler dados a partir da tabela do Application Insights |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/ComputerGroup/read | Ler dados a partir da tabela de grupo de computador |
> | Ação | Microsoft.OperationalInsights/workspaces/query/ConfigurationChange/read | Ler dados da tabela ConfigurationChange |
> | Ação | Microsoft.OperationalInsights/workspaces/query/ConfigurationData/read | Ler dados a partir da tabela de ConfigurationData |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/DeviceHealth/read | Ler dados a partir da tabela de DeviceHealth |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/Event/read | Ler dados a partir da tabela de eventos |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/Heartbeat/read | Ler dados a partir da tabela de Heartbeat |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/Operation/read | Ler dados a partir da tabela de operação |
> | Ação | Microsoft.OperationalInsights/workspaces/query/OutboundConnection/read | Ler dados da tabela OutboundConnection |
> | Ação | Microsoft.OperationalInsights/workspaces/query/Perf/read | Ler dados a partir da tabela de desempenho |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/Syslog/read | Ler dados a partir da tabela de Syslog |
> | Ação | Microsoft.OperationalInsights/workspaces/query/SysmonEvent/read | Ler dados da tabela SysmonEvent |
> | Ação | Microsoft.OperationalInsights/workspaces/query/Tables.Custom/read | Leitura de dados de qualquer registo personalizado |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/Update/read | Ler dados a partir da tabela de atualizações |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/Usage/read | Ler dados a partir da tabela de utilização |
...
> | Ação | Microsoft.OperationalInsights/workspaces/query/WireData/read | Ler dados a partir da tabela de WireData |
...
> | Ação | Microsoft.PolicyInsights/operations/read | Obtém suporte operações no espaço de nomes de policyinsights |
...
> | Ação | Microsoft.PolicyInsights/policyStates/queryResults/action | Consultar informações sobre os Estados da política. |
> | Ação | Microsoft.PolicyInsights/policyStates/queryResults/read | Consultar informações sobre os Estados da política. |
> | Ação | Microsoft.PolicyInsights/policyStates/summarize/action | Consultar as informações de resumo sobre Estados mais recente da política. |
> | Ação | Microsoft.PolicyInsights/policyStates/summarize/read | Consultar as informações de resumo sobre Estados mais recente da política. |
> | Ação | Microsoft.PolicyInsights/policyStates/triggerEvaluation/action | Aciona uma nova avaliação de conformidade para o âmbito selecionado. |
> | Ação | Microsoft.PolicyInsights/policyTrackedResources/queryResults/read | Consultar informações sobre os recursos exigidos pelo DeployIfNotExists políticas. |
> | Ação | Microsoft.PolicyInsights/register/action | Regista o fornecedor de recursos do Microsoft Policy Insights e ativa ações na mesma. |
> | Ação | Microsoft.PolicyInsights/remediations/cancel/action | Cancele remediações de Microsoft Policy em curso. |
> | Ação | Microsoft.PolicyInsights/remediations/delete | Elimine remediações de política. |
> | Ação | Microsoft.PolicyInsights/remediations/listDeployments/read | Lista as implementações necessárias por uma atualização de política. |
> | Ação | Microsoft.PolicyInsights/remediations/read | Obtenha remediações de política. |
> | Ação | Microsoft.PolicyInsights/remediations/write | Criar ou atualizar remediações de Microsoft Policy. |
> | Ação | Microsoft.PolicyInsights/unregister/action | Anula o registo do fornecedor de recursos do Microsoft Policy Insights. |
...
> | Ação | Microsoft.Portal/consoles/read | Lê a instância do Cloud Shell. |
...
> | Ação | Microsoft.Portal/register/action | Registre-se para o Portal |
> | Ação | Microsoft.Portal/usersettings/delete | Remove as definições de utilizador do Cloud Shell. |
> | Ação | Microsoft.Portal/usersettings/read | Lê as definições de utilizador do Cloud Shell. |
...
> | Ação | Microsoft.PowerBIDedicated/locations/checkNameAvailability/action | Verificações de que nome da capacidade do Power BI dedicado é válido e não em utilização. |
...
> | Ação | microsoft.recoveryservices/Locations/backupProtectedItem/write | Criar um Item de cópia de segurança protegido |
...
> | Ação | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/removeDisks/action | Remova os discos |
...
> | Ação | Microsoft.Relay/namespaces/authorizationRules/listkeys/action | Obter a cadeia de ligação para o espaço de nomes |
> | Ação | Microsoft.Relay/namespaces/authorizationRules/read | Obter a lista de descrição de regras de autorização de espaços de nomes. |
...
> | Ação | Microsoft.Relay/namespaces/disasterRecoveryConfigs/authorizationRules/listkeys/action | Obtém a autorização chaves de regras para o espaço de nomes de principal de recuperação após desastre |
> | Ação | Microsoft.Relay/namespaces/disasterRecoveryConfigs/authorizationRules/read | Obter regras de autorização de desastre recuperação primário do espaço de nomes |
> | Ação | Microsoft.Relay/namespaces/disasterRecoveryConfigs/breakPairing/action | Desativa a recuperação após desastre e para a replicação de alterações do primário para espaços de nomes secundários. |
> | Ação | Microsoft.Relay/namespaces/disasterrecoveryconfigs/checkNameAvailability/action | Verifica a disponibilidade do alias do espaço de nomes em determinada subscrição. |
...
> | Ação | Microsoft.Relay/namespaces/disasterRecoveryConfigs/read | Obtém a configuração de recuperação após desastre associada no espaço de nomes. |
> | Ação | Microsoft.Relay/namespaces/disasterRecoveryConfigs/write | Cria ou atualiza a configuração de recuperação após desastre associada no espaço de nomes. |
...
> | Ação | Microsoft.Relay/namespaces/read | Obter a lista de descrição do recurso de espaço de nomes |
> | Ação | Microsoft.Relay/namespaces/removeAcsNamepsace/action | Remover espaço de nomes do ACS |
...
> | Ação | Microsoft.Relay/register/action | Regista a subscrição para o fornecedor de recursos de reencaminhamento e ativa a criação de recursos de reencaminhamento |
> | Ação | Microsoft.Relay/unregister/action | Regista a subscrição para o fornecedor de recursos de reencaminhamento e ativa a criação de recursos de reencaminhamento |
...
> | Ação | Microsoft.ResourceHealth/AvailabilityStatuses/read | Obtém os Estados de disponibilidade para todos os recursos no âmbito especificado |
> | Ação | Microsoft.ResourceHealth/events/read | Eventos de estado de funcionamento do serviço de GET para determinada subscrição |
...
> | Ação | Microsoft.ResourceHealth/impactedResources/read | Obter recursos afetados da subscrição de indicada |
> | Ação | Microsoft.ResourceHealth/metadata/read | Obtém os metadados |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Resources/checkPolicyCompliance/action | Verificar o estado de conformidade de um determinado recurso relativamente às políticas de recursos. |
> | Ação | Microsoft.Resources/checkResourceName/action | Verifique o nome do recurso de validade. |
...
> | Ação | Microsoft.Resources/deployments/whatIf/action | Prevê a alterações de implementação do modelo. |
...
> | Ação | Microsoft.Resources/subscriptions/operationresults/read | Obter resultados da operação de subscrição. |
...
> | Ação | Microsoft.Resources/subscriptions/resourceGroups/delete | Elimina um grupo de recursos e todos os respetivos recursos. |
...
> | Ação | Microsoft.Resources/subscriptions/resourcegroups/deployments/operationstatuses/read | Obtém ou lista de Estados de funcionamento da implementação. |
...
> | Ação | Microsoft.Resources/subscriptions/resourceGroups/read | Obtém ou lista de grupos de recursos. |
> | Ação | Microsoft.Resources/subscriptions/resourcegroups/resources/read | Obtém os recursos para o grupo de recursos. |
> | Ação | Microsoft.Resources/subscriptions/resourceGroups/validateMoveResources/action | Valide movimentação de recursos de um grupo de recursos para outro. |
...
> | Ação | Microsoft.Resources/tags/delete | Remove todas as marcas num recurso. |
> | Ação | Microsoft.Resources/tags/read | Obtém todas as marcas num recurso. |
> | Ação | Microsoft.Resources/tags/write | Atualiza as etiquetas num recurso por substituição ou intercalação etiquetas existentes com um novo conjunto de etiquetas ou remover etiquetas existentes. |
...
> | Ação | Microsoft.Scheduler/jobcollections/enable/action | Permite que a coleção de tarefas. |
> | Ação | Microsoft.Scheduler/jobcollections/jobs/delete | Elimina a tarefa. |
> | Ação | Microsoft.Scheduler/jobcollections/jobs/generateLogicAppDefinition/action | Gera a definição da aplicação lógica com base numa tarefa do agendador. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Security/adaptiveNetworkHardenings/enforce/action | Impõe o tráfego de determinado regras de proteção através da criação de regras de segurança correspondente nos grupos de segurança de rede especificado |
> | Ação | Microsoft.Security/adaptiveNetworkHardenings/read | Recurso protegido de recomendações de sistema de proteção de rede adaptável obtém do Azure |
...
> | Ação | Microsoft.ServiceBus/namespaces/authorizationRules/listkeys/action | Obter a cadeia de ligação para o espaço de nomes |
> | Ação | Microsoft.ServiceBus/namespaces/authorizationRules/read | Obter a lista de descrição de regras de autorização de espaços de nomes. |
...
> | Ação | Microsoft.ServiceBus/namespaces/disasterRecoveryConfigs/authorizationRules/listkeys/action | Obtém a autorização chaves de regras para o espaço de nomes de principal de recuperação após desastre |
> | Ação | Microsoft.ServiceBus/namespaces/disasterRecoveryConfigs/authorizationRules/read | Obter regras de autorização de desastre recuperação primário do espaço de nomes |
> | Ação | Microsoft.ServiceBus/namespaces/disasterRecoveryConfigs/breakPairing/action | Desativa a recuperação após desastre e para a replicação de alterações do primário para espaços de nomes secundários. |
> | Ação | Microsoft.ServiceBus/namespaces/disasterrecoveryconfigs/checkNameAvailability/action | Verifica a disponibilidade do alias do espaço de nomes em determinada subscrição. |
...
> | Ação | Microsoft.ServiceBus/namespaces/disasterRecoveryConfigs/read | Obtém a configuração de recuperação após desastre associada no espaço de nomes. |
> | Ação | Microsoft.ServiceBus/namespaces/disasterRecoveryConfigs/write | Cria ou atualiza a configuração de recuperação após desastre associada no espaço de nomes. |
> | Ação | Microsoft.ServiceBus/namespaces/eventGridFilters/delete | Elimina o filtro do Event Grid associado com o espaço de nomes. |
> | Ação | Microsoft.ServiceBus/namespaces/eventGridFilters/read | Obtém o filtro do Event Grid associado com o espaço de nomes. |
> | Ação | Microsoft.ServiceBus/namespaces/eventGridFilters/write | Cria ou atualiza o filtro do Event Grid associado com o espaço de nomes. |
...
> | Ação | Microsoft.ServiceBus/namespaces/ipFilterRules/read | Obter o recurso de filtro IP |
...
> | Ação | Microsoft.ServiceBus/namespaces/migrationConfigurations/delete | Elimina a configuração de migração. |
...
> | Ação | Microsoft.ServiceBus/namespaces/migrationConfigurations/revert/action | Reverte o padrão para a migração de espaço de nomes premium |
> | Ação | Microsoft.ServiceBus/namespaces/migrationConfigurations/upgrade/action | Atribui o DNS associado com o espaço de nomes padrão para o espaço de nomes premium que conclui a migração e para os recursos de sincronização de standard para o espaço de nomes premium |
...
> | Ação | Microsoft.ServiceBus/namespaces/networkrulesets/delete | Eliminar o recurso de regra VNET |
> | Ação | Microsoft.ServiceBus/namespaces/networkrulesets/read | Obtém o recurso de NetworkRuleSet |
...
> | Ação | Microsoft.ServiceBus/namespaces/read | Obter a lista de descrição do recurso de espaço de nomes |
> | Ação | Microsoft.ServiceBus/namespaces/removeAcsNamepsace/action | Remover espaço de nomes do ACS |
...
> | Ação | Microsoft.ServiceBus/namespaces/virtualNetworkRules/delete | Eliminar o recurso de regra VNET |
> | Ação | Microsoft.ServiceBus/namespaces/virtualNetworkRules/read | Obtém o recurso de regra VNET |
...
> | Ação | Microsoft.ServiceBus/register/action | Regista a subscrição para o fornecedor de recursos do ServiceBus e ativa a criação de recursos do ServiceBus |
...
> | Ação | Microsoft.ServiceBus/unregister/action | Regista a subscrição para o fornecedor de recursos do ServiceBus e ativa a criação de recursos do ServiceBus |
...
> | Ação | Microsoft.ServiceFabric/locations/environments/clusterVersions/read | Ler qualquer versão do Cluster para um ambiente específico |
...
> | Ação | Microsoft.SignalRService/locations/operationresults/signalr/read | Consultar o estado de uma operação assíncrona |
> | Ação | Microsoft.SignalRService/locations/operationStatuses/operationId/read | Consultar o estado de uma operação assíncrona |
> | Ação | Microsoft.SignalRService/locations/usages/read | Obter as utilizações de quota para o serviço Azure SignalR |
> | Ação | Microsoft.SignalRService/operationresults/read | Consultar o estado de uma operação assíncrona |
> | Ação | Microsoft.SignalRService/operationstatus/read | Consultar o estado de uma operação assíncrona |
...
> | Ação | Microsoft.SignalRService/SignalR/eventGridFilters/delete | Elimine um filtro do event grid de uma SignalR. |
> | Ação | Microsoft.SignalRService/SignalR/eventGridFilters/read | Obter as propriedades do filtro de grelha de eventos especificado ou listas de filtros de todos os a grelha de eventos para o SignalR especificado. |
> | Ação | Microsoft.SignalRService/SignalR/eventGridFilters/write | Criar ou atualizar um filtro do event grid para um SignalR com os parâmetros especificados. |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Solutions/applicationDefinitions/applicationArtifacts/read | Lista os artefactos de aplicativo de definição da aplicação. |
...
> | Ação | Microsoft.Solutions/applications/applicationArtifacts/read | Lista os artefactos de aplicações. |
> | Ação | Microsoft.Solutions/applications/delete | Remove uma aplicação. |
> | Ação | Microsoft.Solutions/applications/read | Obtém uma lista de aplicativos. |
> | Ação | Microsoft.Solutions/applications/refreshPermissions/action | Atualiza a aplicação permissões. |
> | Ação | Microsoft.Solutions/applications/updateAccess/action | Acesso de aplicação de atualizações. |
...
> | Ação | Microsoft.Solutions/locations/operationStatuses/read | Lê o estado da operação para o recurso. |
> | Ação | Microsoft.Solutions/register/action | Registre-se às soluções. |
> | Ação | Microsoft.Solutions/unregister/action | Anula o registo de soluções. |
...
> | Ação | Microsoft.Sql/instancePools/usages/read | Obtém as informações de utilização de um conjunto de instância |
...
> | Ação | Microsoft.Sql/locations/encryptionProtectorAzureAsyncOperation/read | Obtém em curso operações no protetor de encriptação de encriptação de dados transparente |
> | Ação | Microsoft.Sql/locations/encryptionProtectorOperationResults/read | Obtém em curso operações no protetor de encriptação de encriptação de dados transparente |
...
> | Ação | Microsoft.Sql/locations/managedInstanceEncryptionProtectorAzureAsyncOperation/read | Obtém em curso operações no protetor de encriptação da instância gerida de encriptação de dados transparente |
> | Ação | Microsoft.Sql/locations/managedInstanceEncryptionProtectorOperationResults/read | Obtém em curso operações no protetor de encriptação da instância gerida de encriptação de dados transparente |
> | Ação | Microsoft.Sql/locations/managedInstanceKeyAzureAsyncOperation/read | Obtém em curso operações na encriptação de dados transparente gerida chaves de instância |
> | Ação | Microsoft.Sql/locations/managedInstanceKeyOperationResults/read | Obtém em curso operações na encriptação de dados transparente gerida chaves de instância |
...
> | Ação | Microsoft.Sql/locations/privateEndpointConnectionProxyAzureAsyncOperation/read | Obtém o resultado de uma operação de proxy de ligação de ponto final privado |
> | Ação | Microsoft.Sql/locations/privateEndpointConnectionProxyOperationResults/read | Obtém o resultado de uma operação de proxy de ligação de ponto final privado |
> | Ação | Microsoft.Sql/locations/read | Obtém as localizações disponíveis para uma determinada subscrição |
> | Ação | Microsoft.Sql/locations/serverKeyAzureAsyncOperation/read | Obtém em curso operações sobre chaves de servidor de encriptação de dados transparente |
> | Ação | Microsoft.Sql/locations/serverKeyOperationResults/read | Obtém em curso operações sobre chaves de servidor de encriptação de dados transparente |
...
> | Ação | Microsoft.Sql/managedInstances/databases/currentSensitivityLabels/write | Etiquetas de sensibilidade de atualização de batch |
...
> | Ação | Microsoft.Sql/managedInstances/databases/schemas/read | Obter um esquema de base de dados gerido. |
> | Ação | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/read | Obtenha uma coluna de base de dados gerida |
...
> | Ação | Microsoft.Sql/managedInstances/databases/schemas/tables/read | Obter uma tabela de base de dados gerida |
> | Ação | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/read | Obter uma lista de políticas de deteção de ameaças de base de dados gerida configurado para um determinado servidor |
...
> | Ação | Microsoft.Sql/managedInstances/securityAlertPolicies/read | Obter uma lista de políticas de deteção de ameaças do servidor gerido configurado para um determinado servidor |
...
> | Ação | Microsoft.Sql/servers/databases/currentSensitivityLabels/write | Etiquetas de sensibilidade de atualização de batch |
...
> | Ação | Microsoft.Sql/servers/databases/failover/action | Ativação pós-falha de base de dados iniciado pelo cliente. |
...
> | Ação | Microsoft.Sql/servers/databases/move/action | Altere o nome da base de dados existente. |
...
> | Ação | Microsoft.Sql/servers/databases/schemas/read | Obter um esquema de banco de dados. |
> | Ação | Microsoft.Sql/servers/databases/schemas/tables/columns/read | Obtenha uma coluna de base de dados. |
...
> | Ação | Microsoft.Sql/servers/databases/schemas/tables/read | Obter uma tabela de base de dados. |
...
> | Ação | Microsoft.Sql/servers/databases/securityAlertPolicies/read | Obter uma lista de políticas de deteção de ameaças da base de dados configurada para um determinado servidor |
...
> | Ação | Microsoft.Sql/servers/elasticPools/failover/action | Cliente iniciada a ativação pós-falha do conjunto elástico. |
...
> | Ação | Microsoft.Sql/servers/privateEndpointConnectionProxies/read | Devolve a lista de ponto final privado proxies de ligação ou obtém as propriedades para o proxy de ligação de ponto final privado especificado. |
> | Ação | Microsoft.Sql/servers/privateEndpointConnectionProxies/validate/action | Valida uma privada chamada de criar a ligação de ponto de extremidade do lado NRP |
...
> | Ação | Microsoft.Sql/servers/privateEndpointConnections/read | Devolve a lista de ligações de ponto final privado ou obtém as propriedades para a ligação de ponto final privado especificado. |
> | Ação | Microsoft.Sql/servers/privateEndpointConnections/write | Aprove ou rejeite uma ligação de ponto final privado existente |
> | Ação | Microsoft.Sql/servers/privateLinkResources/read | Obtenha os recursos de ligação privada para o sql server correspondente |
...
> | Ação | Microsoft.Sql/servers/securityAlertPolicies/read | Obter uma lista de políticas de deteção de ameaças do servidor configurada para um determinado servidor |
...
> | Tipo de ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Storage/checknameavailability/read | Verifica esse nome de conta é válido e não está em utilização. |
> | Ação | Microsoft.Storage/locations/checknameavailability/read | Verifica esse nome de conta é válido e não está em utilização. |
> | Ação | Microsoft.Storage/locations/deleteVirtualNetworkOrSubnets/action | Notifica o Microsoft. Storage que está a ser eliminado rede ou sub-rede virtual |
> | Ação | Microsoft.Storage/locations/usages/read | Devolve o limite e a contagem de utilização atuais para recursos na subscrição especificada |
> | Ação | Microsoft.Storage/operations/read | Consulta o estado de uma operação assíncrona. |
> | Ação | Microsoft.Storage/register/action | Regista a subscrição para o fornecedor de recursos de armazenamento e permite a criação de contas de armazenamento. |
...
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/filter/action | Devolve a lista de blobs numa conta com filtro de etiquetas correspondentes |
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/read | Devolve um blob ou uma lista de blobs |
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/tags/read | Devolve o resultado da leitura de etiquetas de blob |
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/tags/write | Devolve o resultado de escrever as etiquetas de blob |
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/write | Devolve o resultado de escrever um blob |
> | Ação | Microsoft.Storage/storageAccounts/blobServices/containers/clearLegalHold/action | Arquivo legal do contentor de BLOBs clara |
> | Ação | Microsoft.Storage/storageAccounts/blobServices/containers/delete | Devolve o resultado da eliminação de um contentor |
> | Ação | Microsoft.Storage/storageAccounts/blobServices/containers/immutabilityPolicies/delete | Eliminar política de imutabilidade do contentor de BLOBs |
...
> | Ação | Microsoft.Storage/storageAccounts/blobServices/containers/immutabilityPolicies/lock/action | Política de imutabilidade do contentor de BLOBs de bloqueio |
> | Ação | Microsoft.Storage/storageAccounts/blobServices/containers/immutabilityPolicies/read | Obter política de imutabilidade do contentor de BLOBs |
...
> | Ação | Microsoft.Storage/storageAccounts/blobServices/containers/setLegalHold/action | Definir o blob legal do contentor |
...
> | Ação | Microsoft.Storage/storageAccounts/blobServices/generateUserDelegationKey/action | Devolve uma chave de delegação de utilizador para o serviço de BLOBs |
> | Ação | Microsoft.Storage/storageAccounts/blobServices/read | Devolve as propriedades do serviço ou a estatística de BLOBs |
> | Ação | Microsoft.Storage/storageAccounts/blobServices/write | Devolve o resultado de BLOBs colocado as propriedades do serviço |
> | Ação | Microsoft.Storage/storageAccounts/delete | Elimina uma conta de armazenamento existente. |
> | Ação | Microsoft.Storage/storageAccounts/failover/action | Cliente é capaz de controlar a ativação pós-falha em caso de problemas de disponibilidade |
...
> | Ação | Microsoft.Storage/storageAccounts/fileServices/read | Obter propriedades de serviço do ficheiro |
...
> | Ação | Microsoft.Storage/storageAccounts/listkeys/action | Devolve as chaves de acesso de conta de armazenamento especificada. |
...
> | Ação | Microsoft.Storage/storageAccounts/managementPolicies/delete | Eliminar políticas de gestão de conta de armazenamento |
> | Ação | Microsoft.Storage/storageAccounts/managementPolicies/read | Obter políticas de conta de gestão de armazenamento |
> | Ação | Microsoft.Storage/storageAccounts/managementPolicies/write | Colocar políticas de gestão de conta de armazenamento |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/delete | Eliminar Proxies de ligação de ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/validate/action | Validar Proxies de ligação de ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/write | Colocar Proxies de ligação de ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/delete | Eliminar ligação de ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/read | Obter ligação de ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/write | Colocar a ligação de ponto de extremidade privados |
...
> | Ação | Microsoft.Storage/storageAccounts/queueServices/read | Obter as propriedades do serviço fila |
> | Ação | Microsoft.Storage/storageAccounts/queueServices/read | Fila de serviço propriedades ou estatísticas. |
> | Ação | Microsoft.Storage/storageAccounts/queueServices/write | Devolve o resultado da configuração das propriedades do serviço fila |
> | Ação | Microsoft.Storage/storageAccounts/read | Devolve a lista de armazenamento de contas ou obtém as propriedades para a conta de armazenamento especificada. |
...
> | Ação | Microsoft.Storage/storageAccounts/restoreBlobRanges/action | Restaurar os intervalos de BLOBs para o estado do tempo especificado |
> | Ação | Microsoft.Storage/storageAccounts/revokeUserDelegationKeys/action | Revoga todas as chaves de delegação de utilizador para a conta de armazenamento especificada. |
> | Ação | Microsoft.Storage/storageAccounts/services/diagnosticSettings/write | Criar/atualizar definições de diagnóstico de conta de armazenamento. |
> | Ação | Microsoft.Storage/storageAccounts/tableServices/read | Obter as propriedades do serviço de tabela |
> | Ação | Microsoft.Storage/storageAccounts/write | Cria uma conta de armazenamento com os parâmetros especificados ou atualiza as propriedades ou etiquetas ou adiciona um domínio personalizado para a conta de armazenamento especificada. |
> | Ação | Microsoft.Storage/usages/read | Devolve o limite e a contagem de utilização atuais para recursos na subscrição especificada |
...
> | Ação | Microsoft.Web/hostingEnvironments/Join/Action | Associa um ambiente de serviço de aplicações |
...
> | Ação | Microsoft.Web/hostingEnvironments/PrivateEndpointConnectionsApproval/action | Aprovar ligações de ponto de extremidade privados |
...
> | Ação | microsoft.web/sites/extensions/delete | Elimine extensões de Site de aplicações Web. |
> | Ação | microsoft.web/sites/extensions/read | Obtenha as extensões de Site de aplicações Web. |
> | Ação | microsoft.web/sites/extensions/write | Atualize extensões de Site de aplicações Web. |
...
> | Ação | microsoft.web/sites/networktraces/operationresults/read | Obter resultados de operação de rastreio de rede de aplicações Web. |
...
> | Ação | Microsoft.Web/sites/PrivateEndpointConnectionsApproval/action | Aprovar ligações de ponto de extremidade privados |
> | Ação | microsoft.web/sites/processes/modules/read | Obter módulos de processos de aplicações Web. |
> | Ação | microsoft.web/sites/processes/read | Obter processos de aplicações Web. |
> | Ação | microsoft.web/sites/processes/threads/read | Obtenha os Threads de processos de aplicações Web. |
...
> | Ação | microsoft.web/sites/slots/networktraces/operationresults/read | Obter resultados de operação de rastreio de rede ranhuras aplicações Web. |
