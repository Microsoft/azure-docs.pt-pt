...
> | --- | --- | --- | --- |
> | `DenyAssignmentName` | Yes | String | O nome de exibição da missão de negação. Os nomes devem ser únicos para um determinado âmbito. |
> | `Description` | No | String | A descrição da missão de negação. |
