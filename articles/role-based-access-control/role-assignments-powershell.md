...
description: Learn how to manage access to Azure resources for users, groups, and applications using role-based access control (RBAC) and Azure PowerShell. Isto inclui como listar, conceder e remover acesso.
