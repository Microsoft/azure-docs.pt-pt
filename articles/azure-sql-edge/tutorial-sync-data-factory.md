---
title: Sincronizar dados do Azure SQL Edge (Preview) utilizando a Azure Data Factory
description: Saiba mais sobre a sincronização de dados entre o Azure SQL Edge (Preview) e o armazenamento Azure Blob
