---
title: Sync dados do Azure SQL Edge (Preview) utilizando o SQL Data Sync
description: Saiba sobre a sincronização de dados a partir do Azure SQL Edge (Preview) utilizando o Azure SQL Data Sync
...
## <a name="sync-data-between-an-azure-sql-database-and-sql-edge"></a>Sincronizar dados entre uma base de dados Azure SQL e SQL Edge

A configuração da sincronização entre uma base de dados Azure SQL e uma instância SQL Edge através da utilização do SQL Data Sync envolve três passos-chave:  
