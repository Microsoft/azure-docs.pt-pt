...
A Azure SQL Edge suporta atualmente apenas as seguintes entradas e saídas de fluxo.

**Entrada de fluxo**: Isto define as ligações a uma fonte de dados para ler o fluxo de dados a partir de
- Hub de borda
- Kafka (Suporte para entradas Kafka está atualmente disponível apenas nas versões Intel/AMD64 do Azure SQL Edge.)

**Saída de fluxo**: Isto define as ligações a uma fonte de dados para escrever o fluxo de dados para. 
- Hub de borda
