...
1. Guarde o gabarito utilizando a `.liquid` extensão. Este exemplo utiliza `SimpleJsonToJsonTemplate.liquid`.
...
* [DotLiquid - Tente online](http://dotliquidmarkup.org/try-online)
