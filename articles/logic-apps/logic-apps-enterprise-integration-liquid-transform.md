...
1. Para este exemplo, crie o modelo líquido da amostra descrito neste passo. No seu modelo Liquid, pode utilizar [filtros líquidos,](https://shopify.github.io/liquid/basics/introduction/#filters)que utilizam convenções de nomeação [DotLiquid](https://github.com/dotliquid/dotliquid) e C# .
