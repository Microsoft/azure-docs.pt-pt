...
Para criar contratos para troca de mensagens de RosettaNet, veja [mensagens do Exchange RosettaNet](../logic-apps/logic-apps-enterprise-integration-rosettanet.md).
