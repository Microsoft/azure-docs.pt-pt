...
1. Encontre a página de referência para o conector que pretende bloquear.
   ...
   Por exemplo, se quiser bloquear o conector do Instagram, vá a esta página: 
...
1. Na **definição de Política,** forneça as informações para a sua definição de política, com base nas propriedades descritas sob o exemplo:
   ...
   | **Aplicação da política** | Sim | **Ativado** | Esta definição especifica se ativa ou desativa a definição de política quando salva o seu trabalho. |
   ||||
...
1. De acordo com **o Básico,** forneça esta informação para a atribuição de políticas:
   ...
   | **Aplicação da política** | Sim | A definição que permite ou desativa a atribuição de políticas |
