...
* Se possível, utilize [gatilhos e ações incorporados,](../connectors/built-in.md)que custam menos para executar por execução do que [os gatilhos e ações geridos](../connectors/managed.md)do conector .
