...
Esta definição de gatilho verifica todos os dias o e-mail dentro da caixa de entrada para uma conta Do Office 365 Outlook:
...
Esta ação executa código numa aplicação lógica que despoleta quando um novo e-mail chega numa conta do Office 365 Outlook. A aplicação lógica também usa uma ação de e-mail de envio que reencaminha o conteúdo do e-mail recebido juntamente com um pedido de aprovação.
