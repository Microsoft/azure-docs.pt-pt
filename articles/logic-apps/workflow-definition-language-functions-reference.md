...
> Caso contrário, obtém-se um erro, ao contrário de funções semelhantes noutras línguas onde o resultado é o sublamamento do *startIndex* até ao fim da cadeia.
