...
Aqui estão os limites para uma aplicação lógica que começa com um gatilho de Pedido e permite que [o Azure Ative Diretório Open Authentication](../active-directory/develop/about-microsoft-identity-platform.md) (Azure AD OAuth) autorize chamadas de entrada para o gatilho do Pedido:

| Name | Limite | Notas |
| ---- | ----- | ----- |
| Políticas de autorização da AD Azure | 5 | |
...
Esta secção lista os endereços IP de entrada apenas para o serviço De Aplicações Da Lógica Azure. Se tiver governo Azure, consulte o [Governo azure - endereços IP de entrada](#azure-government-inbound).

> [!TIP]
> Para ajudar a reduzir a complexidade quando cria regras de segurança, pode utilizar opcionalmente a etiqueta de [serviço](../virtual-network/service-tags-overview.md), **LogicAppsManagement**, em vez de especificar prefixos de endereçoIP de aplicações lógicas de entrada para cada região. Esta etiqueta funciona em todas as regiões onde o serviço de Aplicações Lógicas está disponível.
...
| Central dos Emirados Emirados Unidos | 20.45.75.193, 20.45.64.29, 20.45.64.87, 20.45.71.213 |
...
Esta secção lista os endereços IP de saída para o serviço de Aplicações Da Lógica Azure e conectores geridos. Se tiver governo Azure, consulte o [Governo azure - endereços IP de saída.](#azure-government-outbound)
...
| Região multi-arrendatária | Aplicativos lógicos IP | Conectores geridos IP |
|---------------------|---------------|-----------------------|
...
| Central dos Emirados Emirados Unidos | 20.45.75.200, 20.45.72.72, 20.45.75.236, 20.45.79.239, 20.45.67.170, 20.45.72.54, 20.45.67.134, 20.45.67.135 | 20.45.67.28, 20.45.67.45, 20.37.74.192 - 20.37.74.207, 40.120.8.0 - 40.120.8.31 |
