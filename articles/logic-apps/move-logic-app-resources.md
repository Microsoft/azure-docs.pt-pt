...
* Permissões do proprietário de recursos para mover e configurar os recursos que deseja. Saiba mais sobre [o controlo de acesso baseado em funções (RBAC)](../role-based-access-control/built-in-roles.md#owner).
