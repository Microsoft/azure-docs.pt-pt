---
title: Exemplos de modelo de Azure Resource Manager – serviço de porta frontal do Azure
...
| [Criar porta frontal com filtragem geográfica](https://github.com/Azure/azure-quickstart-templates/tree/master/101-front-door-geo-filtering)| Crie uma porta frontal que permita/bloqueie o tráfego de determinados países/regiões. |
...
| [Configurar a porta frontal para executar uma ação com parâmetros http específicos](https://github.com/Azure/azure-quickstart-templates/tree/master/201-front-door-waf-http-params)| Configura um Front Door para permitir ou bloquear determinado tráfego com base nos parâmetros http no pedido recebido com regras personalizadas para o controlo de acesso através de parâmetros http. |
| [Configurar limitação da taxa de porta frontal](https://github.com/Azure/azure-quickstart-templates/tree/master/201-front-door-rate-limiting)| Configura um Front Door para limitar as taxas do tráfego recebido para um anfitrião de front-end especificado. |
| | |
