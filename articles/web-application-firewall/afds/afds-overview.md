...
Pode configurar uma política waf e associar essa política a uma ou mais frentes front door para proteção. Uma política de WAF consiste em dois tipos de regras de segurança:
