...
- [Política da WAF no Gateway de Aplicações](/cli/azure/network/application-gateway/waf-policy?view=azure-cli-latest) 

- [Política da WAF na Porta da Frente](/cli/azure/ext/front-door/network/front-door/waf-policy?view=azure-cli-latest)
...
- [Como ativar as definições de diagnóstico para registo de atividades Azure](../azure-monitor/index.yml) 
