...
> [!NOTE]
> As políticas Azure Web Application Firewall (WAF) por site e per-URI estão na Pré-visualização Pública.
> 
...
Crie políticas por site e per-URI utilizando a Azure PowerShell.
