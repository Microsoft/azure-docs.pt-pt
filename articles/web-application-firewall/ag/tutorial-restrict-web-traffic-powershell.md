...
description: Saiba como restringir o tráfego web com uma Firewall de aplicação web num gateway de aplicações utilizando o Azure PowerShell.
...
Se preferir, pode completar este artigo utilizando o [portal Azure](application-gateway-web-application-firewall-portal.md) ou o [Azure CLI](tutorial-restrict-web-traffic-cli.md).
...
Substitua *\<username>* e por os seus *\<password>* valores antes de executar este script.
