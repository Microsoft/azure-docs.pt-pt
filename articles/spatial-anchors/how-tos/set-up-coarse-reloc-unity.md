---
title: Relocalação de grande no Unity
description: Explicação detalhada de como criar e localizar âncoras usando a relocalização de alta utilização no C#.
author: bucurb
manager: dacoghl
...
---
# <a name="how-to-create-and-locate-anchors-using-coarse-relocalization-in-c"></a>Como criar e localizar âncoras usando a relocalação de alta utilização noC#
