---
title: Como criar e localizar as âncoras usando âncoras espaciais do Azure no Swift | Documentos da Microsoft
description: Explicação detalhada sobre como criar e localizar as âncoras usando âncoras espaciais do Azure no Swift.
...
ms.locfileid: "58632627"
---
# <a name="how-to-create-and-locate-anchors-using-azure-spatial-anchors-in-swift"></a>Como criar e localizar as âncoras usando âncoras espaciais do Azure no Swift
...
Âncoras espaciais do Azure permitem-lhe partilhar as âncoras no mundo entre diferentes dispositivos. Ele oferece suporte a vários ambientes de desenvolvimento diferentes. Neste artigo, nos aprofundaremos nas como utilizar o SDK do Azure geográficos âncoras, no Swift, para:
...
Saiba mais sobre o [eliminar](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#deleteanchor) método.
...
Saiba mais sobre o [repor](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#reset) método.
