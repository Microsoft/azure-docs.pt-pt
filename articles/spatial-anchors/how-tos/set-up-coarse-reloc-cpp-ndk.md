...
description: Explicação aprofundada de como criar e localizar âncoras utilizando a relocalização grosseira em C++/NDK.
author: bucurb
manager: dacoghl
...
---
# <a name="how-to-create-and-locate-anchors-using-coarse-relocalization-in-cndk"></a>Como criar e localizar âncoras utilizando a relocalização grosseira em C++/NDK
