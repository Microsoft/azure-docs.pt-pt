...
Siga as instruções [aqui](../how-tos/setup-unity-project.md#download-asa-packages) para descarregar e importar os pacotes ASA SDK necessários para a plataforma Android.
