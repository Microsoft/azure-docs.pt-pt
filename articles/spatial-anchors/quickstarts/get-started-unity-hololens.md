---
title: 'Início rápido: criar um aplicativo do HoloLens com o Unity'
...
No painel **projeto** , vá para `Assets/AzureSpatialAnchors.Examples/Scenes` e abra o `AzureSpatialAnchorsBasicDemo.unity` arquivo de cena.
