...
Localize `startSession()` e adicione a seguinte linha, substituindo no domínio da sua conta anterior: `_cloudSession.configuration.accountKey = @"MyAccountDomain";` .
