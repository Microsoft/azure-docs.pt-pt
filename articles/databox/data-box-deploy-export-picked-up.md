...
1. Conservar a caixa original utilizada para embalar o dispositivo para envio de devolução.
...
Caso encontre algum problema, envie um e-mail para a Data Box Operations Asia [adbo@microsoft.com](mailto:adbo@microsoft.com) fornecendo o nome do trabalho no cabeçalho do assunto e o problema encontrado.
