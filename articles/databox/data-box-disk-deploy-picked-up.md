...
Se estiver a utilizar o Data Box Disk no Japão, Singapura, Coreia, Europa Ocidental ou Índia e tiver selecionado a opção de envio autónomo durante a criação da encomenda, siga estas instruções.
