...
![Ícone de aviso](./media/data-box-safety/read_safety_and_health_information_icon.png) ler ícone de aviso de segurança ler segurança e informações de integridade![](./media/data-box-safety/warning_icon.png)
...
| Ícone | Descrição |
|:--- |:--- |
| ![Ícone](./media/data-box-safety/warning_icon.png) de perigo **perigo!** |Indica uma situação perigosa que, se não for evitada, resultará em morte ou ferimentos sério. Esta palavra de sinal é limitada às situações mais extremas. |
| ![Aviso de](./media/data-box-safety/warning_icon.png) ícone de aviso **!** |Indica uma situação perigosa que, se não for evitada, pode resultar em morte ou ferimentos grave. |
| ![Cuidado com](./media/data-box-safety/warning_icon.png) o ícone de aviso **!** |Indica uma situação perigosa que, se não for evitada, pode resultar em ferimentos secundário ou moderado. |
| ![Aviso do](./media/data-box-safety/notice_icon.png) ícone de aviso **:** |Indica informações consideradas importantes, mas não relacionadas a riscos. |
| ![Ícone](./media/data-box-safety/electrical_shock_hazard_icon.png) de choque elétrico **risco de choque elétrico** |Alta voltagem. |
| ![Ícone](./media/data-box-safety/heavy_weight_hazard_icon.png) de peso pesado **peso pesado** | |
| ![Nenhum ícone](./media/data-box-safety/no_user_serviceable_parts_icon.png) de partes sem serviço de usuário **sem nenhuma parte do usuário** |Não acesse, a menos que seja devidamente treinado. |
...
| ![Ícone](./media/data-box-safety/tip_hazard_icon.png) de risco Tip de **gorjeta** | |

## <a name="handling-precautions"></a>Precauções de manipulação

![](./media/data-box-safety/warning_icon.png) Ícone](./media/data-box-safety/no_user_serviceable_parts_icon.png) de avisoícone](./media/data-box-safety/electrical_shock_hazard_icon.png)![de choque elétrico sem usuários ícone de partes com serviço de peças **cuidado** ![ 
...
![Ícone](./media/data-box-safety/warning_icon.png) ](./media/data-box-safety/heavy_weight_hazard_icon.png) de aviso ícone de peso pesado aviso! ![ 
...
![Ícone](./media/data-box-safety/warning_icon.png) de![aviso ícone](./media/data-box-safety/tip_hazard_icon.png) de risco de dica de advertência **!**
...
![Ícone](./media/data-box-safety/warning_icon.png) ](./media/data-box-safety/electrical_shock_hazard_icon.png) de aviso ícone de choque elétrico aviso! ![
...
* Forneça uma fonte de energia adequada com proteção contra sobrecarga elétrica para atender às seguintes especificações de energia:
    ...
    - Volta 100 v AC a 240 V AC
    - Atualizados 6 A, máximo
...
![Aviso do](./media/data-box-safety/notice_icon.png) ícone de aviso **:**
