...
![Ícone de aviso ](./media/data-box-safety/warning_icon.png)
 ![ Leia o ícone do aviso de segurança ](./media/data-box-safety/read_safety_and_health_information_icon.png) **LEIA INFORMAÇÕES DE SEGURANÇA E SAÚDE**
...
| ![Aviso Ícone ](./media/data-box-safety/warning_icon.png) **CUIDADO!** |Indica uma situação perigosa que, se não for evitada, pode resultar em ferimentos ligeiros ou moderados. |
| ![Aviso de ícone ](./media/data-box-safety/notice_icon.png) **de aviso:** |Indica informações consideradas importantes, mas não relacionadas com riscos. |
| ![Risco de choque elétrico do ícone do choque ](./media/data-box-safety/electrical_shock_hazard_icon.png) **elétrico** |Alta tensão. |
| ![Peso pesado ícone peso ](./media/data-box-safety/heavy_weight_hazard_icon.png) **pesado** | |
| ![Nenhum ícone de peças de serviço do utilizador ](./media/data-box-safety/no_user_serviceable_parts_icon.png) **sem peças resmáveis do utilizador** |Não aceda a menos que esteja devidamente treinado. |
...
| ![Risco de ponta de ](./media/data-box-safety/tip_hazard_icon.png) **aviso de risco de ponta** | |

## <a name="handling-precautions"></a>Precauções de manuseamento

![Ícone de ](./media/data-box-safety/warning_icon.png) ![ aviso ícone de choque elétrico sem ícone ](./media/data-box-safety/electrical_shock_hazard_icon.png)![ de peças de serviço do utilizador ](./media/data-box-safety/no_user_serviceable_parts_icon.png) **PRECAUÇÃO** 
...
* O aparelho está equipado com parafusos à prova de violação. Se suspeitar que o dispositivo está avariado, contacte o [Microsoft Support](data-box-disk-contact-microsoft-support.md) para obter uma substituição. Não tente fazer o serviço. 
...
![Aviso Ícone ](./media/data-box-safety/warning_icon.png) ![ de peso pesado ](./media/data-box-safety/heavy_weight_hazard_icon.png) **AVISO!** 
...
![Aviso Ícone ](./media/data-box-safety/warning_icon.png) ![ de perigo de ponta de ](./media/data-box-safety/tip_hazard_icon.png) **aviso AVISO!**
* Coloque o aparelho sobre uma superfície plana, dura e estável para evitar um potencial perigo de ponta.
* O equipamento montado na cremalheira não deve ser utilizado como prateleiras ou espaços de trabalho. Não coloque a Caixa de Dados em cima de equipamento montado na cremalheira. Adicionar qualquer tipo de carga a uma unidade montada na cremalheira estendida pode criar um potencial perigo de ponta que pode levar a ferimentos, morte ou danos no produto.

![Aviso ícone ](./media/data-box-safety/warning_icon.png) **AVISO!**

* Instale o dispositivo numa área de trabalho que permite uma circulação de ar adequada à volta do dispositivo.
...
![Aviso Ícone ](./media/data-box-safety/warning_icon.png) ![ ícone ícone de choque ](./media/data-box-safety/electrical_shock_hazard_icon.png) **elétrico AVISO!**
...
![Advertência Ícone ](./media/data-box-safety/warning_icon.png) **ATENÇÃO:**
...
![Aviso de ícone ](./media/data-box-safety/notice_icon.png) **de aviso:**
...
Esta secção contém informações regulamentares para a Azure Data Box, número de modelo regulamentar DB010.
...
- Projetado para funcionar no seguinte ambiente. 
    ...
    - Humidade relativa: 15% a 85% (não-consegração) 
    - Altitude de funcionamento: Testada até 6500 pés (0 metros a 2000 metros)
...
![A screenshot mostra uma notificação necessária para o Canadá.](./media/data-box-safety/canada.png)
...
[Solicitar uma cópia da Declaração de Conformidade da UE.](mailto:CSI_Compliance@microsoft.com)
...
![Ícone de eliminação de bateria](./media/data-box-safety/battery_disposal_icon.png)
...
![A screenshot mostra uma notificação necessária para o Japão.](./media/data-box-safety/japan.png)
