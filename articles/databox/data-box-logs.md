...
Para obter mais informações sobre a utilização sugerida do RBAC, consulte [as melhores práticas para o RBAC](../role-based-access-control/overview.md#best-practice-for-using-rbac).
