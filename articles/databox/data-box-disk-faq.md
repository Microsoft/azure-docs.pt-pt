...
R.  Só pode cancelar a encomenda depois de os discos terem sido encomendados e antes de serem enviados. Após o envio, já não pode cancelar a encomenda. No entanto, você pode retornar seus discos em um encargo. 
...
R. O conjunto de ferramentas disponível com o Disco do Data Box contém três ferramentas:
 ...
 - **Disco do data Box ferramenta de cópia dividida**: Use essa ferramenta quando você estiver usando vários discos e tiver um grande conjunto de grandes que precise ser dividido e copiado em todos os discos. Essa ferramenta está disponível no momento para Windows. Não há suporte para essa ferramenta com discos gerenciados. Essa ferramenta também é validada à medida que copia os dados, portanto, você pode ignorar a etapa de validação ao usar essa ferramenta.
