...
description: Neste tutorial, saiba como devolver o Azure Data Box Heavy, incluindo preparar o envio, enviar o Data Box Heavy, verificar o carregamento de dados e apagar os dados.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy
...
ms.locfileid: "87921015"
---
::: zone target = "docs"

# <a name="tutorial-return-azure-data-box-heavy-and-verify-data-upload-to-azure"></a>Tutorial: Devolver o Azure Data Box Heavy e verificar os dados carregados para o Azure
...
- Concluiu o [Tutorial: Copiar dados para o Azure Data Box e verificar](data-box-heavy-deploy-copy-data.md).
