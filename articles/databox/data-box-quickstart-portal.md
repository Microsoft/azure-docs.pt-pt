...
description: Neste início rápido, saiba como implementar o Azure Data Box com o portal do Azure para um pedido de importação. Configure o Azure Data Box e copie os dados a carregar para o Azure.
services: databox
author: alkohli
ms.service: databox
ms.subservice: pod
...
Este início rápido descreve como implementar o Azure Data Box com o portal do Azure para um pedido de importação. Os passos incluem como instalar os cabos, configurar e copiar os dados para o Data Box, para que este os carregue para o Azure. Os passos de início rápido são efetuados no portal do Azure e na IU da Web local do dispositivo.
...
Este guia descreve como implementar o Azure Data Box para importação com o portal do Azure. Os passos incluem examinar os pré-requisitos, instalar os cabos e ligar o dispositivo e copiar dados para o dispositivo para que estes sejam carregados para o Azure.
...
- Certifique-se de que a subscrição que utiliza para o serviço Data Box é de um dos tipos seguintes:
    - Microsoft Customer Agreement (MCA) para novas subscrições ou Microsoft Enterprise Agreement (EA) para subscrições existentes. Leia mais sobre [MCA para novas subscrições](https://www.microsoft.com/licensing/how-to-buy/microsoft-customer-agreement) e [subscrições da EA](https://azure.microsoft.com/pricing/enterprise-agreement/).
