...
As linhas de chat e as mensagens são mantidas até serem explicitamente eliminadas. Um fio totalmente ocioso sem participantes será automaticamente eliminado após 30 dias. Utilize [APIs de chat](/rest/api/communication/chat/chatthread) para obter, listar, atualizar e eliminar mensagens.
...
- [Pedidos de assunto de dados do Azure para o RGPD e CCPA](/microsoft-365/compliance/gdpr-dsr-azure)
