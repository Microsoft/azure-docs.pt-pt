...
Pode criar identidades utilizando a biblioteca de administração dos Serviços de Comunicação Azure. Uma identidade serve como identificador nas conversas. É usado para criar fichas de acesso. A mesma identidade pode participar em múltiplas sessões simultâneas em vários dispositivos. Uma identidade pode ter vários tokens de acesso ativo ao mesmo tempo. 
...
Para revogar um token de acesso antes do seu prazo de validade, utilize a biblioteca de administração dos Serviços de Comunicação Azure. A revogação simbólica não é imediata. Leva até 15 minutos para se propagar. A remoção de uma identidade, recurso ou subscrição revoga todos os tokens de acesso. 
