...
Para obter mais informações sobre a configuração dos diagnósticos, consulte a visão geral dos registos de recursos do [Azure](https://docs.microsoft.com/azure/azure-monitor/platform/platform-logs-overview).
