...
A plataforma APNs precisa de ser configurada com o modo de autenticação simbólica. O modo de autenticação do certificado não é suportado a partir de agora. 
