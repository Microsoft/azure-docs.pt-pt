---
title: Página geral de amostras
titleSuffix: An Azure Communication Services sample overview.
description: Visão geral dos projetos de amostra disponíveis para os Serviços de Comunicação Azure.
...
## <a name="quickstart-samples"></a>Amostras quickstart
Amostras de código de acesso para quickstarts encontradas na nossa documentação.
