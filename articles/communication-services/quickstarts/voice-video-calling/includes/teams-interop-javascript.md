...
description: Neste tutorial, você aprende a se juntar a uma reunião de equipas usando a biblioteca de clientes Azure Communication Services Call para JavaScript
author: chpalm
ms.author: mikben
ms.date: 03/10/2021
ms.topic: quickstart
...
ms.locfileid: "103488014"
---
Neste arranque rápido, você aprenderá a se juntar a uma reunião de equipas usando a biblioteca de clientes Azure Communication Services Call para JavaScript.
