---
title: Quickstart - Chamada para telefone
titleSuffix: An Azure Communication Services quickstart
description: Neste arranque rápido, aprenderás a adicionar capacidades de chamada PSTN à tua app utilizando os Serviços de Comunicação Azure.
author: nikuklic
ms.author: nikuklic
ms.date: 09/11/2020
ms.topic: quickstart
