...
Como o número de instâncias por cluster para as pequenas SKUs é limitado, é preferível usar VMs maiores que têm maior RAM. É necessário mais RAM para alguns tipos de consultas que colocam mais procura no recurso RAM, como consultas que usam `joins`. Portanto, quando estiver a considerar opções de escala, recomendamos que se dimensione para um SKU maior em vez de escalar adicionando mais instâncias.
...
|DS13 v2 + 2&nbsp;TB&nbsp;PS| armazenamento otimizado | 2&nbsp;TUBERCULOSE | 8 | 56&nbsp;GB | 2 | 2 | 1,000
|DS14 v2 + 3&nbsp;TB&nbsp;PS| armazenamento otimizado | 3&nbsp;tuberculose | 16 | 112&nbsp;GB | 2 | 2 | 1,000
|DS14 v2 + 4&nbsp;TB&nbsp;PS| armazenamento otimizado | 4&nbsp;tuberculose | 16 | 112&nbsp;GB | 4 | 2 | 1,000
|L4s v1| armazenamento otimizado | 650&nbsp;GB | 4 | 32&nbsp;GB | 0 | 2 | 16
|L8s v1| armazenamento otimizado | 1,3&nbsp;TB | 8 | 64&nbsp;GB | 0 | 2 | 1,000
|L16s_1| armazenamento otimizado | 2,6&nbsp;tuberculose | 16| 128&nbsp;GB | 0 | 2 | 1,000
