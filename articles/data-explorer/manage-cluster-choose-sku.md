...
|**Name**| **Categoria** | **Tamanho do SSD** | **Núcleos** | **EXISTENTE** | **Discos de armazenamento Premium (1 TB)**| **Contagem mínima de instâncias por cluster** | **Contagem máxima de instâncias por cluster**
|---|---|---|---|---|---|---|---
