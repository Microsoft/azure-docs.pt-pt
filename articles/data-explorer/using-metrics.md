...
## <a name="supported-azure-data-explorer-metrics"></a>Métricas apoiadas do Explorador de Dados Azure

As Métricas de Explorador de Dados Azure suportadas estão separadas em várias categorias de acordo com o uso. 

### <a name="cluster-health-metrics"></a>Métricas de saúde de cluster

As métricas de saúde do cluster acompanham a saúde geral do cluster. Isto inclui a utilização de recursos e ingestão e capacidade de resposta.
...
As métricas de saúde e desempenho das exportações acompanham a saúde geral e o desempenho das operações de exportação, como atrasos, resultados, número de registos e utilização.
...
As métricas de saúde e desempenho da ingestão acompanham a saúde geral e o desempenho de operações de ingestão como latência, resultados e volume.
...
As métricas de desempenho da consulta acompanham a duração da consulta e o número total de consultas simultâneas ou estranguladas.
...
O streaming de métricas de fluxo de dados de ingestão e taxa de pedido, duração e resultados.
