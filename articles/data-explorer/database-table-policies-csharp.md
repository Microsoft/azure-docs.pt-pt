...
O Azure Data Explorer é um serviço de exploração de dados rápido e altamente dimensionável para dados telemétricos e de registo. Neste artigo, você cria políticas de banco de dados e de tabela para C#o Azure data Explorer usando o.
...
* [Um cluster e uma base de dados de teste](create-cluster-database-csharp.md)
