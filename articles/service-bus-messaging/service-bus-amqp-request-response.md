...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|statusCode|int|Sim|Código de resposta HTTP [RFC2616]<br /><br /> 200: OK – sucesso, caso contrário falhou.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|expirações|matriz de timetamp|Sim|Bloqueio de mensagem novo expiração correspondente às fichas de bloqueio de pedido.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|statusCode|int|Sim|Código de resposta HTTP [RFC2616]<br /><br /> 200: OK – tem mais mensagens<br /><br /> 204: Sem conteúdo – sem mais mensagens|  
|estadoDescrição|cadeia (de carateres)|No|Descrição do estado.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|message|matriz de byte|Sim|Mensagem codificada por fios AMQP 1.0.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|sequência-números|matriz de longo|Sim|Número de sequência de mensagens programadas. O número da sequência é usado para cancelar.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|sequência-números|matriz de longo|Sim|Sequência de números de mensagens programadas para cancelar.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|sessão id|string|Sim|Identificação da sessão.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|a partir de sequência-número|long|Sim|Número de sequência a partir do qual começar a espreitar.|  
...
|---------|----------------|--------------|--------------------|  
|sessão id|string|Sim|Identificação da sessão.|  
|sessão-estado|matriz de bytes|Sim|Dados binários opacos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|última atualização da hora|carimbo de data/hora|Sim|Filtrar para incluir apenas sessões atualizadas após um determinado tempo.|  
|saltar|int|Sim|Ignore várias sessões.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|saltar|int|Sim|Número de sessões ignoradas se o código de estado for 200.|  
|sessões ids|matriz de cadeias (de carateres)|Sim|Conjunto de identificações de sessão se o código de estado for 200.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|regra-nome|string|Sim|Nome da regra, sem incluir nomes de subscrição e tópicos.|  
|regra-descrição|mapa|Sim|Descrição da regra, conforme especificado na secção seguinte.|  
...
|sql-regra-ação|mapa|Sim|`sql-rule-action`, conforme especificado na secção seguinte.|  
  
O mapa do filtro sql deve incluir as seguintes entradas:  
  
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|expression|string|Sim|Expressão de filtro sql.|  
...
|propriedades|mapa|Não|Mapas para Service Bus [BrokeredMessage.Properties](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage).|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|top|int|Sim|O número de regras para ir buscar na página.|  
|saltar|int|Sim|O número de regras a ignorar. Define o índice inicial (+1) na lista de regras. | 
...
|---------|----------------|--------------|--------------------|  
|statusCode|int|Sim|Código de resposta HTTP [RFC2616]<br /><br /> 200: OK – sucesso, caso contrário falhou|  
|regras| matriz de mapa|Sim|Conjunto de regras. Cada regra é representada por um mapa.|

Cada entrada de mapa na matriz inclui as seguintes propriedades:

|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|regra-descrição|matriz de objetos descritos|Sim|`com.microsoft:rule-description:list` com AMQP código descrito 0x0000013700000004| 
...
| --- | --- | ---|
| `com.microsoft:sql-filter:list` | 0x00000137000006 | Filtro SQL |
| `com.microsoft:correlation-filter:list` | 0x00000137000009 | Filtro de correlação |
| `com.microsoft:true-filter:list` | 0x000001370000007 | Filtro verdadeiro representando 1=1 |
| `com.microsoft:false-filter:list` | 0x00000137000008 | Filtro falso representando 1=0 |
...
| Nome do descritor | Código de descritor | Valor |
| --- | --- | ---|
| `com.microsoft:empty-rule-action:list` | 0x000001370000005 | Empty Rule Action - Nenhuma ação de regras presente |
| `com.microsoft:sql-rule-action:list` | 0x000001370000006 | Ação de Regras SQL |
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|sequência-números|matriz de longo|Sim|Números de sequência.|  
|modo de liquidação receptor-settle|ubyte|Sim|**Modo de liquidação do recetor,** conforme especificado no núcleo amqp v1.0.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|símbolo de bloqueio|uuid|Sim|Sinal de fechadura se `receiver-settle-mode` for 1.|  
|message|matriz de byte|Sim|Mensagem codificada por fios AMQP 1.0.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|estado de disposição|string|Sim|concluído<br /><br /> abandonado<br /><br /> suspenso|  
...
|propriedades para modificar|mapa|Não|Lista de propriedades de mensagens intermediadas do Service Bus para modificar.|  
