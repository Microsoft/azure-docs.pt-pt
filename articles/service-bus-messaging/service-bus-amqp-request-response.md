...
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:renew-lock`|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:peek-message`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:schedule-message`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|mensagem id|cadeia|Yes|`amqpMessage.Properties.MessageId`como corda|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:cancel-scheduled-message`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:renew-session-lock`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|sessão id|cadeia|Yes|Identificação da sessão.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:set-session-state`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:get-session-state`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:get-message-sessions`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:add-rule`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|regra-nome|cadeia|Yes|Nome da regra, sem incluir nomes de subscrição e tópicos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|expression|cadeia|Yes|Expressão de filtro sql.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|expression|cadeia|Yes|Expressão de ação sql.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:remove-rule`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:enumerate-rules`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|regra-descrição|matriz de objetos descritos|Yes|`com.microsoft:rule-description:list`com AMQP código descrito 0x0000013700000004| 
...
|Índice|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
| 0 | cadeia | Yes | Expressão do filtro sql |
...
| 1 | cadeia | ID de mensagem |
| 2 | cadeia | Para |
| 3 | cadeia | Resposta a |
| 4 | cadeia | Etiqueta |
| 5 | cadeia | ID de sessão |
| 6 | cadeia | Resposta ao ID da sessão|
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:receive-by-sequence-number`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|operação|cadeia|Yes|`com.microsoft:update-disposition`|  
|`com.microsoft:server-timeout`|uint|No|Operação tempo limite do servidor em milissegundos.|  
...
|Chave|Tipo de Valor|Necessário|Conteúdo de valor|  
|---------|----------------|--------------|--------------------|  
|estado de disposição|cadeia|Yes|concluído<br /><br /> abandonado<br /><br /> suspenso|  
