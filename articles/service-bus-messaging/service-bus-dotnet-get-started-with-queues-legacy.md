...
> [!WARNING]
> Este quickstart utiliza o antigo pacote Microsoft.Azure.ServiceBus. Para obter um arranque rápido que utilize o mais recente pacote Azure.Messaging.ServiceBus, consulte [Enviar e receber eventos usando o pacote Azure.Messaging.ServiceBus](service-bus-dotnet-get-started-with-queues.md). 
