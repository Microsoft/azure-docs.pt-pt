...
ms.locfileid: "85337206"
---
# <a name="service-bus-queues-topics-and-subscriptions"></a>Filas, tópicos e subscrições do Service Bus

O Microsoft Azure Service Bus suporta um conjunto de tecnologias de middleware baseadas em nuvem e orientadas para mensagens, incluindo mensagens de mensagens fiáveis e mensagens de publicação/subscrição duradouras. Estas capacidades de mensagens "intermediadas" podem ser consideradas como funcionalidades de mensagens dissociadas que suportam a subscrição de publicação, dissociação temporal e cenários de equilíbrio de carga usando a carga de trabalho de mensagens Service Bus. A comunicação desacoplada tem muitas vantagens; por exemplo, os clientes e os servidores podem ligar-se conforme necessário e efetuar as operações de forma assíncrona.
