...
| Linguagem de programação | SDK ou localização de amostras |
| -------------------- | ----------------------- |
...
| Ir| https://github.com/Azure/azure-service-bus-go/ |
...
* [Arquitetura do Service Bus](./service-bus-messaging-overview.md)
