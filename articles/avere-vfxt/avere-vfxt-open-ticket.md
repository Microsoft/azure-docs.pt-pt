...
Leia [quota para o cluster vFXT](avere-vfxt-prereqs.md#quota-for-the-vfxt-cluster) para saber que componentes são necessários para implementar o Avere vFXT para o Azure. Pode [solicitar um aumento de quota](https://docs.microsoft.com/azure/azure-portal/supportability/resource-manager-core-quotas-request) a partir do portal Azure.
