...
Especificar o servidor DNS que o cluster vFXT utiliza na página de definições da Rede Administrativa do **Cluster.**  >   As definições nessa página incluem:
