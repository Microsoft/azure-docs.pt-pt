...
* [Amostras de PowerShell do Monitor Azure](../azure-monitor/samples/powershell-samples.md)
* [Amostras CLI de plataforma cruzada Azure Monitor](../azure-monitor/samples/cli-samples.md)
