...
Utilize o cmdlet [Get-AzVmss](/powershell/module/az.compute/get-azvmss?view=azps-3.7.0) com parâmetro *InstanceView* para visualizar o *Estado de Serviço* para reparações automáticas de instâncias.
