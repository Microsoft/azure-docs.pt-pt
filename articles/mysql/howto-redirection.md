...
> [!IMPORTANT]
> A reorientação não é suportada atualmente com [Link Privado para Azure Database para o MySQL](concepts-data-access-security-private-link.md).
