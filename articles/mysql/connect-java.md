...
ms.locfileid: "68931602"
---
# <a name="azure-database-for-mysql-use-java-to-connect-and-query-data"></a>Base de Dados do Azure para MySQL: Usar Java para conectar e consultar dados
