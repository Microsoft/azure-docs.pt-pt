...
|**Escalão de Preço**|**vCore(s)**|**InnoDB Buffer Pool size in MB <br>(servers supporting up to 4 TB storage)**| **InnoDB Buffer Pool size in MB <br>(servers supporting up to 16 TB storage)**|
|:---|---:|---:|---:|
|Basic| 1| 960| |
|Basic| 2| 2560| |
