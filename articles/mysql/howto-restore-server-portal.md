...
Para obter mais informações sobre a definição destes valores durante a criação, consulte a Base de [Dados Azure para o servidor MySQL.](quickstart-create-mysql-server-database-using-azure-portal.md)
...
2. Selecione a sua Base de Dados Azure para o servidor MySQL. Esta ação abre a página **de visão geral.**
...
A Base de Dados Azure para MySQL permite-lhe restaurar o servidor de volta a um ponto-a-tempo e a uma nova cópia do servidor. Pode utilizar este novo servidor para recuperar os seus dados ou ter as suas aplicações de cliente apontadas para este novo servidor.
...
2. Na barra de ferramentas da página **de visão geral** do servidor, selecione **Restaurar**.
   ...
   ![Base de Dados Azure para MySQL - Visão geral - Botão restaurar](./media/howto-restore-server-portal/2-server.png)

3. Preencha o formulário Restaurar com as informações necessárias:

   ![Base de Dados Azure para MySQL - Restaurar informações](./media/howto-restore-server-portal/3-restore.png)
...
1. Selecione o botão **Criar um botão de recurso** (+) no canto superior esquerdo do portal. Selecione **Base de** > **Dados de Dados Azure para MySQL**.

   ![A opção "Base de Dados Azure para MySQL"](./media/howto-restore-server-portal/2_navigate-to-mysql.png)
