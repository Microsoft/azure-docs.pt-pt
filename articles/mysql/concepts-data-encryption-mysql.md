...
A encriptação de dados com chaves geridas pelo cliente para a Base de Dados Azure para o MySQL fornece os seguintes benefícios:
...
* Se eliminar o KeyVault, a Base de Dados Azure para o MySQL não poderá aceder à chave e deslocar-se-á para o estado *inacessível.* Recupere o [Cofre de Chaves](../key-vault/general/key-vault-recovery.md) e revalida a encriptação de dados para disponibilizar o servidor . *Available*
...
Saiba como configurar a encriptação de dados com uma chave gerida pelo cliente para a sua base de dados Azure para o MySQL utilizando o [portal Azure](howto-data-encryption-portal.md) e [o Azure CLI](howto-data-encryption-cli.md).
