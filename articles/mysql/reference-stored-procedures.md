...
Os seguintes procedimentos armazenados são utilizados para configurar ou remover a replicação de dados entre um mestre e uma réplica.
...
Para configurar a replicação de dados entre um mestre e uma réplica na Base de Dados Azure para o MySQL, consulte [como configurar a replicação de dados.](howto-data-in-replication.md)
