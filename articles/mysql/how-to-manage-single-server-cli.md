...
Pode aumentar o seu nível de preços, calcular e armazenar facilmente utilizando o seguinte comando. Pode ver toda a operação do servidor que pode realizar [a visão geral do servidor az mysql](/cli/azure/mysql/server?view=azure-cli-latest)
