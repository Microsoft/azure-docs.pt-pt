...
## <a name="sign-in-to-azure-and-list-your-azure-database-for-mysql-servers"></a>Inicie sessão no Azure e listar a sua base de dados do Azure para servidores MySQL
...
3. Na linha de comandos, inicie sessão com as credenciais do Azure.
