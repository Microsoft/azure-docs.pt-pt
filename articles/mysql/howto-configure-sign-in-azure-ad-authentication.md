...
Apenas um utilizador Admin AD AD Azure pode criar/permitir aos utilizadores a autenticação baseada em Azure. Para criar e Azure AD Ad Admin utilizador, siga os seguintes passos
