...
> [!Important]
> - O cenário 2 e 4 podem introduzir uma queda de 5-10% na produção com base no tipo de carga de trabalho para o servidor Azure Database para o servidor MySQL devido à camada adicional de encriptação da infraestrutura.
