---
title: Ler réplicas no banco de dados do Azure para MySQL.
description: Este artigo descreve as réplicas de leitura para o banco de dados do Azure para MySQL.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
