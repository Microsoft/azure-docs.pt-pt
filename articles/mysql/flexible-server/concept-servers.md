...
- Atualmente é suportado com a versão MySQL 5.7. Para obter mais informações, consulte [a Base de Dados Azure suportada para versões do motor MySQL](./concepts-supported-versions.md).
