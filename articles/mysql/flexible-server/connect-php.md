...
Instale o PHP no seu próprio servidor ou crie uma [aplicação Web](https://docs.microsoft.com/azure/app-service/overview) do Azure que inclua o PHP.  Consulte para [criar e gerir regras de firewall](./how-to-manage-firewall-portal.md) para aprender a criar regras de firewall.
