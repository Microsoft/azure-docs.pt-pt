...
Terá de iniciar sessão na sua conta utilizando o comando [de login az.](/cli/azure/reference-index#az_login) Anote a propriedade **id** da saída de comando para o nome de subscrição correspondente.
