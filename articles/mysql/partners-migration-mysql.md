...
| ![Obras Pragmáticas][3] |**Obras Pragmáticas**<br>A Pragmatic Works é uma empresa de formação e consultoria com uma vasta experiência em gestão e desempenho de dados, Business Intelligence, Big Data, Power BI e Azure. Focam-se na otimização de dados e na melhoria da eficiência do SQL Server e da gestão da nuvem.|[Site][pragmatic-works_website]<br>[Twitter][pragmatic-works_twitter]<br>[YouTube][pragmatic-works_youtube]<br>[Contacto][pragmatic-works_contact] | |
| ![Infosys][4] |**Infosys**<br>A Infosys é líder global nos mais recentes serviços digitais e consultoria. Com mais de três décadas de experiência a gerir os sistemas das empresas globais, a Infosys orienta habilmente os clientes através da sua jornada digital, permitindo às organizações com um núcleo movido a IA. Fazê-lo ajuda a priorizar a execução da mudança. A Infosys também fornece às empresas um digital ágil à escala para oferecer níveis de desempenho e prazeres sem precedentes.|[Site][infosys_website]<br>[Twitter][infosys_twitter]<br>[YouTube][infosys_youtube]<br>[Contacto][infosys_contact] | |
