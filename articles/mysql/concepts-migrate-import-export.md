...
Utilize utilitários e ferramentas comuns como mySQL Workbench ou mysqldump para ligar e importar ou exportar remotamente dados para a Base de Dados Azure para o MySQL. 

Utilize estas ferramentas na sua máquina cliente com uma ligação à Internet para ligar à Base de Dados Azure para o MySQL. Utilize uma ligação encriptada SSL para as melhores práticas de segurança, conforme descrito na [conectividade SSL configurada na Base de Dados Azure para o MySQL](concepts-ssl-connection-security.md).
...
![Cadeia de conexão MySQL Workbench](./media/concepts-migrate-import-export/2_setup-new-connection.png)

## <a name="determine-when-to-use-import-and-export-techniques-instead-of-a-dump-and-restore"></a>Determinar quando utilizar técnicas de importação e exportação em vez de uma lixeira e restaurar
Utilize ferramentas MySQL para importar e exportar bases de dados para a base de dados Azure MySQL nos seguintes cenários. Noutros cenários, poderá beneficiar-se de usar a abordagem [de despejo e restauro.](concepts-migrate-dump-restore.md) 
...
Certifique-se de que todas as tabelas da base de dados utilizam o motor de armazenamento InnoDB quando estiver a carregar dados na Base de Dados Azure para o MySQL. A Azure Database for MySQL suporta apenas o motor de armazenamento InnoDB, pelo que não suporta motores de armazenamento alternativos. Se as suas tabelas necessitarem de motores de armazenamento alternativos, certifique-se de que as converte para utilizar o formato do motor InnoDB antes da migração para a Base de Dados Azure para o MySQL. 

Por exemplo, se tiver um WordPress ou uma aplicação web que utilize o motor MyISAM, primeiro converta as tabelas migrando os dados para tabelas InnoDB. Em seguida, restaurar a Base de Dados Azure para o MySQL. Use a cláusula `ENGINE=INNODB` para definir o motor para criar uma tabela e, em seguida, transfira os dados para a tabela compatível antes da migração. 
...
![Assistentes de workbench MySQL no menu de contexto do navegador de objeto](./media/concepts-migrate-import-export/p1.png)
...
![MySQL Workbench exportação de dados usando o painel Navigator](./media/concepts-migrate-import-export/p2.png)
...
![MySQL Workbench Data Import usando O Navegador de Gestão](./media/concepts-migrate-import-export/p3.png)
