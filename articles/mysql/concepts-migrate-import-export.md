...
Para obter orientações detalhadas e abrangentes sobre migração, consulte os recursos do [Guia de Migração.](https://github.com/Azure/azure-mysql/tree/master/MigrationGuide) Para outros cenários de migração, consulte o [Guia de Migração da Base de Dados.](https://datamigration.microsoft.com/) 
...
Utilize ferramentas MySQL para importar e exportar bases de dados para a base de dados Azure MySQL nos seguintes cenários. Para outras ferramentas, consulte a página 22 do guia de [migração mySQL para Azure Database](https://github.com/Azure/azure-mysql/blob/master/MigrationGuide/MySQL%20Migration%20Guide_v1.1.pdf). 
...
:::image type="content" source="./media/concepts-migrate-import-export/p1.png" alt-text="Assistentes de workbench MySQL no menu de contexto do navegador de objeto":::
...
:::image type="content" source="./media/concepts-migrate-import-export/p2.png" alt-text="MySQL Workbench exportação de dados usando o painel Navigator":::
...
:::image type="content" source="./media/concepts-migrate-import-export/p3.png" alt-text="MySQL Workbench Data Import usando O Navegador de Gestão":::
