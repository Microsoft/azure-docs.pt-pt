...
Para obter um guia de migração detalhado e abrangente, consulte [o MySQL para o Guia de Migração da Base de Dados de Azure.](https://github.com/Azure/azure-mysql/tree/master/MigrationGuide) 
