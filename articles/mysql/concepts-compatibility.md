...
| Ir | Go MySQL Driver | https://github.com/go-sql-driver/mysql/releases | 1.3, 1.4 | 1.2 e antes | Utilizar `allowNativePasswords=true` no fio de ligação para a versão 1.3. A versão 1.4 contém uma correção e `allowNativePasswords=true` já não é necessária. |
