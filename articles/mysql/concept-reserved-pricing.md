...
Pode comprar Azure Database para a capacidade reservada do MySQL no [portal Azure.](https://portal.azure.com/) Pague pela reserva [antecipadamente ou com pagamentos mensais](../cost-management-billing/reservations/prepare-buy-reservation.md). Para comprar a capacidade reservada:
...
| Região | A região de Azure que está coberta pela Base de Dados Azure para a reserva de capacidade reservada do MySQL.
