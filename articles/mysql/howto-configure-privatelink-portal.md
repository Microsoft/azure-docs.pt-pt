...
1. No **banco de dados do Azure para MySQL** , forneça estas informações:
    ...
    | Localização | Selecione uma região do Azure em que você deseja que o servidor MySQL resida. |
...
8. Em **criar um ponto de extremidade privado (visualização)-configuração**, insira ou selecione estas informações:
    ...
    |Zona de DNS privado |Selecione *(novo) privatelink. mysql. Database. Azure. com* |
    |||
