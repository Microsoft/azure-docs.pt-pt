...
5. Insira valores para os seguintes parâmetros:
   - **Nome**: O nome tem de ser exclusivo dentro da rede virtual. Para obter a compatibilidade máxima com outros serviços do Azure, é recomendável usar uma letra como o primeiro caractere do nome. Por exemplo, Aplicativo Azure gateway não será implantado em uma sub-rede que tem um nome que começa com um número.
