...
description: Saiba como criar uma rede virtual usando um arquivo de configuração de rede no portal do Azure.
...
Este documento aborda a criação de uma VNet usando o modelo de implantação clássico. Você também pode [criar uma rede virtual no modelo de implantação do Gerenciador de recursos](quick-create-powershell.md).
