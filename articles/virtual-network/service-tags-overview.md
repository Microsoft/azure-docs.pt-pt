...
| **Recuperação do AzureSite** | Recuperação do site Azure.<br/><br/>*Nota:* Esta etiqueta tem uma dependência das tags **De Armazenamento,** **AzureActiveDirectory**e **EventHub.** | Saída | Não | Não |
