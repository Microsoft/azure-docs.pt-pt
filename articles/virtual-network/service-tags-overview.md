...
| **AzureaPIForfHIR** | AZure API para FHIR (Fast Healthcare Interoperabilidade Resources).<br/><br/> *Nota: Esta etiqueta não é atualmente configurável através do Portal Azure.*| Saída | No | No |
