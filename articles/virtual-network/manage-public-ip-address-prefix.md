...
description: Saiba mais sobre os prefixos de endereço IP públicos e onde encontrar informações adicionais se não estiver familiarizado com eles. Também aprenda a criar, alterar ou apagar um.
