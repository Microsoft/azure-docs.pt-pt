...
4. <a name = "security-rule-settings"></a>Selecione **+ adicionar**.  Selecionar ou adicionar valores para as seguintes definições e, em seguida, selecione **OK**:
    ...
    |Acção     | Selecione **permitem** ou **negar**.        |         |
