...
Crie um endereço IP público com preferência de encaminhamento do tipo de **Internet** utilizando a rede de comando [az public-ip create](/cli/azure/network/public-ip#az_network_public_ip_create).
