...
Crie uma tabela de rotas com [a az network route-table create](/cli/azure/network/route-table#az_network_route_table_create). O exemplo a seguir cria uma tabela de rotas chamada *myRouteTablePublic*. 
...
Crie uma rota na tabela de rotas com [a rota de rota de rede az criar](/cli/azure/network/route-table/route#az_network_route_table_route_create). 
