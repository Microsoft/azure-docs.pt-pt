...
- **[Serviço de aplicações do Azure](https://docs.microsoft.com/azure/app-service/app-service-ip-restrictions)** : Disponível em geral em todas as regiões do Azure onde o serviço de aplicações está disponível
