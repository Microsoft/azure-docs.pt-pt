...
12. Você também pode alterar outros parâmetros no modelo se escolher e forem opcionais, dependendo dos seus requisitos:
    ...
    * **Espaço de endereço** -o espaço de endereço da VNET pode ser alterado no modelo antes de salvar modificando a seção **recursos** > de**addressSpace** e alterando a propriedade **addressPrefixes** no **Template. JSON** arquivo:
