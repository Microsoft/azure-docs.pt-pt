...
Um ID de sub-rede é atribuído depois de criar uma rede virtual; especificamente, usando o cmdlet New-AzVirtualNetwork com a - opção de sub-rede. Se configurar a sub-rede com o cmdlet New-AzVirtualNetworkSubnetConfig antes da chamada para New-AzVirtualNetwork, não verá o ID de sub-rede até depois de chamar AzVirtualNetwork de novo.
