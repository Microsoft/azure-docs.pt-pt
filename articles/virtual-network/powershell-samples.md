...
description: Saiba mais sobre as amostras do Azure PowerShell para gerir redes virtuais, incluindo uma amostra para criar uma rede virtual para aplicações multi-camadas.
