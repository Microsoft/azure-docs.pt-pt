---
title: Mover uma VM (clássica) ou uma instância de função de serviços de nuvem para uma sub-rede diferente-Azure PowerShell | Microsoft Docs
