...
```
Combine as definições de configuração para criar um VM chamado **myVM** com [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) no **myResourceGroupNAT**.
