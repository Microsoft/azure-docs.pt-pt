---
title: DPDK em Azure Linux VM / Microsoft Docs
description: Saiba como configurar o DPDK numa máquina virtual Linux.
...
| RHEL 7.5     | 3.10.0-862.11.6.6.el7.x86_64+  | 
| CentOS 7.5   | 3.10.0-862.11.6.6.el7.x86_64+  | 
...
A ligação de rede acelerada deve ser ativada numa máquina virtual Linux. A máquina virtual deve ter pelo menos duas interfaces de rede, com uma interface para gestão. Saiba como [criar uma máquina virtual Linux com ligação acelerada em rede](create-vm-accelerated-networking-cli.md).
