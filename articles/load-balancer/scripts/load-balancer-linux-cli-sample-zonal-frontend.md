---
title: VMs de balanceamento de carga em uma CLI do Azure de zona
...
ms.locfileid: "74068769"
---
# <a name="azure-cli-script-example-load-balance-traffic-to-vms-within-a-specific-availability-zone"></a>CLI do Azure exemplo de script: balancear a carga do tráfego para VMs em uma zona de disponibilidade específica
