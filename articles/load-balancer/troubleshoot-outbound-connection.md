...
[As portas efémeras utilizadas](load-balancer-outbound-connections.md#preallocatedports) para [pat](load-balancer-outbound-connections.md#pat) são um recurso exaustivo, conforme descrito em [VM autónomo sem endereço IP público](load-balancer-outbound-connections.md#defaultsnat) e [VM equilibrado em carga sem endereço IP público](load-balancer-outbound-connections.md#lb). Pode monitorizar a sua utilização de portas efémeras e comparar com a sua alocação atual para determinar o risco de ou confirmar a exaustão do SNAT utilizando [este](https://docs.microsoft.com/azure/load-balancer/load-balancer-standard-diagnostics#how-do-i-check-my-snat-port-usage-and-allocation) guia.

Se sabe que está a iniciar muitas ligações TCP ou UDP de saída para o mesmo endereço IP de destino e porta, e observa ligações de saída falhadas ou é aconselhado por suporte a que está a esgotar as portas SNAT [(portas efémeras](load-balancer-outbound-connections.md#preallocatedports) pré-locadas utilizadas pela [PAT),](load-balancer-outbound-connections.md#pat)tem várias opções gerais de mitigação. Reveja estas opções e decida o que está disponível e o melhor para o seu cenário. É possível que um ou mais possam ajudar a gerir este cenário.
