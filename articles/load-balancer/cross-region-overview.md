...
> [!NOTE]
> O porta de reto final da carga a sua regra de equilíbrio na carga transversal Balancer deve corresponder ao porto frontal da regra de equilíbrio de carga/regra nat de entrada no equilibrador de carga padrão regional. 
