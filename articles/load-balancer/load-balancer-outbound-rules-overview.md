...
Você pode reverter para a [alocação de porta SNAT automática com base no tamanho do pool de back-end](load-balancer-outbound-connections.md#preallocatedports) , especificando 0 para número de portas.
