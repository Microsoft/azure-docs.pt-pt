...
:::image type="content" source="./media/quickstart-load-balancer-standard-public-portal/resources-diagram-basic.png" alt-text="Recursos básicos do balanceador de carga criados em arranque rápido." border="false"::: m
