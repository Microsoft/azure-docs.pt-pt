...
8. Crie seus pools de endereços de back-end- *contosopool* e *fabrikampool*, um*http*de [investigação](../virtual-machines/linux/create-cli-complete.md?toc=%2fazure%2fvirtual-network%2ftoc.json) - e suas regras de balanceamento de carga- *HTTPc* e *HTTPf*:
