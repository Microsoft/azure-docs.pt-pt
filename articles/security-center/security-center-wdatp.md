...
Para ver se a integração do Windows Defender ATP estiver ativada, selecione **Centro de segurança** > **preços & definições** > clique na sua subscrição.
