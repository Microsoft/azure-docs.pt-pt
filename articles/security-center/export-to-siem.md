...
- **Power BI**  -  [Ligue-se à API de Segurança do Gráfico da Microsoft no Power BI Desktop](https://docs.microsoft.com/power-bi/connect-data/desktop-connect-graph-security)
