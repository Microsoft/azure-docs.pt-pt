...
|Nuvens:|![Sim ](./media/icons/yes-icon.png) nuvens comerciais<br>![Sim ](./media/icons/yes-icon.png) Nacional/Soberano (Eua Gov, China Gov, Outro Gov)<br>Suportado apenas em regiões onde a Azure Automation está disponível.<br>![Sim ](./media/icons/yes-icon.png) [Azure Arc](../azure-arc/servers/overview.md) dispositivos habilitados.<br>Consulte [regiões apoiadas para o espaço de trabalho do Log Analytics ligado.](../automation/how-to/region-mappings.md)<br>[Saiba mais sobre o rastreio de mudanças.](../automation/change-tracking/overview.md)|
|||
