...
O Azure Security Center for IoT (Internet of Things) simplifica a proteção híbrida da carga de trabalho, proporcionando visibilidade e controlo unificados, prevenção de ameaças adaptativas e proteção e resposta inteligente de ameaças através de cargas de trabalho que funcionam no limite, no local, em Azure, e em outras nuvens. Para mais informações, consulte [o Centro de Segurança Azure para IoT](https://docs.microsoft.com/azure/asc-for-iot/).
