...
|\[Visualização]: Monitorar banco de dados SQL não criptografado na central de segurança do Azure|A central de segurança do Azure monitora servidores ou bancos de dados SQL não criptografados, conforme recomendado.|
|\[Visualização]: Monitorar banco de dados SQL não auditado na central de segurança do Azure|A central de segurança do Azure monitora os servidores SQL e os bancos de dados que não têm a auditoria do SQL ativada conforme recomendado.|
...
|\[Visualização]: Monitorar aplicativo Web desprotegido na central de segurança do Azure|A central de segurança do Azure monitora aplicativos Web que não têm proteção de firewall do aplicativo Web, conforme recomendado.|
...
|\[Visualização]: As contas externas com permissões de escrita devem ser removidas da sua subscrição|Contas externas que têm permissões de gravação devem ser removidas da sua assinatura para evitar acesso não monitorado.|
