---
title: Definições de política azure monitorizadas no Centro de Segurança Azure Microsoft Docs
description: Este artigo fornece uma lista de definições de Política Azure que você pode monitorizar no Azure Security Center.
...
Este artigo fornece uma lista de definições e iniciativas da [Política Azure](../governance/policy/overview.md) que pode monitorizar no Azure Security Center. Para obter mais informações sobre políticas de segurança, consulte [Trabalhar com políticas de segurança.](tutorial-security-policy.md)
