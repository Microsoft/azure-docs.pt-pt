---
title: Encriptação para a conta de armazenamento do Azure no Centro de segurança do Azure | Documentos da Microsoft
...
ms.locfileid: "64696074"
---
# <a name="encryption-for-azure-storage-account-in-azure-security-center"></a>Encriptação para a conta de armazenamento do Azure no Centro de segurança do Azure

Encriptação de armazenamento do Azure para dados Inativos está ativada por predefinição para todas as contas de armazenamento do Azure. O armazenamento do Azure encripta os dados quando ele é escrito para o armazenamento do Azure e descriptografa-a antes de obtenção. Para obter mais informações, consulte [encriptação do armazenamento do Azure para dados Inativos](../storage/common/storage-service-encryption.md).
