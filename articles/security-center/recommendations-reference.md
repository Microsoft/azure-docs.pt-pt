...
As recomendações do Centro de Segurança baseiam-se no [Benchmark de Segurança Azure.](https://docs.microsoft.com/security/benchmark/azure/introduction)
