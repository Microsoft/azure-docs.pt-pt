...
[Criptografar uma VM IaaS do Windows com o Azure PowerShell](../security/azure-disk-encryption-linux-powershell-quickstart.md) orienta você durante essas etapas. Este tópico pressupõe que você esteja usando um computador cliente Windows do qual você configura a criptografia de disco.
