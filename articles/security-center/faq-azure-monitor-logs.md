...
Se um VM já tiver o Agente de Monitorização da Microsoft instalado como uma extensão Azure, o Security Center não sobrepor-se à ligação existente no espaço de trabalho. Em vez disso, o Centro de Segurança usa o espaço de trabalho existente. O VM será protegido desde que a solução "Security" ou "SecurityCenterFree" tenha sido instalada no espaço de trabalho para o qual está a reportar. 
...
Se um VM já tiver o Agente de Monitorização da Microsoft instalado como uma extensão Azure, o Security Center utiliza o espaço de trabalho conectado existente. Uma solução De Centro de Segurança está instalada no espaço de trabalho se ainda não estiver presente, e a solução é aplicada apenas aos VMs relevantes através [de uma solução direcionada](../operations-management-suite/operations-management-suite-solution-targeting.md).

Quando o Security Center instala o Agente de Monitorização da Microsoft em VMs, utiliza o espaço de trabalho predefinido criado pelo Security Center.
