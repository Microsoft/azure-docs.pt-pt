...
Se um VM já tiver o agente Log Analytics instalado como uma extensão Azure, o Security Center utiliza o espaço de trabalho ligado existente. Uma solução do Centro de Segurança é instalada no espaço de trabalho se ainda não estiver presente, e a solução é aplicada apenas aos VM relevantes através de [uma solução de orientação.](../azure-monitor/insights/solution-targeting.md)
