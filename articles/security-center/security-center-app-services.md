...
## <a name="enable-monitoring-and-protection-of-app-service"></a>Permitir a monitorização e proteção do Serviço de Aplicações
...
* [Blogue de Segurança do Azure](https://docs.microsoft.com/archive/blogs/azuresecurity/): encontre publicações no blogue acerca da segurança e conformidade do Azure.
