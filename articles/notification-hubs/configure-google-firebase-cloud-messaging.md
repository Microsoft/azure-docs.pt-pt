...
O procedimento a seguir dá-lhe passos para configurar as definições de Mensagens Cloud (FCM) do Google Firebase para um centro de notificação: 
...
Para um tutorial com instruções passo a passo para empurrar notificações para dispositivos Android utilizando os Hubs de Notificação do Azure e mensagens cloud do Google Firebase, consulte [notificações Push para dispositivos Android utilizando Os Centros de Notificação e Google FCM](notification-hubs-android-push-notification-google-fcm-get-started.md).
