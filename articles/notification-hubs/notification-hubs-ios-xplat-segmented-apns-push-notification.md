---
title: Envie notificações push para dispositivos iOS específicos usando hubs de notificação Azure | Microsoft Docs
...
5. Adicione a seguinte diretiva de importação às notificações.m:
