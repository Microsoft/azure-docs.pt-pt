...
ms.locfileid: "96001359"
---
# <a name="tutorial-send-push-notifications-to-ios-apps-using-azure-notification-hubs-version-204"></a>Tutorial: Enviar notificações push para aplicações iOS usando Hubs de Notificação Azure (versão 2.0.4)
...
9. Abra o ficheiro **Constants.m** e substitua o seu conteúdo pelo seguinte código. Substitua os espaços reservados literais de cadeia `NotificationHubConnectionString` e o nome do hub e o `NotificationHubConnectionString` **DefaultListdAccessssignature,** respectivamente, tal como obteve anteriormente a partir do portal:
...
10. Abra o seu ficheiro **AppDeegate.h** do seu projeto e substitua o seu conteúdo pelo seguinte código:
...
11. No ficheiro **appDeegate .m** projeto, adicione as `import` seguintes declarações:
