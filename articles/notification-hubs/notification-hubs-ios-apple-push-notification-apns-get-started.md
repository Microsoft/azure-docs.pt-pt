...
8. No arquivo `AppDelegate.m`, adicione o código a seguir no método `didFinishLaunchingWithOptions` com base na sua versão do iOS. Este código regista o seu identificador de dispositivo com APNs:
