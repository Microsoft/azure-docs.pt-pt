...
3. Atualize os seguintes três valores para a sua nova aplicação e, em seguida, **selecione Continue** :
   ...
   - **Notificações push** : Verifique a opção **De Notificações Push** na secção **Capacidades.**
      ...
      :::image type="content" source="media/ios-sdk-get-started/image8.png" alt-text="Screenshot que destaca o Pedido de Um Certificado a partir de uma opção de menu da Autoridade de Certificado.":::
...
1. Desloque-se até à opção **de Notificações push verificadas** e, em seguida, selecione **Configure** para criar o certificado.
   ...
   :::image type="content" source="media/ios-sdk-get-started/image9.png" alt-text="Screenshot que destaca o Pedido de Um Certificado a partir de uma opção de menu da Autoridade de Certificado.":::
...
2. Aparece a janela **SSL Certificates do serviço de notificação apple push.** Selecione o botão **'Criar Certificado'** na secção **Certificado SSL de Desenvolvimento.**
   ...
   :::image type="content" source="media/ios-sdk-get-started/image10.png" alt-text="Screenshot que destaca o Pedido de Um Certificado a partir de uma opção de menu da Autoridade de Certificado.":::
...
4. Depois de o portal criar o certificado, selecione o botão **Descarregar.** Guarde o certificado e lembre-se do local para o qual está guardado.
   ...
   :::image type="content" source="media/ios-sdk-get-started/image11.png" alt-text="Screenshot que destaca o Pedido de Um Certificado a partir de uma opção de menu da Autoridade de Certificado.":::
...
2. Selecione **todos os serviços** no menu esquerdo e, em seguida, selecione **'Centros de Notificação'** na secção **Mobile.** Selecione o ícone estrela ao lado do nome de serviço para adicionar o serviço à secção **FAVORITOS** no menu esquerdo. Depois de adicionar **Os Centros de Notificação** aos **FAVORITOS,** selecione-o.
   ...
   :::image type="content" source="media/ios-sdk-get-started/image18.png" alt-text="Screenshot que destaca o Pedido de Um Certificado a partir de uma opção de menu da Autoridade de Certificado.":::

3. Na página **'Centros de Notificação',** selecione **Adicionar** na barra de ferramentas.

   :::image type="content" source="media/ios-sdk-get-started/image19.png" alt-text="Screenshot que destaca o Pedido de Um Certificado a partir de uma opção de menu da Autoridade de Certificado.":::
...
6. Selecione **Políticas de Acesso** na lista. Note que as duas cordas de ligação estão disponíveis para si. Vai precisar deles mais tarde para lidar com notificações push.
   ...
   :::image type="content" source="media/ios-sdk-get-started/image22.png" alt-text="Screenshot que destaca o Pedido de Um Certificado a partir de uma opção de menu da Autoridade de Certificado.":::
