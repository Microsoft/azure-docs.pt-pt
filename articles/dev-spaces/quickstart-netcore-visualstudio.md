...
ms.date: 11/13/2019
ms.topic: quickstart
description: Este guia de início rápido mostra como usar Azure Dev Spaces e o Visual Studio para depurar e iterar rapidamente um aplicativo .NET Core no serviço kubernetes do Azure
