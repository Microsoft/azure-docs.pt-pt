...
Use o comando `use-dev-spaces` para habilitar espaços de desenvolvimento em seu cluster AKS e siga os prompts.
...
1. Iniciar sessão no [portal do Azure][az-portal].
