...
ms.date: 12/09/2018
ms.topic: tutorial
description: Este tutorial mostra como usar Azure Dev Spaces e o Visual Studio para fazer o desenvolvimento em equipe em um aplicativo .NET Core no serviço kubernetes do Azure
