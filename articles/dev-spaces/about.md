...
ms.date: 05/07/2019
ms.topic: overview
description: Saiba como Azure Dev Spaces fornece uma experiência de desenvolvimento kubernetes rápida e iterativa para equipes em clusters do serviço kubernetes do Azure
