---
title: 'Executar vários serviços dependentes: Java & Visual Studio Code'
services: azure-dev-spaces
ms.date: 11/21/2018
ms.topic: tutorial
description: Este tutorial mostra-lhe como usar o Azure Dev Spaces e o Visual Studio Code para desbugiar uma aplicação Java multi-serviço no Serviço Azure Kubernetes
...
ms.locfileid: "75438336"
---
# <a name="running-multiple-dependent-services-java-and-visual-studio-code-with-azure-dev-spaces"></a>Executar vários serviços dependentes: Java e Visual Studio Code com Espaços Azure Dev
...
1. Prima F5 e aguarde que o serviço seja criado e implementado. Saberá que está pronto quando uma mensagem semelhante à abaixo aparecer na consola de depuração:
...
1. Definir um ponto `index()` de rutura `mywebapi` no método do projeto, na [linha 19 de `Application.java` ](https://github.com/Azure/dev-spaces/blob/master/samples/java/getting-started/mywebapi/src/main/java/com/ms/sample/mywebapi/Application.java#L19)
...
> [Conheça o desenvolvimento de equipas em Espaços Dev](team-development-java.md)
