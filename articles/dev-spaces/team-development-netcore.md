---
title: Desenvolvimento de equipas usando .NET Core e Visual Studio Code
services: azure-dev-spaces
ms.date: 07/09/2018
ms.topic: tutorial
description: Este tutorial mostra-lhe como usar Azure Dev Spaces e Visual Studio Code para fazer desenvolvimento de equipa numa aplicação .NET Core no Serviço Azure Kubernetes
...
ms.locfileid: "87013614"
---
# <a name="team-development-using-net-core-and-visual-studio-code-with-azure-dev-spaces"></a>Desenvolvimento de equipas usando .NET Core e Visual Studio Code com Azure Dev Spaces
...
![Um diagrama mostrando um espaço simples dev.](media/common/ci-cd-space-setup.png)
...
Vá à janela do Código VS `mywebapi` e faça uma edição de código para o `string Get(int id)` método `Controllers/ValuesController.cs` em, por exemplo:
