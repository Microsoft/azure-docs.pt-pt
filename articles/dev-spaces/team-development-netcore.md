---
title: Desenvolvimento de equipa usando .NET Core e Visual Studio Code
services: azure-dev-spaces
ms.date: 07/09/2018
ms.topic: tutorial
description: Este tutorial mostra-lhe como usar o Azure Dev Spaces e o Visual Studio Code para fazer o desenvolvimento da equipa numa aplicação .NET Core no Serviço Azure Kubernetes
...
ms.locfileid: "78251970"
---
# <a name="team-development-using-net-core-and-visual-studio-code-with-azure-dev-spaces"></a>Desenvolvimento de equipa utilizando .NET Core e Visual Studio Code com Espaços Azure Dev
...
Vá à janela do Código VS para `mywebapi` e faça uma edição de código para o método `string Get(int id)` em `Controllers/ValuesController.cs`, por exemplo:
