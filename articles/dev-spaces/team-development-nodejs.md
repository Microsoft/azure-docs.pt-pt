---
title: Desenvolvimento de equipas usando Node.js e Código de Estúdio Visual
services: azure-dev-spaces
ms.date: 07/09/2018
ms.topic: tutorial
description: Este tutorial mostra-lhe como usar Azure Dev Spaces e Visual Studio Code para fazer desenvolvimento de equipa em uma aplicação de Node.js no Serviço Azure Kubernetes
...
ms.locfileid: "87420367"
---
# <a name="team-development-using-nodejs-and-visual-studio-code-with-azure-dev-spaces"></a>Desenvolvimento de equipas usando Node.js e Código de Estúdio Visual com Espaços Azure Dev
...
Vá à janela do Código VS `mywebapi` e faça uma edição de código para o manipulador GET padrão `/` em , por `server.js` exemplo:
