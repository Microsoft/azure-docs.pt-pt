...
ms.date: 07/08/2019
ms.topic: quickstart
description: Este guia de início rápido mostra como usar Azure Dev Spaces e a linha de comando para desenvolver um aplicativo no serviço kubernetes do Azure
