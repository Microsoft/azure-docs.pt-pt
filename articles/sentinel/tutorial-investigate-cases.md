...
- Só poderá investigar o incidente se utilizar os campos de mapeamento da entidade quando configurar a sua regra de análise. O gráfico de investigação requer que o incidente original inclua entidades.
