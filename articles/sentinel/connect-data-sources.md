...
- **Serviço à integração de serviços:**<br> Alguns serviços estão ligados de forma nativa, como os serviços AWS e Microsoft, estes serviços alavancam a fundação Azure para integração fora da caixa, as seguintes soluções podem ser conectadas em alguns cliques:
    ...
    - [Proteção avançada de ameaças azure](connect-azure-atp.md)
    - [Azure Information Protection](connect-azure-information-protection.md)
    - [Centro de Segurança do Azure](connect-azure-security-center.md)
    - [Segurança de aplicativos em nuvem](connect-cloud-app-security.md)
    - [Servidor de nome de domínio](connect-dns.md)
    - [Office 365](connect-office-365.md)
    - [Microsoft Defender ATP](connect-microsoft-defender-advanced-threat-protection.md)
    - [Firewall de aplicação web da Microsoft](connect-microsoft-waf.md)
...
- **Soluções externas via API**: Algumas fontes de dados estão ligadas utilizando APIs fornecidas pela fonte de dados conectada. Tipicamente, a maioria das tecnologias de segurança fornecem um conjunto de APIs através dos quais os registos de eventos podem ser recuperados. As APIs ligam-se ao Azure Sentinel e recolhem tipos de dados específicos e enviam-nos para o Azure Log Analytics. Os aparelhos ligados via API incluem:
    ...
    - [Ponto de força DLP](connect-forcepoint-dlp.md)
...
## Opções de ligação de agente<a name="agent-options"></a>
...
## <a name="map-data-types-with-azure-sentinel-connection-options"></a>Tipos de dados de mapas com opções de conexão Azure Sentinel
...
| AuditLogs | [Ligar AD Azure](connect-azure-active-directory.md)  | V | |
| SigninLogs | [Ligar AD Azure](connect-azure-active-directory.md)  | V | |
| AzureFirewall |[Diagnóstico do Azure](../firewall/tutorial-diagnostics.md) | V | |
| InformationProtectionLogs_CL  | [Relatórios de Proteção de Informação azure](https://docs.microsoft.com/azure/information-protection/reports-aip)<br>[Conectar proteção de informação azure](connect-azure-information-protection.md)  | V | Isto normalmente utiliza a função **InformationProtectionEvents** para além do tipo de dados. Para mais informações, consulte [Como modificar os relatórios e criar consultas personalizadas](https://docs.microsoft.com/azure/information-protection/reports-aip#how-to-modify-the-reports-and-create-custom-queries)|
...
| Atividade do Escritório | [Connect Office 365](connect-office-365.md) | V | |
| Eventos de Segurança | [Conecte eventos de segurança do Windows](connect-windows-security-events.md)  | V | Para os livros de trabalho inseguros protocolos, consulte a configuração do livro de [protocolos inseguros](/azure/sentinel/quickstart-get-visibility#use-built-in-workbooks)  |
| Syslog | [Ligar slog](connect-syslog.md) | V | |
...
| Indicador de Inteligência de Ameaças  | [Ligar a inteligência da ameaça](connect-threat-intelligence.md)  | V | |
...
| Alerta de segurança AATP  | [Ligue atp azure](connect-azure-atp.md) | V | |
| Alerta de Segurança ASC  | [Connect Azure Security Center](connect-azure-security-center.md)  | V | |
...
| ConfigurationData  | [Automatizar inventário VM](../automation/automation-vm-inventory.md)| X | |
| ConfigurationChange  | [Automatizar o rastreio vm](../automation/change-tracking.md) | X | |
| F5 BIG-IP | [Ligar F5 BIG-IP](https://devcentral.f5.com/s/articles/Integrating-the-F5-BIGIP-with-Azure-Sentinel)  | X | |
| McasShadowItReporting  |  | X | |
| Barracuda_CL | [Ligar Barracuda](connect-barracuda.md) | V | |
