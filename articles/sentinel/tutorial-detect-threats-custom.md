...
- Aqui está outra consulta de amostra, que o alertaria quando um número anómalo de recursos é criado na [Atividade Azure](../azure-monitor/platform/activity-log.md).
