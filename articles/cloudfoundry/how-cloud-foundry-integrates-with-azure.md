...
A boa novidade é que [a Azure Availability Zone](https://docs.microsoft.com/azure/availability-zones/az-overview ) é lançada agora, elevando a tolerância à falha para o próximo nível, com baixa redundância de latência em todos os centros de dados.
...
Clique [aqui](https://docs.microsoft.com/azure/cloudfoundry/cloudfoundry-oms-nozzle) para aprender a implementar o Azure Log Analytics Nozzle para o ambiente Open Source e Pivotal Cloud Foundry e, em seguida, aceda aos dados a partir da consola de registos Azure Monitor. 
> [!NOTE]
