...
Especifique a assinatura para sua conta de armazenamento do Azure e, em seguida, selecione sua conta de armazenamento.  Especifique o contêiner de armazenamento e o caminho do diretório para o qual você deseja que o arquivo de exportação vá.  Clique em **Seguinte**.
...
A nova exportação é apresentada na lista de exportações. Por padrão, novas exportações são habilitadas. Se pretender desativar ou eliminar uma exportação agendada, clique em qualquer item na lista e, em seguida, clique em **Desativar** ou **Eliminar**.
...
![Página conta de armazenamento mostrando informações de exemplo e link para abrir no Explorer](./media/tutorial-export-acm-data/storage-account-page.png)
...
![Informações de exemplo mostradas em Gerenciador de Armazenamento](./media/tutorial-export-acm-data/storage-explorer.png)
