...
| Alert type | Enterprise Agreement | Contrato de Cliente Microsoft | Web direct/Pay-As-You-Go |
|---|---|---|---|
| Budget | ✔ | ✔ | ✔ |
| Credit | ✔ |✘ | ✘ |
...
When you view the details of a dismissed alert, you can reactivate it if manual action is needed. A imagem seguinte mostra um exemplo.
