...
Proxy de aplicações é recomendado para fornecer aos usuários remotos acesso aos recursos internos. Proxy da aplicação substitui a necessidade de uma VPN ou o proxy inverso. Não se destina para usuários internos na rede empresarial.  Estes utilizadores que utilizam desnecessariamente o Proxy de aplicações podem introduzir problemas de desempenho inesperados e indesejáveis.
