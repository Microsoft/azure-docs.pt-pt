---
title: Crie & publique documentação única de inscrição para a sua aplicação
...
[Liste a sua candidatura na Galeria de Aplicações AD Azure](https://docs.microsoft.com/Azure/active-directory/develop/howto-app-gallery-listing)
