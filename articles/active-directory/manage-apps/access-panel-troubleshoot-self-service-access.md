---
title: Problema na utilização do acesso a aplicações self-service / Microsoft Docs
description: Problemas relacionados com o acesso a aplicações de autosserviço
...
ms.locfileid: "84760920"
---
# <a name="problem-using-self-service-application-access"></a>Problema na utilização do acesso a aplicações self-service
...
-   Certifique-se de que o acesso à aplicação de autosserviço está configurado corretamente. Consulte "Como configurar o acesso à aplicação de autosserviço".

-   Certifique-se de que o utilizador ou grupo foi habilitado a solicitar o acesso à aplicação de autosserviço.

-   Certifique-se de que o utilizador está a visitar o local correto para o acesso à aplicação de autosserviço. os utilizadores podem navegar para o seu Painel de Acesso à [Aplicação](https://myapps.microsoft.com/) e clicar no botão **+Adicionar** para encontrar as aplicações às quais permitiu o acesso ao self-service.
...
## <a name="how-to-configure-self-service-application-access"></a>Como configurar o acesso a aplicações self-service
