...
ms.locfileid: "103198245"
---
# <a name="header-based-single-sign-on-for-on-premises-apps-with-azure-ad-app-proxy"></a>Sign-on único baseado em cabeçalho para aplicativos no local com Proxy app AD app Azure
