...
Quando a resolução de problemas de Proxy de aplicações, recomendamos que comece por ler o fluxo de resolução de problemas [conector de Proxy de aplicações de depurar problemas](application-proxy-debug-connectors.md), para determinar se os conectores de Proxy de aplicações estão configuradas corretamente. Se ainda estiver a ter problemas em ligar à aplicação, siga o fluxo de resolução de problemas na [Proxy de aplicações de depurar problemas de aplicativos](application-proxy-debug-apps.md).
...
| O conector não conseguiu ligar ao serviço devido a problemas de rede. O conector tentou aceder ao URL seguinte. | O conector não conseguiu ligar ao serviço Proxy de aplicações na cloud. Isto pode acontecer se tiver uma regra de firewall a bloquear a ligação. Certifique-se de que tem permissão para aceder às portas corretas e URLS listados na [pré-requisitos do Proxy de aplicações](application-proxy-add-on-premises-application.md#prepare-your-on-premises-environment). |
...
| Não é possível aceder esta aplicação empresarial. Não está autorizado a aceder a esta aplicação. Falha na autorização. Certifique-se de atribuir o utilizador com acesso a esta aplicação. | O utilizador pode obter este erro ao tentar aceder à aplicação que publicou se utilizarem contas da Microsoft em vez da respetiva conta empresarial para iniciar sessão. Os utilizadores convidados também podem obter este erro. Os utilizadores da Microsoft Account e convidados não é possível aceder a aplicações de IWA. Certifique-se de que o utilizador inicia sessão com a respetiva conta empresarial que corresponda ao domínio do aplicativo publicado.<br><br>Pode não ter atribuída ao utilizador para esta aplicação. Vá para o **aplicativo** separador e, em **utilizadores e grupos**, atribuir este utilizador ou grupo de utilizadores a esta aplicação. |
| Esta aplicação empresarial não é possível aceder neste momento. Tente novamente mais tarde... O conector excedeu o tempo limite. | O utilizador pode obter este erro ao tentar aceder à aplicação que publicou se elas ainda não estão corretamente definidas para esta aplicação no lado no local. Certifique-se de que os utilizadores têm as permissões adequadas, conforme definido para esta aplicação de back-end na máquina no local. |
| Não é possível aceder esta aplicação empresarial. Não está autorizado a aceder a esta aplicação. Falha na autorização. Certifique-se de que o utilizador tem uma licença do Azure Active Directory Premium ou Basic. | O utilizador pode obter este erro ao tentar aceder à aplicação que publicou se eles não foram explicitamente atribuídos com uma licença Premium/Basic pelo administrador do subscritor. Vá para Active Directory o subscritor **licenças** separador e certifique-se de que este utilizador ou grupo de utilizadores é atribuído uma licença Premium ou Basic. |
| Não foi possível encontrar um servidor com o nome de anfitrião especificado. | O utilizador pode obter este erro ao tentar aceder à aplicação que publicou se o domínio personalizado da aplicação não está configurado corretamente. Certifique-se de ter carregado um certificado para o domínio e configurado o registo DNS corretamente ao seguir os passos no [trabalhar com domínios personalizados no Proxy de aplicações do Azure AD](application-proxy-configure-custom-domain.md) |
