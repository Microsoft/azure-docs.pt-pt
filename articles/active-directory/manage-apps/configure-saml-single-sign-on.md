---
title: Configurar um único sign-on (SSO) baseado em SAML para aplicações em Azure AD
description: Configurar um único sign-on (SSO) baseado em SAML para aplicações em Azure AD
