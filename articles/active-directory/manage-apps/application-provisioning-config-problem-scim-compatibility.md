...
As alterações são aplicadas a todas as novas [aplicações SCIM não-galeria](configure-single-sign-on-non-gallery-applications.md) configuradas no portal Azure, após a data da correção.
