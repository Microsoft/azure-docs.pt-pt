...
description: Saiba como utilizar o PingAccess para alargar os benefícios do Application Proxy a aplicações que utilizam a autenticação baseada em cabeçalhos
...
Para configurar uma aplicação com PingAccess, existem quatro passos:

1.  Configurar conectores de procuração de aplicações

2.  Criar uma aplicação de procuração de aplicação AD Azure

3.  Baixar & Configurar PingAccess
