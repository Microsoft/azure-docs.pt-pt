---
title: Nenhum usuário está sendo provisionado para um aplicativo da galeria do Azure AD
...
- Foi **configurado um filtro de escopo** **que está filtrando o usuário com base em um valor de atributo**. Para obter mais informações sobre filtros de escopo, consulte [filtros de escopo](define-conditional-rules-for-provisioning-user-accounts.md).
...
[Sincronização de Azure AD Connect: Noções básicas sobre provisionamento declarativo](../hybrid/concept-azure-ad-connect-sync-declarative-provisioning.md)
