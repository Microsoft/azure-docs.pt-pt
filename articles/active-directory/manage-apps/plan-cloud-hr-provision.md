...
- **Aplicativo de RH de nuvem para Active Directory provisionamento de usuário**: esse aplicativo do conector de provisionamento facilita o provisionamento de contas de usuário do aplicativo de RH na nuvem para um único domínio de Active Directory. Se você tiver vários domínios, poderá adicionar uma instância desse aplicativo da Galeria de aplicativos do Azure AD para cada domínio de Active Directory ao qual você precisa provisionar.
