...
Cada uma destas opções pode ser encontrada ao aceder ao seu aplicativo no "Aplicações empresariais" e abrir o **Single Sign-On** página no menu da esquerda. Note que se a sua aplicação foi criada no portal antigo, poderá não ver todas estas opções.
