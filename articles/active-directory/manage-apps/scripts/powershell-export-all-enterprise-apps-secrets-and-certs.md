...
Este exemplo de script PowerShell exporta todos os segredos e certificados para as aplicações empresariais especificadas do seu diretório para um ficheiro CSV.
