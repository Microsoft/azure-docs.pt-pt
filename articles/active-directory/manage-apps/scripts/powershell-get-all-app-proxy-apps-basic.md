...
Este exemplo de script PowerShell lista informações sobre todas as aplicações de procuração de aplicações Azure Ative (Azure AD), incluindo o ID de aplicação (AppId), nome (DisplayName) e ID de objeto (ObjId).
