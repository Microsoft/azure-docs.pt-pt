---
title: Amostra PowerShell - Atribuir o utilizador a uma aplicação proxy de aplicação
description: Exemplo powerShell que atribui um utilizador a uma aplicação de proxy de aplicação azure Ative Directory (Azure AD).
