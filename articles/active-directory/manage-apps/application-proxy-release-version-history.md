...
Compreender os conectores de Proxy de aplicações do Azure AD | Obter mais informações sobre [gestão do conector](application-proxy-connectors.md) e como conectores de atualização automática.
