...
|Test-ADFSRPDelegationAuthorizationRules      | Aprovado/Reprovado          | O pedido tem regras de autorização de delegação personalizadas definidas. Este é um conceito WS-Trust que a Azure AD suporta utilizando protocolos de autenticação modernos, como o OpenID Connect e o OAuth 2.0. [Saiba mais sobre a Plataforma de Identidade da Microsoft.](https://docs.microsoft.com/azure/active-directory/develop/v2-protocols-oidc)          |
