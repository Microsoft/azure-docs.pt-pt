...
Os membros podem convidar | Os membros podem convidar A Definição desta opção para Sim permite que membros não administrativos do seu diretório convidem os hóspedes. Consulte [os convites do Delegado para a colaboração B2B](../external-identities/delegate-invitations.md#configure-b2b-external-collaboration-settings) para saber mais.
