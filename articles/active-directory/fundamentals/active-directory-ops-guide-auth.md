...
- [Referência de Azure Ative Directory API](/graph/api/resources/directoryaudit)
- [Azure Ative Directory relatório de atividades API referência](/graph/api/resources/signin)
