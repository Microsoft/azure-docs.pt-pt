---
title: Autenticação multi-factor Azure para a sua organização - Azure Ative Directory
...
Existem várias formas de ativar a autenticação multi-factor Azure para os seus utilizadores do Azure Ative Directory (AD) com base nas licenças que a sua organização possui. 
