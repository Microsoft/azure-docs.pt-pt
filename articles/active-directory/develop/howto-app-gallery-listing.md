...
Este artigo mostra como listar uma aplicação na Galeria de aplicações do Azure AD, implementar o início de sessão único (SSO) e gerir a lista.
