...
## <a name="deleted-applications-ui--preview"></a>Aplicações eliminadas UI | previsualizar
...
- [Adicionar uma aplicação](quickstart-register-app.md)
