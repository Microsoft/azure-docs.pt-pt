...
O ponto final da [plataforma de identidade da Microsoft](active-directory-v2-compare.md) suporta os protocolos OAuth 2.0 e OpenID Connect 1.0 padrão da indústria. A Microsoft Authentication Library (MSAL) foi concebida para funcionar com o ponto final da plataforma de identidade da Microsoft. Também pode utilizar bibliotecas de código aberto que suportam OAuth 2.0 e OpenID Connect 1.0.
...
* [Crie um pedido de suporte](https://docs.microsoft.com/azure/azure-portal/supportability/how-to-create-azure-support-request) se encontrar um problema em que o ponto final da plataforma de identidade da Microsoft não esteja em conformidade com o OAuth 2.0 ou o OpenID Connect 1.0.
