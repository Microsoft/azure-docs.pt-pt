...
Os métodos para a experiência pop-up (`loginPopup`, `acquireTokenPopup`) retornam promessas, para que você possa usar o padrão Promise (. then e. catch) para tratá-los, conforme mostrado:
