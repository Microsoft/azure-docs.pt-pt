...
| ---------- | ----------- | ---------------- |
| **Tipos de contas** | | |
| Trabalho da Microsoft ou contas escolares | Suportadas | Suportadas |
...
| Contas da Microsoft para uso pessoal | Suportadas | Suportado através do protocolo Azure AD v2.0 OAuth, mas não sobre quaisquer outros protocolos | 
| Contas facebook, Google, Yahoo | Suportadas | Não apoiado |
| **Protocolos e compatibilidade sdk** | | |
| WIF | Suportadas | Apoiadas, mas instruções limitadas estão disponíveis |
...
| **Formatos simbólicos** | | |
| JWT | Suportado em Beta | Suportadas |
...
| Faça upload de certificados de assinatura de token personalizados | Suportadas | Suportadas |
...
| ---------- | ----------- | ---------------- |
| **Tipos de contas** | | |
| Trabalho da Microsoft ou contas escolares | Suportadas | Suportado através de políticas personalizadas  |
...
| Contas facebook, Google, Yahoo | Suportadas | Facebook e Google suportados de forma nativa, Yahoo suportado através da federação OpenID Connect usando políticas personalizadas |
| **Protocolos e compatibilidade sdk** | | |
...
| Faça upload de certificados de assinatura de token personalizados | Suportadas | Chaves de assinatura personalizadas, não certificados, suportadas através de políticas personalizadas |
