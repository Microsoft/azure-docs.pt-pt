...
> [Como lidar com as alterações de cookies SameSite no navegador Chrome](howto-handle-samesite-cookie-changes-chrome-browser.md)
...
Depois de a sua aplicação web assinar nos utilizadores, pode ligar para apis web em nome dos utilizadores inscritos. Chamar APIs da web app é o objeto do seguinte cenário:
