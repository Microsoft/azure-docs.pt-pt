...
Para novos aplicativos Web, recomendamos que você use a plataforma de identidade da Microsoft (v 2.0) e o MSAL para adquirir tokens e acessar APIs da Web protegidas. Consulte [início rápido: Adicionar entrada com a Microsoft a um aplicativo web ASP.net](quickstart-v2-aspnet-webapp.md) para começar.
