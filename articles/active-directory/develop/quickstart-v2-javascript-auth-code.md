...
> [Tutorial para iniciar sincê-lo e ligar para o MS Graph >](https://docs.microsoft.com/azure/active-directory/develop/tutorial-v2-javascript-auth-code)
