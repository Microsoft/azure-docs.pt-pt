...
> [!NOTE]
> Os id_token v1.0 e v22.0 têm diferenças na quantidade de informação que transportarão, como se pode ver nos exemplos acima referidos. A versão especifica essencialmente o ponto final da plataforma Azure AD a partir do local onde foi emitida. [A implementação da Azure AD OAuth](about-microsoft-identity-platform.md) tem evoluído ao longo dos anos. Atualmente existem dois pontos finais outh diferentes para aplicações AD Azure. Pode utilizar qualquer um dos novos pontos finais que são classificados como v2.0 ou v1.0. Os pontos finais da OAuth para ambos são diferentes. O ponto final v2.0 é mais recente e as características do ponto final v1.0 estão a ser migradas para este ponto final. Os novos desenvolvedores devem utilizar o ponto final v2.0.
>
> - v1.0: Pontos finais Azure AD:`https://login.microsoftonline.com/common/oauth2/authorize`
> - v2.0: Pontos finais da Microsoft identitypPlatform:`https://login.microsoftonline.com/common/oauth2/v2.0/authorize`
