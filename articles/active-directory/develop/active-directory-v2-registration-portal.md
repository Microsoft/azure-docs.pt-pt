...
ms.locfileid: "68835229"
---
# <a name="app-registration-reference"></a>Referência de registo de aplicação
Este documento fornece contexto e descrições de vários recursos encontrados no [portal de registro de aplicativos](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/).

> [!NOTE]
> Não ofereceremos mais suporte ao registro e gerenciamento de aplicativos convergidos e do Azure AD no [portal de registro de aplicativos](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/) a partir de maio de 2019. Recomendamos que você gerencie seus aplicativos existentes e registre novos aplicativos usando a experiência de [registros de aplicativo](https://aka.ms/appregistrations) no portal do Azure.

## <a name="my-applications-or-converged-applications"></a>Meus aplicativos ou aplicativos convergidos
Esta lista contém todos os seus aplicativos registrados para uso com o ponto de extremidade v 2.0 do Azure AD. Esses aplicativos têm a capacidade de conectar usuários com contas da Microsoft pessoais e contas corporativas/de estudante da Azure Active Directory. Para saber mais sobre o ponto de extremidade v 2.0 do Azure AD, consulte a [visão geral do v 2.0](active-directory-appmodel-v2-overview.md). Esses aplicativos também podem ser usados para integrar com o ponto de extremidade de `https://login.live.com`autenticação conta Microsoft,.
...
Esta lista contém todos os seus aplicativos registrados para uso exclusivo com conta Microsoft. Eles não estão habilitados para uso com Azure Active Directory. É aí que você encontra todos os aplicativos que foram registrados anteriormente com o portal do desenvolvedor `https://account.live.com/developers/applications`MSA em. Todas as funções que você executou `https://account.live.com/developers/applications` anteriormente em agora podem ser executadas nesse novo portal `https://apps.dev.microsoft.com`,.
...
Se você já planeja usar o ponto de extremidade v 2.0 do Azure AD, você pode desabilitar com segurança o suporte ao Live SDK.
