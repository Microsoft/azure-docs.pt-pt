...
Para uma visão geral de vídeo da plataforma e uma demonstração da experiência de autenticação, veja [qual é a plataforma de identidade da Microsoft para programadores?](https://youtu.be/uDU1QTSw7Ps)
