...
ms.locfileid: "73905514"
---
# <a name="get-and-remove-accounts-from-the-token-cache-using-msal-for-java-msal4j"></a>Obter e remover contas do cache de token usando MSAL para Java (MSAL4j)

O MSAL4J fornece um cache de token na memória por padrão. O cache de token na memória dura a duração da instância do aplicativo.
