...
6. Abra o [Explorador do Azure ad Graph](https://developer.microsoft.com/graph/graph-explorer) em outra janela e execute as seguintes etapas:
...
1. Abra o [Explorador do Azure ad Graph](https://developer.microsoft.com/graph/graph-explorer).
...
1. Abra o [Explorador do Azure ad Graph](https://developer.microsoft.com/graph/graph-explorer) em outra janela.
