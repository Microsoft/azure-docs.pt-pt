...
| identificador exclusivo não-reproduzido | `identifier`                                                 | `homeAccountId` | N/A                            |
| Nenhuma ID de conta conhecida               | Consultar todas as contas por meio da API `allAccounts:` no `MSALPublicClientApplication` | N/A             | N/A                            |
