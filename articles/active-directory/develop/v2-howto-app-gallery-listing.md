...
Se estiver a implementar um ponto final [SCIM](../app-provisioning/use-scim-to-provision-users-and-groups.md) 2.0 para o provisionamento do utilizador, selecione a opção como mostrado. 
