...
The act of granting an authenticated security principal permission to do something. Existem dois casos de utilização principais no modelo de programação do Azure AD:
