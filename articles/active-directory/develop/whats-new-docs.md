...
- [Quickstart: Proteja uma API web core ASP.NET com plataforma de identidade microsoft](quickstart-v2-aspnet-core-web-api.md)
...
- [Tutorial: Inscreva-se nos utilizadores e ligue para a Microsoft Graph API a partir de uma aplicação Android](tutorial-v2-android.md)
- [Uma aplicação web que chama APIs web: configuração de código](scenario-web-app-call-api-app-configuration.md)
- [Uma aplicação web que chama APIs web: Ligue para uma API web](scenario-web-app-call-api-call-api.md)
...
- [Inscreva-se nos utilizadores e ligue para o Microsoft Graph a partir de uma aplicação para iOS ou macOS](tutorial-v2-ios.md)
- [Quickstart: Ligue para uma API web ASP.NET protegida pela plataforma de identidade da Microsoft](quickstart-v2-dotnet-native-aspnet.md)
...
- [Considerações para a utilização de Xamarin iOS com MSAL.NET](msal-net-xamarin-ios-considerations.md)
