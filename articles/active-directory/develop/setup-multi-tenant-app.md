...
- Obter uma compreensão geral do [como configurar a aplicação de multi-inquilino](https://docs.microsoft.com/azure/active-directory/develop/howto-convert-app-to-be-multi-tenant)
