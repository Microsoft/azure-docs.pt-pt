...
Os métodos de redirecionamento não devolvem uma promessa por causa da mudança para longe da aplicação principal. Para processar e aceder às fichas devolvidas, registe retornos de sucesso e erro antes de ligar para os métodos de redirecionamento.
