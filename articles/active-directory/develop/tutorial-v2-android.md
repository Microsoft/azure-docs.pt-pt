...
3. Na **aplicação** > **src** > **main** > **res** > **raw**, `auth_configbn_single_account.json` crie um novo ficheiro JSON chamado e colhe a Configuração MSAL que guardou anteriormente. 
