...
Para novos aplicativos de área de trabalho, recomendamos que você use a plataforma de identidade da Microsoft (v 2.0) e o MSAL para adquirir tokens e acessar APIs da Web protegidas: [Quickstart: Adquirir um token e chamar Microsoft Graph API de um aplicativo da área de trabalho do Windows](quickstart-v2-windows-desktop.md)
