...
1. Entre no [portal do Azure](https://portal.azure.com) usando uma conta corporativa ou de estudante ou uma conta Microsoft pessoal. Em alternativa, inscreva-se no portal azure de eleição para a nuvem nacional.
...
1. No painel esquerdo, selecione o serviço **de Diretório Ativo Azure** e, em seguida, selecione **as inscrições** da App > **Nova inscrição**.
...
1. Quando a página **Registar uma aplicação** for apresentada, introduza as informações de registo da aplicação:
   ...
   1. Na seção **nome** , insira um nome de aplicativo significativo que será exibido aos usuários do aplicativo. Por exemplo, introduza **AspNetCore-WebApp**.
   1. Para **Redirecionar URI,** adicione o tipo de aplicação e o destino URI que aceitará respostas simbólicas devolvidas após autenticação bem sucedida. Por exemplo, introduza **https://localhost:44321** . Em seguida, selecione **Register**.
1. Selecione o menu **autenticação** e, em seguida, adicione as seguintes informações:
   1. Para **o URL de resposta,** adicione **https://localhost:44321/signin-oidc** do tipo **Web**.
...
1. Quando a **página Registar uma aplicação** for apresentada, introduza as informações de registo da aplicação:
   1. Escolha os tipos de conta suportados para a sua aplicação. (Ver tipos de [conta suportada](./v2-supported-account-types.md).)
   1. Na seção **nome** , insira um nome de aplicativo significativo que será exibido aos usuários do aplicativo. Por exemplo, introduza **mailApp-openidconnect-v2**.
   1. Na secção **Redirecionamento URI (opcional),** selecione **Web** na caixa de combinação e introduza o seguinte redirecionamento URI: **https://localhost:44326/** .
...
1. Selecione **Certificados e segredos** do menu.
...
1. Quando a **página Registar uma aplicação** for apresentada, introduza as informações de registo da aplicação:
   1. Na seção **nome** , insira um nome de aplicativo significativo que será exibido aos usuários do aplicativo. Por exemplo, **introduza python-webapp**.
   ...
   1. Na secção **Redirecionamento URI (opcional),** selecione **Web** na caixa de combinação e introduza o seguinte redirecionamento URI: **http://localhost:5000/getAToken** .
1. Selecione **Registar** para criar a aplicação.
