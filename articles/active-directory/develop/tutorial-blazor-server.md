...
Neste tutorial, você constrói uma aplicação Blazor Server que assina nos utilizadores e obtém dados do Microsoft Graph utilizando a plataforma de identidade da Microsoft e registando a sua aplicação no Azure Ative Directory (Azure AD).
...
No **âmbito da Gestão**, selecione   >  **autenticação implícita e fluxos híbridos**. Selecione **Tokens de acesso** e **fichas de identificação** e, em seguida, selecione **Save**.
