...
* Para obter uma lista completa de recursos de desenvolvimento, incluindo informações de referência para os protocolos e o apoio de fluxos de autorização da OAuth2 pela Azure AD, consulte o [Guia de Desenvolvimento da AD Azure][AAD-Developers-Guide]
