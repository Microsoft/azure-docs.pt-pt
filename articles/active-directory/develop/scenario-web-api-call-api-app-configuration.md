...
Pode também ver um exemplo da implementação do fluxo OBO na amostra [ms-identidade-python-on-behalf-of](https://github.com/Azure-Samples/ms-identity-python-on-behalf-of) sample.
