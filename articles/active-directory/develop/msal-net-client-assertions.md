...
description: Saiba mais sobre o suporte de afirmações de clientes assinados para aplicações confidenciais de clientes na Microsoft Authentication Library for .NET (MSAL.NET).
