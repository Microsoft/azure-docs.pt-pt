---
title: Como gerenciar uma identidade gerenciada atribuída pelo usuário usando CLI do Azure
...
- Se você não estiver familiarizado com identidades gerenciadas para recursos do Azure, confira a [seção visão geral](overview.md). **Certifique-se de examinar a [diferença entre uma identidade gerenciada atribuída pelo sistema e](overview.md#how-does-it-work)** atribuída pelo usuário.
...
```
Na resposta JSON, as identidades gerenciadas atribuídas pelo usuário têm o valor `"Microsoft.ManagedIdentity/userAssignedIdentities"` retornado para a chave, `type`.
