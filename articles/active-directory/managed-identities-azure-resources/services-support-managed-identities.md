...
Azure Arc habilitado kubernetes atualmente [suporta a identidade atribuída ao sistema](../../azure-arc/kubernetes/quickstart-connect-cluster.md). O certificado de identidade de serviço gerido é usado por todos os agentes Azure Arc habilitados kubernetes para comunicação com a Azure.
...
### <a name="azure-log-analytics-cluster"></a>Aglomerado Azure Log Analytics
...
Para mais informações, veja [como funciona a identidade no Azure Monitor](../../azure-monitor/logs/customer-managed-keys.md)
...
- [CLI do Azure](/cli/azure/policy/assignment#az_policy_assignment_create)
