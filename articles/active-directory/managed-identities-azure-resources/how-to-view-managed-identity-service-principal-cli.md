...
Este comando seguinte demonstra como visualizar o diretor de serviço de um VM ou aplicação com identidade gerida ativada. Substitua `<VM or application name>` com os seus próprios valores. 
