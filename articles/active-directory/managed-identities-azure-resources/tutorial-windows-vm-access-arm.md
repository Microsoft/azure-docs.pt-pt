...
Terá de utilizar o **PowerShell** nesta parte.  Se não tiver o **PowerShell** instalado, transfira-o [aqui](https://docs.microsoft.com/powershell/azure/). 
...
4.  Utilizando o cmdlet Invoke-WebRequest, faça um pedido à identidade gerida local para o ponto final dos recursos Azure para obter um token de acesso para Azure Resource Manager.
    ...
    Por fim, chame o Azure Resource Manager com o token de acesso. Neste exemplo, também estamos a usar o cmdlet Invoke-WebRequest para fazer a chamada para O Gestor de Recursos Azure, e incluir o token de acesso no cabeçalho de Autorização.
