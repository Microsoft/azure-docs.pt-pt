...
### <a name="review-membership-of-exclusion-groups-in-conditional-access-policies"></a>Rever a adesão a grupos de exclusão em políticas de acesso condicional 

Há alturas em que as políticas de Acesso Condicional concebidas para manter a sua rede segura não devem ser aplicadas a todos os utilizadores. Por exemplo, uma política de Acesso Condicional que apenas permite que os utilizadores assinem enquanto estão na rede corporativa pode não se aplicar à equipa de Vendas, que viaja extensivamente. Nesse caso, os membros da equipa sales seriam colocados num grupo e esse grupo seria excluído da política de acesso condicional. 
