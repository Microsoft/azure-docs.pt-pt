...
* Se receber uma mensagem de acesso negado quando configurar a gestão de direitos e for um Administrador Global, certifique-se de que o seu diretório tem um [licença do Azure AD Premium P2 (ou do EMS E5)](entitlement-management-overview.md#prerequisites).  
