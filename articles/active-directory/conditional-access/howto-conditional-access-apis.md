...
- [Acesso Condicional API](/graph/api/resources/conditionalaccesspolicy?view=graph-rest-1.0)

- [Localização nomeada API](/graph/api/resources/namedlocation?view=graph-rest-1.0)