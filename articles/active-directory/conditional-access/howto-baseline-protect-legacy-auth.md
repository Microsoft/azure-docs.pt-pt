...
### <a name="step-1-enable-modern-authentication-in-your-directory"></a>Passo 1: Habilitar a autenticação moderna em seu diretório
...
### <a name="step-6-on-premises-clients"></a>Passo 6: Clientes locais
...
* [Cinco etapas para proteger sua infraestrutura de identidade](../../security/azure-ad-secure-steps.md)
