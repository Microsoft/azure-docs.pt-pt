---
title: Azure Ative Directy Conditional Access FAQs | Microsoft Docs
...
- Para configurar políticas de acesso condicional para o seu ambiente, consulte o artigo [Planeie uma implementação de Acesso Condicional.](plan-conditional-access.md) 
