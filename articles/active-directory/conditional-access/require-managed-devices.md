...
:::image type="content" source="./media/require-managed-devices/32.png" alt-text="A screenshot do painel do dispositivo em Azure A D. Ativar e desativar os itens são realçados." border="false":::
