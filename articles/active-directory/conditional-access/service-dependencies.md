...
| Microsoft Classroom | Trocar                                    | Early-bound |
|                     | SharePoint                                  | Early-bound |
| Microsoft Teams     | Trocar                                    | Early-bound |
|                     | MS Planner                                  | Late-bound  |
|                     | SharePoint                                  | Early-bound |
|                     | Skype para Empresas Online                   | Early-bound |
| Office Portal       | Trocar                                    | Late-bound  |
|                     | SharePoint                                  | Late-bound  |
| Outlook groups      | Trocar                                    | Early-bound |
|                     | SharePoint                                  | Early-bound |
...
| Skype para Empresas  | Trocar                                    | Early-bound |
| Visual Studio       | Microsoft Azure Management (portal and API) | Early-bound |
| Microsoft Forms     | Trocar                                    | Early-bound |
|                     | SharePoint                                  | Early-bound |
| Microsoft To-Do     | Trocar                                    | Early-bound |
