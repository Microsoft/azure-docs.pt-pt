...
- [Cenário 2: Aplicações de navegador requerem aplicações aprovadas com políticas de proteção de aplicações](#scenario-2-browser-apps-require-approved-apps-with-app-protection-policies)
- [Cenário 3: Trocar Online e SharePoint Online requerem uma aplicação de clientes aprovada e política de proteção de aplicações](#scenario-3-exchange-online-and-sharepoint-online-require-an-approved-client-app-and-app-protection-policy)
...
## <a name="scenario-2-browser-apps-require-approved-apps-with-app-protection-policies"></a>Cenário 2: Aplicações de navegador requerem aplicações aprovadas com políticas de proteção de aplicações

Neste cenário, a Contoso decidiu que todos os recursos de navegação na Web móvel ao Office 365 devem utilizar uma aplicação de cliente aprovada, como o Edge para iOS e Android, protegido por uma política de proteção de aplicações antes de ter acesso. Todos os seus utilizadores já assinam com credenciais Da Azure AD e têm licenças atribuídas a eles que incluem Azure AD Premium P1 ou P2 e Microsoft Intune.
...
## <a name="scenario-3-exchange-online-and-sharepoint-online-require-an-approved-client-app-and-app-protection-policy"></a>Cenário 3: Trocar Online e SharePoint Online requerem uma aplicação de clientes aprovada e política de proteção de aplicações
