...
* [Exigir a MFA para os administradores (pré-visualização)](howto-baseline-protect-administrators.md)
...
### <a name="require-mfa-for-admins-preview"></a>Exigir a MFA para os administradores (pré-visualização)
...
[Exigir a MFA para os administradores (pré-visualização)](howto-baseline-protect-administrators.md) é uma política de linha de base que requer autenticação multifator (MFA) para as seguintes funções de diretório, consideradas as mais privilegiadas funções do Azure AD:
...
Se sua organização tiver estas contas em uso em scripts ou código, considere substituí-los com [geridos identidades](../managed-identities-azure-resources/overview.md).
