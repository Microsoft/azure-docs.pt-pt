...
Active Directory acesso condicional do Azure permite-lhe limitar o acesso às suas aplicações na cloud para aplicações de cliente que suportam políticas de proteção de aplicações do Intune. Por exemplo, pode restringir o acesso ao Exchange Online para a aplicação Outlook.
...
1. **Utilizadores e grupos**: Cada política de acesso condicional tem de ter pelo menos um utilizador ou grupo selecionado.
1. **Aplicações na cloud:** Como as aplicações na cloud, tem de selecionar **Office 365 Exchange Online**.

   ![Acesso Condicional](./media/app-based-conditional-access/07.png)

1. **Condições:** Como **condições**, terá de configurar **plataformas de dispositivos** e **aplicações de cliente**:
   1. Como **plataformas de dispositivos**, selecione **Android** e **iOS**.

      ![Acesso Condicional](./media/app-based-conditional-access/03.png)

   1. Como **aplicações de cliente (pré-visualização)** , selecione **aplicações móveis e aplicações de ambiente de trabalho** e **clientes de autenticação moderna**.

      ![Acesso Condicional](./media/app-based-conditional-access/91.png)

1. Como **controlos de acesso**, tem de ter **exigir aplicação aprovada do cliente (pré-visualização)** selecionado.
...
1. **Condições:** Como **condições**, terá de configurar **aplicações de cliente (pré-visualização)** . 
   1. Como **aplicações de cliente (pré-visualização)** , selecione **aplicações móveis e clientes de ambiente de trabalho** e **clientes do Exchange ActiveSync**.
...
- Tenta iniciar sessão com as mesmas credenciais que as credenciais de aplicação do Outlook
...
1. O **nome** da sua política de acesso condicional.
1. **Utilizadores e grupos**: Cada política de acesso condicional tem de ter pelo menos um utilizador ou grupo selecionado.
1. **Aplicações na cloud:** Como as aplicações na cloud, tem de selecionar **Office 365 Exchange Online** e **Office 365 SharePoint Online**. 
...
1. **Condições:** Como **condições**, terá de configurar **plataformas de dispositivos** e **aplicações de cliente**:
   ...
   1. Como **aplicações de cliente (pré-visualização)** , selecione **aplicações móveis e clientes de ambiente de trabalho** e **clientes de autenticação moderna**.
...
1. O **nome** da sua política de acesso condicional.
1. **Utilizadores e grupos**: Cada política de acesso condicional tem de ter pelo menos um utilizador ou grupo selecionado.
1. **Aplicações na cloud:** Como as aplicações na cloud, tem de selecionar **Office 365 Exchange Online**. Online 

   ![Acesso Condicional](./media/app-based-conditional-access/07.png)

1. **Condições:** Como **condições**, terá de configurar **aplicações de cliente**:
   1. Como **aplicações de cliente (pré-visualização)** , selecione **aplicações móveis e clientes de ambiente de trabalho** e **clientes do Exchange ActiveSync**.
...
- Alguns usuários já tenham sido inscritos (com ou sem dispositivos da empresa)
...
1. Como **controlos de acesso**, tem de ter o seguinte selecionado:
