---
title: O que é a condição de localização no Azure Active Directory condicional acesso? | Microsoft Docs
...
ms.locfileid: "67112298"
---
# <a name="what-is-the-location-condition-in-azure-active-directory-conditional-access"></a>O que é a condição de localização no Azure Active Directory condicional acesso? 
...
- **Intervalos de IP** -um ou mais intervalos de endereços de IPv4 no formato CIDR. Especificar um intervalo de endereços IPv6 não é suportado.
   ...
   > [!NOTE]
   > Rangess de endereço de IPv6 atualmente não pode ser incluído num local nomeado. Não não possível excluir este intervalos de IPv6 measn de uma política de acesso condicional.
...
O número de localizações com nome, que pode configurar é restrito pelo tamanho do objeto relacionado no Azure AD. As organizações podem configurar até 90 localizações com nome, cada um configurado com até 1200 intervalos IP.
