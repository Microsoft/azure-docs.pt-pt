---
title: 'Tutorial: Integrar uma única floresta de AD para Azure usando PTA'
...
---
# <a name="tutorial--integrate-a-single-ad-forest-using-pass-through-authentication-pta"></a>Tutorial: Integrar uma única floresta de AD utilizando a autenticação pass-through (PTA)

![Criar](media/tutorial-passthrough-authentication/diagram.png)

O seguinte tutorial irá acompanhá-lo através da criação de um ambiente de identidade híbrida usando a autenticação pass-through.  Este ambiente pode então ser utilizado para testes ou para se familiarizar mais com o funcionamento de uma identidade híbrida.
...
6. No ecrã de iniciar sessão do utilizador, selecione a **autenticação Pass-through** e **ative um único sinal e** clique em **Next**.</br>
![PTA](media/tutorial-passthrough-authentication/pta1.png)</b>
7. No ecrã Connect to Azure AD, introduza o nome de utilizador e a palavra-passe do administrador global que criámos acima e clique em **Next**.
...
9. Na página de credenciais de sinal único , introduza o nome de utilizador e senha do administrador de contose clique em **Seguinte.**
10. No ecrã Preparado para configurar, clique em **Instalar**.
11. Quando concluir a instalação, clique em **Sair**.
12. Depois de concluída a instalação, assine e inscreva-se novamente antes de utilizar o Gestor de Serviços de Sincronização ou editor de regras de sincronização.
