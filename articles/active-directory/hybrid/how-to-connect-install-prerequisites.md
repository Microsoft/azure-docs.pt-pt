...
* Um inquilino do Azure AD. You get one with an [Azure free trial](https://azure.microsoft.com/pricing/free-trial/). You can use one of the following portals to manage Azure AD Connect:
...
* Windows Server 2012R2
  * Microsoft PowerShell is installed by default. Não é necessário realizar qualquer ação.
...
| --- | --- | --- | --- |
| Fewer than 10,000 |1.6 GHz |4GB |70 GB |
