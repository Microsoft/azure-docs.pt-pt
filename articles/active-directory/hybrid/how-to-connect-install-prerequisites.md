...
* Se utilizar o caminho de instalação de configurações personalizadas, então tem mais opções para ver [Contas em Diretório Ativo](reference-connect-accounts-permissions.md#custom-installation-settings)
