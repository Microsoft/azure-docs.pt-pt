...
ms.locfileid: "106059246"
---
# <a name="azure-ad-connect-automatic-upgrade"></a>Azure AD Connect: atualização automática
A atualização automática Azure AD Connect é uma funcionalidade que verifica regularmente versões mais recentes do Azure AD Connect. Se o seu servidor estiver ativado para a atualização automática e se encontrar uma versão mais recente para a qual o seu servidor é elegível, realizará uma atualização automática para essa versão mais recente.
Note que, por razões de segurança, o agente que executa a atualização automática valida a nova construção do Azure AD Connect com base na assinatura digital da versão descarregada.
