...
O PowerShell utiliza a configuração em machine.config para contactar o representante. As definições em winhttp/netsh não devem ter impacto nestes cmdlets.
