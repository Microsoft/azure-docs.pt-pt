...
Repor palavra-passe
* Corrigiu um problema que pode fazer com que o servidor Azure AAD Connect não tente voltar a ligar se a ligação tiver sido morta por uma firewall ou procuração.
