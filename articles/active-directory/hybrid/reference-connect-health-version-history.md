...
- Azure AD Connect Health agent for AD FS (versão 3.1.77.0)
   ...
   1.   Correção de erro para alerta "Invalid Service Principal Name (SPN) for AD FS service", para o qual o alerta estava a reportar incorretamente.
