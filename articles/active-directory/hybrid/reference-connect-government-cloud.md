...
> [!NOTE]
> As seguintes orientações também se aplicam à instalação do [conector proxy de aplicação AD Azure](https://aka.ms/whyappproxy) para ambientes do Governo Azure.
