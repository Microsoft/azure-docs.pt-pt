...
Incorporar a governação identitária facilita a transição da organização para a gestão governada pela nuvem, permite que as TI escalquem, aborda novos desafios com os hóspedes e fornece insights mais profundos e automação do que o que os clientes tinham com infraestrutura no local. A governação neste novo mundo significa a capacidade de uma organização ter transparência, visibilidade e controlos adequados sobre o acesso aos recursos dentro da organização. Com a AD Azure, as operações de segurança e as equipas de auditoria têm visibilidade sobre quem tem --- e quem deve ter - acesso aos recursos da organização (em que dispositivos), o que esses utilizadores estão a fazer com esse acesso, e se a organização tem e usa apropriado controlos para remover ou restringir o acesso de acordo com as políticas da empresa ou regulamentares.
