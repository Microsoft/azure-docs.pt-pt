...
1. Identifique os proxyAddresses duplicados, userPrincipalName ou outro valor de atributo que está a causar o erro. Identifique também quais dois \( ou mais \) objetos estão envolvidos no conflito. O relatório gerado pela [Azure AD Connect Health para sincronização](./how-to-connect-health-sync.md) pode ajudá-lo a identificar os dois objetos.
...
1. Identifique o valor duplicado de proxyAddresses (ou outro atributo) que está a causar o erro. Identifique também quais dois \( ou mais \) objetos estão envolvidos no conflito. O relatório gerado pela [Azure AD Connect Health para sincronização](./how-to-connect-health-sync.md) pode ajudá-lo a identificar os dois objetos.
2. Identifique qual o objeto que deve continuar a ter o valor duplicado e qual o objeto que não deve.
