...
ms.locfileid: "78375974"
---
# <a name="azure-ad-connect-sync-attributes-synchronized-to-azure-active-directory"></a>Sincronização Azure AD Connect: Atributos sincronizados com diretório ativo azure
...
## <a name="office-365-proplus"></a>Escritório 365 ProPlus
| Nome de atributo | Utilizador | Comentário |
| --- |:---:| --- |
| accountEnabled |X |Define se uma conta está ativada. |
| CN |X | |
| displayName |X | |
| objectSID |X |propriedade mecânica. Identificador de utilizador aD usado para manter a sincronização entre Azure AD e AD. |
...
| givenName |X |X | | |
| homePhone |X |X | | |
| info |X |X |X |Este atributo não é atualmente consumido para grupos. |
| Iniciais |X |X | | |
| l |X |X | | |
...
| objectSID |X | |X |propriedade mecânica. Identificador de utilizador aD usado para manter a sincronização entre Azure AD e AD. |
...
| Nome de atributo | Dispositivo | Comentário |
| --- |:---:| --- |
| accountEnabled |X | |
| deviceTrustType |X |Valor codificado para computadores ligados ao domínio. |
| displayName |X | |
| ms-DS-CreatorSID |X |Também chamado RegistradoOwnerReference. |
| objectGUID |X |Também chamado de dispositivoID. |
| objectSID |X |Também chamado noLocalsSecurityIdentifier. |
| operatingSystem |X |Também chamado dispositivoOSType. |
...
| --- |:---:|:---:|:---:| --- |---|
| msDS-ExternalDirectoryObjectID| ms-DS-External-Directory-Object-Id |X | | |Derivado da cloudAnchor em Azure AD. Este atributo é novo no Exchange 2016 e no Windows Server 2016 AD. |
...
| publicDelegates| ms-Exch-Public-Delegates  |X | | |Permite que seja concedida uma caixa de correio Online de troca de direitos aos utilizadores com caixa de correio de troca no local. Requer azure AD Connect construir 1.1.552.0 ou depois. |
...
| Nome de atributo | PublicFolder | Comentário |
| --- | :---:| --- |
| displayName | X |  |
| mail | X |  |
