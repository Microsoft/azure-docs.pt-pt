...
5. Em **Manage**, selecione **Single sign-on** e configurar o pedido de inscrição única. (Para mais detalhes, consulte [como gerir um único s-on para aplicações empresariais](../manage-apps/add-application-portal-setup-sso.md).)
