---
title: Compreenda os tokens do utilizador na colaboração B2B - Azure AD
description: Referência simbólica do utilizador para a colaboração B2B do Azure Ative Directory
...
ms.locfileid: "87908915"
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Compreenda os tokens do utilizador na colaboração Azure AD B2B

Se você quer saber como é o símbolo para um utilizador de colaboração B2B, aqui estão os detalhes do token portador e conteúdo simbólico para um hóspede do Azure Ative Directory (Azure AD) e um hóspede da conta microsoft no inquilino de recursos (para inquilino 04dcc6ab-388a-4559-b527-fbec656300ea). Para ver os conteúdos, utilize [https://jwt.io/](https://jwt.io/) ou [https://jwt.ms/](https://jwt.ms/) .

## <a name="azure-ad-guest-token"></a>Ficha de convidado da AD AZure
```
...
## <a name="microsoft-account-guest-token"></a>Ficha de convidado de conta da Microsoft
```
