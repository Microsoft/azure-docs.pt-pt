...
Aqui mostramos como chamar a API de convite, no modo "só de aplicação", para obter o URL de resgate do recurso para o qual está a convidar o utilizador B2B. O objetivo é enviar um e-mail de convite personalizado. O e-mail pode ser composto com um cliente HTTP, para que possa personalizar a sua aparência e enviá-lo através da API do Microsoft Graph.
