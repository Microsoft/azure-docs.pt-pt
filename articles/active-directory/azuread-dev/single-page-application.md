...
![Diagrama de aplicação de uma página única](./media/authentication-scenarios/single-page-app.png)
...
Após o registo do pedido, deve ser configurado para utilizar o protocolo de subvenção implícita OAuth 2.0. Por predefinição, este protocolo é desativado para aplicações. Para ativar o protocolo de subvenção implícita OAuth2 para a sua aplicação, edite o seu manifesto de aplicação a partir do portal Azure e detetete o valor "oauth2AllowImplicitFlow" para o verdadeiro. Para mais informações, consulte [O manifesto da Aplicação.](../develop/reference-app-manifest.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json)
