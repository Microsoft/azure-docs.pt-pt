...
> [!NOTE]
> Procura as bibliotecas Azure AD v2.0 (MSAL)? Check-out o [guia da biblioteca MSAL](https://docs.microsoft.com/azure/active-directory/develop/active-directory-v2-libraries).
>
>
