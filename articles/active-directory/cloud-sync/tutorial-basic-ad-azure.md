...
description: Aprenda a criar um ambiente AD básico e Azure AD.
author: billmath
manager: daveba
...
![Diagrama que mostra um ambiente Azure A D básico.](media/tutorial-single-forest/diagram-2.png)
...
![Screenshot que mostra a página do Diretório Ativo Azure no portal Azure.](media/tutorial-single-forest/create-1.png)</br>
...
![Screenshot que mostra o menu "Visão Geral" com "Utilizadores" selecionados.](media/tutorial-single-forest/administrator-1.png)</br>
...
Segue-se uma secção opcional que fornece passos para a criação de um servidor adicional e ou floresta.  Isto pode ser usado em alguns dos tutoriais mais avançados, como [Pilot for Azure AD Connect para sincronização em nuvem.](tutorial-pilot-aadc-aadccp.md)
...
Agora você tem um ambiente que pode ser usado para tutoriais existentes e para testar funcionalidades adicionais que a cloud sync fornece.
