...
description: Solução de problemas de Azure Active Directory híbridas associados a dispositivos Windows 10 e Windows Server 2016.
...
Para o Windows 10 e o Windows Server 2016, a União de Azure Active Directory híbrida dá suporte à atualização do Windows 10 de novembro de 2015 e acima.

## <a name="troubleshoot-join-failures"></a>Solucionar problemas de falhas de junção

### <a name="step-1-retrieve-the-join-status"></a>Passo 1: Recuperar o status de junção 

**Para recuperar o status de junção:**
...
### <a name="step-2-evaluate-the-join-status"></a>Passo 2: Avaliar o status de junção 
...
### <a name="step-3-find-the-phase-in-which-join-failed-and-the-errorcode"></a>Passo 3: Localize a fase em que a junção falhou e o ErrorCode
...
### <a name="step-4-check-for-possible-causes-and-resolutions-from-the-lists-below"></a>Passo 4: Verifique se há possíveis causas e resoluções das listas abaixo
...
- **DSREG_AUTOJOIN_ADCONFIG_READ_FAILED** (0x801c001d/-2145648611)
   - Falha Não é possível ler o objeto SCP e obter as informações de locatário do Azure AD.
...
- **DSREG_AUTOJOIN_DISC_FAILED** (0x801c0021/-2145648607)
   - Falha Falha de descoberta genérica. Falha ao obter os metadados de descoberta do DRS.
   - Resolução: Localize o suberro abaixo para investigar mais.
- **DSREG_AUTOJOIN_DISC_WAIT_TIMEOUT**  (0x801c001f/-2145648609)
   - Falha Tempo limite da operação atingido ao executar a descoberta.
...
- **DSREG_AUTOJOIN_USERREALM_DISCOVERY_FAILED** (0x801c0021/-2145648611)
   - Falha Falha na descoberta de realm genérico. Falha ao determinar o tipo de domínio (gerenciado/federado) do STS. 
   - Resolução: Localize o suberro abaixo para investigar mais.
...
- **WININET_E_CANNOT_CONNECT** (0x80072efd/-2147012867)
   - Falha A conexão com o servidor não pôde ser estabelecida
...
- **WININET_E_TIMEOUT** (0x80072EE2/-2147012894)
   - Falha Tempo limite de rede geral.
   - Resolução: Garanta a conectividade de rede com os recursos da Microsoft necessários. Para obter mais informações, consulte [requisitos de conectividade de rede](hybrid-azuread-join-managed-domains.md#prerequisites).
- **WININET_E_DECODING_FAILED** (0x80072f8f/-2147012721)
   - Falha A pilha de rede não pôde decodificar a resposta do servidor.
...
- **DSREG_DISCOVERY_TENANT_NOT_FOUND** (0x801c003a/-2145648582)
   - Falha Objeto SCP configurado com a ID de locatário incorreta. Ou nenhuma assinatura ativa foi encontrada no locatário.
...
- **DSREG_SERVER_BUSY** (0x801c0025/-2145648603)
   - Falha HTTP 503 do servidor DRS.
...
- **E_INVALIDDATA** (0x8007000d/-2147024883)
   - Falha Não foi possível analisar o JSON de resposta do servidor. Provavelmente devido ao proxy retornar HTTP 200 com uma página de autenticação HTML.
...
- **ERROR_ADAL_PROTOCOL_NOT_SUPPORTED** (0xcaa90017/-894894057)
   - Falha O protocolo de autenticação não é WS-Trust.
   - Resolução: O provedor de identidade local deve dar suporte a WS-Trust 
- **ERROR_ADAL_FAILED_TO_PARSE_XML** (0xcaa9002c/-894894036)
   - Falha O serviço de federação local não retornou uma resposta XML.
...
- **ERROR_ADAL_COULDNOT_DISCOVER_USERNAME_PASSWORD_ENDPOINT** (0xcaa90023/-894894045)
   - Falha Não foi possível descobrir o ponto de extremidade para a autenticação de nome de usuário/senha.
...
- **ERROR_ADAL_INTERNET_CONNECTION_ABORTED** (0xcaa82efe/-894947586)
   - Falha A conexão com o ponto de extremidade de autenticação foi anulada.
   - Resolução: Tente novamente após algum tempo ou tente ingressar em um local de rede estável alternativo.
- **ERROR_ADAL_INTERNET_SECURE_FAILURE** (0xcaa82f8f/-894947441)
   - Falha O certificado de protocolo SSL (SSL) enviado pelo servidor não pôde ser validado.
...
- **ERROR_ADAL_INTERNET_CANNOT_CONNECT** (0xcaa82efd/-894947587)
   - Falha Falha na tentativa de conexão `https://login.microsoftonline.com` com.
   - Resolução: Verifique a conexão de `https://login.microsoftonline.com`rede para.

##### <a name="other-errors"></a>Outros erros

- **ERROR_ADAL_SERVER_ERROR_INVALID_GRANT** (0xcaa20003/-895352829)
   - Falha O token SAML do provedor de identidade local não foi aceito pelo Azure AD.
...
- **ERROR_ADAL_WSTRUST_REQUEST_SECURITYTOKEN_FAILED** (0xcaa90014/-894894060)
   - Falha A resposta WS-Trust do servidor relatou uma exceção de falha e falhou ao obter a asserção
   - Resolução: Verifique as configurações do servidor de Federação. Procure o código de erro do servidor nos logs de autenticação.
- **ERROR_ADAL_WSTRUST_TOKEN_REQUEST_FAIL** (0xcaa90006/-894894074)
   - Falha Recebeu um erro ao tentar obter o token de acesso do ponto de extremidade do token.
   - Resolução: Procure o erro subjacente no log ADAL. 
- **ERROR_ADAL_OPERATION_PENDING** (0xcaa1002d/-895418323)
   - Falha Falha geral do ADAL
...
- **DSREG_E_DIRECTORY_FAILURE** (0x801c03f2/-2145647630)
   - Falha Recebida uma resposta de erro do DRS com ErrorCode: DirectoryError
   - Resolução: Consulte o código de erro do servidor para obter possíveis razões e resoluções.
- **DSREG_E_DEVICE_AUTHENTICATION_ERROR** (0x801c0002/-2145648638)
   - Falha Recebida uma resposta de erro do DRS com ErrorCode: "AuthenticationError" e ErrorSubCode não é "DeviceNotFound". 
   - Resolução: Consulte o código de erro do servidor para obter possíveis razões e resoluções.
...
- **NTE_BAD_KEYSET** (0x80090016/-2146893802)
   - Falha Falha na operação do TPM ou ela era inválida
...
- **TPM_E_NOTFIPS** (0x80280036/-2144862154)
   - Falha No momento, não há suporte para TPM no modo FIPS.
...
- **WININET_E_TIMEOUT** (0x80072EE2/-2147012894)
   - Falha Tempo limite de rede geral ao tentar registrar o dispositivo no DRS
   - Resolução: Verifique a conectividade de `https://enterpriseregistration.windows.net`rede para.
- **WININET_E_NAME_NOT_RESOLVED** (0x80072ee7/-2147012889)
   - Falha O nome ou endereço do servidor não pôde ser resolvido.
...
- **WININET_E_CONNECTION_ABORTED** (0x80072efe/-2147012866)
   - Falha A conexão com o servidor foi encerrada de forma anormal.
   - Resolução: Tente novamente após algum tempo ou tente ingressar em um local de rede estável alternativo.
...
### <a name="step-5-collect-logs-and-contact-microsoft-support"></a>Passo 5: Coletar logs e contatar Suporte da Microsoft
