...
### <a name="step-1-retrieve-the-join-status"></a>Etapa 1: recuperar o status de junção 
...
### <a name="step-2-evaluate-the-join-status"></a>Etapa 2: avaliar o status de junção 
