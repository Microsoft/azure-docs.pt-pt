...
## <a name="app-consent-permissions"></a>Permissões de consentimento de aplicativos
...
> [!NOTE]
> O portal de administração Azure AD ainda não suporta a adição das permissões enumeradas neste artigo a uma definição de papel de diretório personalizado. Você deve [usar Azure AD PowerShell para criar um papel de diretório personalizado](roles-create-custom.md#create-a-role-using-powershell) com as permissões listadas neste artigo.
