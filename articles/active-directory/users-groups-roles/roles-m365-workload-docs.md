...
Azure Information Protection | [Funções de administração da AD Azure](directory-assign-admin-roles.md) | [Graph API](/graph/api/overview?view=graph-rest-1.0)<br>[Ir buscar atribuições de papéis](/graph/api/directoryrole-list?view=graph-rest-1.0)
...
Privileged Identity Management | [Funções de administração da AD Azure](directory-assign-admin-roles.md) | [Graph API](/graph/api/overview?view=graph-rest-1.0)<br>[Ir buscar atribuições de papéis](/graph/api/directoryrole-list?view=graph-rest-1.0)
