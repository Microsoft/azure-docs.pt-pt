...
1.  Execute o seguinte cmdlet para exibir todos os grupos eliminados do Office 365 na sua organização Azure AD que ainda estão disponíveis para restaurar.
