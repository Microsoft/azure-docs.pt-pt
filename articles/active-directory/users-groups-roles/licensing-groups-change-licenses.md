...
1. Selecione a caixa de verificação para o Office 366 E3 e certifique-se de que, no mínimo, todos os serviços E1 atribuídos ao utilizador são selecionados.
...
- [Como migrar utilizadores licenciados individuais para agrupar licenciamento no Azure Ative Directory](../users-groups-roles/licensing-groups-migrate-users.md)
- [Azure Ative Directory group licenciando cenários adicionais](../users-groups-roles/licensing-group-advanced.md)
- [Exemplos powerShell para licenciamento de grupo em Azure Ative Directory](../users-groups-roles/licensing-ps-examples.md)
