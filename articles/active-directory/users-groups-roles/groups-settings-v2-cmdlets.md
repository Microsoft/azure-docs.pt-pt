---
title: Exemplos do PowerShell para gestão de grupos e pré-visualização de repetição de escrita no local - Azure Active Directory de grupo | Documentos da Microsoft
...
## <a name="manage-group-membership"></a>Gerir a associação de grupo
...
## <a name="group-writeback-to-on-premises-preview"></a>Repetição de escrita do grupo para o local (pré-visualização)

Hoje em dia, muitos grupos continuam a ser geridos no Active Directory no local. Para responder a pedidos para sincronizar grupos de cloud para repetição de escrita de grupos no local, Office 365 a funcionalidade para o Azure AD agora está disponível para pré-visualização.

Grupos do Office 365 são criados e geridos na cloud. A capacidade de repetição de escrita permite-lhe efetuar um write back grupos do Office 365 como grupos de distribuição para uma floresta do Active Directory com o Exchange instalado. Utilizadores com o Exchange no local, caixas de correio, em seguida, podem enviar e receber emails destes grupos. A funcionalidade de repetição de escrita do grupo não suporta grupos de segurança do Azure AD ou grupos de distribuição.
...
Repetição de escrita do grupo do Office 365 é uma funcionalidade de pré-visualização pública do Azure Active Directory (Azure AD) e disponível com qualquer é pago plano de licenciamento do Azure AD. Para obter algumas informações legais sobre pré-visualizações, consulte [termos de utilização suplementares para pré-visualizações do Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).
