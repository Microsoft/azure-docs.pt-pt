...
Para obter mais detalhes, consulte [Criar e atribuir uma função personalizada](roles-create-custom.md) e atribuir [funções personalizadas com âmbito de recursos utilizando o PowerShell.](roles-assign-powershell.md)
...
Crie uma função personalizada utilizando o exemplo fornecido na Microsoft Graph API. Para obter mais detalhes, consulte [Criar e atribuir uma função personalizada](roles-create-custom.md) e atribuir [funções de administração personalizadas utilizando a API do Gráfico microsoft](roles-assign-graph.md).
