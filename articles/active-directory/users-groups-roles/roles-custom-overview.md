...
Pode [criar atribuições de funções](roles-create-custom.md) utilizando o portal Azure, Azure AD PowerShell ou API de gráficos. Também pode [ver as atribuições para um papel personalizado.](roles-view-assignments.md#view-the-assignments-of-a-role)
