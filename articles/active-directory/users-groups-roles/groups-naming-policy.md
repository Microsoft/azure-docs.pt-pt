...
1. Siga os passos em [cmdlets do Azure Ative Directory para configurar as definições de grupo](groups-settings-cmdlets.md) para criar configurações de grupo para esta organização.
...
Para obter mais informações, consulte o artigo [Cmdlets Azure Ative Directory para configurar as definições do grupo](groups-settings-cmdlets.md).
