...
2. **[Configure Clever Nelly SSO](#configure-clever-nelly-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo Clever Nelly no Painel de Acesso, deverá ser automaticamente inscrito na Smart Nelly para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
