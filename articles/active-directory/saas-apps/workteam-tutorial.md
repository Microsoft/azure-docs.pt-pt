---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com Workteam Microsoft Docs'
...
Quando clicar no azulejo workteam no Painel de Acesso, deverá ser automaticamente inscrito na Workteam para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
