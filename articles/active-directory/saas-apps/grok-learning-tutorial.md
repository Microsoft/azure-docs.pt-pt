...
1. Na secção **Basic SAML Configuration,** caso deseje configurar a aplicação no modo iniciado do **IDP,** introduza os valores para os seguintes campos:
    ...
    a. Na caixa de texto **identificador,** digite um URL utilizando o seguinte padrão: `https://<SUBDOMAIN>.groklearning.com/sso/saml2/metadata`

    b. Na caixa de texto **URL de resposta,** escreva um URL utilizando o seguinte padrão: `https://<SUBDOMAIN>.groklearning.com/sso/saml2/acs`
...
Para configurar um único sign-on no lado **grok learning,** você precisa enviar o Url de **Metadados da Federação de Aplicações** para a equipe de [suporte grok learning](mailto:sso-support@groklearning.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
