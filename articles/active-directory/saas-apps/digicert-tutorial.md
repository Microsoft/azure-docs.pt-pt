---
title: 'Tutorial: Integração do Azure Ative Directory com DigiCert Microsoft Docs'
...
A integração do DigiCert com a AD Azure proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso a DigiCert.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos no DigiCert (Sign-On Único) com as suas contas AD Azure.
...
Para configurar a integração AD da Azure com a DigiCert, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode ter um mês de julgamento [aqui.](https://azure.microsoft.com/pricing/free-trial/)
* Subscrição ativada por digiCert

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configura e testa Azure AD um único sinal de acesso em um ambiente de teste.

* DigiCert apoia **IDP** iniciado SSO

## <a name="adding-digicert-from-the-gallery"></a>Adicionar DigiCert da galeria
...
4. Na caixa de pesquisa, **escreva DigiCert,** selecione **DigiCert** do painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar a aplicação.

     ![DigiCert na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar Azure AD único sinal de inscrição

Nesta secção, configura e testa o Azure AD com um único sign-on com DigiCert baseado num utilizador de teste chamado **Britta Simon**.
Para um único sinal de sação a funcionar, é necessário estabelecer uma relação de ligação entre um utilizador AZure AD e o utilizador relacionado no DigiCert.
...
Para configurar o Azure AD single sign-on com DigiCert, execute os seguintes passos:

1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **DigiCert,** selecione **Single sign-on**.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    ![DigiCert Domain e URLs informações únicas de súmis](common/idp-identifier.png)
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso ao DigiCert.
...
Quando clicar no azulejo DigiCert no Painel de Acesso, deverá ser automaticamente inscrito no DigiCert para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
