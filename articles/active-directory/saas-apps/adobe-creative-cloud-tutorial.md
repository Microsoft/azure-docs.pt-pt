...
Quando clicar no azulejo da Nuvem Criativa do Adobe no Painel de Acesso, deverá ser automaticamente inscrito na Nuvem Criativa do Adobe para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
