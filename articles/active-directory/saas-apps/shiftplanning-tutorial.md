...
2. **[Configure o Sign-On Único da Humanidade](#configure-humanity-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
### <a name="configure-humanity-single-sign-on"></a>Configurar a humanidade único sign-on
...
Quando clicar no azulejo da Humanidade no Painel de Acesso, deverá ser automaticamente inscrito na Humanidade para a qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
