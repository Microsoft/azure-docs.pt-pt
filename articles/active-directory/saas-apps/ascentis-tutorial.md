...
2. **[Configure Ascentis SSO](#configure-ascentis-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
1. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
   ...
   ```https
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de resposta real e URL de inscrição. Contacte [a equipa de suporte do Cliente Ascentis](mailto:support@ascentis.com) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
