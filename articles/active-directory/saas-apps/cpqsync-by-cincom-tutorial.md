...
2. **[Configure o CPQSync da Cincom SSO](#configure-cpqsync-by-cincom-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo CPQSync da Cincom no Painel de Acesso, deverá ser automaticamente inscrito no CPQSync pela Cincom para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
