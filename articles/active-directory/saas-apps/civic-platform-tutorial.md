---
title: 'Tutorial: Integração do Azure Ative Directory com Plataforma Cívica Microsoft Docs'
...
Ao clicar no azulejo da Plataforma Cívica no Painel de Acesso, deverá ser automaticamente inscrito na Plataforma Cívica para a qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
