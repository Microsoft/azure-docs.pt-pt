...
1. Na secção **Configuração Básica SAML,** insira os valores para os seguintes campos:
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de inscrição real. Contacte a [equipa de suporte do cliente CBRE ServiceInsight](mailto:SISupport@cbre.com) para obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
