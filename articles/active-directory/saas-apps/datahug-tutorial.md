...
### <a name="configure-datahug-single-sign-on"></a>Configurar datahug único sign-on
...
Quando clicar no azulejo Datahug no Painel de Acesso, deverá ser automaticamente inscrito no Datahug para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
