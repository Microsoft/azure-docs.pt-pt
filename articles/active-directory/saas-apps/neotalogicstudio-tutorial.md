...
2. **[Configure o Sign-On único do Neota Logic Studio](#configure-neota-logic-studio-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
