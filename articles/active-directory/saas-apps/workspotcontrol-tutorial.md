---
title: 'Tutorial: Integração do Diretório Ativo Azure com | de Controlo de Workspot Microsoft Docs'
...
3. Na janela de **configuração de marcação de afirmação de segurança,** siga estes passos:
 
    ![Janela de configuração de marcação de afirmação de segurança](./media/workspotcontrol-tutorial/tutorial_workspotcontrol_saml.png)
