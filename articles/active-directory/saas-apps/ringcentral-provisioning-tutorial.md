...
> * [Único sinal de ringcentral](./ringcentral-tutorial.md) (recomendado)
...
3. Determine quais os dados a [mapear entre Azure AD e RingCentral](../app-provisioning/customize-application-attributes.md). 
...
9. Reveja os atributos do utilizador que são sincronizados de AD AD a RingCentral na secção **De mapeamento de atributos.** Os atributos selecionados como propriedades **de correspondência** são utilizados para combinar as contas de utilizador no RingCentral para operações de atualização. Se optar por alterar o [atributo de alvo correspondente,](../app-provisioning/customize-application-attributes.md)terá de garantir que a API RingCentral suporta utilizadores filtrantes com base nesse atributo. Selecione o botão **Guardar** para escoar quaisquer alterações.
