---
title: 'Tutorial: Integração do Diretório Ativo Azure com ProMaster (by Inlogik) | Microsoft Docs'
...
Quando clicar no azulejo ProMaster (by Inlogik) no Painel de Acesso, deverá ser automaticamente inscrito no ProMaster (by Inlogik) para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger o ProMaster (pela Inlogik) com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)