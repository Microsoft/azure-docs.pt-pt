...
2. **[Configure o sign-on único sem ligação de ponte](#configure-bridgeline-unbound-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
### <a name="configure-bridgeline-unbound-single-sign-on"></a>Configurar bridgeline unbound single sign-on
...
Quando clicar no azulejo Bridgeline Unbound no Painel de Acesso, deverá ser automaticamente inscrito na Bridgeline Unbound para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
