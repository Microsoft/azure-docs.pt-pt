...
2. **[Configure o Sign-On Único de Andromeda](#configure-andromeda-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **De Configuração Básica SAML,** se pretender configurar a aplicação no modo iniciado pelo **IDP,** execute os seguintes passos:
    ...
    ![Andromeda Domain e URLs informações únicas de súmrica](common/idp-intiated.png)
...
5. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
    ...
    ![Andromeda Domain e URLs informações únicas de súmrica](common/metadata-upload-additional-signon.png)
    ...
    > [!NOTE]
    > Estes valores não são reais. Irá atualizar o valor com o identificador real, URL de resposta e URL de inscrição, que é explicado mais tarde no tutorial.
...
Quando clicar no azulejo Andromeda no Painel de Acesso, deverá ser automaticamente inscrito no Andromeda para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
