...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Andromeda (Single Sign-On) com as suas contas do Azure AD.
...
* Andromeda logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Andromeda **SP e IDP** iniciada SSO
* Suporta Andromeda **Just In Time** aprovisionamento de utilizadores
...
Nesta secção, configure e teste do Azure AD início de sessão único com Andromeda com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Andromeda deve ser estabelecido.
...
2. **[Configurar Andromeda Single Sign-On](#configure-andromeda-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Andromeda](#create-andromeda-test-user)**  - para ter um equivalente da Eduarda Almeida na Andromeda que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Andromeda** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, execute os seguintes passos:
    ...
    ![Andromeda domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    ![Andromeda domínio e URLs únicas início de sessão em informações](common/metadata-upload-additional-signon.png)
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualizar o valor com o identificador de real, a URL de resposta e o URL de início de sessão que é explicado mais tarde no tutorial.

6. Aplicação de Andromeda espera que as asserções SAML num formato específico. Configure as seguintes declarações para esta aplicação. Pode gerir os valores destes atributos do **atributos de utilizador** secção na página de integração de aplicações. Sobre o **definido no início de sessão único com o SAML** página, clique em **editar** botão para abrir **atributos de utilizador** caixa de diálogo.
...
7. No **afirmações de utilizador** secção sobre o **atributos de utilizador** caixa de diálogo, editar as afirmações utilizando **ícone de edição** ou adicionar as afirmações utilizando **Adicionar nova afirmação**para configurar o atributo de token SAML conforme mostrado na imagem acima e execute os seguintes passos: 
    ...
    | ------ | -----------|
    | role        | Função de aplicação específica |
...
9. Sobre o **configurar Andromeda** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-andromeda-single-sign-on"></a>Configurar Andromeda início de sessão único

1. Início de sessão no site da sua empresa Andromeda como administrador.

2. Na parte superior da barra de menus, clique em **administrador** e navegue até à **administração**.

    ![Administrador de Andromeda](./media/andromedascm-tutorial/tutorial_andromedascm_admin.png)

3. No lado esquerdo da barra de ferramentas em **Interfaces** secção, clique em **configuração de SAML**.

    ![Andromeda saml](./media/andromedascm-tutorial/tutorial_andromedascm_saml.png)

4. Sobre o **configuração SAML do** secção de página, execute os seguintes passos:

    ![Andromeda config](./media/andromedascm-tutorial/tutorial_andromedascm_config.png)

    a. Verifique **ativar o SSO com SAML**.

    b. Sob **informações Andromeda** secção, copie a **SP identidade** valor e cole-o no **identificador** caixa de texto de **configuração básica de SAML** secção.

    c. Copiar o **URL de consumidor** valor e cole-o no **URL de resposta** caixa de texto de **configuração básica de SAML** secção.

    d. Copiar o **URL de início de sessão** valor e cole-o no **URL de início de sessão** caixa de texto de **configuração básica de SAML** secção.

    e. Sob **fornecedor de identidade de SAML** secção, escreva o nome do IDP.

    f. Na **início de sessão único no ponto final** caixa de texto, cole o valor de **URL de início de sessão** que, quando copiou do portal do Azure.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Andromeda**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Andromeda**.

    ![A ligação de Andromeda na lista de aplicações](common/all-applications.png)
...
Nesta secção, um usuário chamado Eduarda Almeida é criado na Andromeda. Andromeda suporta o aprovisionamento de utilizadores de just-in-time, que está ativado por predefinição. Não existe nenhum item de ação para nesta secção. Se um utilizador já não existir no Andromeda, é criado um novo após a autenticação. Se precisar de criar manualmente um utilizador, contacte [equipa de suporte de cliente Andromeda](https://www.ngcsoftware.com/support/).

### <a name="test-single-sign-on"></a>Testar o início de sessão único 

Nesta secção, vai testar a configuração do Azure AD única início de sessão com o painel de acesso.

Quando clica no mosaico Andromeda no painel de acesso, deve ser automaticamente sessão iniciada no Andromeda para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
