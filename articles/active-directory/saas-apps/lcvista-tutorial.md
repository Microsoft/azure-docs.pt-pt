---
title: 'Tutorial: Integração do Azure Ative Directory com a LCVista Microsoft Docs'
...
### <a name="configure-lcvista-single-sign-on"></a>Configurar o sign-on único da LCVista
...
2. Na secção **SAML Config,** consulte o **login Enable SAML** e introduza os detalhes como mencionado na imagem abaixo. 
    ...
    ![Configurar um único sign-on](./media/lcvista-tutorial/tutorial_lcvista_config.png)
...
Quando clicar no azulejo LCVista no Painel de Acesso, deverá ser automaticamente inscrito na LCVista para a qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
