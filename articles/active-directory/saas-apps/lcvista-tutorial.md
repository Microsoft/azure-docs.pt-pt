...
2. Na seção **configuração do SAML** , marque **habilitar logon do SAML** e insira os detalhes conforme mencionado na imagem abaixo. 
    ...
    ![Configurar logon único](./media/lcvista-tutorial/tutorial_lcvista_config.png)
...
Nesta seção, você criará um usuário chamado Brenda Simon no LCVista. Trabalhe com a [equipe de suporte ao cliente do LCVista](https://lcvista.com/contact) para adicionar os usuários na plataforma do LCVista. Os usuários devem ser criados e ativados antes de usar o logon único.
