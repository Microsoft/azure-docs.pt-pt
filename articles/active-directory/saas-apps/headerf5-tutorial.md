...
1. Você precisa importar o certificado de metadados para o F5 (baseado em cabeçalho), que será usado posteriormente no processo de instalação. Vá para **sistema > gerenciamento de certificados > tráfego gerenciamento de certificado > > lista de certificados SSL**. Clique na **importação** do canto direito

    ![Configuração de F5 (baseada em cabeçalho)](./media/headerf5-tutorial/configure12.png)
 
1. Além disso, você também precisa de um **certificado SSL** para`headerapp.superdemo.live`o nome do host (), neste exemplo, usamos o certificado curinga.

    ![Configuração de F5 (baseada em cabeçalho)](./media/headerf5-tutorial/configure13.png)

1. Ir para – **F5 (baseado em cabeçalho) Big-IP clique em acessar > configuração guiada > federação > provedor de serviços SAML**.
...
1. Criar um novo servidor virtual, especificar o **endereço de destino**, a **porta** de redirecionamento é opcional. Escolha o **certificado curinga** (ou o certificado que você carregou para o aplicativo) que carregamos anteriormente e a **chave privada associada**.
...
1. Em logon único, escolha **baseado em cabeçalho http**. Você pode adicionar outros cabeçalhos com base em seu aplicativo. Consulte o apêndice da lista de variáveis de sessão do SAML

    ![Configuração de F5 (baseada em cabeçalho)](./media/headerf5-tutorial/configure07.png) 

1. Contate a [equipe de suporte do cliente F5 (baseada em cabeçalho)](https://support.f5.com/csp/knowledge-center/software/BIG-IP?module=BIG-IP%20APM45) para ver **as propriedades** detalhes da documentação da verificação do ponto de extremidade

    ![Configuração de F5 (baseada em cabeçalho)](./media/headerf5-tutorial/configure08.png)

1. Contate a [equipe de suporte do cliente F5 (baseada em cabeçalho)](https://support.f5.com/csp/knowledge-center/software/BIG-IP?module=BIG-IP%20APM45) para obter **as propriedades de gerenciamento da sessão** detalhes da documentação.
