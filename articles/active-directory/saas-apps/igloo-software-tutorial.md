---
title: 'Tutorial: Integração do Azure Ative Directory com a Igloo Software Microsoft Docs'
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de inscrição, identificação e URL de resposta. Contacte [a equipa de suporte do Cliente do Igloo Software](https://www.igloosoftware.com/services/support) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-igloo-software-single-sign-on"></a>Configurar o software Igloo único sign-on
...
Quando clicar no azulejo do Software Igloo no Painel de Acesso, deverá ser automaticamente inscrito no Software Igloo para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
