---
title: 'Tutorial: Azure Ative Directory integração única (SSO) com a | De Faísca Comunitária Microsoft Docs'
...
Quando clicar no azulejo comunitário do Spark no Painel de Acesso, deverá ser automaticamente inscrito na Faísca Comunitária para a qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger a Faísca Comunitária com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)