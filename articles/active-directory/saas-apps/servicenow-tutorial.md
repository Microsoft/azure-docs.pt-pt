...
- [O que é o controlo de sessão no Microsoft Cloud App Security?](/cloud-app-security/protect-servicenow)

- [Como proteger o ServiceNow com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)