---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a Robin Microsoft Docs'
...
Quando clicar no azulejo Robin no Painel de Acesso, deverá ser automaticamente inscrito no Robin para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
