...
2. **[Configure veritas Enterprise Vault.cloud SSO Single Sign-On](#configure-veritas-enterprise-vaultcloud-sso-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    b. Na caixa **identifier,** utilize o URL de acordo com o Datacenter:
    ...
    c. Na caixa de texto **URL de resposta,** utilize o URL de acordo com o Datacenter:
    ...
    > [!NOTE]
    > Este valor não é real. Atualize este valor com o URL de inscrição real. Contacte a equipa de [suporte do Cliente SSO da Veritas Enterprise Para](https://www.veritas.com/support/.html) obter este valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-veritas-enterprise-vaultcloud-sso-single-sign-on"></a>Configurar Veritas Enterprise Vault.cloud SSO single sign-on
