...
3. In the User properties, perform the following steps.
    ...
    b. In the **User name** field type `brittasimon@yourcompanydomain.extension`. Por exemplo, BrittaSimon@contoso.com
...
1. On the **Add user** dialog page, perform the following steps:
    ...
    ![Add User](./media/talentlms-tutorial/IC777299.png "Adicionar Utilizador")  
