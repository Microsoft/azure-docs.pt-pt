...
2. **[Configure o Sign-On único talentLMs](#configure-talentlms-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
1. Clique **em um único sign-on (SSO)**,

1. Na secção 'Sign-On' único, execute os seguintes passos:
...
Quando clicar no azulejo TalentLMS no Painel de Acesso, deverá ser automaticamente inscrito no TalentLMS para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
