...
A integração do TalentLMS com a Azure AD proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso ao TalentLMS.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos no TalentLMS (Sign-On Único) com as suas contas AD Azure.
...
* Subscrição ativada por TalentLMS
...
4. Na caixa de pesquisa, escreva **TalentLMS,** selecione **TalentLMS** do painel de resultados e clique em **Adicionar** botão para adicionar a aplicação.

    ![TalentLMS na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar Azure AD único sinal de inscrição

Nesta secção, você configura e testa Azure AD single sign-on com TalentLMS com base em um utilizador de teste chamado **Britta Simon**.
Para um único sign-on para o trabalho, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado no TalentLMS.

Para configurar e testar o Azure AD com o TalentLMS, é necessário completar os seguintes blocos de construção:

1. **[Configure Azure AD Single Sign-On](#configure-azure-ad-single-sign-on)** - para permitir que os seus utilizadores utilizem esta funcionalidade.
2. **[Configure o Sign-On Único talentLMs](#configure-talentlms-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
3. Crie um utilizador de **[teste AD Azure](#create-an-azure-ad-test-user)** - para testar um único sinal de Azure com Britta Simon.
4. **[Atribua o utilizador de teste Azure AD](#assign-the-azure-ad-test-user)** - para permitir que Britta Simon utilize um único sinal de Azure.
5. **[Create TalentLMS test user](#create-talentlms-test-user)** - para ter uma contrapartida de Britta Simon em TalentLMS que está ligada à representação AD Ad Azure do utilizador.
...
Para configurar o Azure AD com o TalentLMS, execute os seguintes passos:
...
### <a name="configure-talentlms-single-sign-on"></a>Configurar o Sign-On Único talentlms
...
1. Na secção Single Sign-On, execute os seguintes passos:
    ...
    ![Único sign-on](./media/talentlms-tutorial/IC777297.png "Início de Sessão Único")
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso ao TalentLMS.

1. No portal Azure, selecione **Aplicações empresariais**, selecione **Todas as aplicações**e, em seguida, selecione **TalentLMS**.

    ![Painel Aplicações empresariais](common/enterprise-applications.png)

2. Na lista de candidaturas, selecione **TalentLMS**.

    ![A ligação TalentLMS na lista de Aplicações](common/all-applications.png)
...
Quando clicar no azulejo TalentLMS no Painel de Acesso, deverá ser automaticamente inscrito no TalentLMS para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
