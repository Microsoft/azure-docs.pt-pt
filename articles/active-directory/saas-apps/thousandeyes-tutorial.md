---
title: 'Tutorial: Azure Ative Directory integração única de sign-on (SSO) com MilEyes | Microsoft Docs'
...
* ThousandEyes suporta fornecimento [ **automatizado** de utilizadores](./thousandeyes-provisioning-tutorial.md)
...
Quando clicar no azulejo MilEyes no Painel de Acesso, deverá ser automaticamente inscrito no ThousandEyes para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Configurar o Provisionamento do Utilizador](./thousandeyes-provisioning-tutorial.md)