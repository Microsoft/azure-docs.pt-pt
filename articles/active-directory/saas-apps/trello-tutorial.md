---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a Trello Microsoft Docs'
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-trello"></a>Configurar e testar Azure AD único sinal para Trello
...
Para configurar e testar o Azure AD SSO com a Trello, complete os seguintes blocos de construção:
...
> [!NOTE]
> Devias ir buscar a **\<enterprise\>** bala ao Trello. Se não tiver o valor da lesma, contacte a equipa de apoio da [Trello](mailto:support@trello.com) para obter a lesma para a sua empresa.

Para configurar o Azure AD com trello, tome os seguintes passos:

1. No [portal Azure,](https://portal.azure.com/)na página de integração da aplicação **Trello,** encontre a secção **Gerir** e selecione **um único sinal de sação**.
...
1. Na secção **Configuração Básica SAML,** se pretender configurar a aplicação no modo iniciado pelo **IDP,** insira os valores para os seguintes campos:
    ...
    a. Na caixa de texto **identifier,** digite um URL: `https://trello.com/auth/saml/metadata`
...
Quando clicar no azulejo Trello no Painel de Acesso, deverá ser automaticamente inscrito no Trello para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
