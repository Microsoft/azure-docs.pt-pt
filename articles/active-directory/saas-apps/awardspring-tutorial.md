---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com PrêmioSpring Microsoft Docs'
...
Quando clicar no azulejo AwardSpring no Painel de Acesso, deverá ser automaticamente inscrito no AwardSpring para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
