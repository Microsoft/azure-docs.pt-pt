...
Neste tutorial, você vai aprender a integrar o AwardSpring com o Azure Ative Directory (Azure AD). Quando integrar o AwardSpring com a Azure AD, pode:

* Controlo em Azure AD que tem acesso a AwardSpring.
* Permita que os seus utilizadores sejam automaticamente inscritos no AwardSpring com as suas contas Azure AD.
...
* AwardSpring single sign-on (SSO) enabled subscrição.

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configura e testa o Azure AD SSO num ambiente de teste.

* AwardSpring apoia **SP e IDP** iniciadoS SSO
* AwardSpring suporta o fornecimento de utilizadores **justo no tempo**

## <a name="adding-awardspring-from-the-gallery"></a>Adicionar PrémioPrimavera da galeria
...
1. No Add da secção **galeria,** digite **AwardSpring** na caixa de pesquisa.
1. **Selecione AwardSpring** do painel de resultados e, em seguida, adicione a aplicação. Espere alguns segundos enquanto a aplicação é adicionada ao seu inquilino.

## <a name="configure-and-test-azure-ad-single-sign-on-for-awardspring"></a>Configure e teste Azure AD único sign-on para AwardSpring

Configure e teste Azure AD SSO com AwardSpring utilizando um utilizador de teste chamado **B.Simon**. Para que o SSO funcione, é necessário estabelecer uma relação de ligação entre um utilizador da AD Azure e o utilizador relacionado no AwardSpring.

Para configurar e testar o Azure AD SSO com a AwardSpring, complete os seguintes blocos de construção:

1. **[Configure Azure AD SSO](#configure-azure-ad-sso)** - para permitir que os seus utilizadores utilizem esta funcionalidade.
    * **[Crie um utilizador de teste Azure AD](#create-an-azure-ad-test-user)** - para testar o único sign-on da Azure AD com b.Simon.
    * Atribuir o utilizador de **[teste Azure AD](#assign-the-azure-ad-test-user)** - para permitir que b.Simon utilize um único sinal de AD Azure.
1. **[Configure AwardSpring SSO](#configure-awardspring-sso)** - para configurar as definições de inscrição únicas no lado da aplicação.
...
1. No [portal Azure,](https://portal.azure.com/)na página de integração de aplicações **da AwardSpring,** encontre a secção **Gerir** e selecione **um único sinal.**
...
1. A aplicação AwardSpring espera as afirmações do SAML num formato específico, o que requer que adicione mapeamentos personalizados de atributos à configuração de atributos de token SAML. A imagem que se segue mostra a lista de atributos predefinidos.

    ![image](common/default-attributes.png)

1. Além de acima, a aplicação AwardSpring espera que poucos atributos sejam retransmitidos na resposta SAML que são mostradas abaixo. Estes atributos também são pré-povoados, mas pode revê-los de acordo com os seus requisitos.
...
Nesta secção, um utilizador chamado B.Simon é criado em AwardSpring. AwardSpring suporta o fornecimento de utilizadores just-in-time, que é ativado por padrão. Não há nenhum item de ação para si nesta secção. Se um utilizador já não existir no AwardSpring, um novo é criado após a autenticação.

> [!Note]
> Se precisar de criar um utilizador manualmente, contacte a equipa de [suporte da AwardSpring](mailto:support@awardspring.com).
