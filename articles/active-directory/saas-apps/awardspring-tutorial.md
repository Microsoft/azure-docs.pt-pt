---
title: 'Tutorial: integração do Azure Active Directory com o AwardSpring | Microsoft Docs'
...
ms.locfileid: "73157774"
---
# <a name="tutorial-azure-active-directory-integration-with-awardspring"></a>Tutorial: integração do Azure Active Directory com o AwardSpring

Neste tutorial, você aprenderá a integrar o AwardSpring com o Azure Active Directory (Azure AD).
A integração do AwardSpring ao Azure AD oferece os seguintes benefícios:

* No Azure AD, é possível controlar quem tem acesso ao AwardSpring.
* Você pode permitir que seus usuários sejam conectados automaticamente ao AwardSpring (logon único) com suas contas do Azure AD.
...
Para configurar a integração do Azure AD ao AwardSpring, você precisará dos seguintes itens:
...
Nesta seção, você configurará e testará o logon único do Azure AD com o AwardSpring, com base em um usuário de teste chamado **Brenda Simon**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no AwardSpring.

Para configurar e testar o logon único do Azure AD com o AwardSpring, você precisa concluir os seguintes blocos de construção:

1. **[Configurar o logon único do Azure ad](#configure-azure-ad-single-sign-on)** – para habilitar seus usuários a usar esse recurso.
2. **[Configurar o logon único do AwardSpring](#configure-awardspring-single-sign-on)** – para configurar as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure ad](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com o Brenda Simon.
4. **[Atribuir o usuário de teste do Azure ad](#assign-the-azure-ad-test-user)** – para permitir que Brenda Simon use o logon único do Azure AD.
5. **[Criar usuário de teste do AwardSpring](#create-awardspring-test-user)** – para ter um equivalente de Brenda Simon no AwardSpring que esteja vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **AwardSpring** , selecione **logon único**.
...
4. Na seção **configuração básica do SAML** , se você quiser configurar o aplicativo no modo iniciado pelo **IDP** , execute as seguintes etapas:
    ...
    ![Informações de logon único de domínio e URLs do AwardSpring](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e execute a seguinte etapa se desejar configurar o aplicativo no modo iniciado pelo **SP** :
    ...
    ![Informações de logon único de domínio e URLs do AwardSpring](common/metadata-upload-additional-signon.png)
...
9. Na seção **Configurar AwardSpring** , copie as URLs apropriadas de acordo com seu requisito.
...
Para configurar o logon único no lado do **AwardSpring** , é necessário enviar o XML de **metadados de Federação** baixado e as URLs copiadas apropriadas de portal do Azure para a equipe de suporte do [AwardSpring](mailto:support@awardspring.com). Eles definem essa configuração para que a conexão de SSO do SAML seja definida corretamente em ambos os lados.
...
Nesta seção, você permitirá que Brenda Simon use o logon único do Azure concedendo acesso ao AwardSpring.

1. Na portal do Azure, selecione **aplicativos empresariais**, selecione **todos os aplicativos**e, em seguida, selecione **AwardSpring**.
...
Nesta seção, um usuário chamado Brenda Simon é criado em AwardSpring. O AwardSpring dá suporte ao provisionamento de usuário just-in-time, que é habilitado por padrão. Não há nenhum item de ação para você nesta seção. Se um usuário ainda não existir no AwardSpring, um novo será criado após a autenticação.
