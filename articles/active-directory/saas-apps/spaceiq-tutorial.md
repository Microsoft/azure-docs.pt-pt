...
### <a name="configure-spaceiq-single-sign-on"></a>Configurar o sign-on único spaceIQ
...
Quando clicar no azulejo SpaceIQ no Painel de Acesso, deverá ser automaticamente inscrito no SpaceIQ para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
