...
ms.locfileid: "68823739"
---
# <a name="tutorial-azure-active-directory-integration-with-floqast"></a>Tutorial: Integração do Azure Active Directory com o FloQast

Neste tutorial, você aprenderá a integrar o FloQast com o Azure Active Directory (Azure AD).
A integração do FloQast ao Azure AD oferece os seguintes benefícios:

* No Azure AD, é possível controlar quem tem acesso ao FloQast.
* Você pode permitir que seus usuários sejam conectados automaticamente ao FloQast (logon único) com suas contas do Azure AD.
...
**Para adicionar o FloQast da galeria, execute as seguintes etapas:**
...
Nesta seção, você configurará e testará o logon único do Azure AD com o FloQast, com base em um usuário de teste chamado **Brenda Simon**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no FloQast.
...
2. **[Configurar o logon único do FloQast](#configure-floqast-single-sign-on)** – para configurar as configurações de logon único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar usuário de teste do FloQast](#create-floqast-test-user)** – para ter um equivalente de Brenda Simon no FloQast que esteja vinculado à representação do usuário no Azure AD.
...
Para configurar o logon único do Azure AD com o FloQast, execute as seguintes etapas:

1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **FloQast** , selecione **logon único**.
...
6. O aplicativo FloQast espera as asserções SAML em um formato específico, o que exige que você adicione mapeamentos de atributo personalizados à sua configuração de atributos de token SAML. A captura de tela a seguir mostra a lista de atributos padrão. Clique no ícone **Editar** para adicionar os atributos.

    ![image](common/edit-attribute.png)

7. Além de acima, o aplicativo FloQast espera que mais alguns atributos sejam passados de volta na resposta SAML. Na seção **declarações do usuário** , na caixa de diálogo **atributos de usuário** , execute as seguintes etapas para adicionar o atributo de token SAML, conforme mostrado na tabela abaixo:
...
10. Na seção **Configurar FloQast** , copie as URLs apropriadas de acordo com seu requisito.
...
Nesta seção, você permitirá que Brenda Simon use o logon único do Azure concedendo acesso ao FloQast.

1. Na portal do Azure, selecione **aplicativos empresariais**, selecione **todos os aplicativos**e, em seguida, selecione **FloQast**.

    ![Folha aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **FloQast**.
...
Nesta seção, você criará um usuário chamado Brenda Simon no FloQast. Trabalhe com a [equipe de suporte do FloQast](mailto:support@floqast.com) para adicionar os usuários na plataforma do FloQast. Os utilizadores tem de ser criados e ativados antes de utilizar o início de sessão único.
