...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Insperity ExpensAble (Single Sign-On) com as suas contas do Azure AD.
...
* Insperity ExpensAble logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Insperity ExpensAble **SP** iniciada SSO
...
4. Na caixa de pesquisa, escreva **Insperity ExpensAble**, selecione **Insperity ExpensAble** a partir do painel de resultados, em seguida, clique nas **Add** botão para adicionar a aplicação.

     ![Insperity ExpensAble na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com Insperity ExpensAble com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Insperity ExpensAble deve ser estabelecido.
...
2. **[Configurar Insperity ExpensAble início de sessão único](#configure-insperity-expensable-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Insperity ExpensAble](#create-insperity-expensable-test-user)**  - para ter um equivalente da Eduarda Almeida na Insperity ExpensAble que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Insperity ExpensAble** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![Domínio de ExpensAble Insperity e URLs únicas início de sessão em informações](common/sp-signonurl.png)
...
6. Sobre o **configurar Insperity ExpensAble** secção, copie os URLs apropriados de acordo com seus requisitos.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Insperity ExpensAble**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Insperity ExpensAble**.

    ![A ligação Insperity ExpensAble na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico Insperity ExpensAble no painel de acesso, deve ser automaticamente sessão iniciada no ExpensAble Insperity para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
