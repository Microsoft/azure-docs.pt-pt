...
2. **[Configure insperidade Insperity Expensable Single Sign-On](#configure-insperity-expensable-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
### <a name="configure-insperity-expensable-single-sign-on"></a>Configurar insperidade expensável único sign-on
