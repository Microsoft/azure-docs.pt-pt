---
title: 'Tutorial: Azure Ative Directory integração única (SSO) com o Syxsense | Microsoft Docs'
...
Quando clicar no azulejo Syxsense no Painel de Acesso, deverá ser automaticamente inscrito no Syxsense para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger o Syxsense com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)