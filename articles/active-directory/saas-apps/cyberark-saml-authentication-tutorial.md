---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a Autenticação SAML cyberArk Microsoft Docs'
...
* Autenticação CyberArk SAML suporta **SP e IDP** iniciado SSO

## <a name="adding-cyberark-saml-authentication-from-the-gallery"></a>Adicionar autenticação SAML CyberArk da galeria
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-cyberark-saml-authentication"></a>Configurar e testar a Azure AD um único sinal para autenticação SAML CyberArk
...
Para configurar e testar o Azure AD SSO com a Autenticação SAML CyberArk, complete os seguintes blocos de construção:
...
1. No [portal Azure](https://portal.azure.com/), na página de integração da **aplicação CyberArk SAML Authentication,** encontre a secção **Gerir** e selecione um único sinal de **sação**.
...
1. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de resposta real e URL de inscrição. Contacte [a equipa de suporte do Cliente de Autenticação CyberArk SAML](mailto:bizdevtech@cyberark.com) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
Quando clicar no azulejo de autenticação CYBERArk SAML no Painel de Acesso, deverá ser automaticamente inscrito na Autenticação SAML CyberArk para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
- [Experimente a autenticação SAML CyberArk com Azure AD](https://aad.portal.azure.com/)