...
2. **[Configurar ScreenSteps Single Sign-On](#configure-screensteps-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > Este valor não é real. Atualize este valor com o URL de inscrição real, que é explicado mais tarde neste tutorial.
...
### <a name="configure-screensteps-single-sign-on"></a>Configurar screenSteps único sinal-on
