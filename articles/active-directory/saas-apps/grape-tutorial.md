...
4. Na caixa de pesquisa, escreva **Gra-Pe,** selecione **Gra-Pe** do painel de resultados e clique em Adicionar o botão **Adicionar** a aplicação.
...
Para configurar o Azure AD com gra-pe, execute os seguintes passos:

1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **Gra-Pe,** selecione **Single sign-on**.
...
6. Na secção **Configurar Gra-Pe,** copie os URL(s) apropriados de acordo com o seu requisito.
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso a Gra-Pe.
...
2. Na lista de candidaturas, selecione **Gra-Pe**.
    ...
    ![O link Gra-Pe na lista de Aplicações](common/all-applications.png)
...
Quando clicar no azulejo Gra-Pe no Painel de Acesso, deverá ser automaticamente inscrito no Gra-Pe para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
