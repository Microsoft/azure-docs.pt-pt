---
title: 'Tutorial: Integração do Azure Ative Directory com a SpringCM Microsoft Docs'
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de inscrição real. Contacte [a equipa de suporte do cliente SpringCM](https://knowledge.springcm.com/support) para obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.

4. Na **configuração de 'Sessão's single com página SAML,** na secção **Certificado de Assinatura SAML,** clique em **Baixar** para descarregar o **Certificado (Raw)** das opções dadas de acordo com o seu requisito e guardá-lo no seu computador.
...
### <a name="configure-springcm-single-sign-on"></a>Configurar springcm único sign-on
...
Quando clicar no azulejo SpringCM no Painel de Acesso, deverá ser automaticamente inscrito no SpringCM para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
