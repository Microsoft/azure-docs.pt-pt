 ...
 * É recomendável que um único usuário do Azure AD seja atribuído ao diretório federado para testar a configuração automática de provisionamento de usuário. Usuários e/ou grupos adicionais podem ser atribuídos posteriormente.
...
5. Copie o valor do **token de acesso** . Esse valor será inserido no campo **token secreto** na guia provisionamento do seu aplicativo de diretório federado no portal do Azure. 
