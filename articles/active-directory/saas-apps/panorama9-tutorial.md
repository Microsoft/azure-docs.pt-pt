...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Panorama9 (Single Sign-On) com as suas contas do Azure AD.
...
* Panorama9 logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Panorama9 **SP** iniciada SSO
...
4. Na caixa de pesquisa, escreva **Panorama9**, selecione **Panorama9** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.

     ![Panorama9 na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com Panorama9 com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Panorama9 deve ser estabelecido.
...
2. **[Configurar Panorama9 Single Sign-On](#configure-panorama9-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Panorama9](#create-panorama9-test-user)**  - para ter um equivalente da Eduarda Almeida na Panorama9 que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Panorama9** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![Panorama9 domínio e URLs únicas início de sessão em informações](common/sp-identifier.png)

    a. Na **iniciar sessão no URL** caixa de texto, escreva um URL: `https://dashboard.panorama9.com/saml/access/3262`

    b. Na **identificador (ID de entidade)** caixa de texto, escreva um URL com o seguinte padrão: `https://www.panorama9.com/saml20/<tenant-name>`

    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o início de sessão real URL e o identificador. Contacte [equipa de suporte de cliente Panorama9](https://support.panorama9.com/) obter esses valores. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.
...
7. Sobre o **configurar Panorama9** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-panorama9-single-sign-on"></a>Configurar Panorama9 início de sessão único

1. Numa janela do browser web diferente, inicie sessão no site da sua empresa Panorama9 como um administrador.

2. Na barra de ferramentas na parte superior, clique em **Manage**e, em seguida, clique em **extensões**.
   
    ![As extensões](./media/panorama9-tutorial/ic790023.png "extensões")

3. Sobre o **extensões** caixa de diálogo, clique em **Single Sign-On**.
   
    ![Início de sessão único](./media/panorama9-tutorial/ic790024.png "início de sessão único")

4. Na **definições** secção, execute os seguintes passos:
   
    ![As definições](./media/panorama9-tutorial/ic790025.png "definições")
   
    a. Na **URL de fornecedor de identidade** caixa de texto, cole o valor de **URL de início de sessão**, que copiou do portal do Azure.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Panorama9**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Panorama9**.

    ![A ligação de Panorama9 na lista de aplicações](common/all-applications.png)
...
### <a name="create-panorama9-test-user"></a>Criar utilizador de teste Panorama9

Para habilitar os utilizadores do Azure AD iniciar sessão no Panorama9, tem de ser aprovisionados em Panorama9.  
...
Quando clica no mosaico Panorama9 no painel de acesso, deve ser automaticamente sessão iniciada no Panorama9 para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
