...
A integração do Panorama9 com a Azure AD proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso ao Panorama9.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos no Panorama9 (Sign-on Único) com as suas contas AD Azure.
...
Para configurar a integração AD da Azure com o Panorama9, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode ter um mês de julgamento [aqui.](https://azure.microsoft.com/pricing/free-trial/)
* Subscrição ativada por panorama9

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configura e testa Azure AD um único sinal de acesso em um ambiente de teste.

* Panorama9 suporta **SSO** iniciado sp

## <a name="adding-panorama9-from-the-gallery"></a>Adicionar Panorama9 da galeria

Para configurar a integração do Panorama9 no Azure AD, é necessário adicionar o Panorama9 da galeria à sua lista de aplicações geridas pelo SaaS.
...
2. **[Configure o Panorama9 Single Sign-On](#configure-panorama9-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
3. Crie um utilizador de **[teste AD Azure](#create-an-azure-ad-test-user)** - para testar um único sinal de Azure com Britta Simon.
4. **[Atribua o utilizador de teste Azure AD](#assign-the-azure-ad-test-user)** - para permitir que Britta Simon utilize um único sinal de Azure.
5. **[Create Panorama9 test user](#create-panorama9-test-user)** - para ter uma contraparte de Britta Simon no Panorama9 que está ligada à representação AD AD do utilizador.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    ![Informações de sinalização de domínio e URLs panorama9](common/sp-identifier.png)

    a. Na caixa de texto **URL,** digite um URL: `https://dashboard.panorama9.com/saml/access/3262`

    b. Na caixa de texto **identifier (Entity ID),** digite um URL utilizando o seguinte padrão: `https://www.panorama9.com/saml20/<tenant-name>`

    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o sinal real no URL e no identificador. Contacte [a equipa de suporte ao cliente Panorama9](https://support.panorama9.com/) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
7. Na secção **Configurar Panorama9,** copie os URL(s) apropriados de acordo com o seu requisito.
...
### <a name="configure-panorama9-single-sign-on"></a>Configurar Panorama9 Single Sign-On
...
Para permitir que os utilizadores da Azure AD entrem no Panorama9, devem ser a provisionados no Panorama9.  
...
3. Na secção Utilizadores, Clique **+** para adicionar novo utilizador.
...
Quando clicar no azulejo Panorama9 no Painel de Acesso, deverá ser automaticamente inscrito no Panorama9 para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
