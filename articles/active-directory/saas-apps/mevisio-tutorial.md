---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com o Mevisio Microsoft Docs'
...
* Controlo em Azure AD que tem acesso a Mevisio.
* Ative os seus utilizadores a serem automaticamente inscritos no Mevisio com as suas contas AD Azure.
...
* Mevisio única inscrição (SSO) ativada subscrição.
...
* Mevisio suporta **provisão de** utilizadores just in time


## <a name="adding-mevisio-from-the-gallery"></a>Adicionando Mevisio da galeria

Para configurar a integração do Mevisio no AD Azure, precisa adicionar Mevisio da galeria à sua lista de aplicações geridas pelo SaaS.

1. Inscreva-se no portal Azure usando uma conta de trabalho ou escola, ou uma conta pessoal da Microsoft.
1. No painel de navegação à esquerda, selecione o serviço **Azure Ative Directory.**
1. Navegue para **aplicações empresariais** e, em seguida, selecione **Todas as Aplicações**.
1. Para adicionar nova aplicação, selecione **Nova aplicação**.
1. Na secção Adicionar da secção **da galeria,** **digite Mevisio** na caixa de pesquisa.
...
## <a name="configure-and-test-azure-ad-sso-for-mevisio"></a>Configurar e testar Azure AD SSO para Mevisio

Configure e teste Azure AD SSO com Mevisio usando um utilizador de teste chamado **B.Simon**. Para que o SSO funcione, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado no Mevisio.
...
1. **[Configure o Mevisio SSO](#configure-mevisio-sso)** - para configurar as definições de inscrição única no lado da aplicação.
    1. **[Create Mevisio test user](#create-mevisio-test-user)** - para ter uma contraparte de B.Simon em Mevisio que está ligada à representação AD AZure do utilizador.
...
1. No portal Azure, na página de integração da aplicação **Mevisio,** encontre a secção **Gerir** e selecione **um único sinal de sação**.
...
## <a name="configure-mevisio-sso"></a>Configurar Mevisio SSO
...
* Clique em **Testar esta aplicação** no portal Azure. Isto irá redirecionar para Mevisio Iniciar o teste de Sessão EM URL onde pode iniciar o fluxo de login.  

* Vá diretamente ao URL de inscrição do Mevisio e inicie o fluxo de login a partir daí.
