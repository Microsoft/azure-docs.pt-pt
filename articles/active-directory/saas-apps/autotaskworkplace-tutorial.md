...
2. **[Configure o sign-on único do local de trabalho de marcação](#configure-autotask-workplace-single-sign-on)** automática - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **De Configuração Básica SAML,** se pretender configurar a aplicação no modo iniciado pelo **IDP,** execute os seguintes passos:
    ...
    ![Autotask Workplace Domain e URLs informações únicas de súmis](common/idp-intiated.png)
...
5. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
    ...
    ![Autotask Workplace Domain e URLs informações únicas de súmis](common/metadata-upload-additional-signon.png)
...
### <a name="configure-autotask-workplace-single-sign-on"></a>Configurar autotask local de trabalho único sign-on
