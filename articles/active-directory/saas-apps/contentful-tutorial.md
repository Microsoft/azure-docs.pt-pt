---
title: 'Tutorial: integração de SSO (logon único) do Azure Active Directory com conteúdo | Microsoft Docs'
description: Saiba como configurar o logon único entre Azure Active Directory e conteúdo.
...
Neste tutorial, você aprenderá a integrar o conteúdo com o Azure Active Directory (Azure AD). Ao integrar o conteúdo com o Azure AD, você pode:

* Controle no Azure AD que tem acesso ao conteúdo.
* Habilite seus usuários a entrarem automaticamente no conteúdo com suas contas do Azure AD.
...
* Assinatura habilitada para SSO (logon único) com conteúdo.

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o SSO do Azure AD em um ambiente de teste.

* O conteúdo oferece suporte ao **SP e** ao SSO iniciado pelo IDP
...
Para configurar a integração do conteúdo com o Azure AD, você precisa adicionar conteúdo da Galeria à sua lista de aplicativos SaaS gerenciados.
...
Configure e teste o SSO do Azure AD com o conteúdo usando um usuário de teste chamado **B. Simon**. Para que o SSO funcione, você precisa estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado com conteúdo.

Para configurar e testar o SSO do Azure AD com o conteúdo, conclua os seguintes blocos de construção:

1. **[Configurar o SSO do Azure ad](#configure-azure-ad-sso)** – para permitir que os usuários usem esse recurso.
    * **[Criar um usuário de teste do Azure ad](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com B. Simon.
    * **[Atribuir o usuário de teste do Azure ad](#assign-the-azure-ad-test-user)** – para habilitar B. Simon para usar o logon único do Azure AD.
1. **[Configurar SSO com conteúdo](#configure-contentful-sso)** -para configurar as configurações de logon único no lado do aplicativo.
    * **[Criar usuário de teste do contently](#create-contentful-test-user)** – para ter um equivalente de B. Simon em conteúdo que esteja vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos com **conteúdo** , localize a seção **gerenciar** e selecione **logon único**.
...
Nesta seção, você habilitará B. Simon para usar o logon único do Azure concedendo acesso ao conteúdo.

1. Na portal do Azure, selecione **aplicativos empresariais**e, em seguida, selecione **todos os aplicativos**.
1. Na lista de aplicativos, selecione **conteúdo**.
...
Nesta seção, um usuário chamado B. Simon é criado com conteúdo. O conteúdo dá suporte ao provisionamento de usuário just-in-time, que é habilitado por padrão. Não há nenhum item de ação para você nesta seção. Se um usuário ainda não existir no conteúdo, um novo será criado após a autenticação.

## <a name="test-sso"></a>Testar SSO

Nesta seção, você testará sua configuração de logon único do Azure AD usando o painel de acesso.

Ao clicar no bloco conteúdo no painel de acesso, você deverá ser conectado automaticamente ao conteúdo para o qual você configurou o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Experimente o conteúdo com o Azure AD](https://aad.portal.azure.com/)