---
title: 'Tutorial: Integração do Azure Ative Directory com a TonicDM / Microsoft Docs'
...
2. **[Configure o Sign-On único da TonicDM](#configure-tonicdm-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-tonicdm-single-sign-on"></a>Configurar tonicdm único sign-on
...
Quando clicar no azulejo TonicDM no Painel de Acesso, deverá ser automaticamente inscrito no TonicDM para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
