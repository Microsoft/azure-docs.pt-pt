...
2. **[Configure logicMonitor single sign-on](#configure-logicmonitor-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-logicmonitor-single-sign-on"></a>Configurar logicMonitor único sinal-on
