---
title: 'Tutorial: Azure Active Directory integração de SSO (logon único) com CakeHR | Microsoft Docs'
...
1. **[Configurar o SSO do CakeHR](#configure-cakehr-sso)** – para configurar as configurações de logon único no lado do aplicativo.
    1. **[Criar usuário de teste do CakeHR](#create-cakehr-test-user)** – para ter um equivalente de B. Simon em CakeHR que esteja vinculado à representação do usuário no Azure AD.
