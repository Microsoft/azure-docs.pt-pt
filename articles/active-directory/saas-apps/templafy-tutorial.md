...
Quando clicar no azulejo TEMplafy SAML2 no Painel de Acesso, deverá ser automaticamente inscrito no TEMplafy SAML2 para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
