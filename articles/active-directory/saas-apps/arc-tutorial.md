---
title: 'Tutorial: integração do Azure Active Directory com a publicação Arc-SSO | Microsoft Docs'
...
ms.locfileid: "73152759"
---
# <a name="tutorial-azure-active-directory-integration-with-arc-publishing---sso"></a>Tutorial: integração de Azure Active Directory com a publicação Arc-SSO

Neste tutorial, você aprenderá a integrar o Arc Publishing-SSO com o Azure Active Directory (Azure AD).
A integração do Arc Publishing-SSO com o Azure AD oferece os seguintes benefícios:

* No Azure AD, é possível controlar quem tem acesso ao Arc Publishing-SSO.
* Você pode habilitar seus usuários a entrarem automaticamente no Arc Publishing-SSO (logon único) com suas contas do Azure AD.
...
Para configurar a integração do Azure AD com o Arc Publishing-SSO, você precisa dos seguintes itens:

* Uma assinatura do Azure AD. Se você não tiver um ambiente do Azure AD, poderá obter uma avaliação de um mês [aqui](https://azure.microsoft.com/pricing/free-trial/)
* Publicação de Arc-assinatura habilitada para logon único do SSO
...
**Para adicionar o Arc Publishing-SSO da galeria, execute as seguintes etapas:**
...
Nesta seção, você configurará e testará o logon único do Azure AD com o Arc Publishing-SSO, com base em um usuário de teste chamado **Brenda Simon**.
...
Para configurar e testar o logon único do Azure AD com o Arc Publishing-SSO, você precisa concluir os seguintes blocos de construção:

1. **[Configurar o logon único do Azure ad](#configure-azure-ad-single-sign-on)** – para habilitar seus usuários a usar esse recurso.
2. **[Configurar o logon único do Arc Publishing-SSO](#configure-arc-publishing---sso-single-sign-on)** -para configurar as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure ad](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com o Brenda Simon.
4. **[Atribuir o usuário de teste do Azure ad](#assign-the-azure-ad-test-user)** – para permitir que Brenda Simon use o logon único do Azure AD.
5. **[Criar usuário de teste do Arc Publishing-SSO](#create-arc-publishing---sso-test-user)** -para ter um equivalente de Brenda Simon no Arc Publishing-SSO vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Arc Publishing-SSO** , selecione **logon único**.
...
4. Na seção **configuração básica do SAML** , se você quiser configurar o aplicativo no modo iniciado pelo **IDP** , execute as seguintes etapas:
    ...
    ![Publicação Arc-informações de logon único de domínio e URLs do SSO](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e execute a seguinte etapa se desejar configurar o aplicativo no modo iniciado pelo **SP** :
    ...
    ![Publicação Arc-informações de logon único de domínio e URLs do SSO](common/metadata-upload-additional-signon.png)
...
1. Na seção **Configurar a publicação Arc-SSO** , copie as URLs apropriadas de acordo com seu requisito.
...
### <a name="configure-arc-publishing---sso-single-sign-on"></a>Configurar a publicação Arc-logon único SSO

Para configurar o logon único no lado do **Arc Publishing-SSO** , você precisa enviar o **certificado (Base64)** baixado e as URLs copiadas apropriadas de portal do Azure para a [equipe de suporte de publicação de SSO](mailto:inf@washpost.com). Eles definem essa configuração para que a conexão de SSO do SAML seja definida corretamente em ambos os lados.
...
Nesta seção, você permitirá que Brenda Simon use o logon único do Azure concedendo acesso ao Arc Publishing-SSO.

1. Na portal do Azure, selecione **aplicativos empresariais**, selecione **todos os aplicativos**e, em seguida, **publicação Arc-SSO**.

    ![Folha aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Arc Publishing-SSO**.

    ![O link de publicação de arco-SSO na lista de aplicativos](common/all-applications.png)
