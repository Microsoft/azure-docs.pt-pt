...
Para configurar um único sinal no lado **dos dias E,** você precisa enviar os metadados da **Federação XML** descarregados e URLs copiados apropriados do portal Azure para a [equipa de suporte e-days](https://support.e-days.com). Eles definiram esta definição para ter a ligação SAML SSO corretamente definida em ambos os lados.

### <a name="create-e-days-test-user"></a>Criar utilizadores de teste e-days

Nesta secção, cria-se um utilizador chamado B.Simon nos dias E. Trabalhe com a [equipa de suporte e-days](https://support.e-days.com) para adicionar os utilizadores na plataforma E-days. Os utilizadores devem ser criados e ativados antes de utilizar um único sinal.
