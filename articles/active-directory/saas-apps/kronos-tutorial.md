---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a Kronos Microsoft Docs'
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-kronos"></a>Configurar e testar Azure AD único sinal para a Kronos
...
Para configurar e testar a Azure AD SSO com a Kronos, complete os seguintes blocos de construção:
...
Quando clicar no azulejo kronos no Painel de Acesso, deverá ser automaticamente inscrito no Kronos para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
