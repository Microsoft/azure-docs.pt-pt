...
Para configurar um único sign-on no lado da **Kronos,** você precisa enviar o descarregamento **da Federação Metadados XML** e URLs copiados apropriados do portal Azure para a equipa de [suporte da Kronos](https://www.kronos.in/contact/en-in/form). Eles definiram esta definição para ter a ligação SAML SSO corretamente definida em ambos os lados.

### <a name="create-kronos-test-user"></a>Criar o utilizador de teste da Kronos

Nesta secção, cria-se uma utilizadora chamada Britta Simon em Kronos. Trabalhe com a equipa de suporte da [Kronos](https://www.kronos.in/contact/en-in/form) para adicionar os utilizadores na plataforma Kronos. Os utilizadores devem ser criados e ativados antes de utilizar um único sinal.
