---
title: 'Tutorial: Integração do Azure Ative Directory com Grafite Hospedada Microsoft Docs'
...
2. **[Configure o signo único](#configure-hosted-graphite-single-sign-on)** de grafite alojado - para configurar as definições de Sign-On único no lado da aplicação.
...
### <a name="configure-hosted-graphite-single-sign-on"></a>Configurar o sign-on único de grafite hospedado
...
Quando clicar no azulejo de Grafite Hospedado no Painel de Acesso, deverá ser automaticamente inscrito no Grafite Hospedado para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
