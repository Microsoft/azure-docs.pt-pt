---
title: 'Tutorial: Azure Ative Directory integração única de sign-on (SSO) com textline | Microsoft Docs'
...
Quando clicar no azulejo Textline no Painel de Acesso, deverá ser automaticamente inscrito na Linha de Texto para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger a Textline com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)