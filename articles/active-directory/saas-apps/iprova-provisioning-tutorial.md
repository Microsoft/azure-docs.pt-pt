---
title: 'Tutorial: Configurar iProva para fornecimento automático de utilizadores com Azure Ative Directory | Microsoft Docs'
...
O objetivo deste tutorial é demonstrar os passos a serem realizados no iProva e no Azure Ative Directory (Azure AD) para configurar a Azure AD para provisão automática e desaprovisionamento de utilizadores e/ou grupos para [o iProva](https://www.iProva.com/). Para obter detalhes importantes sobre o que este serviço faz, como funciona e perguntas frequentes, veja [Automatizar o aprovisionamento e desaprovisionamento de utilizadores em aplicações SaaS no Azure Active Directory](../app-provisioning/user-provisioning.md). 
...
> * [Único sinal para](./iprova-tutorial.md) iProva (recomendado)
...
3. Determine quais os dados a [mapear entre Azure AD e iProva](../app-provisioning/customize-application-attributes.md). 
