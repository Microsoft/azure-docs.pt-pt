...
2. **[Configure o sign-on único do workrite](#configure-workrite-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de inscrição real. Contacte [a equipa de suporte do Cliente Workrite](mailto:support@workrite.co.uk) para obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-workrite-single-sign-on"></a>Configurar o sign-on único do workrite
...
Quando clicar no azulejo workrite no Painel de Acesso, deverá ser automaticamente inscrito no Workrite para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
