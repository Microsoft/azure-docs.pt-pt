...
Para configurar um único sinal no lado **do ShipHazmat,** você precisa enviar o Url de **Metadados da Federação de Aplicações** para a equipe de [suporte ShipHazmat](mailto:support@bureaudg.com). Eles definiram esta definição para ter a ligação SAML SSO corretamente definida em ambos os lados.
