---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com TimeOffManager Microsoft Docs'
...
Quando clicar no azulejo TimeOffManager no Painel de Acesso, deverá ser automaticamente inscrito no TimeOffManager para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
