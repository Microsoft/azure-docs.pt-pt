---
title: 'Tutorial: integração de SSO (logon único) do Azure Active Directory com o TimeOffManager | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-timeoffmanager"></a>Tutorial: integração de SSO (logon único) do Azure Active Directory com o TimeOffManager

Neste tutorial, você aprenderá a integrar o TimeOffManager com o Azure Active Directory (Azure AD). Ao integrar o TimeOffManager ao Azure AD, você pode:

* Controle no Azure AD quem tem acesso ao TimeOffManager.
* Habilite seus usuários a serem conectados automaticamente ao TimeOffManager com suas contas do Azure AD.
...
* Assinatura habilitada para SSO (logon único) do TimeOffManager.
...
1. Na seção **Adicionar da Galeria** , digite **TimeOffManager** na caixa de pesquisa.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-timeoffmanager"></a>Configurar e testar o logon único do Azure AD para o TimeOffManager

Configure e teste o SSO do Azure AD com o TimeOffManager usando um usuário de teste chamado **B. Simon**. Para que o SSO funcione, você precisa estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no TimeOffManager.
...
1. **[Configurar o SSO do TimeOffManager](#configure-timeoffmanager-sso)** – para configurar as configurações de logon único no lado do aplicativo.
    1. **[Criar usuário de teste do TimeOffManager](#create-timeoffmanager-test-user)** – para ter um equivalente de B. Simon em TimeOffManager que esteja vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **TimeOffManager** , localize a seção **gerenciar** e selecione **logon único**.
...
1. O aplicativo TimeOffManager espera as asserções SAML em um formato específico, o que exige que você adicione mapeamentos de atributo personalizados à sua configuração de atributos de token SAML. A captura de tela a seguir mostra a lista de atributos padrão.

    ![imagem](common/edit-attribute.png)

1. Além de acima, o aplicativo TimeOffManager espera que mais alguns atributos sejam passados de volta na resposta SAML, que são mostrados abaixo. Esses atributos também são preenchidos previamente, mas você pode examiná-los de acordo com seu requisito.
...
1. Na seção **Configurar TimeOffManager** , copie as URLs apropriadas com base em seu requisito.
...
Nesta seção, você habilitará B. Simon para usar o logon único do Azure concedendo-lhe acesso ao TimeOffManager.
...
2. Acesse **conta \> opções de conta \> configurações de logon único**.
...
- [Experimente o TimeOffManager com o Azure AD](https://aad.portal.azure.com/)
