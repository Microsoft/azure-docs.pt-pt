...
* Assim que configurar o Azure AD SAML Toolkit, pode impor o Controlo de Sessão, que protege a exfiltração e infiltração dos dados sensíveis da sua organização em tempo real. O Controlo de Sessão estende-se a partir do Acesso Condicional. [Saiba como impor o controlo da sessão com a Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-aad)
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-azure-ad-saml-toolkit"></a>Configurar e testar a Azure AD um único sinal para o Azure AD SAML Toolkit
...
Para configurar e testar o Azure AD SSO com o Azure AD SAML Toolkit, complete os seguintes blocos de construção:
...
1. **[Configure Azure AD SAML Toolkit SSO](#configure-azure-ad-saml-toolkit-sso)** - para configurar as definições de inscrição única no lado da aplicação.
    1. Crie o utilizador de **[teste Azure AD SAML Toolkit](#create-azure-ad-saml-toolkit-test-user)** - para ter uma contraparte de B.Simon em Azure AD SAML Toolkit que está ligada à representação AD AD do utilizador.
...
1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **Azure AD SAML,** encontre a secção **Gerir** e selecione **um único sinal de saúde**.
...
1. Na página **de Configuração Básica SAML,** insira os valores para os seguintes campos:
    ...
    a. Na caixa de texto **URL,** digite um URL: `https://samltoolkit.azurewebsites.net/`

    b. Na caixa de texto **identifier (Entity ID),** digite um URL: `https://samltoolkit.azurewebsites.net`

    c. Na caixa de texto **URL de resposta,** digite um URL: `https://samltoolkit.azurewebsites.net/SAML/Consume`

    > [!NOTE]
    > Estes valores não são valores reais. Atualize estes valores com o sinal real nos valores URL, Identifier e Answer URL, que é explicado mais tarde no tutorial.
...
Quando clicar no telha Azure AD SAML Toolkit no Painel de Acesso, deverá ser automaticamente inscrito no Kit de Ferramentas Azure AD SAML para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
- [Experimente o Azure AD SAML Toolkit com Azure AD](https://aad.portal.azure.com/)

- [O que é o controlo de sessão no Microsoft Cloud App Security?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Como proteger o Azure AD SAML Toolkit com visibilidade e controlos avançados](https://docs.microsoft.com/cloud-app-security/protect-azure)