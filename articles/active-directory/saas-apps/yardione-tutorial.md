---
title: 'Tutorial: Integração do Azure Ative Directory com a YardiOne Microsoft Docs'
...
2. **[Configure yardiOne single sign-on](#configure-yardione-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo YardiOne no Painel de Acesso, deverá ser automaticamente inscrito no YardiOne para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
