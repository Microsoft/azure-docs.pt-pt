...
2. **[Configure rackspace SSO Single Sign-On](#configure-rackspace-sso-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo Rackspace SSO no Painel de Acesso, deverá ser automaticamente inscrito no Rackspace SSO para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
