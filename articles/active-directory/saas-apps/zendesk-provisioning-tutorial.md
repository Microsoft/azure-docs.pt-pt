...
1. Inicie sessão para o [portal do Azure](https://portal.azure.com) e selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Zendesk**.
...
6. O **segredo de Token** para o Zendesk conta está localizada na **administração > API > definições**.
   Certifique-se de que **Token de acesso** está definida como **ativado**.
    ...
    ![Aprovisionamento do Zendesk](./media/zendesk-provisioning-tutorial/ZenDesk4.png)

    ![Aprovisionamento do Zendesk](./media/zendesk-provisioning-tutorial/ZenDesk2.png)
