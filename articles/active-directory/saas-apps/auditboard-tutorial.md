...
4. Na secção **De Configuração Básica SAML,** se pretender configurar a aplicação no modo **iniciado pelo IDP,** execute os seguintes passos:
    ...
    ![AuditBoard Domain e URLs informações únicas de acesso](common/idp-intiated.png)
    ...
    ![AuditBoard Domain e URLs informações únicas de acesso](common/metadata-upload-additional-signon.png)
...
Quando clicar no telha Do AuditBoard no Painel de Acesso, deverá ser automaticamente inscrito no AuditBoard para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
