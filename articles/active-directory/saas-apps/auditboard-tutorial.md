...
5. **[Criar utilizador de teste AuditBoard](#create-auditboard-test-user)**  - para ter um equivalente da Eduarda Almeida na AuditBoard que está ligado à representação de utilizador do Azure AD.
