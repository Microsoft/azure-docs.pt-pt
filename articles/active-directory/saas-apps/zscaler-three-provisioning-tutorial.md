...
3. Para adicionar Zscaler três, clique a **nova aplicação** botão na parte superior da caixa de diálogo.

    ![O novo botão de aplicativo][3]

4. Na caixa de pesquisa, escreva **Zscaler três**.

    ![Aprovisionamento do Zscaler três](./media/zscaler-three-provisioning-tutorial/app-search.png)

5. No painel de resultados, selecione **Zscaler três**e, em seguida, clique nas **Add** botão para adicionar Zscaler três à sua lista de aplicações SaaS.

    ![Aprovisionamento do Zscaler três](./media/zscaler-three-provisioning-tutorial/app-search-results.png)

    ![Aprovisionamento do Zscaler três](./media/zscaler-three-provisioning-tutorial/app-creation.png)
...
2. Selecione Zscaler três da sua lista de aplicações SaaS.

    ![Aprovisionamento do Zscaler três](./media/zscaler-three-provisioning-tutorial/app-instance-search.png)
