...
* Recomenda-se que um único utilizador da AD Azure seja atribuído a 4me para testar a configuração automática de fornecimento do utilizador. Posteriormente, os utilizadores e/ou grupos adicionais podem ser atribuídos.
...
> [!TIP]
> Também pode optar por ativar um único sinal baseado em SAML para 4me, seguindo as instruções fornecidas no tutorial de [inscrição individual 4me](4me-tutorial.md). O único sinal de inscrição pode ser configurado independentemente do fornecimento automático do utilizador, embora estas duas funcionalidades se elogiem mutuamente.
