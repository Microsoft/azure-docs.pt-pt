...
3. Na secção **Preferência de Candidatura,** execute os seguintes passos:
    ...
    c. Selecione **SAML** do menu drop down com a posição **Iniciar sins com .**
...
Quando clicar no azulejo TimeLive no Painel de Acesso, deverá ser automaticamente inscrito no TimeLive para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
