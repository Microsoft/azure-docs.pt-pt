---
title: 'Tutorial: Integração do Azure Ative Directory com a Acadia Microsoft Docs'
...
2. **[Configure o Sign-On Único da Acadia](#configure-acadia-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **De Configuração Básica SAML,** se pretender configurar a aplicação no modo iniciado pelo **IDP,** execute os seguintes passos:
    ...
    ![Informações de assinatura única do domínio de Acadia e URLs](common/idp-intiated.png)
...
Quando clicar no azulejo de Acádia no Painel de Acesso, deverá ser automaticamente inscrito no Acádia para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
