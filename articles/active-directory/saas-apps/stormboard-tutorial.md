...
2. **[Configure o sign-on único do stormboard](#configure-stormboard-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
5. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de resposta real e URL de inscrição. Contacte [a equipa de suporte do Cliente Stormboard](mailto:support@stormboard.com) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-stormboard-single-sign-on"></a>Configurar o sign-on único do stormboard
