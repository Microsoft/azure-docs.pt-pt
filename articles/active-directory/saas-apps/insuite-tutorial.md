---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com insutimento Microsoft Docs'
...
Quando clicar no azulejo insumita no Painel de Acesso, deverá ser automaticamente inscrito no insuiite para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
- [Como proteger o insuito com visibilidade e controlos avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)