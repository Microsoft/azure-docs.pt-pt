---
title: 'Tutorial: Integração do Azure Ative Directory com Evidence.com Microsoft Docs'
...
Quando clicar no azulejo Evidence.com no Painel de Acesso, deverá ser automaticamente inscrito no Evidence.com para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
