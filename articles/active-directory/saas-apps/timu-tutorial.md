---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a TIMU Microsoft Docs'
...
* Pode utilizar o Microsoft Access Panel. Quando clicar no azulejo TIMU no Painel de Acesso, este será redirecionado para URL de inscrição timu. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
