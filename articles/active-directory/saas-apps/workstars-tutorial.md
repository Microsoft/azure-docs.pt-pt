---
title: 'Tutorial: Integração do Azure Ative Directory com a Workstars Microsoft Docs'
...
Quando clicar no azulejo workstars no Painel de Acesso, deverá ser automaticamente inscrito nas Workstars para as quais configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
