---
title: 'Tutorial: Integração do Azure Ative Directory com a Convercent Microsoft Docs'
...
Quando clicar no azulejo Convercent no Painel de Acesso, deverá ser automaticamente inscrito no Convercent para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
