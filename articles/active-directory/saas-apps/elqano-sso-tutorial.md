---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com Elqano SSO / Microsoft Docs'
...
Quando clicar no azulejo Elqano SSO no Painel de Acesso, deverá ser automaticamente inscrito no Elqano SSO para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
- [Como proteger o Elqano SSO com visibilidade e controlos avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)