...
* Uma vez configurado Zoho One China, pode impor o controlo de sessão, que protege a exfiltração e infiltração dos dados sensíveis da sua organização em tempo real. O controlo da sessão estende-se a partir do Acesso Condicional. [Saiba como impor o controlo da sessão com o Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-zoho-one-china"></a>Configurar e testar Azure AD único sign-on para Zoho One China
...
Para configurar e testar a Azure AD SSO com o Zoho One China, complete os seguintes blocos de construção:
...
1. No [portal Azure](https://portal.azure.com/), na página de integração de aplicações **Zoho One China,** encontre a secção **Gerir** e selecione um único sinal de **sação**.
...
Quando clicar no azulejo Zoho One China no Painel de Acesso, deverá ser automaticamente inscrito no Zoho One China para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger o Zoho One China com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)