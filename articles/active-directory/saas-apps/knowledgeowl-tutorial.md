...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para KnowledgeOwl (Single Sign-On) com as suas contas do Azure AD.
...
* KnowledgeOwl logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta KnowledgeOwl **SP e IDP** iniciada SSO
* Suporta KnowledgeOwl **Just In Time** aprovisionamento de utilizadores
...
Nesta secção, configure e teste do Azure AD início de sessão único com KnowledgeOwl com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no KnowledgeOwl deve ser estabelecido.
...
2. **[Configurar KnowledgeOwl Single Sign-On](#configure-knowledgeowl-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste KnowledgeOwl](#create-knowledgeowl-test-user)**  - para ter um equivalente da Eduarda Almeida na KnowledgeOwl que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **KnowledgeOwl** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, execute os seguintes passos:
    ...
    ![KnowledgeOwl domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    ![KnowledgeOwl domínio e URLs únicas início de sessão em informações](common/metadata-upload-additional-signon.png)
...
9. Sobre o **configurar KnowledgeOwl** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-knowledgeowl-single-sign-on"></a>Configurar KnowledgeOwl Single Sign-On

1. Numa janela do browser web diferente, inicie sessão no site da sua empresa KnowledgeOwl como administrador.
...
1. Desloque-se para **SAML SSO integração** e execute os seguintes passos:
    ...
    b. Copiar o **ID de entidade de SP** valor e cole-o no **identificador (ID de entidade)** no **configuração básica de SAML** secção no portal do Azure.

    c. Copiar o **URL de início de sessão de SP** valor e cole-o no **URL de início de sessão e o URL de resposta** caixas de texto no **configuração básica de SAML** secção no portal do Azure.

    d. Na **IdP entityID** caixa de texto, colar a **do Azure AD identificador** valor, que copiou do portal do Azure.

    e. Na **URL de início de sessão do IdP** caixa de texto, colar a **URL de início de sessão** valor, que copiou do portal do Azure.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **KnowledgeOwl**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **KnowledgeOwl**.

    ![A ligação de KnowledgeOwl na lista de aplicações](common/all-applications.png)
...
Nesta secção, um usuário chamado Eduarda Almeida é criado na KnowledgeOwl. KnowledgeOwl suporta o aprovisionamento de utilizadores de just-in-time, que está ativado por predefinição. Não existe nenhum item de ação para nesta secção. Se um utilizador já não existir no KnowledgeOwl, é criado um novo após a autenticação.
...
Quando clica no mosaico KnowledgeOwl no painel de acesso, deve ser automaticamente sessão iniciada no KnowledgeOwl para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
