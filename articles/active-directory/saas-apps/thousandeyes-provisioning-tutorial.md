...
* Recomenda-se que um único utilizador da AD Azure seja atribuído à ThousandEyes para testar a configuração de provisionamento. Posteriormente, os utilizadores e/ou grupos adicionais podem ser atribuídos.
...
10. Na secção **DeMapeamentos de Atributos,** reveja os atributos do utilizador que são sincronizados de Azure AD para ThousandEyes. Os atributos selecionados como propriedades **Correspondentes** são usados para combinar as contas de utilizador em ThousandEyes para operações de atualização. Selecione o botão Guardar para elegiro qualquer alteração.
