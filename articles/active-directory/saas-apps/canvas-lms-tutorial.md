...
* Pode utilizar as minhas apps do Microsoft. Quando clicar no azulejo de Tela nas Minhas Apps, deverá ser automaticamente inscrito na Tela para a qual configura o SSO. Para obter mais informações sobre as Minhas Apps, consulte [Introdução às Minhas Aplicações.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
