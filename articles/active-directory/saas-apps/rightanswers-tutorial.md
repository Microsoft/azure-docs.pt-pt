...
> [!NOTE]
> Você pode usar qualquer outra ferramenta de criação de conta de usuário RightAnswers ou APIs fornecidas pelo RightAnswers para provisionar contas de usuário do Azure AD.
