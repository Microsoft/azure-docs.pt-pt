---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com Soluções Timetabling Microsoft Docs'
...
Quando clicar no azulejo de Soluções de Tempo no Painel de Acesso, deverá ser automaticamente inscrito nas Soluções de Timetabling para as quais configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
- [Como proteger soluções de timetabling com visibilidade e controlos avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
