...
Para configurar um único login no lado do **Code42,** precisa enviar o Url de **Metadados da Federação de Aplicações** para a equipa de [suporte code42](mailto:idpsupport@code42.com). Eles definiram esta definição para ter a ligação SAML SSO corretamente definida em ambos os lados.

### <a name="create-code42-test-user"></a>Criar o utilizador de teste do Código42

Nesta secção, cria-se um utilizador chamado B.Simon no Código42. Trabalhe com a equipa de suporte do [Code42](mailto:idpsupport@code42.com) para adicionar os utilizadores na plataforma Code42. Os utilizadores devem ser criados e ativados antes de utilizar um único sinal.
