---
title: 'Tutorial: integração de SSO (logon único) do Azure Active Directory com o BenSelect | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-benselect"></a>Tutorial: integração de SSO (logon único) do Azure Active Directory com o BenSelect
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-benselect"></a>Configurar e testar o logon único do Azure AD para o BenSelect
...
1. **[Configurar o SSO do BenSelect](#configure-benselect-sso)** – para configurar as configurações de logon único no lado do aplicativo.
    1. **[Criar usuário de teste do BenSelect](#create-benselect-test-user)** – para ter um equivalente de B. Simon em BenSelect que esteja vinculado à representação do usuário no Azure AD.
...
1. O aplicativo BenSelect espera as asserções SAML em um formato específico, o que exige que você adicione mapeamentos de atributo personalizados à sua configuração de atributos de token SAML. A captura de tela a seguir mostra a lista de atributos padrão.

    ![imagem](common/edit-attribute.png)

1. Clique no ícone **Editar** para editar o **valor do identificador de nome**.

    ![imagem](media/benselect-tutorial/mail-prefix1.png)

1. Na seção **gerenciar declarações do usuário** , execute as seguintes etapas:

    ![imagem](media/benselect-tutorial/mail-prefix2.png)
...
- [Experimente o BenSelect com o Azure AD](https://aad.portal.azure.com/)
