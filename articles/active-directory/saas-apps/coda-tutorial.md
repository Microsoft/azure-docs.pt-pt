---
title: 'Tutorial: Azure Ative Directory integração única (SSO) com Coda | Microsoft Docs'
...
Quando clicar no azulejo Coda no Painel de Acesso, deverá ser automaticamente inscrito no Coda para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger a Coda com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)