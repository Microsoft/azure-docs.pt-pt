---
title: 'Tutorial: Integração única de sign-on (SSO) do Azure Ative Directory com controlo de nuvens C3M | Microsoft Docs'
...
Quando clicar no azulejo do Controlo de Nuvem C3M no Painel de Acesso, deverá ser automaticamente inscrito no Controlo de Nuvem C3M para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger o Controlo de Nuvens C3M com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)