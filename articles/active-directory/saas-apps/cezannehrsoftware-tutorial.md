...
Quando clicar no azulejo do Software RH cezanne no Painel de Acesso, deverá ser automaticamente inscrito no Software RH cezanne para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
