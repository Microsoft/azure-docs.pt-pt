...
2. **[Configure determinado sinal único Admin SSO](#configure-certain-admin-sso-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
### <a name="configure-certain-admin-sso-single-sign-on"></a>Configure determinado sinal único de Admin SSO
