---
title: 'Tutorial: Integração do Azure Ative Directory com Serviços de Gestão de Atendimentos Microsoft Docs'
...
2. **[Configure os serviços de gestão de assistência único sign-on](#configure-attendance-management-services-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-attendance-management-services-single-sign-on"></a>Configurar serviços de gestão de assistência único só sign-on
