...
### <a name="configure-policystat-single-sign-on"></a>Configurar policyStat único sign-on
...
3. Clique nos **metadados IDP**e, em seguida, na secção **de metadados IDP,** execute os seguintes passos:
    ...
    ![Configuração única de inscrição](./media/policystat-tutorial/ic808636.png "Configuração única de inscrição")
...
5. Na secção **Configuração,** selecione **Ativar a Integração de Sinais únicos**.
    ...
    ![Configuração única de inscrição](./media/policystat-tutorial/ic808634.png "Configuração única de inscrição")
...
Quando clicar no azulejo PolicyStat no Painel de Acesso, deverá ser automaticamente inscrito no PolicyStat para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
