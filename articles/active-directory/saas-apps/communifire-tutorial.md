...
2. **[Configure o Sign-On Único do Communifire](#configure-communifire-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
### <a name="configure-communifire-single-sign-on"></a>Configurar o Sign-On Único de Communifire
...
Quando clicar no azulejo de fogo communi no Painel de Acesso, deverá ser automaticamente inscrito no Communifire para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
