...
2. **[Configure O SSO Abstrato](#configure-abstract-sso)** - para configurar as definições de Sign-On único no lado da aplicação.
...
Encontrará essas informações na **página 'set up's Single'On com a página SAML:**
...
Quando clicar no azulejo Abstrato no Painel de Acesso, deverá ser automaticamente inscrito no Resumo para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
