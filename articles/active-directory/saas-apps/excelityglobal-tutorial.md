...
2. **[Configure excelityGlobal Single Sign-On](#configure-excelityglobal-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
Quando clicar no azulejo ExcelityGlobal no Painel de Acesso, deverá ser automaticamente inscrito no ExcelityGlobal para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
