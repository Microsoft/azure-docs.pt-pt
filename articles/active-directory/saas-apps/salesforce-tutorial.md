...
4. Na caixa de pesquisa, escreva **Salesforce**, selecione **Salesforce** a partir do painel de resultados, em seguida, clique nas **Add** botão para adicionar a aplicação.
