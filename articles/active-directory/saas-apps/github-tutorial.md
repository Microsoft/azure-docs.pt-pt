...
* Controlo em Azure AD que tem acesso ao GitHub.
* Ative que os seus utilizadores sejam automaticamente inscritos no GitHub com as suas contas Azure AD.
...
* GitHub suporta fornecimento [ **automatizado** de utilizadores](github-provisioning-tutorial.md)
...
1. Na secção **Basic SAML Configuration,** introduza os valores para os seguintes campos:
   ...
   a. No **Sign on URL** text box, digite um URL utilizando o seguinte padrão: `https://github.com/orgs/<entity-id>/sso`
    ...
    b. Na caixa de texto **identificador (Id** da entidade), escreva um URL utilizando o seguinte padrão: `https://github.com/orgs/<entity-id>`
...
2. Clique em **Pessoas**.
    ...
    ![Pessoas](./media/github-tutorial/tutorial_github_config_github_08.png "People")
