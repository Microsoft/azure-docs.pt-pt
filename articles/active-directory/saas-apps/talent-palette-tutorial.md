---
title: 'Tutorial: Integração do Azure Ative Directory com | de Paleta de Talentos Microsoft Docs'
...
Integrar a Paleta de Talentos com Azure AD proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso a Talent Palette.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos na Paleta de Talentos (Single Sign-On) com as suas contas AD Azure.
...
Para configurar a integração AD do Azure com a Paleta de Talentos, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode ter um mês de julgamento [aqui.](https://azure.microsoft.com/pricing/free-trial/)
* Assinatura ativada por uma única paleta de talento
...
Para configurar a integração da Talent Palette no Azure AD, é necessário adicionar a Paleta de Talento da galeria à sua lista de aplicações geridas pelo SaaS.
...
4. Na caixa de pesquisa, escreva **Paleta de Talento,** selecione Paleta de **Talento** do painel de resultados e clique em Adicionar o botão **Adicionar** a aplicação.

     ![Paleta de Talentos na lista de resultados](common/search_new_app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar Azure AD único sinal de inscrição

Nesta secção, você configura e testa Azure AD single sign-on com Talent Palette baseado em um utilizador de teste chamado **Britta Simon**.
Para um único sign-on para o trabalho, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado na Paleta de Talentos.
...
Para configurar o Azure AD single sign-on com Talent Palette, execute os seguintes passos:

1. No [portal Azure,](https://portal.azure.com/)na página de integração da aplicação **Talent Palette,** selecione **Single sign-on**.
...
7. Na secção **Configurar a Paleta de Talentos,** copie os URL(s) apropriados de acordo com o seu requisito.
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso à Paleta de Talentos.
...
2. Na lista de aplicações, escreva e selecione **a Paleta de Talentos.**
    ...
    ![O link da Paleta de Talento na lista de Aplicações](common/all_applications.png)
...
Quando clicar no azulejo da Paleta de Talento no Painel de Acesso, deverá ser automaticamente inscrito na Paleta de Talentos para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
