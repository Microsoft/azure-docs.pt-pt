...
Quando clicar no azulejo de 10.000 pés planos no Painel de Acesso, deverá ser automaticamente inscrito nos Planos de 10.000 pés para os quais configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
