...
description: Saiba como configurar um único sinal entre o Azure Ative Directory e o Front.
...
ms.locfileid: "92450888"
---
# <a name="tutorial-azure-active-directory-integration-with-front"></a>Tutorial: Integração do Diretório Ativo Azure com a Front

Neste tutorial, aprende-se a integrar a Front com o Azure Ative Directory (Azure AD).
Integrar a Frente com a AD Azure proporciona-lhe os seguintes benefícios:

* Pode controlar em Azure AD que tem acesso à Frente.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos na Frente (Sign-on único) com as suas contas AD Azure.
...
Para configurar a integração AZure AD com a Front, precisa dos seguintes itens:
...
* Front suporta **IDP** iniciado SSO

## <a name="adding-front-from-the-gallery"></a>Adicionar Frente da galeria

Para configurar a integração da Front em Azure AD, precisa adicionar Front da galeria à sua lista de aplicações geridas pelo SaaS.

**Para adicionar Front da galeria, execute os seguintes passos:**
...
4. Na caixa de pesquisa, escreva **Frente**, selecione **Front** from result panel e, em seguida, clique no botão **Adicionar** para adicionar a aplicação.

     ![Frente na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar Azure AD único sinal de inscrição

Nesta secção, configura e testa o Azure AD com um único sinal de sinalização com base num utilizador de teste chamado **Britta Simon**.
Para um único sinal de sação a funcionar, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado na Frente.
...
Para configurar o Azure AD single sign-on com Front, execute os seguintes passos:

1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **Frontal,** selecione **Single sign-on**.
...
6. Na secção **Frente configurada,** copie os URL(s) apropriados de acordo com o seu requisito.
...
7. Na secção **de definições do prestador de serviços,** execute os seguintes passos:
    ...
    b. Copie o valor do **URL ACS** e cole-o na caixa de texto **URL de resposta** na secção Domínio frontal e **URLs** no portal Azure.
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso à Frente.
...
### <a name="create-front-test-user"></a>Criar utilizador de teste frontal

Nesta secção, cria-se um utilizador chamado Britta Simon in Front. Trabalhe com a [equipa de suporte do Cliente Frontal](mailto:support@frontapp.com) para adicionar os utilizadores na plataforma Front. Os utilizadores devem ser criados e ativados antes de utilizar uma única s ativação.

### <a name="test-single-sign-on"></a>Testar o início de sessão único 

Nesta secção, testa a configuração de inscrição única AZure AD utilizando o Painel de Acesso.

Quando clicar no azulejo frontal no Painel de Acesso, deverá ser automaticamente inscrito na Frente para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
