...
2. **[Configure SecureW2 JoinNow Connector SSO](#configure-securew2-joinnow-connector-sso)** - para configurar as definições de Sign-On único no lado da aplicação.
...
Quando clicar no telha SecureW2 JoinNow connector no Painel de Acesso, deverá ser automaticamente inscrito no Conector SecureW2 JoinNow para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
