---
title: 'Tutorial: Integração do Azure Ative Directory com o Zscaler Two Microsoft Docs'
...
A integração do Zscaler Two com a Ad Azure proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso a Zscaler 2.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos no Zscaler Two (Sign-On Único) com as suas contas AD Azure.
...
* Zscaler Dois únicos sign-on ativados subscrição
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    ![Zscaler Dois Domínios e URLs informações únicas de súmis](common/sp-signonurl.png)
...
Quando clicar no azulejo Zscaler Two no Painel de Acesso, deverá ser automaticamente inscrito no Zscaler Two para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
