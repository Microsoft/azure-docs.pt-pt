...
2. **[Configure o Sign-On único do Origami](#configure-origami-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de inscrição real. Contacte [a equipa de apoio ao Cliente origami](https://wordpress.org/support/theme/origami) para obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-origami-single-sign-on"></a>Configurar origami único sign-on

1. Faça login na conta origami com direitos de administração.

2. No menu em cima, clique em **Administração.**
   
    ![Configurar um único sign-on](./media/origami-tutorial/tutorial_origami_51.png)

3. Na página de diálogo de sinal único na configuração, execute os seguintes passos:
   
    ![Configurar um único sign-on](./media/origami-tutorial/tutorial_origami_531.png)
...
3. No diálogo **de Utilizadores e Segurança,** clique nos **Utilizadores**.
    ...
    ![Configurar um único sign-on](./media/origami-tutorial/tutorial_origami_54.png)

4. Clique **em Adicionar Novo Utilizador**.
   
    ![Configurar um único sign-on](./media/origami-tutorial/tutorial_origami_55.png)

5. No diálogo Adicionar Novo Utilizador, execute os seguintes passos:
   
    ![Configurar um único sign-on](./media/origami-tutorial/tutorial_origami_56.png)
    ...
    ![Configurar um único sign-on](./media/origami-tutorial/tutorial_origami_57.png)

6. Atribuir **funções de utilizador** e acesso ao **cliente** ao utilizador. 
   
    ![Configurar um único sign-on](./media/origami-tutorial/tutorial_origami_58.png)
