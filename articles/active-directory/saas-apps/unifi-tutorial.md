---
title: 'Tutorial: Integração do Azure Ative Directory com a UNIFI Microsoft Docs'
...
A integração da UNIFI com a AZure AD proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso à UNIFI.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos na UNIFI (Single Sign-On) com as suas contas AD Azure.
...
Para configurar a integração Azure AD com a UNIFI, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode ter um mês de julgamento [aqui.](https://azure.microsoft.com/pricing/free-trial/)
* Unifi assinatura única ativada

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configura e testa Azure AD um único sinal de acesso em um ambiente de teste.

* UNIFI apoia **SP e IDP** iniciado SSO
...
**Para adicionar a UNIFI da galeria, execute os seguintes passos:**
...
4. Na caixa de pesquisa, escreva **UNIFI**, selecione **UNIFI** do painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar a aplicação.

     ![UNIFI na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar Azure AD único sinal de inscrição

Nesta secção, configura e testa o Azure AD com a UNIFI com base num utilizador de teste chamado **Britta Simon**.
Para um único sinal de sação a funcionar, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado na UNIFI.
...
Para configurar o Azure AD com a UNIFI, execute os seguintes passos:

1. No [portal Azure](https://portal.azure.com/), na página de integração de aplicações **DA UNIFI,** selecione **Single sign-on**.
...
5. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
    ...
    Na caixa de texto **URL de entrada de inscrição,** digite um URL:  `https://app.discoverunifi.com/login`
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso à UNIFI.
...
Quando clicar no azulejo UNIFI no Painel de Acesso, deverá ser automaticamente inscrito na UNIFI para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
