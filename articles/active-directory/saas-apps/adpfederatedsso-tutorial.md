...
2. **[Configure o ADP SSO](#configure-adp-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo ADP no Painel de Acesso, deverá ser automaticamente inscrito no ADP para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
