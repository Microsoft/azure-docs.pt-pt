...
2. **[Configure ProNovos Analytics SSO](#configure-pronovos-analytics-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo ProNovos Analytics no Painel de Acesso, deverá ser automaticamente inscrito no ProNovos Analytics para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
