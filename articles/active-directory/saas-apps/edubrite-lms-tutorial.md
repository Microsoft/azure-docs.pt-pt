---
title: 'Tutorial: Integração do Azure Ative Directory com a EduBrite LMS Microsoft Docs'
...
### <a name="configure-edubrite-lms-single-sign-on"></a>Configurar EduBrite LMS Single Sign-On
...
Quando clicar no azulejo EduBrite LMS no Painel de Acesso, deverá ser automaticamente inscrito no EduBrite LMS para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
