...
1. Selecione **EAB Navigate IMPL** a partir do painel de resultados e, em seguida, adicione a aplicação. Espere alguns segundos enquanto a aplicação é adicionada ao seu inquilino.
...
1. Na secção **Basic SAML Configuration,** introduza os valores para os seguintes campos: Na caixa de texto **identificador (Id entidade),** introduza exatamente o seguinte valor:`https://impl.bouncer.eab.com`
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de Sign-On real. Contacte a equipa de suporte ao [cliente EAB Navigate IMPL](mailto:EABTechSupport@eab.com) para obter o valor. Também pode consultar os padrões mostrados na secção **de Configuração SAML Básica** no portal Azure.
...
Para configurar um único sinal no lado do IMPL de navegação da **EAB,** precisa enviar o Url de **Metadados da Federação de Aplicações** para a equipa de suporte do IMPL de navegação da [EAB](mailto:EABTechSupport@eab.com). Eles definiram esta definição para ter a ligação SAML SSO corretamente definida em ambos os lados.

### <a name="create-eab-navigate-impl-test-user"></a>Criar o utilizador de teste EAB Navigate IMPL

Nesta secção, cria-se um utilizador chamado B.Simon no EAB Navigate IMPL. Trabalhe com a equipa de [suporte eAB Navigate IMPL](mailto:EABTechSupport@eab.com) para adicionar os utilizadores na plataforma EAB Navigate IMPL. Os utilizadores devem ser criados e ativados antes de utilizar um único sinal.
