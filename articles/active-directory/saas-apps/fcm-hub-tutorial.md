---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com o FCM HUB Microsoft Docs'
...
* FCM HUB apoia **SP e IDP** iniciado SSO
* Uma vez configurado FCM HUB, pode impor o controlo da sessão, que protege a exfiltração e infiltração dos dados sensíveis da sua organização em tempo real. O controlo da sessão estende-se a partir do Acesso Condicional. [Saiba como impor o controlo da sessão com o Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-fcm-hub"></a>Configurar e testar Azure AD único sign-on para FCM HUB
...
Para configurar e testar o Azure AD SSO com a FCM HUB, complete os seguintes blocos de construção:
...
1. **[Configure o FCM HUB SSO](#configure-fcm-hub-sso)** - para configurar as definições de inscrição única no lado da aplicação.
    * **[Create FCM HUB test user](#create-fcm-hub-test-user)** - para ter uma contraparte de B.Simon no FCM HUB que está ligada à representação AD AD do utilizador.
...
1. No [portal Azure](https://portal.azure.com/), na página de integração de aplicações **FCM HUB,** encontre a secção **Gerir** e selecione um único sinal de **sação**.
...
Quando clicar no azulejo DO HUB da FCM no Painel de Acesso, deverá ser automaticamente inscrito no HUB da FCM para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Experimente o HUB FCM com a Azure AD](https://aad.portal.azure.com/)

- [O que é o controlo de sessão no Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Como proteger o FCM HUB com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)