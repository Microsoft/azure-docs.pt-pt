...
Quando clicar no azulejo SSO do MyCirqa Hospedado no Painel de Acesso, deverá ser automaticamente inscrito no MyCirqa SSO do MyCirqa, para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
