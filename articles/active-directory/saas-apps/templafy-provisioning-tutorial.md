...
* É recomendável que um único usuário do Azure AD seja atribuído ao Templafy para testar a configuração automática de provisionamento de usuário. Usuários e/ou grupos adicionais podem ser atribuídos posteriormente.
...
2. Na lista de aplicativos, selecione **Templafy**.
