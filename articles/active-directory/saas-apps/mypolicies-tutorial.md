---
title: 'Tutorial: Integração do Azure Ative Directory com as myPolicies Microsoft Docs'
...
2. **[Configure myPolicies Single Sign-On](#configure-mypolicies-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-mypolicies-single-sign-on"></a>Configurar myPolicies Single Sign-On
...
Quando clicar no azulejo myPolicies no Painel de Acesso, deverá ser automaticamente inscrito nas myPolicies para as quais configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
