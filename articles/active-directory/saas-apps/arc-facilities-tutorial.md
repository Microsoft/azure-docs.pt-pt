...
Ao clicar no azulejo arc facilities no Painel de Acesso, deverá ser automaticamente inscrito nas Instalações ARC para as quais configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
