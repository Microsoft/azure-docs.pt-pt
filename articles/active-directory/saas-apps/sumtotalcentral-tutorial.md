...
**Para adicionar o SumTotalCentral da galeria, execute os seguintes passos:**
...
4. Na caixa de pesquisa, escreva **SumTotalCentral,** selecione **SumTotalCentral** do painel de resultados e clique em Adicionar o botão **Adicionar** a aplicação.
...
2. **[Configure o Sinal Único SumTotalCentral](#configure-sumtotalcentral-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
3. Crie um utilizador de **[teste AD Azure](#create-an-azure-ad-test-user)** - para testar um único sinal de Azure com Britta Simon.
4. **[Atribua o utilizador de teste Azure AD](#assign-the-azure-ad-test-user)** - para permitir que Britta Simon utilize um único sinal de Azure.
5. Criar utilizador de **[teste SumTotalCentral](#create-sumtotalcentral-test-user)** - para ter uma contraparte de Britta Simon no SumTotalCentral que está ligada à representação AD AD do utilizador.
...
Para configurar o Azure AD com o SumTotalCentral, execute os seguintes passos:
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    b. Na caixa de texto **identifier (Entity ID),** digite um valor: `SumTotalFederationGateway`

    > [!NOTE]
    > O valor url de inscrição não é real. Atualize o valor com o URL de inscrição real. Contacte [a equipa de suporte ao Cliente SumTotalCentral](http://www.sumtotalsystems.com/support/) para obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-sumtotalcentral-single-sign-on"></a>Configurar o sign-on único do SumTotalCentral
...
Nesta secção, você permite que Britta Simon utilize a Azure single sign-on, concedendo acesso ao SumTotalCentral.

1. No portal Azure, selecione **Aplicações empresariais**, selecione **Todas as aplicações**e, em seguida, selecione **SumTotalCentral**.

    ![Lâmina de aplicações da empresa](common/enterprise-applications.png)

2. Na lista de candidaturas, selecione **SumTotalCentral**.
...
Quando clicar no azulejo SumTotalCentral no Painel de Acesso, deverá ser automaticamente inscrito no SumTotalCentral para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
