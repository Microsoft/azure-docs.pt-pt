---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a VeraSMART Microsoft Docs'
...
Quando clicar no azulejo VeraSMART no Painel de Acesso, deverá ser automaticamente inscrito no VeraSMART para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
