...
Neste tutorial, você aprenderá a integrar o Folloze com o Azure Active Directory (Azure AD).
A integração do Folloze ao Azure AD oferece os seguintes benefícios:

* No Azure AD, é possível controlar quem tem acesso ao Folloze.
* Você pode permitir que seus usuários sejam conectados automaticamente ao Folloze (logon único) com suas contas do Azure AD.
...
* Folloze dá suporte ao SSO iniciado pelo **IDP**
* O Folloze dá suporte ao provisionamento **de usuário just in time**

## <a name="adding-folloze-from-the-gallery"></a>Adicionando o Folloze da Galeria

Para configurar a integração do Folloze ao Azure AD, você precisará adicionar o Folloze da Galeria à sua lista de aplicativos SaaS gerenciados.

**Para adicionar o Folloze da galeria, execute as seguintes etapas:**
...
4. Na caixa de pesquisa, digite **Folloze**, selecione **Folloze** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![Folloze na lista de resultados](common/search_new_app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure AD com o Folloze, com base em um usuário de teste chamado **Brenda Simon**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no Folloze.
...
2. **[Configurar o logon único do Folloze](#configure-folloze-single-sign-on)** – para configurar as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure ad](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com o Brenda Simon.
4. **[Atribuir o usuário de teste do Azure ad](#assign-the-azure-ad-test-user)** – para permitir que Brenda Simon use o logon único do Azure AD.
5. **[Criar usuário de teste do Folloze](#create-folloze-test-user)** – para ter um equivalente de Brenda Simon no Folloze que esteja vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Folloze** , selecione **logon único**.
...
8. Na seção **Configurar Folloze** , copie as URLs apropriadas de acordo com seu requisito.
...
Para configurar o logon único no lado do **Folloze** , é necessário enviar o **certificado (Base64)** baixado e as URLs copiadas apropriadas de portal do Azure para a [equipe de suporte do Folloze](mailto:support@folloze.com). Eles definem essa configuração para que a conexão de SSO do SAML seja definida corretamente em ambos os lados.
...
Nesta seção, você permitirá que Brenda Simon use o logon único do Azure concedendo acesso ao Folloze.

1. Na portal do Azure, selecione **aplicativos empresariais**, selecione **todos os aplicativos**e, em seguida, selecione **Folloze**.

    ![Folha aplicativos empresariais](common/enterprise_applications.png)

2. Na lista de aplicativos, digite e selecione **Folloze**.
...
### <a name="create-folloze-test-user"></a>Criar usuário de teste do Folloze

Nesta seção, um usuário chamado Brenda Simon é criado em Folloze. O Folloze dá suporte ao provisionamento de usuário just-in-time, que é habilitado por padrão. Não há nenhum item de ação para você nesta seção. Se um usuário ainda não existir no Folloze, um novo será criado após a autenticação.

### <a name="test-single-sign-on"></a>Testar o início de sessão único

Nesta seção, você testará sua configuração de logon único do Azure AD usando o painel de acesso.

Ao clicar no bloco do Folloze no painel de acesso, você deverá ser conectado automaticamente ao Folloze para o qual você configurou o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
