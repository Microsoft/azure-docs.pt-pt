---
title: 'Tutorial: Azure Ative Directory integração única (SSO) com Otsuka Shokai Microsoft Docs'
...
Quando clicar no azulejo Otsuka Shokai no Painel de Acesso, deverá ser automaticamente inscrito no Otsuka Shokai para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
