...
2. No menu na parte superior, clique em **admin**.
    ...
    ![ADM](./media/freshdesk-tutorial/IC776772.png "ADM")
...
5. Na caixa de diálogo informações do agente, execute as seguintes etapas:
    ...
    >
    >[!NOTE]
    >Você pode usar qualquer outra ferramenta de criação de conta de usuário Freshdesk ou APIs fornecidas pelo Freshdesk para provisionar contas de usuário do AAD para FreshDesk.
