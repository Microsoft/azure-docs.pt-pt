...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Wdesk (Single Sign-On) com as suas contas do Azure AD.
...
* Wdesk logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Wdesk **SP** e **IDP** iniciada SSO
...
4. Na caixa de pesquisa, escreva **Wdesk**, selecione **Wdesk** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.

     ![Wdesk na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com Wdesk com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Wdesk deve ser estabelecido.
...
2. **[Configurar Wdesk Single Sign-On](#configure-wdesk-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Wdesk](#create-wdesk-test-user)**  - para ter um equivalente da Eduarda Almeida na Wdesk que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Wdesk** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, execute os seguintes passos:
    ...
    ![Wdesk domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    ![Wdesk domínio e URLs únicas início de sessão em informações](common/metadata-upload-additional-signon.png)
...
6. Sobre o **configurar Wdesk** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-wdesk-single-sign-on"></a>Configurar Wdesk Single Sign-On

1. Numa janela do browser web diferente, inicie sessão no Wdesk como um administrador de segurança.

2. No canto inferior esquerdo, clique em **administrador** e escolha **administrador de conta**:
 
     ![Configurar o início de sessão único](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig1.png)

3. No Wdesk administrador, navegue até **Security**, em seguida, **SAML** > **definições de SAML**:

    ![Configurar o início de sessão único](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig2.png)

4. Sob **definições gerais**, verifique o **ativar SAML início de sessão único**:

    ![Configurar o início de sessão único](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig3.png)

5. Sob **detalhes do fornecedor de serviço**, execute os seguintes passos:
...
6. Clique em **configurar definições de IdP** para abrir **editar definições de IdP** caixa de diálogo. Clique em **Escolher ficheiro** para localizar o **METADATA** ficheiro que guardou a partir do portal do Azure, em seguida, carregá-lo.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Wdesk**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Wdesk**.

    ![A ligação de Wdesk na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico Wdesk no painel de acesso, deve ser automaticamente sessão iniciada no Wdesk para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
