---
title: 'Tutorial: Integração do Azure Ative Directory com Wingspan eTMF / Microsoft Docs'
...
2. **[Configure a envergadura de asas eTMF Single Sign-On](#configure-wingspan-etmf-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de inscrição, identificação e URL de resposta. Contacte [a equipa de suporte do cliente wingspan eTMF](https://www.wingspan.com/contact-us/) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
Quando clicar no azulejo eTMF da Wingspan no Painel de Acesso, deverá ser automaticamente inscrito no eTMF wingspan para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
