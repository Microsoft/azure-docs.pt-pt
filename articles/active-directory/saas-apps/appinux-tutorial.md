---
title: 'Tutorial: integração do Azure Active Directory com o Appinux | Microsoft Docs'
...
ms.locfileid: "73152834"
---
# <a name="tutorial-azure-active-directory-integration-with-appinux"></a>Tutorial: integração do Azure Active Directory com o Appinux

Neste tutorial, você aprenderá a integrar o Appinux com o Azure Active Directory (Azure AD).
A integração do Appinux ao Azure AD oferece os seguintes benefícios:

* No Azure AD, é possível controlar quem tem acesso ao Appinux.
* Você pode permitir que seus usuários sejam conectados automaticamente ao Appinux (logon único) com suas contas do Azure AD.
...
Nesta seção, você configurará e testará o logon único do Azure AD com o Appinux, com base em um usuário de teste chamado **Brenda Simon**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no Appinux.
...
2. **[Configurar o logon único do Appinux](#configure-appinux-single-sign-on)** – para configurar as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure ad](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com o Brenda Simon.
4. **[Atribuir o usuário de teste do Azure ad](#assign-the-azure-ad-test-user)** – para permitir que Brenda Simon use o logon único do Azure AD.
5. **[Criar usuário de teste do Appinux](#create-appinux-test-user)** – para ter um equivalente de Brenda Simon no Appinux que esteja vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Appinux** , selecione **logon único**.
...
8. Na seção **Configurar Appinux** , copie as URLs apropriadas de acordo com seu requisito.
...
Nesta seção, você permitirá que Brenda Simon use o logon único do Azure concedendo acesso ao Appinux.

1. Na portal do Azure, selecione **aplicativos empresariais**, selecione **todos os aplicativos**e, em seguida, selecione **Appinux**.

    ![Folha aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Appinux**.

    ![O link do Appinux na lista de aplicativos](common/all-applications.png)
