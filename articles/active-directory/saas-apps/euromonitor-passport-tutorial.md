---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com Euromonitor Passport Microsoft Docs'
...
Quando clicar no azulejo do Euromonitor Passport no Painel de Acesso, deverá ser automaticamente inscrito no Euromonitor Passport para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
