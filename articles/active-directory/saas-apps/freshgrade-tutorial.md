...
4. Na **configuração de um único sign-on com** a página SAML, execute os seguintes passos:
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL e o identificador de inscrição real. Contacte [a equipa de suporte ao Cliente FreshGrade](mailto:support@freshgrade.com) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-freshgrade-single-sign-on"></a>Configurar o sign-on único do FreshGrade
...
Quando clicar no azulejo FreshGrade no Painel de Acesso, deverá ser automaticamente inscrito no FreshGrade para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
