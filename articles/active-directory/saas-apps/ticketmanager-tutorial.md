---
title: 'Tutorial: Azure Ative Directory integração única de sign-on (SSO) com ticketManager | Microsoft Docs'
...
Ao clicar no azulejo TicketManager no Painel de Acesso, deverá ser automaticamente inscrito no TicketManager para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger o TicketManager com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)