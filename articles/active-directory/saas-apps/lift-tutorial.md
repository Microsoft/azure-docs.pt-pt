---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com LIFT / Microsoft Docs'
...
Quando clicar no azulejo LIFT no Painel de Acesso, deverá ser automaticamente inscrito no LIFT para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
