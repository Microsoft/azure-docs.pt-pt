...
> * [Único sinal de trabalho](./workplacebyfacebook-tutorial.md) por facebook (recomendado)
...
3. Determine quais os dados a [mapear entre Azure AD e Workplace pelo Facebook](../app-provisioning/customize-application-attributes.md).
...
9. Reveja os atributos do utilizador que são sincronizados do AD AD do Azure para o Workplace pelo Facebook na secção **De mapeamento de Atributos.** Os atributos selecionados como propriedades **de correspondência** são utilizados para combinar as contas de utilizador no Workplace pelo Facebook para operações de atualização. Se optar por alterar o [atributo de alvo correspondente,](../app-provisioning/customize-application-attributes.md)terá de garantir que o Workplace by Facebook API suporta a filtragem dos utilizadores com base nesse atributo. Selecione o botão **Guardar** para escoar quaisquer alterações.
