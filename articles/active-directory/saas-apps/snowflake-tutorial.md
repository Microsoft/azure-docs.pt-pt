...
2. **[Configure o sign-on único](#configure-snowflake-single-sign-on)** do floco de neve - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **De Configuração Básica SAML,** execute os seguintes passos, se desejar configurar a aplicação no modo iniciado pelo **IDP:**
    ...
    ![Domínio de flocos de neve e URLs informações únicas de sinal-on](common/idp-intiated.png)
    ...
    ![Domínio de flocos de neve e URLs informações únicas de sinal-on](common/metadata-upload-additional-signon.png)
...
### <a name="configure-snowflake-single-sign-on"></a>Configurar snowflake single sign-on
...
Quando clicar no azulejo snowflake no Painel de Acesso, deverá ser automaticamente inscrito no Floco de Neve para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
