...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Montage Online (Single Sign-On) com as suas contas do Azure AD.
...
* Montage Online logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Montage Online suporta **SP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com Montage Online com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Montage Online tem de ser estabelecida.
...
2. **[Configurar Montage Online início de sessão único](#configure-montage-online-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Online de Montage](#create-montage-online-test-user)**  - para ter um equivalente da Eduarda Almeida Montage online que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Montage Online** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![Montage Online de domínio e URLs únicas início de sessão em informações](common/sp-identifier.png)
    ...
    > [!NOTE] 
    > O valor de URL de início de sessão não é real. Atualize o valor com o URL de início de sessão real. Contacte [equipa de suporte do cliente Online do Montage](https://www.montage.co.nz/contact-us/) para obter o valor. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.

5. No **definido no início de sessão único com o SAML** página, além do **certificado de assinatura SAML** secção, clique em **transferir** para transferir o **certificado (Base64)** entre as opções de determinado de acordo com seus requisitos e guarde-o no seu computador.

    ![O link de download de certificado](common/certificatebase64.png)

6. Sobre o **configurar Montage Online** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-montage-online-single-sign-on"></a>Configurar Montage Online início de sessão único

Para configurar o início de sessão único num **Montage Online** lado, terá de enviar o transferido **certificado (Base64)** e adequadas copiados URLs a partir do portal do Azure para [Montage Online equipa de suporte ](https://www.montage.co.nz/contact-us/). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Montage Online**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Montage Online**.

    ![A ligação Montage Online na lista de aplicações](common/all-applications.png)
...
### <a name="create-montage-online-test-user"></a>Criar utilizador de teste Montage Online
...
Quando clica no mosaico Montage Online no painel de acesso, deve iniciar sessão automaticamente Montage online para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
