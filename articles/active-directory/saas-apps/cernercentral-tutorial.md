---
title: 'Tutorial: Integração do Azure Ative Directory com a Cerner Central Microsoft Docs'
...
2. **[Configure o Central De sign-on central cerner](#configure-cerner-central-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo Central cerner no Painel de Acesso, deverá ser automaticamente inscrito na Central cerner para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
