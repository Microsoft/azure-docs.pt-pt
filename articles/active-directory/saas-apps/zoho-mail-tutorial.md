...
2. **[Configure o Sign-On Único zoho](#configure-zoho-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de inscrição real. Contacte [a equipa de apoio ao Cliente Zoho](https://www.zoho.com/mail/contact.html) para obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
