...
* Pode utilizar as minhas apps do Microsoft. Quando clicar no azulejo Zoho nas Minhas Apps, deverá ser automaticamente inscrito no Zoho para o qual configura o SSO. Para obter mais informações sobre as Minhas Apps, consulte [Introdução às Minhas Aplicações.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
