...
* É recomendável que um único usuário do Azure AD seja atribuído a flocos de neve para testar a configuração automática de provisionamento de usuário. Usuários e/ou grupos adicionais podem ser atribuídos posteriormente.
