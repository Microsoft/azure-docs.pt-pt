---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com easySSO para Jira Microsoft Docs'
...
Quando clicar no azulejo EasySSO para Jira no Painel de Acesso, deverá ser automaticamente inscrito na instância Jira para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
