...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de inscrição, identificação e URL de resposta. Contacte [a equipa de suporte do cliente do Serviço de Nuvem PICCO](mailto:picco.support@est.fujitsu.com) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-cloud-service-picco-single-sign-on"></a>Configure serviço de nuvem PICCO único sinal-on
...
Quando clicar no azulejo PICCO do Serviço de Nuvem no Painel de Acesso, deverá ser automaticamente inscrito no Serviço de Cloud PICCO para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
