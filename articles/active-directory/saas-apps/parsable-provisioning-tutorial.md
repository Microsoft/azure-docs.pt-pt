---
title: 'Tutorial: Configurar Parsable para fornecimento automático de utilizadores com Diretório Ativo Azure Microsoft Docs'
description: Saiba como provisão e desavisagem automática de contas de utilizadores de Azure AD a Parsable.
...
Este tutorial descreve os passos necessários para realizar tanto no Diretório Parsable como no Azure Ative (Azure AD) para configurar o fornecimento automático do utilizador. Quando configurado, a Azure AD fornece automaticamente e desescvisões utilizadores e grupos para [Parsable](https://www.parsable.com/) usando o serviço de provisionamento Azure AD. Para obter detalhes importantes sobre o que este serviço faz, como funciona e perguntas frequentes, veja [Automatizar o aprovisionamento e desaprovisionamento de utilizadores em aplicações SaaS no Azure Active Directory](../manage-apps/user-provisioning.md). 
...
* Um inquilino parsável (equipa).
* Uma conta de utilizador em Parsable com permissões de Administração.
...
3. Determine quais os dados a [mapear entre Azure AD e Parsable](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-parsable-to-support-provisioning-with-azure-ad"></a>Passo 2. Configure Parsable para apoiar o provisionamento com Azure AD

1. Contacte o representante parsable de sucesso do cliente para optar por esta função de pré-lançamento.
2. Ajudarão ainda mais a levantar um bilhete de apoio para obter o necessário **token do Portador** (símbolo secreto).
3. Copie e guarde o **símbolo do Portador.** Este valor será introduzido no campo **Secret Token** * no separador Provisioning da sua aplicação Parsable no portal Azure.

## <a name="step-3-add-parsable-from-the-azure-ad-application-gallery"></a>Passo 3. Adicione Parsable da galeria de aplicações AZure AD

Adicione a Parsable da galeria de aplicações Azure AD para começar a gerir o fornecimento à Parsable. Se tiver configurado previamente Parsable para SSO, pode utilizar a mesma aplicação. No entanto, é recomendável criar uma aplicação separada ao testar a integração inicialmente. Saiba mais sobre como adicionar uma aplicação a partir da galeria [aqui](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
* Ao atribuir utilizadores e grupos ao Parsable, tem de selecionar outra função que não o **Acesso Predefinido**. Os utilizadores com a função Acesso Predefinido são excluídos do aprovisionamento e marcados como não autorizados de forma efetiva nos registos de aprovisionamento. Se a única função disponível na aplicação for a função de acesso predefinido, pode [atualizar o manifesto de aplicação](https://docs.microsoft.com/azure/active-directory/develop/howto-add-app-roles-in-azure-ad-apps) para adicionar funções adicionais. 

* Comece pequeno. Teste com um pequeno conjunto de utilizadores e grupos antes de implementar para todos. Quando o âmbito do aprovisionamento está definido para os utilizadores e os grupos atribuídos, pode controlar isto ao atribuir um ou dois utilizadores ou grupos à aplicação. Quando o âmbito está definido para todos os utilizadores e grupos, pode especificar um [filtro de âmbito baseado em atributos](https://docs.microsoft.com/azure/active-directory/manage-apps/define-conditional-rules-for-provisioning-user-accounts). 


## <a name="step-5-configure-automatic-user-provisioning-to-parsable"></a>Passo 5. Configure o fornecimento automático de utilizadores ao Parsable 

Esta secção guia-o através dos passos para configurar o serviço de fornecimento de AD Azure para criar, atualizar e desativar utilizadores e/ou grupos no TestApp com base em atribuições de utilizador e/ou grupo em Azure AD.

### <a name="to-configure-automatic-user-provisioning-for-parsable-in-azure-ad"></a>Para configurar o fornecimento automático de utilizadores para a Parsable em Azure AD:

1. Inicie sessão no [portal do Azure](https://portal.azure.com). Selecione **Aplicações Empresariais** e, em seguida, **Todas as aplicações**.

    ![Painel Aplicações empresariais](common/enterprise-applications.png)

2. Na lista de candidaturas, selecione **Parsable**.

    ![O link Parsable na lista de Aplicações](common/all-applications.png)
...
5. Sob a secção **de Credenciais de Administração,** insira o URL do seu Inquilino Parsable e o Token Secreto. Clique em **Testar A Ligação** para garantir que o Azure AD pode ligar-se ao Parsable. Se a ligação falhar, certifique-se de que a sua conta Parsable tem permissões de Administração e tente novamente.
...
8. Na secção **Mappings,** selecione **Synchronize Azure Ative Directory Users para Parsable**.
