---
title: 'Tutorial: Integração do Diretório Ativo Azure com | ICIMS Microsoft Docs'
...
## <a name="add-icims-from-the-gallery"></a>Adicione ICIMS da galeria
...
## <a name="configure-and-test-azure-ad-sso-for-icims"></a>Configurar e testar Azure AD SSO para ICIMS
...
Para configurar e testar o Azure AD SSO com o ICIMS, execute os seguintes passos:
...
1. No portal Azure, na página de integração de aplicações **ICIMS,** encontre a secção **Gerir** e selecione um único sinal de **sação**.
...
1. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    b. Na caixa de texto **identifier,** digite o URL: `icims.com`

    c. Na caixa de texto **URL de resposta,** digite o URL: `https://.icims.com/`
...
* Clique em **Testar esta aplicação** no portal Azure. Isto irá redirecionar para o URL de entrada de ICIMS, onde pode iniciar o fluxo de login. 

* Vá diretamente ao URL de inscrição do ICIMS e inicie o fluxo de login a partir daí.

* Pode utilizar as minhas apps do Microsoft. Quando clicar no azulejo ICIMS nas Minhas Apps, este será redirecionado para URL de inscrição do ICIMS. Para obter mais informações sobre as Minhas Apps, consulte [Introdução às Minhas Aplicações.](../user-help/my-apps-portal-end-user-access.md)
