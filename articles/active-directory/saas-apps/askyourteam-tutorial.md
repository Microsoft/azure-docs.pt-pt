...
1. Na secção **Basic SAML Configuration,** caso deseje configurar a aplicação no modo iniciado do **IDP,** introduza os valores para os seguintes campos:
    ...
    Na caixa de texto **URL de resposta,** escreva um URL utilizando o seguinte padrão: `https://<COMPANY>.app.askyourteam.com/users/auth/saml/callback`
...
1. Na secção **Novo utilizador,** execute os seguintes passos:
    ...
    1. Na caixa de texto **por e-mail,** introduza o endereço de e-mail do utilizador como B.Simon@contoso.com.
