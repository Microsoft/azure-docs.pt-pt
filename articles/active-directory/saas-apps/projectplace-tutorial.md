...
1. Na **configuração de um único sign-on com** a página SAML, na secção **Certificado de Assinatura SAML,** clique no **ícone** de cópia para copiar o Url **de metadados da Federação de Aplicações**, de acordo com o seu requisito e guarde-o no Bloco de Notas.
