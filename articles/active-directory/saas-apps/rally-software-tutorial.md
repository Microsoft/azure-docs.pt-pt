...
2. **[Configure o software de rali único sign-on](#configure-rally-software-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-rally-software-single-sign-on"></a>Configurar o software de rali único sign-on
