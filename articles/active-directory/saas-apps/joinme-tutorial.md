...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para join.me (Single Sign-On) com as suas contas do Azure AD.
...
* JOIN.me logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* suporta JOIN.me **IDP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com join.me com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no join.me deve ser estabelecido.
...
2. **[Configurar join.me início de sessão único](#configure-joinme-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste join.me](#create-joinme-test-user)**  - para ter um equivalente da Eduarda Almeida na join.me que está ligado à representação de utilizador do Azure AD.
...
4. Sobre o **configuração básica de SAML** secção, o utilizador não tem de realizar qualquer passo como a aplicação já está pré-integrada com o Azure.
    ...
    ![JOIN.me domínio e URLs únicas início de sessão em informações](common/preintegrated.png)
...
### <a name="configure-joinme-single-sign-on"></a>Configurar join.me início de sessão único

Para configurar o início de sessão único num **join.me** lado, terá de enviar o **Url de metadados de Federação de aplicação** para [equipa de suporte de join.me](https://help.join.me/s/?language). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **join.me**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **join.me**.

    ![A ligação de join.me na lista de aplicações](common/all-applications.png)
...
### <a name="create-joinme-test-user"></a>Criar utilizador de teste join.me
...
Quando clica no mosaico join.me no painel de acesso, deve ser automaticamente sessão iniciada no join.me para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
