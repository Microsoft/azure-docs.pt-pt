...
Para configurar um único sinal no lado **korn Ferry 360,** você precisa enviar o Certificado descarregado **(Base64)** e URLs copiados apropriados do portal Azure para a equipa de [suporte Korn Ferry 360](mailto:george.gold@kornferry.com). Eles definiram esta definição para ter a ligação SAML SSO corretamente definida em ambos os lados.

### <a name="create-korn-ferry-360-test-user"></a>Criar o utilizador de teste Korn Ferry 360

Nesta secção, cria-se um utilizador chamado B.Simon em Korn Ferry 360. Trabalhe com a equipa de [suporte Korn Ferry 360](mailto:george.gold@kornferry.com) para adicionar os utilizadores na plataforma Korn Ferry 360. Os utilizadores devem ser criados e ativados antes de utilizar um único sinal.
