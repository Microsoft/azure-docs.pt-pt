---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com LinkedIn Elevate Microsoft Docs'
...
Quando clicar no azulejo LinkedIn Elevate no Painel de Acesso, deverá ser automaticamente inscrito no LinkedIn Elevate para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
