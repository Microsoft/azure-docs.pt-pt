---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a Aventri Microsoft Docs'
...
Quando clicar no azulejo Aventri no Painel de Acesso, deverá ser automaticamente inscrito no Aventri para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
