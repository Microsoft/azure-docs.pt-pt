...
---
# <a name="tutorial-azure-active-directory-integration-with-keeper-password-manager--digital-vault"></a>Tutorial: integração do Azure Active Directory com o protetor Password Manager & o cofre digital
...
4. Na seção **configuração básica do SAML** , execute as seguintes etapas:
    ...
    c. Na caixa de texto **URL de resposta** , digite uma URL usando o seguinte padrão: `https://{SSO CONNECT SERVER}/sso-connect/saml/sso`
