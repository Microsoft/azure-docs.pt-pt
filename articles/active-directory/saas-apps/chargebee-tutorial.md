---
title: 'Tutorial: Integração do Azure Ative Directory com Chargebee Microsoft Docs'
...
4. A partir do lado esquerdo do menu, clique em **Definições**  >  **De**  >  **Gestão de**Segurança .
    ...
    ![Configuração chargebee](./media/chargebee-tutorial/config01.png)

5. No **pop-up Single Sign-On,** execute os seguintes passos:

    ![Configuração chargebee](./media/chargebee-tutorial/config02.png)
...
Quando clicar no azulejo Chargebee no Painel de Acesso, deverá ser automaticamente inscrito no Chargebee para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
