---
title: 'Tutorial: Configurar Shopify Plus para fornecimento automático de utilizadores com Azure Ative Directory | Microsoft Docs'
...
Este tutorial descreve os passos necessários para realizar tanto no Shopify Plus como no Azure Ative Directory (Azure AD) para configurar o fornecimento automático do utilizador. Quando configurado, a Azure AD fornece automaticamente e desproteja utilizadores e grupos para [Shopify Plus](https://www.shopify.com) usando o serviço de provisionamento Azure AD. Para obter detalhes importantes sobre o que este serviço faz, como funciona e perguntas frequentes, veja [Automatizar o aprovisionamento e desaprovisionamento de utilizadores em aplicações SaaS no Azure Active Directory](../app-provisioning/user-provisioning.md). 
...
> * [Único sinal de shopify](./shopify-plus-tutorial.md) Plus (recomendado)
...
3. Determine quais os dados a [mapear entre Azure AD e Shopify Plus](../app-provisioning/customize-application-attributes.md). 
...
9. Reveja os atributos do utilizador que são sincronizados de Azure AD para Shopify Plus na secção **De mapeamento de atributos.** Os atributos selecionados como propriedades **de correspondência** são utilizados para corresponder às contas do utilizador no Shopify Plus para operações de atualização. Se optar por alterar o [atributo de alvo correspondente,](../app-provisioning/customize-application-attributes.md)terá de garantir que a API Shopify Plus suporta a filtragem dos utilizadores com base nesse atributo. Selecione o botão **Guardar** para escoar quaisquer alterações.
