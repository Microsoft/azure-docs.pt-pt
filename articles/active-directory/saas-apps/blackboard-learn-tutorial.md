...
* Pode utilizar as minhas apps do Microsoft. Quando clicar no azulejo Blackboard Learn nas Minhas Apps, este irá redirecionar para o URL de assinatura do Blackboard Learn. Para obter mais informações sobre as Minhas Apps, consulte [Introdução às Minhas Aplicações.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
