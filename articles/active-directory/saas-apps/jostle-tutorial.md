---
title: 'Tutorial: Integração do Azure Ative Directory com Jostle Microsoft Docs'
...
2. **[Configure o Único Sign-On jostle](#configure-jostle-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
Quando clicar no azulejo Jostle no Painel de Acesso, deverá ser automaticamente inscrito no Jostle para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
