...
2. **[Configure o seu sign-on único](#configure-itslearning-single-sign-on)** de aprendizagem - para configurar as definições de Sign-On única no lado da aplicação.
...
### <a name="configure-itslearning-single-sign-on"></a>Configure o seu single Sign-On
...
Quando clicar no azulejo de aprendizagem no Painel de Acesso, deverá ser automaticamente inscrito na aprendizagem para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
