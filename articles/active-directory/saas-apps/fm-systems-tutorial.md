...
Neste tutorial, você aprenderá a integrar o FM: Systems ao Azure Active Directory (Azure AD).
...
* Você pode permitir que seus usuários se conectem automaticamente ao FM: Systems (logon único) com suas contas do Azure AD.
...
* FM: Systems dá suporte ao SSO iniciado pelo **IDP**

## <a name="adding-fmsystems-from-the-gallery"></a>Adicionando o FM: Systems da Galeria

Para configurar a integração do FM: Systems ao Azure AD, você precisa adicionar o FM: Systems da Galeria à sua lista de aplicativos SaaS gerenciados.
...
Nesta seção, você configurará e testará o logon único do Azure AD com o FM: Systems, com base em um usuário de teste chamado **Brenda Simon**.
...
2. **[Configurar o logon único do FM: Systems](#configure-fmsystems-single-sign-on)** -para configurar as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure ad](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com o Brenda Simon.
4. **[Atribuir o usuário de teste do Azure ad](#assign-the-azure-ad-test-user)** – para permitir que Brenda Simon use o logon único do Azure AD.
5. **[Criar usuário de teste do FM: Systems](#create-fmsystems-test-user)** – para ter um equivalente de Brenda Simon no FM: Systems que esteja vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **FM: Systems** , selecione **logon único**.
...
4. Na seção **configuração básica do SAML** , execute as seguintes etapas:
    ...
    > [!NOTE]
    > Esse valor não é real. Atualize esse valor com a URL de resposta real. Contate a [equipe de suporte do cliente do FM: Systems](https://fmsystems.com/support-services/) para obter o valor. Você também pode consultar os padrões mostrados na seção **configuração básica do SAML** no portal do Azure.
...
6. Na seção **Configurar o FM: Systems** , copie as URLs apropriadas de acordo com seu requisito.
...
Nesta seção, você permitirá que Brenda Simon use o logon único do Azure concedendo-lhe acesso ao FM: Systems.

1. Na portal do Azure, selecione **aplicativos empresariais**, selecione **todos os aplicativos**e, em seguida, selecione **FM: Systems**.

    ![Folha aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **FM: Systems**.

    ![O link FM: Systems na lista de aplicativos](common/all-applications.png)
...
### <a name="create-fmsystems-test-user"></a>Criar usuário de teste do FM: Systems

1. Em uma janela do navegador da Web, entre no site da empresa do FM: Systems como administrador.
...
4. Na seção **criar usuário** , execute as seguintes etapas:
    ...
    a. Digite o **nome de usuário**, a **senha**, **confirme a senha**, o **email** e a **ID de funcionário** de uma conta de Azure Active Directory válida que você deseja provisionar nas caixas de texto relacionadas.
...
Ao clicar no bloco FM: Systems no painel de acesso, você deverá entrar automaticamente no FM: Systems para o qual você configurou o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
