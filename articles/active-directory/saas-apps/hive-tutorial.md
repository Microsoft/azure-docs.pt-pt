---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a Hive Microsoft Docs'
...
Quando clicar no azulejo da Colmeia no Painel de Acesso, deverá ser automaticamente inscrito na Colmeia para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
