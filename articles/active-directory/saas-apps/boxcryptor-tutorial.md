---
title: 'Tutorial: Integração do Azure Ative Directory com o Boxcryptor Microsoft Docs'
...
2. **[Configurar o boxcryptor Single Sign-On](#configure-boxcryptor-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-boxcryptor-single-sign-on"></a>Configurar boxcryptor único sign-on
...
Quando clicar no azulejo do Boxcryptor no Painel de Acesso, deverá ser automaticamente inscrito no Boxcryptor para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
