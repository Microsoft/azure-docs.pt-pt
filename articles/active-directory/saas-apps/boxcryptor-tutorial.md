...
Para configurar o logon único no lado do **Boxcryptor** , é necessário enviar o **certificado (Base64)** baixado e as URLs copiadas apropriadas de portal do Azure para a [equipe de suporte do Boxcryptor](mailto:support@boxcryptor.com). Eles definem essa configuração para que a conexão de SSO do SAML seja definida corretamente em ambos os lados.
