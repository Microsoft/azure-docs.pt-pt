...
2. **[Configure brightspace by Desire2Learn Single Sign-On](#configure-brightspace-by-desire2learn-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
