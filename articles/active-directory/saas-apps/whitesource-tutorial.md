---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com Whitesource Microsoft Docs'
...
Quando clicar no azulejo Whitesource no Painel de Acesso, deverá ser automaticamente inscrito no Whitesource para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
