---
title: 'Tutorial: integração do Azure Active Directory com o HeyBuddy | Microsoft Docs'
...
ms.locfileid: "73159054"
---
# <a name="tutorial-azure-active-directory-integration-with-heybuddy"></a>Tutorial: integração do Azure Active Directory com o HeyBuddy

Neste tutorial, você aprenderá a integrar o HeyBuddy com o Azure Active Directory (Azure AD).
A integração do HeyBuddy ao Azure AD oferece os seguintes benefícios:

* No Azure AD, é possível controlar quem tem acesso ao HeyBuddy.
* Você pode permitir que seus usuários sejam conectados automaticamente ao HeyBuddy (logon único) com suas contas do Azure AD.
...
Para configurar a integração do Azure AD ao HeyBuddy, você precisará dos seguintes itens:
...
4. Na caixa de pesquisa, digite **HeyBuddy**, selecione **HeyBuddy** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![HeyBuddy na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure AD com o HeyBuddy, com base em um usuário de teste chamado **Brenda Simon**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no HeyBuddy.
...
2. **[Configurar o logon único do HeyBuddy](#configure-heybuddy-single-sign-on)** – para configurar as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure ad](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com o Brenda Simon.
4. **[Atribuir o usuário de teste do Azure ad](#assign-the-azure-ad-test-user)** – para permitir que Brenda Simon use o logon único do Azure AD.
5. **[Criar usuário de teste do HeyBuddy](#create-heybuddy-test-user)** – para ter um equivalente de Brenda Simon no HeyBuddy que esteja vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **HeyBuddy** , selecione **logon único**.
...
6. Além de acima, o aplicativo HeyBuddy espera que mais alguns atributos sejam passados de volta na resposta SAML. Na seção **declarações do usuário** , na caixa de diálogo **atributos de usuário** , execute as seguintes etapas para adicionar o atributo de token SAML, conforme mostrado na tabela abaixo:
...
Para configurar o logon único no lado do **HeyBuddy** , é necessário enviar a **URL de metadados de Federação do aplicativo** para a equipe de suporte do [HeyBuddy](mailto:support@heybuddy.com). Eles definem essa configuração para que a conexão de SSO do SAML seja definida corretamente em ambos os lados.
...
Nesta seção, você permitirá que Brenda Simon use o logon único do Azure concedendo acesso ao HeyBuddy.

1. Na portal do Azure, selecione **aplicativos empresariais**, selecione **todos os aplicativos**e, em seguida, selecione **HeyBuddy**.

    ![Folha aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **HeyBuddy**.

    ![O link do HeyBuddy na lista de aplicativos](common/all-applications.png)
