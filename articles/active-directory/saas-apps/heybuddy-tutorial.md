...
1. Além de acima, a aplicação EZOfficeInventory espera que alguns mais atributos sejam repercutidos na resposta SAML que são mostrados abaixo. Estes atributos também são pré-povoados, mas pode revê-los de acordo com o seu requisito.
    ...
    > [!NOTE]
    > Consulte este [link](https://docs.microsoft.com/azure/active-directory/develop/howto-add-app-roles-in-azure-ad-apps#app-roles-ui) sobre como configurar e configurar as funções para a aplicação.
...
* Pode utilizar as minhas apps do Microsoft. Quando clicar no azulejo HeyBuddy nas Minhas Apps, este irá redirecionar para o URL de sign-on heyBuddy. Para obter mais informações sobre as Minhas Apps, consulte [Introdução às Minhas Aplicações.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
