---
title: 'Tutorial: integração de SSO (logon único) do Azure Active Directory com ScaleX Enterprise | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-scalex-enterprise"></a>Tutorial: integração de SSO (logon único) do Azure Active Directory com ScaleX Enterprise
...
1. **[Configurar ScaleX Enterprise SSO](#configure-scalex-enterprise-sso)** – para configurar as configurações de logon único no lado do aplicativo.
    * **[Criar usuário de teste do ScaleX Enterprise](#create-scalex-enterprise-test-user)** – para ter um equivalente de B. Simon no ScaleX Enterprise que esteja vinculado à representação do usuário no Azure AD.
...
1. Para automatizar a configuração no ScaleX Enterprise, você precisa instalar a **extensão do navegador de entrada seguro de meus aplicativos** clicando em **instalar a extensão**.

    ![Extensão de meus aplicativos](common/install-myappssecure-extension.png)

1. Depois de adicionar a extensão ao navegador, clique em **Configurar ScaleX Enterprise** direcionará você para o aplicativo ScaleX Enterprise. A partir daí, forneça as credenciais de administrador para entrar no ScaleX Enterprise. A extensão do navegador irá configurar automaticamente o aplicativo para você e automatizar as etapas de 3-6.

    ![Configuração da instalação](common/setup-sso.png)

1. Se você quiser configurar o ScaleX Enterprise manualmente, abra uma nova janela do navegador da Web e entre no site da empresa ScaleX Enterprise como administrador e execute as seguintes etapas:
...
- [Experimente o ScaleX Enterprise com o Azure AD](https://aad.portal.azure.com/)