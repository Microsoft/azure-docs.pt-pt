---
title: 'Tutorial: integração de SSO (logon único) do Azure Active Directory com o figma | Microsoft Docs'
...
Neste tutorial, você aprenderá a integrar o figma com o Azure Active Directory (Azure AD). Ao integrar o figma ao Azure AD, você pode:

* Controle no Azure AD quem tem acesso ao figma.
* Habilite seus usuários a serem conectados automaticamente ao figma com suas contas do Azure AD.
...
1. Na seção **Adicionar da Galeria** , digite **figma** na caixa de pesquisa.
...
Configure e teste o SSO do Azure AD com o figma usando um usuário de teste chamado **B. Simon**. Para que o SSO funcione, você precisa estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no figma.
...
1. **[Configurar o SSO do figma](#configure-figma-sso)** – para configurar as configurações de logon único no lado do aplicativo.
    * **[Criar usuário de teste do figma](#create-figma-test-user)** – para ter um equivalente de B. Simon em figma que esteja vinculado à representação do usuário no Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **figma** , localize a seção **gerenciar** e selecione **logon único**.
...
1. Além de acima, o aplicativo figma espera que mais alguns atributos sejam passados de volta na resposta SAML, que são mostrados abaixo. Esses atributos também são preenchidos previamente, mas você pode examiná-los de acordo com seus requisitos.
...
- [Experimente o figma com o Azure AD](https://aad.portal.azure.com/)