...
Neste tutorial, aprende-se a integrar gigya com o Azure Ative Directory (Azure AD).
A integração da Gigya com a AD Azure proporciona-lhe os seguintes benefícios:

* Podes controlar o Azure AD que tem acesso à Gigya.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos no Gigya (Sign-on único) com as suas contas AD Azure.
...
Para configurar a integração AD da Azure com a Gigya, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode ter um mês de julgamento [aqui.](https://azure.microsoft.com/pricing/free-trial/)
* Assinatura ativada por Gigya

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configura e testa Azure AD um único sinal de acesso em um ambiente de teste.

* Gigya suporta **SP** iniciado SSO

## <a name="adding-gigya-from-the-gallery"></a>Adicionar Gigya da galeria
...
4. Na caixa de pesquisa, **digite Gigya,** selecione **Gigya** do painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar a aplicação.

     ![Gigya na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar Azure AD único sinal de inscrição

Nesta secção, você configura e testa Azure AD single sign-on com Gigya com base em um utilizador de teste chamado **Britta Simon**.
Para um único sinal de sação a funcionar, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado em Gigya.

Para configurar e testar o Azure AD com gigya, você precisa completar os seguintes blocos de construção:

1. **[Configure Azure AD Single Sign-On](#configure-azure-ad-single-sign-on)** - para permitir que os seus utilizadores utilizem esta funcionalidade.
2. **[Configure gigya Single Sign-On](#configure-gigya-single-sign-on)** - para configurar as definições de Sign-On única no lado da aplicação.
3. Crie um utilizador de **[teste AD Azure](#create-an-azure-ad-test-user)** - para testar um único sinal de Azure com Britta Simon.
4. **[Atribua o utilizador de teste Azure AD](#assign-the-azure-ad-test-user)** - para permitir que Britta Simon utilize um único sinal de Azure.
5. **[Create Gigya test user](#create-gigya-test-user)** - para ter uma contraparte de Britta Simon em Gigya que está ligada à representação AD AD do utilizador.
...
Para configurar o Azure AD single sign-on com Gigya, execute os seguintes passos:
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    ![Gigya Domain e URLs informações únicas de súmis](common/sp-identifier.png)
...
3. Na secção **de Login SAML,** execute os seguintes passos:
    ...
    d. Na caixa de texto **do Formato ID do nome,** cole o valor do **formato identificador** de nome que copiou do Portal Azure.
...
2. Na lista de candidaturas, selecione **Gigya**.
...
Quando clicar no azulejo Gigya no Painel de Acesso, deverá ser automaticamente inscrito no Gigya para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
