...
* Recomenda-se que um único utilizador da AD Azure seja atribuído ao OfficeSpace Software para testar a configuração automática de fornecimento de utilizadores. Posteriormente, os utilizadores e/ou grupos adicionais podem ser atribuídos.
...
1. Inscreva-se na consola [officeSpace Software Admin](https://support.officespacesoftware.com/hc). Navegar para **Definições > Conectores**.
