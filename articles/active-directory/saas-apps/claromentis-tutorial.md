---
title: 'Tutorial: Azure Ative Directory integração única de sign-on (SSO) com Claromentis | Microsoft Docs'
...
1. Selecione **o separador 'Personal's Handler de Login.**
