...
1. Inicie sessão para o [portal do Azure](https://portal.azure.com) e selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Cisco Spark**.
...
5. Sob o **credenciais de administrador** secção, de entrada a **URL de inquilino**, e **segredo de Token** da conta do Spark Cisco.
    ...
    ![Spark Cisco aprovisionamento](./media/cisco-spark-provisioning-tutorial/secrettoken1.png)
...
6. O **ID do inquilino** e **segredo de Token** para o Spark Cisco a conta pode ser encontrada ao iniciar sessão no [site de desenvolvedor do Cisco Spark](https://developer.webex.com/) com a sua conta de administrador. Uma vez conectado -
...
7. Após preencher os campos mostrados no passo 5, clique em **Testar ligação** para garantir que o Azure AD pode ligar ao Cisco Spark. Se a ligação falhar, certifique-se de que a conta de Cisco Spark tem permissões de administrador e tente novamente.
