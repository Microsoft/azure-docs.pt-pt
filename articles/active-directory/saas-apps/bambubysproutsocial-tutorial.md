...
2. **[Configure bambu by Sprout Social Single Sign-On](#configure-bambu-by-sprout-social-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
Ao clicar no azulejo Bambu by Sprout Social no Painel de Acesso, deverá ser automaticamente inscrito no Bambu by Sprout Social para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
