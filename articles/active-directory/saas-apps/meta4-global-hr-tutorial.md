---
title: 'Tutorial: Integração do Diretório Ativo Azure com o | De RH Global Meta4 Microsoft Docs'
...
A integração do Meta4 Global HR com a Azure AD proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso a Meta4 Global HR.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos no Meta4 Global HR (Sign-On Único) com as suas contas AD Azure.
...
Para configurar a integração AZure AD com o Meta4 Global HR, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode obter uma [conta gratuita](https://azure.microsoft.com/free/)
* Assinatura ativada por um único sinal de meta4 Global HR
...
* Meta4 Global HR suporta **SP e IDP** iniciado SSO



## <a name="adding-meta4-global-hr-from-the-gallery"></a>Adicionar Meta4 Global HR da galeria

Para configurar a integração do Meta4 Global HR em Azure AD, precisa adicionar Meta4 Global HR da galeria à sua lista de aplicações geridas pelo SaaS.
...
Nesta secção, você configura e testa Azure AD single sign-on com Meta4 Global HR com base em um utilizador de teste chamado **Britta Simon**.
Para um único sinal de trabalho, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado no Meta4 Global HR.
...
2. **[Configure o Meta4 Global HR Single Sign-On](#configure-meta4-global-hr-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
3. Crie um utilizador de **[teste AD Azure](#create-an-azure-ad-test-user)** - para testar um único sinal de Azure com Britta Simon.
4. **[Atribua o utilizador de teste Azure AD](#assign-the-azure-ad-test-user)** - para permitir que Britta Simon utilize um único sinal de Azure.
5. **[Create Meta4 Global HR test user](#create-meta4-global-hr-test-user)** - para ter uma contraparte de Britta Simon em Meta4 Global HR que está ligada à representação AD AD Azure do utilizador.
...
Para configurar o Azure AD single sign-on com Meta4 Global HR, execute os seguintes passos:
...
7. Na secção **Configurar Meta4 Global HR,** copie os URL(s) apropriados de acordo com o seu requisito.
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso ao Meta4 Global HR.
...
2. Na lista de candidaturas, selecione **Meta4 Global HR**.
    ...
    ![O link Meta4 Global HR na lista de Aplicações](common/all-applications.png)
...
### <a name="create-meta4-global-hr-test-user"></a>Criar o utilizador de teste de RH Global Meta4

Nesta secção, cria-se um utilizador chamado Britta Simon no Meta4 Global HR. Trabalhe com a [equipa de suporte da Meta4 Global HR](mailto:victors@meta4.com) para adicionar os utilizadores na plataforma Meta4 Global HR. Os utilizadores devem ser criados e ativados antes de utilizar uma única s ativação.

### <a name="test-single-sign-on"></a>Testar o início de sessão único 

Nesta secção, testa a configuração de inscrição única AZure AD utilizando o Painel de Acesso.

Quando clicar no azulejo De RH Meta4 Global no Painel de Acesso, deverá ser automaticamente inscrito no Meta4 Global HR para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
