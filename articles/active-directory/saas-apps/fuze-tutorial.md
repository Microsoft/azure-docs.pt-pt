...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Fuze (Single Sign-On) com as suas contas do Azure AD.
...
* Fuze logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Fuze suporta **SP** iniciada SSO

* Fuze suporta **Just In Time** aprovisionamento de utilizadores
...
4. Na caixa de pesquisa, escreva **Fuze**, selecione **Fuze** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.

     ![Fuze na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com Fuze com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Fuze deve ser estabelecido.
...
2. **[Configurar Fuze Single Sign-On](#configure-fuze-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Fuze](#create-fuze-test-user)**  - para ter um equivalente da Eduarda Almeida na Fuze que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Fuze** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![Fuze domínio e URLs únicas início de sessão em informações](common/sp-signonurl.png)

    Na **URL de início de sessão** caixa de texto, escreva um URL:  `https://www.thinkingphones.com/jetspeed/portal/`
...
6. Sobre o **configurar Fuze** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-fuze-single-sign-on"></a>Configurar Fuze início de sessão único

Para configurar o início de sessão único num **Fuze** lado, terá de enviar o transferido **XML de metadados de Federação** e adequadas copiados URLs a partir do portal do Azure para [equipa de suporte de Fuze](https://www.fuze.com/support) . Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Fuze**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Fuze**.

    ![A ligação de Fuze na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico Fuze no painel de acesso, deve ser automaticamente sessão iniciada no Fuze para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
