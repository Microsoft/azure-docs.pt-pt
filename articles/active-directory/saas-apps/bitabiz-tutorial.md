---
title: 'Tutorial: Integração do Azure Ative Directory com o BitaBIZ Microsoft Docs'
...
Quando clicar no azulejo BitaBIZ no Painel de Acesso, deverá ser automaticamente inscrito no BitaBIZ para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
