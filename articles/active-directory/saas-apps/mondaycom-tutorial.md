---
title: 'Tutorial: integração de SSO (logon único) do Azure Active Directory com o monday.com | Microsoft Docs'
...
ms.locfileid: "75430898"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-mondaycom"></a>Tutorial: integração de SSO (logon único) do Azure Active Directory com o monday.com
...
* o monday.com dá suporte ao **SP e** ao SSO iniciado pelo IDP
...
1. **[Configurar o SSO do Monday.com](#configure-mondaycom-sso)** – para configurar as configurações de logon único no lado do aplicativo.
    1. **[Criar usuário de teste do Monday.com](#create-mondaycom-test-user)** – para ter um equivalente de B. Simon em Monday.com que esteja vinculado à representação do usuário no Azure AD.
...
1. Clique em **definir URLs adicionais** e execute a seguinte etapa se desejar configurar o aplicativo no modo iniciado pelo **SP** :
    ...
    Na caixa de texto **URL de logon** , digite uma URL usando o seguinte padrão: `https://<YOUR_DOMAIN>.monday.com`
...
1. o aplicativo monday.com espera as asserções SAML em um formato específico, o que exige que você adicione mapeamentos de atributo personalizados à sua configuração de atributos de token SAML. A captura de tela a seguir mostra a lista de atributos padrão.

    ![imagem](common/default-attributes.png)

1. Além de acima, o aplicativo monday.com espera que mais alguns atributos sejam passados de volta na resposta SAML, que são mostrados abaixo. Esses atributos também são preenchidos previamente, mas você pode examiná-los de acordo com seus requisitos.
...
## <a name="configure-mondaycom-sso"></a>Configurar o SSO do monday.com
...
- [Experimente o monday.com com o Azure AD](https://aad.portal.azure.com/)