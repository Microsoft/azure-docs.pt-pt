...
Para configurar e testar o Azure AD com a Palo Alto Networks - Admin UI, é necessário completar os seguintes blocos de construção:
...
Para configurar o Azure AD single sign-on com Palo Alto Networks - Admin UI, execute os seguintes passos:

1. No [portal Azure](https://portal.azure.com/), na página de integração de aplicações **Palo Alto Networks - Admin UI,** selecione Single **sign-on**.
...
Quando clicar nas Redes Palo Alto - Azulejo UI Admin no Painel de Acesso, deverá ser automaticamente inscrito nas Redes Palo Alto - UI de administração para as quais configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
