---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com a Adobe Identity Management Microsoft Docs'
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-adobe-identity-management"></a>Configurar e testar Azure AD único sinal para a Gestão de Identidade da Adobe
...
Para configurar e testar a Azure AD SSO com a Adobe Identity Management, complete os seguintes blocos de construção:
...
1. No [portal Azure,](https://portal.azure.com/)na página de integração da aplicação **Adobe Identity Management,** encontre a secção **Gerir** e selecione um único sinal de **sação**.
...
Para configurar um único sign-on no lado **da Adobe Identity Management,** é necessário enviar os **Metadados XML da Federação** descarregados e URLs copiados apropriados do portal Azure para a equipa de suporte da [Adobe Identity Management](mailto:identity@adobe.com). Eles definem esta definição para ter a ligação SSO SAML corretamente definida em ambos os lados.

### <a name="create-adobe-identity-management-test-user"></a>Criar utilizador de teste de Gestão de Identidade da Adobe

Nesta secção, cria-se um utilizador chamado B.Simon in Adobe Identity Management. Trabalhe com a [equipa de suporte da Adobe Identity Management](mailto:identity@adobe.com) para adicionar os utilizadores na plataforma de Gestão de Identidade da Adobe. Os utilizadores devem ser criados e ativados antes de utilizar uma única s ativação.

## <a name="test-sso"></a>Teste SSO 

Nesta secção, testa a configuração de inscrição única AZure AD utilizando o Painel de Acesso.

Quando clicar no azulejo da Adobe Identity Management no Painel de Acesso, deverá ser automaticamente inscrito na Gestão de Identidade da Adobe para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
- [Experimente a Gestão de Identidade da Adobe com Azure AD](https://aad.portal.azure.com/)
