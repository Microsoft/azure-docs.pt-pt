...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Qumu Cloud (Single Sign-On) com as suas contas do Azure AD.
...
* Qumu Cloud logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta a nuvem Qumu **SP** e **IDP** iniciada SSO

* Suporta a nuvem Qumu **Just In Time** aprovisionamento de utilizadores
...
Nesta secção, configure e teste do Azure AD início de sessão único com Qumu Cloud com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado na Qumu Cloud deve ser estabelecido.
...
2. **[Configurar Qumu Cloud início de sessão único](#configure-qumu-cloud-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste da Qumu Cloud](#create-qumu-cloud-test-user)**  - para ter um equivalente da Eduarda Almeida na Cloud de Qumu que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Qumu Cloud** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, execute os seguintes passos:
    ...
    ![Qumu Cloud domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    ![Qumu Cloud domínio e URLs únicas início de sessão em informações](common/metadata-upload-additional-signon.png)
...
9. Sobre o **configurar Qumu Cloud** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-qumu-cloud-single-sign-on"></a>Configurar Qumu Cloud início de sessão único

Para configurar o início de sessão único num **Qumu Cloud** lado, terá de enviar o transferido **XML de metadados de Federação** e adequadas copiados URLs a partir do portal do Azure para [equipa de suporte de Qumu Cloud](mailto:support@qumu.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Qumu Cloud**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Qumu Cloud**.

    ![A ligação de Qumu Cloud na lista de aplicações](common/all-applications.png)
...
### <a name="create-qumu-cloud-test-user"></a>Criar utilizador de teste da Qumu Cloud

Nesta secção, um usuário chamado Eduarda Almeida é criado na Qumu Cloud. Qumu Cloud suporta o aprovisionamento de utilizadores de just-in-time, que está ativado por predefinição. Não existe nenhum item de ação para nesta secção. Se um utilizador já não existir na Qumu Cloud, é criado um novo após a autenticação.
...
Quando clica no mosaico de Qumu Cloud no painel de acesso, deve ser automaticamente conectado para a Cloud de Qumu para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
