---
title: 'Tutorial: Integração do Azure Ative Directory com Qumu Cloud Microsoft Docs'
...
2. **[Configure o Sign-On único da nuvem qumu](#configure-qumu-cloud-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
4. Na secção **De Configuração Básica SAML,** se pretender configurar a aplicação no modo iniciado pelo **IDP,** execute os seguintes passos:
    ...
    ![Qumu Cloud Domain e URLs informações únicas de súmis](common/idp-intiated.png)
...
5. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
    ...
    ![Qumu Cloud Domain e URLs informações únicas de súmis](common/metadata-upload-additional-signon.png)
...
8. Na **configuração de 'Sessão Única' com** a página SAML, na secção **Certificado de Assinatura SAML,** clique em **Baixar** para descarregar o **Metadadata XML** da Federação das opções dadas de acordo com o seu requisito e guarde-o no seu computador.
...
### <a name="configure-qumu-cloud-single-sign-on"></a>Configurar qumu nuvem único sinal-on
...
Quando clicar no azulejo qumu cloud no Painel de Acesso, deverá ser automaticamente inscrito na Nuvem qumu para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
