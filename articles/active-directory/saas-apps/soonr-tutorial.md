---
title: 'Tutorial: Integração do Azure Ative Directory com o Soonr Workplace Microsoft Docs'
...
2. **[Configure o Sign-On único do local de trabalho em breve](#configure-soonr-workplace-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **De Configuração Básica SAML,** se pretender configurar a aplicação no modo iniciado pelo **IDP,** execute os seguintes passos:
    ...
    ![Informações de súmis de trabalho e URLs únicas](common/idp-intiated.png)
...
5. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
    ...
    ![Informações de súmis de trabalho e URLs únicas](common/metadata-upload-additional-signon.png)
...
### <a name="configure-soonr-workplace-single-sign-on"></a>Configurar o sign-on único do local de trabalho do local de trabalho
