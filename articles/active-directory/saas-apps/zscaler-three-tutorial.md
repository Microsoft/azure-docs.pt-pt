---
title: 'Tutorial: Integração de Azure Active Directory com o Zscaler três | Microsoft Docs'
...
Neste tutorial, você aprenderá a integrar o Zscaler três com o Azure Active Directory (Azure AD).
A integração do Zscaler 3 ao Azure AD oferece os seguintes benefícios:

* No Azure AD, é possível controlar quem tem acesso ao Zscaler três.
* Você pode permitir que seus usuários façam logon automaticamente no Zscaler três (logon único) com suas contas do Azure AD.
...
Para configurar a integração do Azure AD ao Zscaler três, você precisará dos seguintes itens:
...
* Zscaler três assinaturas habilitadas para logon único
...
**Para adicionar o Zscaler três da galeria, execute as seguintes etapas:**
...
4. Na caixa de pesquisa, digite **Zscaler três**, selecione **Zscaler três** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![Zscaler três na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta seção, você configurará e testará o logon único do Azure AD com o Zscaler três, com base em um usuário de teste chamado **Brenda Simon**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Zscaler três.

Para configurar e testar o logon único do Azure AD com o Zscaler três, você precisa concluir os seguintes blocos de construção:

1. **[Configurar o Azure AD início de sessão único](#configure-azure-ad-single-sign-on)**  - para permitir que os utilizadores utilizar esta funcionalidade.
2. **[Configurar o Zscaler três logon único](#configure-zscaler-three-single-sign-on)** -para configurar as configurações de logon único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar um usuário de teste do Zscaler três](#create-zscaler-three-test-user)** – para ter um equivalente de Brenda Simon no Zscaler três que esteja vinculado à representação do usuário no Azure AD.
...
Para configurar o logon único do Azure AD com o Zscaler 3, execute as seguintes etapas:

1. Na [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Zscaler três** , selecione **logon único**.
...
4. Na seção **configuração básica do SAML** , execute as seguintes etapas:
    ...
    ![Informações de logon único de domínio e URLs do Zscaler três](common/sp-intiated.png)
...
6. Além de acima, Zscaler três aplicativos esperam que mais alguns atributos sejam passados de volta na resposta SAML. Na seção **declarações do usuário** , na caixa de diálogo **atributos de usuário** , execute as seguintes etapas para adicionar o atributo de token SAML, conforme mostrado na tabela abaixo:
...
8. Na seção **Configurar Zscaler três** , copie as URLs apropriadas de acordo com seu requisito.
...
### <a name="configure-zscaler-three-single-sign-on"></a>Configurar o Zscaler três logon único
...
4. Acesse **administração > autenticação > configurações de autenticação** e execute as seguintes etapas:
    ...
    ![Administração] do (./media/zscaler-three-tutorial/ic800206.png "Administração") do
...
3. Clique na guia **conexões** .   
     ...
     ![Conexões] do (./media/zscaler-three-tutorial/ic769493.png "Conexões") do
...
Nesta seção, você permitirá que Brenda Simon use o logon único do Azure concedendo-lhe acesso ao Zscaler três.

1. Na portal do Azure, selecione **aplicativos empresariais**, selecione **todos os aplicativos**e, em seguida, selecione **Zscaler três**.
...
Nesta seção, um usuário chamado Brenda Simon é criado em Zscaler três. O Zscaler três dá suporte ao provisionamento just-in-time, que é habilitado por padrão. Não há nenhum item de ação para você nesta seção. Se um usuário ainda não existir no Zscaler três, um novo será criado quando você tentar acessar o Zscaler três.
