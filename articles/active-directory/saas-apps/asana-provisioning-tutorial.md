...
Agora começa a sincronização inicial para quaisquer utilizadores atribuídos à Asana na secção **Utilizadores.** A sincronização inicial demora mais tempo a realizar do que as sincronizações subsequentes, que ocorrem aproximadamente a cada 40 minutos, desde que o serviço esteja em execução. Utilize a secção Detalhes de **Sincronização** para monitorizar o progresso e seguir ligações aos registos de atividade de provisionamento. Os registos de auditoria descrevem todas as ações realizadas pelo serviço de provisionamento na sua app Asana.
