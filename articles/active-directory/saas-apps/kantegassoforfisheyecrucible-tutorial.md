...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Kantega SSO para FishEye/Crucible (Single Sign-On) com as suas contas do Azure AD.
...
* Subscrição de ativado Kantega SSO para FishEye/Crucible início de sessão único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Kantega SSO para FishEye/Crucible **SP e IDP** iniciada SSO
...
4. Na caixa de pesquisa, escreva **Kantega SSO para FishEye/Crucible**, selecione **Kantega SSO para FishEye/Crucible** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.

    ![Kantega SSO para FishEye/Crucible na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com o Kantega SSO para FishEye/Crucible com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Kantega SSO para FishEye/Crucible deve ser estabelecido.
...
2. **[Configurar o SSO Kantega para FishEye/Crucible início de sessão único](#configure-kantega-sso-for-fisheyecrucible-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar Kantega SSO para o utilizador de teste FishEye/Crucible](#create-kantega-sso-for-fisheyecrucible-test-user)**  - para ter um equivalente da Eduarda Almeida na Kantega SSO para FishEye/Crucible que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Kantega SSO para FishEye/Crucible** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, execute os seguintes passos:
    ...
    ![Kantega SSO para FishEye/Crucible domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    ![Kantega SSO para FishEye/Crucible domínio e URLs únicas início de sessão em informações](common/metadata-upload-additional-signon.png)
...
7. Sobre o **configurar o SSO Kantega para FishEye/Crucible** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-kantega-sso-for-fisheyecrucible-single-sign-on"></a>Configurar o SSO Kantega para FishEye/Crucible início de sessão único

1. Numa janela do browser web diferente, inicie sessão no seu servidor no local de FishEye/Crucible como um administrador.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Kantega SSO para FishEye/Crucible**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Kantega SSO para FishEye/Crucible**.

    ![O SSO Kantega para ligação de FishEye/Crucible na lista de aplicações](common/all-applications.png)
...
### <a name="create-kantega-sso-for-fisheyecrucible-test-user"></a>Criar Kantega SSO para o utilizador de teste FishEye/Crucible
...
1. Inicie sessão no seu servidor no local de Crucible como um administrador.
...
Ao clicar o SSO Kantega para mosaico FishEye/Crucible no painel de acesso, deve ser automaticamente sessão iniciada no SSO Kantega para FishEye/Crucible para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
