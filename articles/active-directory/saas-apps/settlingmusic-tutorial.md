---
title: 'Tutorial: Integração do Azure Ative Directory com a música settling Microsoft Docs'
...
2. **[Configure a música de fixação single Sign-On](#configure-settling-music-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
