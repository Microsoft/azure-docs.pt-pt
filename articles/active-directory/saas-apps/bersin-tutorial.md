---
title: 'Tutorial: Integração do Azure Ative Directory com a Bersin Microsoft Docs'
...
Quando clicar no azulejo bersin no Painel de Acesso, deverá ser automaticamente inscrito na Bersin para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
