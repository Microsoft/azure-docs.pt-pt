---
title: 'Tutorial: Integração do Azure Ative Directory com o Synergi Microsoft Docs'
...
2. **[Configure o Sintergi Single Sign-On](#configure-synergi-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-synergi-single-sign-on"></a>Configurar sinais único sign-on
...
Quando clicar no teis synergi no Painel de Acesso, deverá ser automaticamente inscrito no Synergi para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
