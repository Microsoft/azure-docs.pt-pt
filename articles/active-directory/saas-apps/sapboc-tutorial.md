...
2. Selecione **Menu**  >  a Administração do**Sistema de**  >  **Administration**Menus .
...
2. Selecione **Menu**  >  **Security**  >  **Utilizadores**de Segurança do Menu .
...
3. Na página **Utilizadores,** para adicionar novos dados do utilizador, selecione **+** . 
    ...
    a. Na caixa **de ID do UTILIZADOR,** introduza o ID do utilizador, como **B**.

    b. Na caixa **FIRST NAME,** insira o primeiro nome do utilizador, como **B**.

    c. Na **caixa NAME,** insira o último nome do utilizador, como **Simão.**

    d. Na caixa **DISPLAY NAME,** insira o nome completo do utilizador, como **B.Simon**.

    e. Na caixa **de E-MAIL,** insira o endereço de e-mail do utilizador, como `b.simon@contoso.com` .

    f. Na página **'Selecionar peças',** selecione a função adequada para o utilizador e, em seguida, selecione **OK**.

      ![Selecionar função](./media/sapboc-tutorial/user3.png)

    exemplo, Selecione o ícone **Guardar.**

### <a name="test-sso"></a>Teste SSO 

Nesta secção, testa a configuração de inscrição única AZure AD utilizando o Painel de Acesso.

Quando clicar no azulejo da Nuvem Analítica SAP no Painel de Acesso, deverá ser automaticamente inscrito na Nuvem Analítica SAP para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
