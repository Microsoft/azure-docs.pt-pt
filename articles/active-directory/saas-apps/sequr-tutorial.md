---
title: 'Tutorial: Integração do Azure Ative Directory com a Sequr / Microsoft Docs'
description: Saiba como configurar um único sinal entre o Azure Ative Directory e o Sequr.
...
A integração do Sequr com a AD Azure proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso a Sequr.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos no Sequr (Sign-On Único) com as suas contas AD Azure.
...
Para configurar a integração AD da Azure com a Sequr, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode obter uma [conta gratuita](https://azure.microsoft.com/free/)
* Assinatura ativada única sequr

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configura e testa Azure AD um único sinal de acesso em um ambiente de teste.

* Sequr apoia **SP e IDP** iniciado SSO

## <a name="adding-sequr-from-the-gallery"></a>Adicionar Sequr da galeria

Para configurar a integração do Sequr no Azure AD, precisa adicionar o Sequr da galeria à sua lista de aplicações geridas pelo SaaS.
...
4. Na caixa de pesquisa, **digite Sequr** , selecione **Sequr** do painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar a aplicação.

    ![Sequr na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar Azure AD único sinal de inscrição

Nesta secção, você configura e testa Azure AD single sign-on com Sequr com base em um utilizador de teste chamado **Britta Simon** .
Para um único sinal de trabalho, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado em Sequr.
...
Para configurar o Azure AD com o Sequr, execute os seguintes passos:

1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **Sequr,** selecione **Single sign-on** .
...
4. Na secção **De Configuração Básica SAML,** se pretender configurar a aplicação no modo iniciado pelo **IDP,** execute o seguinte passo:
    ...
    ![Sequr Domain e URLs informações únicas de súmrica](common/idp-identifier.png)
...
7. Na secção **set up Sequr,** copie os URL(s) apropriados de acordo com o seu requisito.
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso ao Sequr.
...
Nesta secção, cria-se um utilizador chamado Britta Simon em Sequr. Trabalhe com a [equipa de suporte do Cliente Sequr](mailto:support@sequr.io) para adicionar os utilizadores na plataforma Sequr. Os utilizadores devem ser criados e ativados antes de utilizar uma única s ativação.

### <a name="test-single-sign-on"></a>Testar o início de sessão único 

Nesta secção, testa a configuração de inscrição única AZure AD utilizando o Painel de Acesso.

Quando clicar no azulejo Sequr no Painel de Acesso, deverá ser automaticamente inscrito no Sequr para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
