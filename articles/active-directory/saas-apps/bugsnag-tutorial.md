---
title: 'Tutorial: Integração do Azure Ative Directory com o Bugsnag Microsoft Docs'
...
Quando clicar no azulejo bugsnag no Painel de Acesso, deverá ser automaticamente inscrito no Bugsnag para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
