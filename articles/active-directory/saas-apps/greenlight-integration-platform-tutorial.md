...
Neste tutorial, você vai aprender a integrar a Plataforma de Integração Greenlight com o Azure Ative Directory (Azure AD). Quando integrar a Plataforma de Integração Greenlight com o Azure AD, pode:

* Controlo em Azure AD que tem acesso à Plataforma de Integração Greenlight.
* Ative que os seus utilizadores sejam automaticamente inscritos na Greenlight Integration Platform com as suas contas Azure AD.
...
* Greenlight Integration Platform single sign-on (SSO) enabled subscrição.

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configura e testa o Azure AD SSO num ambiente de teste.

* Plataforma de Integração Greenlight suporta **SP e IDP** iniciadoS SSO
* Assim que configurar a Plataforma de Integração Greenlight, pode impor o controlo da sessão, que protege a exfiltração e infiltração dos dados sensíveis da sua organização em tempo real. O controlo da sessão estende-se a partir do Acesso Condicional. [Saiba como impor o controlo](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)da sessão com o Microsoft Cloud App Security .

## <a name="adding-greenlight-integration-platform-from-the-gallery"></a>Adicionar plataforma de integração Greenlight a partir da galeria
...
1. No **Add da** secção galeria, digite plataforma de **integração Greenlight** na caixa de pesquisa.
1. Selecione **Greenlight Integration Platform** a partir do painel de resultados e, em seguida, adicione a aplicação. Espere alguns segundos enquanto a aplicação é adicionada ao seu inquilino.

## <a name="configure-and-test-azure-ad-single-sign-on-for-greenlight-integration-platform"></a>Configure e teste Azure AD único sign-on para greenlight plataforma de integração

Configure e teste Azure AD SSO com plataforma de integração Greenlight utilizando um utilizador de teste chamado **B.Simon**. Para que o SSO funcione, é necessário estabelecer uma relação de ligação entre um utilizador da AD Azure e o utilizador relacionado na Plataforma de Integração Greenlight.
...
1. Configure a Plataforma de **[Integração greenlight SSO](#configure-greenlight-integration-platform-sso)** - para configurar as definições de inscrição únicas no lado da aplicação.
...
1. No [portal Azure,](https://portal.azure.com/)na página de integração de aplicações da Plataforma de **Integração Greenlight,** encontre a secção **Gerir** e selecione **um único sinal.**
