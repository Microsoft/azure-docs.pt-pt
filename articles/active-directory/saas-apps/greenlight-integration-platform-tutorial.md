---
title: 'Tutorial: Azure Ative Directory integração única de sign-on (SSO) com a Plataforma de Integração Greenlight | Microsoft Docs'
...
- [Como proteger a Plataforma de Integração Greenlight com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)