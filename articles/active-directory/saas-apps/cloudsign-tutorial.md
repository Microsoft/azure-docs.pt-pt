---
title: 'Tutorial: Azure Ative Directory integração única de sign-on (SSO) com a CloudSign | Microsoft Docs'
...
Quando clicar no azulejo CloudSign no Painel de Acesso, deverá ser automaticamente inscrito no CloudSign para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger o CloudSign com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)