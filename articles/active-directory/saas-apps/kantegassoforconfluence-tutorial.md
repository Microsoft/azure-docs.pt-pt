...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Kantega SSO para confluência (Single Sign-On) com as suas contas do Azure AD.
...
* Subscrição de ativado Kantega SSO para confluência início de sessão único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Kantega SSO para confluência **SP e IDP** iniciada SSO
...
4. Na caixa de pesquisa, escreva **Kantega SSO para confluência**, selecione **Kantega SSO para confluência** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.

    ![Kantega SSO para confluência na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com o Kantega SSO para confluência com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Kantega SSO para confluência deve ser estabelecido.
...
2. **[Configurar o SSO Kantega para confluência início de sessão único](#configure-kantega-sso-for-confluence-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar Kantega SSO para o utilizador de teste confluência](#create-kantega-sso-for-confluence-test-user)**  - para ter um equivalente da Eduarda Almeida na Kantega SSO para confluência que está ligada à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Kantega SSO para confluência** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, execute os seguintes passos:
    ...
    ![Kantega SSO para confluência de domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    ![Kantega SSO para confluência de domínio e URLs únicas início de sessão em informações](common/metadata-upload-additional-signon.png)
...
7. Sobre o **configurar o SSO Kantega para confluência** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-kantega-sso-for-confluence-single-sign-on"></a>Configurar o SSO Kantega para confluência início de sessão único
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Kantega SSO para confluência**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Kantega SSO para confluência**.

    ![O SSO Kantega para ligação de confluência na lista de aplicações](common/all-applications.png)
...
### <a name="create-kantega-sso-for-confluence-test-user"></a>Criar Kantega SSO para o utilizador de teste confluência

Para ativar a iniciar sessão na confluência de utilizadores do Azure AD, tem de ser aprovisionados na confluência. No caso de Kantega SSO para confluência, o aprovisionamento é uma tarefa manual.

**Para Aprovisionar uma conta de utilizador, execute os seguintes passos:**

1. Inicie sessão no seu SSO Kantega para o site de empresa confluência como administrador.
...
Ao clicar o SSO Kantega para mosaico confluência no painel de acesso, deve ser automaticamente sessão iniciada no SSO Kantega para confluência para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
