---
title: 'Tutorial: Configure nova relíquia por Organização para fornecimento automático de utilizadores com Diretório Ativo Azure [ Microsoft Docs'
description: Aprenda a fornecer e desfornecer automaticamente contas de utilizadores de Azure AD para New Relic by Organization.
...
Este tutorial descreve os passos necessários para executar tanto em New Relic by Organization como no Azure Ative Directory (Azure AD) para configurar o fornecimento automático de utilizadores. Quando configurado, a Azure AD disponibiliza e desinpresta automaticamente utilizadores e grupos à [New Relic by Organization](https://newrelic.com/) utilizando o serviço de provisionamento de AD Azure. Para detalhes importantes sobre o que este serviço faz, como funciona, e perguntas frequentes, consulte o fornecimento e o [desprovisionamento de utilizadores automate para aplicações SaaS com o Diretório Ativo Azure.](../manage-apps/user-provisioning.md) 


## <a name="capabilities-supported"></a>Capacidades Suportadas
> [!div class="checklist"]
> * Criar utilizadores em Nova Relíquia por Organização
> * Remova os utilizadores em New Relic by Organization quando já não necessitam de acesso
> * Mantenha os atributos dos utilizadores sincronizados entre a Azure AD e a New Relic by Organization
> * Grupos de provisões e membros do grupo em New Relic by Organization
> * [Inscrição única](https://docs.microsoft.com/azure/active-directory/saas-apps/new-relic-limited-release-tutorial) para Nova Relíquia por Organização (recomendado)
...
3. Determine quais os dados a [mapear entre a AD Azure e](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)a Nova Relíquia por Organização. 

## <a name="step-2-configure-new-relic-by-organization-to-support-provisioning-with-azure-ad"></a>Passo 2. Configure nova relíquia por organização para apoiar o provisionamento com a AD Azure
...
## <a name="step-3-add-new-relic-by-organization-from-the-azure-ad-application-gallery"></a>Passo 3. Adicione nova relíquia por organização da galeria de aplicações da AD Azure

Adicione a Nova Relíquia por Organização da galeria de aplicações Azure AD para começar a gerir o provisionamento à New Relic by Organization. Se já criou a New Relic by Organization for SSO, pode utilizar a mesma aplicação. No entanto, recomenda-se que crie uma aplicação separada ao testar a integração inicialmente. Saiba mais sobre a adição de uma aplicação na galeria [aqui.](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) 
...
## <a name="step-5-configure-automatic-user-provisioning-to-new-relic-by-organization"></a>Passo 5. Configure o fornecimento automático de utilizadores à Nova Relíquia por Organização 
...
2. Na lista de candidaturas, selecione **New Relic by Organization**.
...
8. Na secção **Mapeamentos,** **selecione Synchronize Azure Ative Directory Users to New Relic by Organization**.

9. Reveja os atributos do utilizador que são sincronizados de Azure AD para New Relic by Organization na secção **Attribute-Mapping.** Os atributos selecionados como propriedades **Correspondentes** são usados para combinar as contas de utilizador em New Relic by Organization para operações de atualização. Se optar por alterar o [atributo-alvo correspondente,](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)terá de garantir que a Nova Relíquia pela Organização API suporta filtrar os utilizadores com base nesse atributo. Selecione o botão **Guardar** para elegiro qualquer alteração.
...
10. Na secção **Mapeamentos,** **selecione Synchronize Azure Ative Directory Groups to New Relic by Organization**.

11. Reveja os atributos do grupo que são sincronizados de Azure AD para New Relic by Organization na secção **Attribute-Mapping.** Os atributos selecionados como propriedades **correspondentes** são usados para combinar os grupos em New Relic by Organization para operações de atualização. Selecione o botão **Guardar** para elegiro qualquer alteração.
...
13. Para permitir o serviço de provisionamento de AD Azure para A Nova Relíquia por Organização, altere o Estado de **Provisionamento** para **On** na secção **Definições.**

    ![Estatuto de provisionamento Alternado](common/provisioning-toggle-on.png)

14. Defina os utilizadores e/ou grupos que gostaria de fornecer à New Relic pela Organização, escolhendo os valores desejados no **Âmbito** na secção **Definições.**
