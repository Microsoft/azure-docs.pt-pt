---
title: 'Tutorial: Configurar nova relíquia por organização para fornecimento automático de utilizadores com Azure Ative Directory | Microsoft Docs'
...
Este tutorial descreve os passos necessários para realizar tanto em New Relic by Organization como no Azure Ative Directory (Azure AD) para configurar o fornecimento automático de utilizadores. Quando configurado, a Azure AD fornece automaticamente e desnegri os utilizadores e grupos para [Nova Relíquia por Organização](https://newrelic.com/) utilizando o serviço de provisionamento Azure AD. Para obter detalhes importantes sobre o que este serviço faz, como funciona e perguntas frequentes, veja [Automatizar o aprovisionamento e desaprovisionamento de utilizadores em aplicações SaaS no Azure Active Directory](../app-provisioning/user-provisioning.md). 
...
> * [Único sinal de](./new-relic-limited-release-tutorial.md) nova relíquia por organização (recomendado)
...
3. Determine quais os dados a [mapear entre Azure AD e New Relic by Organization](../app-provisioning/customize-application-attributes.md). 
...
9. Reveja os atributos do utilizador que são sincronizados de Azure AD a Nova Relíquia por Organização na secção **De Mapeamento de Atributos.** Os atributos selecionados como propriedades **de correspondência** são utilizados para combinar as contas de utilizador em New Relic by Organization para operações de atualização. Se optar por alterar o [atributo de alvo correspondente,](../app-provisioning/customize-application-attributes.md)terá de garantir que a Nova Relíquia da Organização API suporta utilizadores filtrantes com base nesse atributo. Selecione o botão **Guardar** para escoar quaisquer alterações.
