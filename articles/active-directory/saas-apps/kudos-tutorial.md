---
title: 'Tutorial: Integração do Azure Ative Directory com o Kudos Microsoft Docs'
...
2. **[Configure kudos único sign-on](#configure-kudos-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de inscrição real. Contacte [a equipa de apoio ao Cliente Kudos](http://success.kudosnow.com/home) para obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-kudos-single-sign-on"></a>Configurar kudos único sign-on
...
Quando clicar no azulejo de Kudos no Painel de Acesso, deverá ser automaticamente inscrito nos Kudos para os quais configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
