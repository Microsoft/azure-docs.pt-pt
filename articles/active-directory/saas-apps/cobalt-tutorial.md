---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com Cobalt Microsoft Docs'
...
1. Na secção **Configuração Básica SAML,** insira os valores para os seguintes campos:
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de inscrição real. Contacte [a equipa de suporte do Cliente Cobalt](https://www.cobalt.net/support/) para obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
Quando clicar no azulejo cobalto no Painel de Acesso, deverá ser automaticamente inscrito no Cobalt para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
