---
title: 'Tutorial: Integração do Azure Ative Directory com a Frontline Education Microsoft Docs'
...
2. **[Configure o SSO de Educação da Linha da Frente](#configure-frontline-education-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo da Frontline Education no Painel de Acesso, deverá ser automaticamente inscrito na Educação da Linha da Frente para a qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
