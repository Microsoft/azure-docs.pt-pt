...
* Caixa suporta [ **fornecimento automatizado** de utilizadores e desprovisionamento](https://docs.microsoft.com/azure/active-directory/saas-apps/box-userprovisioning-tutorial) (recomendado)
...
Quando clicar no azulejo da Caixa no Painel de Acesso, deverá ser automaticamente inscrito na Caixa para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
