---
title: 'Tutorial: Integração do Azure Ative Directory com a Coupa Microsoft Docs'
...
A integração de Coupa com a Azure AD proporciona-lhe os seguintes benefícios:

* Podes controlar em Azure AD que tem acesso a Coupa.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos no Coupa (Sign-on único) com as suas contas AD Azure.
...
Para configurar a integração AZure AD com Coupa, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode ter um mês de julgamento [aqui.](https://azure.microsoft.com/pricing/free-trial/)
* Assinatura ativada por coupa única
...
Nesta secção, você configura e testa Azure AD single sign-on com Coupa com base em um utilizador de teste chamado **Britta Simon**.
Para um único sinal de trabalho, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado em Coupa.
...
Para configurar o Azure AD com coupa, execute os seguintes passos:

1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **Coupa,** selecione **Single sign-on**.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    ![Coupa Domain e URLs informações únicas de assinatura](common/sp-identifier-reply.png)
    ...
    c. Na caixa de texto **URL de resposta,** digite um URL:
...
3. Clique em **Criar**.
    ...
    ![Create Users](./media/coupa-tutorial/ic791909.png "Criar Utilizadores") (Criar Utilizadores)
...
Quando clicar no azulejo coupa no Painel de Acesso, deverá ser automaticamente inscrito no Coupa para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
