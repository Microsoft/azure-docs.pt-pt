...
>[!NOTE]
>Você pode usar qualquer outra ferramenta de criação de conta de usuário do Vitóriaa ou APIs fornecidas pelo Vitóriaa para provisionar contas de usuário do Azure AD.
