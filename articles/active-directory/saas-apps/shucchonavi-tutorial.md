...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Shuccho Navi (Single Sign-On) com as suas contas do Azure AD.
...
* Shuccho Navi logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Shuccho Navi **SP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com Shuccho Navi com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Shuccho Navi deve ser estabelecido.
...
2. **[Configurar Shuccho Navi início de sessão único](#configure-shuccho-navi-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Shuccho Navi](#create-shuccho-navi-test-user)**  - para ter um equivalente da Eduarda Almeida na Shuccho Navi que está ligado à representação de utilizador do Azure AD.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![Shuccho Navi domínio e URLs únicas início de sessão em informações](common/sp-signonurl.png)
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de início de sessão real. Contacte [equipa de suporte de cliente de Navi Shuccho](mailto:sys_ntabtm@nta.co.jp) para obter o valor. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.

5. No **definido no início de sessão único com o SAML** página, além do **certificado de assinatura SAML** secção, clique em **transferir** para transferir o **XML de metadados de Federação**  entre as opções de determinado de acordo com seus requisitos e guarde-o no seu computador.

    ![O link de download de certificado](common/metadataxml.png)

6. Sobre o **configurar Shuccho Navi** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-shuccho-navi-single-sign-on"></a>Configurar Shuccho Navi início de sessão único

Para configurar o início de sessão único num **Shuccho Navi** lado, terá de enviar o transferido **XML de metadados** e adequadas copiados URLs a partir do portal do Azure para [equipa de suporte de Shuccho Navi](mailto:sys_ntabtm@nta.co.jp). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Shuccho Navi**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Shuccho Navi**.

    ![A ligação de Shuccho Navi na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico Shuccho Navi no painel de acesso, deve ser automaticamente sessão iniciada no Shuccho Navi para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
