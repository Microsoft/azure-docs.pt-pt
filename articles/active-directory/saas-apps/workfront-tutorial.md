---
title: 'Tutorial: Integração do Azure Ative Directory com Workfront Microsoft Docs'
...
2. **[Configure o Sign-On único da frente de trabalho](#configure-workfront-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-workfront-single-sign-on"></a>Configurar o sign-on único da frente de trabalho
...
Quando clicar no azulejo workfront no Painel de Acesso, deverá ser automaticamente inscrito na Workfront para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
