...
2. **[Configure SAML 1.1 Token permitiu que a aplicação LOB single sign-on](#configure-saml-11-token-enabled-lob-app-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
