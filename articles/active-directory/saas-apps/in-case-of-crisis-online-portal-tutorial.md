...
* Assim que configurar o Em Caso de Crise - Portal Online pode impor controlos de sessão, que protegem a exfiltração e infiltração dos dados sensíveis da sua organização em tempo real. Os controles de sessão se estendem do acesso condicional. [Saiba como impor o controlo](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)da sessão com o Microsoft Cloud App Security .
...
1. Selecione **Em Caso de Crise - Portal Online** do painel de resultados e, em seguida, adicione a app. Aguarde alguns segundos enquanto o aplicativo é adicionado ao seu locatário.
