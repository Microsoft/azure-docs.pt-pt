---
title: 'Tutorial: Integração do Azure Ative Directory com Greenhouse Microsoft Docs'
...
2. **[Configure o Sign-On Único de Estufa](#configure-greenhouse-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
### <a name="configure-greenhouse-single-sign-on"></a>Configurar o sign-on único da estufa
