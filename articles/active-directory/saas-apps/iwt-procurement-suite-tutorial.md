---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com suíte de aquisição do IWT Microsoft Docs'
...
Quando clicar no azulejo da Suíte de Compras IWT no Painel de Acesso, deverá ser automaticamente inscrito na Suite de Aquisição IWT para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
- [Como proteger a Suíte de Aquisição da IWT com visibilidade e controlos avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
