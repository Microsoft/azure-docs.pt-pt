---
title: 'Tutorial: Integração do Azure Ative Directory com Land Gorilla Microsoft Docs'
...
2. **[Configure land Gorilla SSO](#configure-land-gorilla-sso)** - para configurar as definições de Sign-On único no lado da aplicação.
...
Quando clicar no azulejo Land Gorilla no Painel de Acesso, deverá ser automaticamente inscrito no Land Gorilla para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
