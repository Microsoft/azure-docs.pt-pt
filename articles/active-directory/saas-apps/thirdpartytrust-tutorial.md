...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para ThirdPartyTrust (Single Sign-On) com as suas contas do Azure AD.
...
* ThirdPartyTrust logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta ThirdPartyTrust **SP** e **IDP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com ThirdPartyTrust com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no ThirdPartyTrust deve ser estabelecido.
...
2. **[Configurar ThirdPartyTrust Single Sign-On](#configure-thirdpartytrust-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste ThirdPartyTrust](#create-thirdpartytrust-test-user)**  - para ter um equivalente da Eduarda Almeida na ThirdPartyTrust que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **ThirdPartyTrust** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, executar o passo seguinte:
    ...
    ![ThirdPartyTrust domínio e URLs únicas início de sessão em informações](common/idp-identifier.png)
...
7. Sobre o **configurar ThirdPartyTrust** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-thirdpartytrust-single-sign-on"></a>Configurar ThirdPartyTrust Single Sign-On

Para configurar o início de sessão único num **ThirdPartyTrust** lado, terá de enviar o transferido **XML de metadados de Federação** e adequadas copiados URLs a partir do portal do Azure para [ThirdPartyTrust equipa de suporte](mailto:support@thirdpartytrust.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **ThirdPartyTrust**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **ThirdPartyTrust**.

    ![A ligação de ThirdPartyTrust na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico ThirdPartyTrust no painel de acesso, deve ser automaticamente sessão iniciada no ThirdPartyTrust para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
