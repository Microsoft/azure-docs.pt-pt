...
* É recomendável que um único usuário do Azure AD seja atribuído para recompensar o gateway para testar a configuração automática de provisionamento de usuário. Usuários e/ou grupos adicionais podem ser atribuídos posteriormente.
...
1. Entre no seu [console de administração do gateway de recompensa](https://rewardgateway.photoshelter.com/login/). Cliqueem integrações.
...
## <a name="add-reward-gateway-from-the-gallery"></a>Adicionar gateway de recompensa da Galeria
