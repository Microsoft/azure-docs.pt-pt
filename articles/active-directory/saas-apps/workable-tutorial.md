---
title: 'Tutorial: Integração do Azure Ative Directory com Workable Microsoft Docs'
...
Quando clicar no azulejo viável no Painel de Acesso, deverá ser automaticamente inscrito no Workable para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
