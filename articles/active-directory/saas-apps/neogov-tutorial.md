---
title: 'Tutorial: Integração do Active Directory do Azure com NEOGOV | Documentos da Microsoft'
description: Saiba como configurar o início de sessão único entre o Azure Active Directory e NEOGOV.
...
Neste tutorial, irá aprender como integrar NEOGOV com o Azure Active Directory (Azure AD). Quando integrar NEOGOV com o Azure AD, pode:

* Controlar no Azure AD que tenha acesso ao NEOGOV.
* Permita que os utilizadores ser automaticamente sessão iniciada para NEOGOV com as suas contas do Azure AD.
...
* NEOGOV início de sessão único (SSO) ativado na subscrição.

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configurar e testar o SSO do Azure AD num ambiente de teste. Suporta NEOGOV **IDP** iniciada SSO.

## <a name="adding-neogov-from-the-gallery"></a>Adicionando NEOGOV da Galeria

Para configurar a integração do NEOGOV com o Azure AD, terá de adicionar NEOGOV a partir da Galeria à sua lista de aplicações de SaaS geridas.
...
1. Na **adicionar a partir da galeria** secção, escreva **NEOGOV** na caixa de pesquisa.
1. Selecione **NEOGOV** do painel de resultados e, em seguida, adicionar a aplicação. Aguarde alguns segundos enquanto a aplicação é adicionada ao seu inquilino.

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Configurar e testar o SSO do Azure AD com NEOGOV com um utilizador de teste **B. Simon**. Para SSO para funcionar, tem de estabelecer uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no NEOGOV.

Para configurar e testar o SSO do Azure AD com NEOGOV, conclua os seguintes blocos de construção:

1. **[Configurar o SSO do Azure AD](#configure-azure-ad-sso)**  - para permitir que os utilizadores utilizar esta funcionalidade.
2. **[Configurar o NEOGOV SSO](#configure-neogov-sso)**  - para configurar as definições de início de sessão único no lado do aplicativo.
...
5. **[Criar utilizador de teste NEOGOV](#create-neogov-test-user)**  - para ter um equivalente de Simon B. no NEOGOV que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **NEOGOV** página de integração de aplicativo, encontrar o **gerir** secção e selecione **início de sessão único**.
...
1. Além dos acima, o aplicativo NEOGOV espera mais alguns atributos a serem passados na resposta SAML. Na secção de afirmações de utilizador na caixa de diálogo de atributos de utilizador, execute os seguintes passos para adicionar o atributo de token SAML como mostra a tabela a seguir:
...
### <a name="configure-neogov-sso"></a>Configurar o NEOGOV SSO

Para configurar o início de sessão único num **NEOGOV** lado, terá de enviar o **Url de metadados de Federação de aplicação** para [equipa de suporte de NEOGOV](mailto:itops@neogov.net). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
Nesta secção, irá ativar a Simon B. utilizar o Azure início de sessão único ao conceder acesso para NEOGOV.
...
Nesta secção, vai criar um usuário chamado Simon B. no NEOGOV. Trabalhar com [equipa de suporte de NEOGOV](mailto:itops@neogov.net) para adicionar os utilizadores na plataforma NEOGOV. Os utilizadores tem de ser criados e ativados antes de utilizar o início de sessão único.

### <a name="test-sso"></a>Teste SSO

Ao selecionar o mosaico NEOGOV no painel de acesso, deve ser automaticamente sessão iniciada no NEOGOV para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
