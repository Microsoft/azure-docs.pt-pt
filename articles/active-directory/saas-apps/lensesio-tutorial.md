...
ms.locfileid: "86172806"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-lensesio"></a>Tutorial: Azure Ative Directory integração única (SSO) com Lenses.io

Neste tutorial, você vai aprender a integrar Lenses.io com Azure Ative Directory (Azure AD). Quando integra Lenses.io com a AD Azure, pode:

* Controlo em Azure AD que tem acesso a Lenses.io.
* Ative os seus utilizadores a serem automaticamente inscritos para Lenses.io com as suas contas AD Azure.
...
* Lenses.io subscrição ativada por um único sso (SSO).
...
Configure e teste Azure AD SSO com Lenses.io usando um utilizador de teste chamado **B.Simon**. Para que o SSO funcione, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado em Lenses.io.
...
1. **[Configure Lenses.io SSO](#configure-lensesio-sso)** - para configurar as definições de inscrição única no lado da aplicação.
    1. **[Crie Lenses.io utilizador de teste](#create-lensesio-test-user)** - para ter uma contraparte de B.Simon em Lenses.io que está ligada à representação AD AD do utilizador.
...
1. Na secção **Configuração Básica SAML,** insira os valores para os seguintes campos:
    ...
    a. Na caixa de texto **URL, digite** um URL utilizando o seguinte padrão:`https://<CUSTOMER_LENSES_BASE_URL>`

    b. Na caixa de texto **identifier (Entity ID),** digite um URL utilizando o seguinte padrão:`https://<CUSTOMER_LENSES_BASE_URL>`
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o sinal real em URL, URL de resposta e identificador. Contacte [Lenses.io equipa de apoio ao Cliente](mailto:support@lenses.io) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.

1. Na **configuração de um único sessão de inscrição com** a página SAML, na secção **Certificado de Assinatura SAML,** encontre o **Metadados XML da Federação** e selecione **Descarregue** para descarregar o certificado e guarde-o no seu computador.

    ![O link de descarregamento de certificado](common/metadataxml.png)

1. Na secção **Configuração Lenses.io,** copie os URL(s) apropriados com base no seu requisito.
...
Para configurar um único sign-on **Lenses.io** lado, você precisa enviar os **metadados XML da Federação** descarregados e URLs copiados apropriados do portal Azure para [Lenses.io equipa de suporte](mailto:support@lenses.io). Eles definem esta definição para ter a ligação SSO SAML corretamente definida em ambos os lados.

### <a name="create-lensesio-test-user"></a>Criar Lenses.io utilizador de teste

Nesta secção, cria-se um utilizador chamado Britta Simon em Lenses.io. Trabalhe com [Lenses.io equipa de suporte](mailto:support@lenses.io) para adicionar os utilizadores na plataforma Lenses.io. Os utilizadores devem ser criados e ativados antes de utilizar uma única s ativação.

## <a name="test-sso"></a>Teste SSO 

Nesta secção, testa a configuração de inscrição única AZure AD utilizando o Painel de Acesso.

Quando clicar no azulejo Lenses.io no Painel de Acesso, deverá ser automaticamente inscrito no Lenses.io para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
