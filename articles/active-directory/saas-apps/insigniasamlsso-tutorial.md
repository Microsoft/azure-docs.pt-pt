---
title: 'Tutorial: Integração do Diretório Ativo Azure com Insignia SAML SSO | Microsoft Docs'
...
2. **[Configure insígnias SAML SSO Single Sign-On](#configure-insignia-saml-sso-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-insignia-saml-sso-single-sign-on"></a>Configure Insignia SAML SSO Single Sign-On
...
Quando clicar no azulejo SSO insígnia SAML no Painel de Acesso, deverá ser automaticamente inscrito no SSO insígnia SAML para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
