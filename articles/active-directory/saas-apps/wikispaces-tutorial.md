...
2. **[Configure wikispaces Single Sign-On](#configure-wikispaces-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
