---
title: 'Tutorial: Integração do Azure Ative Directory com a HyperAnna Microsoft Docs'
...
2. **[Configure HyperAnna SSO](#configure-hyperanna-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo HyperAnna no Painel de Acesso, deverá ser automaticamente inscrito no HyperAnna para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
