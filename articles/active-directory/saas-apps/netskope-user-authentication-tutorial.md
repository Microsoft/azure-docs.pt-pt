---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com autenticação do utilizador netskope Microsoft Docs'
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-netskope-user-authentication"></a>Configurar e testar a Azure AD um único sinal para autenticação do utilizador netskope
...
1. **[Configure o SSO de autenticação do utilizador netskope](#configure-netskope-user-authentication-sso)** - para configurar as definições de inscrição única no lado da aplicação.
    * Crie o utilizador de **[teste de autenticação do utilizador netskope](#create-netskope-user-authentication-test-user)** - para ter uma contraparte de B.Simon na Autenticação do Utilizador netskope que está ligada à representação AD AD do utilizador.
...
1. No [portal Azure](https://portal.azure.com/), na página de integração da **aplicação netskope User Authentication,** encontre a secção **Gerir** e selecione um único sinal de **sação**.
...
1. Clique no **separador Definições** a partir do painel de navegação esquerdo.
    ...
    ![Criação do utilizador de autenticação do utilizador netskope](./media/netskope-user-authentication-tutorial/config-settings.png)

1. Clique no separador **Plataforma Ativa.**

    ![Criação do utilizador de autenticação do utilizador netskope](./media/netskope-user-authentication-tutorial/user1.png)

1. Clique **no separador Utilizadores.**

    ![Criação do utilizador de autenticação do utilizador netskope](./media/netskope-user-authentication-tutorial/add-user.png)

1. CLIQUE **EM UTILIZADORES DE ADD**.

    ![Criação do utilizador de autenticação do utilizador netskope](./media/netskope-user-authentication-tutorial/user-add.png)

1. Introduza o endereço de e-mail do utilizador que pretende adicionar e clique em **ADD**.

    ![Criação do utilizador de autenticação do utilizador netskope](./media/netskope-user-authentication-tutorial/add-user-popup.png)

## <a name="test-sso"></a>Teste SSO

Nesta secção, testa a configuração de inscrição única AZure AD utilizando o Painel de Acesso.

Quando clicar no azulejo de autenticação do utilizador netskope no Painel de Acesso, deverá ser automaticamente inscrito na Autenticação do Utilizador netskope para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
- [Experimente a autenticação do utilizador netskope com Azure AD](https://aad.portal.azure.com/)