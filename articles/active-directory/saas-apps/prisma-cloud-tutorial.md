---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com o Prisma Cloud SSO / Microsoft Docs'
...
* Prisma Cloud SSO suporta **provisão de** utilizadores just in time

* Assim que configurar o Prisma Cloud SSO, pode impor controlos de sessão, que protegem a exfiltração e infiltração dos dados sensíveis da sua organização em tempo real. Os controlos de sessão estendem-se desde o Acesso Condicional. [Saiba como impor o controlo da sessão com o Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).

## <a name="adding-prisma-cloud-sso-from-the-gallery"></a>Adicionar Prisma Cloud SSO da galeria
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-prisma-cloud-sso"></a>Configurar e testar Azure AD único sinal para Prisma Cloud SSO
...
Para configurar e testar O Azure AD SSO com o Prisma Cloud SSO, complete os seguintes blocos de construção:
...
1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **Prisma Cloud SSO,** encontre a secção **Gerir** e selecione **um único sinal de sação**.
...
Quando clicar no azulejo Prisma Cloud SSO no Painel de Acesso, deverá ser automaticamente inscrito no SSO da Nuvem prisma para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Experimente o Prisma Cloud SSO com Azure AD](https://aad.portal.azure.com/)