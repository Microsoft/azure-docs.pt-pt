---
title: 'Tutorial: Integração do Azure Ative Directory com Accredible Microsoft Docs'
...
Quando clicar no azulejo accredible no Painel de Acesso, deverá ser automaticamente inscrito no Accredible para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
