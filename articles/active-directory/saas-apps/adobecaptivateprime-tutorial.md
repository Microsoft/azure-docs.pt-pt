---
title: 'Tutorial: Integração do Azure Ative Directory com a Adobe Captivate Prime Microsoft Docs'
...
### <a name="configure-adobe-captivate-prime-single-sign-on"></a>Configurar Adobe Cativar prime single sign-on
...
Quando clicar no azulejo Prima Adobe Captivate no Painel de Acesso, deverá ser automaticamente inscrito no Adobe Captivate Prime para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
