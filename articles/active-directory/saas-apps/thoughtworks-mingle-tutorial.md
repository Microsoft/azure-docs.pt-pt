...
2. **[Configure os trabalhos de pensamento Misturar o único sign-on](#configure-thoughtworks-mingle-single-sign-on)** - para configurar as definições de Sign-On única no lado da aplicação.
...
### <a name="configure-thoughtworks-mingle-single-sign-on"></a>Configurar thoughtworks Misturar Sign-On
