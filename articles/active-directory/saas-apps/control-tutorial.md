---
title: 'Tutorial: Integração do Azure Ative Directory com Controlo Microsoft Docs'
...
2. **[Configure Control SSO](#configure-control-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando selecionar o azulejo de controlo no Painel de Acesso, deverá ser automaticamente inscrito no Controlo para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
