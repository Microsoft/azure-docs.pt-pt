...
2. **[Configure a aprendizagem no work SSO](#configure-learning-at-work-sso)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo Learning at Work no Painel de Acesso, deverá ser automaticamente inscrito no Learning at Work para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
