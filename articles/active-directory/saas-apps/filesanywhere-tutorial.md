---
title: 'Tutorial: Integração do Azure Ative Directory com o FilesAnywhere Microsoft Docs'
...
2. **[Configure ficheirosSQuando se a sign-on única](#configure-filesanywhere-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
5. Clique **em Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação **no** modo iniciado sp:
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de resposta real e URL de inscrição. Contacte [ficheirosA equipa de suporte ao Cliente](mailto:support@FilesAnywhere.com) para obter estes valores. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
### <a name="configure-filesanywhere-single-sign-on"></a>Configure ficheirosAonwhere único sinal
...
Quando clicar no FicheiroSOnde o azulejo do Painel de Acesso, deverá ser automaticamente inscrito no FicheirosOnde configurar sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
