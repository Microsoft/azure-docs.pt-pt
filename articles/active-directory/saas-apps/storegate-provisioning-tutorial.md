...
* Recomenda-se que um único utilizador da AD Azure seja designado para o Storegate para testar a configuração automática de fornecimento do utilizador. Usuários e/ou grupos adicionais podem ser atribuídos posteriormente.
...
2. Dentro das definições, navegue para **Team > Definições** e verifique se o interruptor de alternância está ligado na secção de **sinalização Single.**
...
7. Dentro das definições, navegará para **Team > Definições** e clique no interruptor de alternância na secção de início de sinal único, isto iniciará o fluxo de consentimento. Clique em **Ativar**.
