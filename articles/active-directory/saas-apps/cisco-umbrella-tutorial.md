...
2. **[Configure cisco Umbrella Single Sign-On](#configure-cisco-umbrella-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo da Cisco Umbrella no Painel de Acesso, deverá ser automaticamente inscrito no Cisco Umbrella para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
