...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Reflektive (Single Sign-On) com as suas contas do Azure AD.
...
* Reflektive logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Reflektive **SP** e **IDP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com Reflektive com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Reflektive deve ser estabelecido.
...
2. **[Configurar Reflektive Single Sign-On](#configure-reflektive-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Reflektive](#create-reflektive-test-user)**  - para ter um equivalente da Eduarda Almeida na Reflektive que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Reflektive** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, executar o passo seguinte:
    ...
    ![Reflektive domínio e URLs únicas início de sessão em informações](common/idp-identifier.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    > [!NOTE]
    > Para SP modo tem de obter o id de e-mail registado [equipa de suporte de Reflektive](https://support@reflektive.com). Quando inserir sua ID na **E-Mail** será ativada a caixa de texto, em seguida, a opção de início de sessão única. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.
...
7. Sobre o **configurar Reflektive** secção, copie os URLs apropriados de acordo com seus requisitos.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Reflektive**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Reflektive**.

    ![A ligação de Reflektive na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico Reflektive no painel de acesso, deve ser automaticamente sessão iniciada no Reflektive para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
