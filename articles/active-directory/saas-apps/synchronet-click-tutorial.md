---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com SynchroNet CLICK / Microsoft Docs'
...
Quando clicar no azulejo SynchroNet CLICK no Painel de Acesso, deverá ser automaticamente inscrito no Click SynchroNet para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
