...
description: Saiba como configurar o Azure Ative Directory para provisão automática e desa provisionar contas de utilizadores ao LinkedIn Elevate.
...
O objetivo deste tutorial é mostrar-lhe os passos que precisa de executar no LinkedIn Elevate e AZure AD para provisões automáticas e desavisionamento de contas de utilizadores do Azure AD para LinkedIn Elevate.
...
Antes de configurar e ativar o serviço de fornecimento, terá de decidir quais os utilizadores e/ou grupos em Azure AD que representam os utilizadores que precisam de acesso ao LinkedIn Elevate. Uma vez decididos, pode atribuir estes utilizadores ao LinkedIn Elevate seguindo as instruções aqui:
...
* Recomenda-se que um único utilizador AD Azure seja designado para o LinkedIn Elevate para testar a configuração de provisionamento. Utilizadores e/ou grupos adicionais podem ser atribuídos mais tarde.

* Ao atribuir um utilizador ao LinkedIn Elevate, tem de selecionar a função **Utilizador** no diálogo de atribuição. A função "Acesso Predefinido" não funciona para o provisionamento.
...
4. Clique **+ Adicione a nova configuração SCIM** e siga o procedimento preenchendo cada campo.
    ...
    ![Provisão de Elevação linkedIn](./media/linkedinelevate-provisioning-tutorial/linkedin_elevate1.PNG)
    ...
    ![Provisão de Elevação linkedIn](./media/linkedinelevate-provisioning-tutorial/linkedin_elevate2.PNG)
...
8. Se já configurar o LinkedIn Elevate para um único sign-on, procure a sua instância de LinkedIn Elevate utilizando o campo de pesquisa. Caso contrário, **selecione Add** e procure **linkedIn Elevate** na galeria de aplicações. Selecione LinkedIn Elevate a partir dos resultados da pesquisa e adicione-o à sua lista de aplicações.
...
10. Desa ajuste o **modo de provisionamento** para **automático**.
    ...
    ![Provisão de Elevação linkedIn](./media/linkedinelevate-provisioning-tutorial/linkedin_elevate3.PNG)

11. Preencha os seguintes campos sob **as credenciais de administração:**

    * No campo URL do **inquilino,** insira `https://api.linkedin.com` .
...
14. Na secção **De mapeamentos de atributos,** reveja os atributos do utilizador e do grupo que serão sincronizados de Azure AD para LinkedIn Elevate. Note que os atributos selecionados como propriedades **de correspondência** serão utilizados para combinar com as contas e grupos de utilizador no LinkedIn Elevate para operações de atualização. Selecione o botão Guardar para escoar quaisquer alterações.

    ![Provisão de Elevação linkedIn](./media/linkedinelevate-provisioning-tutorial/linkedin_elevate4.PNG)
