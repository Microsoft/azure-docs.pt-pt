---
title: 'Tutorial: Integração do Diretório Ativo Azure com | eLuminate Microsoft Docs'
...
2. **[Configurar eLuminato Único Sinal -](#configure-eluminate-single-sign-on)** para configurar as definições de Sign-On única no lado da aplicação.
...
### <a name="configure-eluminate-single-sign-on"></a>Configurar Sign-On única eluminada
...
Quando clicar no azulejo eLuminato no Painel de Acesso, deverá ser automaticamente inscrito no eLuminate para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
