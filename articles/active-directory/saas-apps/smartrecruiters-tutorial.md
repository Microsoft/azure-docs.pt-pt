...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para SmartRecruiters (Single Sign-On) com as suas contas do Azure AD.
...
* SmartRecruiters único início de sessão na subscrição ativada

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta SmartRecruiters **SP e IDP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com SmartRecruiters com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no SmartRecruiters deve ser estabelecido.
...
2. **[Configurar SmartRecruiters Single Sign-On](#configure-smartrecruiters-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste SmartRecruiters](#create-smartrecruiters-test-user)**  - para ter um equivalente da Eduarda Almeida na SmartRecruiters que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **SmartRecruiters** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, execute os seguintes passos:
    ...
    ![SmartRecruiters domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    ![SmartRecruiters domínio e URLs únicas início de sessão em informações](common/metadata-upload-additional-signon.png)
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de identificador, o URL de resposta e início de sessão real. Contacte [equipa de suporte de cliente SmartRecruiters](https://www.smartrecruiters.com/about-us/contact-us/) obter esses valores. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.
...
7. Sobre o **configurar SmartRecruiters** secção, copie os URLs apropriados de acordo com seus requisitos.
...
1. Na **configuração do fornecedor de identidade**, execute os seguintes passos:
    ...
    b. Open **certificate(Base64)** que transferiu a partir do portal do Azure no bloco de notas e copie o conteúdo do mesmo e cole **certificado do fornecedor de identidade** caixa de texto.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **SmartRecruiters**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **SmartRecruiters**.

    ![A ligação de SmartRecruiters na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico SmartRecruiters no painel de acesso, deve ser automaticamente sessão iniciada no SmartRecruiters para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
