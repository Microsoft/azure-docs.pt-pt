...
Para configurar e testar a Azure AD SSO com Caprichosa, complete os seguintes blocos de construção:
...
1. No [portal Azure](https://portal.azure.com/), na página de integração de aplicações **caprichosas,** encontre a secção **Gerir** e selecione **um único sinal de sing.on**.
...
Para configurar um único sinal no lado **caprichoso,** precisa de carregar o **MÍnica Federação XML** que acabou de descarregar para as [definições do seu espaço de trabalho.](https://whimsical.com/workspace/settings)
...
Quando clicar no azulejo caprichoso no Painel de Acesso, deverá ser automaticamente inscrito no Caprichoso para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
