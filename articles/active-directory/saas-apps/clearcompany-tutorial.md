...
2. **[Configure ClearCompany Single Sign-On](#configure-clearcompany-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
Quando clicar no azulejo ClearCompany no Painel de Acesso, deverá ser automaticamente inscrito na ClearCompany para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
