...
* Assim que configurar o Comando Verkada, pode impor controlos de sessão, que protegem a exfiltração e infiltração dos dados sensíveis da sua organização em tempo real. Os controlos de sessão estendem-se a partir do Acesso Condicional. [Saiba como impor o controlo](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)da sessão com o Microsoft Cloud App Security .
...
1. Selecione **O Comando Verkada** a partir do painel de resultados e, em seguida, adicione a aplicação. Espere alguns segundos enquanto a aplicação é adicionada ao seu inquilino.
...
1. Clique em **Definir URLs adicionais** e execute o seguinte passo se desejar configurar a aplicação no modo iniciado **por SP:**
    ...
    > [!NOTE]
    > O valor do URL de inscrição não é real. Atualize este valor com o URL de início de sinal real. Contacte a equipa de apoio ao Cliente do [Comando Verkada](mailto:support@verkada.com) para obter este valor. Também pode consultar os padrões mostrados na secção **de Configuração SAML Básica** no portal Azure.
...
Para configurar um único sinal no lado do **Comando Verkada,** você precisa enviar os metadados da **Federação XML** descarregados e URLs copiados apropriados do portal Azure para a equipa de suporte do [Comando Verkada](mailto:support@verkada.com). Eles definiram esta definição para ter a ligação SAML SSO corretamente definida em ambos os lados.

### <a name="create-verkada-command-test-user"></a>Criar o utilizador do teste do Comando Verkada

Nesta secção, cria-se um utilizador chamado B.Simon no Comando Verkada. Trabalhe com a equipa de suporte do [Comando Verkada](mailto:support@verkada.com) para adicionar os utilizadores na plataforma do Comando Verkada. Os utilizadores devem ser criados e ativados antes de utilizar um único sinal.
