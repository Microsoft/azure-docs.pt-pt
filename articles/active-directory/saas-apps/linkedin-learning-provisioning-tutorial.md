...
5. Sob a secção **de Credenciais de Administração,** entrada `https://api.linkedin.com/scim` na URL do **inquilino.** Insira o valor do token de acesso recuperado anteriormente em **Secret Token**. Clique em **'Test Connection'** para garantir que o Azure AD pode ligar-se ao LinkedIn Learning. Se a ligação falhar, certifique-se de que a sua conta LinkedIn Learning tem permissões de Administração e tente novamente.
    ...
    ![provisionamento](./media/linkedin-learning-provisioning-tutorial/provisioning.png)
