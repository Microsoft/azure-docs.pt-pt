---
title: 'Tutorial: Azure Ative Directy integração única com Sabedoria pela Invictus Microsoft Docs'
...
Ao clicar na Sabedoria por Invictus no Painel de Acesso, deverá ser automaticamente inscrito na Sabedoria da Invictus para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
