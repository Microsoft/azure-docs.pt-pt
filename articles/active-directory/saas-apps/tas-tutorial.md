...
2. **[Configure o único sign-on TAS](#configure-tas-single-sign-on)** - para configurar as definições de Sign-On únicas no lado da aplicação.
...
### <a name="configure-tas-single-sign-on"></a>Configurar TAS único sinal de inscrição
