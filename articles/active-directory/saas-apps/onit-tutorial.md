...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Onit (Single Sign-On) com as suas contas do Azure AD.
...
* Onit logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Onit **SP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com Onit com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Onit deve ser estabelecido.
...
2. **[Configurar Onit Single Sign-On](#configure-onit-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Onit](#create-onit-test-user)**  - para ter um equivalente da Eduarda Almeida na Onit que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Onit** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![Onit domínio e URLs únicas início de sessão em informações](common/sp-identifier.png)

    a. Na **iniciar sessão no URL** caixa de texto, escreva um URL com o seguinte padrão: `https://<sub-domain>.onit.com`

    b. Na **identificador (ID de entidade)** caixa de texto, escreva um URL com o seguinte padrão: `https://<sub-domain>.onit.com`

    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o início de sessão real URL e o identificador. Contacte [equipa de suporte de cliente Onit](https://www.onit.com/support) obter esses valores. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.

5. Aplicação de Onit espera que as asserções SAML num formato específico, o que requer a adição de mapeamentos de atributos personalizado à sua configuração de atributos de token SAML. Captura de ecrã seguinte mostra a lista de atributos predefinidos. Clique em **edite** ícone para abrir **atributos do utilizador** caixa de diálogo.

    ![image](common/edit-attribute.png)

6. Além dos acima, o aplicativo Onit espera mais alguns atributos a serem passados na resposta SAML. No **afirmações de utilizador** secção sobre o **atributos de utilizador** caixa de diálogo, execute os seguintes passos para adicionar o atributo de token de SAML conforme mostrado na tabela a seguir:
...
9. Sobre o **configurar Onit** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-onit-single-sign-on"></a>Configurar Onit Single Sign-On
...
5. Sobre o **segurança** separador, execute os seguintes passos:
    ...
    b. Na **URL de destino do Idp** caixa de texto, cole o valor de **URL de início de sessão**, que copiou do portal do Azure.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Onit**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Onit**.

    ![A ligação de Onit na lista de aplicações](common/all-applications.png)
...
Para habilitar logon Onit de utilizadores do Azure AD, tem de ser aprovisionados em Onit. No caso de Onit, o aprovisionamento é uma tarefa manual.
...
3. Sobre o **adicionar utilizador** caixa de diálogo página, execute os seguintes passos:
    ...
    a. Tipo de **nome** e o **endereço de E-Mail** de um Azure válido conta AD que pretende aprovisionar em caixas de texto relacionadas.
