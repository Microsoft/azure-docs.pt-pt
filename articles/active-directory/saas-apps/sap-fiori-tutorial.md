...
> [!NOTE]
> Para a autenticação iniciada pelo CABO SAP Fiori, recomendamos a utilização do parâmetro **IsPassive** no AuthnRequest SAML para autenticação silenciosa. Para mais detalhes sobre o parâmetro **IsPassive** consulte a [Azure AD SAML informações únicas de súprização](https://docs.microsoft.com/azure/active-directory/develop/single-sign-on-saml-protocol)
