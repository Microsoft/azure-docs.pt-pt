...
7. Na seção **configurar & francamente** , copie as URLs apropriadas de acordo com seu requisito.
...
Para configurar o logon único no lado do **& francamente** , é necessário enviar o XML de **metadados de Federação** baixado e as URLs copiadas apropriadas do portal do Azure para a [equipe de suporte do & francamente](mailto:help@andfrankly.com). Eles definem essa configuração para que a conexão de SSO do SAML seja definida corretamente em ambos os lados.
...
Nesta seção, você criará um usuário chamado Brenda Simon em & francamente. Trabalhe com [& equipe de suporte francamente](mailto:help@andfrankly.com) para adicionar os usuários na & plataforma francamente. Os usuários devem ser criados e ativados antes de usar o logon único.
