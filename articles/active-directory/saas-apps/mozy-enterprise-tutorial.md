...
>[!NOTE]
>Você pode usar qualquer outra ferramenta de criação de conta de usuário Enterprise do Mozy ou APIs fornecidas pelo Mozy Enterprise para provisionar contas de usuário do Azure AD.
