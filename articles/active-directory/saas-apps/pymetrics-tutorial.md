---
title: 'Tutorial: Azure Ative Directory integração única de sign-on (SSO) com pymetrics | Microsoft Docs'
...
Quando clicar no azulejo pymétrico no Painel de Acesso, deverá ser automaticamente inscrito na pymetrics para a qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger a pymetrics com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)