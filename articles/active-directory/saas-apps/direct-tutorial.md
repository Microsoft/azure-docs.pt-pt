---
title: 'Tutorial: Integração do Azure Ative Directory com direto Microsoft Docs'
description: Saiba como configurar um único sinal de entrada entre o Azure Ative Directory e o direct.
...
Neste tutorial, aprende-se a integrar diretamente com o Azure Ative Directory (Azure AD).
A integração direta com a Azure AD proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso direto.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos para dirigir (Single Sign-On) com as suas contas AD Azure.
...
Para configurar a integração Azure AD com diretamente, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode obter uma [conta gratuita](https://azure.microsoft.com/free/)
* subscrição direta única ativada
...
## <a name="adding-direct-from-the-gallery"></a>Adicionar diretamente da galeria

Para configurar a integração do direct no AD Azure, é necessário adicionar diretamente da galeria à sua lista de aplicações geridas pelo SaaS.

**Para adicionar diretamente da galeria, execute os seguintes passos:**
...
Nesta secção, configura e testa o Azure AD com base direta num utilizador de teste chamado **Britta Simon**.
Para um único sinal de acesso ao trabalho, deve ser estabelecida uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado em direto.
...
Para configurar o Azure AD com um único sinal de entrada direta, execute os seguintes passos:
...
4. Na secção **De Configuração Básica SAML,** se pretender configurar a aplicação no modo iniciado pelo **IDP,** execute o seguinte passo:
    ...
    ![informações de súmis e URLs diretos](common/idp-identifier.png)

    Na caixa de texto **identifier,** digite um URL:  `https://direct4b.com/`
...
7. Na secção **Configuração direta,** copie os URL(s) apropriados de acordo com o seu requisito.
...
Nesta secção, cria-se um utilizador chamado Britta Simon em direto. Trabalhe com [a equipa de suporte direto](https://direct4b.com/ja/support.html#inquiry) para adicionar os utilizadores na plataforma direta. Os utilizadores devem ser criados e ativados antes de utilizar uma única s ativação.

### <a name="test-single-sign-on"></a>Testar o início de sessão único 

Nesta secção, testa a configuração de inscrição única AZure AD utilizando o Painel de Acesso.

1. Se desejar testar no **Modo Iniciado do IDP:**
...
Quando clicar no azulejo direto no Painel de Acesso, deverá ser automaticamente inscrito no direct para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
