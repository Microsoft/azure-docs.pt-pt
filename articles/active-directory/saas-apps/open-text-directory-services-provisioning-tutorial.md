---
title: 'Tutorial: Configurar serviços de diretório OpenText para fornecimento automático de utilizadores com Azure Ative Directory | Microsoft Docs'
...
> * [Único sinal de abertura](./opentext-directory-services-tutorial.md) para serviços de diretório OpenText (recomendado)
...
3. Determine quais os dados a [mapear entre o Azure AD e os Serviços de Diretório OpenText](../app-provisioning/customize-application-attributes.md). 
