---
title: 'Tutorial: Azure Ative Directory integração única de sign-on (SSO) com MailGates | Microsoft Docs'
...
Quando clicar no azulejo MailGates no Painel de Acesso, deverá ser automaticamente inscrito nos MailGates para os quais configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Como proteger mailGates com visibilidade e controlos avançados](/cloud-app-security/proxy-intro-aad)