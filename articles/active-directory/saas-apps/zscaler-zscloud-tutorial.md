...
2. **[Configure zscaler ZSCloud Single Sign-On](#configure-zscaler-zscloud-single-sign-on)** - para configurar as definições de Sign-On único no lado da aplicação.
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    > [!NOTE]
    > Tem de atualizar o valor com o URL de inscrição real. Contacte [a equipa de suporte do Zscaler ZSCloud para](https://help.zscaler.com/) obter o valor. Também pode consultar os padrões indicados na secção **de Configuração BÁSICA SAML** no portal Azure.
...
Quando clicar no azulejo Zscaler ZSCloud no Painel de Acesso, deverá ser automaticamente inscrito no Zscaler ZSCloud para o qual configura o SSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
