---
title: 'Tutorial: Integração do Azure Ative Directory com a OutSystems Azure AD / Microsoft Docs'
...
Neste tutorial, você configura e testa Azure AD SSO em um ambiente de teste. A OutSystems Azure AD suporta o SSO iniciado **pelo SP e o IDP** e suporta o fornecimento do utilizador Just In **Time.**

## <a name="adding-outsystems-azure-ad-from-the-gallery"></a>Adicionar OutSystems Azure AD da galeria
...
Para configurar e testar o Azure AD SSO com a OutSystems Azure AD, complete os seguintes blocos de construção:

1. **[Configure Azure AD SSO](#configure-azure-ad-sso)** para permitir que os seus utilizadores utilizem esta funcionalidade.
2. **[Configure OutSystems Azure AD](#configure-outsystems-azure-ad)** para configurar as definições SSO no lado da aplicação.
...
5. Crie o utilizador de **[teste Azure AD da OutSystems](#create-outsystems-azure-ad-test-user)** para ter uma contraparte de B. Simon in OutSystems Azure AD que está ligada à representação AD Ad do utilizador.
...
1. No [portal Azure](https://portal.azure.com/), na página de integração de aplicações **Azure Azure OutSystems,** encontre a secção **Gerir** e selecione **'Único sinal de s-on'.**
...
Nesta secção, você permitirá a B. Simon usar o único sinal de Azure, concedendo acesso ao OutSystems Azure AD.
...
Quando selecionar o azulejo AZure AD outSystems no Painel de Acesso, deverá ser automaticamente inscrito no OutSystems Azure AD para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
