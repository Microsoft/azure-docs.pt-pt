...
* Recomenda-se que um único utilizador da AD Azure seja atribuído ao RFPIO para testar a configuração automática de fornecimento do utilizador. Usuários e/ou grupos adicionais podem ser atribuídos posteriormente.
...
3.  Navegue para **a GESTÃO DE UTILIZADORES** > **SEGURANÇA** > **SCIM**.
...
> [!TIP]
> Também pode optar por ativar um único sinal baseado em SAML para O RFPIO, seguindo as instruções fornecidas no [tutorial de inscrição individual RFPIO](rfpio-tutorial.md). O logon único pode ser configurado independentemente do provisionamento automático de usuário, embora esses dois recursos se complementem.
