---
title: 'Tutorial: Integração do Azure Ative Directory com a UltiPro Microsoft Docs'
...
A integração da UltiPro com a Azure AD proporciona-lhe os seguintes benefícios:

* Você pode controlar em Azure AD que tem acesso à UltiPro.
* Pode permitir que os seus utilizadores sejam automaticamente inscritos na UltiPro (Sign-On Único) com as suas contas AD Azure.
...
Para configurar a integração AD da Azure com a UltiPro, precisa dos seguintes itens:

* Uma assinatura AD Azure. Se não tiver um ambiente AD Azure, pode ter um mês de julgamento [aqui.](https://azure.microsoft.com/pricing/free-trial/)
* UltiPro assinatura ativada única

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configura e testa Azure AD um único sinal de acesso em um ambiente de teste.

* UltiPro suporta SSO iniciado **pela SP**
...
4. Na caixa de pesquisa, **digite UltiPro,** selecione **UltiPro** do painel de resultados e clique em Adicionar o botão **Adicionar** a aplicação.

     ![UltiPro na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar Azure AD único sinal de inscrição

Nesta secção, configura e testa o Azure AD com ultiPro com base num utilizador de teste chamado **Britta Simon**.
Para um único sinal de sação a funcionar, é necessário estabelecer uma relação de ligação entre um utilizador Azure AD e o utilizador relacionado na UltiPro.

Para configurar e testar o Azure AD com ultiPro, você precisa completar os seguintes blocos de construção:

1. **[Configure Azure AD Single Sign-On](#configure-azure-ad-single-sign-on)** - para permitir que os seus utilizadores utilizem esta funcionalidade.
2. **[Configure ultiPro sign-on único](#configure-ultipro-single-sign-on)** - para configurar as definições de Sign-On única no lado da aplicação.
3. Crie um utilizador de **[teste AD Azure](#create-an-azure-ad-test-user)** - para testar um único sinal de Azure com Britta Simon.
4. **[Atribua o utilizador de teste Azure AD](#assign-the-azure-ad-test-user)** - para permitir que Britta Simon utilize um único sinal de Azure.
5. **[Create UltiPro test user](#create-ultipro-test-user)** - para ter uma contraparte de Britta Simon na UltiPro que está ligada à representação AD AD Azure do utilizador.
...
Para configurar o Azure AD com a UltiPro, execute os seguintes passos:

1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **UltiPro,** selecione **'Único's sign-on**' .
...
4. Na secção **de Configuração Básica SAML,** execute os seguintes passos:
    ...
    ![UltiPro Domain e URLs informações únicas de súmis](common/sp-identifier-reply.png)
...
Nesta secção, você permite que Britta Simon use Azure single sign-on, concedendo acesso à UltiPro.
...
Quando clicar no azulejo UltiPro no Painel de Acesso, deverá ser automaticamente inscrito no UltiPro para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
