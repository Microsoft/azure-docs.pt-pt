...
* Pode utilizar as minhas apps do Microsoft. Quando clicar no azulejo teamViewer nas Minhas Apps, este será redirecionado para o URL de assinatura do TeamViewer. Para obter mais informações sobre as Minhas Apps, consulte [Introdução às Minhas Aplicações.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
