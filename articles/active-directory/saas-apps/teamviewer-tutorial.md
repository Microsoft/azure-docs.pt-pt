---
title: 'Tutorial: Azure Ative Directy integração única (SSO) com TeamViewer Microsoft Docs'
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-teamviewer"></a>Configurar e testar Azure AD único sinal para TeamViewer
...
1. **[Configure TeamViewer SSO](#configure-teamviewer-sso)** - para configurar as definições de inscrição única no lado da aplicação.
    * **[Create TeamViewer test user](#create-teamviewer-test-user)** - para ter uma contraparte de B.Simon em TeamViewer que está ligada à representação AD AD do utilizador.
...
1. No [portal Azure](https://portal.azure.com/), na página de integração da aplicação **TeamViewer,** encontre a secção **Gerir** e selecione **um único sinal de sação**.
...
Quando clicar no azulejo teamViewer no Painel de Acesso, deverá ser automaticamente inscrito no TeamViewer para o qual configura sSO. Para obter mais informações sobre o Painel de Acesso, consulte [Introdução ao Painel de Acesso.](../user-help/my-apps-portal-end-user-access.md)
...
- [Experimente o TeamViewer com Azure AD](https://aad.portal.azure.com/)