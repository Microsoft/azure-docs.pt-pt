...
| **Percentual de administradores globais** | Esta definição especifica a percentagem mínima de administradores que são administradores globais, de 0% a 100%, abaixo do qual não quer que a sua organização Azure AD baixe. |
