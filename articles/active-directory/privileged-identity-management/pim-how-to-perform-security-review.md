---
title: Rever acesso para funções do Azure AD no PIM - Azure Active Directory | Documentos da Microsoft
description: Saiba como rever o acesso de funções do Azure AD no Azure AD Privileged Identity Management (PIM).
...
ms.locfileid: "65140973"
---
# <a name="review-access-to-azure-ad-roles-in-pim"></a>Rever acesso para funções do Azure AD no PIM
