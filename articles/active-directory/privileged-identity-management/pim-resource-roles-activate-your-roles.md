...
Quando precisar tomar uma função de recurso do Azure, você poderá solicitar a ativação usando a opção de navegação **minhas funções** no PIM.
...
1. Clique em **Ativar** para abrir o painel ativar.
...
1. Se você quiser especificar um escopo reduzido, clique em **escopo** para abrir o painel Filtro de recursos.
...
1. Termine sessão no portal do Azure e, em seguida, inicie sessão novamente.
    ...
    Quando você ativar uma função de recurso do Azure, verá os estágios da ativação. Quando todas as fases estiverem concluídas, verá a ligação **Terminar sessão**. Pode utilizar esta ligação para terminar sessão. Deste modo, vai resolver a maioria dos atrasos da ativação.
...
- [Ativar as minhas funções do Microsoft Azure AD no PIM](pim-how-to-activate-role.md)
