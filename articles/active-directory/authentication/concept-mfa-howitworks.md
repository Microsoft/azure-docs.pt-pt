...
---
# <a name="how-it-works-azure-multi-factor-authentication"></a>Como funciona: Autenticação Multi-Factor Azure
...
![métodos de autenticação conceptual imagem](./media/concept-mfa-howitworks/methods.png)</center>
...
## <a name="how-to-get-multi-factor-authentication"></a>Como obter a autenticação multi-factor?

A autenticação multi-factor surge como parte das seguintes ofertas:
...
* **Administradores Globais de Diretório Ativo Azure** - Um subconjunto de capacidades de autenticação multi-factor Azure está disponível como forma de proteger as contas de administrador global.
