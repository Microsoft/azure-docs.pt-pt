...
| --- | --- |
| Palavra-passe | MFA and SSPR |
| Security questions | SSPR Only |
| Endereço de e-mail | SSPR Only |
| Aplicação Microsoft Authenticator | MFA and SSPR |
| OATH Hardware token | Public preview for MFA and SSPR |
| SMS | MFA and SSPR |
| Chamada de voz | MFA and SSPR |
| Palavras-passe de aplicações | MFA only in certain cases |
