...
| Number of methods required to reset | One | Dois |
| :---: | :---: | :---: |
| Mobile app features available | Código | Code or Notification |
...
| Number of methods registered | Number of methods required | Resultado |
| :---: | :---: | :---: |
