---
title: Iniciar o Azure MFA Server - Diretório Ativo Azure
...
4. Selecione **Transferir** e siga as instruções na página de transferência para guardar o instalador. 
   ...
   ![Baixe o MFA Server do portal Azure](./media/howto-mfaserver-deploy/downloadportal.png)
...
> [!NOTE]
> Apenas administradores globais são capazes de gerar credenciais de ativação no portal Azure.
...
![Modelos de e-mail do Servidor MFA na consola](./media/howto-mfaserver-deploy/email2.png)
...
4. Realce todos os utilizadores à direita e clique em **Importar**. Deverá receber um pop-up a indicar que a importação foi bem-sucedida. Feche a janela de importação.
   ...
   ![Importação de utilizador do Servidor MFA do Diretório Ativo](./media/howto-mfaserver-deploy/import2.png)
