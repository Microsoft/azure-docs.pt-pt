...
1. Inicie sessão no servidor Azure AD Connect e inicie o **Start**Gestor de **Serviçode Sincronização** selecionando o Serviço de  >  **Sincronização**inicial .
...
* **ID do utilizador**: Quem foi o utilizador que viu o erro? Um exemplo é * \@ o utilizador contoso.com*.
