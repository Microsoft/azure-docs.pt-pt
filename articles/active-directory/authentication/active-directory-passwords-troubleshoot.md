...
| SsprNotEnabledInUserPolicy = 11 | Desculpe, você não pode redefinir sua senha neste momento porque o administrador não configurou a redefinição de senha para sua organização. Não há nenhuma ação adicional que você possa executar para resolver essa situação. Entre em contato com seu administrador e peça para configurar a redefinição de senha. Para saber mais sobre a configuração de redefinição [de senha, consulte início rápido: Redefinição](https://docs.microsoft.com/azure/active-directory/active-directory-passwords-getting-started)de senha de autoatendimento do Azure AD. | SSPR_0011: Sua organização não definiu uma política de redefinição de senha. Entre em contato com seu administrador e peça para definir uma política de redefinição de senha. |
...
Para obter mais granularidade, faça referência à lista atualizada de [Microsoft Azure intervalos de IP](https://www.microsoft.com/download/details.aspx?id=41653) do datacenter atualizados todas as quartas-feiras e coloque em vigor na próxima segunda-feira.
...
* **ID de usuário**: Quem era o usuário que viu o erro? Um exemplo é *o\@usuário contoso.com*.
