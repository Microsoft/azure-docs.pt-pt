...
| **Customization** | Customize helpdesk link | Sim |
|   | Custom helpdesk email or URL | Support site or email address |
| **Integração no local** | Write back passwords to on-premises AD | Sim |
