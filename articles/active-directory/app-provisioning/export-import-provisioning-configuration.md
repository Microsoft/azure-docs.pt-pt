---
title: Configuração de fornecimento de exportação e reversão para um bom estado conhecido para recuperação de desastres
...
ms.locfileid: "82593765"
---
# <a name="how-to-export-provisioning-configuration-and-roll-back-to-a-known-good-state"></a>Como: Configuração de fornecimento de exportação e reversão para um bom estado conhecido

Neste artigo, aprenderá a:

- Exportar e importar a sua configuração de provisionamento do portal Azure
- Exportar e importar a sua configuração de provisionamento utilizando a Microsoft Graph API
...
1. No painel de navegação à esquerda, selecione **o fornecimento**. A partir da página de configuração de provisionamento, clique em **mapeamentos de atributos,** em **seguida, mostrar opções avançadas**, e finalmente **rever o seu esquema**. Isto vai levá-lo ao editor de esquemas.
1. Clique em download na barra de comando na parte superior da página para descarregar o seu esquema.
...
Selecione **Run Query** para importar o novo esquema.
