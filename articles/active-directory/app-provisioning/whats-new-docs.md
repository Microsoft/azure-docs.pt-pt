...
- [Personalizar o fornecimento de produtos de fornecimento de mapeamentos de atributos para aplicações SaaS no Azure Ative Directory](customize-application-attributes.md)
- [Construa um ponto final SCIM e configuure o fornecimento de utilizadores com Azure AD](use-scim-to-provision-users-and-groups.md)
- [Referência de atributo da Workday](workday-attribute-reference.md)
