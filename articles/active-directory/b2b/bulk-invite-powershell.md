---
title: Tutorial para utilizadores de colaboração B2B convidativos a granel - Diretório Ativo Azure [ Azure Ative Diretório ] Microsoft Docs
description: Neste tutorial, você aprende a usar powerShell e um ficheiro CSV para enviar convites a granel para utilizadores convidados de colaboração Azure AD B2B externos.
