...
Descarregue e preencha o modelo CSV de carregamento a granel para ajudá-lo a convidar com sucesso os utilizadores convidados da Azure AD a granel. O modelo CSV que descarrega pode parecer este exemplo:

![Folha de cálculo para upload e chamadas explicando o propósito e valores para cada linha e coluna](media/tutorial-bulk-invite/understand-template.png)
...
- **Títulos da coluna**: O formato das rubricas da coluna é &lt;o nome&gt; &lt; *item* [PropertyName] *exigido ou em branco*&gt;. Por exemplo, `Email address to invite [inviteeEmail] Required`. Algumas versões mais antigas do modelo podem ter ligeiras variações.
...
4. Na página de convidar os utilizadores a **granel,** selecione **Download** para obter um modelo de .csv válido com propriedades de convite.
