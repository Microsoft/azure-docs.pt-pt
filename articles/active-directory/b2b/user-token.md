---
title: Compreender os tokens do utilizador na colaboração B2B - Azure AD
description: Referência simbólica do utilizador para colaboração Azure Ative Directory B2B
...
## <a name="microsoft-account-guest-token"></a>Ficha de hóspede da conta da Microsoft
```
