...
description: Neste tutorial, saiba como exigir a MFA (autenticação multifator) ao usar o Azure AD B2B para colaborar com usuários externos e organizações parceiras.
...
> * Crie uma política de acesso condicional que exija MFA para acesso a um aplicativo de nuvem em seu ambiente. Neste tutorial, utilizaremos a aplicação Microsoft Azure Management para ilustrar o processo.
...
4.  Selecione **Novo utilizador convidado**.
    ...
    ![Captura de tela mostrando onde selecionar a nova opção de usuário convidado](media/tutorial-mfa/tutorial-mfa-user-3.png)
...
5.  Em **Nome de utilizador**, introduza o endereço de e-mail do utilizador externo. Também tem a opção de incluir uma mensagem de boas-vindas. 
    ...
    ![Captura de tela mostrando onde inserir a mensagem de convite de convidado](media/tutorial-mfa/tutorial-mfa-user-4.png)
...
3.  Na página **Azure Active Directory** , na seção **segurança** , selecione **acesso condicional**.
...
12. Na página **Selecionar**, selecione **Microsoft Azure Management** e, em seguida, selecione **Selecionar**.
    ...
    ![Captura de tela mostrando o aplicativo de gerenciamento de Microsoft Azure selecionado](media/tutorial-mfa/tutorial-mfa-policy-11.png)
...
15. Na página **Conceder**, selecione **Conceder acesso**, selecione a caixa de verificação **Exigir autenticação multifator** e, em seguida, selecione **Selecionar**.
    ...
    ![Captura de tela mostrando a opção exigir autenticação multifator](media/tutorial-mfa/tutorial-mfa-policy-13.png)

16. Em **Ativar política**, selecione **Ativado**.

    ![Captura de tela mostrando a opção Habilitar política definida como ativado](media/tutorial-mfa/tutorial-mfa-policy-14.png)
...
4.  Na página **Aplicações na cloud**, selecione **Selecionar aplicações** e, em seguida, selecione **Selecionar**. Na lista de aplicações, selecione **Microsoft Azure Management** e, em seguida, selecione **Selecionar**. 
    ...
    ![Captura de tela mostrando o aplicativo de gerenciamento de Microsoft Azure selecionado](media/tutorial-mfa/tutorial-mfa-whatif-3.png)
...
Neste tutorial, você criou uma política de acesso condicional que exige que os usuários convidados usem a MFA ao entrar em um dos seus aplicativos de nuvem. Para saber mais sobre como adicionar utilizadores para colaboração, veja [Adicionar utilizadores de colaboração B2B do Azure Active Directory no portal do Azure](add-users-administrator.md).
