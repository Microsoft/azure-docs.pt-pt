---
title: Tutorial - Autenticação multifactor para B2B - Azure AD
description: Neste tutorial, aprenda a exigir autenticação multifactor (MFA) quando utilizar o Azure AD B2B para colaborar com utilizadores externos e organizações parceiras.
...
4.  Selecione **Novo utilizador convidado**.
    ...
    ![Screenshot mostrando onde selecionar a nova opção de utilizador de hóspedes](media/tutorial-mfa/tutorial-mfa-user-3.png)
...
5.  Em **Nome de utilizador**, introduza o endereço de e-mail do utilizador externo. Também tem a opção de incluir uma mensagem de boas-vindas. 
    ...
    ![Screenshot mostrando onde inserir a mensagem de convite do hóspede](media/tutorial-mfa/tutorial-mfa-user-4.png)
...
## <a name="create-a-conditional-access-policy-that-requires-mfa"></a>Criar uma política de acesso condicional que exija MFA
...
3.  Na página do **Diretório Ativo Azure,** na secção **Segurança,** selecione **Acesso Condicional**.
...
11. Na página **Aplicações na cloud**, selecione **Selecionar aplicações** e, em seguida, selecione **Selecionar**.
    ...
    ![Screenshot mostrando a página de aplicações Cloud e a opção Select](media/tutorial-mfa/tutorial-mfa-policy-10.png)

12. Na página **Selecionar**, selecione **Microsoft Azure Management** e, em seguida, selecione **Selecionar**.

    ![Screenshot mostrando a aplicação Microsoft Azure Management selecionada](media/tutorial-mfa/tutorial-mfa-policy-11.png)
...
16. Em **Ativar política**, selecione **Ativado**.
    ...
    ![Screenshot mostrando a opção de política Ativação definida para On](media/tutorial-mfa/tutorial-mfa-policy-14.png)
...
1.  Na página **Acesso Condicional - Políticas,** selecione **What If**. 
    ...
    ![Screenshot mostrando onde selecionar o E se a opção](media/tutorial-mfa/tutorial-mfa-whatif-1.png)
...
4.  Na página **Aplicações na cloud**, selecione **Selecionar aplicações** e, em seguida, selecione **Selecionar**. Na lista de aplicações, selecione **Microsoft Azure Management** e, em seguida, selecione **Selecionar**. 
    ...
    ![Screenshot mostrando a aplicação Microsoft Azure Management selecionada](media/tutorial-mfa/tutorial-mfa-whatif-3.png)
...
6.  Selecione **What If** e verifique se a sua nova política é apresentada em **Resultados da avaliação** no separador **Políticas que serão aplicadas**.
    ...
    ![Screenshot mostrando onde selecionar o E se a opção](media/tutorial-mfa/tutorial-mfa-whatif-4.png)
...
2.  Deverá ver um pedido de métodos de autenticação adicionais. Tenha em atenção que poderá demorar algum tempo até que a política entre em vigor.
    ...
    ![Screenshot mostrando a mensagem mais necessária](media/tutorial-mfa/mfa-required.png)
 
3.  Termine a sessão.

## <a name="clean-up-resources"></a>Limpar recursos
Quando já não for necessário, retire o utilizador do teste e a política de acesso condicional do teste.
1.  Inicie sessão no [portal do Azure](https://portal.azure.com/) como administrador do Azure Active Directory.
2.  No painel esquerdo, selecione **Azure Active Directory**.
3.  Em **Gerir**, selecione **Utilizadores**.
