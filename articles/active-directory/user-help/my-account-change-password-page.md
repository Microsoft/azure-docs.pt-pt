...
1. Inscreva-se na sua conta de trabalho ou escolar, utilizando ahttps://myprofile.microsoft.com/) sua senha existente, e depois vá para a Minha **Conta** (página).
