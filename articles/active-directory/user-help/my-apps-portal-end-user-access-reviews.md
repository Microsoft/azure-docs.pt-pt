...
Pode utilizar o seu trabalho ou conta escolar com o portal **My Apps** baseado na Web para realizar avaliações de acesso para as suas apps e grupos. As avaliações de acesso ajudam-no a gerir o acesso desatualizado ou a alterar os requisitos de acesso e a garantir que são revistos e atualizados.
...
>[!Note]
>Se não vir o azulejo do **Access reviews,** significa que não tem permissão para realizar avaliações de acesso, ou que não tem quaisquer avaliações pendentes à espera da sua aprovação. Se achar que deve ter acesso ao azulejo, contacte o seu Helpdesk para obter assistência.
