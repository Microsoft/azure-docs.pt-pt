...
## <a name="using-myappsmicrosoftcom"></a>Usando myapps.microsoft.com
...
## <a name="using-myapplicationsmicrosoftcom"></a>Usando myapplications.microsoft.com
...
>[!Note]
>Se não vir o azulejo do **Access reviews,** pode significar que não tem permissão para realizar avaliações de acesso, ou que não tem quaisquer avaliações pendentes à espera da sua aprovação. Se acha que deve ter acesso ao azulejo, contacte o seu balcão de ajuda para obter assistência.

## <a name="to-perform-access-reviews"></a>Para realizar avaliações de acesso
