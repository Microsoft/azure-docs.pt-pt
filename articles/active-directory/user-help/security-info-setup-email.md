---
title: Configurar informações de segurança (versão prévia) para usar email-Azure AD
description: Como configurar suas informações de segurança para verificar sua identidade usando seu endereço de email.
