---
title: Ver informações relacionadas com a privacidade do portal do meu perfil (pré-visualização) - Azure Active Directory | Documentos da Microsoft
description: Uma visão geral sobre a página de privacidade do portal do meu perfil.
...
3. Reveja as informações, incluindo:
    ...
    - **Serviços.** Uma lista de serviços online que estiver ligado ao utilizar a sua conta escolar ou profissional.

    - **Termos de utilização**. Termos da sua organização de utilização.
