...
Seus administradores podem exigir que você confirme seus métodos de autenticação após um período de tempo para garantir que você ainda tenha os métodos apropriados registrados.
