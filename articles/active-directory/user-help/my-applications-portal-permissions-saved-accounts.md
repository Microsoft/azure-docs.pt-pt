---
title: Gerir permissões de candidatura do portal My Apps - Azure Ative Directory [ Diretório Ativo Azure ] Microsoft Docs
description: Saiba como gerir as permissões de aplicação para aplicações baseadas na nuvem da sua organização a partir do portal My Apps.
