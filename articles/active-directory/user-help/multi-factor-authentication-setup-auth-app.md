...
1. Na página **verificação de segurança adicional** , selecione **aplicativo móvel** na **etapa 1: como devemos entrar em contato com a sua** área.
...
8. Na área **etapa 4: continuar usando seus aplicativos existentes** , copie a senha de aplicativo fornecida e cole-a em um local seguro.
...
6. No aplicativo Microsoft Authenticator, role para baixo até sua conta corporativa ou de estudante, copie e cole o código de 6 dígitos do aplicativo na **etapa 2: Insira o código de verificação na caixa aplicativo móvel** no computador e, em seguida, selecione **verificar**.
