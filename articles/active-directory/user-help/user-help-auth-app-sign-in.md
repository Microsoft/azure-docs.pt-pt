...
Para as etapas necessárias para iniciar sessão no seu trabalho ou na sua escola ou na sua conta pessoal, utilizando os vários métodos de verificação de dois fatores, consulte [O Signin usando informações de verificação ou segurança em duas etapas](user-help-sign-in.md).
