...
ms.locfileid: "60295114"
---
# <a name="enabling-azure-active-directory-identity-protection"></a>Ativar o Azure Active Directory Identity Protection

O Azure Active Directory Identity Protection é um recurso do Azure Active Directory (Azure AD). Com o Azure AD Identity Protection, são capazes de:

- Obter uma vista consolidada de utilizadores sinalizados e eventos de risco detetados com algoritmos de machine learning
- Definir políticas de acesso condicional com base no risco para proteger automaticamente os seus utilizadores
