...
As deteções em tempo real podem não aparecer nos relatórios durante 5 a 10 minutos. As deteções offline podem não aparecer nos relatórios durante duas a quatro horas.
