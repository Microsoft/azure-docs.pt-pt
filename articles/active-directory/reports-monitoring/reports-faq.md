...
**P: quanto tempo devo ver os dados de atividades depois de obter uma licença Premium?**
...
* **Falha**: isso significa que houve uma política de autoridade de certificação com o usuário e o aplicativo no escopo e as políticas de autoridade de certificação não foram satisfeitas. 
...
* **Não aplicado**: isso pode ser porque as condições da política não foram atendidas.
