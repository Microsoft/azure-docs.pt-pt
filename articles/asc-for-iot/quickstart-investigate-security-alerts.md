...
description: Compreenda, investigue e investigue o Centro de Segurança Azure para alertas de segurança IoT nos seus dispositivos IoT.
...
ms.locfileid: "88068573"
---
# <a name="quickstart-investigate-security-alerts"></a>Quickstart: Investigar alertas de segurança

A investigação programada e a reparação dos alertas emitidos pelo Azure Security Center for IoT é a melhor forma de garantir o cumprimento e proteção em toda a sua solução IoT.
...
Avance para o próximo artigo para saber mais sobre os tipos de alerta do Azure Security Center e possíveis personalizações...
