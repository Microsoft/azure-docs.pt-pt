...
Quando a agregação do evento é deixada **on**, Azure Security Center for IoT agentes agrega eventos para o intervalo período ou janela de tempo.
...
Faça alterações na configuração do Azure Security Center para agregação de eventos IoT dentro do objeto de [configuração](how-to-agent-configuration.md) do agente do módulo twin identidade do módulo **de azureiotsecurity.**
...
- Rever O Centro de Segurança Azure para [pré-requisitos](service-prerequisites.md) de serviço IoT
