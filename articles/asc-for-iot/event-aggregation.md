---
title: Compreender o Centro de Segurança Azure para a agregação de eventos IoT. Microsoft Docs
...
ms.locfileid: "73928963"
---
# <a name="azure-security-center-for-iot-event-aggregation"></a>Centro de Segurança Azure para agregação de eventos IoT

O Azure Security Center para agentes de segurança IoT recolhe dados e eventos do sistema do seu dispositivo local e envia estes dados para a nuvem Azure para processamento e análise. O agente de segurança recolhe muitos tipos de eventos de dispositivos, incluindo novos processos e novos eventos de conexão. Tanto o novo processo como os novos eventos de conexão podem ocorrer com frequência num dispositivo dentro de um segundo, e embora importante para uma segurança robusta e abrangente, o número de mensagens que os agentes de segurança são forçados a enviar pode chegar rapidamente ou exceder o seu Hub IoT limites de quotas e custos. No entanto, estes eventos contêm informações de segurança altamente valiosas que são cruciais para proteger o seu dispositivo.
