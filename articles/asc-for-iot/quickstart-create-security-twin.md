---
title: 'Quickstart: Criar um módulo de segurança twin para o Azure Security Center para IoT'
...
2. Editar manualmente cada módulo gémeo individualmente com configurações específicas para cada dispositivo.
