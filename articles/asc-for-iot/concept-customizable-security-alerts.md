...
description: Saiba mais sobre alertas de segurança personalizáveis e remediação recomendada utilizando o Azure Security Center para funcionalidades e serviços IoT.
...
A seguinte lista de alertas do Azure Security Center for IoT é definível por si com base no seu comportamento ioT hub e/ou dispositivo esperado. Para obter mais detalhes sobre como personalizar cada alerta, consulte [criar alertas personalizados.](quickstart-create-custom-alerts.md)
