...
Embora opcional e não necessário, ativar e configurar o Log Analytics pode ser útil quando deseja investigar mais eventos e atividades do dispositivo. Leia sobre como configurar e usar [o Log Analytics com o Azure Security Center para o serviço IoT](how-to-security-data-access.md#log-analytics) para saber mais. 
