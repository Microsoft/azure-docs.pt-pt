---
title: Implementar um ASC para o módulo do IoT Edge | Documentos da Microsoft
description: Saiba mais sobre como implementar o ASC para o agente de segurança de IoT no IoT Edge.
services: ascforiot
...
ASC para IoT **azureiotsecurity** módulo fornece uma solução de segurança abrangente para o seu dispositivo IoT Edge.
