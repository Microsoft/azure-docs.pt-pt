...
1. Instale o Centro de Segurança Azure para o agente IoT Windows C# no dispositivo. Descarregue a versão mais recente para a sua máquina a partir do Azure Security Center para [o repositório](https://github.com/Azure/Azure-IoT-Security-Agent-CS)IoT GitHub .
