...
| logFilePath | Caminho para o ficheiro | Se fileLogLevel > desativado, os logs serão gravados nesse arquivo. |
...
| idScope | cadeia | Escopo da ID do DPS |
| registrationId | cadeia  | ID de registro do dispositivo DPS. |
|
