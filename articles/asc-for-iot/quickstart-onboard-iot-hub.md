...
2. Escolha o ecrã **Definições** e modifique as definições de gelocalização e/ou manuseamento IP como desejar.
...
1. Abra o seu IoT Hub e, em seguida, selecione **a visão geral** do menu De **segurança.** 
2. Escolha o ecrã **Definições** e modifique a configuração do espaço de trabalho das definições de Log Analytics como desejar.
...
1. Abra o seu IoT Hub e, em seguida, selecione **a visão geral** do menu De **segurança.** 
2. Escolha o ecrã **Definições** e modifique as definições de segurança de qualquer hub IoT na sua subscrição Azure como desejar.
