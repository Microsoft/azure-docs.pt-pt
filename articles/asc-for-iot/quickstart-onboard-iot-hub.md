---
title: 'Início rápido: habilitar a central de segurança do Azure para o serviço de IoT no Hub IoT'
description: Saiba como carregar e habilitar a central de segurança do Azure para o serviço de segurança de IoT no Hub IoT do Azure.
