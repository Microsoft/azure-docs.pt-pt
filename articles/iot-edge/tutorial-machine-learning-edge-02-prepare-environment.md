...
1. Corre Create-AzureDevVM.ps1.
   ...
   O script é executado por vários minutos enquanto executa os seguintes passos:
    ...
    1. Instala o [módulo Azure PowerShell Az](/powershell/azure/new-azureps-module-az).
