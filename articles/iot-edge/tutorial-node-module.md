...
| - | ------------------ | ------------------ |
| **AMD64 do Linux** | ![Utilize o Código VS para módulos Node.js no Linux AMD64](./media/tutorial-c-module/green-check.png) |  |
| **ARM32 do Linux** | ![Utilize o Código VS para módulos Node.js no Linux ARM32](./media/tutorial-c-module/green-check.png) |  |
