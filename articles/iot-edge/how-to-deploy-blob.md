...
2. No **separador Definições** do Módulo, forneça um nome para o módulo e, em seguida, especifique a imagem do recipiente URI:
   ...
   ![A screenshot mostra o separador Definições do Módulo da página 'Adicionar I o T Edge Module'.](./media/how-to-deploy-blob/addmodule-tab1.png)
...
3. Abra o **separador Opções de Criação de Recipientes.**
   ...
   ![A screenshot mostra o separador Opções de Criação de Recipientes da página Do Módulo Add I o T Edge.](./media/how-to-deploy-blob/addmodule-tab3.png)
...
5. No **separador Definições Gémeas** do Módulo, copie o JSON seguinte e cole-o na caixa.
   ...
   ![A screenshot mostra o separador Configurações Twin módulo da página 'Adicionar eu o T Edge Module'.](./media/how-to-deploy-blob/addmodule-tab4.png)
...
1. Adicione `HTTPS_PROXY` para o **Nome** e o seu URL de procuração para o **Valor**.
      ...
      ![A screenshot mostra o painel do módulo de borda I o T Edge onde pode introduzir os valores especificados.](./media/how-to-deploy-blob/https-proxy-config.png)
...
1. Verifique a definição selecionando o módulo na página de detalhes do dispositivo e na parte inferior da página **IoT Edge Modules Details** selecione o separador **Variáveis ambiente.**
      ...
      ![A screenshot mostra o separador Variáveis ambientais.](./media/how-to-deploy-blob/verify-proxy-config.png)
