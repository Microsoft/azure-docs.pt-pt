...
1. É-lhe pedido que selecione a tarefa de construção a executar. Selecione **Compilar**.
...
1. Clique no **...** à direita do **Azure IoT Hub** para mais ações. Selecione **copiar cadeia de conexão do Hub IOT**.
