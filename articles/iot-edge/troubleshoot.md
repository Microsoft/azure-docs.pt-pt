...
Para o Hub de IoT Edge, defina uma variável de ambiente **OptimizeForPerformance** como **false**. Existem duas formas de definir variáveis ambientais:
