---
title: Exemplos de um certificado de sinalizador de política Azure Attestation
description: Um exemplo do conteúdo do certificado de sinalizador de política Azure Attestation.
...
## <a name="policy-signer-certificate-content"></a>Conteúdo do certificado do signatário da política
...
## <a name="policy-signer-certificates-file-content"></a>Conteúdo de ficheiro de certificados de signatários de política
