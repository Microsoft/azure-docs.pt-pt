...
A condição é composta por condições individuais em várias propriedades de uma reclamação. Uma condição pode ter um identificador opcional, que pode ser usado para remeter a reclamação/s que satisfaz a circunstância. Esta referência pode ser utilizada nas outras condições ou na ação da mesma regra.
