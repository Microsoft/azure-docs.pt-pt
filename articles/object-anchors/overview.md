...
- **Preparação**: Crie experiências de formação de realidade mista para os seus trabalhadores, sem necessidade de colocar marcadores ou passar tempo a ajustar manualmente o alinhamento do holograma. Se quiser aumentar as suas experiências de treino de realidade mista com deteção e rastreio automatizados, ingere o seu modelo no serviço Object Anchors e estará um passo mais perto de uma experiência sem marcadores.

- **Orientação de Tarefas**. Caminhar os colaboradores através de um conjunto de tarefas pode ser muito simplificado ao usar a Realidade Mista. Sobrepor instruções digitais e boas práticas, em cima do objeto físico – seja uma peça de maquinaria no chão de uma fábrica, ou uma cafeteira na cozinha da equipa – pode reduzir consideravelmente a dificuldade de completar o conjunto de tarefas. Desencadear estas experiências normalmente requer alguma forma de alinhamento marcador ou manual, mas com âncoras de objetos, pode criar uma experiência que detete automaticamente o objeto relacionado com a tarefa em questão. Em seguida, fluir perfeitamente através da orientação da Realidade Mista sem marcadores ou alinhamento manual.

- **Procura de ativos**. Se já tiver um modelo 3D de algum objeto no seu espaço físico, as Âncoras de Objetos podem permitir-lhe localizar e rastrear instâncias desse objeto no seu ambiente físico.
