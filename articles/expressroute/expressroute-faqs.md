...
Sim. Pode ligar até 10 redes virtuais na mesma subscrição que o circuito ou diferentes subscrições utilizando um único circuito ExpressRoute. Este limite pode ser aumentado permitindo a funcionalidade de prémio ExpressRoute.
...
Sim. Os pontos finais de serviço do Office 365 são alcançáveis através da Internet, embora o ExpressRoute tenha sido configurado para a sua rede. Por favor, consulte a equipa de networking da sua organização se a rede na sua localização está configurada para ligar aos serviços do Office 365 através do ExpressRoute.
