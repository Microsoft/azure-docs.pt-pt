---
title: Azure Cloud Services (suporte alargado) Def. LoadBalancerProbe Schema | Microsoft Docs
description: Informações relacionadas com o esquema da sonda do balançador de carga para serviços em nuvem (suporte alargado)
ms.topic: article
