...
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Crie um novo serviço em nuvem com função única e certificado a partir do cofre chave
...
$cloudService = New-AzCloudService                                              `
                  ...
                  -OSProfile $osProfile
```
## <a name="create-new-cloud-service-with-multiple-roles-and-extensions"></a>Criar um novo serviço em nuvem com múltiplas funções e extensões
