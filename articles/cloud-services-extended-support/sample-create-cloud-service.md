---
title: Exemplos do Azure PowerShell – Criar um Serviço Cloud do Azure (suporte alargado)
description: Scripts de amostra para criar implementações do Azure Cloud Service (suporte alargado)
ms.topic: sample
...
ms.locfileid: "98745128"
---
# <a name="create-a-new-azure-cloud-service-extended-support"></a>Criar um novo Serviço de Nuvem Azure (Suporte alargado)
Estas amostras cobrem várias formas de criar uma nova implantação do Azure Cloud Service (suporte alargado).

## <a name="create-new-cloud-service-with-single-role"></a>Criar novo Serviço cloud com um papel único
...
## <a name="create-new-cloud-service-with-single-role-and-remote-desktop-extension"></a>Criar novo Serviço cloud com função única e extensão remota de ambiente de trabalho
...
## <a name="create-a-cloud-service-with-a-single-role-and-windows-azure-diagnostics-extension"></a>Criar um Serviço cloud com um único papel e extensão de Diagnóstico Windows Azure
...
-ExtensionProfileExtension $extension
```
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Criar novo Serviço cloud com papel único e certificado a partir de Key Vault
...
## <a name="create-new-cloud-service-with-multiple-roles-and-extensions"></a>Criar novo Serviço cloud com múltiplas funções e extensões
