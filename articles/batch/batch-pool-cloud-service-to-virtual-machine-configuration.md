...
Se utilizar piscinas de "cloudServiceConfiguration", é altamente recomendável que se mova para utilizar piscinas de "configuração virtual de investigação". Este artigo descreve como migrar para a configuração recomendada de "virtualMachineConfiguration".
