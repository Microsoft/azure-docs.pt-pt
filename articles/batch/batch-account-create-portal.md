...
Para obter informações sobre as contas e cenários do Lote, consulte o fluxo de trabalho e os recursos do [serviço de lote.](batch-service-workflow-features.md)
