...
|`nodeAgentId`|Cadeia|O SKU do agente de nó de lote previsto no nó de computação.|
...
|Nome do elemento|Tipo|Notas|
|------------------|--------------|----------|
|`subnetId`|Cadeia|Especifica o identificador de recursos da sub-rede em que são criados os nós computacional da piscina.|
