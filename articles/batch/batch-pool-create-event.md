...
|`nodeAgentId`|Cadeia|O sKU do agente do nó batch provisionado no nó computacional.|
...
|Nome do elemento|Tipo|Notas|
|------------------|--------------|----------|
|`subnetId`|Cadeia|Especifica o identificador de recursos da subnet na qual são criados os nódosos de cálculo da piscina.|
