...
Tal como acontece com outros serviços Azure, existem limites em certos recursos associados ao serviço Batch. Muitos destes limites são quotas de incumprimento aplicadas pela Azure ao nível da subscrição ou da conta. Este artigo discute esses incumprimentos e como pode solicitar aumentos de quota.
...
Se criou uma conta Batch com modo de atribuição de piscina definido para **a subscrição do utilizador,** as quotas são aplicadas de forma diferente. Neste modo, os VMs do Lote e outros recursos são criados diretamente na sua subscrição quando um pool é criado. As quotas de núcleos Azure Batch não se aplicam a uma conta criada neste modo. Em vez disso, são aplicadas as quotas na sua subscrição para núcleos de computação regional e outros recursos. Saiba mais sobre estas quotas em [limites de subscrição e serviços, quotas e restrições de subscrição da Azure.](../azure-resource-manager/management/azure-subscription-service-limits.md)
...
Veja as quotas da sua conta Batch no [portal Azure.][portal]

1. Selecione **as contas de Batch** no portal e, em seguida, selecione a conta Batch em que está interessado.
