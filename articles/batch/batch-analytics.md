...
ms.locfileid: "85958111"
---
# <a name="batch-analytics"></a>Batch Analytics
Os tópicos no Batch Analytics contêm informações de referência para os eventos e alertas disponíveis para os recursos de serviço batch.
