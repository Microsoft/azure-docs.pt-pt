...
* **Tarefas**: Um diretório é criado para cada tarefa que é executada no nó. O diretório é acedido ao consultar a variável de ambiente `AZ_BATCH_TASK_DIR`.
