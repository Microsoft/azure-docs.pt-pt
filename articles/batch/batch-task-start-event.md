...
description: Informações de referência para evento de início de tarefa de Lote. Esse evento é emitido depois que uma tarefa é agendada para ser iniciada em um nó de computação pelo Agendador.
services: batch
author: ju-shim
manager: gwallace
ms.assetid: ''
