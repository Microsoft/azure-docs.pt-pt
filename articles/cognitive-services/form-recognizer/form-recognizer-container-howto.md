...
O recipiente fornece APIs de ponto final REST, que pode encontrar na página de referência [Form Recogniser https://westus.dev.cognitive.microsoft.com/docs/services/form-recognizer-api-v2-1-preview-3/operations/AnalyzeWithCustomForm) API].
