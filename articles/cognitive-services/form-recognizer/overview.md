---
title: O que é o reconhecedor de formulário?
...
---
# <a name="what-is-form-recognizer"></a>O que é o reconhecedor de formulário?
...
Quando envia os dados de entrada, o algoritmo prepara a ele, clusters os formulários por tipos, Deteta que as chaves e tabelas estão presentes e aprende a associar valores para chaves e as entradas a tabelas. Aprendizado não supervisionado permite que o modelo compreender o esquema e relações entre os campos e entradas sem a etiquetagem de dados manual ou com utilização intensiva de codificação e manutenção. Por outro lado, com formação prévia de aprendizagem modelos de transferência de dados padronizada e são menos precisas com material de entrada que desvia a partir dos formatos tradicionais, como formulários específicos da indústria.
...
O serviço é disponibilizado como um [pré-visualização](https://azure.microsoft.com/support/legal/preview-supplemental-terms/) de um serviço do Azure sob o [termos de serviço Online](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=31). Irá reter a propriedade dos seus dados e é usada apenas para fornecer os Serviços Online, conforme explicado no seu contrato:

### <a name="processing-of-customer-data-ownership"></a>Processamento de dados do cliente; propriedade

Dados do cliente serão usados ou caso contrário, processados apenas para fornecer ao cliente os Online Services, incluindo fins compatíveis com a prestação dos serviços. A Microsoft será não utilizar ou caso contrário, processar dados do cliente ou derivará informações dos mesmos para fins publicitários ou comerciais. Como entre as partes, o cliente mantém tudo bem, title e interesses no e aos dados dos clientes. Microsoft não adquire nenhum direito em dados do cliente, que não sejam os direitos que dos clientes concede à Microsoft para fornecer os Serviços Online para o cliente.
