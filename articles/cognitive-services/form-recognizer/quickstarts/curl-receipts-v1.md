...
> [!IMPORTANT]
> Este guia de início rápido usa a API do Forms Recognizer v 1.0. Se sua assinatura estiver na região de `West US 2` ou `West Europe`, você deverá seguir o[início rápido da API v 2,0](./python-train-extract.md) em vez disso.
