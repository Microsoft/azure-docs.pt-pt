...
Na [ferramenta 'Rever'](https://contentmoderator.cognitive.microsoft.com)(rever o vídeo de texto de imagem de   >   /  /  revisão ( dependendo do conteúdo utilizado). O conteúdo que fez o upload deve aparecer, pronto para revisão humana.
