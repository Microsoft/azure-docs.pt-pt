...
1. Volte ao separador funcionalidades da **Plataforma.** Utilize o **+** botão do painel esquerdo para levantar o painel de **funções Nova.** A função que está prestes a criar receberá eventos do Facebook.
