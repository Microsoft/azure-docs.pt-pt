...
As subequipes são úteis para criar equipes de escalonamento ou equipes dedicadas à revisão de categorias específicas de conteúdo. Por exemplo, você pode enviar conteúdo adulto para uma equipe separada para análise adicional.
...
Clique no botão **Adicionar membro** para atribuir membros de sua equipe padrão a uma ou mais subequipes. Você só pode adicionar usuários existentes a uma subequipe. Para adicionar novos usuários que não estão na ferramenta de revisão, convide-os usando o botão "convidar" na página de configurações da equipe.
...
![Atribuir revisão de imagem à subequipe](images/3-review-image-subteam-1.png)
...
![Configurações de conectores de Content Moderator](images/settings-4-connectors.png)
...
![Content Moderator configurações de fluxo de trabalho](images/settings-5-workflows.png)
...
![Content Moderator chaves no portal do Azure](images/credentials-azure-portal-keys.PNG)
...
![Content Moderator a ID do recurso no portal do Azure](images/credentials-azure-portal-resourceid.PNG)
