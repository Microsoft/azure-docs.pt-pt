...
### <a name="how-many-review-teams-can-a-user-join-can-the-user-switch-between-teams"></a>Quantos, reveja as equipes podem uma associação de utilizador? O usuário pode alternar entre as equipes?

Um utilizador só pode ingressar numa equipe de cada vez.
...
Atualmente, as ferramentas de revisão permite atribuir funções de administrador e revisor. Os administradores podem convidar outros utilizadores e tem acesso para as definições de configuração, enquanto os revisores só podem rever os resultados de moderação e uma etiqueta ou untag conteúdo.
...
Uma marca é um código de curto de letras de um ou dois que denota um sinalizador de moderação, por exemplo, "a" para adulto, 'r' para adultos e assim por diante. Os administradores podem definir novas marcas para seus negócios, conforme necessário.
...
Pode ter um máximo de cinco membros da Equipe, incluindo o administrador numa equipa.
