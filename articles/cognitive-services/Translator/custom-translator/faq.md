...
Os sistemas implantados podem ser acedidos através do Tradutor especificando a categoriaID. Mais informações sobre o Tradutor podem ser encontradas na página de Referência da [API.](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-reference)
