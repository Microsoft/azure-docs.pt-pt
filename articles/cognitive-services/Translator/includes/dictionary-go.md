...
Crie um novo projeto Go usando seu IDE/editor favorito ou uma nova pasta na área de trabalho. Em seguida, copie esse trecho de código em seu projeto/pasta em `dictionaryLookup.go`um arquivo chamado.
