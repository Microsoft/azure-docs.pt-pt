...
O ponto final global do Tradutor é definido como `endpoint` o . `path` define a rota `translate` e identifica que queremos utilizar a versão 3 da API.
