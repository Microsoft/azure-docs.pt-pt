...
Na classe, crie uma função chamada `DetectTextRequest()`. `Program` Essa classe encapsula o código usado para chamar o recurso de detecção e imprime o resultado no console do.
