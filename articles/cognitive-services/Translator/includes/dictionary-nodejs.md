...
Crie um novo projeto usando seu IDE ou editor favorito ou crie uma nova pasta na sua área de trabalho. Copie este trecho de código em seu projeto/pasta em um arquivo `alt-translations.js`chamado.
