...
Crie um novo projeto utilizando o seu IDE ou editor favorito, ou crie uma nova pasta no seu ambiente de trabalho. Copie este fragmento de código no seu `alt-translations.js`projeto/pasta num ficheiro denominado .
