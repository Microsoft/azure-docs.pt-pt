...
Adicione estas linhas à `GetLanguages` classe. Você vai notar que a chave de subscrição e o ponto final estão sendo lidos a partir de variáveis ambientais:
...
Adicione esta linha à `GetLanguages` classe para instantaneamente: `OkHttpClient`
