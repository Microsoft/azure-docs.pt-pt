...
>[!NOTE]
> Para obter mais informações sobre os pontos finais, rotas e parâmetros de pedido, consulte [o Tradutor 3.0: Traduzir](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-translate).
