...
| category | **Opcional** uma cadeia de caracteres que contém o domínio da tradução ou a categoria. Este parâmetro suporta apenas a opção predefinida **gerais**.|
