---
title: Tradução documental obtenha método de formatos de documento
titleSuffix: Azure Cognitive Services
description: O método de formatos de documento obtém uma lista de formatos de documento suportados.
...
ms.locfileid: "105613160"
---
# <a name="document-translation-get-document-formats"></a>Tradução documental: obtenha formatos de documento

O método Obter Formatos de Documento devolve uma lista de formatos de documentos suportados pelo serviço de Tradução documental. A lista inclui a extensão comum do ficheiro e o tipo de conteúdo se utilizar a API de upload.
...
|Nome|Tipo|Description|
|--- |--- |--- |
 |code|string|Números contendo códigos de erro de alto nível. Valores possíveis:<ul><li>InternalServerError</li><li>Argumento invalido</li><li>InáduloRequest</li><li>RequestRateTooHigh</li><li>RecursosNotFound</li><li>ServiceUnavailable</li><li>Não autorizado</li></ul>|
