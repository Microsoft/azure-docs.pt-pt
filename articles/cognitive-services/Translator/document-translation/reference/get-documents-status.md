---
title: Obter estado de documentos
titleSuffix: Azure Cognitive Services
description: O método de estado dos documentos obtém a devolução do estado de todos os documentos num pedido de tradução de documentos de lote.
...
ms.locfileid: "107864869"
---
# <a name="get-documents-status"></a>Obter estado de documentos

O método de estado dos documentos get devolve o estado de todos os documentos num pedido de tradução de documentos de lote.
...
## <a name="get-documents-status-response"></a>Obtenha resposta do estado dos documentos

### <a name="successful-get-documents-status-response"></a>Resposta de estado de obter com sucesso
