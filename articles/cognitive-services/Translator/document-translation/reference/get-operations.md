---
title: Tradução documental obtenha operações
titleSuffix: Azure Cognitive Services
description: O método de operações get devolve uma lista de pedidos de lote apresentados e o estado de cada pedido.
...
O método Get Operations devolve uma lista de pedidos de lote apresentados e o estado de cada pedido. Esta lista contém apenas pedidos de lote enviados pelo utilizador (com base na subscrição). O estado de cada pedido é classificado por id.
...
## <a name="get-operations-response"></a>Obtenha resposta de operações

### <a name="successful-get-operations-response"></a>Resposta de operações com sucesso
