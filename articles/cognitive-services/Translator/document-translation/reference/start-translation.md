---
title: Iniciar a tradução
titleSuffix: Azure Cognitive Services
description: Inicie um pedido de tradução documental com o serviço de Tradução documental.
...
ms.locfileid: "107836317"
---
# <a name="start-translation"></a>Iniciar a tradução

Utilize esta API para iniciar um pedido de tradução a granel (lote) com o serviço de Tradução documental. Cada pedido pode conter vários documentos e deve conter um recipiente de origem e destino para cada documento.
