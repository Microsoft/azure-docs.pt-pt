...
ms.locfileid: "70393938"
---
# <a name="quickstart-use-the-translator-text-api-to-translate-text"></a>Início rápido: Use o API de Tradução de Texto para traduzir o texto
