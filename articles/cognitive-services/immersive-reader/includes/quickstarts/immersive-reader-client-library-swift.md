---
title: Início rápido da biblioteca de clientes Imersivo Reader Swift
titleSuffix: Azure Cognitive Services
description: Neste arranque rápido, você constrói uma aplicação iOS de raiz e adiciona a funcionalidade Imersiva da API do Leitor.
...
Adicione um novo ficheiro à pasta raiz do projeto chamada *ImmersiveReaderViewController.swift* e adicione o seguinte código.
...
Adicione outro novo ficheiro à pasta raiz do projeto chamada *LaunchImmersiveReader.swift* e adicione o seguinte código.
...
Adicione um ficheiro à pasta *Recursos* denominada *iFrameMessaging.js* e adicione o seguinte código.
