...
1. Comece por abrir a [Casca de Nuvem Azure.](https://docs.microsoft.com/azure/cloud-shell/overview) Certifique-se de que a casca de nuvem está definida para powerShell no dropdown da mão superior esquerda ou digitando `pwsh`.
...
1. Executar a função `Create-ImmersiveReaderResource`, fornecendo os parâmetros conforme apropriado.
    ...
    | ResourceSKU |Opções: `S0`. Visite a nossa página de [preços dos Serviços Cognitivos](https://azure.microsoft.com/pricing/details/cognitive-services/immersive-reader/) para saber mais sobre cada SKU disponível. Esse parâmetro será opcional se o recurso já existir. |
...
1. Copie a saída JSON em um arquivo de texto para uso posterior. O resultado deverá ser semelhante ao seguinte.
