...
1. Use `fs.createReadStream()` para ler o arquivo de imagem e criar variáveis para seus resultados e solicitação de pesquisa. Em seguida, use o cliente para pesquisar imagens.
