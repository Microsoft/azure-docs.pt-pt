...
|--|--|
|Chave de autor do proprietário| Até 1000 acessos de ponto final|
|Chaves de autoria colaborador/colaborador| Até 1000 acessos de ponto final|
|Qualquer chave atribuída à LUIS por um autor ou colaborador/colaborador|Com base no nível de utilização chave|
