...
## <a name="v2-api-deprecation"></a>V2 API Deprecação

A previsão V2 API não será depreciada durante pelo menos 9 meses após a pré-visualização da V3, 8 de junho de 2020.
