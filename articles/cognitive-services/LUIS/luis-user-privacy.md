...
Com exceção dos dados de aprendizagem ativa (detalhados abaixo), LUIS segue a [práticas de armazenamento de dados para serviços regionais](https://azuredatacentermap.azurewebsites.net/). 
