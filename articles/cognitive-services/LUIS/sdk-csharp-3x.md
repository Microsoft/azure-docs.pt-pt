---
title: 'Início rápido: Reconhecimento vocal (LUIS) criando biblioteca de cliente 3. x para .NET'
titleSuffix: Azure Cognitive Services
description: Introdução à biblioteca de cliente do LUIS 3. x para .NET. Siga estas etapas para instalar o pacote e experimentar o código de exemplo para tarefas básicas.
...
ms.locfileid: "74807507"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>Início rápido: Reconhecimento vocal (LUIS) biblioteca de cliente 3. x para .NET

Introdução à biblioteca de cliente do Reconhecimento vocal (LUIS) 3. x para .NET. Siga estas etapas para instalar o pacote e experimentar o código de exemplo para tarefas básicas.  O Reconhecimento vocal (LUIS) permite que você aplique inteligência de aprendizado de máquina personalizada ao texto de linguagem natural de um usuário para prever o significado geral e extrair informações relevantes e detalhadas.

Use a biblioteca de cliente do Reconhecimento vocal (LUIS) 3. x para .NET para:
