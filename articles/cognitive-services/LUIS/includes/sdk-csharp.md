...
O cliente de autoria de Compreensão linguística (LUIS) é um objeto [LUISAuthoringClient](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.luisauthoringclient) que autentica a Azure, que contém a sua chave de autoria.
...
* Exemplo de declarações - [adicionar,](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions) [excluir por ID](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions.deleteasync)
* Features - gerir [listas de frases](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.featuresextensions.addphraselistasync)
* Modelo - gerir [intenções](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.modelextensions) e entidades
* Pattern - gerir [padrões](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.patternextensions)
* Train - [treine](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.trainextensions.trainversionasync) a app e a sondagem para [o estado da formação](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.trainextensions.getstatusasync)
* [Versões](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.versionsextensions) - gerir com clone, exportar e eliminar

## <a name="prediction-object-model"></a>Modelo de objeto de previsão

O cliente de previsão de idioma (LUIS) é um objeto [LUISRuntimeClient](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.luisruntimeclient) que autentica para Azure, que contém a sua chave de recursos.

## <a name="code-examples-for-prediction-runtime"></a>Exemplos de código para o tempo de execução da previsão

Assim que o cliente for criado, utilize este cliente para aceder à funcionalidade, incluindo:

* Previsão por [encenação ou ranhura de produção](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.predictionoperationsextensions.getslotpredictionasync)
...
Crie um objeto [ApiKeyServiceClientCredentials](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.apikeyserviceclientcredentials) com a sua chave e use-o com o seu ponto final para criar um objeto [LUISAuthoringClient.](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.luisauthoringclient)
...
Criar um [ApplicationCreateObject](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.models.applicationcreateobject). O nome e a cultura linguística são propriedades necessárias. Ligue para o método [Apps.AddAsync.](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.appsextensions.addasync) A resposta é o ID da aplicação.
...
Call [Examples.AddAsync](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions) com o ID da aplicação, iD da versão e o exemplo.
...
O método [Train.TrainVersionAsync](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.trainextensions) precisa do ID da aplicação e do ID da versão.
...
Utilize um objeto [ApiKeyServiceClientCredentials](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.apikeyserviceclientcredentials) com a sua chave e use-o com o seu ponto final para criar um objeto [LUISRuntimeClient.](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.luisruntimeclient)
...
A expressão do utilizador faz parte do objeto [PredictionRequest.](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.models.predictionrequest)
