...
Chame [exemplos.adicione](//javascript/api/@azure/cognitiveservices-luis-authoring/examples?view=azure-node-latest#add-string--string--examplelabelobject--models-examplesaddoptionalparams-) com o ID da aplicação, iD da versão e o exemplo.
