...
description: Este artigo contém informações de entidade de URL predefinidas em Reconhecimento vocal (LUIS).
...
ms.locfileid: "73499505"
---
# <a name="url-prebuilt-entity-for-a-luis-app"></a>Entidade de URL predefinida para um aplicativo LUIS
A entidade de URL extrai URLs com nomes de domínio ou endereços IP. Como essa entidade já está treinada, você não precisa adicionar o exemplo declarações contendo URLs ao aplicativo. A entidade de URL tem suporte apenas na cultura `en-us`. 

## <a name="types-of-urls"></a>Tipos de URLs
A URL é gerenciada do repositório GitHub de [texto de reconhecedores](https://github.com/Microsoft/Recognizers-Text/blob/master/Patterns/Base-URL.yaml)

## <a name="resolution-for-prebuilt-url-entity"></a>Resolução para entidade de URL predefinida
