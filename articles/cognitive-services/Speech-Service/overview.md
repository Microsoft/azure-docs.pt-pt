...
ms.locfileid: "84417230"
---
# <a name="what-is-the-speech-service"></a>O que é o serviço de Voz?

O serviço de discurso é a unificação da palavra-a-texto, texto-a-discurso e tradução da fala numa única subscrição do Azure. É fácil de falar para ativar as suas aplicações, ferramentas e dispositivos com o [SDK de fala,](speech-sdk-reference.md) [dispositivos de fala SDK,](https://aka.ms/sdsdk-quickstart)ou [REST APIs](rest-apis.md).
...
| Serviço | Funcionalidade | Description | SDK | REST |
|---------|---------|-------------|-----|------|
...
| Serviço de Voz | Plataforma | Description |
| -------------- | -------- | ----------- |
