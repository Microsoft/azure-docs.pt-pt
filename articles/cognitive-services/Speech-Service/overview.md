...
|----------------|-------------|-------------|
| Voz em Texto | [Fala Personalizada](https://aka.ms/customspeech) | Personalize modelos de reconhecimento de fala para suas necessidades e dados disponíveis. Ultrapasse barreiras de reconhecimento de voz, como o estilo de fala, o vocabulário e o barulho de fundo. |
