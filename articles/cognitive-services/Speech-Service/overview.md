...
| [Texto-a-Discurso](text-to-speech.md) | Conversão de texto em voz | O texto-a-discurso converte o texto de entrada em linguagem humana sintetizada utilizando [a linguagem de marcação da síntese de fala (SSML)](speech-synthesis-markup.md). Use vozes neurais, que são vozes humanas alimentadas por redes neuronais profundas. Consulte [o suporte linguístico.](language-support.md) | [Sim](./speech-sdk.md) | [Sim](#reference-docs) |
...
* [Início rápido do reconhecimento de intenção](./get-started-intent-recognition.md)
