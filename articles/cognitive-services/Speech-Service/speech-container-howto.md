...
O contêiner fornece o ponto final REST APIs que pode ser encontradas [aqui](https://docs.microsoft.com/azure/cognitive-services/speech-service/rest-apis#text-to-speech-api) e pode ver exemplos [aqui](https://azure.microsoft.com/resources/samples/cognitive-speech-tts/).
