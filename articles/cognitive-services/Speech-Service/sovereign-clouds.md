...
- SR em SpeechSDK:*config. FromHost ("wss://virginia.stt.speech.azure.us", "\<a sua chave\>");*
...
- SR em SpeechSDK: *config. FromHost ("wss://chinaeast2.stt.speech.azure.cn", "\<a sua chave\>");*
...
- Portal de Discurso Personalizado: https://chinaeast2.cris.azure.cn/Home/CustomSpeech
- SKUs disponível: S0
- Características suportadas:
  - Voz em Texto
  - Discurso Personalizado (adaptação acústica/linguagem)
