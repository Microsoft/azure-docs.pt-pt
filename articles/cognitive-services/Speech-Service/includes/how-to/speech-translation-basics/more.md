...
ms.locfileid: "81399619"
---
## <a name="additional-language-and-platform-support"></a>Suporte adicional de linguagem e plataforma

Se clicou neste separador, provavelmente não viu um artigo básico na sua linguagem de programação favorita. Não se preocupe, temos amostras de código adicionais disponíveis no GitHub. Utilize a tabela para encontrar a amostra certa para a sua linguagem de programação e combinação plataforma/OS.
