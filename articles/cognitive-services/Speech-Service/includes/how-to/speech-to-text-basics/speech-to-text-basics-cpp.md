...
Para chamar o serviço de Discurso usando o SDK do Discurso, é necessário criar um [`SpeechConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig). Esta aula inclui informações sobre a sua subscrição, como a sua chave e região associada, ponto final, anfitrião ou sinal de autorização.
...
Vamos ver como um [`SpeechConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig) é criado usando uma chave e região.
...
A [classe Recogniser](https://docs.microsoft.com/cpp/cognitive-services/speech/speechrecognizer) para o C++ SDK da Fala para expor alguns métodos que pode usar para reconhecimento da fala.
...
Aqui está um exemplo de reconhecimento assíncrono usando [`RecognizeOnceAsync`: ](https://docs.microsoft.com/cpp/cognitive-services/speech/speechrecognizer#recognizeonceasync)

```cpp
auto result = recognizer->RecognizeOnceAsync().get();
```

Tens de escrever um código para lidar com o resultado. Esta amostra avalia o [`result->Reason`: ](https://docs.microsoft.com/cpp/cognitive-services/speech/recognitionresult#reason)
...
Comecemos por definir a entrada e rubricar um [`SpeechRecognizer`: ](https://docs.microsoft.com/cpp/cognitive-services/speech/speechrecognizer)
...
Em seguida, vamos criar uma variável para gerir o estado de reconhecimento da fala. Para começar, vamos declarar um `promise<void>`, uma vez que no início do reconhecimento podemos assumir com segurança que não está terminado.
...
Com tudo preparado, podemos [chamá`StopContinuousRecognitionAsync`. ](https://docs.microsoft.com/cpp/cognitive-services/speech/speechrecognizer#startcontinuousrecognitionasync)
...
Para ativar o modo de ditado, utilize o método [`EnableDictation`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig#enabledictation) na sua [`SpeechConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig).
...
Para utilizar uma lista de frases, primeiro crie [um](https://docs.microsoft.com/cpp/cognitive-services/speech/phraselistgrammar)`PhraseListGrammar`objeto, em seguida, adicione palavras e frases específicas com [`AddPhrase`](https://docs.microsoft.com/cpp/cognitive-services/speech/phraselistgrammar#addphrase).

Quaisquer alterações à [`PhraseListGrammar`](https://docs.microsoft.com/cpp/cognitive-services/speech/phraselistgrammar) produzir efeitos sobre o próximo reconhecimento ou após uma reconexão ao serviço da Fala.
