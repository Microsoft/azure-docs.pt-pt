...
Pode construir `libgstreamer_android.so` usando o seguinte comando em Ubuntu 16.04 ou 18.04. As seguintes linhas de comando foram testadas apenas para a [versão 1.14.4 do GStreamer Android](https://gstreamer.freedesktop.org/data/pkg/android/1.14.4/gstreamer-1.0-android-universal-1.14.4.tar.bz2) com o Android [NDK b16b.](https://dl.google.com/android/repository/android-ndk-r16b-linux-x86_64.zip)
