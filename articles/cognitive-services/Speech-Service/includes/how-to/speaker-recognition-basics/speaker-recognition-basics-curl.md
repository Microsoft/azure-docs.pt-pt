...
Comece por [criar um perfil de voz.](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/createprofile) Terá de inserir a chave e região do serviço Speech em cada um dos comandos de caracóis neste artigo.
...
Agora está pronto para [verificar uma amostra de áudio contra o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/verifyprofile). Esta amostra de áudio deve conter a mesma palavra-passe que as amostras utilizadas para inscrever o perfil de voz.
...
Para terminar, [elimine o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/deleteprofile).
...
Comece por [criar um perfil de verificação independente de texto.](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/createprofile)
...
Em seguida, [inscreva o perfil de voz.](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/createenrollment) Mais uma vez, em vez de submeter três amostras de áudio, é necessário submeter amostras de áudio que contenham um total de 20 segundos de áudio.
...
Para terminar, [elimine o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/deleteprofile).
...
Comece por [criar um perfil de identificação independente por texto.](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/createprofile)
...
Em seguida, [você matricula o perfil de voz.](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/createenrollment) Mais uma vez, precisa de enviar amostras de áudio que contenham um total de 20 segundos de áudio. Estas amostras não precisam de conter uma palavra-passe.
...
Para terminar, [elimine o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/deleteprofile).
