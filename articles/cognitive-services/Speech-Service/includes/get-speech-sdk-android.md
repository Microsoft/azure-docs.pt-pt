...
:::row:::
    :::column span="3":::
        Xamarin.Android expõe o SDK Android completo para desenvolvedores .NET. Construa aplicativos Android totalmente nativos usando C# ou F# em Visual Studio. Para mais informações, consulte <a href="https://docs.microsoft.com/xamarin/android/" target="_blank">Xamarin.Android <span class="docon docon-navigate-external x-hidden-focus"></span> </a>
    :::column-end:::
    :::column:::
        <br>
        <div class="icon is-large">
