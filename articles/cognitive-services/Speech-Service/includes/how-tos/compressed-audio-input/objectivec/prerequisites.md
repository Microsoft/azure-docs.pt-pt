...
1. Copie o `GStreamerWrapper.framework` que acabou de construir e o quadro do SDK do Discurso dos Serviços Cognitivos, que pode transferir daqui [para](https://aka.ms/csspeech/iosbinary)o diretório que contém o seu projeto de amostra.
