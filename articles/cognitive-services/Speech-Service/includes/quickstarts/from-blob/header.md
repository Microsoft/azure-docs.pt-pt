---
title: 'Quickstart: Reconhecer a fala armazenada no armazenamento de bolhas - Serviço de fala'
...
Para obter mais informações sobre as opções disponíveis e detalhes de [configuração,](../../../batch-transcription.md)consulte a transcrição do lote .

O seguinte quickstart irá acompanhá-lo através de uma amostra de uso.
