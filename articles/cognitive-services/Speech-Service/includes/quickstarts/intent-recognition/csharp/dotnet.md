...
ms.locfileid: "78925088"
---
## <a name="prerequisites"></a>Pré-requisitos

Antes de começar:

* <a href="~/articles/cognitive-services/Speech-Service/quickstarts/setup-platform.md?tabs=dotnet" target="_blank">Instale o SDK de Discurso para o<span class="docon docon-navigate-external x-hidden-focus"></span>seu ambiente de desenvolvimento um projeto de amostra sinuoso e de criação.</a>
...
* Substitua `"YourLanguageUnderstandingServiceRegion"` pela sua localização LUIS. Identificador **região** de utilização da [região.](https://aka.ms/speech/sdkregion)
