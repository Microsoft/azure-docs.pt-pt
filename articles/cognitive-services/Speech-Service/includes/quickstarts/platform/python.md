...
ms.locfileid: "83673242"
---
Este guia mostra como instalar o [SDK](~/articles/cognitive-services/speech-service/speech-sdk.md) de Discurso para Python. Se só quer que o nome do pacote seja iniciado por conta própria, `pip install azure-cognitiveservices-speech` corra.
...
Uma vez usado com sucesso `pip` para `azure-cognitiveservices-speech` instalar, pode usar o SDK de Fala importando o espaço de nome para os seus projetos Python.
...
1. Abra o Código do Estúdio Visual e instale a extensão Python. Selecione **File**  >  extensões de**Preferences**  >  **preferências** de ficheiro sacar do menu. Procure **Python** e clique em **Instalar**.
