...
## <a name="configure-go-environment"></a>Configure O ambiente Go

1. Uma vez que as encadernações `cgo` dependem, você precisa definir as variáveis ambientais para que Go possa encontrar o SDK:
...
1. Além disso, para executar aplicações incluindo o SDK, precisamos dizer ao SD Onde encontrar os libs:
