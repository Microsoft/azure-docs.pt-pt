...
ms.locfileid: "80656654"
---
:::row:::
    :::column span="3":::
        O Speech SDK apenas apoia **Ubuntu 16.04/18.04**, **Debian 9**, **Red Hat Enterprise Linux (RHEL) 8**, e **CentOS 7/8** nas seguintes arquiteturas-alvo quando utilizados com Linux:
        - x86
        - X64
        - ARM32
        - ARM64
