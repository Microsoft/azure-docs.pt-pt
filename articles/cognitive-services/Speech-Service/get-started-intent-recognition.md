---
title: Início rápido de reconhecimento de intenções - Serviço de fala
titleSuffix: Azure Cognitive Services
description: Neste arranque rápido, usa o reconhecimento de intenções para reconhecer interativamente intenções a partir de dados áudio capturados a partir de um microfone.
...
ms.locfileid: "107211368"
---
# <a name="get-started-with-intent-recognition"></a>Começar com reconhecimento de intenção
