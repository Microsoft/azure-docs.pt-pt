---
title: 'Início rápido: Traduzir a fala C# , (.NET Core Windows)-serviço de fala'
titleSuffix: Azure Cognitive Services
description: Neste guia de início rápido, você criará um aplicativo .NET Core simples para capturar a fala do usuário, convertê-lo em outro idioma e enviar o texto para a linha de comando. Este guia foi projetado para usuários do Windows.
...
ms.locfileid: "68609665"
---
# <a name="quickstart-translate-speech-with-the-speech-sdk-for-net-core"></a>Início rápido: Traduzir a fala com o SDK de fala para .NET Core

Os guias de início rápido também estão disponíveis para [conversão de fala em texto](quickstart-csharp-dotnet-windows.md) e [texto em fala](quickstart-text-to-speech-dotnetcore.md).
