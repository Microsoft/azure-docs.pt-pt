...
Os guias de início rápido também estão disponíveis para [síntese de fala](quickstart-text-to-speech-swift-ios.md).
...
1. No `ViewController.swift`, substitua a cadeia de caracteres `YourSubscriptionKey` pela sua chave de assinatura.
