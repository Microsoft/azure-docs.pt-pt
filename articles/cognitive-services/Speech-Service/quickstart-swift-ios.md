...
description: Aprender a reconhecer voz em Swift no iOS com o SDK de voz
...
ms.locfileid: "67467433"
---
# <a name="quickstart-recognize-speech-in-swift-on-ios-using-the-speech-sdk"></a>Início rápido: Reconhecer voz em Swift no iOS com o SDK de voz

[!INCLUDE [Selector](../../../includes/cognitive-services-speech-service-quickstart-selector.md)]

Neste artigo, saiba como criar uma aplicação iOS no Swift com o SDK de voz dos serviços cognitivos para transcrição de voz gravada usando um microfone para texto.
...
O SDK de voz dos serviços cognitivos para iOS é distribuído como um pacote do framework.
