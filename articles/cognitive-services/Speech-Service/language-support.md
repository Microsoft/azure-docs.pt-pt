...
O reconhecimento de voz de Microsoft SDK e a API REST suportam as seguintes linguagens (localidades). Estão disponíveis para cada idioma diferentes níveis de personalização.
