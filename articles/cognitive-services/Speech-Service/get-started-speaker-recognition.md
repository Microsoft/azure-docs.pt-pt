---
title: Quickstart de Reconhecimento de Altifalantes - Serviço de fala
titleSuffix: Azure Cognitive Services
description: Saiba como usar o Reconhecimento de Oradores do SDK do Discurso para responder à pergunta, "quem está a falar". Neste quickstart, você aprende sobre padrões de design comuns para trabalhar com a verificação e identificação de alto-falante, que ambos usam biometria de voz para identificar vozes únicas.
