...
Roobo fornece uma ferramenta que captura todos os áudio a memória flash. Ele pode ajudar a resolver problemas de áudio. Uma versão da ferramenta é fornecida para cada configuração de kit de desenvolvimento. Sobre o [Roobo site](http://ddk.roobo.com/), selecione o seu dispositivo e, em seguida, selecione o **Roobo ferramentas** link na parte inferior da página.
