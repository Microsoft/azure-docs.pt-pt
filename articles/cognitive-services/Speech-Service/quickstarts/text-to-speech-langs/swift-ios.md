---
title: 'Quickstart: Sintetizar o discurso em Swift no iOS - Serviço de fala'
titleSuffix: Azure Cognitive Services
description: Saiba como sintetizar o discurso em Swift no iOS usando o Speech SDK
...
ms.locfileid: "87062288"
---
# <a name="quickstart-synthesize-speech-in-swift-on-ios-using-the-speech-sdk"></a>Quickstart: Sintetizar o discurso em Swift no iOS usando o Discurso SDK

Neste artigo, aprende-se a criar uma aplicação iOS em Swift utilizando o SDK de Discurso dos Serviços Cognitivos para sintetizar o discurso a partir de texto.
...
O SDK de Discurso de Serviços Cognitivos para iOS é distribuído como um pacote-quadro.
