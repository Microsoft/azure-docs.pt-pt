...
* [Pitão](~/articles/cognitive-services/Speech-Service/quickstarts/text-to-speech.md?pivots=programming-language-python)
* [Nó.js](quickstart-nodejs-text-to-speech.md)
