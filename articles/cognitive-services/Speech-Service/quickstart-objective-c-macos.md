...
1. Navegue para o diretório da sua aplicação de exemplo (`helloworld`). Colocar um ficheiro de texto com o nome `Podfile` e nesse diretório, o seguinte conteúdo:
    ```
...
1. Substitua os conteúdos do gerado automaticamente `AppDelegate.m` de ficheiros por: [!code-objectivec[Quickstart Code](~/samples-cognitive-services-speech-sdk/quickstart/objectivec-macos/helloworld/helloworld/AppDelegate.m#code)]
