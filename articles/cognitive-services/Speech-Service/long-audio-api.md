...
O restante desta página centrar-se-á em Python, mas o código de amostra para a API de áudio longo está disponível no GitHub para as seguintes linguagens de programação:
