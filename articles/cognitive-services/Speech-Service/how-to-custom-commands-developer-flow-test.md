---
title: Teste a sua app comandos personalizados
...
- [Linguagems de programação SDK de fala, plataformas, capacidades de cenário](https://docs.microsoft.com/azure/cognitive-services/speech-service/speech-sdk)
