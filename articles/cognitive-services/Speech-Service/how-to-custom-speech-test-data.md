...
|----------|-------------|-------------|
| Verifique o formato de áudio | Utilize este comando para verificar o formato de arquivo de áudio. | `soxi <filename>.wav` |
| Converter o formato de áudio | Utilize este comando para converter o arquivo de áudio para o canal único, de 16 bits, 48 KHz. | `sox <filename>.wav -b 16 -3 signed-integer -c l -r 48k -t wav <filename>.wav` |
