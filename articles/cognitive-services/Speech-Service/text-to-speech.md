...
> [!NOTE]
> Atualmente, os eventos viseme são apenas suportados para a `en-US-AriaNeural` voz.
...
Além de vozes neurais, pode criar e afinar vozes personalizadas únicas ao seu produto ou marca. Tudo o que é preciso para começar são um punhado de ficheiros áudio e as transcrições associadas. Para mais informações, consulte [Começar com a Voz Personalizada](how-to-custom-voice.md)
