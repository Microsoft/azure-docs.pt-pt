...
* [Sintetizar a voz num ficheiro de áudio](quickstarts/text-to-speech-audio-file.md)
...
- Todas as marcações no campo de texto do organismo de `<speak>` `<voice>` pedido no formato SSML, com exceção e etiquetas
