...
ms.locfileid: "71803965"
---
# <a name="quickstart-synthesize-speech-with-the-speech-sdk-for-python"></a>Início rápido: Sintetizar fala com o SDK de fala para Python

Os guias de início rápido também estão disponíveis para [reconhecimento de fala](quickstart-python.md).

Este artigo mostra como usar os serviços de fala por meio do SDK de fala para Python. Ele ilustra como sintetizar a fala a partir do texto e reproduzi-lo com a saída de áudio padrão.
