---
title: Início rápido de discurso para texto - Serviço de fala
titleSuffix: Azure Cognitive Services
description: Saiba como usar o SDK do discurso para converter o discurso-a-texto. Neste arranque rápido, aprende-se sobre a construção de objetos, formatos de entrada de áudio suportados e opções de configuração para reconhecimento de voz.
