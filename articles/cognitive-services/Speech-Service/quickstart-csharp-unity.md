...
description: Use este guia para criar um aplicativo de fala a texto com o Unity e o SDK de fala para o Unity. Quando terminar, pode utilizar o microfone do seu computador para converter voz em texto em tempo real.
...
ms.locfileid: "71803470"
---
# <a name="quickstart-recognize-speech-with-the-speech-sdk-for-unity"></a>Início rápido: Reconhecer a fala com o SDK de fala para o Unity
...
Use este guia para criar um aplicativo de fala a texto usando o [Unity](https://unity3d.com/) e o SDK de fala para o Unity.
...
1. Abra o Unity. Se você estiver usando o Unity pela primeira vez, a janela *<version number>* do **Hub do Unity** será exibida. (Você também pode abrir o Hub do Unity diretamente para chegar a essa janela.)
   ...
   [janela do Hub ![Unity](media/sdk/qs-csharp-unity-hub.png)](media/sdk/qs-csharp-unity-hub.png#lightbox)
1. Selecione **Novo**. A janela **criar um novo projeto com o Unity** *<version number>* é exibida.

   [![Create um novo projeto no Hub do Unity](media/sdk/qs-csharp-unity-create-a-new-project.png)](media/sdk/qs-csharp-unity-create-a-new-project.png#lightbox)
...
1. Baixe e abra o [SDK de fala para o Unity](https://aka.ms/csspeech/unitypackage), que é empacotado como um pacote de ativos de Unity (. unitypackage). Quando o pacote de ativos é aberto, a caixa de diálogo **Importar pacote do Unity** é exibida.

   [caixa de diálogo ![Import do pacote do Unity no editor do Unity](media/sdk/qs-csharp-unity-01-import.png)](media/sdk/qs-csharp-unity-01-import.png#lightbox)
...
1. Na parte superior da janela **hierarquia** , selecione **criar** > **interface do usuário** > **botão**.
   ...
   [ambiente de editor de @no__t 1Unity](media/sdk/qs-csharp-unity-editor-window.png)](media/sdk/qs-csharp-unity-editor-window.png#lightbox)
...
1. Na janela **hierarquia** , selecione **criar** > **IU** > **texto** para criar um objeto de **texto** .
...
[exibição de @no__t 1Scene no editor do Unity](media/sdk/qs-csharp-unity-02-ui-inline.png)](media/sdk/qs-csharp-unity-02-ui-inline.png#lightbox)
...
1. Na [janela do projeto](https://docs.unity3d.com/Manual/ProjectView.html), selecione **criar** **C# script**  >  para adicionar um novo C# script.
   ...
   [janela ![Project no editor do Unity](media/sdk/qs-csharp-unity-project-window.png)](media/sdk/qs-csharp-unity-project-window.png#lightbox)
...
1. Localize e substitua a cadeia de caracteres `YourServiceRegion` pela [região](regions.md) associada à sua assinatura. Por exemplo, se estiver a utilizar a versão de avaliação gratuita, a região é `westus`.
...
1. Na janela **Inspetor** , selecione o botão **Adicionar componente** .
   ...
   [janela ![Inspector no editor do Unity](media/sdk/qs-csharp-unity-inspector-window.png)](media/sdk/qs-csharp-unity-inspector-window.png#lightbox)

1. Na lista suspensa, pesquise o script `HelloWorld` que criamos acima e adicione-o. Uma seção **Olá, mundo (script)** aparece na janela **Inspetor** , listando duas propriedades não inicializadas, **texto de saída** e o **botão iniciar recup**. Essas propriedades do componente do Unity correspondem às propriedades públicas da classe `HelloWorld`.
...
1. Selecione o botão e fale uma frase ou sentença em inglês no microfone do seu computador. Sua fala é transmitida para os serviços de fala e transcrita para texto, que aparece na exibição do **jogo** .
   ...
   [exibição de @no__t 1Game no editor do Unity](media/sdk/qs-csharp-unity-03-output-inline.png)](media/sdk/qs-csharp-unity-03-output-inline.png#lightbox)

1. Verifique a [janela do **console** ](https://docs.unity3d.com/Manual/Console.html) em busca de mensagens de depuração. Se a janela do **console** não estiver sendo exibida, vá para a barra de menus e selecione **janela** > **geral** > **console** para exibi-lo.
