...
Os guias de início rápido também estão disponíveis para [síntese de fala](quickstart-text-to-speech-swift-macos.md).
...
1. Adicione o caminho relativo `helloworld/MicrosoftCognitiveServicesSpeech-Bridging-Header.h` ao cabeçalho de ponte para as configurações de projeto Swift para o destino HelloWorld no campo de *cabeçalho de ponte Objective-C* ![Header Propriedades @ no__t-3
...
1. No `AppDelegate.swift`, substitua a cadeia de caracteres `YourSubscriptionKey` pela sua chave de assinatura.
