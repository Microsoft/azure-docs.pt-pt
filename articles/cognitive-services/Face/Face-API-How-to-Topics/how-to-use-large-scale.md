...
Quando utiliza a biblioteca de cliente de Face API, a chave de subscrição e o ponto final de subscrição são transmitidos através do construtor da classe FaceServiceClient. Por exemplo:
