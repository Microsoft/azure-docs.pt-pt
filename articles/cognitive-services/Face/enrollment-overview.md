...
Para utilizar a API de Face de Serviços Cognitivos para verificação ou identificação facial, é necessário inscrever rostos num **LargePersonGroup** ou numa estrutura de dados semelhante. Este mergulho profundo demonstra as melhores práticas para recolher consentimento significativo dos utilizadores e lógica de exemplo para criar inscrições de alta qualidade que irão otimizar a precisão do reconhecimento. 
