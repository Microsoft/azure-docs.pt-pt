...
A cadeia de consulta do URL do ponto final do face especifica quais os atributos faciais para recuperar. Pode desejar alterar esta cadeia dependendo da utilização pretendida.
