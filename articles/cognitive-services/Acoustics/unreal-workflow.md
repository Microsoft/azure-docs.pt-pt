...
![Projeto oclusão curva](media/wwise-occlusion-curve.png)
...
![Projeto obstrução curva](media/wwise-obstruction-curve.png)
...
![Opções de plug-in do mixer Acoustics do projeto](media/mixer-plugin-global-settings.png)
...
![Por definições de som Mixer](media/per-sound-mixer-settings.png)
...
![Controles de espaço de Acoustics](media/acoustics-space-controls.png)
...
![Controles de componente de áudio](media/audio-component-controls.png)
...
![Configuração de transmissão em fluxo](media/streaming-setup.png)
