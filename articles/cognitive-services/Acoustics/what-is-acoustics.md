...
![Captura de tela do Gears of War 4, que mostra acoustics voxels](media/gears-with-voxels.jpg)
...
![Animação mostrando um setor 2D horizontal de propagação de wave por meio de uma cena](media/wave-simulation.gif)
