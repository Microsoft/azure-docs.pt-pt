...
ms.locfileid: "80053640"
---
# <a name="what-is-custom-vision"></a>O que é a Visão Personalizada?

[!INCLUDE [TLS 1.2 enforcement](../../../includes/cognitive-services-tls-announcement.md)]

A Visão Personalizada é um serviço cognitivo que lhe permite criar, implementar e melhorar os seus classificadores de imagens. Um classificador de imagem é um serviço de IA que aplica etiquetas (que representam _classes_) às imagens, de acordo com as suas características visuais. Ao contrário do serviço [Computer Vision,](https://docs.microsoft.com/azure/cognitive-services/computer-vision/home) a Custom Vision permite-lhe determinar as etiquetas a aplicar.
