...
> [!IMPORTANT]
> Aceda ao portal do Azure. Se o recurso Custom Vision Training que criou na secção **Pré-requisitos** implementado com sucesso, clique no botão **'Ir a Recursos'** nos **Passos Seguintes**. Pode encontrar a sua chave e ponto final na **página chave e ponto final** do recurso. 
>
