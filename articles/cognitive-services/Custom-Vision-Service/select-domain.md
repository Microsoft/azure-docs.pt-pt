...
|__Marcos__|Otimizado para marcos reconhecíveis, tanto naturais como artificiais. Este domínio funciona melhor quando o marco é claramente visível na fotografia. Este domínio funciona mesmo que o marco seja ligeiramente obstruído por pessoas à sua frente.|
...
|__Logotipo__|Otimizado para encontrar logotipos da marca em imagens.|
...
|Deteção de Objetos|Geral (compacto)|45 MB|35 ms|5 ms|
