...
---
# <a name="autosuggest-api-upgrade-guide"></a>Guia de upgrade api autosuggest API
...
- O número da versão do ponto final mudou de v5 para v7. Por exemplo,\/https:\*\*/api.cognitive.microsoft.com/bing/ v7.0**/Sugestões.
