---
title: 'Quickstart: Bing Autosuggest biblioteca de clientes para .NET Microsoft Docs'
description: Inicie-se com a biblioteca de clientes Bing Autosuggest para .NET, e obtenha sugestões de pesquisa baseadas em cordas de consulta parcial.
...
---
# <a name="quickstart-bing-autosuggest-client-library-for-net"></a>Quickstart: Bing Autosuggest biblioteca de clientes para .NET
