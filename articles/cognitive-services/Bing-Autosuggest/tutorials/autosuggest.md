---
title: 'Tutorial: Obtenção de sugestões automáticas Resultados usando Bing Autosuggest API'
titleSuffix: Azure Cognitive Services
description: Neste tutorial, irá construir uma página web que permite aos utilizadores consultar a API Bing Autosuggest e apresentar os resultados da consulta.
...
Especifique o ponto final da Bing Autosuggest API e declare um objeto XMLHttpRequest, que usaremos para enviar pedidos. Pode utilizar o ponto final global abaixo, ou o ponto final personalizado do [subdomínio](../../../cognitive-services/cognitive-services-custom-subdomains.md) exibido no portal Azure para o seu recurso.
...
Crie um formulário HTML com um campo de texto. Manuseie `oninput` o `bingAutosuggest()` evento e ligue para a função, passando o conteúdo do campo de texto e a tecla API Bing Autosuggest.
