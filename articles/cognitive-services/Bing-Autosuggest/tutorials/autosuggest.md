---
title: 'Tutorial: Obtenção automática de sugestões Resultados usando API autosuggest Bing'
titleSuffix: Azure Cognitive Services
description: Neste tutorial, irá construir uma página web que permite aos utilizadores consultarem a API Bing Autosuggest e apresentar os resultados da consulta.
...
Para acompanhar o tutorial, necessita de uma chave de subscrição para a API de Sugestão Automática do Bing. Se não tiver um, [crie um recurso Bing Autosuggest](https://portal.azure.com/#create/Microsoft.CognitiveServicesBingAutosuggest-v7) no portal Azure.
...
Especifique o ponto final da API Bing Autosuggest e declare um objeto XMLHttpRequest, que usaremos para enviar pedidos. Pode utilizar o ponto final global abaixo ou o ponto final [personalizado subdomínio](../../../cognitive-services/cognitive-services-custom-subdomains.md) exibido no portal Azure para o seu recurso.
...
Crie um formulário HTML com um campo de texto. Lide com o `oninput` evento e ligue para a `bingAutosuggest()` função, passando o conteúdo do campo de texto e a chave API Bing Autosuggest.
