...
Crie um formulário HTML com um campo de texto. Manuseie o evento `oninput` e ligue para a função `bingAutosuggest()`, passando o conteúdo do campo de texto e a tecla API Bing Autosuggest.
