...
1. Abra o [portal Azure](https://portal.azure.com)e selecione o seu recurso Personalizer.
1. Selecione **Modelo e definições** de aprendizagem na secção Gestão de **Recursos.**
1. Para as definições de **aprendizagem de importação,** selecione o botão de definições de **aprendizagem de exportação.** Isto guarda o ficheiro `json` para o seu computador local.
