...
Dependendo do dispositivo do utilizador, normalmente exibe um subconjunto das miniaturas, com uma opção para o utilizador [páginar através](paging-webpages.md) das restantes imagens.
