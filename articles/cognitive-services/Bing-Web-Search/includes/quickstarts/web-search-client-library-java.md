---
title: Bing Web Search Java biblioteca de clientes quickstart
...
* [Referência a Java SDK do Azure](/java/api/overview/azure/cognitiveservices/client/bingwebsearchapi?view=azure-java-stable)