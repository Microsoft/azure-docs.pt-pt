...
O [API de pesquisa na Web do Bing](../Bing-Web-Search/overview.md) retorna páginas da Web, imagens, vídeo, notícias e muito mais. Você pode filtrar as consultas de pesquisa enviadas a essa API para incluir ou excluir determinados tipos de conteúdo.
...
| [Pesquisa de Vídeo](../Bing-Video-Search/overview.md) | O API de Pesquisa de Vídeo do Bing permite encontrar vídeos na Web. Obtenha vídeos de tendência, conteúdo relacionado e visualizações em miniatura. |
| [Pesquisa Visual](../Bing-visual-search/overview.md) | Carregue uma imagem ou use uma URL para obter informações mais criteriosas sobre ela, como produtos visualmente semelhantes, imagens e pesquisas relacionadas. |
 [Pesquisa de negócios local](../bing-local-business-search/overview.md) | A API de pesquisa de negócios local do Bing permite que seus aplicativos encontrem informações de contato e local sobre empresas locais com base em consultas de pesquisa. |
