...
Para obter uma lista completa de opções e parâmetros, consulte [bing Web Search API v7](/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-reference).
