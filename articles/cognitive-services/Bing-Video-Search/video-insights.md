...
Para obter vídeos relacionados com o vídeo especificado, desafine o parâmetro de consulta dos [módulos](/rest/api/cognitiveservices-bingsearch/bing-video-api-v7-reference#modulesrequested) para `RelatedVideos` .
...
A resposta a este pedido terá um objeto [videoDetails](/rest/api/cognitiveservices-bingsearch/bing-video-api-v7-reference#videodetails) de alto nível em vez de um objeto [de Vídeos.](/rest/api/cognitiveservices-bingsearch/bing-video-api-v7-reference#videos)  
