...
description: Utilize este tutorial para construir uma página web que envia consultas para a API de Verificação ortográfica de Bing e apresenta os resultados.
...
Para acompanhar o tutorial, necessita de uma chave de subscrição para a API de Verificação de Ortografia do Bing. Se não tiver um, vai precisar de:

* Uma subscrição do Azure - [Crie uma gratuitamente](https://azure.microsoft.com/free/cognitive-services/)
* [Um recurso bing spell check](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7)
...
Crie um formulário HTML com um campo de texto. Manuseie o `onsubmit` evento e ligue para a função bingSpellCheck, passando o conteúdo do campo de texto e a tecla API de Verificação ortográfica de Bing.
