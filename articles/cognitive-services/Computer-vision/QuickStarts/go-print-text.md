...
ms.locfileid: "68276490"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-computer-vision-rest-api-with-go"></a>Início rápido: Extrair texto impresso (OCR) usando a API REST de imagem digitalizada com Go
