---
title: 'Quickstart: Visão computacional 2.0 e 2.1 - Extrato de texto impresso e manuscrito - REST, JavaScript'
titleSuffix: Azure Cognitive Services
description: Neste arranque rápido, extrai texto impresso e manuscrito de uma imagem utilizando a API de Visão de Computador com JavaScript.
...
1. Opcionalmente, substitua o valor do `value` atributo pelo controlo pelo URL de uma imagem diferente da qual pretende extrair `inputImage` texto.
1. Guarde o código como um ficheiro com a extensão `.html`. Por exemplo, `get-text.html`.
1. Abra uma janela do browser.
1. Quando a página web for apresentada no navegador, preencha os parâmetros necessários e escolha o botão **de imagem Ler.**
