...
Opcionalmente, você pode executar este guia de início rápido em uma maneira passo a lado usando um [](https://mybinder.org)Notebook Jupyter em mybinder. Para iniciar o Binder, selecione o botão seguinte:
