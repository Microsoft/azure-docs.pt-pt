...
```
Consulte [o Apoio à Região](https://azure.microsoft.com/global-infrastructure/services/?products=cognitive-services) para as regiões disponíveis.
```bash
...
Terá de instalar a versão 1.0.9 do [Azure IoT Edge.](../../iot-edge/how-to-install-iot-edge.md) Siga estes passos para descarregar a versão correta:
...
Em seguida, registe o computador anfitrião como um dispositivo IoT Edge na sua instância IoT Hub, utilizando uma [cadeia de ligação](../../iot-edge/how-to-register-device.md).
...
Agora que montou e configuraram o seu VM, siga os passos abaixo para configurar a Azure IoT Edge. 
...
Em seguida, registe o VM como um dispositivo IoT Edge na sua instância IoT Hub, utilizando uma [cadeia de ligação](../../iot-edge/how-to-register-device.md).
