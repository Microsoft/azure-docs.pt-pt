...
Utilize a [API do comboio](https://docs.microsoft.com/rest/api/cognitiveservices/qnamakerruntime/runtime/train) para enviar a resposta correta à QnA Maker, depois de o utilizador a selecionar.
