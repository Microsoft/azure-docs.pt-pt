...
description: Este guia de início rápido mostra como criar uma base de dados de conhecimento (KB) QnA Maker de seu próprio conteúdo, como perguntas frequentes ou manuais de produto. A base de dados de conhecimento QnA Maker neste exemplo é criada de uma página da Web de perguntas frequentes simples para responder a perguntas sobre a recuperação de chave do BitLocker.
author: diberry
manager: nitinme
...
1. No portal do Azure, crie o recurso. Lembre-se de sua ID de Azure Active Directory, assinatura, nome de recurso QnA que você selecionou ao criar o recurso.
1. Retorne ao portal de QnA Maker, atualize a página da Web no portal para continuar criando sua base de dados de conhecimento. Selecione um inquilino existente, subscrição e o novo recurso. Selecione o idioma. Esta será a linguagem usada para todas as bases de conhecimento neste serviço QnA Maker.
...
1. No portal de QnA Maker, na página **Editar** , selecione **+ Adicionar par de QnA** na barra de ferramentas de contexto.
...
1. Uma nova guia do navegador é aberta para o portal do Azure, com a página de criação do serviço de bot do Azure. Configure o serviço de bot do Azure. O bot e o QnA Maker podem compartilhar o plano do serviço de aplicativo Web, mas não podem compartilhar o aplicativo Web. Isso significa que o **nome do aplicativo** para o bot deve ser diferente do nome do aplicativo para o serviço de QnA Maker.
    ...
    * **Não**
        * Altere as configurações a seguir no portal do Azure ao criar o bot. Eles são preenchidos previamente para sua base de dados de conhecimento existente:
...
## <a name="what-did-you-accomplish"></a>O que você obteve?

Você criou uma nova base de dados de conhecimento, adicionou uma URL pública à base de dados de conhecimento, adicionou seu próprio QnA definido, treinado, testado e publicado a base de dados de conhecimento.

Depois de publicar a base de dados de conhecimento, você criou um bot e testou o bot.

Isso foi realizado em alguns minutos sem a necessidade de escrever nenhum código e limpar o conteúdo.
