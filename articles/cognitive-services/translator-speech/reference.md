...
|X-ClientVersion|(vazio)    |Identifica a versão da aplicação cliente. Exemplo: "2.1.0.123".<br/>Em vez de usar um cabeçalho, este valor pode ser passado com o parâmetro de consulta `X-ClientVersion`. Se o cabeçalho e o parâmetro de consulta são definidos, o parâmetro de consulta é ignorado.|cabeçalho|string|
