...
1. Executar o programa a partir do seu IDE ou linha de comando, por exemplo `npm start` ou `node detect.js` .
...
A API da Análise de Sentimentos deteta o sentimento de um conjunto de registos de texto através do [método Sentimento](https://westcentralus.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v2-1/operations/56f30ceeeda5650db055a3c9). A análise de sentimentos pode ser usada para descobrir o que os clientes pensam da sua marca ou tópico, analisando texto em bruto para pistas sobre sentimentos positivos ou negativos. O exemplo a seguir fornece pontuações para dois documentos, um em inglês e outro em espanhol.

1. Crie um novo projeto Node.JS no seu IDE favorito ou numa pasta no seu ambiente de trabalho.
1. Adicione o código abaixo fornecido a um novo `.js` ficheiro.
1. Copie a sua chave de Análise de Texto e ponto final no código. 
1. Executar o programa a partir do seu IDE ou linha de comando, por exemplo `npm start` ou `node sentiment.js` .
...
1. Adicione o código abaixo fornecido a um novo `.js` ficheiro.
1. Copie a sua chave de Análise de Texto e ponto final no código. 
1. Executar o programa a partir do seu IDE ou linha de comando, por exemplo `npm start` ou `node key-phrases.js` .
...
1. Adicione o código abaixo fornecido a um novo `.js` ficheiro.
1. Copie a sua chave de análise de texto e ponto final no código
1. Executar o programa a partir do seu IDE ou linha de comando, por exemplo `npm start` ou `node entities.js` .
