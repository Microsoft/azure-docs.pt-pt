...
## <a name="what-is-the-maximum-size-and-number-of-requests-i-can-make-to-the-api"></a>Qual é o tamanho máximo e o número de pedidos que posso fazer à API?

Consulte o artigo [limite de dados](concepts/data-limits.md) para obter informações sobre o tamanho e o número de pedidos que pode enviar por minuto e segundo.
