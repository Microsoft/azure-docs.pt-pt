...
Saiba como implementar o contentor de deteção de idioma. Este procedimento mostra como criar contentores de Docker locais, envie os contentores para o seu próprio registo privado de contentor, execute o contentor num cluster do Kubernetes e testá-la num navegador da web. Através de contentores podem deslocar a atenção dos desenvolvedores evitar o gerenciamento de infra-estrutura para em vez disso, com foco no desenvolvimento de aplicativos.
