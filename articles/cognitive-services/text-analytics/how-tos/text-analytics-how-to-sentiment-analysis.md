...
A próxima versão do Análise de Sentimento agora está disponível para visualização pública. Ele fornece melhorias significativas na precisão e nos detalhes da categorização e da Pontuação de texto da API. Experimente usando o [console de teste de API](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-0-Preview-1/operations/Sentiment).
