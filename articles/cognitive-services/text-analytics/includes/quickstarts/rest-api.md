...
ms.locfileid: "102445689"
---
# <a name="version-31-preview"></a>[Visualização da versão 3.1](#tab/version-3-1)

[v3.1 Documentação de referência](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-3/)
...
> [!NOTE]
> O exemplo abaixo inclui um pedido para a característica de Análise de Sentimento de Opinião utilizando o `opinionMining=true` parâmetro, que fornece informações granulares sobre os pareceres relacionados com aspetos (como os atributos de produtos ou serviços) em texto.
