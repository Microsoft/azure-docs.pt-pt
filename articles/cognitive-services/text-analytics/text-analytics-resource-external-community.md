---
title: Conteúdo comunitário de & externos para API de Análise de Texto
titleSuffix: Azure Cognitive Services
description: Blogs de parceiros, vídeos do YouTube, formação para Azure Cognitive Services Text Analytics API.
...
+ [Anúncio original da API de Análise de Texto (blog Azure)](https://azure.microsoft.com/blog/using-text-analytics-in-call-centers/)

+ [Utilização de palavras-chave de texto API de Serviços Cognitivos API da PowerShell (blog AutomationNext)](https://automationnext.wordpress.com/tag/text-analytics/)

+ [R Quick tip: Microsoft Cognitive Services's Text Analytics API (R Bloggers)](https://www.r-bloggers.com/r-quick-tip-microsoft-cognitive-services-text-analytics-api/)
...
+ [App lógica para detetar sentimento e extrair frases-chave do seu texto](https://www.youtube.com/watch?v=jVN9NObAzgk)

+ [Análise de sentimento usando Power BI e Microsoft Cognitive Services](https://www.youtube.com/watch?v=gJ1j3N7Y75k)

+ [A análise de texto extrai frases-chave usando Power BI e Microsoft Cognitive Services](https://www.youtube.com/watch?v=R_-1TB2BF14)
