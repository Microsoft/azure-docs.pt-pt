...
3. Enviar o pedido através de `requests.post()`. Combinar o ponto final e o URL de deteção de anomalias para todo o URL do pedido e incluir os cabeçalhos e dados de pedido do json. 

4. Se a solicitação for bem-sucedida, devolve a resposta.  
