...
1. Na **Criar uma máquina virtual - Básicos, insira**ou selecione esta informação:
    ...
    | Palavra-passe | Insira uma senha à sua escolha. A palavra-passe tem de ter, pelo menos, 12 carateres e cumprir os [requisitos de complexidade definidos](../virtual-machines/windows/faq.md?toc=%2fazure%2fvirtual-network%2ftoc.json#what-are-the-password-requirements-when-creating-a-vm).|
