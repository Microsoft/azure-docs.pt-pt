...
3. Selecione **Concordo com os termos e condições acima indicados** e, em seguida, selecione **Comprar**. A colocação pode demorar 20 minutos ou mais para ser concluída.

## <a name="validate-the-deployment"></a>Validar a implementação
> [!NOTE]
> o modelo ARM gera um nome único para o recurso Virtual Machine myVm<b>{uniqueid}</b> e para o servidor sqlserver sqlserver Azure SQL<b>{uniqueid}</b> recurso, substitua <b>{uniqueid}</b> pelo seu valor gerado.

### <a name="connect-to-a-vm-from-the-internet"></a>Ligar a uma VM a partir da Internet

Ligue-se ao VM *myVm{uniqueid}* da internet da seguinte forma:

1. Na barra de pesquisa do portal, insira *myVm{uniqueid}*.
...
Nesta secção, irá ligar-se ao SqL Database Server a partir do VM utilizando o Ponto Final Privado.
 ...
 1. No Ambiente de Trabalho Remoto do *myVM{uniqueid}*, abra o PowerShell.
...
```
 ...
 7. (Opcionalmente) Criar ou consultar informações a partir de *sample-db*
 8. Feche a ligação remota do ambiente de trabalho ao *myVm{uniqueid}*.
