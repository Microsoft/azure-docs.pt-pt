---
title: Quickstart - Interaja com um dispositivo IoT Plug and Play ligado à sua solução Azure IoT (Node.js) Microsoft Docs
description: Quickstart - Utilize Node.js para ligar e interagir com um dispositivo IoT Plug and Play que esteja ligado à sua solução Azure IoT.
author: elhorton
ms.author: elhorton
ms.date: 10/05/2020
ms.topic: quickstart
...
> [!NOTE]
> Estas amostras de serviço utilizam a classe **registro** do cliente de **serviço IoT Hub.** Para saber mais sobre as APIs, incluindo as gémeas digitais API, consulte o [guia de desenvolvedores de serviços.](concepts-developer-guide-service.md)
