...
O hub IoT que criou anteriormente será a fonte de [eventos](https://docs.microsoft.com/azure/time-series-insights/concepts-streaming-ingestion-event-sources)do seu ambiente TSI.
