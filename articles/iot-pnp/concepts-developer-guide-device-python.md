---
title: Guia de desenvolvedores de dispositivos (Python) - IoT Plug and Play Microsoft Docs
description: Descrição de IoT Plug e Play para desenvolvedores de dispositivos Python
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91580488"
---
# <a name="iot-plug-and-play-device-developer-guide-python"></a>Guia de desenvolvedores de dispositivos IoT Plug and Play (Python)
