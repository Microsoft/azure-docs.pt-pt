---
title: Guia de desenvolvimento de dispositivos (Node.js) - IoT Plug and Play Microsoft Docs
description: Descrição de IoT Plug e Play para desenvolvedores de dispositivos Node.js
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91580084"
---
# <a name="iot-plug-and-play-device-developer-guide-nodejs"></a>Guia de desenvolvimento de dispositivos IoT Plug and Play (Node.js)
