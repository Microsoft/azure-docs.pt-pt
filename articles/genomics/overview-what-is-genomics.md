...
Em vez de gerir os seus próprios datacenters, tire partido do dimensionamento e da experiência da Microsoft ao executar cargas de trabalho em escala de exabyte. Nossa implementação em nuvem do BWA-GATK é altamente decaboada com o pipeline de práticas recomendadas do amplo Instituto.


## <a name="keep-your-business-running"></a>Mantenha sua empresa em execução
...
Agora que você leu uma introdução ao Microsoft Genomics, você está pronto para:
