...
description: Entre rapidamente no Azure Notebooks Preview e defina uma ID de usuário, que oferece a capacidade de acessar projetos salvos e compartilhar blocos de anotações com outras pessoas.
ms.topic: quickstart
ms.date: 04/15/2019
...
---
# <a name="quickstart-sign-in-and-set-a-user-id-for-azure-notebooks-preview"></a>Início rápido: entrar e definir uma ID de usuário para Azure Notebooks versão prévia
