---
title: Criar um Azure Notebooks projeto de visualização com um ambiente personalizado
description: Crie um novo projeto no Azure Notebooks Preview configurado com um conjunto específico de pacotes instalados e scripts de inicialização.
ms.topic: quickstart
ms.date: 12/04/2018
