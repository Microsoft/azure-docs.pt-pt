---
title: Tutorial – criar e executar um bloco de anotações do Jupyter-Azure Notebooks visualização
description: Saiba como criar e executar um notebook Jupyter em Azure Notebooks visualização que demonstra o processo de regressão linear na ciência de dados.
ms.topic: tutorial
ms.date: 01/11/2019
...
> [!div class="checklist"]
> * Criar um bloco de anotações do projeto com alguns dados de exemplo
> * Usar a interface do bloco de anotações para criar uma variedade de tipos de células
> * Executar o bloco de notas
> * Salvar o bloco de anotações
> * Depurar o bloco de anotações no Visual Studio Code
...
| Menu | Descrição |
| --- | --- |
| Ficheiros | Comandos para gerir o ficheiro de bloco de notas, incluindo comandos para criar e copiar blocos de notas, mostram uma pré-visualização de impressa e Baixe o bloco de notas numa variedade de formatos. |
