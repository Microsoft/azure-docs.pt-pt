...
|  |**Rede virtual hub**|**Centro virtual seguro**  |
|---------|---------|---------|
|**Recurso subjacente**     |Rede virtual|Centro Wan Virtual|
|**Hub & Spoke**     |Utiliza o peering de rede virtual|Automatizado usando conexão de rede virtual hub|
...
|**Firewall de aplicação web no gateway da aplicação** |Suportado em Rede Virtual|Atualmente suportado em rede de porta-voz|
