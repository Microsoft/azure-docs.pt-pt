...
Pode utilizar fornecedores de terceiros para filtragem de tráfego branch to Internet (B2I), lado a lado com Azure Firewall para Branch para VNet (B2V), VNet para VNet (V2V) e VNet para Internet (V2I). 
