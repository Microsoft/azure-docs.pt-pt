...
A sua conta de Media Service está ligada a uma conta de Armazenamento Azure e, quando grava o vídeo na nuvem, o conteúdo é escrito para um [ativo](../latest/assets-concept.md)do Media Service . Cada ativo é mapeado para um recipiente na conta de armazenamento. a gestão do ciclo de vida permite-lhe definir uma [política](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#policy) para uma conta de Armazenamento, na qual pode especificar uma [regra](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#rules) como a seguinte.
...
* Especifica que quando as bolhas envelhecem para além dos 30 dias, são transferidas do [nível](https://docs.microsoft.com/azure/storage/blobs/storage-blob-storage-tiers?tabs=azure-portal)de acesso quente para arrefecer .
