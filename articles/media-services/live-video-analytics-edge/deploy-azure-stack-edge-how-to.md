...
* **Kubernetes API Access (kubectl)**
    ...
    * Siga a documentação para configurar a sua máquina para [acesso ao cluster Kubernetes.](../../databox-online/azure-stack-edge-gpu-create-kubernetes-cluster.md)
