...
Neste artigo, você aprenderá sobre a utilização do protocolo gRPC para enviar mensagens entre o módulo Live Video Analytics e a extensão personalizada de IA ou CV.

gRPC é um moderno quadro RPC de código aberto e de alto desempenho que funciona em qualquer ambiente. O serviço de transporte gRPC utiliza o streaming bidirecional HTTP/2 entre:
...
## <a name="media-graph-grpc-extension-contract-definitions"></a>Definições de contrato de extensão gRPC de gráficos de mídia
