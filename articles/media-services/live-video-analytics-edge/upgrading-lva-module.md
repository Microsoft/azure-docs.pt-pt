...
> |Título|Vídeo ao vivo Analytics 1.0|Vídeo ao vivo Analytics 2.0|Descrição|
> |-------------|----------|---------|---------|
...
Pode produzir uma imagem Telegraf com uma configuração personalizada facilmente utilizando o docker. Saiba mais sobre isso na página [de Monitorização e Registo.](monitoring-logging.md#azure-monitor-collection-using-telegraf)
