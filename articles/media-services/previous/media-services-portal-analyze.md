...
## <a name="azure-media-indexer"></a>Indexador de Multimédia do Azure
...
Selecione esta opção se desejar gerar o arquivo de blob de índice de áudio para uso com o IFilter de SQL Server personalizado. Para obter mais informações, consulte [este](https://azure.microsoft.com/blog/using-aib-files-with-azure-media-indexer-and-sql-server/) blog.
