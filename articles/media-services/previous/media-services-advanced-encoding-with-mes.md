...
> [!NOTE] 
> Muitas das funcionalidades avançadas dos Media Services v2 da Media Encoder Standard não estão atualmente disponíveis na V3. Para obter mais informações, consulte [as lacunas de funcionalidades.](https://docs.microsoft.com/azure/media-services/latest/media-services-v2-vs-v3#feature-gaps-with-respect-to-v2-apis)
