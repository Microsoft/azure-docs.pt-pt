...
- [Como codificar com uma transformação personalizada usando o CLI](../latest/transform-custom-preset-cli-how-to.md)
- [Codificação com os Serviços de Multimédia do Azure v3](../latest/encode-concept.md)
