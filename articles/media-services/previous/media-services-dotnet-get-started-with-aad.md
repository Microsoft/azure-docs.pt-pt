...
Para obter instruções sobre como criar e configurar um certificado de forma a ser utilizada pela Azure AD, consulte [Autenticação para AD Azure em aplicações daemon com certificados - passos](https://github.com/Azure-Samples/active-directory-dotnet-daemon-certificate-credential/blob/master/Manual-Configuration-Steps.md)de configuração manual .
