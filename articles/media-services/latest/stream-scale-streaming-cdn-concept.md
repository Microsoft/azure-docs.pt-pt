...
- O [ponto final de streaming](stream-streaming-endpoint-concept.md) e o URL de streaming permanecem os `hostname` mesmos quer ativem ou não a CDN.
...
* Certifique-se de rever o documento [streaming Endpoint (origem).](stream-streaming-endpoint-concept.md)
