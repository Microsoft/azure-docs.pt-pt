...
![Curva de distorção de taxa (RD) utilizando PSNR](media/encode-content-aware-concept/msrv1.png)

**Figura 1: Curva de distorção de taxas (RD) utilizando a métrica PSNR para fonte de alta complexidade**

![Curva de distorção de taxa (RD) utilizando VMAF](media/encode-content-aware-concept/msrv2.png)
...
![Curva RD usando PSNR](media/encode-content-aware-concept/msrv3.png)

**Figura 3: Curva RD utilizando PSNR para entrada de baixa qualidade (a 1080p)**

![Curva RD usando VMAF](media/encode-content-aware-concept/msrv4.png)
