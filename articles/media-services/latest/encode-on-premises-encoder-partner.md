...
2. Criar e iniciar o **Evento** Ao Vivo. <br/> Para mais informações, consulte [os estados do Live Event e a faturação.](live-event-states-billing-concept.md)
...
1. Na sua conta de Media Services, certifique-se de que o **Streaming Endpoint** está em execução. 
2. Crie e inicie o **evento ao vivo** ao vivo ao vivo. <br/> Para mais informações, consulte [os estados do Live Event e a faturação.](live-event-states-billing-concept.md)
...
[Codificadores testados nas instalações](encode-recommended-on-premises-live-encoders.md)
