---
title: Codificar uma transformação personalizada REST
...
- [Criar uma conta de Serviços de Comunicação](./account-create-how-to.md)Social. <br/>Lembre-se do nome do grupo de recursos e do nome da conta dos Serviços de Comunicação Social. 
- [Configure Carteiro para Azure Media Services REST Chamadas API](setup-postman-rest-how-to.md).<br/>Certifique-se de seguir o último passo do tema [Get Azure AD Token](setup-postman-rest-how-to.md#get-azure-ad-token). 
