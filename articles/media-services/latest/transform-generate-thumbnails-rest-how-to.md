...
Recomenda-se que se familiarize com transformações personalizadas lendo [Como codificar com uma transformação personalizada - REST](transform-custom-preset-rest-how-to.md).
...
[Gerenas de miniaturas usando .NET](transform-generate-thumbnails-dotnet-how-to.md)