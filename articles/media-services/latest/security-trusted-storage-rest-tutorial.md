...
Se não sabe como obter a identificação do seu inquilino e identificação de assinatura, consulte [como encontrar o seu ID do inquilino](setup-azure-tenant-how-to.md) e encontre a [identificação do seu inquilino.](setup-azure-tenant-how-to.md)
