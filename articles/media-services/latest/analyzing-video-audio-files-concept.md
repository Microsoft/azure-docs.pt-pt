...
|[FaceDetectorPreset](https://docs.microsoft.com/rest/api/media/transforms/createorupdate#facedetectorpreset)||Descreve as definições a utilizar ao analisar um vídeo para detetar rostos presentes.|
