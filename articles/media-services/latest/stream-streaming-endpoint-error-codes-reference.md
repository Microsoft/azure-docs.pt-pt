---
title: Azure Media Services embalagens e erros de origem
...
ms.locfileid: "106282140"
---
# <a name="streaming-endpoint-origin-errors"></a>Erros do Ponto Final de Transmissão em Fluxo (Origem)

Este tópico descreve erros que poderá receber do serviço Azure Media [Streaming Endpoint](stream-streaming-endpoint-concept.md).
...
- [Conceito: Políticas de streaming](stream-streaming-policy-concept.md)
