...
* [Políticas-chave de conteúdo](drm-content-key-policy-concept.md) AMS utilizando a ferramenta AMS API v3, Azure portal ou a ferramenta [Azure Media Services Explorer (AMSE)](https://github.com/Azure/Azure-Media-Services-Explorer)
...
Leia [Design de um sistema de proteção de conteúdos multi-DRM com controlo de acesso](./architecture-design-multi-drm-system.md) para mais detalhes sobre o subsistema.
...
Aplicam-se a configuração da [política-chave](drm-content-key-policy-concept.md) de conteúdos e [políticas de streaming](stream-streaming-policy-concept.md) para DRM e AES-128.  Alterar a `ContentKeyPolicyRestriction` política de chave de conteúdo.
...
Os *grupos* afirmam ser membro de um Conjunto de [Reclamações Restritas](../../active-directory/develop/reference-claims-mapping-policy-type.md#claim-sets) em Azure AD.
