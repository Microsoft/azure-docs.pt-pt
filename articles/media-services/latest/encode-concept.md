...
![Fluxo de trabalho para codificação a pedido com embalagem dinâmica](./media/encode-dynamic-packaging-concept/media-services-dynamic-packaging.svg)
...
> [!TIP]
> Se pretender transmitir um sublip do seu vídeo sem voltar a codificar o vídeo, considere utilizar [manifestos de pré-filtragem com o Dynamic Packager](filters-dynamic-manifest-concept.md).
...
- **EncoderNamedPreset.AdaptiveStreaming** (recomendado): Isto suporta a codificação de bitramento adaptativo H.264. Para obter mais informações, consulte [uma escada de bitrate que gera automaticamente.](encode-autogen-bitrate-ladder.md)
