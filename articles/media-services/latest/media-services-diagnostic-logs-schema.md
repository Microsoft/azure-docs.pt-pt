...
Para obter informações [detalhadas, consulte as métricas do Monitor Azure](../../azure-monitor/data-platform.md) e [os registos de diagnóstico do Monitor Azure](../../azure-monitor/essentials/platform-logs-overview.md).
