...
> * Uma [subscrição do Azure](setup-azure-subscription-how-to.md)
> * Uma conta [de Serviços de Comunicação](account-create-how-to.md) Social e um grupo de recursos.
