...
Para ver todas as transformações de API REST que estão disponíveis, consulte [Transforms - Create Or Update](https://docs.microsoft.com/rest/api/media/transforms/createorupdate#definitions).
