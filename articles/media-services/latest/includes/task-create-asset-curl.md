...
ms.locfileid: "88608899"
---
<!--Create a media services asset cURL-->

O seguinte comando CURL Azure cria um novo ativo media. Substitua os valores `subscriptionID` `resourceGroup` , e pelos `amsAccountName` valores com os quais está a trabalhar. Dê um nome ao seu ativo definindo `assetName` aqui.
