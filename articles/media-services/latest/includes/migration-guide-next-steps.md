...
A sua aplicação de Media Services V2 pode ser única. Por isso, fornecemos orientações com base na forma como *pode ter* usado serviços de comunicação social no passado e os passos para cada característica do serviço, tais como:
