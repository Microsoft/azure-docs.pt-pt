...
1. Na secção **Criar uma conta de Serviços de Mídia** introduza os valores necessários.
    ...
    |**Grupo de Recursos**|Selecione o recurso novo ou existente. Um grupo de recursos é uma coleção de recursos que partilham o ciclo de vida, as permissões e as políticas. Saiba mais [aqui.](../../../azure-resource-manager/management/overview.md#resource-groups)|
