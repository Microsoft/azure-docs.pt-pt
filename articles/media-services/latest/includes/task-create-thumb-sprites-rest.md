...
ms.locfileid: "101705467"
---
<!--Create a thumbnail sprites REST-->

O seguinte comando Azure REST cria uma transformação de sprite de miniatura. Substitua os valores `subscriptionID` `resourceGroup` , e pelos `accountName` valores com os quais está a trabalhar. 

Dê à sua transformação um nome por definição `transformName` .
