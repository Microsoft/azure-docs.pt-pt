...
ms.locfileid: "88653898"
---
<!--Create a media services asset with Postman-->

Esta secção mostra como criar um novo Ativo usando o Carteiro.

1. Selecione **Ativos**  ->  **Criar ou atualizar um Ativo**.
2. Prima **Enviar**. Verá a **Resposta** com a informação sobre o bem recém-criado.
