...
|Ponto final de streaming padrão (pré-visualização)|2.0|0|Sim|Paga|
|Unidades de streaming premium|1.0|>0|Sim|Paga|
|Unidades de streaming premium|2.0|>0|Sim|Paga|
...
- [Dimensionar Transmissão em Fluxo com CDN](stream-scale-streaming-cdn-concept.md)
...
[Gerir pontos finais de transmissão em fluxo](stream-manage-streaming-endpoints-how-to.md)
