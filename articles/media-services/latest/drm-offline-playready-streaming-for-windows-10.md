...
- [Offline FairPlay Streaming for iOS](drm-offline-fairplay-for-ios-concept.md) (Transmissão Offline do FairPlay para iOS)
- [Streaming de Widevine offline para Android](drm-offline-widevine-for-android.md)
...
## <a name="background-on-offline-mode-playback"></a>Fundo na reprodução do modo offline
