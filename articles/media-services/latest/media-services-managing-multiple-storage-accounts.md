---
title: Gerir os serviços de mídia v3 ativos em várias contas de armazenamento | Microsoft Docs
description: Estes artigos dão-lhe orientação sobre como gerir os ativos de Media Services v3 em várias contas de armazenamento.
...
ms.locfileid: "105572549"
---
# <a name="managing-media-services-v3-assets-across-multiple-storage-accounts"></a>Gestão de serviços de mídia v3 ativos em várias contas de armazenamento  
