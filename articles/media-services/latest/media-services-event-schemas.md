---
title: Esquemas de grelha de eventos Azure para eventos de Serviços de Mídia
description: Conheça as propriedades que são fornecidas para eventos de Serviços de Media com Azure Event Grid.
...
[Registe-se para eventos de mudança de estado de trabalho](job-state-events-cli-how-to.md)
