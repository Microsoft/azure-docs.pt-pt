...
Para obter uma lista de scripts e tutoriais de amostras, consulte [a fonte do evento Media Services.](../../event-grid/event-schema-subscriptions.md)
...
- [Códigos de erro do Evento em Direto](live-event-error-codes.md)
