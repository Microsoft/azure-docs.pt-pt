...
Este artigo mostra-lhe como começar o seu ponto final de streaming.
...
1. Navegue na sua conta Azure Media Services.
1. À esquerda, selecione **Streaming Endpoints**.
1. Selecione o ponto final de streaming que pretende iniciar, clique em **Iniciar**.
...
## <a name="use-cli"></a>Utilizar a CLI
...
* Começar um ponto final de streaming é uma operação assíncrona. 
    ...
    Para mais detalhes sobre como monitorizar uma operação de longo prazo, consulte [operações de longo prazo](media-services-apis-overview.md)
