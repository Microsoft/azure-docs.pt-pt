...
|Codificar conteúdo|Assim que enviar os seus ficheiros de mídia digital de alta qualidade para Ativos, pode codificar em formatos que podem ser reproduzidos numa grande variedade de navegadores e dispositivos. <br/><br/>Para codificar com os Serviços de Media v3, é necessário criar **Transforms** and **Jobs.**|[Transformações e Empregos](transforms-jobs-concept.md)<br/><br/>[Codificação com serviços de media](encoding-concept.md)|
