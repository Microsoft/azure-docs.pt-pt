...
Uso [SDK de .NET](https://aka.ms/ams-v3-dotnet-sdk).

Explore os serviços de multimédia [.NET ref](https://aka.ms/ams-v3-dotnet-ref) documentação.

### <a name="java"></a>Java

Uso [Java SDK](https://aka.ms/ams-v3-java-sdk).

Reveja os serviços de multimédia [Java ref](https://aka.ms/ams-v3-java-ref) documentação.

### <a name="nodejs"></a>Node.js

Uso [SDK node. js](https://aka.ms/ams-v3-nodejs-sdk).
