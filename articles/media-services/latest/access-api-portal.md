---
title: Começar com a autenticação azure AD usando o portal Azure
...
ms.locfileid: "79082749"
---
# <a name="use-the-azure-portal-to-get-credentials-to-access-media-services-api"></a>Utilize o portal Azure para obter credenciais para aceder à API dos Serviços de Media  
...
Este artigo mostra-lhe como usar o portal Azure para obter credenciais para aceder à API dos Serviços de Media.
...
- Uma conta dos Media Services. Para mais informações, consulte [Criar uma conta Azure Media Services utilizando o portal Azure](create-account-portal.md).
