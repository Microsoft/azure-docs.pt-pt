...
Para clientes que procuram entregar conteúdo a grandes audiências de internet, recomendamos que você ative a CDN no [ponto final](stream-streaming-endpoint-concept.md)de streaming .
...
> [!NOTE]
> Pode utilizar o [portal Azure](https://portal.azure.com/) para gerir v3 [Live Events,](live-event-outputs-concept.md)ver [ativos](assets-concept.md)v3, obter informações sobre o acesso às APIs. Para todas as outras tarefas de gestão (por exemplo, Transformações e Empregos), utilize o [REST API,](/rest/api/media/) [CLI,](/cli/azure/ams)ou um dos [SDKs suportados.](media-services-apis-overview.md#sdks)
...
A transcrição ao vivo é uma característica que pode usar com eventos ao vivo que são de passagem ou codificação ao vivo. Para mais informações, consulte [a transcrição em direto.](live-event-live-transcription-how-to.md) Quando esta funcionalidade está ativada, o serviço utiliza a funcionalidade [Discurso-Texto](../../cognitive-services/speech-service/speech-to-text.md) dos Serviços Cognitivos para transcrever as palavras faladas no áudio de entrada em texto. Este texto é então disponibilizado para entrega juntamente com vídeo e áudio nos protocolos MPEG-DASH e HLS.
...
- [Pontos finais de transmissões em fluxo](stream-streaming-endpoint-concept.md)
- [Eventos em direto e saídas em direto](live-event-outputs-concept.md)
...
7. Crie um **localizador de streaming** com os [tipos de política de streaming incorporados](stream-streaming-policy-concept.md).
...
- [Codificadores em direto recomendados](encode-recommended-on-premises-live-encoders.md)
- [Using a cloud DVR](live-event-cloud-dvr-time-how-to.md) (Utilizar um DVR na cloud)
- [Comparação de tipos de eventos ao vivo](live-event-types-comparison-reference.md)
- [States and billing](live-event-states-billing-concept.md) (Estados e faturação)
