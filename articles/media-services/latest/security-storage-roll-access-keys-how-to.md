...
O seguinte artigo mostra como adicionar contas de armazenamento à sua conta AMS: [Anexar várias contas de armazenamento a uma conta de Serviços de Mídia](storage-managing-multiple-storage-accounts-how-to.md).
