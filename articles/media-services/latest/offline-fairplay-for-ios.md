...
* Reveja proteção de conteúdo online para FairPlay: 
...
Remova a marca de comentário do código que configura a opção de política FairPlay:
...
Para habilitar o modo offline, crie um StreamingPolicy personalizado e use seu nome ao criar um StreamingLocator no [CreateStreamingLocatorAsync](https://github.com/Azure-Samples/media-services-v3-dotnet-tutorials/blob/master/AMSV3Tutorials/EncryptWithDRM/Program.cs#L563).
...
![Fluxos offline do aplicativo iOS FairPlay](media/offline-fairplay-for-ios/offline-fairplay-ios-app-streams.png)
...
![Estrutura de arquivos de aplicativo de exemplo do iOS FairPlay offline](media/offline-fairplay-for-ios/offline-fairplay-file-structure.png)
