...
> [!NOTE]
> Atualmente, não pode utilizar o portal do Azure para gerir recursos v3. Use the [REST API](https://aka.ms/ams-v3-rest-sdk), CLI, or one of the supported SDKs.
...
* When submitting a job, you can specify to ingest your source video using HTTPS URLs, SAS URLs, or paths to files located in Azure Blob storage. Atualmente, o AMS v3 não suporta a codificação de transferência segmentada através de URLs HTTPS.
