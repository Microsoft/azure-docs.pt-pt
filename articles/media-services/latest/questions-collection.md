---
title: Coleção de perguntas Azure Media Services v3
description: Este artigo dá respostas a uma coleção de perguntas sobre a Azure Media Services v3.
...
# <a name="media-services-v3-questions-collection"></a>Recolha de perguntas dos Serviços de Comunicação Social v3
