---
title: Descrição geral da Comunidade dos serviços de multimédia do Azure | Documentos da Microsoft
description: Esta página da Comunidade de serviços de multimédia do Azure descreve formas diferentes, pode fazer perguntas, comentários e obter atualizações sobre os serviços de multimédia.
...
ms.locfileid: "64710177"
---
# <a name="azure-media-services-community"></a>Comunidade dos Serviços de Multimédia do Azure  

Esta página da Comunidade de serviços de multimédia do Azure descreve formas diferentes, pode fazer perguntas, comentários e obter atualizações sobre os serviços de multimédia.
...
Pode utilizar o [ @MSFTAzureMedia ](https://twitter.com/MSFTAzureMedia) identificador do twitter contacte-nos ou seguir as atualizações no Twitter. Utilize o [ @AzureSupport ](https://twitter.com/azuresupport) identificador do twitter para pedir suporte no Twitter.  
