...
Recomenda-se que se familiarize com transformações personalizadas lendo [Como codificar com uma transformação personalizada - .NET](transform-custom-presets-how-to.md).
