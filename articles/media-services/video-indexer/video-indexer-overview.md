...
- **Identificação de celebridade**: O Video Indexer identifica automaticamente celebridades de mais de 1 milhão – como líderes mundiais, atores, actresses, atletas Favoritos, pesquisadores, empresas e líderes em tecnologia em todo o mundo. Os dados sobre estas celebridades também podem ser encontrados em vários sites conhecidos como, por exemplo, o IMDB e a Wikipédia.
...
- **Segmentação de cena**: determina quando uma cena altera em vídeo com base no indicações visuais. Uma cena descreve um único evento e é constituído por uma série de capturas consecutivas, que é semanticamente estão relacionados. 
- **Captura de deteção**: determina quando é alterado uma captura de vídeo com base nas ajudas visuais. Uma captura é uma série de retirada do mesmo câmara de imagem de movimento de fotogramas. Para obter mais informações, consulte [nos bastidores, capturas e quadros-chave](scenes-shots-keyframes.md).
...
- **Sem interrupção créditos**: identificar o início e no fim do crédito sem interrupção no final da contas de programas de TV e filmes.
...
- Criação de conteúdo – insights extraídos dos vídeos e ajude a efetivamente criar conteúdo como trailers, conteúdo de mídia social, notícias clips etc. do conteúdo existente no arquivo de organização 
...
- [Começar com o site do Video Indexer](video-indexer-get-started.md)
