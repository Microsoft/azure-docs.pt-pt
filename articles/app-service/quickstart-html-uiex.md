...
<li><a href="/cli/azure/webapp?view=azure-cli-latest#az-webapp-create">Crie uma aplicação de Serviço de Aplicações</a> com o nome especificado.</li>
