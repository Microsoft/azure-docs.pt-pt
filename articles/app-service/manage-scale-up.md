---
title: Escalar verticalmente recursos e capacidades – serviço de Azure App | Microsoft Docs
description: Saiba como escalar verticalmente um aplicativo no serviço de Azure App para adicionar capacidade e recursos.
...
Para vídeos sobre o dimensionamento de aplicativos do serviço de aplicativo, consulte os seguintes recursos:
...
* [Dimensionamento automático de sites do Azure, CPU ou agendado-com Stefan Schackow](https://azure.microsoft.com/resources/videos/auto-scaling-azure-web-sites/)
* [Como os sites do Azure são dimensionados com Stefan Schackow](https://azure.microsoft.com/resources/videos/how-azure-web-sites-scale/)
