...
Para obter mais informações, consulte [utilizar a Azure PowerShell com o Azure Resource Manager](../powershell-azure-resource-manager.md)
...
### <a name="deploy-to-azure-button"></a>Implementar para o botão Azure
