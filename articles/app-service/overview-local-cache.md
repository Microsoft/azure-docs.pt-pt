---
title: Visão geral do cache local-serviço de Azure App | Microsoft Docs
description: Este artigo descreve como habilitar, redimensionar e consultar o status do recurso de cache local do serviço de Azure App
...
* O [streaming de log](troubleshoot-diagnostic-logs.md#streamlogs) é afetado pela cópia de melhor esforço. Você pode observar um atraso de um minuto nos logs transmitidos.
