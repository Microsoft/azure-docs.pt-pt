...
O seguinte comando cria um plano de Serviço de Aplicações em _P1V2_. Podes executá-lo na Cloud Shell. As opções `--sku` para são P1V3, _P2V3_e _P3V3._
...
O seguinte comando cria um plano de Serviço de Aplicações em _P1V3_. As opções `-WorkerSize` para são _Pequenas,_ _Médias_e _Grandes._
