...
Pode automatizar a criação de aplicações no nível **PremiumV2** com scripts, utilizando o [Azure CLI](/cli/azure/install-azure-cli) ou [o Azure PowerShell](/powershell/azure/).
