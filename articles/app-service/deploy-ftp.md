...
Este artigo mostra-lhe como usar FTP ou FTPS para implementar a sua aplicação web, suporte de aplicativo móvel ou app API para [o Azure App Service](https://go.microsoft.com/fwlink/?LinkId=529714).
