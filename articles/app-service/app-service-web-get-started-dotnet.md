---
title: 'Início rápido: criar C# um aplicativo ASP.NET Core'
description: Saiba como executar aplicativos Web no serviço de Azure App implantando o modelo C# de aplicativo web do ASP.NET Core padrão do Visual Studio.
