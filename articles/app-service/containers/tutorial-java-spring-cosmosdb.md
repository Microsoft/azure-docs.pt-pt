...
ms.locfileid: "68489461"
---
# <a name="tutorial-build-a-java-web-app-using-spring-and-azure-cosmos-db"></a>Tutorial: Compilar um aplicativo Web Java usando Spring e Azure Cosmos DB
