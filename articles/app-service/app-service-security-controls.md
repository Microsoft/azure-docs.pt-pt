...
| Encriptação em trânsito (como encriptação ExpressRoute, na encriptação VNet e encriptação VNet-VNet )| Sim | Os clientes podem configurar web sites para exigir e usar HTTPS para tráfego de entrada.  | [Como fazer um Serviço de Aplicações Azure HTTPS apenas](https://blogs.msdn.microsoft.com/benjaminperkins/2017/11/30/how-to-make-an-azure-app-service-https-only/) (blog post)
