...
Para atualizar seu token de acesso a qualquer momento, basta `/.auth/refresh` chamar em qualquer idioma. O trecho a seguir usa o jQuery para atualizar os tokens de acesso de um cliente JavaScript.
