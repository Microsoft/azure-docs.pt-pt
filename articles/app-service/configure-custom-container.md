...
Este guia fornece conceitos e instruções fundamentais para a contentorização de aplicações Linux no Serviço de Aplicações. Se nunca usou o Azure App Service, siga primeiro o [quickstart](quickstart-custom-container.md?pivots=container-linux) e [tutorial](tutorial-custom-container.md?pivots=container-linux) do recipiente personalizado. Há também um quickstart e tutorial [de aplicativo multi-contentores.](quickstart-multi-container.md) [tutorial](tutorial-multi-container-app.md)
...
> [!NOTE]
> Também pode [configurar o seu próprio armazenamento persistente.](configure-connect-to-azure-storage.md?pivots=platform-linux)
