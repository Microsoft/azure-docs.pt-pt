...
ms.locfileid: "107777622"
---
# <a name="access-azure-storage-preview-as-a-network-share-from-a-container-in-app-service"></a>Aceder ao Armazenamento do Microsoft Azure (pré-visualização) como uma partilha de rede de um contentor no Serviço de Aplicações
...
Para montar um Azure Files Share para um diretório na sua aplicação App Service, utilize o [`az webapp config storage-account add`](/cli/azure/webapp/config/storage-account#az_webapp_config_storage_account_add) comando. O tipo de armazenamento deve ser AzureFiles.
