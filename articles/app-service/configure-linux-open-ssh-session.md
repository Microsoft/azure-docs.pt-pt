...
> [!NOTE]
> Se este comando falhar, certifique-se de que [a depuração remota](https://medium.com/@auchenberg/introducing-remote-debugging-of-node-js-apps-on-azure-app-service-from-vs-code-in-public-preview-9b8d83a6e1f0) é *desativada* com o seguinte comando:
>
> ```azurecli-interactive
