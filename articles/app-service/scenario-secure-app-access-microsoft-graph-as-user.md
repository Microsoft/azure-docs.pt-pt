...
No ficheiro *.cs Arranque,* o ```AddMicrosoftIdentityWebApp``` método adiciona o Microsoft.Identity.Web à sua aplicação web. O ```AddMicrosoftGraph``` método adiciona suporte ao Microsoft Graph.
