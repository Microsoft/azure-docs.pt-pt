...
Tem de utilizar uma [ imagem principal suportada](quickstart-custom-container.md#use-a-different-parent-image). Altere a imagem principal, substituindo a linha `FROM` pelo seguinte código:
