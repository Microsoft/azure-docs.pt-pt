...
* Um [Token de Acesso Pessoal (PAT)](/azure/devops/organizations/accounts/use-personal-access-tokens-to-authenticate) para a sua organização do Azure DevOps.
