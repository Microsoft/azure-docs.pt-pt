...
| [`az webapp config hostname add`](/cli/azure/webapp/config/hostname#az_webapp_config_hostnam_eadd) | Mapeia um domínio personalizado para uma aplicação de Serviço de Aplicações. |
