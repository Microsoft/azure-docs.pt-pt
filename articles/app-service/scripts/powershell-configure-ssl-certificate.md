---
title: 'PowerShell: carregar e associar SSL'
description: Saiba como usar Azure PowerShell para automatizar a implantação e o gerenciamento do serviço de aplicativo. Este exemplo mostra como associar um certificado SSL personalizado a um aplicativo.
