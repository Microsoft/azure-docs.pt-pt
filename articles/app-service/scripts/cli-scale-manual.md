...
| [`az appservice plan update`](/cli/azure/appservice/plan#az-appservice-plan-update) | Atualiza as propriedades do plano do Serviço de Aplicações. |
