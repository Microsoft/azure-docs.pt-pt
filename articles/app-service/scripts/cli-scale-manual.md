...
| [`az appservice plan update`](/cli/azure/appservice/plan#az_appservice_plan_update) | Atualiza as propriedades do plano do Serviço de Aplicações. |
