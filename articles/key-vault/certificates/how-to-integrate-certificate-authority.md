...
4. Definir **emitente**. Isto irá adicionar Digicert como autoridade de certificado no cofre chave. Para saber mais sobre os parâmetros, [leia aqui](/powershell/module/az.keyvault/Set-AzKeyVaultCertificateIssuer)
```azurepowershell-interactive
