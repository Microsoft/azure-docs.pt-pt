...
Agora, pode utilizar esta chave protegida por HSM no Cofre de chaves. Para obter mais informações, consulte este preços e funcionalidades [comparação](https://azure.microsoft.com/pricing/details/key-vault/).
