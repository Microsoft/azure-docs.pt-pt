...
- Gere (ou importe usando as teclas [BYOK)](hsm-protected-keys-byok.md)e use-as para encriptar os seus dados em repouso em serviços Azure, tais como [Azure Storage,](../../storage/common/encryption-customer-managed-keys.md) [Azure SQL,](../../azure-sql/database/transparent-data-encryption-byok-overview.md)e [Azure Information Protection](/azure/information-protection/byok-price-restrictions).
