...
Segundo preview versão 2015-02-01-pré-visualização, anunciámos a 20 de Abril de 2015. Para obter mais informações, consulte [atualizações de API do REST](https://blogs.technet.com/b/kv/archive/2015/04/20/empty-3.aspx) postagem de blog.
