...
Para mais informações, e para que um tutorial começasse a usar o Key Vault (incluindo como criar um cofre chave para chaves protegidas por HSM), veja [o que é o Cofre chave Azure?](../general/overview.md)
