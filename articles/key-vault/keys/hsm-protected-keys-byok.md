...
| Versão Azure CLI 2.1.0 ou mais tarde | Consulte [a Instalação do Azure CLI](/cli/azure/install-azure-cli?view=azure-cli-latest&preserve-view=true).|
