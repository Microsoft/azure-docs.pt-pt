...
|AES 128-bit, 256-bit <br/>(Gerido apenas HSM)| AES-KW<br>AES-GCM<br>AES-CBC| ND| 
|||
...
##  <a name="symmetric-key-algorithms-managed-hsm-only"></a>Algoritmos chave simétricos (apenas HSM gerido)
