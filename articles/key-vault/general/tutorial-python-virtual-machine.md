...
Criar uma identidade atribuída ao sistema para a máquina virtual utilizando o comando de atribuição de identidade Azure CLI [vm:](/cli/azure/vm/identity#az_vm_identity_assign)
