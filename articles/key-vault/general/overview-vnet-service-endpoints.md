...
|Base de Dados SQL do Azure|[Encriptação de dados transparente com suporte de chave própria para Azure SQL Database e Azure Synapse Analytics](../../azure-sql/database/transparent-data-encryption-byok-overview.md).|
...
|Gateway de Aplicação do Azure |[Utilização de certificados key vault para ouvintes com VIA HTTPS](../../application-gateway/key-vault-certs.md)
