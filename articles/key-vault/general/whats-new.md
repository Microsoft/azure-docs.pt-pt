---
title: Novidades para Azure Key Vault Microsoft Docs
...
ms.locfileid: "87563652"
---
# <a name="whats-new-for-azure-key-vault"></a>O que há de novo para Azure Key Vault

> [!WARNING]
> **julho de 2020**: Existem duas atualizações para o cofre-chave que têm o potencial de impactar as implementações do serviço: [cofre-chave de exclusão por defeito](#soft-delete-on-by-default) e alterações no [certificado Azure TLS](#azure-tls-certificate-changes). Veja abaixo os detalhes.
...
Os atuais certificados de CA *só* serão revogados em 15 de fevereiro de 2021. Depois dessa data, pode remover as impressões digitais antigas do seu código.

Se esta data mudar, será notificado da nova data de revogação.

### <a name="will-this-affect-me"></a>Isto vai afetar-me?
...
- Diferentes sistemas operativos e tempos de execução linguísticos que comunicam com os serviços da Azure podem exigir medidas adicionais para construir corretamente a cadeia de certificados com estas novas raízes: 
    - **Linux**: Muitas distribuições requerem que adicione CAs listados acima a /etc/ssl/certs. Para instruções específicas consulte a documentação da distribuição.
    - **Java**: Certifique-se de que a loja de chaves Java contém os CAs listados acima.
    - **Windows running in disconnected environments**: Os sistemas que executam em ambientes desligados terão de ter as raízes acima listadas adicionadas à loja Trusted Root Certification Authorities e os intermediários adicionados à loja Das Autoridades de Certificação Intermédia.
