...
Para obter mais informações sobre a criação de grupos no Azure Ative Directory através do portal Azure, consulte [Criar um grupo básico e adicionar membros](/azure/active-directory/fundamentals/active-directory-groups-create-azure-portal)
