...
Para definir as políticas de acesso para um cofre chave, utilize o [portal Azure,](https://portal.azure.com/)o [Azure CLI,](/cli/azure/install-azure-cli?view=azure-cli-latest) [o Azure PowerShell](/powershell/azureps-cmdlets-docs)ou o [Key Vault Management REST APIs](/rest/api/keyvault/).
...
Para mais informações sobre a revisão do endereço de endereço da rede Azure Key Vault, os [pontos finais](overview-vnet-service-endpoints.md)do serviço de rede virtual para o Cofre de Chaves Azure )
