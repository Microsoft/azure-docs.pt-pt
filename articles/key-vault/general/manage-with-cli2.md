...
Para uma visão geral do Cofre de Chaves Azure, veja [o que é o Cofre de Chaves Azure?](overview.md) Se não tiver uma subscrição Azure, crie uma [conta gratuita](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) antes de começar.
...
Para obter instruções mais detalhadas sobre como gerar este pacote BYOK, consulte como utilizar chaves protegidas por [HSM com cofre](../keys/hsm-protected-keys.md)de chave Azure .
...
- Para referências de programação, consulte [o guia do desenvolvedor do Cofre chave Azure](developers-guide.md)

- Para obter informações sobre o Cofre de Chaves Azure e hSMs, consulte como utilizar chaves protegidas por [HSM com cofre](../keys/hsm-protected-keys.md)de chave Azure .
