...
Não precisa de verificar a expiração do token antes de ligar para o `GetAccessTokenAsync` método, porque `AzureServiceTokenProvider` caches o símbolo na memória e o recupera do AZure AD pouco antes de expirar. 
