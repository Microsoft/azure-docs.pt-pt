...
* O comando de reserva confirma todas as versões de cada segredo. Se tiver um segredo com um grande número de versões anteriores (mais de 10), o tamanho do pedido pode exceder o máximo permitido e a operação pode falhar.
