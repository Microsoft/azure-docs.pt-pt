...
| Restrinja quem pode aceder aos seus registos de cofre seledores Azure Key | [Registos do Cofre de Chaves)](logging.md) guarde informações sobre as atividades realizadas no seu cofre, tais como criação ou eliminação de cofres, chaves, segredos e pode ser usado durante uma investigação |  - |

## <a name="networking"></a>Redes

| Recomendação | Comentários | Centro de Segurança |
|-|----|--|
|Limitar a exposição à rede | O acesso à rede deve limitar-se às redes virtuais utilizadas por soluções que requerem acesso ao cofre. Rever informações sobre [os pontos finais do serviço de rede virtual para o Cofre de Chaves Azure)](overview-vnet-service-endpoints.md) | - |
