...
Você pode criar um novo cofre chave seguindo os passos em [set e recuperar um segredo do Cofre chave Azure usando o portal Azure](../secrets/quick-create-portal.md)
...
- Saiba mais sobre [o Cofre de Chaves Azure](overview.md)
