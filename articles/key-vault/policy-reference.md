...
ms.locfileid: "105038325"
---
# <a name="azure-policy-built-in-definitions-for-key-vault"></a>Definições incorporadas da Política Azure para o Cofre-Chave

Esta página é um índice de definições de política incorporadas da [Azure Policy](../governance/policy/overview.md) para Key Vault. Para obter mais incorporados em Azure Policy para outros serviços, consulte [definições incorporadas da Política Azure](../governance/policy/samples/built-in-policies.md).
