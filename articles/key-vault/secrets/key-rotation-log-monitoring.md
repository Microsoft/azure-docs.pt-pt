...
Primeiro, tens de ativar o registo no cofre da chave. Utilize os seguintes comandos PowerShell. (Pode ver todos os detalhes deste artigo sobre a [exploração de porta-chaves .)](../general/logging.md)
