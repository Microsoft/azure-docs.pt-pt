---
title: Azure Quickstart - Criar um cofre de chaves Azure e um segredo usando o modelo de Gestor de Recursos Azure / Microsoft Docs
...
O modelo utilizado neste arranque rápido é de [Azure Quickstart Templates](https://azure.microsoft.com/resources/templates/101-key-vault-create/).
...
![Modelo ARM, integração do Cofre chave, implementar saída de validação do portal](../media/quick-create-template/resource-manager-template-portal-deployment-cli-output.png)
