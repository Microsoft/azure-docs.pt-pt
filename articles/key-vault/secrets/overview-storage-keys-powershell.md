...
Connect-AzAccount
```
Se tiver várias subscrições Azure, pode listá-las usando o cmdlet [Get-AzSubscription](/powershell/module/az.accounts/get-azsubscription?view=azps-2.5.0) e especificar a subscrição que pretende utilizar com o [cmdlet Set-AzContext.](/powershell/module/az.accounts/set-azcontext?view=azps-2.5.0) 
...
Utilize o cmdlet de assinatura Azure PowerShell [Set-AzKeyVaagedStorageStorageSasDefinition](/powershell/module/az.keyvault/set-azkeyvaultmanagedstoragesasdefinition?view=azps-2.6.0) para criar uma definição de assinatura de acesso partilhado.  Pode fornecer o nome da sua escolha ao `-Name` parâmetro.
