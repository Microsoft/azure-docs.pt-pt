...
Para obter mais informações sobre o registo de utilização para o Cofre chave, consulte a [exploração do Cofre de Chaves Azure](key-vault-logging.md).
